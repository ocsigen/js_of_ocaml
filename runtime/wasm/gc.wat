...
(@then
   ...
   (func $caml_gc_stat (export "caml_gc_stat")
      ...
      (local $f (ref eq))
      (local.set $f (struct.new $float (f64.const 0)))
      (array.new_fixed $block 19 (ref.i31 (i32.const 0))
         (local.get $f) (local.get $f) (local.get $f)
...
(@else
   ...
   (func (export "caml_memprof_enlist") (param (ref eq)) (result (ref eq))
      (ref.i31 (i32.const 0)))

   (func (export "caml_memprof_enlist_all_domains")
      (param (ref eq)) (result (ref eq))
      (ref.i31 (i32.const 0)))
