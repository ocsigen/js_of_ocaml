...
(@then
       ...
       (block $cont (result (ref array))
        (block $f32
         (block $f64
          ...
          ;; i8
          (br $cont (array.new $string (i32.const 0) (local.get $sz))))
         ;; f64
         (br $cont (array.new $float_array (f64.const 0) (local.get $sz))))
        ;; f32
        (array.new $f32_array (f32.const 0) (local.get $sz))))
      (extern.convert_any
         (struct.new $data (local.get $a) (i32.const 0) (local.get $sz))))

   (func $ta_length (export "ta_length") (param $b (ref extern)) (result i32)
      (struct.get $data $len
         (ref.cast (ref $data) (any.convert_extern (local.get $b)))))

   (func $ta_get_f64 (param $b (ref extern)) (param $i i32) (result f64)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.get $float_array
         (ref.cast (ref $float_array) (struct.get $data $array (local.get $d)))
         (i32.add (struct.get $data $offset (local.get $d)) (local.get $i))))

   (func $ta_get_f32 (param $b (ref extern)) (param $i i32) (result f64)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (f64.promote_f32
         (array.get $f32_array
   ...
   (func $ta_get_i32 (export "ta_get_i32")
      (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.get $i32_array
   ...
   (func $ta_get_i16 (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
   ...
   (func $ta_get_ui16 (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
   ...
   (func $ta_get_i8 (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.get_s $string
         (ref.cast (ref $string) (struct.get $data $array (local.get $d)))
         (i32.add (struct.get $data $offset (local.get $d)) (local.get $i))))

   (func $ta_get_ui8 (export "ta_get_ui8")
      (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.get_u $string
   ...
   (func $ta_get32_ui8 (export "ta_get32_ui8")
      (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data)) (local $s (ref $string))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (local.set $s
         (ref.cast (ref $string) (struct.get $data $array (local.get $d))))
      (local.set $i
   ...
   (func $ta_get16_ui8 (export "ta_get16_ui8")
      (param $b (ref extern)) (param $i i32) (result i32)
      (local $d (ref $data)) (local $s (ref $string))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (local.set $s
   ...
   (func $ta_set_f64 (param $b (ref extern)) (param $i i32) (param $v f64)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
   ...
   (func $ta_set_f32 (param $b (ref extern)) (param $i i32) (param $v f64)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.set $f32_array
         (ref.cast (ref $f32_array) (struct.get $data $array (local.get $d)))
         (i32.add (struct.get $data $offset (local.get $d)) (local.get $i))
         (f32.demote_f64 (local.get $v))))

   (func $ta_set_i32 (export "ta_set_i32")
      (param $b (ref extern)) (param $i i32) (param $v i32)
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.set $i32_array
         (ref.cast (ref $i32_array) (struct.get $data $array (local.get $d)))
   ...
   (func $ta_set_i16 (param $b (ref extern)) (param $i i32) (param $v (ref i31))
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.set $i16_array
         (ref.cast (ref $i16_array) (struct.get $data $array (local.get $d)))
   ...
   (func $ta_set_ui16 (param $b (ref extern)) (param $i i32) (param $v (ref i31))
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.set $i16_array
         (ref.cast (ref $i16_array) (struct.get $data $array (local.get $d)))
   ...
   (func $ta_set_i8 (param $b (ref extern)) (param $i i32) (param $v (ref i31))
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.set $string
         (ref.cast (ref $string) (struct.get $data $array (local.get $d)))
   ...
   (func $ta_set_ui8 (export "ta_set_ui8")
      (param $b (ref extern)) (param $i i32) (param $v (ref i31))
      (local $d (ref $data))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (array.set $string
         (ref.cast (ref $string) (struct.get $data $array (local.get $d)))
   ...
   (func $ta_set16_ui8
      (param $b (ref extern)) (param $i i32) (param $v (ref i31))
      (local $d (ref $data)) (local $s (ref $string)) (local $j i32)
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (local.set $s
         (ref.cast (ref $string) (struct.get $data $array (local.get $d))))
      (local.set $j (i31.get_u (local.get $v)))
      (local.set $i
         (i32.add (struct.get $data $offset (local.get $d)) (local.get $i)))
      (array.set $string (local.get $s) (local.get $i) (local.get $j))
      (array.set $string (local.get $s) (i32.add (local.get $i) (i32.const 1))
         (i32.shr_u (local.get $j) (i32.const 8))))

   (func $ta_set32_ui8 (param $b (ref extern)) (param $i i32) (param $v i32)
      (local $d (ref $data)) (local $s (ref $string))
      (local.set $d (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (local.set $s
         (ref.cast (ref $string) (struct.get $data $array (local.get $d))))
      (local.set $i
         (i32.add (struct.get $data $offset (local.get $d)) (local.get $i)))
      (array.set $string (local.get $s) (local.get $i) (local.get $v))
      (array.set $string (local.get $s) (i32.add (local.get $i) (i32.const 1))
      ...
      (array.set $string (local.get $s) (i32.add (local.get $i) (i32.const 3))
            ...
            (loop $loop
               (if (i32.lt_u (local.get $i) (local.get $len))
                  (then
                     ...
                     (br $loop)))))
      (else
         (local.set $a8 (ref.cast (ref $string) (local.get $a)))
         (loop $loop
            (if (i32.lt_u (local.get $i) (local.get $len))
               (then
                  (array.set $string (local.get $a8)
                     (i32.add (local.get $ofs) (local.get $i))
                     (local.get $v))
                  (local.set $i (i32.add (local.get $i) (i32.const 1)))
                  (br $loop)))))))))
   ...
   (func $ta_set (export "ta_set")
      ...
      (local $si8 (ref $string)) (local $di8 (ref $string))
               ...
               (if (i32.lt_u (local.get $i) (local.get $len))
                  (then
                     (array.set $i16_array (local.get $di16)
                        (i32.add (local.get $do) (local.get $i))
                        (array.get $i16_array (local.get $si16)
                           (i32.add (local.get $so) (local.get $i))))
                     (local.set $i (i32.add (local.get $i) (i32.const 1)))
                     (br $loop))))))
      (if (ref.test (ref $string) (local.get $sa))
         (then
            (local.set $si8 (ref.cast (ref $string) (local.get $sa)))
            (local.set $di8 (ref.cast (ref $string) (local.get $da)))
            (loop $loop
               (if (i32.lt_u (local.get $i) (local.get $len))
                  (then
                     (array.set $string (local.get $di8)
                        (i32.add (local.get $do) (local.get $i))
                        (array.get $string (local.get $si8)
                           (i32.add (local.get $so) (local.get $i))))
                     (local.set $i (i32.add (local.get $i) (i32.const 1)))
                     (br $loop)))))))
   ...
   (func $ta_subarray (export "ta_subarray")
      ...
      (extern.convert_any
         (struct.new $data
            (struct.get $data $array (local.get $d))
            (i32.add (struct.get $data $offset (local.get $d)) (local.get $s))
            (i32.sub (local.get $e) (local.get $s)))))

   (func $ta_blit_from_string (export "ta_blit_from_string")
      (param $s (ref $string)) (param $so i32)
      ...
      (local.set $data
         (ref.cast (ref $data) (any.convert_extern (local.get $b))))
      (local.set $d
         (ref.cast (ref $string) (struct.get $data $array (local.get $data))))
      (local.set $do
         (i32.add (local.get $do (struct.get $data $offset (local.get $data)))))
      (loop $loop
         (if (i32.lt_u (local.get $i) (local.get $len))
            (then
               (array.set $string (local.get $d)
                  (i32.add (local.get $do) (local.get $i))
   ...
   (func $ta_blit_to_string (export "ta_blit_to_string")
      (param $b (ref extern)) (param $so i32)
      (param $d (ref $string)) (param $do i32)
      (param $len i32)
      (local $data (ref $data))
      (local $s (ref $string))
      (local $i i32)
