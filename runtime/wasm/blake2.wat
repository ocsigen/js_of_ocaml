...
(@then
   ...
   (import "js" "blake2_js_for_wasm_create"
      (func $blake2_js_for_wasm_create (param (ref eq) externref) (result externref)))

   (import "js" "blake2_js_for_wasm_update"
      (func $blake2_js_for_wasm_update (param externref externref i32 i32)))

   (import "js" "blake2_js_for_wasm_string"
      (func $blake2_js_for_wasm_string
         (param (ref eq) externref externref i32 i32) (result externref)))

   (import "js" "blake2_js_for_wasm_final"
      (func $blake2_js_for_wasm_final (param externref (ref eq)) (result externref)))
