...
import { caml_array_blit } from './array.js';
...
export function caml_ephe_create(n) {
...
export function caml_ephe_get_key_copy(x, i) {
...
export function caml_ephe_check_key(x, i) {
  var weak = x[caml_ephe_key_offset + i];
  if (weak === caml_ephe_none) return 0;
  if (globalThis.WeakRef && weak instanceof globalThis.WeakRef) {
    weak = weak.deref();
...
export function caml_ephe_blit_key(a1, i1, a2, i2, len) {
...
export function caml_ephe_blit_data(src, dst) {
...
export function caml_ephe_get_data(x) {
...
export function caml_ephe_get_data_copy(x) {
...
export function caml_ephe_set_data(x, data) {
...
export function caml_ephe_set_data_opt(x, data_opt) {
...
export function caml_ephe_unset_data(x) {
  x[caml_ephe_data_offset] = caml_ephe_none;
  return 0;
}

//Provides: caml_ephe_check_data
export function caml_ephe_check_data(x) {
