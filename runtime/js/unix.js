...
function caml_unix_times() {
  if (globalThis.process && globalThis.process.cpuUsage) {
    var t = globalThis.process.cpuUsage();
    return BLOCK(0, t.user / 1e6, t.system / 1e6, 0, 0);
  } else if (globalThis.performance && globalThis.performance.now) {
...
function caml_unix_getgid(unit) {
  if (globalThis.process && globalThis.process.getgid) {
...
function caml_unix_getegid(unit) {
  if (globalThis.process && globalThis.process.getegid) {
