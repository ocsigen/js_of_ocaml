...
import { caml_bytes_unsafe_get, caml_jsbytes_of_string } from './mlBytes.js';

//Provides: caml_lex_array
export function caml_lex_array(s) {
...
export function caml_lex_engine(tbl, start_state, lexbuf) {
  var lex_buffer = 2;
...
export function caml_new_lex_engine(tbl, start_state, lexbuf) {
  var lex_buffer = 2;
  var lex_buffer_len = 3;
  var lex_start_pos = 5;
  var lex_curr_pos = 6;
