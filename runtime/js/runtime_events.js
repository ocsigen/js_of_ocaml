...
//Version: >= 5.1
export function caml_runtime_events_user_write(_event, _event_content) {
  return 0;
}
...
//Version: >= 5.2
export function caml_ml_runtime_events_pause() {
  return 0;
}
...
//Version: >= 5.2
export function caml_ml_runtime_events_are_active() {
  return 0;
}
...
//Version: >= 5.0
export function caml_runtime_events_create_cursor(_target) {
  return {};
}

//Provides: caml_runtime_events_free_cursor
//Version: >= 5.0
export function caml_runtime_events_free_cursor(_cursor) {
  return 0;
}

//Provides: caml_runtime_events_read_poll
//Version: >= 5.0
export function caml_runtime_events_read_poll(_cursor, _callbacks, _num) {
  return 0;
}

//Provides: caml_ml_runtime_events_path const
//Version: >= 5.3
export function caml_ml_runtime_events_path(_unit) {
  return 0;
}
