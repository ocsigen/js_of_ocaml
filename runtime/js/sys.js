...
import { caml_invalid_argument, caml_raise_not_found, caml_raise_with_arg } from './fail.js';
import { jsoo_is_win32 } from './fs_node.js';
import { resolve_fs_device } from './fs.js';
import { caml_callback } from './jslib.js';
import { MlBytes, caml_jsstring_of_string, caml_string_of_jsbytes, caml_string_of_jsstring } from './mlBytes.js';
import { caml_global_data, caml_named_value } from './stdlib.js';

//Provides: caml_raise_sys_error (const)
export function caml_raise_sys_error(msg) {
...
//Alias: unix_exit
export function caml_sys_exit(code) {
...
export function caml_is_special_exception(exn) {
  switch (exn[2]) {
...
export function caml_format_exception(exn) {
  var r = "";
  if (exn[0] === 0) {
    r += exn[1][1];
    if (
...
export function caml_fatal_uncaught_exception(err) {
...
export function jsoo_sys_getenv(n) {
...
export function caml_sys_getenv(name) {
...
export function caml_sys_unsafe_getenv(name) {
...
export function caml_sys_argv(_unit) {
  return caml_argv;
}

//Provides: caml_sys_modify_argv
export function caml_sys_modify_argv(arg) {
  caml_argv = arg;
  return 0;
}

//Provides: caml_sys_executable_name const
export function caml_sys_executable_name(_unit) {
  return caml_executable_name;
}

//Provides: caml_sys_system_command
export function caml_sys_system_command(cmd) {
...
export function caml_sys_time() {
  var now = new Date().getTime();
  return now * 0.001 - caml_initial_time;
}

//Provides: caml_sys_time_include_children
export function caml_sys_time_include_children(_b) {
  return caml_sys_time();
}

//Provides: caml_sys_random_seed mutable
//The function needs to return an array since OCaml 4.0...
export function caml_sys_random_seed() {
...
export function caml_sys_const_word_size() {
  return 32;
}

//Provides: caml_sys_const_int_size const
export function caml_sys_const_int_size() {
  return 32;
}
...
export function caml_sys_isatty(_chan) {
  return 0;
}

//Provides: caml_runtime_variant
export function caml_runtime_variant(_unit) {
  return caml_string_of_jsbytes("");
}
//Provides: caml_runtime_parameters
export function caml_runtime_parameters(_unit) {
  return caml_string_of_jsbytes("");
}

//Provides: caml_install_signal_handler const
export function caml_install_signal_handler() {
  return 0;
}
...
export function caml_ml_runtime_warnings_enabled(_unit) {
  return caml_runtime_warnings;
}

//Provides: caml_sys_const_naked_pointers_checked const (const)
export function caml_sys_const_naked_pointers_checked(_unit) {
  return 0;
}
