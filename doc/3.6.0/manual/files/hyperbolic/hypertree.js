   ...
   {"use strict";
    ...
    var
     ...
     public_methods=
      [0,
       ...
       caml_string_of_jsbytes("reload"),
       caml_string_of_jsbytes("replace")],
     s$0=caml_string_of_jsbytes("3.6.0"),
     git_version=caml_string_of_jsbytes("251a37a45"),
     languages=
      [0,
       [0,
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _le_=1;return _le_}
       catch(_lf_)
        {_lf_ = caml_wrap_exception(_lf_);
         if(_lf_ === Not_found)return 0;
         throw _lf_}
      return invalid_arg(_o_)}
    function contains(s,c){return contains_from(s,0,c)}
    function iter$0(f,a)
     {var _lc_=a.length - 1 - 1 | 0,_lb_=0;
      if(! (_lc_ < 0))
       {var i=_lb_;
        for(;;)
         {caml_call1(f,a[1 + i]);
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_k$_=l - 1 | 0,_k__=1;
      if(! (_k$_ < 1))
       {var i=_k__;
        for(;;)
    ...
    function fold_left(f,x,a)
     {var r=[0,x],_k8_=a.length - 1 - 1 | 0,_k7_=0;
      if(! (_k8_ < 0))
       {var i=_k7_;
        for(;;)
    ...
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_k6_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_k6_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_k1_=height(lr);
            if(_k1_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _k2_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_k2_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_k3_=height(rl);
            if(_k3_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _k4_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_k4_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _k5_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_k5_]}
      var empty=0;
         ...
         {var _kX_=param[1];
          if(_kX_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_kX_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_u_)}
      function _kA_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
            ...
            if(_kU_)
             {var _kV_=for_all(p,l);
              if(_kV_){var param$0=r;continue}
              var _kW_=_kV_}
            else
             var _kW_=_kU_;
            return _kW_}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _kN_=merge(f,r1,r2),
             _kO_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_kO_,_kN_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _kP_=merge(f,r1$0,r2$0),
           _kQ_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_kQ_,_kP_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _kL_=concat(lf,rf);return [0,join(lt,v,d,rt),_kL_]}
          var _kM_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_kM_]}
        return _x_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _kI_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_kI_)
               {var _kJ_=caml_call2(cmp,d1,d2);
                if(_kJ_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_kH_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _kH_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_kF_=cons_enum(t,rest);
          return [0,[0,k,v],function(_kG_){return seq_of_enum(_kF_,_kG_)}]}
        return 0}
      function to_seq(m)
       {var _kD_=cons_enum(m,0);
        return function(_kE_){return seq_of_enum(_kD_,_kE_)}}
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_jS_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_jS_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_jT_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_jT_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_jU_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_jU_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_jV_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_jV_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_jW_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_jW_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_jX_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_jX_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_jY_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_jY_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_jZ_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_jZ_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_j0_=ty1[2],_j1_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_j2_=trans(_j0_,rest2$7);
              return [8,trans(_j1_,ty2),_j2_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_j3_=ty1[3],_j4_=ty1[2],_j5_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_j4_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_j5_,ty22,trans(_j3_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_j6_,rest2$9)]}
          throw [0,Assert_failure,_al_];
         case 11:
          var switch$11=0,_j7_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_j7_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_am_];
          break;
         case 12:
          var switch$12=0,_j8_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_j8_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_an_];
          break;
         case 13:
          var switch$13=0,_j9_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_j9_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ao_];
          break;
         default:
          var switch$14=0,_j__=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_j__,rest2$13)];
             default:switch$14 = 1}
         ...
         case 4:
          ...
          if(typeof _jE_ !== "number" && 2 === _jE_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_jD_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _jG_ !== "number" && 3 === _jG_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_jF_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
          ...
          if(typeof _jI_ !== "number" && 4 === _jI_[0])
           {var
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_jH_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _jK_=match$11[3],
           _jJ_=match$11[1];
          if(typeof _jK_ !== "number" && 5 === _jK_[0])
           {var
             fmtty_rest$6=_jK_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_jJ_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
          ...
          if(typeof _jM_ !== "number" && 6 === _jM_[0])
           {var
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_jL_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _jO_=match$15[2],
           _jN_=match$15[1];
          if(typeof _jO_ !== "number" && 7 === _jO_[0])
           {var
             fmtty_rest$8=_jO_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_jN_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _jP_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_jP_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _jQ_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_jQ_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_jQ_[1];
              ...
              if(32 <= match)
               {var _jr_=match - 34 | 0,switch$2=0;
                if(58 < _jr_ >>> 0)
                 ...
                 if(56 < (_jr_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _jf_=_as_;break;
        ...
        case 9:var _jf_=_aA_;break;
        case 10:var _jf_=_aB_;break;
        case 11:var _jf_=_aC_;break;
        case 0:
        case 13:var _jf_=_ar_;break;
        case 3:
        case 14:var _jf_=_au_;break;
        default:var _jf_=_aD_}
      return transform_int_alt(iconv,caml_format_int(_jf_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _je_=_aS_;break;
        case 2:var _je_=_aT_;break;
        case 4:var _je_=_aV_;break;
        case 5:var _je_=_aW_;break;
        case 6:var _je_=_aX_;break;
        case 7:var _je_=_aY_;break;
        case 8:var _je_=_aZ_;break;
        case 9:var _je_=_a0_;break;
        case 10:var _je_=_a1_;break;
        case 11:var _je_=_a2_;break;
        case 0:
        case 13:var _je_=_aR_;break;
        case 3:
        case 14:var _je_=_aU_;break;
        default:var _je_=_a3_}
      return transform_int_alt(iconv,caml_format_int(_je_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _jd_=_a5_;break;
        case 2:var _jd_=_a6_;break;
        case 4:var _jd_=_a8_;break;
        case 5:var _jd_=_a9_;break;
        case 6:var _jd_=_a__;break;
        case 7:var _jd_=_a$_;break;
        case 8:var _jd_=_ba_;break;
        case 9:var _jd_=_bb_;break;
        case 10:var _jd_=_bc_;break;
        case 11:var _jd_=_bd_;break;
        case 0:
        case 13:var _jd_=_a4_;break;
        case 3:
        case 14:var _jd_=_a7_;break;
        default:var _jd_=_be_}
    ...
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _jc_=_aF_;break;
        ...
        case 0:
        case 13:var _jc_=_aE_;break;
        case 3:
        case 14:var _jc_=_aH_;break;
          ...
          {if(i$0 === len)
            ...
            {var
             ...
             if(23 < _i$_ >>> 0)
              ...
              if(21 < (_i$_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _ja_=1}
           var _jb_=_ja_?str:symbol(str,_bf_);
            ...
            {var i=_i6_;
             for(;;)
              {var c=caml_bytes_unsafe_get(s,i),switch$1=0;
               if(97 <= c && ! (122 < c)){var _i8_=c - 32 | 0;switch$1 = 1}
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_iY_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_iY_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _iV_=[8,acc,_bp_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iV_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_iV_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iU_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_iU_,rest])}
       ...
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          ...
          _iJ_=field(e,1),
          _iL_=caml_call2(sprintf(_bz_),_iJ_,_iI_);
        else
         switch(match)
          {case 0:var _iL_=_bA_;break;
           case 1:var _iL_=_bB_;break;
           default:var _iK_=field(e,1),_iL_=caml_call1(sprintf(_bC_),_iK_)}
        return symbol(constructor,_iL_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _iG_=a.length - 1 - 1 | 0,_iF_=0;
        if(! (_iG_ < 0))
         {var i=_iF_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _iz_=slot[4],
              _iA_=slot[3],
              _iB_=slot[6]?_bM_:_bO_,
              _iC_=slot[2],
              _iD_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bN_),_iD_,_iC_,_iB_,_iA_,_iz_,_iy_)];
            else
             if(slot[1])
              var match=0;
             else
              var _iE_=info(0),match=[0,caml_call1(sprintf(_bP_),_iE_)];
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _iu_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_iu_;continue}
           var accu=[0,_bS_],_iq_=54 + max(55,l) | 0,_ip_=0;
           if(! (_iq_ < 0))
            {var i=_ip_;
             for(;;)
              {var
               ...
               var
                _ir_=accu[1],
                _il_=caml_string_get(_ir_,3) << 24,
                _im_=caml_string_get(_ir_,2) << 16,
                _in_=caml_string_get(_ir_,1) << 8,
                _io_=
                 ((caml_string_get(_ir_,0) + _in_ | 0) + _im_ | 0)
                 +
                 _il_
                 |
                 0,
                _is_=
                 ...
                 &
                 1073741823;
               caml_check_bound(result[1],j)[1 + j] = _is_;
               var _it_=i + 1 | 0;
               if(_iq_ !== i){var i=_it_;continue}
               break}}
           result[2] = 0;
           return result}}];
     ...
     {if(opt)var sth=opt[1],random=sth;else var random=randomized_default;
      ...
      for(;;)
       {if(! (initial_size <= x) && ! (max_array_length < (x * 2 | 0)))
        ...
        if(random)
         {var
           _ij_=caml_obj_tag(prng),
           _ik_=250 === _ij_?prng[1]:246 === _ij_?force_lazy_block(prng):prng;
          _ik_[2] = (_ik_[2] + 1 | 0) % 55 | 0;
          var
           _ig_=_ik_[2],
           curval=caml_check_bound(_ik_[1],_ig_)[1 + _ig_],
           _ih_=(_ik_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_ik_[1],_ih_)[1 + _ih_]
            +
           ...
           _ii_=_ik_[2];
          caml_check_bound(_ik_[1],_ii_)[1 + _ii_] = newval30;
          var seed=newval30}
        else
         var seed=0;
    ...
    function find$0(h,key)
     {var _if_=indexfun(h,key),match=caml_check_bound(h[2],_if_)[1 + _if_];
      if(match)
    ...
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_h4_=len < new_size?1:0;
      if(_h4_)
       {var a2=caml_make_vect(new_size,dummy_met),_h5_=array[2],switch$0=0;
        if
         (0
          <=
          len
          &&
          !
          ((_h5_.length - 1 - len | 0) < 0)
          &&
          !
          ((a2.length - 1 - len | 0) < 0))
         {caml_array_blit(_h5_,0,a2,0,len);switch$0 = 1}
    ...
    function get_method_label(table,name)
     {try
       {var _h2_=caml_call2(Meths[27],name,table[3]);return _h2_}
      catch(_h3_)
    ...
    function iter$1(x,f)
     {var _hZ_=1 - (x == no_handler?1:0);return _hZ_?caml_call1(f,x):_hZ_}
    function case$0(x,f,g)
     {return x == no_handler?caml_call1(f,0):caml_call1(g,x)}
    function test$0(x){return x !== undefined$0?1:0}
    function iter$2(x,f)
     {var _hY_=x !== undefined$0?1:0;return _hY_?caml_call1(f,x):_hY_}
      ...
      if(e.addEventListener === undefined$0)
       {var
         ...
         callback=
          function(e)
           {var _hV_=[0,h,e,[0]];
            return function(_hW_,_hX_){return caml_js_call(_hV_,_hW_,_hX_)}};
    ...
    function unsafeCreateElementEx(type,name,doc,elt)
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        var _hP_=createElementSyntax[1];
        if(785140586 === _hP_)
         {try
           {var
             el=document.createElement('<input name="x">'),
             _hS_=el.tagName.toLowerCase() === "input"?1:0,
             _hT_=_hS_?el.name === "x"?1:0:_hS_,
             _hQ_=_hT_}
          catch(_hU_){var _hQ_=0}
          var _hR_=_hQ_?982028505:-1003883683;
          createElementSyntax[1] = _hR_;
          continue}
        if(982028505 <= _hP_)
    ...
    function stopPropagation(ev)
     {function _hN_(param){return ev.stopPropagation()}
      function _hO_(param){return ev.cancelBubble = true$0}
      return case$1(ev.stopPropagation,_hO_,_hN_)}
    var
         ...
         {var
          ...
          try
           {var
             ...
             _hL_=function(callback){return req(callback)};
            return _hL_}
          catch(_hM_)
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_hK_){throw [0,Assert_failure,_b9_]}}}}}
    function regexp(s)
    ...
    function path_of_path_string(s)
     {var l=caml_ml_string_length(s);
      function aux(i)
       {try
         {var _hB_=index_from(s,i,47),j=_hB_}
        catch(_hC_)
         {_hC_ = caml_wrap_exception(_hC_);
          if(_hC_ !== Not_found)throw _hC_;
          var j=l}
      ...
      if(a && ! caml_string_notequal(a[1],_cb_))
       {var _hA_=a[2];
        if(! _hA_)return 0;
        if(! caml_string_notequal(_hA_[1],_cc_) && ! _hA_[2])return _cd_}
      return a}
              ...
              function(s)
               {function _hy_(param)
                 {var
                   y=param[2],
                   x=param[1],
                   _hz_=urldecode_js_string_string(y);
                  return [0,urldecode_js_string_string(x),_hz_]}
                var index=s.indexOf(caml_jsstring_of_string(make$0(1,61)));
                if(index < 0)
                 var _hx_=undefined$0;
                else
                 var
                  _hw_=s.slice(index + 1 | 0),
                  _hx_=[0,s.slice(0,index),_hw_];
                return case$1(_hx_,interrupt,_hy_)},
             _hu_=aux([0,case$1(arr[idx$0],interrupt,_ht_),acc],_hs_);
            return _hu_}
          catch(_hv_)
     ...
     var
      ...
      _dc_=
       function
        ...
        {if(! _db_[1])
          {if(0 === public_methods)
            var _gW_=new_table([0]);
           else
            {var
              tags=map(public_method_label,public_methods),
              table=new_table(tags),
              _gS_=public_methods.length - 1 - 1 | 0,
              _gR_=0;
             if(! (_gS_ < 0))
              {var i=_gR_;
               for(;;)
             ...
             var _gW_=table}
           var
            _gX_=new_variable(_gW_,_dd_),
            _gU_=map(function(_hr_){return get_method_label(_gW_,_hr_)},names),
            _gY_=_gU_[1],
            _gZ_=_gU_[2],
            _g0_=_gU_[3],
            _g1_=_gU_[4],
            ...
            _g__=
             function(self_1)
              {var env=self_1[1 + _gX_];return caml_call1(env[2],env[1])},
            _g$_=
             function(self_1)
              {var env=self_1[1 + _gX_];return caml_call1(env[3],env[1])},
            _ha_=
             function(self_1)
              {var env=self_1[1 + _gX_];return caml_call1(env[4],env[1])},
            _hb_=function(self_1){var env=self_1[1 + _gX_];return env[5]},
            _hc_=function(self_1){var env=self_1[1 + _gX_];return env[6]},
            _hd_=function(self_1){var env=self_1[1 + _gX_];return env[7]},
            _he_=function(self_1){var env=self_1[1 + _gX_];return env[8]},
            _hf_=function(self_1){var env=self_1[1 + _gX_];return env[9]},
            _hg_=function(self_1){var env=self_1[1 + _gX_];return env[10]},
            _hh_=function(self_1){var env=self_1[1 + _gX_];return env[11]},
            _hi_=function(self_1){var env=self_1[1 + _gX_];return env[12]},
            methods=
             [0,
              _g5_,
              function(self_1){var env=self_1[1 + _gX_];return env[13]},
              _g1_,
              _hi_,
              _g7_,
              _hh_,
              ...
              {var
                ...
                next=
                 function(param)
                  {i$0[1]++;
                   var _hq_=i$0[1];
                   return caml_check_bound(methods,_hq_)[1 + _hq_]},
                clo=next(0);
                  ...
                  case 19:
                   var
                    ...
                    clo$0=
                     function(n,m)
                       {return function(obj)
                         {var _ho_=caml_call1(obj[1][1 + m],obj);
                          return caml_call2(obj[1][1 + n],obj,_ho_)}}
                      (n$15,m$1);
                   break;
                  case 20:
                   var
                  ...
                  default:
                   var
                    ...
                    clo$0=
                     function(m,n,c)
                       {return function(obj)
                         {var _hp_=caml_call1(obj[1][1 + n],obj);
                          return caml_call2(caml_get_public_method(_hp_,m,0),_hp_,c)}}
                      (m$5,n$18,c$2)}
               else
                var clo$0=clo;
               method_count[1]++;
               if(caml_call2(Labs[27],label,_gW_[4]))
                {resize$0(_gW_,label + 1 | 0);
                 caml_check_bound(_gW_[2],label)[1 + label] = clo$0}
               else
                _gW_[6] = [0,[0,label,clo$0],_gW_[6]];
               i$0[1]++;
               continue}
             var
              _hj_=
               function(_hl_)
                {var obj=caml_obj_block(248,_gW_[1]);
                 obj[1] = _gW_[2];
                 var _hk_=caml_set_oo_id(obj);
                 _hk_[1 + _gX_] = _hl_;
                 return _hk_};
             inst_var_count[1] = (inst_var_count[1] + _gW_[1] | 0) - 1 | 0;
             var l1=_gW_[8],l2=0;
             for(;;)
              {if(l1)
               ...
               resize$0
                (_gW_,
                 3 + ((caml_check_bound(_gW_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
               _db_[1] = _hj_;
               break}
             break}}
         return caml_call1
                 (_db_[1],
                  [0,
                   ...
                   protocol,
                   href])},
      _de_=function(param,_gQ_){return 0},
      _df_=function(param,_gP_){return 0},
    ...
    try
     ...
     {_gO_ = caml_wrap_exception(_gO_);if(_gO_[1] !== Failure)throw _gO_}
     ...
     {var _gN_=p[1];
      switch(_gN_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_gN_[1],p$1=underlying(p$0);
    ...
    function add_implicitly_removed_callbac(callbacks,f)
     {var
       node$0=[1,f],
       _gM_=callbacks[1],
       node=typeof _gM_ === "number"?node$0:[0,node$0,_gM_];
      callbacks[1] = node;
      return 0}
    var
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _gL_=caml_call1(f,v);return _gL_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _gJ_=result[1] === Canceled?1:0,is_canceled=_gJ_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_gH_,0)}
      var _gI_=callbacks[1];
      ...
      return iter_callback_list$0(_gI_,0)}
    var
        ...
        {if(0 !== q[1])
          {var _gF_=q[2];
           if(_gF_)
            {var _gG_=_gF_[1];
             if(_gF_[2])
              {var next=_gF_[2];q[1] = q[1] - 1 | 0;q[2] = next}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             var result=_gG_[2],callbacks=_gG_[1];
    ...
    function wakeup_general(api_function_name,p,result)
     {var p$0=underlying(p),_gE_=p$0[1];
      switch(_gE_[0])
       {case 1:
         return _gE_[1] === Canceled
                 ?0
      ...
      switch(_gD_[0])
       {case 1:return resolve(_cq_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _gB_=p_callbacks[2],
          _gC_=outer_callbacks[2],
          cancel_callbacks=
           typeof _gC_ === "number"
            ?_gB_
            :typeof _gB_ === "number"?_gC_:[0,_gC_,_gB_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _gA_=caml_call1(f,v),p$0=_gA_}
       ...
       {case 1:return [0,_gy_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_cs_,function(param){return caml_call1(f,v)},_gz_)}}
    ...
    function poll(p)
     {var _gv_=underlying(p)[1];
      switch(_gv_[0])
       {case 1:var e=_gv_[1];throw e;
        case 2:return 0;
        default:var v=_gv_[1];return [0,v]}}
    var pause_hook=[0,function(_gu_){return 0}],s1=create$2(0),_cv_=[0,0];
    ...
    function yield$0(param)
     {var match=task(0),w=match[2],t=match[1],d=0.;
      function callback(_gs_){return wakeup(w,_gs_)}
      var id=[0,0];
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var cb=remain == 0.?callback:function(_gr_){return loop(remain,_gr_)};
      ...
      on_cancel
       (t,
        function(param)
         {var _gq_=id[1];
          if(_gq_){var x=_gq_[1];id[1] = 0;return window.clearTimeout(x)}
          return 0});
      return t}
    ...
    function compose(param,_gn_)
     {var
       ...
       _gm_=sdiv(c,norm(c));
      return [0,div(add$0(t2p1,p2),den),_gm_]}
    function compute_translation(z0,z1)
     {var dz=sub$1(z1,z0),z0z1=mul(z0,z1),_gl_=1. - sq_norm(z0z1);
      return sdiv(add$0(mul(z0z1,conj(dz)),dz),_gl_)}
    var json=JSON;
    function http_get(url)
     {var opt=[0,0];
      ...
      function headers$0(s)
       {function _gj_(v){return [0,caml_string_of_jsstring(v)]}
        function _gk_(param){return 0}
        return case$0
                (req.getResponseHeader(caml_jsbytes_of_string(s)),_gk_,_gj_)}
      var st=[0,382334108];
                ...
                _ge_=
                 function(param)
                  {var x=req.responseXML;
                   ...
                   var match=case$0(x,function(param){return 0},_gi_);
                   if(match)
                    {var doc=match[1];
                     return doc.documentElement === no_handler?0:[0,doc]}
                   return 0},
                _gf_=caml_string_of_jsstring,
                _gg_=function(param){return _cx_},
                response=
                 [0,
                  url,
                  code,
                  headers$0,
                  case$0(req.responseText,_gg_,_gf_),
                  _ge_];
    ...
    function load_messages(param)
     {function _f6_(s)
      ...
      return symbol_bind(getfile(_cB_),_f6_)}
       ...
       {var i=_f0_;
        for(;;)
         {var
           ...
           _f1_=caml_check_bound(ch,j)[1 + j];
          caml_check_bound(ch,i)[1 + i] = _f1_;
    ...
    function compute_text_nodes(node_names,nodes)
     {try
       ...
       {_fV_ = caml_wrap_exception(_fV_);
        ...
        var names=_fI_}
      try
       {var _fP_=find$0(names,_cI_),_fJ_=_fP_}
      catch(_fU_)
       {_fU_ = caml_wrap_exception(_fU_);
        if(_fU_ !== Not_found)throw _fU_;
        var _fJ_=_cH_}
      document.title = caml_jsstring_of_string(_fJ_);
             ...
             {var
              ...
              if(_fG_)
               {var
                 ...
                 nsize=osize * 2 | 0,
                 _fx_=nsize < max_array_length?1:0;
                if(_fx_)
                 {var
                      ...
                      for(;;)
                       {if(cell)
                         {var
                          ...
                          continue}
                        var _fF_=i$0 + 1 | 0;
                        if(_fz_ !== i$0){var i$0=_fF_;continue a}
                        break}
                      break}}
                  if(inplace)
    ...
    function close_button(over)
     {var
      ...
      canvas.className = caml_jsstring_of_string(_eU_);
