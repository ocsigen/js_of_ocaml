...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     s$2=caml_string_of_jsbytes("3.6.0"),
    ...
    var
     ...
     _ca_=caml_string_of_jsbytes("Js_of_ocaml__Url.Local_exn"),
     _ce_=
      caml_string_of_jsbytes
     ...
     _cq_=[0,0],
     _cr_=[0,0],
     _cp_=caml_string_of_jsbytes("wakeup_exn"),
     _co_=caml_string_of_jsbytes("wakeup"),
     _cl_=
      [0,
     ...
     _cm_=
      [0,
       ...
       caml_string_of_jsbytes("Lwt.%s")],
     _cn_=[0,0],
     _cj_=caml_string_of_jsbytes("Fatal error: exception "),
     _ck_=caml_string_of_jsbytes("Lwt.Resolution_loop.Canceled"),
     _cy_=caml_string_of_jsbytes(""),
     _cx_=
      caml_string_of_jsbytes
       ("Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers"),
     _cz_=caml_string_of_jsbytes("Exception during Lwt.async: "),
     _cC_=[0,0,0],
     _cF_=
      [0,
     ...
     _c5_=[0,1.],
     _c6_=[0,20.],
     _c8_=caml_string_of_jsbytes("scene.json"),
     _cH_=
    ...
    function iteri(f,a)
     {var _hP_=a.length - 1 - 1 | 0,_hO_=0;
      if(! (_hP_ < 0))
       {var i=_hO_;
        for(;;)
    ...
    function _A_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_hN_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_hN_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_hI_=height(lr);
            if(_hI_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _hJ_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_hJ_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_hK_=height(rl);
            if(_hK_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _hL_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_hL_)}
            return invalid_arg(_u_)}
          return invalid_arg(_v_)}
        var _hM_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_hM_]}
      var empty=0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hG_=param$0[1];
            if(_hG_){var param$0=_hG_;continue}
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hF_=param$0[1];
            if(_hF_){var param$0=_hF_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
         ...
         {var _hE_=param[1];
          if(_hE_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_hE_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_w_)}
      function _hh_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _hB_=caml_call2(p,v,d);
            if(_hB_)
             {var _hC_=for_all(p,l);
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _hu_=merge(f,r1,r2),
             _hv_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_hv_,_hu_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _hw_=merge(f,r1$0,r2$0),
           _hx_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_hx_,_hw_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _hs_=concat(lf,rf);return [0,join(lt,v,d,rt),_hs_]}
          var _ht_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_ht_]}
        return _z_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _hp_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_hp_)
               {var _hq_=caml_call2(cmp,d1,d2);
                if(_hq_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_ho_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _ho_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_hm_=cons_enum(t,rest);
          return [0,[0,k,v],function(_hn_){return seq_of_enum(_hm_,_hn_)}]}
        return 0}
      function to_seq(m)
       {var _hk_=cons_enum(m,0);
        return function(_hl_){return seq_of_enum(_hk_,_hl_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _hi_=c;
          return function(_hj_){return seq_of_enum(_hi_,_hj_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_hg_=q[3];
      return _hg_
              ?(q[1] = q[1] + 1 | 0,_hg_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_gz_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_gz_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_gA_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_gA_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_gB_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_gB_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_gC_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_gC_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_gD_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_gD_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_gE_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_gE_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_gF_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_gF_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_gG_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_gG_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_gH_=ty1[2],_gI_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_gJ_=trans(_gH_,rest2$7);
              return [8,trans(_gI_,ty2),_gJ_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_gK_=ty1[3],_gL_=ty1[2],_gM_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_gL_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_gM_,ty22,trans(_gK_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_gN_,rest2$9)]}
          throw [0,Assert_failure,_am_];
         case 11:
          var switch$11=0,_gO_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_gO_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_an_];
          break;
         case 12:
          var switch$12=0,_gP_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_gP_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ao_];
          break;
         case 13:
          var switch$13=0,_gQ_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_gQ_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ap_];
          break;
         default:
          var switch$14=0,_gR_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_gR_,rest2$13)];
             default:switch$14 = 1}
       ...
       {if(prec)
         {var _gy_=match[2];
          if(typeof _gy_ !== "number" && 2 === _gy_[0])
           {var rest=_gy_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 4:
          ...
          if(typeof _gl_ !== "number" && 2 === _gl_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_gk_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _gn_ !== "number" && 3 === _gn_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_gm_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
          ...
          if(typeof _gp_ !== "number" && 4 === _gp_[0])
           {var
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_go_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _gr_=match$11[3],
           _gq_=match$11[1];
          if(typeof _gr_ !== "number" && 5 === _gr_[0])
           {var
             fmtty_rest$6=_gr_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_gq_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _gt_=match$13[3],
           _gs_=match$13[1];
          if(typeof _gt_ !== "number" && 6 === _gt_[0])
           {var
             fmtty_rest$7=_gt_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_gs_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _gv_=match$15[2],
           _gu_=match$15[1];
          if(typeof _gv_ !== "number" && 7 === _gv_[0])
           {var
             fmtty_rest$8=_gv_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_gu_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _gx_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_gx_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_gx_[1];
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _gb_ >>> 0)
           {if(33 < (_gb_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _gb_)switch$0 = 1;
           ...
           {var i$0=_f5_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _f__=match - 34 | 0,switch$2=0;
                if(58 < _f__ >>> 0)
                 {if(93 <= _f__)switch$2 = 1}
                else
                 if(56 < (_f__ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
             ...
             var _fT_=1}
           var _fU_=_fT_?str:symbol(str,_bg_);
            ...
            {var i=_fN_;
             for(;;)
              {var c=caml_bytes_unsafe_get(s,i),switch$1=0;
               if(97 <= c && ! (122 < c)){var _fP_=c - 32 | 0;switch$1 = 1}
               if(! switch$1)var _fP_=c;
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_fL_,_fK_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_fL_,_fK_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_fL_,_fK_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _fM_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_fM_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_fM_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_fM_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
            ...
            {if(0 === pad$5[0])
              {var _fG_=pad$5[2],_fH_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_fH_,_fG_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_fH_,_fG_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_fH_,_fG_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _fI_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_fI_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_fI_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_fI_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _fJ_=type_format_gen(fmt$0,fmtty$0);
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_fF_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_fF_])}}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _by_;
      ...
      return caml_call2(sprintf(_bz_),_fv_,_fu_)}
       ...
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          ...
          _fq_=field(e,1),
          _fs_=caml_call2(sprintf(_bA_),_fq_,_fp_);
        else
         switch(match)
          {case 0:var _fs_=_bB_;break;
           case 1:var _fs_=_bC_;break;
           default:var _fr_=field(e,1),_fs_=caml_call1(sprintf(_bD_),_fr_)}
        return symbol(constructor,_fs_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _fn_=a.length - 1 - 1 | 0,_fm_=0;
        if(! (_fn_ < 0))
         {var i=_fm_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _fg_=slot[4],
              _fh_=slot[3],
              _fi_=slot[6]?_bN_:_bP_,
              _fj_=slot[2],
              _fk_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bO_),_fk_,_fj_,_fi_,_fh_,_fg_,_ff_)];
            else
             if(slot[1])
              var match=0;
             else
              var _fl_=info(0),match=[0,caml_call1(sprintf(_bQ_),_fl_)];
    ...
    function f(s)
     {var accu=[0,0],_fc_=caml_ml_string_length(s) - 1 | 0,_fb_=0;
      if(! (_fc_ < 0))
       {var i=_fb_;
        for(;;)
         {var _fd_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _fd_ | 0;
          var _fe_=i + 1 | 0;
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _e7_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _e7_;
      var _e9_=len - 1 | 0,_e8_=0;
      if(! (_e9_ < 0))
       {var i=_e8_;
        for(;;)
         {var
           _e$_=(i * 2 | 0) + 3 | 0,
           _e__=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_e$_)[1 + _e$_] = _e__;
          var _fa_=i + 1 | 0;
          if(_e9_ !== i){var i=_fa_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_e4_=len < new_size?1:0;
      if(_e4_)
       {var a2=caml_make_vect(new_size,dummy_met),_e5_=array[2],switch$0=0;
        if
         (0
          <=
          len
          &&
          !
          ((_e5_.length - 1 - len | 0) < 0)
          &&
          !
          ((a2.length - 1 - len | 0) < 0))
         {caml_array_blit(_e5_,0,a2,0,len);switch$0 = 1}
    ...
    function get_method_label(table,name)
     {try
       {var _e2_=caml_call2(Meths[27],name,table[3]);return _e2_}
      catch(_e3_)
    ...
    function new_variable(table,name)
     {try
       {var _e0_=caml_call2(Vars[27],name,table[7]);return _e0_}
      catch(_e1_)
     ...
     {if(e.addEventListener === t37)
       {var
         ...
         callback=
          function(e)
           {var _eX_=[0,h,e,[0]];
            return function(_eY_,_eZ_){return caml_js_call(_eX_,_eY_,_eZ_)}};
         ...
         {var
          ...
          try
           {var
             ...
             _eV_=function(callback){return req(callback)};
            return _eV_}
          catch(_eW_)
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_eU_){throw [0,Assert_failure,_b__]}}}}}
    function regexp(s)
    ...
    if(test$0(window.location))
     ...
     var
      t40=function(param,_eM_){return 0},
      t39=function(param,_eL_){return 0},
    ...
    (function(param)
       {try
         {var _eJ_=[0,caml_int_of_string(caml_string_of_jsbytes(_cg_.port))];
          return _eJ_}
        catch(_eK_)
         {_eK_ = caml_wrap_exception(_eK_);
          if(_eK_[1] === Failure)return 0;
          throw _eK_}}
      (_ch_));
    var
    ...
    function aux(i)
     {try
       {var _eH_=index_from(s$1,i,47),j=_eH_}
      catch(_eI_)
    ...
    if(a$0 && ! caml_string_notequal(a$0[1],_cb_))
     {var _cc_=a$0[2];
      if(! _cc_ || ! caml_string_notequal(_cc_[1],_cd_) && ! _cc_[2])
       switch$0 = 1}
    var
     _ci_=_cg_.search.charAt(0) === "?"?_cg_.search.slice(1):_cg_.search,
     arr=_ci_.split(caml_jsstring_of_string(make$0(1,38))),
     len$0=arr.length;
        ...
        try
         {var
           ...
           _eA_=
            function(s)
             {function _eF_(param)
               {var y=param[2],x=param[1],_eG_=urldecode_js_string_string(y);
                return [0,urldecode_js_string_string(x),_eG_]}
              var index=s.indexOf(caml_jsstring_of_string(make$0(1,61)));
              if(index < 0)
               var _eE_=t37;
              else
               var _eD_=s.slice(index + 1 | 0),_eE_=[0,s.slice(0,index),_eD_];
              return case$1(_eE_,interrupt,_eF_)},
           _eB_=aux$0([0,case$1(arr[idx$0],interrupt,_eA_),acc],_ez_);
          return _eB_}
        catch(_eC_)
         {_eC_ = caml_wrap_exception(_eC_);
          if(_eC_ === Local_exn){var idx$1=idx$0 - 1 | 0,idx$0=idx$1;continue}
          throw _eC_}}}
    aux$0(0,len$0 - 1 | 0);
     ...
     {var _ey_=p[1];
      switch(_ey_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_ey_[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _ex_=caml_call1(f,v);return _ex_}
      catch(exn)
     ...
     {if(1 === result[0])
      ...
      if(is_canceled)
       {var
        ...
        iter_callback_list(_et_,0)}
      var _eu_=callbacks[1];
      ...
      return iter_callback_list$0(_eu_,0)}
    var
      ...
      for(;;)
       {if(param)
        ...
        var
         headers$0=
          function(s)
           {function _d1_(v){return [0,caml_string_of_jsstring(v)]}
        ...
        handler
         (function(param)
           {var page=doc.documentElement;
            ...
            function _c$_(s)
             {var
               _da_=json.parse(caml_jsstring_of_string(s)),
               scene=_da_[3],
               bboxes=_da_[2],
               match=_da_[1],
               y2=match[4],
              ...
              function points(d)
               {return caml_jsstring_of_string(caml_call1(sprintf(_c7_),d))}
              var
               size_px=points(size),
               pos=[0,height],
               thumb=createDiv(doc),
