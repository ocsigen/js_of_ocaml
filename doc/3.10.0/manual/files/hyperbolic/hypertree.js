...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _bV_=caml_string_of_jsbytes("Hashtbl: unsupported hash table format"),
     _dj_=caml_string_of_jsbytes("OCAMLRUNPARAM"),
     _dh_=caml_string_of_jsbytes("CAMLRUNPARAM"),
     _bT_=caml_string_of_jsbytes(""),
     _bW_=caml_string_of_jsbytes(""),
     _bX_=caml_string_of_jsbytes("Js_of_ocaml__Js.Error"),
     _bY_=caml_string_of_jsbytes("jsError"),
     _b9_=caml_string_of_jsbytes("canvas"),
     _b7_=caml_string_of_jsbytes("dt"),
     _b6_=caml_string_of_jsbytes("dd"),
     _b5_=caml_string_of_jsbytes("img"),
     _b4_=caml_string_of_jsbytes("a"),
     _b3_=caml_string_of_jsbytes("div"),
     _b2_=caml_string_of_jsbytes("li"),
     _b1_=caml_string_of_jsbytes("dl"),
     _b0_=caml_string_of_jsbytes("ul"),
     _bZ_=caml_string_of_jsbytes("button"),
     ...
     _cd_=[0,caml_string_of_jsbytes(""),0],
     ...
     _c8_=caml_string_of_jsbytes("info-38.png"),
     _c9_=caml_string_of_jsbytes("globe-38.png"),
     _c__=caml_string_of_jsbytes("meeting-point-38.png"),
     _c$_=caml_string_of_jsbytes("ocsigen-powered.png"),
     _c1_=caml_string_of_jsbytes(".wikipedia.org/wiki/"),
     _c2_=caml_string_of_jsbytes("http://"),
     _cW_=caml_string_of_jsbytes("px"),
     _c4_=caml_string_of_jsbytes(".jpg"),
     _c5_=caml_string_of_jsbytes("images/"),
     _cX_=caml_string_of_jsbytes(""),
     _c3_=caml_string_of_jsbytes("?uselang="),
     _cY_=caml_string_of_jsbytes("http://commons.wikimedia.org/wiki/File:"),
     _cZ_=caml_string_of_jsbytes("commons-38.png"),
     _c0_=caml_string_of_jsbytes("wikipedia-38.png"),
     _cP_=caml_string_of_jsbytes("px"),
     _cQ_=caml_string_of_jsbytes("px 3px"),
     _cR_=caml_string_of_jsbytes("px 3px "),
     _cS_=caml_string_of_jsbytes("on"),
     _cU_=caml_string_of_jsbytes("off"),
     _cT_=caml_string_of_jsbytes("filled_button "),
     _cV_=caml_string_of_jsbytes("px"),
     _cN_=caml_string_of_jsbytes("on"),
     _cO_=caml_string_of_jsbytes("off"),
     _cM_=caml_string_of_jsbytes("image_info.json"),
     _cK_=[0,0,0,0.],
     _cL_=[254,-1.,0.],
     _cJ_=[0,caml_string_of_jsbytes("examples/hyperbolic/hypertree.ml"),987,2],
     _cI_=caml_string_of_jsbytes("<TITLE>"),
     _cH_=caml_string_of_jsbytes(""),
     _cC_=caml_string_of_jsbytes(".jpg"),
     _cD_=caml_string_of_jsbytes("thumbnails/"),
     _cB_=caml_string_of_jsbytes("messages.json"),
     _cz_=caml_string_of_jsbytes("icons/"),
    ...
    if(caml_sys_const_naked_pointers_checked(0))
     at_exit(function(_ld_){return caml_gc_major(_ld_)});
    var
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _lb_=1;return _lb_}
       catch(_lc_)
        {_lc_ = caml_wrap_exception(_lc_);
         if(_lc_ === Not_found)return 0;
         throw _lc_}
      return invalid_arg(_o_)}
    function contains(s,c){return contains_from(s,0,c)}
    function iter$0(f,a)
     {var _k$_=a.length - 1 - 1 | 0,_k__=0;
      if(! (_k$_ < 0))
       {var i=_k__;
        for(;;)
         {caml_call1(f,a[1 + i]);
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_k8_=l - 1 | 0,_k7_=1;
      if(! (_k8_ < 1))
       {var i=_k7_;
        for(;;)
    ...
    function fold_left(f,x,a)
     {var r=[0,x],_k5_=a.length - 1 - 1 | 0,_k4_=0;
      if(! (_k5_ < 0))
       {var i=_k4_;
        for(;;)
    ...
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_k3_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_k3_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_kY_=height(lr);
            if(_kY_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _kZ_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_kZ_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_k0_=height(rl);
            if(_k0_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _k1_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_k1_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _k2_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
         ...
         {var _kU_=param[1];
          if(_kU_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_kU_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_u_)}
      function _kt_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _kR_=caml_call2(p,v,d);
            if(_kR_)
             {var _kS_=for_all(p,l);
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _kK_=merge(f,r1,r2),
             _kL_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_kL_,_kK_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _kM_=merge(f,r1$0,r2$0),
           _kN_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_kN_,_kM_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _kI_=concat(lf,rf);return [0,join(lt,v,d,rt),_kI_]}
          var _kJ_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_kJ_]}
        return _x_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _kF_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_kF_)
               {var _kG_=caml_call2(cmp,d1,d2);
                if(_kG_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_kE_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _kE_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_kC_=cons_enum(t,rest);
          return [0,[0,k,v],function(_kD_){return seq_of_enum(_kC_,_kD_)}]}
        return 0}
      function to_seq(m)
       {var _kA_=cons_enum(m,0);
      ...
      function rev_seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_ky_=snoc_enum(t,rest);
          return [0,[0,k,v],function(_kz_){return rev_seq_of_enum(_ky_,_kz_)}]}
        return 0}
      function to_rev_seq(c)
       {var _kw_=snoc_enum(c,0);
        return function(_kx_){return rev_seq_of_enum(_kw_,_kx_)}}
    ...
    function add(x,q)
     {var cell=[0,x,0],_ks_=q[3];
      return _ks_
              ?(q[1] = q[1] + 1 | 0,_ks_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_j9_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_j9_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_j__=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_j__,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_j$_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_j$_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_ka_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_ka_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_kb_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_kb_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_kc_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_kc_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_kd_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_kd_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_ke_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_ke_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_kf_=ty1[2],_kg_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_kh_=trans(_kf_,rest2$7);
              return [8,trans(_kg_,ty2),_kh_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_ki_=ty1[3],_kj_=ty1[2],_kk_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_kj_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_kk_,ty22,trans(_ki_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_kl_,rest2$9)]}
          throw [0,Assert_failure,_al_];
         case 11:
          var switch$11=0,_km_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_km_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_am_];
          break;
         case 12:
          var switch$12=0,_kn_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_kn_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_an_];
          break;
         case 13:
          var switch$13=0,_ko_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_ko_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ao_];
          break;
         default:
          var switch$14=0,_kp_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_kp_,rest2$13)];
             default:switch$14 = 1}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         ...
         _jN_=function(param){return 0};
        return [0,function(param){return 0},_jN_,_jM_,_jL_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _jO_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_jO_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _jP_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _jQ_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _jR_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _jS_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _jT_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _jU_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _jV_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _jW_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _jX_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _jY_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _jZ_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _j0_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _j1_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _j2_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _j3_=function(param){caml_call1(de$12,0);return 0},
           _j4_=function(param){caml_call1(ed$12,0);return 0},
           _j5_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _j6_=function(param){caml_call1(de$13,0);return 0},
           _j7_=function(param){caml_call1(ed$13,0);return 0},
           _j8_=function(param){caml_call1(af$13,0);return 0};
          return [0,
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _jI_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_jI_))
             throw Type_mismatch;
            var _jJ_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_jJ_))
             throw Type_mismatch;
            var
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _jn_ >>> 0)
           {if(33 < (_jn_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _jn_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _jg_=caml_ml_bytes_length(s$0) - 1 | 0,
           _jf_=0;
          if(! (_jg_ < 0))
           {var i$0=_jf_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _jk_=match - 34 | 0,switch$2=0;
                if(58 < _jk_ >>> 0)
                 {if(93 <= _jk_)switch$2 = 1}
                else
                 if(56 < (_jk_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _jl_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _jl_=4;break;case 1:var _jl_=2;break}
              n[1] = n[1] + _jl_ | 0;
              var _jm_=i$0 + 1 | 0;
              if(_jg_ !== i$0){var i$0=_jm_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _ji_=caml_ml_bytes_length(s$0) - 1 | 0,_jh_=0;
            if(! (_ji_ < 0))
             {var i=_jh_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _jo_=s}
          var str$0=caml_string_of_bytes(_jo_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_ja_=caml_ml_string_length(s) - 1 | 0,_i$_=0;
        if(! (_ja_ < 0))
         {var i$0=_i$_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _je_=i$0 + 1 | 0;
            if(_ja_ !== i$0){var i$0=_je_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _jc_=caml_ml_string_length(s) - 1 | 0,
         _jb_=0;
        if(! (_jc_ < 0))
         {var i=_jb_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _i__=_as_;break;
        case 2:var _i__=_at_;break;
        case 4:var _i__=_av_;break;
        case 5:var _i__=_aw_;break;
        case 6:var _i__=_ax_;break;
        case 7:var _i__=_ay_;break;
        case 8:var _i__=_az_;break;
        case 9:var _i__=_aA_;break;
        case 10:var _i__=_aB_;break;
        case 11:var _i__=_aC_;break;
        case 0:
        case 13:var _i__=_ar_;break;
        case 3:
        case 14:var _i__=_au_;break;
        default:var _i__=_aD_}
    ...
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _i9_=_aS_;break;
        ...
        case 9:var _i9_=_a0_;break;
        case 10:var _i9_=_a1_;break;
        case 11:var _i9_=_a2_;break;
        case 0:
        case 13:var _i9_=_aR_;break;
        case 3:
        case 14:var _i9_=_aU_;break;
        default:var _i9_=_a3_}
      return transform_int_alt(iconv,caml_format_int(_i9_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _i8_=_a5_;break;
        case 2:var _i8_=_a6_;break;
        case 4:var _i8_=_a8_;break;
        case 5:var _i8_=_a9_;break;
        case 6:var _i8_=_a__;break;
        case 7:var _i8_=_a$_;break;
        case 8:var _i8_=_ba_;break;
        case 9:var _i8_=_bb_;break;
        case 10:var _i8_=_bc_;break;
        case 11:var _i8_=_bd_;break;
        case 0:
        case 13:var _i8_=_a4_;break;
        case 3:
        case 14:var _i8_=_a7_;break;
        default:var _i8_=_be_}
      return transform_int_alt(iconv,caml_format_int(_i8_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _i7_=_aF_;break;
        case 2:var _i7_=_aG_;break;
        case 4:var _i7_=_aI_;break;
        case 5:var _i7_=_aJ_;break;
        case 6:var _i7_=_aK_;break;
        case 7:var _i7_=_aL_;break;
        case 8:var _i7_=_aM_;break;
        case 9:var _i7_=_aN_;break;
        case 10:var _i7_=_aO_;break;
        case 11:var _i7_=_aP_;break;
        case 0:
        case 13:var _i7_=_aE_;break;
        case 3:
        case 14:var _i7_=_aH_;break;
        default:var _i7_=_aQ_}
      return transform_int_alt(iconv,caml_int64_format(_i7_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _i4_ >>> 0)
              {if(55 === _i4_)switch$0 = 1}
             else
              if(21 < (_i4_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _i5_=1}
           var _i6_=_i5_?str:symbol(str,_bf_);
           return caml_special_val(_i6_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_i0_=l - 1 | 0,_iZ_=0;
           if(! (_i0_ < 0))
            {var i=_iZ_;
             for(;;)
              {var
                ...
                switcher=c - 97 | 0,
                _i1_=25 < switcher >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_i1_);
               var _i2_=i + 1 | 0;
               if(_i0_ !== i){var i=_i2_;continue}
               break}}
           var _i3_=r}
         return caml_string_of_bytes(_i3_);
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _iV_=pad$5[2],_iW_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_iW_,_iV_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_iW_,_iV_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_iW_,_iV_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _iX_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_iX_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_iX_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_iX_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _iY_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _iY_[2] === "number")
              {var fmt=_iY_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_iU_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_iU_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _iR_=[8,acc,_bp_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iR_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_iR_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iQ_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_iQ_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_iO_,_iN_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_iO_,_iN_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_iO_,_iN_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _iP_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_iP_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_iP_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_iP_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_iI_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_iI_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bx_;
      var _iG_=other_fields(x,i + 1 | 0),_iH_=field(x,i);
      return caml_call2(sprintf(_by_),_iH_,_iG_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _iB_=other_fields(e,2),
          _iC_=field(e,1),
          _iE_=caml_call2(sprintf(_bz_),_iC_,_iB_);
        else
         switch(match)
          {case 0:var _iE_=_bA_;break;
           case 1:var _iE_=_bB_;break;
           default:var _iD_=field(e,1),_iE_=caml_call1(sprintf(_bC_),_iD_)}
        return symbol(constructor,_iE_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _iz_=a.length - 1 - 1 | 0,_iy_=0;
        if(! (_iz_ < 0))
         {var i=_iy_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _ir_=slot[4],
              _is_=slot[3],
              _it_=slot[6]?_bM_:_bO_,
              _iu_=slot[2],
              _iv_=slot[7],
              _iw_=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bN_),_iw_,_iv_,_iu_,_it_,_is_,_ir_,_iq_)];
            else
             if(slot[1])
              var match=0;
             else
              var _ix_=info(0),match=[0,caml_call1(sprintf(_bP_),_ix_)];
            if(match){var str=match[1];caml_call1(fprintf(outchan,_bQ_),str)}
            var _iA_=i + 1 | 0;
            if(_iz_ !== i){var i=_iA_;continue}
            break}}
        return 0}
       ...
       {_hS_ = caml_wrap_exception(_hS_);
        if(_hS_ === Not_found)
         {var index=new_slot(table);
          if(caml_string_notequal(name,_bW_))
    ...
    var
     ...
     t121=t2.Date,
     t252=t2.Math,
     Error=[248,_bX_,caml_fresh_oo_id(0)];
    register_exception(_bY_,[0,Error,{}]);
    ...
    function path_of_path_string(s)
     {var l=caml_ml_string_length(s);
      ...
      var a=aux(0);
      if(a && ! caml_string_notequal(a[1],_cb_))
       {var _hz_=a[2];
        if(! _hz_)return 0;
        if(! caml_string_notequal(_hz_[1],_cc_) && ! _hz_[2])return _cd_}
      return a}
    ...
    new t2$0(caml_jsbytes_of_string(_cf_));
    if(test$0(t2.location))
     var _cg_=t2.location;
    else
     var
      empty="",
      _db_=[0,0,0,0],
         ...
         return caml_call1
                 (_db_[1],
                  [0,
                   ...
                   protocol,
                   href])},
      _de_=function(param,_gP_){return 0},
      _df_=function(param,_gO_){return 0},
    ...
    try
     {caml_int_of_string(caml_string_of_jsbytes(_cg_.port))}
    catch(_gN_)
       ...
       {case 1:return [0,_gx_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_cs_,function(param){return caml_call1(f,v)},_gy_)}}
    ...
    var pause_hook=[0,function(_gt_){return 0}],s1=create$1(0),_cv_=[0,0];
    ...
    function icon(nm){return caml_jsstring_of_string(symbol(_cz_,nm))}
            ...
            case 4:
             ...
             if(_gg_)
              {var
                ...
                _gf_=function(param){return _cx_},
                response=
                 [0,
                  url,
                  code,
    ...
    function _cA_(st){var x=st.getItem("hyp_lang");return x == t58?f(0):x}
    var language=[0,case$1(t2.localStorage,f,_cA_)];
    t713.log(language[1]);
    function load_messages(param)
     {function _f5_(s)
       {var t139=caml_jsstring_of_string(s);return return$0(t278.parse(t139))}
      return symbol_bind(getfile(_cB_),_f5_)}
    ...
    function compute_text_nodes(node_names,nodes)
     {try
       ...
       {_fU_ = caml_wrap_exception(_fU_);
        ...
        var names=_fH_}
      try
       {var _fO_=find$0(names,_cI_),_fI_=_fO_}
      catch(_fT_)
     ...
     {function _eW_(s)
       {var
             ...
             {var
              ...
              if(_fF_)
               {var
                 ...
                 nsize$0=osize * 2 | 0,
                 _fE_=nsize$0 < max_array_length?1:0;
                if(_fE_)
                 {var
                   ndata=caml_make_vect(nsize$0,0),
                   _fv_=h.length - 1 < 4?1:0,
                   _fw_=_fv_ || (h[4] < 0?1:0),
                   inplace=1 - _fw_;
                  h[2] = ndata;
                  var
                      ...
                      for(;;)
                       {if(cell)
                         {var
                          ...
                          continue}
                        var _fD_=i$0 + 1 | 0;
                        if(_fy_ !== i$0){var i$0=_fD_;continue a}
                        break}
                      break}}
                  if(inplace)
        ...
        var
         node_names$0=
          symbol$0
           (symbol$0(node_names,function(_fu_){return map(_e1_,_fu_)}),
            to_list);
              ...
              [0,
               ...
               [0,
                [246,
                 function(_fr_)
                  {function _fs_(param)
                    {function _ft_(img){schedule_redraw(0);return return$0(img)}
                     return symbol_bind
                             (load_image
                               (caml_jsstring_of_string(symbol(_cD_,symbol(img,_cC_)))),
                              _ft_)}
                   return symbol_bind(yield$0(0),_fs_)}],
                img]];
           else
        ...
        function layout_rec
         ...
         {var
          ...
          vi[1]++;
          var _fo_=transf[1];
          caml_check_bound(vertices,i$0)[1 + i$0] = _fo_;
          var l$0=ch.length - 1;
          if(0 === l$0)
           var ch$0=[0];
          else
           {var j=[0,0],total_weight=weight_sum(ch_weights);
            ...
            if(0 === l)
             ...
             {var
               _fi_=caml_check_bound(ch_weights,0)[1],
               r=caml_make_vect(l,f(caml_check_bound(ch,0)[1],_fi_)),
               _fk_=l - 1 | 0,
               _fj_=1;
              if(! (_fk_ < 1))
               {var i=_fj_;
                for(;;)
                 {var
                   _fl_=caml_check_bound(ch_weights,i)[1 + i],
                   _fm_=f(caml_check_bound(ch,i)[1 + i],_fl_);
                  caml_check_bound(r,i)[1 + i] = _fm_;
                  var _fn_=i + 1 | 0;
                  if(_fk_ !== i){var i=_fn_;continue}
                  break}}
              var _fq_=r}
            var ch$0=_fq_}
        ...
        function compute_frontiers(node)
         {var l=node[2],i=node[1];
          ...
          if(0 === l.length - 1)
           var _fc_=[0,status(i)],_fd_=[0,[0,status(i)],_fc_];
          else
           var
            _fe_=l.length - 1 - 1 | 0,
            _ff_=caml_check_bound(l,_fe_)[1 + _fe_][1],
            _fg_=caml_check_bound(frontiers,_ff_)[1 + _ff_][2],
            _fh_=caml_check_bound(l,0)[1][1],
            _fd_=[0,caml_check_bound(frontiers,_fh_)[1 + _fh_][1],_fg_];
          caml_check_bound(frontiers,i)[1 + i] = _fd_;
          return 0}
        ...
        function compute_neigh(node,parent,lft,rght)
         {var
           ...
           _e2_=caml_array_concat([0,parent,[0,lft,[0,rght,[0,children,0]]]]);
          caml_check_bound(neighboors,i)[1 + i] = _e2_;
          var
            ...
            for(;;)
             {if(0 < j)
               var
                ...
                lft$0=caml_check_bound(frontiers,_e6_)[1 + _e6_][2];
              else
               if(is_root)
                var
                 _fa_=n - 1 | 0,
                 _fb_=caml_check_bound(ch,_fa_)[1 + _fa_][1],
                 lft$0=caml_check_bound(frontiers,_fb_)[1 + _fb_][2];
               else
                var lft$0=lft;
              if(j < (n - 1 | 0))
               var
                _e7_=j + 1 | 0,
                _e8_=caml_check_bound(ch,_e7_)[1 + _e7_][1],
                rght$0=caml_check_bound(frontiers,_e8_)[1 + _e8_][1];
              else
               if(is_root)
                var
                 _e$_=caml_check_bound(ch,0)[1][1],
                 rght$0=caml_check_bound(frontiers,_e$_)[1 + _e$_][1];
               else
                var rght$0=rght;
              var _e9_=[0,status(i)];
              compute_neigh(caml_check_bound(ch,j)[1 + j],_e9_,lft$0,rght$0);
              var _e__=j + 1 | 0;
              if(_e4_ !== j){var j=_e__;continue}
              break}}
          return 0}
        compute_neigh(tree,[0],[0],[0]);
        var _eY_=nodes.length - 1 - 1 | 0,_eX_=0;
        if(! (_eY_ < 0))
         {var i=_eX_;
          for(;;)
           {var
             ...
             info=match[2],
             _eZ_=[0,caml_check_bound(neighboors,i)[1 + i],info];
            caml_check_bound(nodes,i)[1 + i] = _eZ_;
            var _e0_=i + 1 | 0;
    ...
    function close_button(over)
     {var
      ...
      t305.stroke();
      t305.restore();
      var _eU_=over?_cN_:_cO_;
      t281.className = caml_jsstring_of_string(_eU_);
    ...
    function img_button(href,h,src)
     {function decoration(over)
        ...
        var
         _eR_=
          caml_jsstring_of_string
           (symbol(caml_string_of_jsbytes("" + max(38,h)),_cP_));
        div.style.height = _eR_;
               ...
               (_cR_,
                symbol
                 (caml_string_of_jsbytes("" + (extra - (extra / 2 | 0) | 0)),
                  _cQ_))));
        div.style.padding = _eS_;
        var _eT_=over?_cS_:_cU_;
        div.className = caml_jsstring_of_string(symbol(_cT_,_eT_));
        appendChild(div,img);
        return div}
      ...
      var
       _eQ_=
        caml_jsstring_of_string
         (symbol(caml_string_of_jsbytes("" + (8 + max(38,h) | 0)),_cV_));
      button.style.height = _eQ_;
      if(href)
              ...
              (image_info,
               function(image_info)
                {var
                 ...
                 if(0 <= i[1])
                  {var
                     ...
                     function(elt)
                      {var w=createDiv(t766);
                       ...
                       var
                        _eO_=
                         caml_jsstring_of_string
                          (symbol(caml_string_of_jsbytes("" + info[5]),_cW_));
                       w.style.maxHeight = _eO_;
                       appendChild(w,elt);
                       return w},
                    img=createImg(t766),
                   ...
                   if(_eG_)
                    ...
                    var
                     url$0=
                      caml_jsstring_of_string(symbol(_c5_,symbol(name,_c4_)));
                   img.src = url$0;
                   img.width = info[4];
                   img.height = info[5];
                   ...
                   var
                    suffix=
                     language[1] === "en"
                      ?_cX_
                      :symbol(_c3_,caml_string_of_jsstring(language[1])),
                    url$1=
                     symbol(_cY_,symbol(caml_string_of_jsstring(info[2]),suffix)),
                    commons=
                     img_button([0,caml_jsstring_of_string(url$1)],52,_cZ_),
                    tt$0=
                     tooltip
                      (opt_style
                   ...
                   var
                    ...
                    list=
                     function(title,lang)
                      {var ul=createUl(t766),empty=[0,1],_eJ_=info[6];
                       iter$0
                        (function(param)
                          {var
                            refer=param[3],
                             ...
                             var
                              ...
                              _eM_=
                               0 === caml_ml_string_length(refer$0)
                                ...
                                :refer$0,
                              _eN_=symbol(_c1_,_eM_),
                              url=symbol(_c2_,symbol(caml_string_of_jsstring(lang),_eN_));
                 ...
                 return return$0(0)})}
    var information_en=caml_jsstring_of_string(_c6_);
                      ...
                      {var page=t766.documentElement;
                                  ...
                                  {var s$0=min_scale(l,1.,1.,1.);
                                   if(1. < s$0 * max(rx$2,ry$2))
                                    {var _em_=caml_obj_tag(img$0);
                                     if(250 !== _em_ && 246 === _em_)force_lazy_block(img$0)}}}
                                  ...
                                  {var
                                   ...
                                   if(0 < i)
                                    {var
                                      ...
                                      _dO_=match[2],
                                      switch$1=0;
                                     if(typeof _dO_ !== "number" && 3654627 === _dO_[1])
                                      {var match$0=_dO_[2],name=match$0[2],img=match$0[1];
                                            ...
                                            {var _dA_=touch.identifier === id?1:0;
                                             if(_dA_)
                                              {var x=touch.clientX,y=touch.clientY;
                                               ...
                                               if(_dB_)
                                                {var match=caml_check_bound(nodes,i)[1 + i],_dC_=match[2];
                                                 if(typeof _dC_ !== "number" && 3654627 === _dC_[1])
                                                  {var match$0=_dC_[2],name=match$0[2],img=match$0[1];
                                                   show_image(all_messages,image_info,name,img);
                                                   return 0}
                                                 var _dD_=0}
                                               else
                       ...
                       function make_buttons(param)
                        {var _do_=prev_buttons[1];
                         if(_do_){var buttons=_do_[1];removeChild(t766.body,buttons)}
                             ...
                             handler
                              (function(param)
                                {var lang=caml_jsstring_of_string(id);
                                 function _dp_(t138){return t138.setItem("hyp_lang",lang)}
                                 iter$2(t2.localStorage,_dp_);
                                 language[1] = lang;
                                 make_buttons(0);
    ...
    function start(param)
     {try
       {createCanvas(t2.document);var _dl_=_c7_(0);return _dl_}
      catch(_dm_)
       {_dm_ = caml_wrap_exception(_dm_);
        if(_dm_ === Canvas_not_available){unsupported_messages(0);return t238}
        throw _dm_}}
