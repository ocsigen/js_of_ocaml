   ...
   {"use strict";
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_ga_ = caml_wrap_exception(_ga_);
              if(_ga_[1] !== Sys_error)throw _ga_;
              var _f$_=_ga_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function engine(tbl,state,buf)
     {var
       ...
       _f8_=0 <= result?1:0,
       _f9_=_f8_?buf[12] !== dummy_pos?1:0:_f8_;
      if(_f9_)
       {buf[11] = buf[12];
        var _f__=buf[12];
        buf[12] = [0,_f__[1],_f__[2],_f__[3],buf[4] + buf[6] | 0]}
      return result}
        ...
        {case 0:
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_f0_,rest2$9)]}
          throw [0,Assert_failure,_aa_];
         case 11:
          var switch$11=0,_f1_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_f1_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ab_];
          break;
         case 12:
          var switch$12=0,_f2_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_f2_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ac_];
          break;
         case 13:
          var switch$13=0,_f3_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_f3_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ad_];
          break;
         default:
          var switch$14=0,_f4_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_f4_,rest2$13)];
             default:switch$14 = 1}
        ...
        {case 0:
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _fA_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _fB_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _fC_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _fD_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _fE_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _fF_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _fG_=function(param){caml_call1(de$12,0);return 0},
           _fH_=function(param){caml_call1(ed$12,0);return 0},
           _fI_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _fJ_=function(param){caml_call1(de$13,0);return 0},
           _fK_=function(param){caml_call1(ed$13,0);return 0},
           _fL_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       {if(prec)
         {var _fn_=match[2];
          if(typeof _fn_ !== "number" && 2 === _fn_[0])
           {var rest=_fn_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _e2_ >>> 0)
           {if(33 < (_e2_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _e2_)switch$0 = 1;
           ...
           {var i$0=_eU_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _eZ_=match - 34 | 0,switch$2=0;
                if(58 < _eZ_ >>> 0)
                 {if(93 <= _eZ_)switch$2 = 1}
                else
                 if(56 < (_eZ_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _eH_ >>> 0)
              {if(55 === _eH_)switch$0 = 1}
             else
              if(21 < (_eH_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _eI_=1}
           var _eJ_=_eI_?str:symbol(str,_a6_);
           return caml_special_val(_eJ_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_eD_=l - 1 | 0,_eC_=0;
           if(! (_eD_ < 0))
            {var i=_eC_;
             for(;;)
              {var
                ...
                switcher=c - 97 | 0,
                _eE_=25 < switcher >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_eE_);
               var _eF_=i + 1 | 0;
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_ex_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_ex_])}}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_er_,_eq_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_er_,_eq_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_er_,_eq_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _es_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_es_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_es_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_es_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_el_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_el_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bm_;
      var _ej_=other_fields(x,i + 1 | 0),_ek_=field(x,i);
      return caml_call2(sprintf(_bn_),_ek_,_ej_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _ee_=other_fields(e,2),
          _ef_=field(e,1),
          _eh_=caml_call2(sprintf(_bo_),_ef_,_ee_);
        else
         switch(match)
          {case 0:var _eh_=_bp_;break;
           case 1:var _eh_=_bq_;break;
           default:var _eg_=field(e,1),_eh_=caml_call1(sprintf(_br_),_eg_)}
        return symbol(constructor,_eh_)}
      return e[1]}
           ...
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _d6_=slot[4],
              _d7_=slot[3],
              _d8_=slot[6]?_bB_:_bD_,
              _d9_=slot[2],
              _d__=slot[7],
              _d$_=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bC_),_d$_,_d__,_d9_,_d8_,_d7_,_d6_,_d5_)];
            else
             if(slot[1])
              var match=0;
             else
              var _ea_=info(0),match=[0,caml_call1(sprintf(_bE_),_ea_)];
