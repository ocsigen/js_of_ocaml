...
(function(globalThis){
   ...
   var
    ...
    _ci_ = "Lighting",
    _cj_ = "Clip",
    _cd_ = [0, cst_examples_planet_planet_ml, 437, 2],
    _cc_ = [0, cst_examples_planet_planet_ml, 438, 2],
    _cb_ = [0, cst_examples_planet_planet_ml, 439, 2],
    _ca_ = [0, cst_examples_planet_planet_ml, 440, 2];
