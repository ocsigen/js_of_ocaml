...
(function(globalThis){
   ...
   var
    at_exit_key = new_key(0, function(param, _ek_){return 0;}),
    _o_ = "Array.blit";
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _d8_ = caml_ml_bytes_length(b) - 1 | 0,
     _d7_ = 0;
    if(_d8_ >= 0){
     var i$0 = _d7_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _d__ = caml_ml_bytes_length(b) - 1 | 0, _d9_ = 0;
     if(_d__ >= 0){
      var i = _d9_;
      for(;;){
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _dW_ = _dV_ ? str : symbol(str, _a3_);
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bj_), _dI_, _dH_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dD_ = field(e, 1),
       _dF_ = caml_call2(sprintf(_bk_), _dD_, _dC_);
     else
      switch(match){
        case 0:
         var _dF_ = _bl_; break;
        case 1:
         var _dF_ = _bm_; break;
        default:
         var _dE_ = field(e, 1), _dF_ = caml_call1(sprintf(_bn_), _dE_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _ds_ = slot[4],
        _dt_ = slot[3],
        _du_ = slot[6] ? _bx_ : _bz_,
        _dv_ = slot[2],
        _dw_ = slot[7],
        _dx_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_by_), _dx_, _dw_, _dv_, _du_, _dt_, _ds_, _dr_)];
      else if(slot[1])
       var match = 0;
      else
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _db_ = get_int64_le(d2, 8),
     _dc_ = get_int64_le(d2, 0),
     _dd_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _dd_, _dc_, _db_);
    return s;
   }
   var
   ...
   var
    ...
    _bV_ = "select",
    _bU_ = "option",
    _b2_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _cb_ = [0, 0],
    _cc_ = [0, 1],
    _b$_ = [0, 0],
    _ca_ = [0, 1],
    ...
    _b8_ = [0, 0],
    _b4_ = cst_Fatal_error_exception,
    _b5_ = "Lwt.Resolution_loop.Canceled",
    _cd_ = "Exception during Lwt.async: ",
    _cu_ = [0, [8, [0, 0, 0], 0, [0, 2], 0], "%.2f"],
    _co_ = "Resume",
    _cp_ = "Pause",
    _cq_ = "Fixed position",
    _cr_ = "Follow rotation",
    param = [0, "December solstice", [0, "Equinox", [0, "June solstice", 0]]],
    _cs_ = "Lighting",
    _ct_ = "Clip",
    _cn_ = [0, cst_examples_planet_planet_ml, 436, 2],
    _cm_ = [0, cst_examples_planet_planet_ml, 437, 2],
    _cl_ = [0, cst_examples_planet_planet_ml, 438, 2],
    _ck_ = [0, cst_examples_planet_planet_ml, 439, 2];
   try{var _cw_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _cw_;}
   catch(_c9_){
    var _bP_ = caml_wrap_exception(_c9_);
    if(_bP_ !== Not_found) throw caml_maybe_attach_backtrace(_bP_, 0);
    try{var _cv_ = caml_sys_getenv("CAMLRUNPARAM"), _bS_ = _cv_;}
    catch(_c__){
     var _bQ_ = caml_wrap_exception(_c__);
   ...
   if(lim < 0)
    ...
    try{
     ...
     var _n_ = caml_wrap_exception(_c8_);
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    function callback(e){
     var _c5_ = [0, h, e, [0]];
     return function(_c6_, _c7_){return caml_js_call(_c5_, _c6_, _c7_);};
    }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _cZ_ = createElementSyntax[1];
     if(785140586 !== _cZ_){
      if(982028505 <= _cZ_){
     ...
     try{
      var
       ...
       _c2_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _c3_ = _c2_ ? t49.name == "x" ? 1 : 0 : _c2_,
       _c0_ = _c3_;
     }
     catch(_c4_){var _c0_ = 0;}
     var _c1_ = _c0_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _c1_;
    }
   }
   function createInput(type, name, doc){
    return unsafeCreateElementEx(type, name, doc, _bW_);
   }
   function createLabel(doc){return unsafeCreateElement(doc, _bX_);}
   function createDiv(doc){return unsafeCreateElement(doc, _bY_);}
   var
    Canvas_not_available = [248, _b2_, caml_fresh_oo_id(0)],
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cY_ = caml_call1(f, v); return _cY_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cX_ = result[1] === Canceled ? 1 : 0, is_canceled = _cX_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cW_ = deferred_callbacks[2];
      if(! _cW_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cW_[1];
      if(_cW_[2]){
       var next = _cW_[2];
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _cV_ = p[1];
    switch(_cV_[0]){
      case 1:
       return _cV_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _cU_ = caml_call1(f, v), user_provided_promise = _cU_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_b__, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_b9_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
   ...
   function matrix_mul(m$0, m){
    var
     m$1 = matrix_transp(m),
     _cR_ = matrix_vect_mul(m$1, m$0[3]),
     _cS_ = matrix_vect_mul(m$1, m$0[2]);
    return [0, matrix_vect_mul(m$1, m$0[1]), _cS_, _cR_];
   }
   ...
   function create_canvas(t17, t19){
    var t52 = unsafeCreateElement(document, _b3_);
   ...
   for(;;){
    ...
    for(;;){
     ...
     if(0 === j){
      var _cf_ = 2 * k | 0;
      caml_check_bound(faces, _cf_)[1 + _cf_] = [0, north, k, (k + 8 | 0) % 96 | 0];
      var _cg_ = (2 * k | 0) + 1 | 0;
      caml_check_bound(faces, _cg_)[1 + _cg_] =
       [0, south, ((k + 16 | 0) - 1 | 0) % 96 | 0, (k + 8 | 0) - 1 | 0];
     }
     else{
      var _ci_ = 2 * k | 0;
      caml_check_bound(faces, _ci_)[1 + _ci_] = [0, k, (k + 8 | 0) % 96 | 0, k - 1 | 0];
      var _cj_ = (2 * k | 0) + 1 | 0;
       ...
       symbol_bind
        (symbol_bind(t, function(param){return [0, [0, img]];}),
         function(texture){
          ...
          function br(param){return unsafeCreateElement(document, _b0_);}
          appendChild
           (form,
            toggle_button(_cp_, _co_, function(p){paused[1] = p; return 0;}));
          appendChild(form, br(0));
          appendChild
           (form,
            toggle_button(_cr_, _cq_, function(f){follow[1] = f; return 0;}));
          appendChild(form, br(0));
          ...
          var
           t124 = unsafeCreateElementEx(0, 0, document, _bV_),
           param$0 = param;
          for(;;){
           if(! param$0) break;
           var
            l = param$0[2],
            txt = param$0[1],
            o = unsafeCreateElement(document, _bU_);
           appendChild
          ...
          appendChild
           (form$0,
            checkbox(_cs_, 1, function(l){lighting[1] = l; return 0;}));
          appendChild(form$0, br(0));
          appendChild
           (form$0, checkbox(_ct_, 1, function(l){clipped[1] = l; return 0;}));
          appendChild(form$0, br(0));
          ...
          var t131 = unsafeCreateElement(document, _bZ_);
          t131.innerHTML =
                    ...
                    (document,
                     ...
                     handler
                      (function(t135){
                        ...
                        if(0 !== dx){
                         var _cJ_ = m[1];
                         m[1] = matrix_mul(xz_rotation(2. * dx / 600), _cJ_);
                        }
                        mx[1] = x;
                        my[1] = y;
                        return true$0;
          ...
          function loop(t$0, phi$0){
           ...
           var
            _cB_ = matrix_mul(m_obliq[1], rotation),
            m$0 = matrix_mul(m[1], _cB_),
            _cA_ = map(function(v){return matrix_vect_mul(m$0, v);}, vertices),
           ...
           var _cy_ = faces.length - 1 - 1 | 0, _cx_ = 0;
           if(_cy_ >= 0){
            var i = _cx_;
            for(;;){
             var
              ...
              v2 = param[2],
              v1 = param[1],
              match$1 = caml_check_bound(_cA_, v1)[1 + v1],
              y1$0 = match$1[2],
              x1$0 = match$1[1],
              match$2 = caml_check_bound(_cA_, v2)[1 + v2],
              y2$0 = match$2[2],
              x2$0 = match$2[1],
              match$3 = caml_check_bound(_cA_, v3)[1 + v3],
              y3 = match$3[2],
              x3 = match$3[1],
             ...
             if(0. <= x1 * x2 + y1 * y2 + z1 * z2){
              ...
              var
               ...
               d = dy2 * dv3 - dy3 * dv2,
               e = dy2 * du3 - dy3 * du2,
               f$0 = y1$0 - d * u1 - e * v1$0;
              t164.transform(a, d, b, e, c, f$0);
           ...
           try{t167.getImageData(0., 0., 1., 1.);}catch(_cI_){}
           var
           ...
           var
            _cC_ = fps[1],
            t179 = caml_jsstring_of_string(caml_call1(sprintf(_cu_), _cC_));
           rateText.data = t179;
           ti[1] = t$1;
           var match$0 = task(0), w = match$0[2], t = match$0[1];
           function callback(_cH_){return wakeup(w, _cH_);}
           var id = [0, 0];
           function loop$0(d, param){
            ...
            var
             cb =
               remain == 0.
                ? callback
                : function(_cG_){return loop$0(remain, _cG_);};
           ...
           function _cD_(param){
            var
             ...
             _cE_ = 1 - paused[1],
             _cF_ = _cE_ ? follow[1] : _cE_;
            if(_cF_) phi_rot[1] = phi_rot[1] + angle;
