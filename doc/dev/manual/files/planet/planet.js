...
(function(globalThis){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _d0_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _d0_ >>> 0){
           if(55 === _d0_) break a;
          }
          else if(21 < _d0_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _d1_ = 1;
        }
        var _d2_ = _d1_ ? str : symbol(str, _a5_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dT_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dT_);
     }
    }
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _dO_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _dO_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bl_), _dN_, _dM_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dI_ = field(e, 1),
       _dK_ = caml_call2(sprintf(_bm_), _dI_, _dH_);
     else
      switch(match){
        case 0:
         var _dK_ = _bn_; break;
        case 1:
         var _dK_ = _bo_; break;
        default:
         var _dJ_ = field(e, 1), _dK_ = caml_call1(sprintf(_bp_), _dJ_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        match =
          [0,
           caml_call7(sprintf(_bA_), _dC_, _dB_, _dA_, _dz_, _dy_, _dx_, _dw_)];
      else if(slot[1])
       var match = 0;
      else
       var _dD_ = info(0), match = [0, caml_call1(sprintf(_bC_), _dD_)];
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _dg_ = get_int64_le(d2, 8),
     _dh_ = get_int64_le(d2, 0),
     _di_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _di_, _dh_, _dg_);
    return s;
   }
   function split(s){
    var
   ...
   if(lim < 0)
    ...
    try{
     ...
     var _n_ = caml_wrap_exception(_db_);
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    function callback(e){
     var _c__ = [0, h, e, [0]];
     return function(_c$_, _da_){return caml_js_call(_c__, _c$_, _da_);};
    }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _c4_ = createElementSyntax[1];
     if(785140586 !== _c4_){
      if(982028505 <= _c4_){
     ...
     try{
      var
       ...
       _c7_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _c8_ = _c7_ ? t49.name == "x" ? 1 : 0 : _c7_,
       _c5_ = _c8_;
     }
     catch(_c9_){var _c5_ = 0;}
     var _c6_ = _c5_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _c6_;
    }
   }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c3_ = caml_call1(f, v); return _c3_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c2_ = result[1] === Canceled ? 1 : 0, is_canceled = _c2_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _c1_ = deferred_callbacks[2];
      if(! _c1_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _c1_[1];
      if(_c1_[2]){
       var next = _c1_[2];
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _c0_ = p[1];
    switch(_c0_[0]){
      case 1:
       return _c0_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _cZ_ = caml_call1(f, v), user_provided_promise = _cZ_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function matrix_mul(m$0, m){
    var
     m$1 = matrix_transp(m),
     _cW_ = matrix_vect_mul(m$1, m$0[3]),
     _cX_ = matrix_vect_mul(m$1, m$0[2]);
    return [0, matrix_vect_mul(m$1, m$0[1]), _cX_, _cW_];
   }
   ...
   function start(param$0){
    ...
    function _cB_(texture){
      ...
      uv =
        map
         (function(v$0){
           ...
           throw caml_maybe_attach_backtrace([0, Assert_failure, _cn_], 1);
          },
          vertices),
      normals =
        map
     ...
     var t124 = unsafeCreateElementEx(0, 0, document, _bY_), param$0 = param;
     for(;;){
      if(! param$0) break;
      var
       l = param$0[2],
      ...
      appendChild(o, document.createTextNode(caml_jsstring_of_string(txt)));
               ...
               (document,
                ...
                handler
                 (function(t135){
                   ...
                   if(0 !== dx){
                    var _cO_ = m[1];
                    m[1] = matrix_mul(xz_rotation(2. * dx / 600), _cO_);
                   }
                   mx[1] = x;
                   my[1] = y;
                   return true$0;
     ...
     function loop(t$0, phi$0){
      ...
      if(lighting$0){
       ...
       var
        i$0 =
          (6.283185307179586 - phi) * w$1 / 2. / 3.141592653589793 % w$1 | 0;
      ...
      var
       ...
       _cF_ = map(function(v){return matrix_vect_mul(m$0, v);}, vertices),
      ...
      if(_cD_ >= 0){
       ...
       for(;;){
        var
         ...
         v2 = param[2],
         v1 = param[1],
         match$1 = caml_check_bound(_cF_, v1)[1 + v1],
         y1$0 = match$1[2],
         x1$0 = match$1[1],
         match$2 = caml_check_bound(_cF_, v2)[1 + v2],
         y2$0 = match$2[2],
         x2$0 = match$2[1],
         match$3 = caml_check_bound(_cF_, v3)[1 + v3],
         y3 = match$3[2],
         x3 = match$3[1],
      ...
      try{t167.getImageData(0., 0., 1., 1.);}catch(_cN_){}
      var
      ...
      var
       _cH_ = fps[1],
       t179 = caml_jsstring_of_string(caml_call1(sprintf(_cx_), _cH_));
      rateText.data = t179;
      ti[1] = t$1;
      ...
      var d = 10.;
      function callback(_cK_){return wakeup(w, _cK_);}
      var id = [0, 0];
      function loop$0(d, param){
       ...
       var
        cb =
          remain == 0.
           ? callback
           : function(_cJ_){return loop$0(remain, _cJ_);};
      ...
      return symbol_bind(t, _cI_);
     }
     return loop((new date_constr).getTime(), 0.);
    }
    var match$0 = task(0), w = match$0[2], t = match$0[1];
    function _cA_(param){return [0, [0, img]];}
    var t21 = handler(function(param){wakeup(w, 0); return false$0;});
    img.onload = t21;
    img.src = "../planet/texture.jpg";
    var p = symbol_bind(symbol_bind(t, _cA_), _cB_), match = underlying(p)[1];
    switch(match[0]){
      case 1:
