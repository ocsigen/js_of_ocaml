...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      if(_eb_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_eb_, 0);
     }
     param$0 = l;
    }
   }
   ...
   var
    at_exit_key = new_key(0, function(param, _d8_){return 0;}),
    _n_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _d7_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _d7_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _d6_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _d6_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _d6_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _d3_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _d3_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _d4_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _d4_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _d2_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _d2_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _dU_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _dT_ = 0;
    if(_dU_ >= 0){
     var i$0 = _dT_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _dW_ = caml_ml_bytes_length(s$0) - 1 | 0, _dV_ = 0;
     if(_dW_ >= 0){
      var i = _dV_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_d1_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dO_ = caml_ml_string_length(s) - 1 | 0, _dN_ = 0;
    if(_dO_ >= 0){
     var i$0 = _dN_;
     for(;;){
    ...
    var
     ...
     _dQ_ = caml_ml_string_length(s) - 1 | 0,
     _dP_ = 0;
    if(_dQ_ >= 0){
     var i = _dP_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dJ_ = _ar_; break;
      default: var _dJ_ = _aA_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dJ_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dG_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dG_ >>> 0){
           if(55 === _dG_) break a;
          }
          else if(21 < _dG_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dI_ = _dH_ ? str : str + cst$2;
        return caml_special_val(_dI_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dC_ = l - 1 | 0, _dB_ = 0;
        if(_dC_ >= 0){
         var i = _dB_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s$0, i),
           _dD_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dD_);
          var _dE_ = i + 1 | 0;
          if(_dC_ === i) break;
          i = _dE_;
         }
       ...
       return caml_string_of_bytes(_dF_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _dA_ = type_format_gen(fmt$0, fmtty$0);
       ...
       case 18:
        var _dy_ = fmt$0[1];
        if(0 === _dy_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dy_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dy_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dz_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dz_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dw_ = [8, acc, _a9_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dw_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dw_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dv_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dv_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dv_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bg_), _du_, _dt_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_ds_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dp_ = field(e, 1),
       _dr_ = caml_call2(sprintf(_bh_), _dp_, _do_);
     else
      switch(match){
        case 0:
         var _dr_ = _bi_; break;
        case 1:
         var _dr_ = _bj_; break;
        default:
         var _dq_ = field(e, 1), _dr_ = caml_call1(sprintf(_bk_), _dq_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _de_ = slot[4],
        _df_ = slot[3],
        _dg_ = slot[6] ? _bu_ : _bw_,
        _dh_ = slot[2],
        _di_ = slot[7],
        _dj_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bv_), _dj_, _di_, _dh_, _dg_, _df_, _de_, _dd_)];
      else if(slot[1])
       var match = 0;
      else
       var _dk_ = info(0), match = [0, caml_call1(sprintf(_bx_), _dk_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _c3_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _c3_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _c4_ = abs(status);
        prerr_endline(caml_check_bound(errors, _c4_)[1 + _c4_]);
       }
       var _c__ = caml_ml_flush(stderr), _c8_ = _c__;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _c6_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _c6_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _c7_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _c7_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _c8_ = caml_ml_flush(stderr);
      }
      var _c9_ = _c8_;
     }
     catch(_da_){
      var _c5_ = caml_wrap_exception(_da_);
      if(_c5_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_c5_, 0);
      var _c9_ = prerr_endline(_bz_);
     }
     return _c9_;
    }
    catch(_c$_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    ...
    var i3$0 = caml_notequal(i3, _bB_) ? i3 : _bE_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bC_) ? i4 : _bD_;
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _cZ_ = get_int64_le(d2, 8),
     _c0_ = get_int64_le(d2, 0),
     _c1_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _c1_, _c0_, _cZ_);
    return s;
   }
   var
   ...
   var
    ...
    _bL_ = cst$1,
    _bN_ = "Jsoo_runtime.Error.Exn",
    _bO_ = "select",
    _bQ_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _bZ_ = [0, 0],
    _b0_ = [0, 1],
    _bX_ = [0, 0],
    _bY_ = [0, 1],
    _bV_ = [0, 0],
    _bW_ = [0, 0],
    _bS_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bT_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bU_ = [0, 0],
    _bR_ = "Lwt.Resolution_loop.Canceled",
    _b1_ = "Exception during Lwt.async: ",
    _cg_ = [0, [8, [0, 0, 0], 0, [0, 2], 0], "%.2f"],
    _ca_ = "Resume",
    _cb_ = "Pause",
    _cc_ = "Fixed position",
    _cd_ = "Follow rotation",
    param = [0, "December solstice", [0, "Equinox", [0, "June solstice", 0]]],
    _ce_ = "Lighting",
    _cf_ = "Clip",
    _b$_ = [0, cst_examples_planet_planet_ml, 436, 2],
    _b__ = [0, cst_examples_planet_planet_ml, 437, 2],
    _b9_ = [0, cst_examples_planet_planet_ml, 438, 2],
    _b8_ = [0, cst_examples_planet_planet_ml, 439, 2];
   try{var _ci_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _ci_;}
   catch(_cV_){
    var _bJ_ = caml_wrap_exception(_cV_);
    if(_bJ_ !== Not_found) throw caml_maybe_attach_backtrace(_bJ_, 0);
    try{var _ch_ = caml_sys_getenv("CAMLRUNPARAM"), _bM_ = _ch_;}
    catch(_cW_){
     var _bK_ = caml_wrap_exception(_cW_);
     if(_bK_ !== Not_found) throw caml_maybe_attach_backtrace(_bK_, 0);
     var _bM_ = _bL_;
    }
    var params = _bM_;
   }
   ...
   if(lim < 0)
    ...
    try{
     ...
     var _m_ = caml_wrap_exception(_cU_);
   ...
   function addEventListener(t28, typ, t44, capt){
    ...
    function callback(e){
     var _cR_ = [0, t44, e, [0]];
     return function(_cS_, _cT_){return caml_js_call(_cR_, _cS_, _cT_);};
    }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _cL_ = createElementSyntax[1];
     if(785140586 !== _cL_){
      if(982028505 <= _cL_){
     ...
     try{
      var
       ...
       t50 = t49.tagName,
       _cO_ = t50.toLowerCase() == cst_input ? 1 : 0,
       _cP_ = _cO_ ? t49.name == "x" ? 1 : 0 : _cO_,
       _cM_ = _cP_;
     }
     catch(_cQ_){var _cM_ = 0;}
     var _cN_ = _cM_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _cN_;
    }
   }
   var
    Canvas_not_available = [248, _bQ_, caml_fresh_oo_id(0)],
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cK_ = caml_call1(f, v); return _cK_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _bR_, caml_fresh_oo_id(0)];
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cI_ = deferred_callbacks[2];
      if(! _cI_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cI_[1];
      if(_cI_[2]){
       var next = _cI_[2];
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _cH_ = p[1];
    switch(_cH_[0]){
      case 1:
       return _cH_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _bT_), api_function_name);
      case 2:
       if(0 === result$0[0])
        var x = result$0[1], result = [0, x];
       else
        var exn = result$0[1], result = [1, exn];
       resolve(_bU_, 0, p, result);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _bS_), api_function_name);
    }
   }
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       var p$0 = underlying(p);
       resolve(_bX_, 0, p$0, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _cG_ = caml_call1(f, v), user_provided_promise = _cG_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p1 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_bW_, 0, outer_promise, p1[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          p1[1] = state;
          break;
         default: resolve(_bV_, 0, outer_promise, p1[1]);
       }
      }
      return 0;
     }
   ...
   function toggle_button(txt1, txt2, action){
    var
     ...
     type = [0, button_type],
     t5 = unsafeCreateElementEx(type, 0, document, _bP_);
    t5.value = txt1$0;
    var
     t8 =
       handler
   ...
   function checkbox(txt, checked, action){
    var
     type = [0, "checkbox"],
     t11 = unsafeCreateElementEx(type, 0, document, _bP_),
     t10 = ! ! checked;
    t11.checked = t10;
    var
     t13 =
   ...
   function matrix_mul(m$0, m){
    var
     m$1 = matrix_transp(m),
     _cD_ = matrix_vect_mul(m$1, m$0[3]),
     _cE_ = matrix_vect_mul(m$1, m$0[2]);
    return [0, matrix_vect_mul(m$1, m$0[1]), _cE_, _cD_];
   }
   ...
   for(;;){
    ...
    for(;;){
     ...
     if(0 === j){
      var v3 = (v2 + 8 | 0) % 96 | 0, _b3_ = 2 * v2 | 0;
      caml_check_bound(faces, _b3_)[1 + _b3_] = [0, north, v2, v3];
      var
       v3$0 = (v2 + 8 | 0) - 1 | 0,
       v2$0 = ((v2 + 16 | 0) - 1 | 0) % 96 | 0,
       _b4_ = (2 * v2 | 0) + 1 | 0;
      caml_check_bound(faces, _b4_)[1 + _b4_] = [0, south, v2$0, v3$0];
     }
     else{
      var v3$1 = v2 - 1 | 0, v2$1 = (v2 + 8 | 0) % 96 | 0, _b6_ = 2 * v2 | 0;
      caml_check_bound(faces, _b6_)[1 + _b6_] = [0, v2, v2$1, v3$1];
      var
       v3$2 = ((v2 + 8 | 0) - 1 | 0) % 96 | 0,
       v2$2 = (v2 + 8 | 0) % 96 | 0,
       v1 = v2 - 1 | 0,
       _b7_ = (2 * v2 | 0) + 1 | 0;
      caml_check_bound(faces, _b7_)[1 + _b7_] = [0, v1, v2$2, v3$2];
     }
     var _b5_ = j + 1 | 0;
     if(7 === j) break;
     j = _b5_;
       ...
       symbol_bind
        (symbol_bind(t, function(param){return [0, [0, img]];}),
         function(texture){
              ...
              (function(v$0){
                ...
                if(! (0. <= u))
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _b$_], 1);
                if(! (u < tw))
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _b__], 1);
                if(! (0. <= v))
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _b9_], 1);
                if(v < th) return [0, u, v];
                throw caml_maybe_attach_backtrace
                       ([0, Assert_failure, _b8_], 1);
               },
               vertices),
           normals =
             map
          ...
          appendChild
           (form$0,
            toggle_button(_cb_, _ca_, function(p){paused[1] = p; return 0;}));
          appendChild(form$0, createElement(document, name$3));
          appendChild
           (form$0,
            toggle_button(_cd_, _cc_, function(f){follow[1] = f; return 0;}));
          appendChild(form$0, createElement(document, name$3));
          var
           type = [0, button_type],
           t1 = unsafeCreateElementEx(type, 0, document, _bP_);
          ...
          var
           t123 = unsafeCreateElementEx(0, 0, document, _bO_),
           param$0 = param;
          for(;;){
           if(! param$0) break;
           var
          ...
          appendChild
           (form, checkbox(_ce_, 1, function(l){lighting[1] = l; return 0;}));
          appendChild(form, createElement(document, name$3));
          appendChild
           (form, checkbox(_cf_, 1, function(l){clipped[1] = l; return 0;}));
          appendChild(form, createElement(document, name$3));
                    ...
                    (document,
                     ...
                     handler
                      (function(t135){
                        ...
                        if(0 !== dx){
                         var _cv_ = m[1];
                         m[1] = matrix_mul(xz_rotation(2. * dx / 600), _cv_);
                        }
                        mx[1] = x;
                        my[1] = y$0;
                        return true$0;
          ...
          function loop(t$0, phi$0){
           ...
           var
            _cn_ = matrix_mul(m_obliq[1], rotation),
            m$0 = matrix_mul(m[1], _cn_),
            _cm_ = map(function(v){return matrix_vect_mul(m$0, v);}, vertices),
           ...
           var _ck_ = faces.length - 2 | 0, _cj_ = 0;
           if(_ck_ >= 0){
            var i = _cj_;
            for(;;){
             var
              ...
              v2 = param[2],
              v1 = param[1],
              match$1 = caml_check_bound(_cm_, v1)[1 + v1],
              t75 = match$1[2],
              t74 = match$1[1],
              match$2 = caml_check_bound(_cm_, v2)[1 + v2],
              t78 = match$2[2],
              t77 = match$2[1],
              match$3 = caml_check_bound(_cm_, v3)[1 + v3],
              t81 = match$3[2],
              t80 = match$3[1],
           ...
           try{t167.getImageData(0., 0., 1., 1.);}catch(_cu_){}
           var
           ...
           var
            _co_ = fps[1],
            t179 = caml_jsstring_of_string(caml_call1(sprintf(_cg_), _co_));
           rateText.data = t179;
           ti[1] = t$1;
           var match$0 = task(0), w = match$0[2], t = match$0[1];
           function callback(_ct_){return wakeup(w, _ct_);}
           var id = [0, 0];
           function loop$0(d, param){
            ...
            var
             cb =
               remain == 0.
                ? callback
                : function(_cs_){return loop$0(remain, _cs_);},
           ...
           function _cp_(param){
            var
             ...
             _cq_ = 1 - paused[1],
             _cr_ = _cq_ ? follow[1] : _cq_;
            if(_cr_) phi_rot[1] = phi_rot[1] + angle;
