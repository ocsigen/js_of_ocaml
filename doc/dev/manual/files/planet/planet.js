...
(function(globalThis){
   ...
   var
    at_exit_key = new_key(0, function(param, _eh_){return 0;}),
    _n_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _eg_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _eg_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _ee_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _ee_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ef_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ef_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ef_[1];
   ...
   function fix_padding(padty, width, str){
    ...
    var _eb_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _eb_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _d5_ = caml_ml_bytes_length(b) - 1 | 0,
     _d4_ = 0;
    if(_d5_ >= 0){
     var i$0 = _d4_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _d7_ = caml_ml_bytes_length(b) - 1 | 0, _d6_ = 0;
     if(_d7_ >= 0){
      var i = _d6_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var
     ...
     _d1_ = caml_ml_string_length(s) - 1 | 0,
     _d0_ = 0;
    if(_d1_ >= 0){
     var i = _d0_;
     for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dR_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dR_ >>> 0){
           if(55 === _dR_) break a;
          }
          else if(21 < _dR_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dJ_ = fmt$0[1];
        if(0 === _dJ_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dJ_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dJ_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dK_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dK_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dH_ = [8, acc, _a9_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dH_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dH_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dG_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dG_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dG_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _dE_ = other_fields(x, i + 1 | 0), _dF_ = field(x, i);
    return caml_call2(sprintf(_bg_), _dF_, _dE_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dD_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _dz_ = other_fields(e, 2),
       _dA_ = field(e, 1),
       _dC_ = caml_call2(sprintf(_bh_), _dA_, _dz_);
     else
      switch(match){
        case 0:
         var _dC_ = _bi_; break;
        case 1:
         var _dC_ = _bj_; break;
        default:
         var _dB_ = field(e, 1), _dC_ = caml_call1(sprintf(_bk_), _dB_);
      }
     var match$0 = [0, constructor, [0, _dC_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dp_ = slot[4],
        _dq_ = slot[3],
        _dr_ = slot[6] ? _bu_ : _bw_,
        _ds_ = slot[2],
        _dt_ = slot[7],
        _du_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bv_), _du_, _dt_, _ds_, _dr_, _dq_, _dp_, _do_)];
      else if(slot[1])
       var match = 0;
      else
       var _dv_ = info(0), match = [0, caml_call1(sprintf(_bx_), _dv_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dm_){}
      try{
       var _dc_ = to_string(exn$0);
       caml_call1(eprintf(_bz_), _dc_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _dd_ = abs(status);
        prerr_endline(caml_check_bound(errors, _dd_)[1 + _dd_]);
       }
       var _de_ = caml_ml_flush(stderr), _di_ = _de_;
      }
      catch(exn$1){
       var
       ...
       caml_call1(eprintf(_bB_), _dg_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dh_ = to_string(exn);
       caml_call1(eprintf(_bC_), _dh_);
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _c__ = get_int64_le(d2, 8),
     _c$_ = get_int64_le(d2, 0),
     _da_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _da_, _c$_, _c__);
    return s;
   }
   var
   ...
   var
    ...
    _cr_ = [0, [8, [0, 0, 0], 0, [0, 2], 0], "%.2f"],
    _cl_ = "Resume",
    _cm_ = "Pause",
    _cn_ = "Fixed position",
    _co_ = "Follow rotation",
    param = [0, "December solstice", [0, "Equinox", [0, "June solstice", 0]]],
    _cp_ = "Lighting",
    _cq_ = "Clip",
    _ck_ = [0, cst_examples_planet_planet_ml, 436, 2],
    _cj_ = [0, cst_examples_planet_planet_ml, 437, 2],
    _ci_ = [0, cst_examples_planet_planet_ml, 438, 2],
    _ch_ = [0, cst_examples_planet_planet_ml, 439, 2];
   try{var _ct_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _ct_;}
   catch(_c6_){
    var _bM_ = caml_wrap_exception(_c6_);
    if(_bM_ !== Not_found) throw caml_maybe_attach_backtrace(_bM_, 0);
    try{var _cs_ = caml_sys_getenv("CAMLRUNPARAM"), _bP_ = _cs_;}
    catch(_c7_){
     var _bN_ = caml_wrap_exception(_c7_);
   ...
   if(lim < 0)
    ...
    try{
     ...
     var _m_ = caml_wrap_exception(_c5_);
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    function callback(e){
     var _c2_ = [0, h, e, [0]];
     return function(_c3_, _c4_){return caml_js_call(_c2_, _c3_, _c4_);};
    }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _cW_ = createElementSyntax[1];
     if(785140586 !== _cW_){
      if(982028505 <= _cW_){
     ...
     try{
      var
       ...
       _cZ_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _c0_ = _cZ_ ? t49.name == "x" ? 1 : 0 : _cZ_,
       _cX_ = _c0_;
     }
     catch(_c1_){var _cX_ = 0;}
     var _cY_ = _cX_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _cY_;
    }
   }
   function createInput(type, name, doc){
    return unsafeCreateElementEx(type, name, doc, _bT_);
   }
   function createLabel(doc){return unsafeCreateElement(doc, _bU_);}
   function createDiv(doc){return unsafeCreateElement(doc, _bV_);}
   var
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cV_ = caml_call1(f, v); return _cV_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cU_ = result[1] === Canceled ? 1 : 0, is_canceled = _cU_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cT_ = deferred_callbacks[2];
      if(! _cT_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cT_[1];
      if(_cT_[2]){
       var next = _cT_[2];
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _cS_ = p[1];
    switch(_cS_[0]){
      case 1:
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _cR_ = caml_call1(f, v), user_provided_promise = _cR_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_b7_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_b6_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
   ...
   function matrix_mul(m$0, m){
    var
     m$1 = matrix_transp(m),
     _cO_ = matrix_vect_mul(m$1, m$0[3]),
     _cP_ = matrix_vect_mul(m$1, m$0[2]);
    return [0, matrix_vect_mul(m$1, m$0[1]), _cP_, _cO_];
   }
   ...
   function create_canvas(t17, t19){
    var t52 = unsafeCreateElement(document, _b0_);
   ...
   for(;;){
    ...
    for(;;){
     ...
     if(0 === j){
      var _cc_ = 2 * k | 0;
      caml_check_bound(faces, _cc_)[1 + _cc_] = [0, north, k, (k + 8 | 0) % 96 | 0];
      var _cd_ = (2 * k | 0) + 1 | 0;
      caml_check_bound(faces, _cd_)[1 + _cd_] =
       [0, south, ((k + 16 | 0) - 1 | 0) % 96 | 0, (k + 8 | 0) - 1 | 0];
     }
     else{
      var _cf_ = 2 * k | 0;
      caml_check_bound(faces, _cf_)[1 + _cf_] = [0, k, (k + 8 | 0) % 96 | 0, k - 1 | 0];
      var _cg_ = (2 * k | 0) + 1 | 0;
   ...
   function start(param$0){
    var
     img = unsafeCreateElement(document, _bY_),
     match$0 = task(0),
     w = match$0[2],
     t = match$0[1],
       ...
       symbol_bind
        (symbol_bind(t, function(param){return [0, [0, img]];}),
         function(texture){
          ...
          function br(param){return unsafeCreateElement(document, _bX_);}
          appendChild
           (form,
            toggle_button(_cm_, _cl_, function(p){paused[1] = p; return 0;}));
          appendChild(form, br(0));
          appendChild
           (form,
            toggle_button(_co_, _cn_, function(f){follow[1] = f; return 0;}));
          appendChild(form, br(0));
          ...
          var
           t124 = unsafeCreateElementEx(0, 0, document, _bS_),
           param$0 = param;
          for(;;){
           if(! param$0) break;
           var
            l = param$0[2],
            txt = param$0[1],
            o = unsafeCreateElement(document, _bR_);
           appendChild
          ...
          appendChild
           (form$0,
            checkbox(_cp_, 1, function(l){lighting[1] = l; return 0;}));
          appendChild(form$0, br(0));
          appendChild
           (form$0, checkbox(_cq_, 1, function(l){clipped[1] = l; return 0;}));
          appendChild(form$0, br(0));
          ...
          var t131 = unsafeCreateElement(document, _bW_);
          t131.innerHTML =
          ...
          function loop(t$0, phi$0){
           ...
           var
            ...
            _cx_ = map(function(v){return matrix_vect_mul(m$0, v);}, vertices),
           ...
           var _cv_ = faces.length - 2 | 0, _cu_ = 0;
           if(_cv_ >= 0){
            var i = _cu_;
            for(;;){
             var
              ...
              v2 = param[2],
              v1 = param[1],
              match$1 = caml_check_bound(_cx_, v1)[1 + v1],
              y1$0 = match$1[2],
              x1$0 = match$1[1],
              match$2 = caml_check_bound(_cx_, v2)[1 + v2],
              y2$0 = match$2[2],
              x2$0 = match$2[1],
              match$3 = caml_check_bound(_cx_, v3)[1 + v3],
              y3 = match$3[2],
              x3 = match$3[1],
           ...
           try{t167.getImageData(0., 0., 1., 1.);}catch(_cF_){}
           var
           ...
           var
            _cz_ = fps[1],
            t179 = caml_jsstring_of_string(caml_call1(sprintf(_cr_), _cz_));
           rateText.data = t179;
           ti[1] = t$1;
           var match$0 = task(0), w = match$0[2], t = match$0[1];
           function callback(_cE_){return wakeup(w, _cE_);}
           var id = [0, 0];
