...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ek_ = caml_wrap_exception(_el_);
      if(_ek_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ek_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function do_at_exit$0(param){
    ...
    if(oldval !== none)
     ...
     var
      ...
      _ef_ = curval === oldval ? (st$1[1 + idx] = new_obj, 1) : 0;
     if(_ef_)
      var f = new_obj;
     else{
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _ee_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _ee_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ed_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ed_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ed_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _ea_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _ea_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _eb_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _eb_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _d$_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _d$_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _d3_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _d2_ = 0;
    if(_d3_ >= 0){
     var i$0 = _d2_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _d5_ = caml_ml_bytes_length(s$0) - 1 | 0, _d4_ = 0;
     if(_d5_ >= 0){
      var i = _d4_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_d__),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dX_ = caml_ml_string_length(s) - 1 | 0, _dW_ = 0;
    if(_dX_ >= 0){
     var i$0 = _dW_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dS_ = _as_; break;
      default: var _dS_ = _aB_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dS_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dP_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dP_ >>> 0){
           if(55 === _dP_) break a;
          }
          else if(21 < _dP_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dR_ = _dQ_ ? str : str + cst$2;
        return caml_special_val(_dR_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dL_ = l - 1 | 0, _dK_ = 0;
        if(_dL_ >= 0){
         var i = _dK_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s$0, i),
           _dM_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dM_);
          var _dN_ = i + 1 | 0;
          if(_dL_ === i) break;
          i = _dN_;
         }
       ...
       return caml_string_of_bytes(_dO_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dH_ = fmt$0[1];
        if(0 === _dH_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dH_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dH_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dI_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dI_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dF_ = [8, acc, _a__];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dF_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dF_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dE_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dE_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dE_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bh_), _dD_, _dC_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dB_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dy_ = field(e, 1),
       _dA_ = caml_call2(sprintf(_bi_), _dy_, _dx_);
     else
      switch(match){
        case 0:
         var _dA_ = _bj_; break;
        case 1:
         var _dA_ = _bk_; break;
        default:
         var _dz_ = field(e, 1), _dA_ = caml_call1(sprintf(_bl_), _dz_);
      }
     var match$0 = [0, constructor, [0, _dA_]];
    }
    else
     var match$0 = [0, e[1], 0];
   ...
   function print_raw_backtrace(outchan, raw_backtrace){
    ...
    if(_dv_ >= 0){
     ...
     for(;;){
      ...
      if(0 === slot[0]){
       if(slot[3] === slot[6])
        var _dk_ = slot[3], lines = caml_call1(sprintf(_bv_), _dk_);
       else
        var
         _dr_ = slot[6],
         _ds_ = slot[3],
         lines = caml_call2(sprintf(_bz_), _ds_, _dr_);
       var
        _dl_ = slot[7],
        _dm_ = slot[4],
        _dn_ = slot[8] ? _bw_ : _by_,
        _do_ = slot[2],
        _dp_ = slot[9],
        _dq_ = info(slot[1]),
        match =
          [0,
           caml_call7
            (sprintf(_bx_), _dq_, _dp_, _do_, _dn_, lines, _dm_, _dl_)];
      }
      else if(slot[1])
       var match = 0;
      else
       var _dt_ = info(0), match = [0, caml_call1(sprintf(_bA_), _dt_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _c__ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _c__);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _c$_ = abs(status);
        prerr_endline(caml_check_bound(errors, _c$_)[1 + _c$_]);
       }
       var _df_ = caml_ml_flush(stderr), _dd_ = _df_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _db_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _db_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dc_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _dc_);
      ...
      var _da_ = caml_wrap_exception(_dh_);
      if(_da_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_da_, 0);
      var _de_ = prerr_endline(_bC_);
     }
     return _de_;
    }
    catch(_dg_){return 0;}
   ...
   function BLAKE2(X){
    var _c8_ = X[1] < 1 ? 1 : 0, _c9_ = _c8_ || (64 < X[1] ? 1 : 0);
    if(_c9_) invalid_arg(_bD_);
   }
   BLAKE2([0, 16]);
   BLAKE2([0, 32]);
   BLAKE2([0, 64]);
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _c4_ = get_int64_le(d2, 8),
     _c5_ = get_int64_le(d2, 0),
     _c6_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _c6_, _c5_, _c4_);
    return s;
   }
   var
   ...
   var
    _l_ = "String.contains_from / Bytes.contains_from",
    _bP_ = cst$1,
    _bR_ = "Jsoo_runtime.Error.Exn",
    _bS_ = "select",
    _bU_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b3_ = [0, 0],
    _b4_ = [0, 1],
    _b1_ = [0, 0],
    _b2_ = [0, 1],
    _bZ_ = [0, 0],
    _b0_ = [0, 0],
    _bW_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bX_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bY_ = [0, 0],
    _bV_ = "Lwt.Resolution_loop.Canceled",
    _b5_ = "Exception during Lwt.async: ",
    _ck_ = [0, [8, [0, 0, 0], 0, [0, 2], 0], "%.2f"],
    _ce_ = "Resume",
    _cf_ = "Pause",
    _cg_ = "Fixed position",
    _ch_ = "Follow rotation",
    param = [0, "December solstice", [0, "Equinox", [0, "June solstice", 0]]],
    _ci_ = "Lighting",
    _cj_ = "Clip",
    _cd_ = [0, cst_examples_planet_planet_ml, 436, 2],
    _cc_ = [0, cst_examples_planet_planet_ml, 437, 2],
    _cb_ = [0, cst_examples_planet_planet_ml, 438, 2],
    _ca_ = [0, cst_examples_planet_planet_ml, 439, 2];
   try{var _cm_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _cm_;}
   catch(_c0_){
    var _bN_ = caml_wrap_exception(_c0_);
    if(_bN_ !== Not_found) throw caml_maybe_attach_backtrace(_bN_, 0);
    try{var _cl_ = caml_sys_getenv("CAMLRUNPARAM"), _bQ_ = _cl_;}
    catch(_c1_){
     var _bO_ = caml_wrap_exception(_c1_);
   ...
   if(lim < 0)
    ...
    try{
     ...
     for(;;){
      ...
      if(caml_string_unsafe_get(params, i) === 82) break;
      var i$0 = i + 1 | 0;
      i = i$0;
     }
    }
    catch(_cZ_){
     var _m_ = caml_wrap_exception(_cZ_);
     if(_m_ !== Not_found) throw caml_maybe_attach_backtrace(_m_, 0);
    }
   ...
   function addEventListener(t28, typ, t44, capt){
    ...
    function callback(e){
     var _cW_ = [0, t44, e, [0]];
     return function(_cX_, _cY_){return caml_js_call(_cW_, _cX_, _cY_);};
    }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cP_ = caml_call1(f, v); return _cP_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cO_ = result[1] === Canceled ? 1 : 0, is_canceled = _cO_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cN_ = deferred_callbacks[2];
      if(! _cN_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cN_[1];
      if(_cN_[2]){
       var next = _cN_[2];
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _cM_ = p[1];
    switch(_cM_[0]){
      case 1:
       return _cM_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       var p$0 = underlying(p);
       resolve(_b1_, 0, p$0, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _cL_ = caml_call1(f, v), user_provided_promise = _cL_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p1 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_b0_, 0, outer_promise, p1[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          p1[1] = state;
          break;
         default: resolve(_bZ_, 0, outer_promise, p1[1]);
       }
      }
      return 0;
     }
   ...
   var width = 600, obliquity = 0.41015237421866746, button_type = "button";
   function toggle_button(txt1, txt2, action){
    var
     ...
     type = [0, button_type],
     t5 = unsafeCreateElementEx(type, 0, document, _bT_);
    t5.value = txt1$0;
    var
     t8 =
       handler
   ...
   function checkbox(txt, checked, action){
    var
     type = [0, "checkbox"],
     t11 = unsafeCreateElementEx(type, 0, document, _bT_),
     t10 = ! ! checked;
    t11.checked = t10;
    var
     t13 =
    ...
    t11.onclick = t13;
    var lab = createElement(document, name$0);
    appendChild(lab, t11);
    var t15 = caml_jsstring_of_string(txt);
    appendChild(lab, document.createTextNode(t15));
    return lab;
   }
   function vect(_cK_, param){
    var
     z2 = param[3],
     y2 = param[2],
     x2 = param[1],
   ...
   function matrix_mul(m$0, m){
    var
     m$1 = matrix_transp(m),
     _cI_ = matrix_vect_mul(m$1, m$0[3]),
     _cJ_ = matrix_vect_mul(m$1, m$0[2]);
    return [0, matrix_vect_mul(m$1, m$0[1]), _cJ_, _cI_];
   }
   ...
   function create_canvas(t17, t19){
    var t52 = createElement(document, name$5);
   ...
   var i$2 = 0, overflow_limit = 2147483000., dark = 0.04000000000000001;
   for(;;){
    var j = 0;
    for(;;){
     var
     ...
     if(0 === j){
      var v3 = (v2 + 8 | 0) % 96 | 0, _b7_ = 2 * v2 | 0;
      caml_check_bound(faces, _b7_)[1 + _b7_] = [0, north, v2, v3];
      var
       v3$0 = (v2 + 8 | 0) - 1 | 0,
       v2$0 = ((v2 + 16 | 0) - 1 | 0) % 96 | 0,
       _b8_ = (2 * v2 | 0) + 1 | 0;
      caml_check_bound(faces, _b8_)[1 + _b8_] = [0, south, v2$0, v3$0];
     }
     else{
      var v3$1 = v2 - 1 | 0, v2$1 = (v2 + 8 | 0) % 96 | 0, _b__ = 2 * v2 | 0;
      caml_check_bound(faces, _b__)[1 + _b__] = [0, v2, v2$1, v3$1];
      var
       v3$2 = ((v2 + 8 | 0) - 1 | 0) % 96 | 0,
       v2$2 = (v2 + 8 | 0) % 96 | 0,
       v1 = v2 - 1 | 0,
       _b$_ = (2 * v2 | 0) + 1 | 0;
      caml_check_bound(faces, _b$_)[1 + _b$_] = [0, v1, v2$2, v3$2];
     }
     var _b9_ = j + 1 | 0;
     if(7 === j) break;
     j = _b9_;
   ...
   function start(param$0){
    ...
    var
     p =
       symbol_bind
        (symbol_bind(t, function(param){return [0, [0, img]];}),
         function(texture){
          var
           w = texture.width,
           h = texture.height,
           ...
           t32 = h / 8 | 0,
           t31 = w / 8 | 0,
           img = ctx.getImageData(0., 0., t31, t32),
           data = img.data;
             ...
             if(_cF_ >= 0){
              ...
              for(;;){
               var
                ...
                theta = (j / t32 - 0.5) * 3.141592653589793,
                phi = i / t31 * 2. * 3.141592653589793,
                x = Math.cos(phi) * Math.cos(theta),
                y = Math.sin(theta),
          ...
          var
           w$0 = texture.width,
           h$0 = texture.height,
           canvas$0 = create_canvas(w$0, h$0),
          ...
          var
           ...
           t102 = canvas$2.getContext(cst_2d),
           tw = texture.width,
           th = texture.height,
           uv =
             map
           ...
           m = [0, matrix_identity],
           phi_rot = [0, 0.],
           rateText = document.createTextNode(cst$1),
           ctrl = createElement(document, name$1);
          ctrl.className = "controls";
          var d = createElement(document, name$1);
          appendChild
           (d, document.createTextNode("Click and drag mouse to rotate."));
          appendChild(ctrl, d);
          var form$0 = createElement(document, name$1);
          appendChild
           (form$0,
            toggle_button(_cf_, _ce_, function(p){paused[1] = p; return 0;}));
          appendChild(form$0, createElement(document, name$3));
          appendChild
           (form$0,
            toggle_button(_ch_, _cg_, function(f){follow[1] = f; return 0;}));
          appendChild(form$0, createElement(document, name$3));
          var
           type = [0, button_type],
           t1 = unsafeCreateElementEx(type, 0, document, _bT_);
          ...
          t1.onclick = t2;
          appendChild(form$0, t1);
          appendChild(form$0, createElement(document, name$3));
          var lab = createElement(document, name$0);
          appendChild(lab, document.createTextNode("Date:"));
          var
           t123 = unsafeCreateElementEx(0, 0, document, _bS_),
           param$0 = param;
          for(;;){
           if(! param$0) break;
           var
            l = param$0[2],
            txt = param$0[1],
            t121 = createElement(document, name),
            t119 = caml_jsstring_of_string(txt);
           appendChild(t121, document.createTextNode(t119));
           t123.add(t121, no_handler);
           param$0 = l;
          }
          var
           t125 =
          ...
          t123.onchange = t125;
          appendChild(lab, t123);
          appendChild(form$0, lab);
          appendChild(ctrl, form$0);
          var form = createElement(document, name$1);
          appendChild
           (form, checkbox(_ci_, 1, function(l){lighting[1] = l; return 0;}));
          appendChild(form, createElement(document, name$3));
          appendChild
           (form, checkbox(_cj_, 1, function(l){clipped[1] = l; return 0;}));
          appendChild(form, createElement(document, name$3));
          appendChild(form, document.createTextNode("Frames per second: "));
          appendChild(form, rateText);
          appendChild(ctrl, form);
          appendChild(document.body, ctrl);
          var t131 = createElement(document, name$2);
          t131.innerHTML =
                    ...
                    (document,
                     ...
                     handler
                      (function(t135){
                        ...
                        if(0. !== dx){
                         var _cA_ = m[1];
                         m[1] = matrix_mul(xz_rotation(2. * dx / 600), _cA_);
                        }
                        mx[1] = x;
                        my[1] = y$0;
                        return true$0;
          ...
          var t140 = new date_constr, ti = [0, t140.getTime()], fps = [0, 0.];
          function loop(t$0, phi$0){
           var
           ...
           if(lighting$0){
            ...
            var
             t62 =
               (6.283185307179586 - phi) * w$0 / 2. / 3.141592653589793 % w$0
               | 0;
            ctx$0.drawImage(canvas, t62, 0.);
            var t66 = t62 - w$0;
            ctx$0.drawImage(canvas, t66, 0.);
           }
           ...
           var
            _cs_ = matrix_mul(m_obliq[1], rotation),
            m$0 = matrix_mul(m[1], _cs_),
            _cq_ = map(function(v){return matrix_vect_mul(m$0, v);}, vertices),
            dir = matrix_vect_mul(matrix_transp(m$0), v);
           t102.clearRect(0., 0., 600, 600);
           t102.save();
           if(clipped[1]){
            t102.beginPath();
            t102.arc(300., 300., 285., 0., -6.283185307179586, true$0);
            t102.clip();
           }
           t102.setTransform(298., 0., 0., 298., 300., 300.);
           t102.globalCompositeOperation = "lighter";
           var _co_ = faces.length - 2 | 0, _cn_ = 0;
           if(_co_ >= 0){
            var i = _cn_;
            for(;;){
             var
              ...
              v2 = param[2],
              v1 = param[1],
              match$1 = caml_check_bound(_cq_, v1)[1 + v1],
              t75 = match$1[2],
              t74 = match$1[1],
              match$2 = caml_check_bound(_cq_, v2)[1 + v2],
              t78 = match$2[2],
              t77 = match$2[1],
              match$3 = caml_check_bound(_cq_, v3)[1 + v3],
              t81 = match$3[2],
              t80 = match$3[1],
              _cr_ = caml_check_bound(normals, i)[1 + i],
              z2 = dir[3],
              y2 = dir[2],
              x2 = dir[1],
              z1 = _cr_[3],
             ...
             if(0. <= x1 * x2 + y1 * y2 + z1 * z2){
              ...
              var
               ...
               t86 = dx2 * dv3 - dx3 * dv2,
               t88 = dx2 * du3 - dx3 * du2,
               t90 = t74 - t86 * u1 - t88 * v1$0,
               t87 = dy2 * dv3 - dy3 * dv2,
               t89 = dy2 * du3 - dy3 * du2,
               t91 = t75 - t87 * u1 - t89 * v1$0;
              t102.transform(t86, t87, t88, t89, t90, t91);
              t102.drawImage
               (canvas$0, t98, t99, t100, t101, t98, t99, t100, t101);
              t102.restore();
             }
             var _cp_ = i + 1 | 0;
             if(_co_ === i) break;
           ...
           try{t167.getImageData(0., 0., 1., 1.);}catch(_cz_){}
           var
            t178 = new date_constr,
            t$1 = t178.getTime(),
            hz = 1000. / (t$1 - ti[1]),
           ...
           var
            _ct_ = fps[1],
            t179 = caml_jsstring_of_string(caml_call1(sprintf(_ck_), _ct_));
           rateText.data = t179;
           ti[1] = t$1;
           var match$0 = task(0), w = match$0[2], t = match$0[1];
           function callback(_cy_){return wakeup(w, _cy_);}
           var id = [0, 0];
           function loop$0(d, param){
            ...
            var
             cb =
               remain === 0.
                ? callback
                : function(_cx_){return loop$0(remain, _cx_);},
           ...
           function _cu_(param){
            var
             t182 = new date_constr,
             t = t182.getTime(),
             dt = t - t$0,
             dt$0 = dt < 0. ? 0. : 1000. < dt ? 0. : dt,
             angle = 6.283185307179586 * dt$0 / 1000. / 10.,
             _cv_ = 1 - paused[1],
             _cw_ = _cv_ ? follow[1] : _cv_;
            if(_cw_) phi_rot[1] = phi_rot[1] + angle;
           ...
           return symbol_bind(t, _cu_);
          }
          var t184 = new date_constr;
