...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _em_ = caml_wrap_exception(_en_);
      if(_em_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_em_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function engine(tbl, state, buf){
    var
     ...
     _ej_ = 0 <= result ? 1 : 0,
     _ek_ = _ej_ ? buf[12] !== dummy_pos ? 1 : 0 : _ej_;
    if(_ek_){
     buf[11] = buf[12];
     var _el_ = buf[12];
     buf[12] = [0, _el_[1], _el_[2], _el_[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
   ...
   var
    at_exit_key = new_key(0, function(param, _ei_){return 0;}),
    _o_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _eh_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _eh_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _ef_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _ef_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _eg_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _eg_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _eg_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _ed_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _ed_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _ee_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _ee_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _ec_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _ec_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _d6_ = caml_ml_bytes_length(b) - 1 | 0,
     _d5_ = 0;
    if(_d6_ >= 0){
     var i$0 = _d5_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _d8_ = caml_ml_bytes_length(b) - 1 | 0, _d7_ = 0;
     if(_d8_ >= 0){
      var i = _d7_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _d0_ = caml_ml_string_length(s) - 1 | 0, _dZ_ = 0;
    if(_d0_ >= 0){
     var i$0 = _dZ_;
     for(;;){
    ...
    var
     ...
     _d2_ = caml_ml_string_length(s) - 1 | 0,
     _d1_ = 0;
    if(_d2_ >= 0){
     var i = _d1_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dV_ = _at_; break;
      default: var _dV_ = _aC_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dV_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dS_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dS_ >>> 0){
           if(55 === _dS_) break a;
          }
          else if(21 < _dS_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dU_ = _dT_ ? str : symbol(str, _a3_);
        return caml_special_val(_dU_);
       }
      case 6:
       return hex(0);
      case 7:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _dM_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _dM_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _dM_[1];
       ...
       case 18:
        var _dK_ = fmt$0[1];
        if(0 === _dK_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dK_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dK_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dL_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dL_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dI_ = [8, acc, _ba_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dI_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dI_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dH_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dH_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dH_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _dF_ = other_fields(x, i + 1 | 0), _dG_ = field(x, i);
    return caml_call2(sprintf(_bj_), _dG_, _dF_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dE_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _dA_ = other_fields(e, 2),
       _dB_ = field(e, 1),
       _dD_ = caml_call2(sprintf(_bk_), _dB_, _dA_);
     else
      switch(match){
        case 0:
         var _dD_ = _bl_; break;
        case 1:
         var _dD_ = _bm_; break;
        default:
         var _dC_ = field(e, 1), _dD_ = caml_call1(sprintf(_bn_), _dC_);
      }
     var match$0 = [0, constructor, [0, _dD_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dq_ = slot[4],
        _dr_ = slot[3],
        _ds_ = slot[6] ? _bx_ : _bz_,
        _dt_ = slot[2],
        _du_ = slot[7],
        _dv_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_by_), _dv_, _du_, _dt_, _ds_, _dr_, _dq_, _dp_)];
      else if(slot[1])
       var match = 0;
      else
       var _dw_ = info(0), match = [0, caml_call1(sprintf(_bA_), _dw_)];
    ...
    try{
     try{
      ...
      try{
       ...
       var _df_ = caml_ml_flush(stderr), _dj_ = _df_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dh_ = to_string(exn$0);
       caml_call1(eprintf(_bE_), _dh_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _di_ = to_string(exn);
       caml_call1(eprintf(_bF_), _di_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _dj_ = caml_ml_flush(stderr);
      }
      var _dk_ = _dj_;
     }
     catch(_dm_){
      var _dg_ = caml_wrap_exception(_dm_);
      if(_dg_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_dg_, 0);
      var _dk_ = prerr_endline(_bD_);
     }
     return _dk_;
    }
    catch(_dl_){return 0;}
   ...
   var
    ...
    _bY_ = [0, 0],
    _bU_ = cst_Fatal_error_exception,
    _bV_ = "Lwt.Resolution_loop.Canceled",
    _b5_ = "Exception during Lwt.async: ",
    _b9_ = [0, cst_examples_wiki_wikicreole_m, 207, 32],
    _b__ = [0, cst_examples_wiki_wikicreole_m, 216, 6],
    _b$_ = [0, cst_examples_wiki_wikicreole_m, 231, 6],
    _cb_ = [0, cst_examples_wiki_wikicreole_m, 285, 6],
    _cc_ = "*",
    _ca_ = [5, 0],
    _b8_ = [0, cst_examples_wiki_wikicreole_m, 158, 6],
    _b6_ = "//",
    _b7_ = "**",
    _ch_ = "http://youtube.com/embed/",
    _cg_ = "ul",
    _cf_ = "ol",
    _cd_ = "th",
    _ce_ = "td",
    _ci_ = [0, "examples/wiki/main.ml", 33, 70],
    _cj_ = cst$0,
   ...
   function createDiv(doc){return unsafeCreateElement(doc, _bP_);}
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _dc_ = caml_call1(f, v); return _dc_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _db_ = result[1] === Canceled ? 1 : 0, is_canceled = _db_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _da_ = deferred_callbacks[2];
      if(! _da_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _da_[1];
      if(_da_[2]){
       var next = _da_[2];
   ...
   function count(c, s){
    var n = [0, 0], _c__ = caml_ml_string_length(s) - 1 | 0, _c9_ = 0;
    if(_c__ >= 0){
     var i = _c9_;
     for(;;){
   ...
   function push(c, v){
    var _c7_ = c[12];
    if(typeof _c7_ !== "number" && 1 === _c7_[0]){c[8] = [0, v, c[8]]; return;}
    var _c8_ = c[7];
    c[7] = [0, caml_call1(c[1][21], v), _c8_];
    return;
   }
   ...
   function pop_link(c, addr, stack){
    c[12] = stack;
    var _c4_ = c[7], _c5_ = rev(c[8]);
    c[7] = [0, caml_call2(c[1][7], addr, _c5_), _c4_];
    c[8] = 0;
    c[5] = 0;
    return;
   }
     ...
     switch(_c2_[0]){
       ...
       case 7:
        ...
        if(typeof match !== "number" && 6 === match[0]){
         var stack = match[2], entries = match[1], heading = _c2_[1];
     ...
     switch(_c1_[0]){
       ...
       case 6:
        ...
        if(typeof match !== "number" && 5 === match[0]){
         var rows = match[1], entries = _c1_[1];
   ...
   function end_paragraph(c, lev){
    for(;;){
     ...
     if(typeof match === "number"){
      if(0 !== c[7]){
       var _cS_ = c[11], _cT_ = rev(c[7]);
       c[11] = [0, caml_call1(c[1][9], _cT_), _cS_];
       c[7] = 0;
      }
      c[12] = 0;
      return;
     ...
     switch(match[0]){
       ...
       case 2:
        ...
        var _cU_ = c[11];
        c[11] = [0, caml_call1(f, rev(c[7])), _cU_];
        c[7] = 0;
        c[4] = 0;
        c[12] = 0;
        return;
       case 3:
        var stack$1 = match[1], _cV_ = c[10];
        c[10] = [0, [0, rev(c[7]), 0], _cV_];
        c[12] = stack$1;
        c[7] = 0;
        break;
       case 4:
        ...
        break;
       case 5:
        var rows = match[1], _cY_ = c[11], _cZ_ = rev(rows);
        c[11] = [0, caml_call1(c[1][20], _cZ_), _cY_];
        c[12] = 0;
        return;
       case 6:
   ...
   function start_list_item(c, kind, lev){
    var _cP_ = lev === (c[6] + 1 | 0) ? 1 : 0;
    a:
    {
     if(_cP_)
      var _cQ_ = _cP_;
     else{
      var _cR_ = lev <= c[6] ? 1 : 0;
      if(_cR_){
    ...
    for(;;){
     ...
     switch(ocaml_lex_state$0){
       ...
       case 4:
        end_paragraph(c, 0);
        var _cK_ = c[11];
        c[11] = [0, caml_call1(c[1][19], 0), _cK_];
        break;
       case 5:
        end_paragraph(c, 0);
        for(;;){
         ...
         switch(ocaml_lex_state$2){
           case 0:
            var s$0 = lexeme(lexbuf), _cL_ = c[9];
            c[9] =
             [0, sub$0(s$0, 1, caml_ml_string_length(s$0) - 1 | 0), _cL_];
            break;
           case 1:
            var _cM_ = c[11], _cN_ = rev(c[9]);
            c[11] = [0, caml_call1(c[1][10], _cN_), _cM_];
            c[9] = 0;
            if(counter >= 50)
             return caml_trampoline_return(parse_bol$0, [0, c, lexbuf]);
            var counter$6 = counter + 1 | 0;
            return parse_bol$0(counter$6, c, lexbuf);
           default: var _cO_ = c[9]; c[9] = [0, lexeme(lexbuf), _cO_];
         }
        }
        break;
       case 6:
   ...
   function parse_rem(counter, c, lexbuf){
    ...
    if(counter >= 50)
     return caml_trampoline_return
             (ocaml_lex_parse_rem_rec, [0, c, lexbuf, _cG_]);
    var counter$0 = counter + 1 | 0;
    return ocaml_lex_parse_rem_rec(counter$0, c, lexbuf, _cG_);
   }
      ...
      switch(ocaml_lex_state$1){
        ...
        case 5:
         ...
         var
          ...
          _cA_ = c[7],
          _cB_ = [0, caml_call1(c[1][1], addr$0), 0];
         c[7] = [0, caml_call2(c[1][8], addr$0, _cB_), _cA_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$3 = counter + 1 | 0;
         return parse_rem(counter$3, c, lexbuf);
        ...
        case 8:
         ...
         var
          ...
          _cC_ = c[7],
          _cD_ = [0, caml_call1(c[1][1], addr$3), 0];
         c[7] = [0, caml_call2(c[1][7], addr$3, _cD_), _cC_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$6 = counter + 1 | 0;
        ...
        case 11:
         var
          ...
          _cE_ = caml_call1(c[1][1], txt),
          _cF_ = [0, caml_call1(c[1][21], _cE_), 0];
         push(c, caml_call1(c[1][6], _cF_));
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$8 = counter + 1 | 0;
     ...
     _cu_ =
       map
        (function(param){
          ...
          if(l1$0){
           var _cv_ = l1$0[2], h1 = l1$0[1];
           if(_cv_){
            var match = _cv_[2], h2 = _cv_[1];
            if(match){
             var
              tl = match[2],
              h3 = match[1],
             ...
             for(;;){
              if(l1){
               var _cw_ = l1[2], h1$0 = l1[1];
               if(_cw_){
                var match$0 = _cw_[2], h2$0 = _cw_[1];
                if(match$0){
                 var
                  tl$0 = match$0[2],
                  h3$0 = match$0[1],
               ...
               dst[1 + offset] = l2;
              var _cx_ = [0, h1, [0, h2, block]];
              break;
             }
            }
            else
             var _cx_ = [0, h1, [0, h2, l2]];
           }
           else
            var _cx_ = [0, h1, l2];
          }
           ...
           var _cx_ = l2;
          return symbol$0(d.createElement("li"), _cx_);
         },
         c);
    return symbol$0(d.createElement(caml_jsstring_of_string(tag)), _cu_);
   }
   var
    builder =
      [0,
       ...
       function(s){return symbol$0(document.createElement("strong"), s);},
       function(s){return symbol$0(document.createElement("em"), s);},
       function(param){return document.createElement(cst_br);},
       function(addr, alt){
        var
         t23 = unsafeCreateElement(document, _bS_),
       ...
       function(s){return symbol$0(document.createElement("tt"), s);},
       function(addr, s){
        var
         t11 = unsafeCreateElement(document, _bR_),
         t10 = caml_jsstring_of_string(addr);
        t11.href = t10;
        return symbol$0(t11, s);
       },
       function(addr, s){
        var t13 = unsafeCreateElement(document, _bT_);
        t13.width = "480";
        t13.height = "360";
        var
         s$0 = caml_jsstring_of_string(addr),
         video_link =
           symbol(_ch_, caml_string_of_jsstring(global.encodeURI(s$0))),
         t16 = caml_jsstring_of_string(video_link);
        t13.src = t16;
        t13.frameBorder = "0";
        return t13;
       },
       function(s){return symbol$0(document.createElement("p"), s);},
       function(s){
        ...
        if(s){
         ...
         var dst = caml_create_bytes(_cs_), pos = pos$1, param$0 = s;
         for(;;){
          if(param$0){
           var hd$0 = param$0[1];
           if(param$0[2]){
          ...
          var _ct_ = caml_string_of_bytes(dst);
          break;
         }
        }
        else
         var _ct_ = _n_;
        appendChild(p, document.createTextNode(caml_jsstring_of_string(_ct_)));
        return p;
       },
       function(s){return symbol$0(document.createElement("h1"), s);},
       function(s){return symbol$0(document.createElement("h2"), s);},
       function(s){return symbol$0(document.createElement("h3"), s);},
       function(s){return symbol$0(document.createElement("h4"), s);},
       function(s){return symbol$0(document.createElement("h5"), s);},
       function(s){return symbol$0(document.createElement("h6"), s);},
       function(s){return list_builder(document, _cg_, s);},
       function(s){return list_builder(document, _cf_, s);},
            ...
            (function(entries){
              var
               _cr_ =
                 map
                  (function(param){
                    var c = param[2], h = param[1], kind = h ? _cd_ : _ce_;
                    return symbol$0
                            (document.createElement(caml_jsstring_of_string(kind)), c);
                   },
                   entries);
              return symbol$0(document.createElement("tr"), _cr_);
             },
             rows),
         _cq_ = [0, symbol$0(document.createElement("tbody"), rows$0), 0];
        return symbol$0(document.createElement("table"), _cq_);
       },
       function(x){return x;}],
   ...
   function onload(param){
    ...
    appendChild(body, unsafeCreateElement(document, _bQ_));
    ...
    function dyn_preview(old_text, n){
     ...
     if(text !== old_text){
      try{
       ...
       var
        _ck_ = rev(c[11]),
        rendered = symbol$0(createDiv(document), _ck_),
     ...
     function loop(d, param){
      ...
      var
       cb =
         remain == 0.
          ? callback$0
          : function(_cn_){return loop(remain, _cn_);};
     ...
     function create_result_promise_and_call(param){
      ...
      function callback(p_result){
       if(1 === p_result[0]){
        ...
        resolve(_b1_, 0, p$1, p_result);
        return 0;
       }
       var v = p_result[1];
       current_storage[1] = saved_storage;
       try{var _cm_ = f$0(v), user_provided_promise = _cm_;}
       catch(exn$0){
        var exn = caml_wrap_exception(exn$0);
       ...
       if(p$0 !== outer_promise){
        ...
        switch(match[0]){
          case 1:
           resolve(_b0_, 0, outer_promise, p$0[1]); break;
          case 2:
           var
            p_callbacks = match[1],
           ...
           break;
          default: resolve(_bZ_, 0, outer_promise, p$0[1]);
        }
       }
       return 0;
      }
