...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      if(_d$_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_d$_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function engine(tbl, state, buf){
    var
     ...
     _d8_ = 0 <= result ? 1 : 0,
     _d9_ = _d8_ ? buf[12] !== dummy_pos ? 1 : 0 : _d8_;
    if(_d9_){
     buf[11] = buf[12];
     var _d__ = buf[12];
     buf[12] = [0, _d__[1], _d__[2], _d__[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
   ...
   var
    at_exit_key = new_key(0, function(param, _d7_){return 0;}),
    _n_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _d6_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _d6_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _d4_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _d4_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _d5_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _d5_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _d5_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _d2_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _d2_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _d3_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _d3_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _d1_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _d1_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _dT_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _dS_ = 0;
    if(_dT_ >= 0){
     var i$0 = _dS_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _dV_ = caml_ml_bytes_length(s$0) - 1 | 0, _dU_ = 0;
     if(_dV_ >= 0){
      var i = _dU_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_d0_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dN_ = caml_ml_string_length(s) - 1 | 0, _dM_ = 0;
    if(_dN_ >= 0){
     var i$0 = _dM_;
     for(;;){
    ...
    var
     ...
     _dP_ = caml_ml_string_length(s) - 1 | 0,
     _dO_ = 0;
    if(_dP_ >= 0){
     var i = _dO_;
     for(;;){
   ...
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dK_ = _aE_; break;
      default: var _dK_ = _aN_;
    }
    return transform_int_alt(iconv, caml_format_int(_dK_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dI_ = _ar_; break;
      default: var _dI_ = _aA_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dI_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dF_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dF_ >>> 0){
           if(55 === _dF_) break a;
          }
          else if(21 < _dF_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dH_ = _dG_ ? str : str + cst$2;
        return caml_special_val(_dH_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dB_ = l - 1 | 0, _dA_ = 0;
        if(_dB_ >= 0){
         var i = _dA_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dC_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dC_);
          var _dD_ = i + 1 | 0;
          if(_dB_ === i) break;
          i = _dD_;
         }
       ...
       return caml_string_of_bytes(_dE_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dx_ = fmt$0[1];
        if(0 === _dx_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dx_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dx_[1][1];
   ...
   var
    ...
    _bw_ = cst,
    _bx_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _by_ = [0, [2, 0, [12, 10, 0]], "%s\n"];
   ...
   function other_fields(x, i){
    ...
    var _ds_ = other_fields(x, i + 1 | 0), _dt_ = field(x, i);
    return caml_call2(sprintf(_bg_), _dt_, _ds_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dr_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _dn_ = other_fields(e, 2),
       _do_ = field(e, 1),
       _dq_ = caml_call2(sprintf(_bh_), _do_, _dn_);
     else
      switch(match){
        case 0:
         var _dq_ = _bi_; break;
        case 1:
         var _dq_ = _bj_; break;
        default:
         var _dp_ = field(e, 1), _dq_ = caml_call1(sprintf(_bk_), _dp_);
      }
     var match$0 = [0, constructor, [0, _dq_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dd_ = slot[4],
        _de_ = slot[3],
        _df_ = slot[6] ? _bu_ : _bw_,
        _dg_ = slot[2],
        _dh_ = slot[7],
        _di_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bv_), _di_, _dh_, _dg_, _df_, _de_, _dd_, _dc_)];
      else if(slot[1])
       var match = 0;
      else
       var _dj_ = info(0), match = [0, caml_call1(sprintf(_bx_), _dj_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _by_), str);}
      var _dm_ = pos + 1 | 0;
      if(_dl_ === pos) break;
      pos = _dm_;
     }
   ...
   var
    errors =
      [0,
       ...
       (),
    empty_backtrace = [0],
    _bz_ = "Fatal error: out of memory in uncaught exception handler";
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_da_){}
      try{
       var _c2_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _c2_);
       ...
       var _c9_ = caml_ml_flush(stderr), _c7_ = _c9_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _c5_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _c5_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _c6_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _c6_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _c7_ = caml_ml_flush(stderr);
      }
      var _c8_ = _c7_;
     }
     catch(_c$_){
      var _c4_ = caml_wrap_exception(_c$_);
      if(_c4_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_c4_, 0);
      var _c8_ = prerr_endline(_bz_);
     }
     return _c8_;
    }
    catch(_c__){return 0;}
   ...
   var
    _bA_ = caml_int64_create_lo_mi_hi(1, 0, 0),
    _bB_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bC_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bD_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bE_ = caml_int64_create_lo_mi_hi(1, 0, 0);
   function mk(i1, i2, i3$0, i4$0){
    var s = caml_ba_create(7, 0, [0, 4]);
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bA_));
    caml_ba_set_1(s, 1, i2);
    var i3 = caml_notequal(i3$0, _bB_) ? i3$0 : _bE_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bC_) ? i4$0 : _bD_;
    caml_ba_set_1(s, 3, i4);
    return s;
   }
   var
    _bF_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bG_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bH_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bI_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520);
   function split(s){
    var
     i1 = caml_lxm_next(s),
     i2 = caml_lxm_next(s),
   ...
   function mk_default(param){return mk(_bI_, _bH_, _bG_, _bF_);}
   ...
   var
    ...
    _bN_ = [0, 0],
    _bO_ = [0, 0],
    _bK_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bL_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bM_ = [0, 0],
    _bJ_ = "Lwt.Resolution_loop.Canceled",
    _bT_ = "Exception during Lwt.async: ",
    _bX_ = [0, cst_examples_wiki_wikicreole_m, 207, 32],
    _bY_ = [0, cst_examples_wiki_wikicreole_m, 216, 6],
    _bZ_ = [0, cst_examples_wiki_wikicreole_m, 231, 6],
    _b1_ = [0, cst_examples_wiki_wikicreole_m, 285, 6],
    _b2_ = "*",
    _b0_ = [5, 0],
    _bW_ = [0, cst_examples_wiki_wikicreole_m, 158, 6],
    _bU_ = "//",
    _bV_ = "**",
    _b6_ = "ul",
    _b5_ = "ol",
    _b3_ = "th",
    _b4_ = "td",
    _b7_ = [0, "examples/wiki/main.ml", 33, 70],
    _b8_ = cst,
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c1_ = caml_call1(f, v); return _c1_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _bJ_, caml_fresh_oo_id(0)];
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c0_ = result[1] === Canceled ? 1 : 0, is_canceled = _c0_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cZ_ = deferred_callbacks[2];
      if(! _cZ_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cZ_[1];
      if(_cZ_[2]){
       var next = _cZ_[2];
   ...
   function count(c, s){
    var n = [0, 0], _cX_ = caml_ml_string_length(s) - 1 | 0, _cW_ = 0;
    if(_cX_ >= 0){
     var i = _cW_;
     for(;;){
   ...
   function push(c, v){
    var _cU_ = c[12];
    if(typeof _cU_ !== "number" && 1 === _cU_[0]){c[8] = [0, v, c[8]]; return;}
    var _cV_ = c[7];
    c[7] = [0, caml_call1(c[1][21], v), _cV_];
    return;
   }
   ...
   function style_change(c, style){
    ...
    return style ? push_string(c, _bU_) : push_string(c, _bV_);
   }
   function pop_link(c, addr, stack){
    c[12] = stack;
    var _cR_ = c[7], _cS_ = rev(c[8]);
    c[7] = [0, caml_call2(c[1][7], addr, _cS_), _cR_];
    c[8] = 0;
    c[5] = 0;
    return;
   }
     ...
     switch(_cP_[0]){
       ...
       case 7:
        ...
        if(typeof match !== "number" && 6 === match[0]){
         var stack = match[2], entries = match[1], heading = _cP_[1];
     ...
     switch(_cO_[0]){
       ...
       case 6:
        ...
        if(typeof match !== "number" && 5 === match[0]){
         var rows = match[1], entries = _cO_[1];
   ...
   function end_paragraph(c, lev){
    for(;;){
     ...
     if(typeof match === "number"){
      if(0 !== c[7]){
       var _cF_ = c[11], _cG_ = rev(c[7]);
       c[11] = [0, caml_call1(c[1][9], _cG_), _cF_];
       c[7] = 0;
      }
      c[12] = 0;
      return;
     ...
     switch(match[0]){
       ...
       case 2:
        ...
        var _cH_ = c[11];
        c[11] = [0, caml_call1(f, rev(c[7])), _cH_];
        c[7] = 0;
        c[4] = 0;
        c[12] = 0;
        return;
       case 3:
        var stack$1 = match[1], _cI_ = c[10];
        c[10] = [0, [0, rev(c[7]), 0], _cI_];
        c[12] = stack$1;
        c[7] = 0;
        break;
       case 4:
        ...
        break;
       case 5:
        var rows = match[1], _cL_ = c[11], _cM_ = rev(rows);
        c[11] = [0, caml_call1(c[1][20], _cM_), _cL_];
        c[12] = 0;
        return;
       case 6:
   ...
   function start_list_item(c, kind, lev){
    var _cC_ = lev === (c[6] + 1 | 0) ? 1 : 0;
    a:
    {
     if(_cC_)
      var _cD_ = _cC_;
     else{
      var _cE_ = lev <= c[6] ? 1 : 0;
      if(_cE_){
   ...
   function start_table_row(c, heading){
    if(1 - close_row(c)){end_paragraph(c, 0); c[12] = _b0_;}
    ...
    for(;;){
     ...
     switch(ocaml_lex_state$0){
       ...
       case 4:
        end_paragraph(c, 0);
        var _cx_ = c[11];
        c[11] = [0, caml_call1(c[1][19], 0), _cx_];
        break;
       case 5:
        end_paragraph(c, 0);
        for(;;){
         ...
         switch(ocaml_lex_state$2){
           case 0:
            var s$0 = lexeme(lexbuf), _cy_ = c[9];
            c[9] =
             [0, sub$0(s$0, 1, caml_ml_string_length(s$0) - 1 | 0), _cy_];
            break;
           case 1:
            var _cz_ = c[11], _cA_ = rev(c[9]);
            c[11] = [0, caml_call1(c[1][10], _cA_), _cz_];
            c[9] = 0;
            if(counter >= 50)
             return caml_trampoline_return(parse_bol$0, [0, c, lexbuf]);
            var counter$6 = counter + 1 | 0;
            return parse_bol$0(counter$6, c, lexbuf);
           default: var _cB_ = c[9]; c[9] = [0, lexeme(lexbuf), _cB_];
         }
        }
        break;
       case 6:
   ...
   function parse_rem(counter, c, lexbuf){
    ...
    if(counter >= 50)
     return caml_trampoline_return
             (ocaml_lex_parse_rem_rec, [0, c, lexbuf, _ct_]);
    var counter$0 = counter + 1 | 0;
    return ocaml_lex_parse_rem_rec(counter$0, c, lexbuf, _ct_);
   }
      ...
      switch(ocaml_lex_state$1){
        ...
        case 4:
         ...
         var
          ...
          _cl_ = c[7],
          _cm_ = [0, caml_call1(c[1][1], addr), 0];
         c[7] = [0, caml_call2(c[1][7], addr, _cm_), _cl_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$2 = counter + 1 | 0;
         return parse_rem(counter$2, c, lexbuf);
        case 5:
         ...
         var
          ...
          _cn_ = c[7],
          _co_ = [0, caml_call1(c[1][1], addr$0), 0];
         c[7] = [0, caml_call2(c[1][8], addr$0, _co_), _cn_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$3 = counter + 1 | 0;
         return parse_rem(counter$3, c, lexbuf);
        ...
        case 8:
         ...
         var
          ...
          _cp_ = c[7],
          _cq_ = [0, caml_call1(c[1][1], addr$3), 0];
         c[7] = [0, caml_call2(c[1][7], addr$3, _cq_), _cp_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$6 = counter + 1 | 0;
        ...
        case 11:
         var
          ...
          _cr_ = caml_call1(c[1][1], txt),
          _cs_ = [0, caml_call1(c[1][21], _cr_), 0];
         push(c, caml_call1(c[1][6], _cs_));
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$8 = counter + 1 | 0;
     ...
     _ch_ =
       map
        (function(param){
          ...
          if(l1$0){
           var _ci_ = l1$0[2], h1 = l1$0[1];
           if(_ci_){
            var match = _ci_[2], h2 = _ci_[1];
            if(match){
             var
              tl = match[2],
              h3 = match[1],
             ...
             for(;;){
              if(l1){
               var _cj_ = l1[2], h1$0 = l1[1];
               if(_cj_){
                var match$0 = _cj_[2], h2$0 = _cj_[1];
                if(match$0){
                 var
                  tl$0 = match$0[2],
                  h3$0 = match$0[1],
               ...
               dst[1 + offset] = l2;
              var _ck_ = [0, h1, [0, h2, block]];
              break;
             }
            }
            else
             var _ck_ = [0, h1, [0, h2, l2]];
           }
           else
            var _ck_ = [0, h1, l2];
          }
           ...
           var _ck_ = l2;
          return symbol(t3.createElement("li"), _ck_);
         },
         c);
    return symbol(t3.createElement(t0), _ch_);
   }
   var
    builder =
      [0,
       ...
       function(s){
        ...
        if(s){
         a:
         {
          ...
          var _cf_ = caml_ml_string_length(hd) + acc | 0;
         }
         var dst = caml_create_bytes(_cf_), pos = pos$1, param$0 = s;
         for(;;){
          if(param$0){
           var hd$0 = param$0[1];
           if(param$0[2]){
          ...
          var _cg_ = caml_string_of_bytes(dst);
          break;
         }
        }
        else
         var _cg_ = _m_;
        var t32 = caml_jsstring_of_string(_cg_);
       ...
       function(s){return list_builder(document, _b6_, s);},
       function(s){return list_builder(document, _b5_, s);},
               ...
               _ce_ =
                 map
                  (function(param){
                   ...
                   entries);
              return symbol(document.createElement("tr"), _ce_);
             },
             rows),
         _cd_ = [0, symbol(document.createElement("tbody"), rows$0), 0];
        return symbol(document.createElement("table"), _cd_);
       },
       function(x){return x;}],
    ...
    function dyn_preview(old_text, n){
     ...
     if(text !== old_text){
      try{
       ...
       var
        _b9_ = rev(c[11]),
        rendered = symbol(createElement(document, name), _b9_),
      ...
      var
       y = n - 1 | 0,
       x = 0,
       _b__ = caml_greaterequal(0, y) ? x : y,
       n$0 = _b__;
     var d$0 = 0 === n$0 ? 0.5 : 0.1, p = new_pending(1), d = d$0 * 1000.;
     function callback$0(v){
      var result$0 = [0, v], p$0 = underlying(p), _cb_ = p$0[1];
      switch(_cb_[0]){
        case 1:
         return _cb_[1] === Canceled
                 ? 0
                 : caml_call1(ksprintf(invalid_arg, _bL_), api_function_name);
        case 2:
         if(0 === result$0[0])
          var x = result$0[1], result = [0, x];
         else
          var exn = result$0[1], result = [1, exn];
         resolve(_bM_, 0, p$0, result);
         return 0;
        default:
         return caml_call1(ksprintf(invalid_arg, _bK_), api_function_name);
      }
     }
     var id = [0, 0];
     function loop(d, param){
      ...
      var
       cb =
         remain == 0.
          ? callback$0
          : function(_ca_){return loop(remain, _ca_);},
     ...
     function create_result_promise_and_call(param){
      ...
      function callback(p_result){
       if(1 === p_result[0]){
        var p$0 = underlying(p);
        resolve(_bP_, 0, p$0, p_result);
        return 0;
       }
       current_storage[1] = saved_storage;
       try{var _b$_ = dyn_preview(text, n$0), user_provided_promise = _b$_;}
       catch(exn$0){
        var exn = caml_wrap_exception(exn$0);
       ...
       if(p1 !== outer_promise){
        ...
        switch(match[0]){
          case 1:
           resolve(_bO_, 0, outer_promise, p1[1]); break;
          case 2:
           var
            p_callbacks = match[1],
           ...
           p1[1] = state;
           break;
          default: resolve(_bN_, 0, outer_promise, p1[1]);
        }
       }
       return 0;
      }
