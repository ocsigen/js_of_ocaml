...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ei_ = caml_wrap_exception(_ej_);
      if(_ei_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ei_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function engine(tbl, state, buf){
    var
     ...
     _ef_ = 0 <= result ? 1 : 0,
     _eg_ = _ef_ ? buf[12] !== dummy_pos ? 1 : 0 : _ef_;
    if(_eg_){
     buf[11] = buf[12];
     var _eh_ = buf[12];
     buf[12] = [0, _eh_[1], _eh_[2], _eh_[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
   ...
   var
    at_exit_key = new_key(0, function(param, _ee_){return 0;}),
    _n_ = "Array.blit";
   ...
   function string_of_formatting_lit(formatting_lit){
    ...
    switch(formatting_lit[0]){
      ...
      default:
       ...
       return "@" + caml_string_of_bytes(make(1, c));
    }
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _ed_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _ed_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _eb_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _eb_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ec_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ec_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ec_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _d$_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _d$_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _ea_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _ea_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _d2_ = caml_ml_bytes_length(b) - 1 | 0,
     _d1_ = 0;
    if(_d2_ >= 0){
     var i$0 = _d1_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _d4_ = caml_ml_bytes_length(b) - 1 | 0, _d3_ = 0;
     if(_d4_ >= 0){
      var i = _d3_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dW_ = caml_ml_string_length(s) - 1 | 0, _dV_ = 0;
    if(_dW_ >= 0){
     var i$0 = _dV_;
     for(;;){
    ...
    var
     ...
     _dY_ = caml_ml_string_length(s) - 1 | 0,
     _dX_ = 0;
    if(_dY_ >= 0){
     var i = _dX_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dR_ = _ar_; break;
      default: var _dR_ = _aA_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dR_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dO_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dO_ >>> 0){
           if(55 === _dO_) break a;
          }
          else if(21 < _dO_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dQ_ = _dP_ ? str : str + cst$2;
        return caml_special_val(_dQ_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dK_ = l - 1 | 0, _dJ_ = 0;
        if(_dK_ >= 0){
         var i = _dJ_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dL_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dL_);
          var _dM_ = i + 1 | 0;
          if(_dK_ === i) break;
          i = _dM_;
         }
       ...
       return caml_string_of_bytes(_dN_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dG_ = fmt$0[1];
        if(0 === _dG_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dG_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dG_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dH_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dH_);
     }
    }
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bg_), _dC_, _dB_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dA_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dx_ = field(e, 1),
       _dz_ = caml_call2(sprintf(_bh_), _dx_, _dw_);
     else
      switch(match){
        case 0:
         var _dz_ = _bi_; break;
        case 1:
         var _dz_ = _bj_; break;
        default:
         var _dy_ = field(e, 1), _dz_ = caml_call1(sprintf(_bk_), _dy_);
      }
     var match$0 = [0, constructor, [0, _dz_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dm_ = slot[4],
        _dn_ = slot[3],
        _do_ = slot[6] ? _bu_ : _bw_,
        _dp_ = slot[2],
        _dq_ = slot[7],
        _dr_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bv_), _dr_, _dq_, _dp_, _do_, _dn_, _dm_, _dl_)];
      else if(slot[1])
       var match = 0;
      else
       var _ds_ = info(0), match = [0, caml_call1(sprintf(_bx_), _ds_)];
   ...
   var
    ...
    _bA_ = "Fatal error: out of memory in uncaught exception handler",
    _bB_ =
      [0,
       [11, cst_Fatal_error_exception, [2, 0, [12, 10, 0]]],
       cst_Fatal_error_exception_s],
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _c$_ = to_string(exn$0);
       caml_call1(eprintf(_bz_), _c$_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _da_ = abs(status);
        prerr_endline(caml_check_bound(errors, _da_)[1 + _da_]);
       }
       var _db_ = caml_ml_flush(stderr), _df_ = _db_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dd_ = to_string(exn$0);
       caml_call1(eprintf(_bB_), _dd_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _de_ = to_string(exn);
       caml_call1(eprintf(_bC_), _de_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _df_ = caml_ml_flush(stderr);
      }
      var _dg_ = _df_;
     }
     catch(_di_){
      var _dc_ = caml_wrap_exception(_di_);
      if(_dc_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_dc_, 0);
      var _dg_ = prerr_endline(_bA_);
     }
     return _dg_;
    }
    catch(_dh_){return 0;}
   ...
   var
    ...
    _bV_ = [0, 0],
    _bR_ = cst_Fatal_error_exception,
    _bS_ = "Lwt.Resolution_loop.Canceled",
    _b2_ = "Exception during Lwt.async: ",
    _b6_ = [0, cst_examples_wiki_wikicreole_m, 207, 32],
    _b7_ = [0, cst_examples_wiki_wikicreole_m, 216, 6],
    _b8_ = [0, cst_examples_wiki_wikicreole_m, 231, 6],
    _b__ = [0, cst_examples_wiki_wikicreole_m, 285, 6],
    _b$_ = "*",
    _b9_ = [5, 0],
    _b5_ = [0, cst_examples_wiki_wikicreole_m, 158, 6],
    _b3_ = "//",
    _b4_ = "**",
    _cd_ = "ul",
    _cc_ = "ol",
    _ca_ = "th",
    _cb_ = "td",
    _ce_ = [0, "examples/wiki/main.ml", 33, 70],
    _cf_ = cst,
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c__ = caml_call1(f, v); return _c__;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c9_ = result[1] === Canceled ? 1 : 0, is_canceled = _c9_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _c8_ = deferred_callbacks[2];
      if(! _c8_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _c8_[1];
      if(_c8_[2]){
       var next = _c8_[2];
   ...
   function count(c, s){
    var n = [0, 0], _c6_ = caml_ml_string_length(s) - 1 | 0, _c5_ = 0;
    if(_c6_ >= 0){
     var i = _c5_;
     for(;;){
   ...
   function push(c, v){
    var _c3_ = c[12];
    if(typeof _c3_ !== "number" && 1 === _c3_[0]){c[8] = [0, v, c[8]]; return;}
    var _c4_ = c[7];
    c[7] = [0, caml_call1(c[1][21], v), _c4_];
    return;
   }
   ...
   function style_change(c, style){
    ...
    return style ? push_string(c, _b3_) : push_string(c, _b4_);
   }
   function pop_link(c, addr, stack){
    c[12] = stack;
    var _c0_ = c[7], _c1_ = rev(c[8]);
     ...
     switch(_cY_[0]){
       ...
       case 7:
        ...
        if(typeof match !== "number" && 6 === match[0]){
         var stack = match[2], entries = match[1], heading = _cY_[1];
     ...
     switch(_cX_[0]){
       ...
       case 6:
        ...
        if(typeof match !== "number" && 5 === match[0]){
         var rows = match[1], entries = _cX_[1];
   ...
   function end_paragraph(c, lev){
    for(;;){
     ...
     if(typeof match === "number"){
      if(0 !== c[7]){
       var _cO_ = c[11], _cP_ = rev(c[7]);
       c[11] = [0, caml_call1(c[1][9], _cP_), _cO_];
       c[7] = 0;
      }
      c[12] = 0;
      return;
     ...
     switch(match[0]){
       ...
       case 2:
        ...
        var _cQ_ = c[11];
        c[11] = [0, caml_call1(f, rev(c[7])), _cQ_];
        c[7] = 0;
        c[4] = 0;
        c[12] = 0;
        return;
       case 3:
        var stack$1 = match[1], _cR_ = c[10];
        c[10] = [0, [0, rev(c[7]), 0], _cR_];
        c[12] = stack$1;
        c[7] = 0;
        break;
       case 4:
        ...
        break;
       case 5:
        var rows = match[1], _cU_ = c[11], _cV_ = rev(rows);
        c[11] = [0, caml_call1(c[1][20], _cV_), _cU_];
        c[12] = 0;
        return;
       case 6:
   ...
   function start_list_item(c, kind, lev){
    var _cL_ = lev === (c[6] + 1 | 0) ? 1 : 0;
    a:
    {
     if(_cL_)
      var _cM_ = _cL_;
     else{
      var _cN_ = lev <= c[6] ? 1 : 0;
      if(_cN_){
   ...
   function start_table_row(c, heading){
    if(1 - close_row(c)){end_paragraph(c, 0); c[12] = _b9_;}
    ...
    for(;;){
     ...
     switch(ocaml_lex_state$0){
       ...
       case 4:
        end_paragraph(c, 0);
        var _cG_ = c[11];
        c[11] = [0, caml_call1(c[1][19], 0), _cG_];
        break;
       case 5:
        end_paragraph(c, 0);
        for(;;){
         ...
         switch(ocaml_lex_state$2){
           case 0:
            var s$0 = lexeme(lexbuf), _cH_ = c[9];
            c[9] =
             [0, sub$0(s$0, 1, caml_ml_string_length(s$0) - 1 | 0), _cH_];
            break;
           case 1:
            var _cI_ = c[11], _cJ_ = rev(c[9]);
            c[11] = [0, caml_call1(c[1][10], _cJ_), _cI_];
            c[9] = 0;
            if(counter >= 50)
             return caml_trampoline_return(parse_bol$0, [0, c, lexbuf]);
            var counter$6 = counter + 1 | 0;
            return parse_bol$0(counter$6, c, lexbuf);
           default: var _cK_ = c[9]; c[9] = [0, lexeme(lexbuf), _cK_];
         }
        }
        break;
       case 6:
   ...
   function parse_rem(counter, c, lexbuf){
    ...
    if(counter >= 50)
     return caml_trampoline_return
             (ocaml_lex_parse_rem_rec, [0, c, lexbuf, _cC_]);
    var counter$0 = counter + 1 | 0;
    return ocaml_lex_parse_rem_rec(counter$0, c, lexbuf, _cC_);
   }
      ...
      switch(ocaml_lex_state$1){
        ...
        case 4:
         ...
         var
          ...
          _cu_ = c[7],
          _cv_ = [0, caml_call1(c[1][1], addr), 0];
         c[7] = [0, caml_call2(c[1][7], addr, _cv_), _cu_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$2 = counter + 1 | 0;
         return parse_rem(counter$2, c, lexbuf);
        case 5:
         ...
         var
          ...
          _cw_ = c[7],
          _cx_ = [0, caml_call1(c[1][1], addr$0), 0];
         c[7] = [0, caml_call2(c[1][8], addr$0, _cx_), _cw_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$3 = counter + 1 | 0;
         return parse_rem(counter$3, c, lexbuf);
        ...
        case 8:
         ...
         var
          ...
          _cy_ = c[7],
          _cz_ = [0, caml_call1(c[1][1], addr$3), 0];
         c[7] = [0, caml_call2(c[1][7], addr$3, _cz_), _cy_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$6 = counter + 1 | 0;
        ...
        case 11:
         var
          ...
          _cA_ = caml_call1(c[1][1], txt),
          _cB_ = [0, caml_call1(c[1][21], _cA_), 0];
         push(c, caml_call1(c[1][6], _cB_));
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$8 = counter + 1 | 0;
     ...
     _cq_ =
       map
        (function(param){
          ...
          if(l1$0){
           var _cr_ = l1$0[2], h1 = l1$0[1];
           if(_cr_){
            var match = _cr_[2], h2 = _cr_[1];
            if(match){
             var
              tl = match[2],
              h3 = match[1],
             ...
             for(;;){
              if(l1){
               var _cs_ = l1[2], h1$0 = l1[1];
               if(_cs_){
                var match$0 = _cs_[2], h2$0 = _cs_[1];
                if(match$0){
                 var
                  tl$0 = match$0[2],
                  h3$0 = match$0[1],
               ...
               dst[1 + offset] = l2;
              var _ct_ = [0, h1, [0, h2, block]];
              break;
             }
            }
            else
             var _ct_ = [0, h1, [0, h2, l2]];
           }
           else
            var _ct_ = [0, h1, l2];
          }
           ...
           var _ct_ = l2;
          return symbol(d.createElement("li"), _ct_);
         },
         c);
    return symbol(d.createElement(caml_jsstring_of_string(tag)), _cq_);
   }
   var
    builder =
      [0,
       ...
       function(param){return document.createElement(cst_br);},
       function(addr, alt){
        var
         t23 = unsafeCreateElement(document, _bP_),
       ...
       function(addr, s){
        var
         t11 = unsafeCreateElement(document, _bO_),
         t10 = caml_jsstring_of_string(addr);
        t11.href = t10;
        return symbol(t11, s);
       },
       function(addr, s){
        var t13 = unsafeCreateElement(document, _bQ_);
        t13.width = "480";
        t13.height = "360";
        var
         ...
         video_link =
           ...
           + caml_string_of_jsstring(global.encodeURI(s$0)),
       ...
       function(s){
        ...
        if(s){
         ...
         var _cp_ = _m_;
        appendChild(p, document.createTextNode(caml_jsstring_of_string(_cp_)));
        return p;
       },
       ...
       function(s){return list_builder(document, _cd_, s);},
       function(s){return list_builder(document, _cc_, s);},
       function(param){return document.createElement("hr");},
       function(rows){
        var
         rows$0 =
           map
               ...
               _cn_ =
                 map
                  (function(param){
                   ...
                   entries);
              return symbol(document.createElement("tr"), _cn_);
             },
             rows),
         _cm_ = [0, symbol(document.createElement("tbody"), rows$0), 0];
        return symbol(document.createElement("table"), _cm_);
       },
       function(x){return x;}],
   ...
   function onload(param){
    ...
    appendChild(body, unsafeCreateElement(document, _bN_));
    ...
    function dyn_preview(old_text, n){
     ...
     if(text !== old_text){
      try{
       ...
       var
        _cg_ = rev(c[11]),
        rendered = symbol(createDiv(document), _cg_),
     ...
     function loop(d, param){
      ...
      var
       cb =
         remain == 0.
          ? callback$0
          : function(_cj_){return loop(remain, _cj_);};
     ...
     function create_result_promise_and_call(param){
      ...
      function callback(p_result){
       if(1 === p_result[0]){
        ...
        resolve(_bY_, 0, p$1, p_result);
        return 0;
       }
       var v = p_result[1];
       current_storage[1] = saved_storage;
       try{var _ci_ = f$0(v), user_provided_promise = _ci_;}
       catch(exn$0){
        var exn = caml_wrap_exception(exn$0);
       ...
       if(p$0 !== outer_promise){
        ...
        switch(match[0]){
          case 1:
           resolve(_bX_, 0, outer_promise, p$0[1]); break;
          case 2:
           var
            p_callbacks = match[1],
           ...
           break;
          default: resolve(_bW_, 0, outer_promise, p$0[1]);
        }
       }
       return 0;
      }
