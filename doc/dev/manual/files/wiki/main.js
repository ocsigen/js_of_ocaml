...
(function(globalThis){
   ...
   var
    ...
    _b__ = "//",
    _b$_ = "**",
    _cl_ = "http://youtube.com/embed/",
    _ck_ = "ul",
    _cj_ = "ol",
    _ch_ = "th",
    _ci_ = "td",
    _cm_ = [0, "examples/wiki/main.ml", 33, 70],
    _cn_ = cst$0;
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ez_ = caml_wrap_exception(_eA_);
      if(_ez_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ez_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function engine(tbl, state, buf){
    var
     ...
     _ew_ = 0 <= result ? 1 : 0,
     _ex_ = _ew_ ? buf[12] !== dummy_pos ? 1 : 0 : _ew_;
    if(_ex_){
     buf[11] = buf[12];
     var _ey_ = buf[12];
     buf[12] = [0, _ey_[1], _ey_[2], _ey_[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _d5_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _d5_ >>> 0){
           if(55 === _d5_) break a;
          }
          else if(21 < _d5_ - 1 >>> 0) break a;
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dQ_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _do_ = caml_call1(f, v); return _do_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _dn_ = result[1] === Canceled ? 1 : 0, is_canceled = _dn_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _dm_ = deferred_callbacks[2];
      if(! _dm_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _dm_[1];
      if(_dm_[2]){
       var next = _dm_[2];
   ...
   function push(c, v){
    var _dh_ = c[12];
    if(typeof _dh_ !== "number" && 1 === _dh_[0]){c[8] = [0, v, c[8]]; return;}
    var _di_ = c[7];
    c[7] = [0, caml_call1(c[1][21], v), _di_];
    return;
   }
   ...
   function pop_link(c, addr, stack){
    c[12] = stack;
    var _de_ = c[7], _df_ = rev(c[8]);
    c[7] = [0, caml_call2(c[1][7], addr, _df_), _de_];
    c[8] = 0;
    c[5] = 0;
    return;
   }
     ...
     switch(_dc_[0]){
       ...
       case 7:
        ...
        if(typeof match !== "number" && 6 === match[0]){
         var stack = match[2], entries = match[1], heading = _dc_[1];
     ...
     switch(_db_[0]){
       ...
       case 6:
        ...
        if(typeof match !== "number" && 5 === match[0]){
         var rows = match[1], entries = _db_[1];
   ...
   function end_paragraph(c, lev){
    for(;;){
     ...
     if(typeof match === "number"){
      if(0 !== c[7]){
       var _c4_ = c[11], _c5_ = rev(c[7]);
       c[11] = [0, caml_call1(c[1][9], _c5_), _c4_];
       c[7] = 0;
      }
      c[12] = 0;
      return;
     ...
     switch(match[0]){
       ...
       case 2:
        ...
        var _c6_ = c[11];
        c[11] = [0, caml_call1(f, rev(c[7])), _c6_];
        c[7] = 0;
        c[4] = 0;
        c[12] = 0;
        return;
       case 3:
        var stack$1 = match[1], _c7_ = c[10];
        c[10] = [0, [0, rev(c[7]), 0], _c7_];
        c[12] = stack$1;
        c[7] = 0;
        break;
       case 4:
        ...
        break;
       case 5:
        var rows = match[1], _c__ = c[11], _c$_ = rev(rows);
        c[11] = [0, caml_call1(c[1][20], _c$_), _c__];
        c[12] = 0;
        return;
       case 6:
   ...
   function start_list_item(c, kind, lev){
    var _c1_ = lev === (c[6] + 1 | 0) ? 1 : 0;
    a:
    {
     if(_c1_)
      var _c2_ = _c1_;
     else{
      var _c3_ = lev <= c[6] ? 1 : 0;
      if(_c3_){
    ...
    for(;;){
     ...
     switch(ocaml_lex_state$0){
       ...
       case 4:
        end_paragraph(c, 0);
        var _cW_ = c[11];
        c[11] = [0, caml_call1(c[1][19], 0), _cW_];
        break;
       case 5:
        end_paragraph(c, 0);
        for(;;){
         ...
         switch(ocaml_lex_state$2){
           case 0:
            var s$0 = lexeme(lexbuf), _cX_ = c[9];
            c[9] =
             [0, sub$0(s$0, 1, caml_ml_string_length(s$0) - 1 | 0), _cX_];
            break;
           case 1:
            var _cY_ = c[11], _cZ_ = rev(c[9]);
            c[11] = [0, caml_call1(c[1][10], _cZ_), _cY_];
            c[9] = 0;
            if(counter >= 50)
             return caml_trampoline_return(parse_bol$0, [0, c, lexbuf]);
            var counter$6 = counter + 1 | 0;
            return parse_bol$0(counter$6, c, lexbuf);
           default: var _c0_ = c[9]; c[9] = [0, lexeme(lexbuf), _c0_];
         }
        }
        break;
       case 6:
   ...
   function parse_rem(counter, c, lexbuf){
    ...
    if(counter >= 50)
     return caml_trampoline_return
             (ocaml_lex_parse_rem_rec, [0, c, lexbuf, _cS_]);
    var counter$0 = counter + 1 | 0;
    return ocaml_lex_parse_rem_rec(counter$0, c, lexbuf, _cS_);
   }
      ...
      switch(ocaml_lex_state$1){
        ...
        case 4:
         ...
         var
          ...
          _cK_ = c[7],
          _cL_ = [0, caml_call1(c[1][1], addr), 0];
         c[7] = [0, caml_call2(c[1][7], addr, _cL_), _cK_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$2 = counter + 1 | 0;
         return parse_rem(counter$2, c, lexbuf);
        case 5:
         ...
         var
          ...
          _cM_ = c[7],
          _cN_ = [0, caml_call1(c[1][1], addr$0), 0];
         c[7] = [0, caml_call2(c[1][8], addr$0, _cN_), _cM_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$3 = counter + 1 | 0;
         return parse_rem(counter$3, c, lexbuf);
        ...
        case 8:
         ...
         var
          ...
          _cO_ = c[7],
          _cP_ = [0, caml_call1(c[1][1], addr$3), 0];
         c[7] = [0, caml_call2(c[1][7], addr$3, _cP_), _cO_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$6 = counter + 1 | 0;
        ...
        case 11:
         var
          ...
          _cQ_ = caml_call1(c[1][1], txt),
          _cR_ = [0, caml_call1(c[1][21], _cQ_), 0];
         push(c, caml_call1(c[1][6], _cR_));
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$8 = counter + 1 | 0;
     ...
     _cG_ =
       map
        (function(param){
          ...
          if(l1$0){
           var _cH_ = l1$0[2], h1 = l1$0[1];
           if(_cH_){
            var match = _cH_[2], h2 = _cH_[1];
            if(match){
             var
              tl = match[2],
              h3 = match[1],
             ...
             for(;;){
              if(l1){
               var _cI_ = l1[2], h1$0 = l1[1];
               if(_cI_){
                var match$0 = _cI_[2], h2$0 = _cI_[1];
                if(match$0){
                 var
                  tl$0 = match$0[2],
                  h3$0 = match$0[1],
               ...
               dst[1 + offset] = l2;
              var _cJ_ = [0, h1, [0, h2, block]];
              break;
             }
            }
            else
             var _cJ_ = [0, h1, [0, h2, l2]];
           }
           else
            var _cJ_ = [0, h1, l2];
          }
           ...
           var _cJ_ = l2;
          return symbol$0(d.createElement("li"), _cJ_);
         },
         c);
    return symbol$0(d.createElement(caml_jsstring_of_string(tag)), _cG_);
   }
   var
    builder =
      [0,
       ...
       function(addr, s){
        ...
        var
         ...
         video_link =
           symbol(_cl_, caml_string_of_jsstring(global.encodeURI(s$0))),
       ...
       function(s){
        ...
        if(s){
         a:
         {
          ...
          var _cE_ = caml_ml_string_length(hd) + acc | 0;
         }
         var dst = caml_create_bytes(_cE_), pos = pos$1, param$0 = s;
         for(;;){
          if(param$0){
           var hd$0 = param$0[1];
           if(param$0[2]){
          ...
          var _cF_ = caml_string_of_bytes(dst);
          break;
         }
        }
        else
         var _cF_ = _n_;
        appendChild(p, document.createTextNode(caml_jsstring_of_string(_cF_)));
        return p;
       },
       ...
       function(s){return list_builder(document, _ck_, s);},
       function(s){return list_builder(document, _cj_, s);},
            ...
            (function(entries){
              var
               _cD_ =
                 map
                  (function(param){
                    var c = param[2], h = param[1], kind = h ? _ch_ : _ci_;
                    return symbol$0
                            (document.createElement(caml_jsstring_of_string(kind)), c);
                   },
                   entries);
              return symbol$0(document.createElement("tr"), _cD_);
             },
             rows),
         _cC_ = [0, symbol$0(document.createElement("tbody"), rows$0), 0];
        return symbol$0(document.createElement("table"), _cC_);
       },
       function(x){return x;}];
    ...
    function dyn_preview(old_text, n){
     ...
     if(caml_string_notequal(text, old_text)){
      try{
       ...
       var
        ...
        _ct_ = 0,
        _cu_ = 0,
        _cv_ = caml_ml_string_length(text),
        lexbuf =
          [0,
       ...
       var
        _cw_ = rev(c[11]),
        rendered = symbol$0(createDiv(document), _cw_),
     ...
     function loop(d, param){
      ...
      var
       cb =
         remain == 0.
          ? callback$0
          : function(_cz_){return loop(remain, _cz_);};
     ...
     function create_result_promise_and_call(param){
      ...
      function callback(p_result){
       ...
       try{var _cy_ = f$0(v), user_provided_promise = _cy_;}
       catch(exn$0){
        var exn = caml_wrap_exception(exn$0);
