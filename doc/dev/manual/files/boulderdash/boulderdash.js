...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      if(_fI_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fI_, 0);
     }
     param$0 = l;
    }
   }
   ...
   var _r_ = "Buffer.add: cannot grow buffer";
   ...
   function do_at_exit$0(param){
    ...
    if(oldval !== none)
     ...
     var
      ...
      _fE_ = curval === oldval ? (st$1[1 + idx] = new_obj, 1) : 0;
     if(_fE_)
      var f = new_obj;
     else{
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _fD_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _fD_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fC_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fC_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fC_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _fz_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _fz_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _fA_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _fA_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _fy_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _fy_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _fq_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _fp_ = 0;
    if(_fq_ >= 0){
     var i$0 = _fp_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _fs_ = caml_ml_bytes_length(s$0) - 1 | 0, _fr_ = 0;
     if(_fs_ >= 0){
      var i = _fr_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_fx_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _fk_ = caml_ml_string_length(s) - 1 | 0, _fj_ = 0;
    if(_fk_ >= 0){
     var i$0 = _fj_;
     for(;;){
    ...
    var
     ...
     _fm_ = caml_ml_string_length(s) - 1 | 0,
     _fl_ = 0;
    if(_fm_ >= 0){
     var i = _fl_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ff_ = _aw_; break;
      default: var _ff_ = _aF_;
    }
    return transform_int_alt(iconv, caml_int64_format(_ff_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fc_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fc_ >>> 0){
           if(55 === _fc_) break a;
          }
          else if(21 < _fc_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _fe_ = _fd_ ? str : str + cst$3;
        return caml_special_val(_fe_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _e__ = l - 1 | 0, _e9_ = 0;
        if(_e__ >= 0){
         var i = _e9_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _e$_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _e$_);
          var _fa_ = i + 1 | 0;
          if(_e__ === i) break;
          i = _fa_;
         }
       ...
       return caml_string_of_bytes(_fb_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _e8_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _e8_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _e8_[1];
       ...
       case 18:
        var _e6_ = fmt$0[1];
        if(0 === _e6_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _e6_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _e6_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _e7_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _e7_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _e4_ = [8, acc, _bc_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _e4_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _e4_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _e3_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _e3_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _e3_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bl_), _e2_, _e1_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_e0_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _eX_ = field(e, 1),
       _eZ_ = caml_call2(sprintf(_bm_), _eX_, _eW_);
     else
      switch(match){
        case 0:
         var _eZ_ = _bn_; break;
        case 1:
         var _eZ_ = _bo_; break;
        default:
         var _eY_ = field(e, 1), _eZ_ = caml_call1(sprintf(_bp_), _eY_);
      }
   ...
   function print_raw_backtrace(outchan, raw_backtrace){
    ...
    if(_eU_ >= 0){
     ...
     for(;;){
      ...
      if(0 === slot[0]){
       if(slot[3] === slot[6])
        var _eJ_ = slot[3], lines = caml_call1(sprintf(_bz_), _eJ_);
       else
        var
         _eQ_ = slot[6],
         _eR_ = slot[3],
         lines = caml_call2(sprintf(_bD_), _eR_, _eQ_);
       var
        _eK_ = slot[7],
        _eL_ = slot[4],
        _eM_ = slot[8] ? _bA_ : _bC_,
        _eN_ = slot[2],
        _eO_ = slot[9],
        _eP_ = info(slot[1]),
        match =
          [0,
           caml_call7
            (sprintf(_bB_), _eP_, _eO_, _eN_, _eM_, lines, _eL_, _eK_)];
      }
      else if(slot[1])
       var match = 0;
      else
       var _eS_ = info(0), match = [0, caml_call1(sprintf(_bE_), _eS_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_eH_){}
      try{
       var _ex_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _ex_);
       ...
       var _eE_ = caml_ml_flush(stderr), _eC_ = _eE_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _eA_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _eA_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eB_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _eB_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _eC_ = caml_ml_flush(stderr);
      }
      var _eD_ = _eC_;
     }
     catch(_eG_){
      var _ez_ = caml_wrap_exception(_eG_);
      if(_ez_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_ez_, 0);
      var _eD_ = prerr_endline(_bG_);
     }
     return _eD_;
    }
    catch(_eF_){return 0;}
   ...
   function BLAKE2(X){
    var _ev_ = X[1] < 1 ? 1 : 0, _ew_ = _ev_ || (64 < X[1] ? 1 : 0);
    if(_ew_) invalid_arg(_bH_);
   }
   BLAKE2([0, 16]);
   BLAKE2([0, 32]);
   BLAKE2([0, 64]);
   ...
   function mk(i1, i2, i3$0, i4$0){
    ...
    var i3 = caml_notequal(i3$0, _bJ_) ? i3$0 : _bM_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bK_) ? i4$0 : _bL_;
   ...
   var
    ...
    _n_ = "String.concat",
    _bR_ = "[\\][()\\\\|+*.?{}^$]",
    _bS_ = "Js_of_ocaml__Url.Local_exn",
    _bV_ = "Lwt_sequence.Empty",
    _b$_ = [0, 0],
    _ca_ = [0, 1],
    _b9_ = [0, 0],
    _b__ = [0, 1],
    ...
    _b1_ = "wakeup_exn",
    _b0_ = "wakeup",
    _bX_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bY_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bZ_ = [0, 0],
    _bW_ = "Lwt.Resolution_loop.Canceled",
    _cc_ = cst,
    _cb_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cd_ = "Exception during Lwt.async: ",
    _cl_ = [0, [8, [0, 0, 3], 0, 0, 0], "%g"],
    _cm_ = "malformed level",
    _cn_ = "Boulder Dash in Ocaml",
    _co_ = "Elapsed time: ",
    _cp_ = " Remaining diamonds: ",
    _cq_ = cst$2,
    _cr_ = "Choose a level",
    _cj_ = [0, "examples/boulderdash/boulderdash.ml", 335, 72],
    _ck_ = "--",
    _cs_ = "maps.txt",
    _cg_ =
      [0,
    ...
    _cf_ = "--:--:--",
    _ce_ = "LOADING...",
    _ch_ = "Dune__exe__Boulderdash.Death",
    _ci_ = "Dune__exe__Boulderdash.Eos",
   ...
   var
    ...
    quote_re = regexp(_bR_),
    Local_exn = [248, _bS_, caml_fresh_oo_id(0)];
   function interrupt(param){throw caml_maybe_attach_backtrace(Local_exn, 1);}
   var
    plus_re = regexp(caml_string_of_jsbytes(cst$4.replace(quote_re, "\\$&"))),
    plus_re_js_string = new regExp("\\+", cst_g);
   function urldecode_js_string_string(t16){
    plus_re_js_string.lastIndex = 0;
    var s = t16.replace(plus_re_js_string, cst$2);
   ...
   if(test(global.location))
    ...
    var
     t42 = function(_eu_, param){return 0;},
     t41 = function(_et_, param){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _bU_ = caml_wrap_exception(_es_);
    if(_bU_[1] !== Failure) throw caml_maybe_attach_backtrace(_bU_, 0);
   }
   var
     ...
     a:
     {
      ...
      if(0 <= i$1 && lim >= i$1){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _eq_ = i; break a;}
        var i$0 = i + 1 | 0;
        i = i$0;
       }
      }
      var _eq_ = invalid_arg(_p_);
     }
     var j = _eq_;
    }
    catch(_er_){
     var _ep_ = caml_wrap_exception(_er_);
   ...
   if(a && a[1] === cst){
    var _bT_ = a[2];
    if(! _bT_ || _bT_[1] === cst && ! _bT_[2]) break a;
   }
   var t49 = t43.search;
   if(t49.charAt(0) == "?")
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
      var t3 = arr[idx$0], _el_ = idx$0 - 1 | 0;
      if(t3 === undefined$0)
       var _en_ = interrupt(0);
      else{
       var
       ...
       if(0 <= index)
        var
         t7 = index + 1 | 0,
         _ej_ = t3.slice(t7),
         x$0 = [0, t3.slice(0, index), _ej_];
       else
        var x$0 = undefined$0;
       if(x$0 === undefined$0)
        var _ei_ = interrupt(0);
       else
        var
         y = x$0[2],
         x = x$0[1],
         _em_ = urldecode_js_string_string(y),
         _ei_ = [0, urldecode_js_string_string(x), _em_];
       var _en_ = _ei_;
      }
      aux$0([0, _en_, acc], _el_);
      return;
     }
     catch(_eo_){
      var _ek_ = caml_wrap_exception(_eo_);
      if(_ek_ !== Local_exn) throw caml_maybe_attach_backtrace(_ek_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   var s2 = cst$4 + "480cee7";
   "5.9.1" + s2;
   var
    console$0 = caml_js_get_console(0),
    Empty$0 = [248, _bV_, caml_fresh_oo_id(0)];
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _eh_ = caml_call1(f, v); return _eh_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _eg_ = result[1] === Canceled ? 1 : 0, is_canceled = _eg_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _ef_ = deferred_callbacks[2];
      if(! _ef_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _ef_[1];
      if(_ef_[2]){
       var next = _ef_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    ...
    switch(_ee_[0]){
      ...
      case 2:
       ...
       resolve(_bZ_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _bX_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_b0_, r, [0, v]);}
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_b6_, 0, outer_promise, p1[1]);
      case 2:
       var
        p_callbacks = match[1],
      ...
      default: return resolve(_b5_, 0, outer_promise, p1[1]);
    }
   }
   ...
   function catch$0(f, h){
    try{var _eb_ = caml_call1(f, 0), p = _eb_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
     var p = fail(exn);
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      var exn = p_result[1];
      current_storage[1] = saved_storage;
      try{var _ec_ = caml_call1(h, exn), p$1 = _ec_;}
      catch(exn){
   ...
   function sleep(d){
    ...
    function callback(_ea_){return wakeup(w, _ea_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain === 0. ? callback : function(_d$_){return loop(remain, _d$_);},
   ...
   function append_text(e, s){
    ...
    return appendChild(e, document.createTextNode(t1));
   }
   ...
   var Death = [248, _ch_, caml_fresh_oo_id(0)];
   ...
   function fall(state){
    var changed = [0, 0], _dH_ = state[1].length - 3 | 0;
    if(_dH_ >= 1){
     var y = _dH_;
     for(;;){
      var
       _dJ_ = caml_check_bound(state[1], y)[1 + y].length - 3 | 0,
       _dI_ = 1;
      if(_dJ_ >= 1){
       var x = _dI_;
       for(;;){
        var
         ...
         _dM_ =
           6
            ===
             caml_check_bound(caml_check_bound(state[1], _dL_)[1 + _dL_], x)
              [1 + x]
            ? 1
            : 0,
         sustaining =
        ...
        if(_dN_)
         var
          ...
          _dP_ =
            3
             ===
              caml_check_bound(caml_check_bound(state[1], _dO_)[1 + _dO_], x)
               [1 + x]
             ? 1
             : 0;
        else
        ...
        if(_dQ_){
         var
          ...
          _dS_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _dR_)[1 + _dR_], x)
               [1 + x]
             ? 1
             : 0;
         if(_dS_){
          var
           ...
           _dU_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _dT_)
                [1 + _dT_]
              ? 1
              : 0;
          if(_dU_)
           var
            ...
            _dX_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _dW_)[1 + _dW_], _dV_)
                 [1 + _dV_]
               ? 1
               : 0;
          else
        ...
        if(_dY_){
         var
          ...
          _d0_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _dZ_)[1 + _dZ_], x)
               [1 + x]
             ? 1
             : 0;
         if(_d0_){
          var
           ...
           _d2_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _d1_)
                [1 + _d1_]
              ? 1
              : 0;
          if(_d2_)
           var
            ...
            _d5_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _d4_)[1 + _d4_], _d3_)
                 [1 + _d3_]
               ? 1
               : 0;
          else
        ...
        if(_d6_)
         var
          ...
          _d8_ =
            6
             ===
              caml_check_bound(caml_check_bound(state[1], _d7_)[1 + _d7_], x)
               [1 + x]
             ? 1
             : 0,
          _d9_ =
    ...
    return changed[1]
            ? symbol_bind(sleep(0.05), function(param){return fall(state);})
            : return$0(0);
   }
   function build_interaction(state, show_rem, clock){
    var clock_stop = clock[3], m = state[7];
    function _c1_(param){
     var _c5_ = state[1].length - 2 | 0, _c4_ = 0;
     if(_c5_ >= 0){
      var y$0 = _c4_;
      for(;;){
       var
        _c7_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 2 | 0,
        _c6_ = 0;
       if(_c7_ >= 0){
        var x$0 = _c6_;
        for(;;){
     ...
     function inhibit(f, x){
      if(1 - state[8]){
       state[8] = 1;
       symbol_bind
        (caml_call1(f, 0), function(param){state[8] = 0; return return$0(0);});
      }
      return false$0;
     }
     function set_pending_out(f, out, param){
      return symbol_bind
              (caml_call1(f, 0),
               function(param){state[9][1] = [0, out]; return return$0(0);});
     }
     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       a:
       {
        if(5 !== param$1 && 3 <= param$1){var _dp_ = 0; break a;}
        var _dp_ = 1;
       }
       if(_dp_){
        var
         ...
         cur_img = t20.src;
        let
         click_cont = click_cont$0,
         out_cont = out_cont$0,
         over_cont = over_cont$0,
         y$0 = y,
         x$0 = x,
         cur_img$0 = cur_img;
        var
         ...
         click_cont$1 =
           function(param){
            return symbol_bind
                    (caml_call1(click_cont, 0),
                     function(param){
                      if
                       (2
                        ===
                         caml_check_bound
                           (caml_check_bound(state[1], y$0)[1 + y$0], x$0)
                          [1 + x$0])
                       state[5] = state[5] - 1 | 0;
         ...
         _dq_ = function(_dG_){return with_pending_out(over_cont$2, _dG_);},
         _dr_ =
           function(_dF_){return set_pending_out(_dv_, out_cont$2, _dF_);};
        let
         over_cont$2 = over_cont$1,
         out_cont$2 = out_cont$1,
         _dv_ = _dq_,
         _dw_ = _dr_;
        var
         t25 = handler(function(_dE_){return inhibit(_dw_, _dE_);}),
         t26 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t26.onmouseover = t25;
        var
         _ds_ = function(param){return return$0(0);},
         _dt_ = function(_dD_){return with_pending_out(_dx_, _dD_);};
        let _dx_ = _ds_, _dy_ = _dt_;
        var
         t27 = handler(function(_dC_){return inhibit(_dy_, _dC_);}),
         t28 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t28.onmouseout = t27;
        let click$0 = click;
        var _du_ = function(_dB_){return with_pending_out(click$0, _dB_);};
        let _dz_ = _du_;
        var
         t29 = handler(function(_dA_){return inhibit(_dz_, _dA_);}),
         t30 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t30.onclick = t29;
        if
     ...
     function update_push(pos, next, img, img_guy){
      ...
      try{
       ...
       var _c__ = caml_wrap_exception(_do_);
      ...
      function click(param){
       ...
       return symbol_bind
               (catch$0
                 (function(param){return fall(state);},
                  function(e){
                   return e === Death ? (state[6] = 1, return$0(0)) : fail(e);
                  }),
                function(param){
      ...
      function _da_(_dn_){return with_pending_out(over, _dn_);}
      function _db_(_dm_){return set_pending_out(_da_, out, _dm_);}
      var
       t39 = handler(function(_dl_){return inhibit(_db_, _dl_);}),
       t40 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t40.onmouseover = t39;
      function _dc_(param){return return$0(0);}
      function _dd_(_dk_){return with_pending_out(_dc_, _dk_);}
      var
       t41 = handler(function(_dj_){return inhibit(_dd_, _dj_);}),
       t42 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t42.onmouseout = t41;
      function _de_(_di_){return with_pending_out(click, _di_);}
      var
       t43 = handler(function(_dh_){return inhibit(_de_, _dh_);}),
       t44 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t44.onclick = t43;
     ...
     if(m[1])
      if(is_empty(m[2]))
       ...
       var node = seq[2];
       remove(node);
       var r = node[3], result$0 = [0, v], p = underlying(r), _c3_ = p[1];
       switch(_c3_[0]){
         case 1:
          if(_c3_[1] !== Canceled)
         ...
         case 2:
          ...
          resolve(0, _b4_, p, result);
          break;
         default: caml_call1(ksprintf(invalid_arg, _b2_), api_function_name);
       }
      }
     return return$0(0);
    }
    ...
    else{m[1] = 1; var _c2_ = return_unit;}
    return symbol_bind(_c2_, _c1_);
   }
   ...
   var
    Eos = [248, _ci_, caml_fresh_oo_id(0)],
    t79 =
      handler
       (function(param){
         ...
         var
          board_div = createElement(document, name$0),
          t0 = [0, caml_sys_time(0)],
          div$0 = createElement(document, name$0),
          t9 = div$0.style;
         t9.cssText = cst_border_1px_black_solid_bac;
         append_text(div$0, _cf_);
         var stopped = [0, 1];
         function update_cb(param){
          ...
          if(1 - stopped[1]){
           ...
           replace_child(div$0, txt);
          }
          return symbol_bind(sleep(1.), function(param){return update_cb(0);});
         }
         update_cb(0);
         var
          clock =
            [0,
             ...
             function(param){stopped[1] = 1; return 0;}],
          clock_start = clock[2],
          clock_div = clock[1];
         function load_data(name, process){
          var div = createElement(document, name$0), t6 = div.style;
          t6.cssText =
           "background-color: red; color: white; display:inline; position: absolute; top:0; right:0;";
          append_text(div, _ce_);
          appendChild(parent, div);
          function _cU_(data){
           return symbol_bind
                   (caml_call1(process, data),
                    function(res){
                     removeChild(parent, div);
                     return return$0(res);
                    });
          }
          try{var _cT_ = return$0(caml_read_file_content(name)), _cV_ = _cT_;}
          catch(_cW_){
           var _cS_ = caml_wrap_exception(_cW_);
           if(_cS_ !== Not_found) throw caml_maybe_attach_backtrace(_cS_, 0);
           var
            content_type$2 = 0,
            check_headers = function(_c0_, param){return 1;},
            contents = 0,
            _cR_ =
              function(r){
               var cod = r[2], msg = r[4];
           ...
           var
            ...
            t10 = caml_jsstring_of_string(name),
                 ...
                 switch(req.readyState){
                   ...
                   case 4:
                    ...
                    var
                     ...
                     _cY_ = x == no_handler ? _cc_ : g(x),
                     response = [0, name, code, headers, _cY_, _cX_];
           ...
           if(contents){
            var match$1 = contents[1], _cQ_ = match$1[1];
            if(-836918635 === _cQ_){
             ...
             if(891486873 <= match$2[1]){
              ...
              if(l){
               ...
               a:
               {
                ...
                var _cO_ = caml_ml_string_length(hd) + acc | 0;
               }
               var dst = caml_create_bytes(_cO_);
               a:
               {
                b:
                {
                 var pos = pos$1, param$0 = l;
                 for(;;){
                  if(! param$0) break;
                  var hd$0 = param$0[1];
               ...
               var _cP_ = _o_;
              var t60 = caml_jsstring_of_string(_cP_);
              req.send(t60);
             }
             else{var t62 = match$2[2]; req.send(t62);}
            }
            else if(737307005 <= _cQ_){
             var t66 = match$1[2];
             req.send(t66);
            }
            else{
             var s = match$1[2], t64 = caml_jsstring_of_string(s);
             req.send(t64);
            }
           }
           else
           ...
           var _cV_ = symbol_bind(res, _cR_);
          }
          return symbol_bind(_cV_, _cU_);
         }
         var div = createElement(document, name$0), t62 = div.style;
         t62.cssText = cst_border_1px_black_solid_bac;
         append_text(div, _ck_);
         function show_rem(v){
          var t63 = caml_jsstring_of_string("" + v);
          return replace_child(div, document.createTextNode(t63));
         }
         symbol_bind
          (load_data
            (_cs_,
              ...
              for(;;){
               try{
                var
                 ...
                 st$2 = match$1[2],
                 snd = match$1[1],
                 _cM_ = [0, [0, [0, fst, snd], st$2]],
                 _cL_ = _cM_;
               }
               catch(_cN_){
                var _cK_ = caml_wrap_exception(_cN_);
                if(_cK_ !== Eos) throw caml_maybe_attach_backtrace(_cK_, 0);
                var _cL_ = 0;
               }
               if(! _cL_) return return$0(rev(acc));
               var
                match = _cL_[1],
                st$0 = match[2],
                elt = match[1],
           ...
           function(levels){
            ...
            var h1 = createElement(document, name$1);
            append_text(h1, _cn_);
            appendChild(parent, h1);
            var div$0 = createElement(document, name$0);
            append_text(div$0, _co_);
            appendChild(div$0, clock_div);
            append_text(div$0, _cp_);
            appendChild(div$0, div);
            append_text(div$0, _cq_);
            var
             select = createElement(document, elt),
             option = createElement(document, name);
            append_text(option, _cr_);
            appendChild(select, option);
            iter
             (function(param){
               var n = param[2], option = createElement(document, name);
            ...
            var
             t77 =
               handler
                (function(param$0){
                  var i = select.selectedIndex - 1 | 0, _cu_ = 0 <= i ? 1 : 0;
                  if(_cu_){
                    ...
                    (file,
                     function(data){
                      var
                       res = [0, 0],
                       row = [0, 0],
                       _cF_ = caml_ml_string_length(data) - 1 | 0,
                       _cE_ = 0;
                      if(_cF_ >= 0){
                       var i = _cE_;
                       for(;;){
                      ...
                      function _cG_(c){
                       var
                        img = createElement(document, name$3),
                        t65 = img_assoc(c);
                       img.src = t65;
                       return img;
                      }
                      var
                       cells =
                         map$0(function(_cJ_){return map$0(_cG_, _cJ_);}, map$1),
                       gx = [0, 0],
                       gy = [0, 0],
                       ex = [0, 0],
                       ey = [0, 0],
                       ...
                       td_style = [0, td_style$0],
                       style = [0, style$0],
                       table = createElement(document, name$4);
                      opt_style(table, style);
                      var _cz_ = cells.length - 2 | 0, tr_style = 0, _cy_ = 0;
                      if(_cz_ >= 0){
                       var y = _cy_;
                       for(;;){
                        ...
                        var
                         _cB_ = caml_check_bound(cells, y)[1 + y].length - 2 | 0,
                         _cA_ = 0;
                        if(_cB_ >= 0){
                         var x = _cA_;
                         for(;;){
                                  ...
                                  return symbol_bind
                                          (sleep(0.05),
                                           function(param){
                                            var
                                             t71 =
                                               caml_jsstring_of_string(caml_call1(sprintf(_cl_), t - t0)),
                                             t72 = table.style;
                                            t72.opacity = t71;
                                            return fade(0);
                                           });
            ...
            select.onchange = t77;
            appendChild(div$0, select);
            appendChild(div$0, createElement(document, name$2));
            appendChild(div$0, createElement(document, name$2));
            appendChild(div$0, board_div);
            appendChild(parent, div$0);
            return return$0(0);
           });
         return false$0;
        });
