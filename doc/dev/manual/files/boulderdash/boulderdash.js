...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _fA_ = caml_wrap_exception(_fB_);
      if(_fA_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fA_, 0);
     }
     param$0 = l;
    }
   }
   ...
   var
    at_exit_key = new_key(0, function(param, _fw_){return 0;}),
    _q_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _fv_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _fv_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fu_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fu_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fu_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _fr_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _fr_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _fs_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _fs_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _fq_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _fq_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _fi_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _fh_ = 0;
    if(_fi_ >= 0){
     var i$0 = _fh_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _fk_ = caml_ml_bytes_length(s$0) - 1 | 0, _fj_ = 0;
     if(_fk_ >= 0){
      var i = _fj_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_fp_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _fc_ = caml_ml_string_length(s) - 1 | 0, _fb_ = 0;
    if(_fc_ >= 0){
     var i$0 = _fb_;
     for(;;){
    ...
    var
     ...
     _fe_ = caml_ml_string_length(s) - 1 | 0,
     _fd_ = 0;
    if(_fe_ >= 0){
     var i = _fd_;
     for(;;){
   ...
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _e$_ = _aI_; break;
      default: var _e$_ = _aR_;
    }
    return transform_int_alt(iconv, caml_format_int(_e$_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _e__ = _aV_; break;
      default: var _e__ = _a4_;
    }
    return transform_int_alt(iconv, caml_format_int(_e__, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _e9_ = _av_; break;
      default: var _e9_ = _aE_;
    }
    return transform_int_alt(iconv, caml_int64_format(_e9_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _e6_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _e6_ >>> 0){
           if(55 === _e6_) break a;
          }
          else if(21 < _e6_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _e8_ = _e7_ ? str : str + cst$3;
        return caml_special_val(_e8_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _e2_ = l - 1 | 0, _e1_ = 0;
        if(_e2_ >= 0){
         var i = _e1_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _e3_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _e3_);
          var _e4_ = i + 1 | 0;
          if(_e2_ === i) break;
          i = _e4_;
         }
       ...
       return caml_string_of_bytes(_e5_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _e0_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _e0_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _e0_[1];
       ...
       case 18:
        var _eY_ = fmt$0[1];
        if(0 === _eY_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _eY_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _eY_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _eZ_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _eZ_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _eW_ = [8, acc, _bb_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _eW_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _eW_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _eV_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _eV_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _eV_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bk_), _eU_, _eT_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_eS_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _eP_ = field(e, 1),
       _eR_ = caml_call2(sprintf(_bl_), _eP_, _eO_);
     else
      switch(match){
        case 0:
         var _eR_ = _bm_; break;
        case 1:
         var _eR_ = _bn_; break;
        default:
         var _eQ_ = field(e, 1), _eR_ = caml_call1(sprintf(_bo_), _eQ_);
      }
     var match$0 = [0, constructor, [0, _eR_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _eE_ = slot[4],
        _eF_ = slot[3],
        _eG_ = slot[6] ? _by_ : _bA_,
        _eH_ = slot[2],
        _eI_ = slot[7],
        _eJ_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _eJ_, _eI_, _eH_, _eG_, _eF_, _eE_, _eD_)];
      else if(slot[1])
       var match = 0;
      else
       var _eK_ = info(0), match = [0, caml_call1(sprintf(_bB_), _eK_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_eB_){}
      try{
       var _er_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _er_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _es_ = abs(status);
        prerr_endline(caml_check_bound(errors, _es_)[1 + _es_]);
       }
       var _ey_ = caml_ml_flush(stderr), _ew_ = _ey_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _eu_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _eu_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _ev_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _ev_);
      ...
      var _et_ = caml_wrap_exception(_eA_);
      if(_et_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_et_, 0);
      var _ex_ = prerr_endline(_bD_);
     }
     return _ex_;
    }
    catch(_ez_){return 0;}
   ...
   var
    ...
    _n_ = "String.concat",
    _bN_ = "[\\][()\\\\|+*.?{}^$]",
    _bO_ = "Js_of_ocaml__Url.Local_exn",
    _bR_ = "Lwt_sequence.Empty",
    _b7_ = [0, 0],
    _b8_ = [0, 1],
    _b5_ = [0, 0],
    _b6_ = [0, 1],
    ...
    _bX_ = "wakeup_exn",
    _bW_ = "wakeup",
    _bT_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bU_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bV_ = [0, 0],
    _bS_ = "Lwt.Resolution_loop.Canceled",
    _b__ = cst,
    _b9_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _b$_ = "Exception during Lwt.async: ",
    _ch_ = [0, [8, [0, 0, 3], 0, 0, 0], "%g"],
    _ci_ = "malformed level",
    _cj_ = "Boulder Dash in Ocaml",
    _ck_ = "Elapsed time: ",
    _cl_ = " Remaining diamonds: ",
    _cm_ = cst$2,
    _cn_ = "Choose a level",
    _cf_ = [0, "examples/boulderdash/boulderdash.ml", 335, 72],
    _cg_ = "--",
    _co_ = "maps.txt",
    _cc_ =
      [0,
    ...
    _cb_ = "--:--:--",
    _ca_ = "LOADING...",
    _cd_ = "Dune__exe__Boulderdash.Death",
    _ce_ = "Dune__exe__Boulderdash.Eos",
   ...
   var
    ...
    quote_re = regexp(_bN_),
    Local_exn = [248, _bO_, caml_fresh_oo_id(0)];
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _bQ_ = caml_wrap_exception(_eo_);
    if(_bQ_[1] !== Failure) throw caml_maybe_attach_backtrace(_bQ_, 0);
   }
   var
     ...
     a:
     {
      ...
      if(0 <= i$1 && lim >= i$1){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _em_ = i; break a;}
        var i$0 = i + 1 | 0;
        i = i$0;
       }
      }
      var _em_ = invalid_arg(_p_);
     }
     var j = _em_;
    }
    catch(_en_){
     var _el_ = caml_wrap_exception(_en_);
     if(_el_ !== Not_found) throw caml_maybe_attach_backtrace(_el_, 0);
     var j = l;
    }
   ...
   if(a && a[1] === cst){
    var _bP_ = a[2];
    if(! _bP_ || _bP_[1] === cst && ! _bP_[2]) break a;
   }
   var t49 = t43.search;
   if(t49.charAt(0) == "?")
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
      var t3 = arr[idx$0], _eh_ = idx$0 - 1 | 0;
      if(t3 === undefined$0)
       var _ej_ = interrupt(0);
      else{
       var
       ...
       if(0 <= index)
        var
         t7 = index + 1 | 0,
         _ef_ = t3.slice(t7),
         x$0 = [0, t3.slice(0, index), _ef_];
       else
        var x$0 = undefined$0;
       if(x$0 === undefined$0)
        var _ee_ = interrupt(0);
       else
        var
         y = x$0[2],
         x = x$0[1],
         _ei_ = urldecode_js_string_string(y),
         _ee_ = [0, urldecode_js_string_string(x), _ei_];
       var _ej_ = _ee_;
      }
      aux$0([0, _ej_, acc], _eh_);
      return;
     }
     catch(_ek_){
      var _eg_ = caml_wrap_exception(_ek_);
      if(_eg_ !== Local_exn) throw caml_maybe_attach_backtrace(_eg_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   var s2 = cst$4 + "1627b71";
   "5.7.2" + s2;
   var
    console$0 = caml_js_get_console(0),
    Empty$0 = [248, _bR_, caml_fresh_oo_id(0)];
   ...
   function wakeup_general(api_function_name, r, result){
    ...
    switch(_ea_[0]){
      ...
      case 2:
       ...
       resolve(_bV_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _bT_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_bW_, r, [0, v]);}
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_b2_, 0, outer_promise, p1[1]);
      case 2:
       var
        p_callbacks = match[1],
      ...
      default: return resolve(_b1_, 0, outer_promise, p1[1]);
    }
   }
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_b3_, 0, p$2, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _d$_ = caml_call1(f, v), p$0 = _d$_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function catch$0(f, h){
    try{var _d9_ = caml_call1(f, 0), p = _d9_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
     var p = fail(exn);
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 !== p_result[0]){
       var p$0 = underlying(p);
       resolve(_b5_, 0, p$0, p_result);
       return 0;
      }
      var exn = p_result[1];
      current_storage[1] = saved_storage;
      try{var _d__ = caml_call1(h, exn), p$1 = _d__;}
      catch(exn){
   ...
   create(0);
   var Wrong_headers = [248, _b9_, caml_fresh_oo_id(0)];
   function sleep(d){
    var match = task(0), w = match[2], t = match[1], d$0 = d * 1000.;
    function callback(_d8_){return wakeup(w, _d8_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_d7_){return loop(remain, _d7_);},
   ...
   var Death = [248, _cd_, caml_fresh_oo_id(0)];
   ...
   function fall(state){
    var changed = [0, 0], _dD_ = state[1].length - 3 | 0;
    if(_dD_ >= 1){
     var y = _dD_;
     for(;;){
      var
       _dF_ = caml_check_bound(state[1], y)[1 + y].length - 3 | 0,
       _dE_ = 1;
      if(_dF_ >= 1){
       var x = _dE_;
       for(;;){
        var
         ...
         _dI_ =
           6
            ===
             caml_check_bound(caml_check_bound(state[1], _dH_)[1 + _dH_], x)
              [1 + x]
            ? 1
            : 0,
         sustaining =
        ...
        if(_dJ_)
         var
          ...
          _dL_ =
            3
             ===
              caml_check_bound(caml_check_bound(state[1], _dK_)[1 + _dK_], x)
               [1 + x]
             ? 1
             : 0;
        else
        ...
        if(_dM_){
         var
          ...
          _dO_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _dN_)[1 + _dN_], x)
               [1 + x]
             ? 1
             : 0;
         if(_dO_){
          var
           ...
           _dQ_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _dP_)
                [1 + _dP_]
              ? 1
              : 0;
          if(_dQ_)
           var
            ...
            _dT_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _dS_)[1 + _dS_], _dR_)
                 [1 + _dR_]
               ? 1
               : 0;
          else
        ...
        if(_dU_){
         var
          ...
          _dW_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _dV_)[1 + _dV_], x)
               [1 + x]
             ? 1
             : 0;
         if(_dW_){
          var
           ...
           _dY_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _dX_)
                [1 + _dX_]
              ? 1
              : 0;
          if(_dY_)
           var
            ...
            _d1_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _d0_)[1 + _d0_], _dZ_)
                 [1 + _dZ_]
               ? 1
               : 0;
          else
        ...
        if(_d2_)
         var
          ...
          _d4_ =
            6
             ===
              caml_check_bound(caml_check_bound(state[1], _d3_)[1 + _d3_], x)
               [1 + x]
             ? 1
             : 0,
          _d5_ =
   ...
   function build_interaction(state, show_rem, clock){
    ...
    function _cX_(param){
     var _c1_ = state[1].length - 2 | 0, _c0_ = 0;
     if(_c1_ >= 0){
      var y$0 = _c0_;
      for(;;){
       var
        _c3_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 2 | 0,
        _c2_ = 0;
       if(_c3_ >= 0){
        var x$0 = _c2_;
        for(;;){
     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       a:
       {
        if(5 !== param$1 && 3 <= param$1){var _dl_ = 0; break a;}
        var _dl_ = 1;
       }
       if(_dl_){
        var
        ...
        var
         ...
         _dm_ = function(_dC_){return with_pending_out(over_cont$2, _dC_);},
         _dn_ =
           function(_dB_){return set_pending_out(_dr_, out_cont$2, _dB_);};
        let
         ...
         _ds_ = _dn_;
        var
         t25 = handler(function(_dA_){return inhibit(_ds_, _dA_);}),
         t26 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t26.onmouseover = t25;
        var
         _do_ = function(param){return return$0(0);},
         _dp_ = function(_dz_){return with_pending_out(_dt_, _dz_);};
        let _dt_ = _do_, _du_ = _dp_;
        var
         t27 = handler(function(_dy_){return inhibit(_du_, _dy_);}),
         t28 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t28.onmouseout = t27;
        let click$0 = click;
        var _dq_ = function(_dx_){return with_pending_out(click$0, _dx_);};
        let _dv_ = _dq_;
        var
         t29 = handler(function(_dw_){return inhibit(_dv_, _dw_);}),
         t30 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t30.onclick = t29;
        if
     ...
     function update_push(pos, next, img, img_guy){
      ...
      try{
       ...
       var _c6_ = caml_wrap_exception(_dk_);
       if(_c6_[1] !== Invalid_argument)
      ...
      function _c8_(_dj_){return with_pending_out(over, _dj_);}
      function _c9_(_di_){return set_pending_out(_c8_, out, _di_);}
      var
       t39 = handler(function(_dh_){return inhibit(_c9_, _dh_);}),
       t40 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t40.onmouseover = t39;
      function _c__(param){return return$0(0);}
      function _c$_(_dg_){return with_pending_out(_c__, _dg_);}
      var
       t41 = handler(function(_df_){return inhibit(_c$_, _df_);}),
       t42 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t42.onmouseout = t41;
      function _da_(_de_){return with_pending_out(click, _de_);}
      var
       t43 = handler(function(_dd_){return inhibit(_da_, _dd_);}),
       t44 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t44.onclick = t43;
     ...
     if(m[1])
      if(is_empty(m[2]))
       ...
       var node = seq[2];
       remove(node);
       var r = node[3], result$0 = [0, v], p = underlying(r), _cZ_ = p[1];
       switch(_cZ_[0]){
         case 1:
          if(_cZ_[1] !== Canceled)
         ...
         case 2:
          ...
          resolve(0, _b0_, p, result);
          break;
         default: caml_call1(ksprintf(invalid_arg, _bY_), api_function_name);
       }
      }
     return return$0(0);
    }
    ...
    else{m[1] = 1; var _cY_ = return_unit;}
    return symbol_bind(_cY_, _cX_);
   }
   ...
   var
    Eos = [248, _ce_, caml_fresh_oo_id(0)],
    t79 =
      handler
       (function(param){
         ...
         function load_data(name, process){
          ...
          try{var _cP_ = return$0(caml_read_file_content(name)), _cR_ = _cP_;}
          catch(_cS_){
           var _cO_ = caml_wrap_exception(_cS_);
           if(_cO_ !== Not_found) throw caml_maybe_attach_backtrace(_cO_, 0);
           var
            content_type$2 = 0,
            check_headers = function(param, _cW_){return 1;},
            contents = 0,
            _cN_ =
              function(r){
               var cod = r[2], msg = r[4];
                 ...
                 switch(req.readyState){
                   ...
                   case 4:
                    ...
                    var
                     ...
                     _cU_ = x == no_handler ? _b__ : g(x),
                     response = [0, name, code, headers, _cU_, _cT_];
           ...
           if(contents){
            var match$1 = contents[1], _cM_ = match$1[1];
            if(-836918635 === _cM_){
             ...
             if(891486873 <= match$2[1]){
              ...
              if(l){
               ...
               a:
               {
                ...
                var _cK_ = caml_ml_string_length(hd) + acc | 0;
               }
               var dst = caml_create_bytes(_cK_);
               a:
               {
                b:
                {
               ...
               var _cL_ = caml_string_of_bytes(dst);
              }
              else
               var _cL_ = _o_;
              var t60 = caml_jsstring_of_string(_cL_);
              req.send(t60);
             }
             else{var t62 = match$2[2]; req.send(t62);}
            }
            else if(737307005 <= _cM_){
             var t66 = match$1[2];
             req.send(t66);
            }
            else{
              ...
              for(;;){
               try{
                var
                 ...
                 st$2 = match$1[2],
                 snd = match$1[1],
                 _cI_ = [0, [0, [0, fst, snd], st$2]],
                 _cH_ = _cI_;
               }
               catch(_cJ_){
                var _cG_ = caml_wrap_exception(_cJ_);
                if(_cG_ !== Eos) throw caml_maybe_attach_backtrace(_cG_, 0);
                var _cH_ = 0;
               }
               if(! _cH_) return return$0(rev(acc));
               var
                match = _cH_[1],
                st$0 = match[2],
                elt = match[1],
           ...
           function(levels){
            ...
            var
             t77 =
               handler
                (function(param$0){
                  var i = select.selectedIndex - 1 | 0, _cq_ = 0 <= i ? 1 : 0;
                  if(_cq_){
                    ...
                    (file,
                     function(data){
                      var
                       res = [0, 0],
                       row = [0, 0],
                       _cB_ = caml_ml_string_length(data) - 1 | 0,
                       _cA_ = 0;
                      if(_cB_ >= 0){
                       var i = _cA_;
                       for(;;){
                      ...
                      var
                       cells =
                         map$0(function(_cF_){return map$0(_cC_, _cF_);}, map$1),
                       gx = [0, 0],
                       gy = [0, 0],
                       ex = [0, 0],
                       ey = [0, 0],
                      ...
                      var _cv_ = cells.length - 2 | 0, tr_style = 0, _cu_ = 0;
                      if(_cv_ >= 0){
                       var y = _cu_;
                       for(;;){
                        ...
                        var
                         _cx_ = caml_check_bound(cells, y)[1 + y].length - 2 | 0,
                         _cw_ = 0;
                        if(_cx_ >= 0){
                         var x = _cw_;
                         for(;;){
                                  ...
                                  return symbol_bind
                                          (sleep(0.05),
                                           function(param){
                                            var
                                             t71 =
                                               caml_jsstring_of_string(caml_call1(sprintf(_ch_), t - t0)),
                                             t72 = table.style;
                                            t72.opacity = t71;
                                            return fade(0);
                                           });
