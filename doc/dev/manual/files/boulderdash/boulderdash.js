     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       if(_dZ_){
        ...
        function _d0_(_d$_){return with_pending_out(over_cont$1, _d$_);}
        function _d1_(_d__){return set_pending_out(_d0_, out_cont$1, _d__);}
        var
