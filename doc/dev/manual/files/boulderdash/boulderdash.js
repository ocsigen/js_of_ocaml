...
(function(globalThis){
   ...
   var
    at_exit_key = new_key(0, function(param, _gd_){return 0;}),
    _q_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _gc_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _gc_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _ga_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _ga_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gb_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gb_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gb_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _f__ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _f__))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _f$_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _f$_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _f9_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _f9_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _f1_ = caml_ml_bytes_length(b) - 1 | 0,
     _f0_ = 0;
    if(_f1_ >= 0){
     var i$0 = _f0_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _f3_ = caml_ml_bytes_length(b) - 1 | 0, _f2_ = 0;
     if(_f3_ >= 0){
      var i = _f2_;
      for(;;){
   ...
   function convert_int64(iconv, n){
    ...
    return transform_int_alt(iconv, caml_int64_format(_fQ_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fN_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fN_ >>> 0){
           if(55 === _fN_) break a;
          }
          else if(21 < _fN_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _fP_ = _fO_ ? str : str + cst$5;
        return caml_special_val(_fP_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _fJ_ = l - 1 | 0, _fI_ = 0;
        if(_fJ_ >= 0){
         var i = _fI_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _fK_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _fK_);
          var _fL_ = i + 1 | 0;
          if(_fJ_ === i) break;
          i = _fL_;
         }
       ...
       return caml_string_of_bytes(_fM_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _fF_ = fmt$0[1];
        if(0 === _fF_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _fF_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _fF_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _fG_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _fG_);
     }
    }
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bk_), _fB_, _fA_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_fz_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _fw_ = field(e, 1),
       _fy_ = caml_call2(sprintf(_bl_), _fw_, _fv_);
     else
      switch(match){
        case 0:
         var _fy_ = _bm_; break;
        case 1:
         var _fy_ = _bn_; break;
        default:
         var _fx_ = field(e, 1), _fy_ = caml_call1(sprintf(_bo_), _fx_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _fl_ = slot[4],
        _fm_ = slot[3],
        _fn_ = slot[6] ? _by_ : _bA_,
        _fo_ = slot[2],
        _fp_ = slot[7],
        _fq_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _fq_, _fp_, _fo_, _fn_, _fm_, _fl_, _fk_)];
      else if(slot[1])
       var match = 0;
      else
       var _fr_ = info(0), match = [0, caml_call1(sprintf(_bB_), _fr_)];
    ...
    try{
     try{
      ...
      try{
       ...
       caml_call1(eprintf(_bF_), _fc_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fd_ = to_string(exn);
       caml_call1(eprintf(_bG_), _fd_);
   ...
   var
    ...
    _bW_ = "[\\][()\\\\|+*.?{}^$]",
    _bZ_ = cst$2,
    _bX_ = "Js_of_ocaml__Url.Local_exn",
    _b1_ = "Lwt_sequence.Empty",
    _cg_ = [0, 0],
    _ch_ = [0, 1],
    _ce_ = [0, 0],
    _cf_ = [0, 1],
    ...
    _b6_ = [0, 0],
    _b2_ = cst_Fatal_error_exception,
    _b3_ = "Lwt.Resolution_loop.Canceled",
    _cq_ = "PATCH",
    _cr_ = cst_POST,
    _cs_ = "HEAD",
    _ct_ = "DELETE",
    ...
    _cy_ = cst$2,
    _cz_ = cst$3,
    _cp_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 98, 29],
    _co_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 90, 29],
    _cn_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 82, 29],
    _cm_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 74, 29],
    _cl_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 66, 29],
    _ck_ = cst,
    _ci_ = cst$2,
    _cj_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
   ...
   function createOption(doc){return unsafeCreateElement(doc, _bQ_);}
   ...
   var
    ...
    quote_re = regexp(_bW_),
    Local_exn = [248, _bX_, caml_fresh_oo_id(0)];
   function interrupt(param){throw caml_maybe_attach_backtrace(Local_exn, 1);}
   var
    plus_re = regexp(caml_string_of_jsbytes(cst$6.replace(quote_re, "\\$&"))),
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b0_ = caml_wrap_exception(_e7_);
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l$0 >= i){
       var _e5_ = index_rec(path_string, l$0, i, c);
       break a;
      }
      var _e5_ = invalid_arg(_p_);
     }
     var j = _e5_;
    }
    catch(_e6_){
   ...
   if(a && a[1] === cst){
    var _bY_ = a[2];
    if(! _bY_ || _bY_[1] === cst && ! _bY_[2]) break a;
   }
   var
    s = t43.search.charAt(0) == cst$3 ? t43.search.slice(1) : t43.search,
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
      ...
      var _eY_ = caml_wrap_exception(_eZ_);
      if(_eY_ !== Local_exn) throw caml_maybe_attach_backtrace(_eY_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   var
    ...
    Empty$0 = [248, _b1_, caml_fresh_oo_id(0)];
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _eX_ = caml_call1(f, v); return _eX_;}
    catch(exn$0){
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      if(! _eV_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _eV_[1];
      if(_eV_[2]){
       var next = _eV_[2];
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_cb_, 0, outer_promise, p[1]);
      case 2:
       var
        p_callbacks = match[1],
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_cc_, 0, p$2, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _eT_ = caml_call1(f, v), p$0 = _eT_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function catch$0(f, h){
    try{var _eR_ = caml_call1(f, 0), p = _eR_;}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      var exn = p_result[1];
      current_storage[1] = saved_storage;
      try{var _eS_ = caml_call1(h, exn), p$1 = _eS_;}
      catch(exn){
   ...
   (opt,
    ...
    if(_ex_) var sth$0 = _ex_[1], get_args = sth$0; else var get_args = 0;
    if(_ew_)
     var sth$1 = _ew_[1], check_headers = sth$1;
    else
     var check_headers = function(param, _eQ_){return 1;};
    if(contents){
     var c$0 = contents[1], _ey_ = c$0[1];
     if(440620227 === _ey_){
      var args = c$0[2];
      a:
      {
       b:
       {
        ...
        for(;;){
         if(! param) break;
         var l = param[2], a = param[1], _ez_ = a[2];
         c:
         {
          if(typeof _ez_ !== "number" && -976970511 === _ez_[1]){var _es_ = 1; break c;}
          var _es_ = 0;
         }
         if(! _es_) break b;
         param = l;
      ...
      if(only_strings)
       ...
       if(match)
        var constr = match[1], _eA_ = [0, 808620462, new constr];
       else
        var _eA_ = [0, 891486873, [0, 0]];
       var form_contents = _eA_;
      }
      iter
       (function(param){
         var
        ...
        args);
      var _eB_ = [0, -836918635, form_contents];
     }
     else if(737307005 <= _ey_)
      var b = c$0[2], _eB_ = [0, 737307005, b];
     else
      var _eB_ = c$0;
     var contents$0 = [0, _eB_];
    }
    else
     var contents$0 = 0;
    function override_method$0(m){
     ...
     return 492530731 <= v
             ? 891112544
               <= v
               ? 994393768 <= v ? _cq_ : _cr_
               : 801894688 <= v ? _cs_ : _ct_
             : 3546230 === v ? _cu_ : 3997359 <= v ? _cv_ : _cw_;
    }
    if(contents$0){
     ...
     if(-836918635 === match$0[1]){
      ...
      if(891486873 <= form[1])
       var
        ...
        method = override_method$0(_cx_);
      else
       var content_type$1 = content_type, method = override_method$0(_cA_);
     }
     else
      var content_type$1 = content_type, method = override_method$0(_cB_);
    }
    else
     var
      method$0 = override_method$0(_cC_),
      ...
      _et_ =
        concat
         (_bZ_,
          map
           (function(param){
             var v = param[2], n = param[1], _eP_ = cst$7 + urlencode(0, v);
             return urlencode(0, n) + _eP_;
            },
            get_args));
     try{
      index_rec(url, caml_ml_string_length(url), 0, 63);
      var _ev_ = 1, _eD_ = _ev_;
     }
     catch(_eO_){
      var _eu_ = caml_wrap_exception(_eO_);
      if(_eu_ !== Not_found) throw caml_maybe_attach_backtrace(_eu_, 0);
      var _eD_ = 0;
     }
     var _eE_ = _eD_ ? _cy_ : _cz_, url$0 = url + _eE_ + _et_;
    }
    var
     match$1 = task(0),
     w = match$1[2],
             ...
             switch(response_type){
               case 0:
                var
                 ...
                 _eM_ = e$1 instanceof arrayBuffer ? e$1 : no_handler,
                 response = [0, url$0, code, headers$0, _eM_, _eL_];
                break;
               case 1:
                var
                 code$0 = req.status,
                 ...
                 _eK_ = e$0 instanceof blob_constr ? e$0 : no_handler,
                 response = [0, url$0, code$0, headers$0, _eK_, _eJ_];
                break;
               case 2:
                var
                 code$1 = req.status,
                 ...
                 _eI_ = e instanceof doc_constr ? e : no_handler,
                 response = [0, url$0, code$1, headers$0, _eI_, _eH_];
                break;
               case 3:
                var
                 code$2 = req.status,
    ...
    if(contents$0){
     var match$2 = contents$0[1], _eC_ = match$2[1];
     if(-836918635 === _eC_){
              ...
              (function(param){
                ...
                if(781515420 <= match[1]){
                 var
                  t0 = match[2],
                  _eF_ =
                    cst$7 + urlencode(0, caml_string_of_jsstring(t0.name));
                 return urlencode(0, name) + _eF_;
                }
                var
                 s = match[2],
                 _eG_ = cst$7 + urlencode(0, caml_string_of_jsstring(s));
   ...
   function sleep(d){
    ...
    function callback(_er_){return wakeup(w, _er_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_eq_){return loop(remain, _eq_);};
   ...
   function fall(state){
    var changed = [0, 0], _dY_ = state[1].length - 3 | 0;
    if(_dY_ >= 1){
     var y = _dY_;
     for(;;){
      var
       _d0_ = caml_check_bound(state[1], y)[1 + y].length - 3 | 0,
       _dZ_ = 1;
      if(_d0_ >= 1){
       var x = _dZ_;
       for(;;){
        var
         ...
         _d3_ =
           6
            ===
             caml_check_bound(caml_check_bound(state[1], _d2_)[1 + _d2_], x)
              [1 + x]
            ? 1
            : 0,
         sustaining =
        ...
        if(_d4_)
         var
          ...
          _d6_ =
            3
             ===
              caml_check_bound(caml_check_bound(state[1], _d5_)[1 + _d5_], x)
               [1 + x]
             ? 1
             : 0;
        else
        ...
        if(_d7_){
         var
          ...
          _d9_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _d8_)[1 + _d8_], x)
               [1 + x]
             ? 1
             : 0;
         if(_d9_){
          var
           ...
           _d$_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _d__)
                [1 + _d__]
              ? 1
              : 0;
          if(_d$_)
           var
            ...
            _ec_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _eb_)[1 + _eb_], _ea_)
                 [1 + _ea_]
               ? 1
               : 0;
          else
        ...
        if(_ed_){
         var
          ...
          _ef_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _ee_)[1 + _ee_], x)
               [1 + x]
             ? 1
             : 0;
         if(_ef_){
          var
           ...
           _eh_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _eg_)
                [1 + _eg_]
              ? 1
              : 0;
          if(_eh_)
           var
            ...
            _ek_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _ej_)[1 + _ej_], _ei_)
                 [1 + _ei_]
               ? 1
               : 0;
          else
   ...
   function build_interaction(state, show_rem, clock){
    ...
    function _dg_(param){
     var _dk_ = state[1].length - 2 | 0, _dj_ = 0;
     if(_dk_ >= 0){
      var y$0 = _dj_;
      for(;;){
       var
        _dm_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 2 | 0,
        _dl_ = 0;
       if(_dm_ >= 0){
        var x$0 = _dl_;
        for(;;){
     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       a:
       {
        if(5 !== param$1 && 3 <= param$1){var _dG_ = 0; break a;}
        var _dG_ = 1;
       }
       if(_dG_){
        var
        ...
        var
         ...
         _dH_ = function(_dX_){return with_pending_out(over_cont$2, _dX_);},
         _dI_ =
           function(_dW_){return set_pending_out(_dM_, out_cont$2, _dW_);};
        let
         ...
         _dN_ = _dI_;
        var
         t25 = handler(function(_dV_){return inhibit(_dN_, _dV_);}),
         t26 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t26.onmouseover = t25;
        var
         _dJ_ = function(param){return return$0(0);},
         _dK_ = function(_dU_){return with_pending_out(_dO_, _dU_);};
        let _dO_ = _dJ_, _dP_ = _dK_;
        var
         t27 = handler(function(_dT_){return inhibit(_dP_, _dT_);}),
         t28 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t28.onmouseout = t27;
        let click$0 = click;
        var _dL_ = function(_dS_){return with_pending_out(click$0, _dS_);};
        let _dQ_ = _dL_;
        var
         t29 = handler(function(_dR_){return inhibit(_dQ_, _dR_);}),
         t30 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t30.onclick = t29;
        if
     ...
     function update_push(pos, next, img, img_guy){
      ...
      try{
       ...
       var _dp_ = caml_wrap_exception(_dF_);
       if(_dp_[1] !== Invalid_argument)
      ...
      function _dr_(_dE_){return with_pending_out(over, _dE_);}
      function _ds_(_dD_){return set_pending_out(_dr_, out, _dD_);}
      var
       t39 = handler(function(_dC_){return inhibit(_ds_, _dC_);}),
       t40 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t40.onmouseover = t39;
      function _dt_(param){return return$0(0);}
      function _du_(_dB_){return with_pending_out(_dt_, _dB_);}
      var
       t41 = handler(function(_dA_){return inhibit(_du_, _dA_);}),
       t42 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t42.onmouseout = t41;
      function _dv_(_dz_){return with_pending_out(click, _dz_);}
      var
       t43 = handler(function(_dy_){return inhibit(_dv_, _dy_);}),
       t44 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t44.onclick = t43;
     ...
     if(m[1])
      if(is_empty(m[2]))
       ...
       var node = seq[2];
       remove(node);
       var r = node[3], result$0 = [0, v], p = underlying(r), _di_ = p[1];
       switch(_di_[0]){
         case 1:
          if(_di_[1] !== Canceled)
    ...
    else{m[1] = 1; var _dh_ = return_unit;}
    return symbol_bind(_dh_, _dg_);
   }
      ...
      handler
       (function(param){
         ...
         function load_data(name, process){
          ...
          try{var _dc_ = return$0(caml_read_file_content(name)), _de_ = _dc_;}
          catch(_df_){
           var _db_ = caml_wrap_exception(_df_);
         ...
         symbol_bind
          (load_data
              ...
              for(;;){
               try{
                var
                 ...
                 st$2 = match$1[2],
                 snd = match$1[1],
                 _c$_ = [0, [0, [0, fst, snd], st$2]],
                 _c__ = _c$_;
               }
               catch(_da_){
                var _c9_ = caml_wrap_exception(_da_);
                if(_c9_ !== Eos) throw caml_maybe_attach_backtrace(_c9_, 0);
                var _c__ = 0;
               }
               if(! _c__) return return$0(rev(acc));
               var
                match = _c__[1],
                st$0 = match[2],
                elt = match[1],
           ...
           function(levels){
            ...
            var h1 = unsafeCreateElement(document, _bS_);
            append_text(h1, _cN_);
            ...
            var
             t77 =
               handler
                (function(param$0){
                  var i = select.selectedIndex - 1 | 0, _cT_ = 0 <= i ? 1 : 0;
                  if(_cT_){
                  ...
                  if(_cU_){
                   ...
                   if(0 <= i){
                    b:
                    {
                     ...
                     var _cV_ = failwith(_i_);
                     break a;
                    }
                    var _cV_ = a;
                   }
                   else
                    var _cV_ = invalid_arg(_j_);
                   var file = _cV_[1];
                   load_data
                    (file,
                     function(data){
                      var
                       res = [0, 0],
                       row = [0, 0],
                       _c4_ = caml_ml_string_length(data) - 1 | 0,
                       _c3_ = 0;
                      if(_c4_ >= 0){
                       var i = _c3_;
                       for(;;){
                      ...
                      function _c5_(c){
                       var
                        img = unsafeCreateElement(document, _bU_),
                        t65 = img_assoc(c);
                       img.src = t65;
                       return img;
                      }
                      var
                       cells =
                         map$0(function(_c8_){return map$0(_c5_, _c8_);}, map$1),
                       gx = [0, 0],
                       gy = [0, 0],
                       ex = [0, 0],
                       ey = [0, 0],
                       ...
                       style$0 = [0, style],
                       table = unsafeCreateElement(document, _bV_);
                      opt_style(table, style$0);
                      var _cY_ = cells.length - 2 | 0, tr_style = 0, _cX_ = 0;
                      if(_cY_ >= 0){
                       var y = _cX_;
                       for(;;){
                        ...
                        var
                         _c0_ = caml_check_bound(cells, y)[1 + y].length - 2 | 0,
                         _cZ_ = 0;
                        if(_c0_ >= 0){
                         var x = _cZ_;
                         for(;;){
