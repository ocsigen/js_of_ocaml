...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gs_ = caml_wrap_exception(_gt_);
      if(_gs_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gs_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _gr_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_gr_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _fZ_ = _fY_ ? str : symbol(str, _a9_);
     ...
     if(2 < match >>> 0)
      ...
      switch(match){
        ...
        case 1:
         var _fH_ = _bs_; break;
        default:
         var _fG_ = field(e, 1), _fH_ = caml_call1(sprintf(_bt_), _fG_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _fu_ = slot[4],
        _fv_ = slot[3],
        _fw_ = slot[6] ? _bD_ : _bF_,
        _fx_ = slot[2],
        _fy_ = slot[7],
        _fz_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bE_), _fz_, _fy_, _fx_, _fw_, _fv_, _fu_, _ft_)];
      else if(slot[1])
       var match = 0;
      else
    ...
    try{
     try{
      ...
      try{
       ...
       caml_call1(eprintf(_bL_), _fl_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fm_ = to_string(exn);
       caml_call1(eprintf(_bM_), _fm_);
   ...
   if(test(global.location))
    ...
    var
     t42 = function(param, _fg_){return 0;},
     t41 = function(param, _ff_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b8_ = caml_wrap_exception(_fe_);
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l$0 >= i){
       var _fc_ = index_rec(path_string, l$0, i, c);
       break a;
      }
      var _fc_ = invalid_arg(_q_);
     }
     var j = _fc_;
    }
    catch(_fd_){
     var _fb_ = caml_wrap_exception(_fd_);
     if(_fb_ !== Not_found) throw caml_maybe_attach_backtrace(_fb_, 0);
     var j = l;
    }
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
           ...
           function(s){
            ...
            function _e$_(param){
             var
              y = param[2],
              x = param[1],
              _fa_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _fa_];
            }
            if(0 <= index)
             var
              _e9_ = s.slice(index + 1 | 0),
              _e__ = [0, s.slice(0, index), _e9_];
            else
             var _e__ = undefined$0;
            return case$1(_e__, interrupt, _e$_);
           }),
         acc],
        _e7_);
      return;
      ...
      if(_e6_ !== Local_exn) throw caml_maybe_attach_backtrace(_e6_, 0);
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _e5_ = caml_call1(f, v); return _e5_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _e4_ = result[1] === Canceled ? 1 : 0, is_canceled = _e4_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _e3_ = deferred_callbacks[2];
      if(! _e3_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _e3_[1];
      if(_e3_[2]){
       var next = _e3_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _e2_ = p[1];
    switch(_e2_[0]){
      case 1:
       return _e2_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _e1_ = caml_call1(f, v), p$0 = _e1_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function catch$0(f, h){
    try{var _eZ_ = caml_call1(f, 0), p = _eZ_;}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      var exn = p_result[1];
      current_storage[1] = saved_storage;
      try{var _e0_ = caml_call1(h, exn), p$1 = _e0_;}
      catch(exn){
   ...
   (opt,
      ...
      a:
      {
       b:
       {
        ...
        for(;;){
         ...
         c:
         {
          if(typeof _eF_ !== "number" && -976970511 === _eF_[1]){var _ey_ = 1; break c;}
          var _ey_ = 0;
         }
         if(! _ey_) break b;
         var param = l;
    ...
    if(0 === get_args)
          ...
          map
           (function(param){
             var
              v = param[2],
              n = param[1],
              _eX_ = symbol(_b6_, urlencode(0, v));
     ...
     try{
      ...
      var _eA_ = caml_wrap_exception(_eW_);
      if(_eA_ !== Not_found) throw caml_maybe_attach_backtrace(_eA_, 0);
      var _eJ_ = 0;
     }
     var _eK_ = _eJ_ ? _cI_ : _cJ_, url$0 = symbol(url, symbol(_eK_, _ez_));
    }
    var
     match$1 = task(0),
     w = match$1[2],
                ...
                var
                 ...
                 response =
                   [0,
                    ...
                    headers$0,
                    case$0
                     (req.responseText, function(param){return _cu_;}, _eO_),
                    _eN_];
             }
            ...
            (_cs_,
             map
              (function(param){
                ...
                var
                 s = match[2],
                 _eM_ = symbol(_cr_, urlencode(0, caml_string_of_jsstring(s)));
   ...
   function sleep(d){
    ...
    function callback(_ex_){return wakeup(w, _ex_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_ew_){return loop(remain, _ew_);};
   ...
   function fall(state){
    var changed = [0, 0], _d4_ = state[1].length - 1 - 2 | 0;
    if(_d4_ >= 1){
     var y = _d4_;
     for(;;){
      var
       _d6_ = caml_check_bound(state[1], y)[1 + y].length - 1 - 2 | 0,
       _d5_ = 1;
      if(_d6_ >= 1){
       var x = _d5_;
       for(;;){
        ...
        if(_d__)
         var
          ...
          _ea_ =
            3
             ===
              caml_check_bound(caml_check_bound(state[1], _d$_)[1 + _d$_], x)
               [1 + x]
             ? 1
             : 0;
        else
        ...
        if(_eb_){
         var
          ...
          _ed_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _ec_)[1 + _ec_], x)
               [1 + x]
             ? 1
             : 0;
         if(_ed_){
          var
           ...
           _ef_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _ee_)
                [1 + _ee_]
              ? 1
              : 0;
          if(_ef_)
           var
            ...
            _ei_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _eh_)[1 + _eh_], _eg_)
                 [1 + _eg_]
               ? 1
               : 0;
          else
        ...
        if(_ej_){
         var
          ...
          _el_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _ek_)[1 + _ek_], x)
               [1 + x]
             ? 1
             : 0;
         if(_el_){
          var
           ...
           _en_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _em_)
                [1 + _em_]
              ? 1
              : 0;
          if(_en_)
           var
            ...
            _eq_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _ep_)[1 + _ep_], _eo_)
                 [1 + _eo_]
               ? 1
               : 0;
          else
   ...
   function build_interaction(state, show_rem, clock){
    ...
    function _dr_(param){
     var _dv_ = state[1].length - 1 - 1 | 0, _du_ = 0;
     if(_dv_ >= 0){
      var y$0 = _du_;
      for(;;){
       var
        _dx_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 1 - 1 | 0,
        _dw_ = 0;
       if(_dx_ >= 0){
        var x$0 = _dw_;
        for(;;){
     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       a:
       {
        if(5 !== param$1 && 3 <= param$1){var _dR_ = 0; break a;}
        var _dR_ = 1;
       }
       if(_dR_){
        var
        ...
        var
         t25 = handler(function(_d3_){return inhibit(_dT_, _d3_);}),
         t26 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t26.onmouseover = t25;
        var
         t27 = handler(function(_d2_){return inhibit(_dV_, _d2_);}),
         t28 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t28.onmouseout = t27;
        let click$0 = click;
        var
         t29 = handler(function(_d1_){return inhibit(_dW_, _d1_);}),
         t30 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t30.onclick = t29;
        var
         _dS_ = function(_d0_){return with_pending_out(over_cont, _d0_);},
         _dT_ = function(_dZ_){return set_pending_out(_dS_, out_cont, _dZ_);},
         _dU_ = function(param){return return$0(0);},
         _dV_ = function(_dY_){return with_pending_out(_dU_, _dY_);},
         _dW_ = function(_dX_){return with_pending_out(click$0, _dX_);};
        if
         (5
          !== caml_check_bound(caml_check_bound(state[1], y)[1 + y], x)[1 + x]){
         var
     ...
     function update_push(pos, next, img, img_guy){
      ...
      try{
       ...
       var _dA_ = caml_wrap_exception(_dQ_);
       if(_dA_[1] !== Invalid_argument)
      ...
      var
       t39 = handler(function(_dP_){return inhibit(_dD_, _dP_);}),
       t40 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t40.onmouseover = t39;
      function _dC_(_dO_){return with_pending_out(over, _dO_);}
      function _dD_(_dN_){return set_pending_out(_dC_, out, _dN_);}
      var
       t41 = handler(function(_dM_){return inhibit(_dF_, _dM_);}),
       t42 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t42.onmouseout = t41;
      function _dE_(param){return return$0(0);}
      function _dF_(_dL_){return with_pending_out(_dE_, _dL_);}
      var
       t43 = handler(function(_dK_){return inhibit(_dG_, _dK_);}),
       t44 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t44.onclick = t43;
      function _dG_(_dJ_){return with_pending_out(click, _dJ_);}
      return;
     }
     ...
     if(m[1])
      if(is_empty(m[2]))
       ...
       var node = seq[2];
       remove(node);
       var r = node[3], result$0 = [0, v], p = underlying(r), _dt_ = p[1];
       switch(_dt_[0]){
         case 1:
          if(_dt_[1] !== Canceled)
    ...
    else{m[1] = 1; var _ds_ = return_unit;}
    return symbol_bind(_ds_, _dr_);
   }
      ...
      handler
       (function(param){
         ...
         function load_data(name, process){
          ...
          try{var _dn_ = return$0(caml_read_file_content(name)), _dp_ = _dn_;}
          catch(_dq_){
           var _dm_ = caml_wrap_exception(_dq_);
           if(_dm_ !== Not_found) throw caml_maybe_attach_backtrace(_dm_, 0);
           var
            _dp_ =
              symbol_bind
              ...
              for(;;){
               try{
                var
                 ...
                 st$2 = match$1[2],
                 snd = match$1[1],
                 _dk_ = [0, [0, [0, fst, snd], st$2]],
                 _dj_ = _dk_;
               }
               catch(_dl_){
                var _di_ = caml_wrap_exception(_dl_);
                if(_di_ !== Eos) throw caml_maybe_attach_backtrace(_di_, 0);
                var _dj_ = 0;
               }
               if(! _dj_) return return$0(rev(acc));
               var
                match = _dj_[1],
                st$0 = match[2],
                elt = match[1],
           ...
           function(levels){
            ...
            var
             t77 =
               handler
                (function(param$0){
                  var i = select.selectedIndex - 1 | 0, _c4_ = 0 <= i ? 1 : 0;
                  if(_c4_){
                  ...
                  if(_c5_){
                   if(0 <= i){
                    var l$0 = levels, n = i;
                    for(;;){
                     if(! l$0){var _c6_ = failwith(_j_); break;}
                     var l$1 = l$0[2], a = l$0[1];
                     if(0 === n){var _c6_ = a; break;}
                     var n$0 = n - 1 | 0, l$0 = l$1, n = n$0;
                    }
                   }
                   else
                    var _c6_ = invalid_arg(_k_);
                   var file = _c6_[1];
                   load_data
                    (file,
                     function(data){
                      var
                       res = [0, 0],
                       row = [0, 0],
                       _dd_ = caml_ml_string_length(data) - 1 | 0,
                       _dc_ = 0;
                      if(_dd_ >= 0){
                       var i = _dc_;
                       for(;;){
                      ...
                      var
                       map$1 = of_list(map(of_list, rev(res[1]))),
                       cells =
                         map$0(function(_dh_){return map$0(_de_, _dh_);}, map$1),
                       gx = [0, 0],
                       gy = [0, 0],
                       ex = [0, 0],
                       ey = [0, 0],
                      ...
                      if(_c9_ >= 0){
                       ...
                       for(;;){
                        ...
                        var
                         _c$_ = caml_check_bound(cells, y)[1 + y].length - 1 - 1 | 0,
                         _c__ = 0;
                        if(_c$_ >= 0){
                         var x = _c__;
                         for(;;){
