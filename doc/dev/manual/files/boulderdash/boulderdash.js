...
(function(globalThis){
   ...
   if(a && a[1] === cst$0){
    var _b1_ = a[2];
    if(! _b1_ || _b1_[1] === cst$0 && ! _b1_[2]) break a;
   }
   var
   ...
   function fall(state){
    var changed = [0, 0], _d5_ = state[1].length - 3 | 0;
    if(_d5_ >= 1){
     var y = _d5_;
     for(;;){
      var
       _d7_ = caml_check_bound(state[1], y)[1 + y].length - 3 | 0,
       _d6_ = 1;
      if(_d7_ >= 1){
       var x = _d6_;
       for(;;){
   ...
   function build_interaction(state, show_rem, clock){
    ...
    function _dn_(param){
     var _dr_ = state[1].length - 2 | 0, _dq_ = 0;
     if(_dr_ >= 0){
      var y$0 = _dq_;
      for(;;){
       var
        _dt_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 2 | 0,
        _ds_ = 0;
       if(_dt_ >= 0){
        var x$0 = _ds_;
        for(;;){
                   ...
                   load_data
                    (file,
                     function(data){
                      ...
                      var _c5_ = cells.length - 2 | 0, tr_style = 0, _c4_ = 0;
                      if(_c5_ >= 0){
                       var y = _c4_;
                       for(;;){
                        ...
                        var
                         _c7_ = caml_check_bound(cells, y)[1 + y].length - 2 | 0,
                         _c6_ = 0;
                        if(_c7_ >= 0){
                         var x = _c6_;
                         for(;;){
