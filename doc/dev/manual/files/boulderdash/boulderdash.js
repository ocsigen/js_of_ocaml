...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gQ_ = caml_wrap_exception(_gR_);
      if(_gQ_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gQ_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _gP_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_gP_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   var at_exit_key = new_key(0, function(param, _gL_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _gK_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _gK_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gJ_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gJ_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gJ_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _gx_ = caml_ml_bytes_length(b) - 1 | 0,
     _gw_ = 0;
    if(_gx_ >= 0){
     var i$0 = _gw_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _gz_ = caml_ml_bytes_length(b) - 1 | 0, _gy_ = 0;
     if(_gz_ >= 0){
      var i = _gy_;
      for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _gm_ = _az_; break;
      default: var _gm_ = _aI_;
    }
    return transform_int_alt(iconv, caml_int64_format(_gm_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _gj_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _gj_ >>> 0){
           if(55 === _gj_) break a;
          }
          else if(21 < _gj_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _gk_ = 1;
        }
        var _gl_ = _gk_ ? str : symbol(str, _a9_);
        return caml_special_val(_gl_);
       }
      case 6:
       return hex(0);
      case 7:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _gc_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _gc_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _f$_ = [8, acc, _bg_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _f$_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _f$_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _f__ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _f__, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _f__, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _f9_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _f9_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _f7_ = other_fields(x, i + 1 | 0), _f8_ = field(x, i);
    return caml_call2(sprintf(_bp_), _f8_, _f7_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_f6_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _f2_ = other_fields(e, 2),
       _f3_ = field(e, 1),
       _f5_ = caml_call2(sprintf(_bq_), _f3_, _f2_);
     else
      switch(match){
        case 0:
         var _f5_ = _br_; break;
        case 1:
         var _f5_ = _bs_; break;
        default:
         var _f4_ = field(e, 1), _f5_ = caml_call1(sprintf(_bt_), _f4_);
      }
     var match$0 = [0, constructor, [0, _f5_]];
    }
    else
     var match$0 = [0, e[1], 0];
    ...
    if(_f0_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _bz_ : _bA_ : 0 === pos$0 ? _bB_ : _bC_;
      }
      if(0 === slot[0])
       var
        _fR_ = slot[5],
        _fS_ = slot[4],
        _fT_ = slot[3],
        _fU_ = slot[6] ? _bD_ : _bF_,
        _fV_ = slot[2],
        _fW_ = slot[7],
        _fX_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bE_), _fX_, _fW_, _fV_, _fU_, _fT_, _fS_, _fR_)];
      else if(slot[1])
       var match = 0;
      else
       var _fY_ = info(0), match = [0, caml_call1(sprintf(_bG_), _fY_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_fP_){}
      try{
       var _fF_ = to_string(exn$0);
       caml_call1(eprintf(_bJ_), _fF_);
       ...
       var _fH_ = caml_ml_flush(stderr), _fL_ = _fH_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _fJ_ = to_string(exn$0);
       caml_call1(eprintf(_bL_), _fJ_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fK_ = to_string(exn);
       caml_call1(eprintf(_bM_), _fK_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _fL_ = caml_ml_flush(stderr);
      }
      var _fM_ = _fL_;
     }
     catch(_fO_){
      var _fI_ = caml_wrap_exception(_fO_);
      if(_fI_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_fI_, 0);
      var _fM_ = prerr_endline(_bK_);
     }
     return _fM_;
    }
    catch(_fN_){return 0;}
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b8_ = caml_wrap_exception(_fC_);
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l$0 >= i){
       var _fA_ = index_rec(path_string, l$0, i, c);
       break a;
      }
      var _fA_ = invalid_arg(_q_);
     }
     var j = _fA_;
    }
    catch(_fB_){
     var _fz_ = caml_wrap_exception(_fB_);
     if(_fz_ !== Not_found) throw caml_maybe_attach_backtrace(_fz_, 0);
     var j = l;
    }
      ...
      var
       ...
       _ft_ =
         function(s){
          ...
          if(0 <= index)
           var
            _fv_ = s.slice(index + 1 | 0),
            _fw_ = [0, s.slice(0, index), _fv_];
          else
           var _fw_ = undefined$0;
          return case$1(_fw_, interrupt, _fx_);
         };
      aux$0([0, case$1(arr[idx$0], interrupt, _ft_), acc], _fs_);
      return;
     }
     catch(_fu_){
      var _fr_ = caml_wrap_exception(_fu_);
      if(_fr_ !== Local_exn) throw caml_maybe_attach_backtrace(_fr_, 0);
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _fq_ = caml_call1(f, v); return _fq_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _fp_ = result[1] === Canceled ? 1 : 0, is_canceled = _fp_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _fo_ = deferred_callbacks[2];
      if(! _fo_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _fo_[1];
      if(_fo_[2]){
       var next = _fo_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _fn_ = p[1];
    switch(_fn_[0]){
      case 1:
       return _fn_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _fm_ = caml_call1(f, v), p$0 = _fm_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function catch$0(f, h){
    try{var _fk_ = caml_call1(f, 0), p = _fk_;}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      var exn = p_result[1];
      current_storage[1] = saved_storage;
      try{var _fl_ = caml_call1(h, exn), p$1 = _fl_;}
      catch(exn){
   ...
   (opt,
    ...
    if(_eT_) var sth$0 = _eT_[1], get_args = sth$0; else var get_args = 0;
    if(_eS_)
     var sth$1 = _eS_[1], check_headers = sth$1;
    else
     var check_headers = function(param, _fj_){return 1;};
    if(contents){
     var c$0 = contents[1], _eU_ = c$0[1];
     if(440620227 === _eU_){
      var args = c$0[2];
      a:
      {
       b:
       {
        ...
        for(;;){
         if(! param) break;
         var l = param[2], a = param[1], _eV_ = a[2];
         c:
         {
          if(typeof _eV_ !== "number" && -976970511 === _eV_[1]){var _eO_ = 1; break c;}
          var _eO_ = 0;
         }
         if(! _eO_) break b;
         var param = l;
      ...
      if(only_strings)
       ...
       if(match)
        var constr = match[1], _eW_ = [0, 808620462, new constr];
       else
        var _eW_ = [0, 891486873, [0, 0]];
       var form_contents = _eW_;
      }
      iter
       (function(param){
         var
        ...
        args);
      var _eX_ = [0, -836918635, form_contents];
     }
     else if(737307005 <= _eU_)
      var b = c$0[2], _eX_ = [0, 737307005, b];
     else
      var _eX_ = c$0;
     var contents$0 = [0, _eX_];
    }
    else
     var contents$0 = 0;
          ...
          map
           (function(param){
             var
              v = param[2],
              n = param[1],
              _fi_ = symbol(_b6_, urlencode(0, v));
             return symbol(urlencode(0, n), _fi_);
            },
            get_args));
     try{
      index_rec(url, caml_ml_string_length(url), 0, 63);
      var _eR_ = 1, _eZ_ = _eR_;
     }
     catch(_fh_){
      var _eQ_ = caml_wrap_exception(_fh_);
      if(_eQ_ !== Not_found) throw caml_maybe_attach_backtrace(_eQ_, 0);
      var _eZ_ = 0;
     }
     var _e0_ = _eZ_ ? _cI_ : _cJ_, url$0 = symbol(url, symbol(_e0_, _eP_));
    }
    var
     match$1 = task(0),
     w = match$1[2],
    ...
    function headers$0(s){
     function _ff_(v){return [0, caml_string_of_jsstring(v)];}
     function _fg_(param){return 0;}
     return case$0
             (req.getResponseHeader(caml_jsbytes_of_string(s)), _fg_, _ff_);
    }
    var st = [0, 382334108];
             ...
             switch(response_type){
               case 0:
                var
                 ...
                 e$1 = req.response,
                 _fd_ = e$1 instanceof arrayBuffer ? e$1 : no_handler,
                 response = [0, url$0, code, headers$0, _fd_, _fc_];
                break;
               case 1:
                var
                 code$0 = req.status,
                 ...
                 e$0 = req.response,
                 _fb_ = e$0 instanceof blob_constr ? e$0 : no_handler,
                 response = [0, url$0, code$0, headers$0, _fb_, _fa_];
                break;
               case 2:
                var
                 code$1 = req.status,
                 ...
                 e = req.response,
                 _e__ = e instanceof doc_constr ? e : no_handler,
                 response = [0, url$0, code$1, headers$0, _e__, _e9_];
                break;
               case 3:
                var
                 code$2 = req.status,
                 ...
                 response = [0, url$0, code$2, headers$0, req.response, _e$_];
                break;
               case 4:
                var
                 code$3 = req.status,
                 ...
                 _e7_ = function(x){return x;},
                 _e8_ = function(param){return cst$0;},
                 response =
                   [0,
                    url$0,
                    code$3,
                    headers$0,
                    case$0(req.responseText, _e8_, _e7_),
                    _e6_];
                break;
               default:
                var
                 ...
                 _e4_ = caml_string_of_jsstring,
                 _e5_ = function(param){return _cu_;},
                 response =
                   [0,
                    url$0,
                    code$4,
                    headers$0,
                    case$0(req.responseText, _e5_, _e4_),
                    _e3_];
             }
    ...
    if(contents$0){
     var match$2 = contents$0[1], _eY_ = match$2[1];
     if(-836918635 === _eY_){
             ...
             map
              (function(param){
                ...
                if(781515420 <= match[1]){
                 ...
                 return symbol(urlencode(0, name), _e1_);
                }
                var
                 s = match[2],
                 _e2_ = symbol(_cr_, urlencode(0, caml_string_of_jsstring(s)));
                return symbol(urlencode(0, name), _e2_);
               },
               l$1))));
      }
      else{var f = match$3[2]; req.send(f);}
     }
     else if(737307005 <= _eY_){
      var b$0 = match$2[2];
      req.send(b$0);
     }
   ...
   function sleep(d){
    ...
    function callback(_eN_){return wakeup(w, _eN_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_eM_){return loop(remain, _eM_);};
   ...
   function fall(state){
        ...
        if(_eo_)
         var
          ...
          _eq_ =
            3
             ===
              caml_check_bound(caml_check_bound(state[1], _ep_)[1 + _ep_], x)
               [1 + x]
             ? 1
             : 0;
        else
        ...
        if(_er_){
         var
          ...
          _et_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _es_)[1 + _es_], x)
               [1 + x]
             ? 1
             : 0;
         if(_et_){
    ...
    function _ei_(param){return fall(state);}
    return symbol_bind(sleep(0.05), _ei_);
   }
   function build_interaction(state, show_rem, clock){
    var clock_stop = clock[3];
    function _dy_(param){
     var _dC_ = state[1].length - 1 - 1 | 0, _dB_ = 0;
     if(_dC_ >= 0){
      var y$0 = _dB_;
      for(;;){
       var
        _dE_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 1 - 1 | 0,
        _dD_ = 0;
       if(_dE_ >= 0){
        var x$0 = _dD_;
        for(;;){
     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       a:
       {
        if(5 !== param$1 && 3 <= param$1){var _dZ_ = 0; break a;}
        var _dZ_ = 1;
       }
       if(_dZ_){
        var
         ...
         cur_img = t20.src;
        let
         click_cont$1 = click_cont$0,
         out_cont$1 = out_cont$0,
         over_cont$1 = over_cont$0,
         y$0 = y,
         x$0 = x,
         cur_img$0 = cur_img;
         ...
         var
          t22 =
            caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
             [1 + x$0];
         t22.src = img;
         return caml_call1(over_cont$1, 0);
        }
         ...
         var
          t24 =
            caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
             [1 + x$0];
         t24.src = cur_img$0;
         return caml_call1(out_cont$1, 0);
        }
        function click_cont(param){
         ...
         return symbol_bind(caml_call1(click_cont$1, 0), _ec_);
        }
         ...
         return symbol_bind
                 (catch$0
                   (function(param){
                     ...
                     return symbol_bind(caml_call1(click_cont$1, 0), _eb_);
                    },
                    function(e){
        ...
        function _d0_(_d$_){return with_pending_out(over_cont, _d$_);}
        function _d1_(_d__){return set_pending_out(_d0_, out_cont, _d__);}
        var
         t25 = handler(function(_d9_){return inhibit(_d1_, _d9_);}),
         t26 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t26.onmouseover = t25;
        function _d2_(param){return return$0(0);}
        function _d3_(_d8_){return with_pending_out(_d2_, _d8_);}
        var
         t27 = handler(function(_d7_){return inhibit(_d3_, _d7_);}),
         t28 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t28.onmouseout = t27;
        let click$0 = click;
        function _d4_(_d6_){return with_pending_out(click$0, _d6_);}
        var
         t29 = handler(function(_d5_){return inhibit(_d4_, _d5_);}),
         t30 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
        t30.onclick = t29;
        if
     ...
     function update_push(pos, next, img, img_guy){
      ...
      try{
       ...
       var _dH_ = caml_wrap_exception(_dY_);
       if(_dH_[1] !== Invalid_argument)
      ...
      function click(param){
       ...
       function _dX_(param){return build_interaction(state, show_rem, clock);}
       return symbol_bind
               (catch$0
      ...
      function _dJ_(_dW_){return with_pending_out(over, _dW_);}
      function _dK_(_dV_){return set_pending_out(_dJ_, out, _dV_);}
      var
       t39 = handler(function(_dU_){return inhibit(_dK_, _dU_);}),
       t40 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t40.onmouseover = t39;
      function _dL_(param){return return$0(0);}
      function _dM_(_dT_){return with_pending_out(_dL_, _dT_);}
      var
       t41 = handler(function(_dS_){return inhibit(_dM_, _dS_);}),
       t42 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t42.onmouseout = t41;
      function _dN_(_dR_){return with_pending_out(click, _dR_);}
      var
       t43 = handler(function(_dQ_){return inhibit(_dN_, _dQ_);}),
       t44 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t44.onclick = t43;
     ...
     if(m[1])
      if(is_empty(m[2]))
       ...
       var node = seq[2];
       remove(node);
       var r = node[3], result$0 = [0, v], p = underlying(r), _dA_ = p[1];
       switch(_dA_[0]){
         case 1:
          if(_dA_[1] !== Canceled)
    ...
    else{m[1] = 1; var _dz_ = return_unit;}
    return symbol_bind(_dz_, _dy_);
   }
      ...
      handler
       (function(param){
         ...
         function update_cb(param){
          ...
          function _dx_(param){return update_cb(0);}
          return symbol_bind(sleep(1.), _dx_);
         }
         update_cb(0);
         var
          clock =
         ...
         function load_data(name, process){
          ...
          function _dt_(data){
           function _dw_(res){removeChild(parent, div); return return$0(res);}
           return symbol_bind(caml_call1(process, data), _dw_);
          }
          try{var _ds_ = return$0(caml_read_file_content(name)), _du_ = _ds_;}
          catch(_dv_){
           var _dr_ = caml_wrap_exception(_dv_);
         ...
         function _c4_(levels){
          ...
          var
           t77 =
             handler
              (function(param$0){
                var i = select.selectedIndex - 1 | 0, _c9_ = 0 <= i ? 1 : 0;
                if(_c9_){
                ...
                if(_c__){
                 if(0 <= i){
                  var l$0 = levels, n = i;
                  for(;;){
                   if(! l$0){var _c$_ = failwith(_j_); break;}
                   var l$1 = l$0[2], a = l$0[1];
                   if(0 === n){var _c$_ = a; break;}
                   var n$0 = n - 1 | 0, l$0 = l$1, n = n$0;
                  }
                 }
                 else
                  var _c$_ = invalid_arg(_k_);
                 var file = _c$_[1];
                 load_data
                  (file,
                   function(data){
                    var
                     res = [0, 0],
                     row = [0, 0],
                     _di_ = caml_ml_string_length(data) - 1 | 0,
                     _dh_ = 0;
                    if(_di_ >= 0){
                     var i = _dh_;
                     for(;;){
                    ...
                    var
                     cells =
                       map$0(function(_dp_){return map$0(_dj_, _dp_);}, map$1),
                     gx = [0, 0],
                     gy = [0, 0],
                     ex = [0, 0],
                     ey = [0, 0],
                    ...
                    var _dc_ = cells.length - 1 - 1 | 0, tr_style = 0, _db_ = 0;
                    if(_dc_ >= 0){
                     var y = _db_;
                     for(;;){
                      ...
                      var
                       _de_ = caml_check_bound(cells, y)[1 + y].length - 1 - 1 | 0,
                       _dd_ = 0;
                      if(_de_ >= 0){
                       var x = _dd_;
                       for(;;){
                    ...
                    function _dk_(param){
                     ...
                     function fade(param){
                      ...
                      return symbol_bind(sleep(0.05), _do_);
                     }
                     function _dn_(param){
                      caml_call1(clock_start, 0);
                      return return$0(0);
                     }
                     return symbol_bind(fade(0), _dn_);
                    }
                    var _da_ = [0, 0, create(0)];
                    return symbol_bind
                            (build_interaction
                              ([0,
                                map$1,
              ...
              for(;;){
               try{
                var
                 ...
                 st$2 = match$1[2],
                 snd = match$1[1],
                 _c7_ = [0, [0, [0, fst, snd], st$2]],
                 _c6_ = _c7_;
               }
               catch(_c8_){
                var _c5_ = caml_wrap_exception(_c8_);
                if(_c5_ !== Eos) throw caml_maybe_attach_backtrace(_c5_, 0);
                var _c6_ = 0;
               }
               if(! _c6_) return return$0(rev(acc));
               var
                match = _c6_[1],
                st$0 = match[2],
                elt = match[1],
