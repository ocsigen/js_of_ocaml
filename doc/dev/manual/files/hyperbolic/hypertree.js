...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.5.2+git-94bee37
(function
  (Object){
...
(function(globalThis){
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 23:
        ...
        switch(ign[0]){
          ...
          case 9:
           ...
           return make_from_fmtty$0(counter$0, k$0, acc$0, fmtty$0, rest$22);
          case 10:
           if(counter >= 50)
            return caml_trampoline_return
                    (make_invalid_arg, [0, k$0, acc$0, rest$22]);
       ...
       default:
        ...
        return make_custom$0(counter$15, k$0, acc$0, rest$23, arity, _hh_);
     }
    }
   }
   ...
   function iter$1(x, f){
    ...
    return _gz_ ? caml_call1(f, x) : _gz_;
   }
   ...
   function iter$2(x, f){
    ...
    return _gy_ ? caml_call1(f, x) : _gy_;
   }
   ...
   function stopPropagation(t109){
    ...
    return case$1(t109.stopPropagation, _gu_, _gt_);
   }
   global.FormData;
   global.FormData;
