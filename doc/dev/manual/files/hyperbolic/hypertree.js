...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.6.0+git-679bb51
(function
  (Object){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        ...
        if(0 === _hd_[0]){
         ...
         function k$1(kacc){return make_printf(k, [1, acc, [0, kacc]], rest);}
         var k$0 = k$1, acc$0 = 0, fmt$0 = fmt$1;
        }
        else{
         var rest$18 = fmt$0[2], fmt$2 = _hd_[1][1];
         let acc = acc$0, k = k$0, rest = rest$18;
         function k$2(kacc){return make_printf(k, [1, acc, [1, kacc]], rest);}
