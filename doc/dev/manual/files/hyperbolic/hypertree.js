...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.6.0+git-b7d2959
(function
  (Object){
   ...
   function getfile(url){
    try{var _fR_ = return$0(caml_read_file_content(url)); return _fR_;}
     ...
     var
      ...
      contents = 0;
     {var content_type = content_type$1, method$0 = method;}
     var
      match$1 = task(0),
      w = match$1[2],
      res = match$1[1],
     ...
     if(content_type){
      var content_type$0 = content_type[1];
      req.setRequestHeader
       ("Content-type", caml_jsstring_of_string(content_type$0));
     }
     iter
      (function(param){
     ...
     if(contents){
      var match$2 = contents[1], _fO_ = match$2[1];
      if(-836918635 === _fO_){
       ...
       if(891486873 <= match$3[1]){
        ...
        if(l$1){
         ...
         var dst$1 = caml_create_bytes(_fL_), pos = pos$1, param$1 = l$1;
         for(;;){
          if(param$1){
           var hd$0 = param$1[1];
           if(param$1[2]){
       ...
       else{var f$0 = match$3[2]; req.send(f$0);}
      }
      else if(737307005 <= _fO_){
       var b = match$2[2];
       req.send(b);
      }
      else{var s = match$2[2]; req.send(caml_jsstring_of_string(s));}
     }
     else
      req.send(no_handler);
