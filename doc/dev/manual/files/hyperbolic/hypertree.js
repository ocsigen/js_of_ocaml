...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.7.0+e269769
(function
  (Object){
...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _hm_ = caml_wrap_exception(_hn_);
      if(_hm_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_hm_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function fold_left(f, x, a){
    var r = [0, x], _he_ = a.length - 1 - 1 | 0, _hd_ = 0;
    if(_he_ >= 0){
     var i = _hd_;
     for(;;){
   ...
   var key_counter = [0, 0], parent_keys = [0, 0], _s_ = "Array.blit";
   ...
   var at_exit_key = new_key(0, function(param, _hc_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _hb_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _hb_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ha_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ha_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ha_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _g9_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _g9_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _g__ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _g__))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _g8_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _g8_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _g0_ = caml_ml_bytes_length(b) - 1 | 0,
     _gZ_ = 0;
    if(_g0_ >= 0){
     var i$0 = _gZ_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _g2_ = caml_ml_bytes_length(b) - 1 | 0, _g1_ = 0;
     if(_g2_ >= 0){
      var i = _g1_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _gM_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _gM_ >>> 0){
           if(55 === _gM_) break a;
          }
          else if(21 < _gM_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _gN_ = 1;
        }
        var _gO_ = _gN_ ? str : symbol(str, _a7_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _gG_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _gG_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _gG_[1];
       ...
       case 18:
        var _gE_ = fmt$0[1];
        if(0 === _gE_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _gE_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _gE_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _gF_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _gF_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _gC_ = [8, acc, _be_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _gC_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _gC_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _gB_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _gB_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _gB_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _gz_ = other_fields(x, i + 1 | 0), _gA_ = field(x, i);
    return caml_call2(sprintf(_bn_), _gA_, _gz_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_gy_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _gu_ = other_fields(e, 2),
       _gv_ = field(e, 1),
       _gx_ = caml_call2(sprintf(_bo_), _gv_, _gu_);
     else
      switch(match){
        case 0:
         var _gx_ = _bp_; break;
        case 1:
         var _gx_ = _bq_; break;
        default:
         var _gw_ = field(e, 1), _gx_ = caml_call1(sprintf(_br_), _gw_);
      }
     var match$0 = [0, constructor, [0, _gx_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _gk_ = slot[4],
        _gl_ = slot[3],
        _gm_ = slot[6] ? _bB_ : _bD_,
        _gn_ = slot[2],
        _go_ = slot[7],
        _gp_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bC_), _gp_, _go_, _gn_, _gm_, _gl_, _gk_, _gj_)];
      else if(slot[1])
       var match = 0;
      else
       var _gq_ = info(0), match = [0, caml_call1(sprintf(_bE_), _gq_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_gh_){}
      try{
       var _f9_ = to_string(exn$0);
       caml_call1(eprintf(_bG_), _f9_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _f__ = abs(status);
        prerr_endline(caml_check_bound(errors, _f__)[1 + _f__]);
       }
       var _f$_ = caml_ml_flush(stderr), _gd_ = _f$_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _gb_ = to_string(exn$0);
       caml_call1(eprintf(_bI_), _gb_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _gc_ = to_string(exn);
       caml_call1(eprintf(_bJ_), _gc_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _gd_ = caml_ml_flush(stderr);
      }
      var _ge_ = _gd_;
     }
     catch(_gg_){
      var _ga_ = caml_wrap_exception(_gg_);
      if(_ga_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_ga_, 0);
      var _ge_ = prerr_endline(_bH_);
     }
     return _ge_;
    }
    catch(_gf_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    ...
    var i3$0 = caml_notequal(i3, _bL_) ? i3 : _bO_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bM_) ? i4 : _bN_;
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _f5_ = get_int64_le(d2, 8),
     _f6_ = get_int64_le(d2, 0),
     _f7_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _f7_, _f6_, _f5_);
    return s;
   }
   var
   ...
   var
    ...
    _n_ = cst$0,
    _m_ = "String.concat",
    _bX_ = "Hashtbl: unsupported hash table format",
    _bV_ = cst$0,
    ...
    _b0_ = "dl",
    _bZ_ = "ul",
    _b7_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b9_ = "[\\][()\\\\|+*.?{}^$]",
    _b__ = "Js_of_ocaml__Url.Local_exn",
    _c3_ = cst$3,
    _cm_ = [0, 0],
    _cn_ = [0, 1],
    _ck_ = [0, 0],
    ...
    _ch_ = "wakeup_exn",
    _cg_ = "wakeup",
    _cd_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _ce_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cf_ = [0, 0],
    _cb_ = cst_Fatal_error_exception,
    _cc_ = "Lwt.Resolution_loop.Canceled",
    _cu_ = cst_POST,
    _cs_ = cst_POST,
    _ct_ = cst_POST,
    _cr_ = cst$0,
    _co_ = cst$4,
    _cp_ = cst$4,
    _cq_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cv_ = "Exception during Lwt.async: ",
    _cZ_ = cst_info_38_png,
    _c0_ = cst_globe_38_png,
    _c1_ = cst_meeting_point_38_png,
    _c2_ = cst_ocsigen_powered_png,
    _cU_ = ".wikipedia.org/wiki/",
    _cV_ = "http://",
    _cP_ = cst_px,
    _cX_ = cst_jpg,
    _cY_ = "images/",
    _cQ_ = cst$0,
    _cW_ = "?uselang=",
    _cR_ = "http://commons.wikimedia.org/wiki/File:",
    _cS_ = cst_commons_38_png,
    _cT_ = cst_wikipedia_38_png,
    _cI_ = cst_px,
    _cJ_ = "px 3px",
    _cK_ = "px 3px ",
    _cL_ = cst_on,
    ...
    _cG_ = cst_on,
    _cH_ = cst_off,
    _cF_ = "image_info.json",
    _cD_ = [0, 0, 0, 0.],
    _cE_ = [254, -1., 0.],
    _cC_ = [0, "examples/hyperbolic/hypertree.ml", 972, 2],
    _cB_ = "<TITLE>",
    _cA_ = cst$0,
    _cy_ = cst_jpg,
    _cz_ = "thumbnails/",
    _cx_ = "messages.json",
    _cw_ = "icons/";
   try{var _c5_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _c5_;}
   catch(_f1_){
    var _bT_ = caml_wrap_exception(_f1_);
    if(_bT_ !== Not_found) throw caml_maybe_attach_backtrace(_bT_, 0);
    try{var _c4_ = caml_sys_getenv("CAMLRUNPARAM"), _bW_ = _c4_;}
    catch(_f2_){
     var _bU_ = caml_wrap_exception(_f2_);
     if(_bU_ !== Not_found) throw caml_maybe_attach_backtrace(_bU_, 0);
     var _bW_ = _bV_;
    }
    var params = _bW_;
   }
   ...
   if(l < 0)
    ...
    try{index_rec(params, l, i, c); var _r_ = 1, randomized_default = _r_;}
    catch(_f0_){
     var _q_ = caml_wrap_exception(_f0_);
   ...
   function find(h, key){
    var
     _fZ_ = key_index(h, key),
     match = caml_check_bound(h[2], _fZ_)[1 + _fZ_];
   ...
   function iter$1(x, f){
    var _fY_ = 1 - (x == no_handler ? 1 : 0);
    return _fY_ ? caml_call1(f, x) : _fY_;
   }
   ...
   function iter$2(x, f){
    var _fX_ = 1 - (x === undefined$0 ? 1 : 0);
    return _fX_ ? caml_call1(f, x) : _fX_;
   }
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    function callback(e){
     var _fU_ = [0, h, e, [0]];
     return function(_fV_, _fW_){return caml_js_call(_fU_, _fV_, _fW_);};
    }
   ...
   function createCanvas(doc){
    var t52 = unsafeCreateElement(doc, _b8_);
   ...
   var
    ...
    quote_re = regexp(_b9_),
    Local_exn = [248, _b__, caml_fresh_oo_id(0)];
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _fT_){return 0;},
     t41 = function(param, _fS_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _ca_ = caml_wrap_exception(_fR_);
    if(_ca_[1] !== Failure) throw caml_maybe_attach_backtrace(_ca_, 0);
   }
   var
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l >= i){
       var _fP_ = index_rec(path_string, l, i, c);
       break a;
      }
      var _fP_ = invalid_arg(_o_);
     }
     var j = _fP_;
    }
    catch(_fQ_){
     var _fO_ = caml_wrap_exception(_fQ_);
     if(_fO_ !== Not_found) throw caml_maybe_attach_backtrace(_fO_, 0);
     var j = l$0;
    }
   ...
   if(a && ! caml_string_notequal(a[1], cst$0)){
    var _b$_ = a[2];
    if(! _b$_ || ! caml_string_notequal(_b$_[1], cst$0) && ! _b$_[2]) break a;
   }
   var
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
           ...
           function(s){
            ...
            function _fM_(param){
             var
              y = param[2],
              x = param[1],
              _fN_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _fN_];
            }
            if(0 <= index)
             var
              _fK_ = s.slice(index + 1 | 0),
              _fL_ = [0, s.slice(0, index), _fK_];
            else
             var _fL_ = undefined$0;
      ...
      var _fI_ = caml_wrap_exception(_fJ_);
      if(_fI_ !== Local_exn) throw caml_maybe_attach_backtrace(_fI_, 0);
   ...
   symbol(s$1, symbol(_c3_, git_version));
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _fH_ = caml_call1(f, v); return _fH_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _fG_ = result[1] === Canceled ? 1 : 0, is_canceled = _fG_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _fF_ = deferred_callbacks[2];
      if(! _fF_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _fF_[1];
      if(_fF_[2]){
       var next = _fF_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _fE_ = p[1];
    switch(_fE_[0]){
      case 1:
       return _fE_[1] === Canceled
               ? 0
      ...
      case 2:
       ...
       resolve(_cf_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _cd_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_cg_, r, [0, v]);}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_ck_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _fD_ = caml_call1(f, v), user_provided_promise = _fD_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_cj_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_ci_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
   ...
   var Wrong_headers = [248, _cq_, caml_fresh_oo_id(0)];
   function yield$0(param){
    var match = task(0), w = match[2], t = match[1];
    function callback(_fC_){return wakeup(w, _fC_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_fB_){return loop(remain, _fB_);};
   ...
   function icon(nm){return caml_jsstring_of_string(symbol(_cw_, nm));}
   ...
   function transf(a, b, c, d, z){
    var _fA_ = add_mul(c, z, d);
    return div(add_mul(a, z, b), _fA_);
   }
   function transl(p){
    var c = mul(conj(p), one);
    return function(z){return transf(one, p, c, one, z);};
   }
   function compose(param, _fy_){
    var
     t2 = _fy_[2],
     p2 = _fy_[1],
     t1 = param[2],
     ...
     _fz_ = div(conj(den), den),
     c = mul(mul(t1, t2), _fz_),
     _fx_ = sdiv(c, norm(c));
    return [0, div(add$0(t2p1, p2), den), _fx_];
   }
   function compute_translation(z0, z1){
    var dz = sub$1(z1, z0), z0z1 = mul(z0, z1), _fw_ = 1. - sq_norm(z0z1);
    return sdiv(add$0(mul(z0z1, conj(dz)), dz), _fw_);
   }
   var json = JSON;
   function getfile(url){
    try{var _fq_ = return$0(caml_read_file_content(url)); return _fq_;}
    catch(_fr_){
     var _fp_ = caml_wrap_exception(_fr_);
     if(_fp_ !== Not_found) throw caml_maybe_attach_backtrace(_fp_, 0);
     var
      content_type$2 = 0,
      check_headers = function(param, _fv_){return 1;},
      contents = 0,
      _fo_ =
        function(r){
         var cod = r[2], msg = r[4];
     ...
     if(contents){
      ...
      if(-836918635 === match$1[1]){
       ...
       if(891486873 <= form[1])
        ...
        var content_type$0 = content_type$2, method$0 = _ct_;
      }
      else
       var content_type$0 = content_type$2, method$0 = _cu_;
     }
     else
     ...
     if(contents){
      var match$3 = contents[1], _fn_ = match$3[1];
      if(-836918635 === _fn_){
           ...
           function(param){
            ...
            if(781515420 <= match[1]){
             var
              t0 = match[2],
              _fs_ =
                symbol(_co_, urlencode(0, caml_string_of_jsstring(t0.name)));
             return symbol(urlencode(0, name), _fs_);
            }
            var
             s = match[2],
             _ft_ = symbol(_cp_, urlencode(0, caml_string_of_jsstring(s)));
   ...
   function screen_transform(canvas){
    var
     _fk_ = opt_style(style.padding, 0.),
     offset = opt_style(style.border, 0.5) + _fk_,
     w = canvas.width,
     h = canvas.height,
     rx = w / 2.,
     ry = h / 2.,
      ...
      if(typeof img !== "number"){
       if(4204112 <= img[1]){
        ...
        var
         min_scale =
           function(l, w, h, s){
            var s$0 = [0, s], _fh_ = l.length - 1 - 1 | 0, _fg_ = 0;
            if(_fh_ >= 0){
             var i = _fg_;
             for(;;){
              var
               ...
               _fi_ = z[1],
               sx =
                 Math.abs(caml_check_bound(vertices, j)[1 + j][1] - _fi_) / w,
        ...
        if(caml_obj_tag(img$0) !== 246){
         var _e__ = caml_obj_tag(img$0);
         c:
         if(250 === _e__)
          var _e$_ = img$0[1];
         else{
          if(246 !== _e__ && 244 !== _e__){var _e$_ = img$0; break c;}
          var _e$_ = force_lazy_block(img$0);
         }
         var match$1 = poll(_e$_);
         if(match$1){
          var
           t205 = match$1[1],
           w$1 = t205.width,
          ...
          if(_fb_){
           ...
           var
            _fc_ = 2. <= w$2 ? 1 : 0,
            _fd_ = _fc_ ? 2. <= h$2 ? 1 : 0 : _fc_;
           if(_fd_) large_image_count[1]++;
          }
         }
        }
        else{
         ...
         if(1. < s$0 * max(rx$2, ry$2)){
          var _fe_ = caml_obj_tag(img$0);
          c:
          if(250 !== _fe_){
           if(246 !== _fe_ && 244 !== _fe_) break c;
   ...
   function randomize_tree(n){
    var ch = n[2], _e2_ = ch.length - 1 - 1 | 0;
    if(_e2_ >= 0){
     var i = _e2_;
     for(;;){
      var
       ...
       _eZ_
        ? (need_redraw
          ...
          global.requestAnimationFrame
           (caml_js_wrap_callback
             (function(param){
               var _e1_ = need_redraw[1];
               return _e1_ ? perform_redraw(0) : _e1_;
              })),
          0)
        : _eZ_;
    return _e0_;
   ...
   function compute_text_nodes(node_names, nodes){
    try{var _eU_ = assq(language[1], node_names)[1], names = _eU_;}
    catch(_eX_){
     var _eH_ = caml_wrap_exception(_eX_);
     if(_eH_ !== Not_found) throw caml_maybe_attach_backtrace(_eH_, 0);
     try{var _eT_ = assq(cst_en, node_names)[1], _eJ_ = _eT_;}
     catch(_eY_){
      var _eI_ = caml_wrap_exception(_eY_);
      if(_eI_ !== Not_found) throw caml_maybe_attach_backtrace(_eI_, 0);
      var _eJ_ = create$0(0, 11);
     }
     var names = _eJ_;
    }
    try{var _eS_ = find(names, _cB_), _eL_ = _eS_;}
    catch(_eW_){
     var _eK_ = caml_wrap_exception(_eW_);
     if(_eK_ !== Not_found) throw caml_maybe_attach_backtrace(_eK_, 0);
     var _eL_ = _cA_;
    }
    var t271 = caml_jsstring_of_string(_eL_);
    document.title = t271;
    var _eN_ = nodes.length - 1 - 1 | 0, _eM_ = 0;
    if(_eN_ >= 0){
     var i = _eM_;
     for(;;){
      var match = caml_check_bound(nodes, i)[1 + i], _eO_ = match[2];
      a:
      if(typeof _eO_ !== "number" && 4204112 === _eO_[1]){
       var
        match$0 = _eO_[2],
        info = match$0[3],
        is_root = match$0[1],
       ...
       try{
        var
         ...
         _eG_ = caml_obj_tag(text_size_div);
        b:
        if(250 === _eG_)
         var t116 = text_size_div[1];
        else{
         if(246 !== _eG_ && 244 !== _eG_){var t116 = text_size_div; break b;}
        ...
        var _eR_ = [0, canvas], canvas$0 = _eR_;
       }
       catch(_eV_){
        var _eQ_ = caml_wrap_exception(_eV_);
   ...
   function close_button(over){
    ...
    t282.stroke();
    t282.restore();
    var _eF_ = over ? _cG_ : _cH_, t304 = caml_jsstring_of_string(_eF_);
   ...
   function img_button(href, h, src){
    function decoration(over){
     ...
     t322.width = cst_38px;
     var
      t324 = caml_jsstring_of_string(symbol("" + max(38, h), _cI_)),
      t325 = t317.style;
     t325.height = t324;
     var t328 = t317.style;
     t328.margin = cst_2px;
     ...
     var
      ...
      t333 =
        caml_jsstring_of_string
         (symbol
           ("" + (extra / 2 | 0),
            symbol(_cK_, symbol("" + (extra - (extra / 2 | 0) | 0), _cJ_)))),
      t334 = t317.style;
     t334.padding = t333;
     var
      _eE_ = over ? _cL_ : _cN_,
      t335 = caml_jsstring_of_string(symbol(_cM_, _eE_));
     t317.className = t335;
    ...
    t341.width = cst_48px;
    var
     t343 = caml_jsstring_of_string(symbol("" + (8 + max(38, h) | 0), _cO_)),
     t344 = button.style;
    t344.height = t343;
    if(href){
            ...
            (image_info,
             function(image_info){
              ...
              if(0 <= i[1]){
               var
                _ew_ = i[1],
                info = caml_check_bound(image_info, _ew_)[1 + _ew_];
               ...
               var
                wrap =
                  function(elt){
                   ...
                   var
                    t417 = caml_jsstring_of_string(symbol("" + info[5], _cP_)),
                    t418 = t398.style;
                   t418.maxHeight = t417;
                ...
                _ex_ = caml_obj_tag(small_image);
               a:
               if(250 === _ex_)
                var _ey_ = small_image[1];
               else{
                if(246 !== _ex_ && 244 !== _ex_){
                 var _ey_ = small_image;
                 break a;
                }
                var _ey_ = force_lazy_block(small_image);
               }
               var match = poll(_ey_);
               if(match){
                var
               ...
               if(match$0)
                ...
                var
                 t450 =
                   caml_jsstring_of_string(symbol(_cY_, symbol(name, _cX_)));
               t449.src = t450;
               var t452 = info[4];
               t449.width = t452;
               var t454 = info[5];
               ...
               var
                suffix =
                  language[1] === cst_en
                   ? _cQ_
                   : symbol(_cW_, caml_string_of_jsstring(language[1])),
                url$0 =
                  symbol
                   (_cR_, symbol(caml_string_of_jsstring(info[2]), suffix)),
                commons =
                  img_button([0, caml_jsstring_of_string(url$0)], 52, _cS_),
                t550 =
                  tooltip
                   (opt_style
               ...
               var
                wikipedia = img_button(0, 34, _cT_),
                    ...
                    (function(param){
                      ...
                      var
                       ...
                       url =
                         symbol
                          (_cV_,
                           symbol(caml_string_of_jsstring(lang), symbol(_cU_, _eD_))),
                ...
                _ez_ = language[1];
               list(opt_style(messages.language, cst_In_English), _ez_);
       ...
       (getfile(tree_url),
        function(s){
          ...
          iter$0
           (function(param){
             ...
             var
              ...
              nsize$0 = osize * 2 | 0,
              _es_ = nsize$0 < max_array_length ? 1 : 0;
             if(! _es_) return _es_;
             var
              ndata = caml_make_vect(nsize$0, 0),
              _ej_ = h.length - 1 < 4 ? 1 : 0,
              _ek_ = _ej_ || (h[4] < 0 ? 1 : 0),
              inplace = 1 - _ek_;
             h[2] = ndata;
             var
         ...
         var
          node_names$0 =
            symbol$0
             (symbol$0(node_names, function(_ei_){return map(_dS_, _ei_);}),
              to_list);
         ...
         (current, current_weights, is_root, transf, lineWidth, dir){
          ...
          vi[1]++;
          var _ef_ = transf[1];
          caml_check_bound(vertices, i$0)[1 + i$0] = _ef_;
          var l$0 = ch.length - 1;
          if(0 === l$0)
           var ch$0 = [0];
          else{
           ...
           if(0 === l)
            ...
            var
             _d$_ = caml_check_bound(ch_weights, 0)[1],
             r = caml_make_vect(l, f(caml_check_bound(ch, 0)[1], _d$_)),
             _eb_ = l - 1 | 0,
             _ea_ = 1;
            if(_eb_ >= 1){
             var i = _ea_;
             for(;;){
              var
               _ec_ = caml_check_bound(ch_weights, i)[1 + i],
               _ed_ = f(caml_check_bound(ch, i)[1 + i], _ec_);
              caml_check_bound(r, i)[1 + i] = _ed_;
              var _ee_ = i + 1 | 0;
              if(_eb_ === i) break;
              var i = _ee_;
             }
         ...
         function compute_frontiers(node){
          ...
          if(0 === l.length - 1)
           var _d5_ = [0, status(i)], _d6_ = [0, [0, status(i)], _d5_];
          else
           var
            _d7_ = l.length - 1 - 1 | 0,
            _d8_ = caml_check_bound(l, _d7_)[1 + _d7_][1],
            _d9_ = caml_check_bound(frontiers, _d8_)[1 + _d8_][2],
            _d__ = caml_check_bound(l, 0)[1][1],
            _d6_ = [0, caml_check_bound(frontiers, _d__)[1 + _d__][1], _d9_];
          caml_check_bound(frontiers, i)[1 + i] = _d6_;
          return 0;
         }
         ...
         function compute_neigh(node, parent, lft, rght){
          ...
          caml_check_bound(neighboors, i)[1 + i] = _dT_;
          var
          ...
          if(_dV_ >= 0){
           ...
           for(;;){
            if(0 < j)
             var
              _dW_ = j - 1 | 0,
              _dX_ = caml_check_bound(ch, _dW_)[1 + _dW_][1],
              lft$0 = caml_check_bound(frontiers, _dX_)[1 + _dX_][2];
            else if(is_root)
             var
              _d3_ = n - 1 | 0,
              _d4_ = caml_check_bound(ch, _d3_)[1 + _d3_][1],
              lft$0 = caml_check_bound(frontiers, _d4_)[1 + _d4_][2];
            else
             var lft$0 = lft;
            if(j < (n - 1 | 0))
             var
              _dY_ = j + 1 | 0,
              _dZ_ = caml_check_bound(ch, _dY_)[1 + _dY_][1],
              rght$0 = caml_check_bound(frontiers, _dZ_)[1 + _dZ_][1];
            else if(is_root)
             var
              _d2_ = caml_check_bound(ch, 0)[1][1],
              rght$0 = caml_check_bound(frontiers, _d2_)[1 + _d2_][1];
            else
             var rght$0 = rght;
            var _d0_ = [0, status(i)];
            compute_neigh(caml_check_bound(ch, j)[1 + j], _d0_, lft$0, rght$0);
            var _d1_ = j + 1 | 0;
            if(_dV_ === j) break;
            var j = _d1_;
           }
         ...
         var _dQ_ = nodes.length - 1 - 1 | 0, _dP_ = 0;
         if(_dQ_ >= 0){
          var i = _dP_;
          for(;;){
           var info = caml_check_bound(nodes, i)[1 + i][2];
   ...
   function start(param){
    try{
                   ...
                   (all_messages,
                    function(all_messages){
                     ...
                     redraw_funct[1] =
                      function(param){
                       ...
                       var
                        ...
                        _dN_ = t687 !== element.width ? 1 : 0,
                        _dO_ = _dN_ || (t689 !== element.height ? 1 : 0);
                       if(_dO_){element.width = t687; element.height = t689;}
                       var
                        param$0 = tr$0[1],
                        t = param$0[2],
                        p = param$0[1],
                        c = mul(conj(p), t),
                        _dK_ = vertices.length - 1 - 1 | 0,
                        _dJ_ = 0;
                       if(_dK_ >= 0){
                        var i = _dJ_;
                        for(;;){
                         ...
                         caml_check_bound(vertices$0, i)[1 + i] = _dL_;
                         var _dM_ = i + 1 | 0;
                         if(_dK_ === i) break;
                         var i = _dM_;
                        }
                        ...
                        handler
                         (function(param){
                           var
                            ...
                            w = page.clientWidth,
                            h = page.clientHeight,
                            _dH_ = w !== element.width ? 1 : 0,
                            _dI_ = _dH_ || (h !== element.height ? 1 : 0);
                           if(_dI_) schedule_redraw(0);
                           return true$0;
                          });
                     ...
                     function find_box(boxes, x, y){
                      var
                       p = [0, -1],
                       _dC_ = boxes[3].length - 1 - 1 | 0,
                       _dB_ = 0;
                      if(_dC_ >= 0){
                       var i = _dB_;
                       for(;;){
                        var _dD_ = 0. < boxes[3][1 + i] ? 1 : 0;
                        if(_dD_)
                         var
                          _dE_ =
                              ...
                              handler
                               (function(t34){
                                 ...
                                 if(started[1]){
                                  ...
                                  a:
                                  if(0 < i){
                                   var _dx_ = caml_check_bound(nodes, i)[1 + i][2];
                                     ...
                                     iter$2
                                      (t56.changedTouches.item(i),
                                       function(touch){
                                        ...
                                        var i = find_box(boxes, x, y), _dl_ = 0 < i ? 1 : 0;
                                        if(_dl_){
                                         var _dm_ = caml_check_bound(nodes, i)[1 + i][2];
                                         if(typeof _dm_ !== "number" && 3654627 === _dm_[1]){
                     ...
                     function make_buttons(param){
                      ...
                      var
                       t735 =
                         handler
                          (function(param){
                            try{var _da_ = assq(language[1], tree_i18n)[2], info = _da_;
                            }
                            catch(_db_){
                             var _c8_ = caml_wrap_exception(_db_);
                             if(_c8_ !== Not_found)
                              throw caml_maybe_attach_backtrace(_c8_, 0);
                             try{var _c$_ = assq(cst_en, tree_i18n)[2], _c__ = _c$_;}
                             catch(_dc_){
                              var _c9_ = caml_wrap_exception(_dc_);
                              if(_c9_ !== Not_found)
                               throw caml_maybe_attach_backtrace(_c9_, 0);
                              var _c__ = information_en;
                             }
                             var info = _c__;
                            }
                      ...
                      var lang = img_button(0, 38, _c0_), t746 = lang.style;
                     ...
                     make_buttons(0);
                     var t802 = createImg(document), t801 = icon(_c2_);
                     t802.src = t801;
     ...
     var _c6_ = caml_wrap_exception(_c7_);
     if(_c6_ !== Canvas_not_available)
      throw caml_maybe_attach_backtrace(_c6_, 0);
