...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.7.1+d2cf189
(function
  (Object){
...
(function(globalThis){
   ...
   function fold_left(f, x, a){
    var r = [0, x], _gV_ = a.length - 2 | 0, _gU_ = 0;
    if(_gV_ >= 0){
     var i = _gU_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _gT_){return 0;});
   ...
   function string_of_formatting_lit(formatting_lit){
    ...
    switch(formatting_lit[0]){
      ...
      default: var c = formatting_lit[1]; return "@" + make$0(1, c);
    }
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _gS_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _gS_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _gQ_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _gQ_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gR_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gR_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gR_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _gF_ = caml_ml_bytes_length(b) - 1 | 0,
     _gE_ = 0;
    if(_gF_ >= 0){
     var i$0 = _gE_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _gH_ = caml_ml_bytes_length(b) - 1 | 0, _gG_ = 0;
     if(_gH_ >= 0){
      var i = _gG_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _gz_ = caml_ml_string_length(s) - 1 | 0, _gy_ = 0;
    if(_gz_ >= 0){
     var i$0 = _gy_;
     for(;;){
    ...
    var
     ...
     _gB_ = caml_ml_string_length(s) - 1 | 0,
     _gA_ = 0;
    if(_gB_ >= 0){
     var i = _gA_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _gx_ = _ai_; break;
      default: var _gx_ = _ar_;
    }
    return transform_int_alt(iconv, caml_format_int(_gx_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _gu_ = _av_; break;
      default: var _gu_ = _aE_;
    }
    return transform_int_alt(iconv, caml_int64_format(_gu_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _gr_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _gr_ >>> 0){
           if(55 === _gr_) break a;
          }
          else if(21 < _gr_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _gt_ = _gs_ ? str : str + cst$2;
        return caml_special_val(_gt_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _gn_ = l - 1 | 0, _gm_ = 0;
        if(_gn_ >= 0){
         var i = _gm_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _go_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _go_);
          var _gp_ = i + 1 | 0;
          if(_gn_ === i) break;
          i = _gp_;
         }
       ...
       return caml_string_of_bytes(_gq_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _gl_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _gl_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _gl_[1];
       ...
       case 18:
        var _gj_ = fmt$0[1];
        if(0 === _gj_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _gj_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _gj_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _gk_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _gk_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _gh_ = [8, acc, _bb_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _gh_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _gh_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _gg_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _gg_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _gg_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bk_), _gf_, _ge_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_gd_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _f$_ = other_fields(e, 2),
       _ga_ = field(e, 1),
       _gc_ = caml_call2(sprintf(_bl_), _ga_, _f$_);
     else
      switch(match){
        case 0:
         var _gc_ = _bm_; break;
        case 1:
         var _gc_ = _bn_; break;
        default:
         var _gb_ = field(e, 1), _gc_ = caml_call1(sprintf(_bo_), _gb_);
      }
     var match$0 = [0, constructor, [0, _gc_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _f1_ = slot[4],
        _f2_ = slot[3],
        _f3_ = slot[6] ? _by_ : _bA_,
        _f4_ = slot[2],
        _f5_ = slot[7],
        _f6_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _f6_, _f5_, _f4_, _f3_, _f2_, _f1_, _f0_)];
      else if(slot[1])
       var match = 0;
      else
       var _f7_ = info(0), match = [0, caml_call1(sprintf(_bB_), _f7_)];
   ...
   var
    ...
    _bE_ = "Fatal error: out of memory in uncaught exception handler",
    _bF_ =
      [0,
       [11, cst_Fatal_error_exception, [2, 0, [12, 10, 0]]],
       cst_Fatal_error_exception_s],
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _fO_ = to_string(exn$0);
       caml_call1(eprintf(_bD_), _fO_);
       ...
       var _fQ_ = caml_ml_flush(stderr), _fU_ = _fQ_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _fS_ = to_string(exn$0);
       caml_call1(eprintf(_bF_), _fS_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fT_ = to_string(exn);
       caml_call1(eprintf(_bG_), _fT_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _fU_ = caml_ml_flush(stderr);
      }
      var _fV_ = _fU_;
     }
     catch(_fX_){
      var _fR_ = caml_wrap_exception(_fX_);
      if(_fR_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_fR_, 0);
      var _fV_ = prerr_endline(_bE_);
     }
     return _fV_;
    }
    catch(_fW_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    ...
    var i3$0 = caml_notequal(i3, _bI_) ? i3 : _bL_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bJ_) ? i4 : _bK_;
   ...
   var
    ...
    _m_ = cst,
    _l_ = "String.concat",
    _bU_ = "Hashtbl: unsupported hash table format",
    _bS_ = cst,
    _bV_ = "Jsoo_runtime.Error.Exn",
    _b5_ = "canvas",
    _b3_ = "dt",
    _b2_ = "dd",
    _b1_ = "img",
    ...
    _bX_ = "dl",
    _bW_ = "ul",
    _b4_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b6_ = "[\\][()\\\\|+*.?{}^$]",
    _b7_ = "Js_of_ocaml__Url.Local_exn",
    _cj_ = [0, 0],
    _ck_ = [0, 1],
    _ch_ = [0, 0],
    _ci_ = [0, 1],
    ...
    _ce_ = "wakeup_exn",
    _cd_ = "wakeup",
    _ca_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cb_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cc_ = [0, 0],
    _b__ = cst_Fatal_error_exception,
    _b$_ = "Lwt.Resolution_loop.Canceled",
    _cp_ = cst_POST,
    _cn_ = cst_POST,
    _co_ = cst_POST,
    _cm_ = cst,
    _cl_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cq_ = "Exception during Lwt.async: ",
    _cF_ = cst_info_38_png,
    _cG_ = cst_globe_38_png,
    _cH_ = cst_meeting_point_38_png,
    _cI_ = cst_ocsigen_powered_png,
    _cC_ = cst,
    _cD_ = cst_commons_38_png,
    _cE_ = cst_wikipedia_38_png,
    _cA_ = cst_on,
    _cB_ = cst_off,
    _cy_ = cst_on,
    _cz_ = cst_off,
    _cx_ = "image_info.json",
    _cv_ = [0, 0, 0, 0.],
    _cw_ = [254, -1., 0.],
    _cu_ = [0, "examples/hyperbolic/hypertree.ml", 972, 2],
    _ct_ = "<TITLE>",
    _cs_ = cst,
    _cr_ = "messages.json";
   try{var _cK_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _cK_;}
   catch(_fG_){
    var _bQ_ = caml_wrap_exception(_fG_);
    if(_bQ_ !== Not_found) throw caml_maybe_attach_backtrace(_bQ_, 0);
    try{var _cJ_ = caml_sys_getenv("CAMLRUNPARAM"), _bT_ = _cJ_;}
    catch(_fH_){
     var _bR_ = caml_wrap_exception(_fH_);
   ...
   var
    Error = [248, _bV_, caml_fresh_oo_id(0)],
    exn = [0, Error, [0]],
   ...
   function iter$2(x, f){
    var _fC_ = 1 - (x === undefined$0 ? 1 : 0);
    return _fC_ ? caml_call1(f, x) : _fC_;
   }
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    function callback(e){
     var _fz_ = [0, h, e, [0]];
     return function(_fA_, _fB_){return caml_js_call(_fz_, _fA_, _fB_);};
    }
   ...
   function createUl(doc){return unsafeCreateElement(doc, _bW_);}
   function createDl(doc){return unsafeCreateElement(doc, _bX_);}
   function createLi(doc){return unsafeCreateElement(doc, _bY_);}
   function createDiv(doc){return unsafeCreateElement(doc, _bZ_);}
   function createA(doc){return unsafeCreateElement(doc, _b0_);}
   function createImg(doc){return unsafeCreateElement(doc, _b1_);}
   function createDd(doc){return createElement(doc, _b2_);}
   function createDt(doc){return createElement(doc, _b3_);}
   var Canvas_not_available = [248, _b4_, caml_fresh_oo_id(0)];
   function createCanvas(doc){
    var t52 = unsafeCreateElement(doc, _b5_);
   ...
   var
    ...
    quote_re = regexp(_b6_),
    Local_exn = [248, _b7_, caml_fresh_oo_id(0)];
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _fy_){return 0;},
     t41 = function(param, _fx_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b9_ = caml_wrap_exception(_fw_);
    if(_b9_[1] !== Failure) throw caml_maybe_attach_backtrace(_b9_, 0);
   }
   var
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l >= i){
       var _fu_ = index_rec(path_string, l, i, c);
       break a;
      }
      var _fu_ = invalid_arg(_n_);
     }
     var j = _fu_;
    }
    catch(_fv_){
     var _ft_ = caml_wrap_exception(_fv_);
     if(_ft_ !== Not_found) throw caml_maybe_attach_backtrace(_ft_, 0);
     var j = l$0;
    }
   ...
   if(a && a[1] === cst){
    var _b8_ = a[2];
    if(! _b8_ || _b8_[1] === cst && ! _b8_[2]) break a;
   }
   var
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
           ...
           function(s){
            ...
            function _fr_(param){
             var
              y = param[2],
              x = param[1],
              _fs_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _fs_];
            }
            if(0 <= index)
             var
              _fp_ = s.slice(index + 1 | 0),
              _fq_ = [0, s.slice(0, index), _fp_];
            else
             var _fq_ = undefined$0;
            return case$1(_fq_, interrupt, _fr_);
           }),
         acc],
        idx$0 - 1 | 0);
      return;
      ...
      var _fn_ = caml_wrap_exception(_fo_);
      if(_fn_ !== Local_exn) throw caml_maybe_attach_backtrace(_fn_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _fm_ = caml_call1(f, v); return _fm_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _b$_, caml_fresh_oo_id(0)];
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _fl_ = result[1] === Canceled ? 1 : 0, is_canceled = _fl_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _fk_ = deferred_callbacks[2];
      if(! _fk_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _fk_[1];
      if(_fk_[2]){
       var next = _fk_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _fj_ = p[1];
    switch(_fj_[0]){
      case 1:
       return _fj_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _cb_), api_function_name);
      case 2:
       if(0 === result[0])
        var x = result[1], result$0 = [0, x];
       else
        var exn = result[1], result$0 = [1, exn];
       resolve(_cc_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _ca_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_cd_, r, [0, v]);}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_ch_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _fi_ = caml_call1(f, v), user_provided_promise = _fi_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_cg_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_cf_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
   ...
   var Wrong_headers = [248, _cl_, caml_fresh_oo_id(0)];
   function yield$0(param){
    var match = task(0), w = match[2], t = match[1];
    function callback(_fh_){return wakeup(w, _fh_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_fg_){return loop(remain, _fg_);};
   ...
   function transf(a, b, c, d, z){
    var _ff_ = add_mul(c, z, d);
    return div(add_mul(a, z, b), _ff_);
   }
   function transl(p){
    var c = mul(conj(p), one);
    return function(z){return transf(one, p, c, one, z);};
   }
   function compose(param, _fd_){
    var
     t2 = _fd_[2],
     p2 = _fd_[1],
     t1 = param[2],
     ...
     _fe_ = div(conj(den), den),
     c = mul(mul(t1, t2), _fe_),
     _fc_ = sdiv(c, norm(c));
    return [0, div(add$0(t2p1, p2), den), _fc_];
   }
   function compute_translation(z0, z1){
    var dz = sub$1(z1, z0), z0z1 = mul(z0, z1), _fb_ = 1. - sq_norm(z0z1);
    return sdiv(add$0(mul(z0z1, conj(dz)), dz), _fb_);
   }
   var json = JSON;
   function getfile(url){
    try{var _e7_ = return$0(caml_read_file_content(url)); return _e7_;}
    catch(_e8_){
     var _e6_ = caml_wrap_exception(_e8_);
     if(_e6_ !== Not_found) throw caml_maybe_attach_backtrace(_e6_, 0);
     var
      content_type$2 = 0,
      check_headers = function(param, _fa_){return 1;},
      contents = 0,
      _e5_ =
        function(r){
         var cod = r[2], msg = r[4];
     ...
     if(contents){
      ...
      if(-836918635 === match$1[1]){
       ...
       if(891486873 <= form[1])
        ...
        var content_type$0 = content_type$2, method$0 = _co_;
      }
      else
       var content_type$0 = content_type$2, method$0 = _cp_;
     }
     else
     ...
     if(contents){
      var match$3 = contents[1], _e4_ = match$3[1];
      if(-836918635 === _e4_){
       ...
       if(891486873 <= match$4[1]){
         ...
         f =
           function(param){
            ...
            if(781515420 <= match[1]){
             var
              t0 = match[2],
              _e9_ = cst$4 + urlencode(0, caml_string_of_jsstring(t0.name));
             return urlencode(0, name) + _e9_;
            }
            var
             s = match[2],
             _e__ = cst$4 + urlencode(0, caml_string_of_jsstring(s));
            return urlencode(0, name) + _e__;
           };
        if(l$3){
        ...
        if(l$1){
         ...
         var dst$1 = caml_create_bytes(_e2_);
         a:
         {
          b:
          {
         ...
         var _e3_ = caml_string_of_bytes(dst$1);
        }
        else
         var _e3_ = _m_;
        req.send(caml_jsstring_of_string(_e3_));
       }
       else{var f$0 = match$4[2]; req.send(f$0);}
      }
      else if(737307005 <= _e4_){
       var b = match$3[2];
       req.send(b);
      }
   ...
   function screen_transform(canvas){
    var
     _e1_ = opt_style(style.padding, 0.),
     offset = opt_style(style.border, 0.5) + _e1_,
     w = canvas.width,
     h = canvas.height,
     rx = w / 2.,
     ry = h / 2.,
      ...
      if(typeof img !== "number"){
       if(4204112 <= img[1]){
        ...
        var
         min_scale =
           function(l, w, h, s){
            var s$0 = [0, s], _eY_ = l.length - 2 | 0, _eX_ = 0;
            if(_eY_ >= 0){
             var i = _eX_;
             for(;;){
              var
               ...
               _eZ_ = z[1],
               sx =
                 Math.abs(caml_check_bound(vertices, j)[1 + j][1] - _eZ_) / w,
        ...
        if(caml_obj_tag(img$0) !== 246){
         ...
         if(250 === _eP_)
          ...
          if(246 !== _eP_ && 244 !== _eP_){var _eQ_ = img$0; break c;}
          var _eQ_ = force_lazy_block(img$0);
         }
         var match$1 = poll(_eQ_);
         if(match$1){
          var
           t205 = match$1[1],
           w$1 = t205.width,
          ...
          if(_eS_){
           ...
           var
            _eT_ = 2. <= w$2 ? 1 : 0,
            _eU_ = _eT_ ? 2. <= h$2 ? 1 : 0 : _eT_;
           if(_eU_) large_image_count[1]++;
          }
         }
        }
        else{
         ...
         if(1. < s$0 * max(rx$2, ry$2)){
          var _eV_ = caml_obj_tag(img$0);
          c:
          if(250 !== _eV_){
           if(246 !== _eV_ && 244 !== _eV_) break c;
       ...
       _eE_
        ? (need_redraw
          ...
          global.requestAnimationFrame
           (caml_js_wrap_callback
             (function(param){
               var _eG_ = need_redraw[1];
               return _eG_ ? perform_redraw(0) : _eG_;
              })),
          0)
        : _eE_;
    return _eF_;
   ...
   function compute_text_nodes(node_names, nodes){
    try{var _ez_ = assq(language[1], node_names)[1], names = _ez_;}
    catch(_eC_){
     var _em_ = caml_wrap_exception(_eC_);
     if(_em_ !== Not_found) throw caml_maybe_attach_backtrace(_em_, 0);
     try{var _ey_ = assq(cst_en, node_names)[1], _eo_ = _ey_;}
     catch(_eD_){
      var _en_ = caml_wrap_exception(_eD_);
      if(_en_ !== Not_found) throw caml_maybe_attach_backtrace(_en_, 0);
      var _eo_ = create$0(0, 11);
     }
     var names = _eo_;
    }
    try{var _ex_ = find(names, _ct_), _eq_ = _ex_;}
    catch(_eB_){
     var _ep_ = caml_wrap_exception(_eB_);
     if(_ep_ !== Not_found) throw caml_maybe_attach_backtrace(_ep_, 0);
     var _eq_ = _cs_;
    }
    var t271 = caml_jsstring_of_string(_eq_);
    document.title = t271;
    var _es_ = nodes.length - 2 | 0, _er_ = 0;
    if(_es_ >= 0){
     var i = _er_;
     for(;;){
      var match = caml_check_bound(nodes, i)[1 + i], _et_ = match[2];
      a:
      if(typeof _et_ !== "number" && 4204112 === _et_[1]){
       var
        match$0 = _et_[2],
        info = match$0[3],
        is_root = match$0[1],
       ...
       try{
        var
         ...
         _el_ = caml_obj_tag(text_size_div);
        b:
        if(250 === _el_)
         var t116 = text_size_div[1];
        else{
         if(246 !== _el_ && 244 !== _el_){var t116 = text_size_div; break b;}
        ...
        var _ew_ = [0, canvas], canvas$0 = _ew_;
       }
       catch(_eA_){
        var _ev_ = caml_wrap_exception(_eA_);
        if(_ev_ !== Not_found) throw caml_maybe_attach_backtrace(_ev_, 0);
        var canvas$0 = 0;
       }
   ...
   function close_button(over){
    ...
    t282.stroke();
    t282.restore();
    var _ek_ = over ? _cy_ : _cz_, t304 = caml_jsstring_of_string(_ek_);
   ...
   function img_button(href, h, src){
    function decoration(over){
     ...
     t322.width = cst_38px;
     var
      t324 = caml_jsstring_of_string("" + max(38, h) + cst_px),
      t325 = t317.style;
     t325.height = t324;
     var t328 = t317.style;
     t328.margin = cst_2px;
     ...
     var
      _ej_ = over ? _cA_ : _cB_,
      t335 = caml_jsstring_of_string("filled_button " + _ej_);
     t317.className = t335;
    ...
    t341.width = cst_48px;
    var
     t343 = caml_jsstring_of_string("" + (8 + max(38, h) | 0) + cst_px),
     t344 = button.style;
    t344.height = t343;
    if(href){
            ...
            (image_info,
             function(image_info){
              ...
              if(0 <= i[1]){
               ...
               var
                wrap =
                  function(elt){
                   ...
                   var
                    t417 = caml_jsstring_of_string("" + info[5] + cst_px),
                    t418 = t398.style;
                   t418.maxHeight = t417;
               ...
               a:
               if(250 === _ec_)
                var _ed_ = small_image[1];
               else{
                if(246 !== _ec_ && 244 !== _ec_){
                 var _ed_ = small_image;
                 break a;
                }
                var _ed_ = force_lazy_block(small_image);
               }
               var match = poll(_ed_);
               if(match){
                var
               ...
               if(match$0)
                ...
                var
                 t450 = caml_jsstring_of_string("images/" + name + cst_jpg);
               t449.src = t450;
               var t452 = info[4];
               t449.width = t452;
               var t454 = info[5];
               ...
               var
                suffix =
                  language[1] === cst_en
                   ? _cC_
                   : "?uselang=" + caml_string_of_jsstring(language[1]),
                url$0 =
                  "http://commons.wikimedia.org/wiki/File:"
                  + caml_string_of_jsstring(info[2])
                  + suffix,
                commons =
                  img_button([0, caml_jsstring_of_string(url$0)], 52, _cD_),
                t550 =
                  tooltip
                   (opt_style
               ...
               var
                wikipedia = img_button(0, 34, _cE_),
                t569 = createDiv(document),
                count = [0, 0],
                dl = createDl(document),
                list =
                  function(title, lang){
                   var ul = createUl(document), empty = [0, 1];
                   iter$0
                    (function(param){
                      var
                       refer = param[3],
                      ...
                      var
                       ...
                       _ei_ =
                         0 === caml_ml_string_length(refer$0)
                          ...
                          : refer$0,
                       url =
                         "http://" + caml_string_of_jsstring(lang)
                         + ".wikipedia.org/wiki/"
                         + _ei_,
                ...
                _ee_ = language[1];
               list(opt_style(messages.language, cst_In_English), _ee_);
       ...
       (getfile(tree_url),
        function(s){
         ...
         function _dx_(param){
          ...
          iter$0
           (function(param){
             ...
             h[1] = h[1] + 1 | 0;
             var _d__ = h[2].length - 1 << 1 < h[1] ? 1 : 0;
             if(! _d__) return _d__;
             var
              odata = h[2],
              osize = odata.length - 1,
              nsize$0 = osize * 2 | 0,
              _d9_ = nsize$0 < max_array_length ? 1 : 0;
             if(! _d9_) return _d9_;
             var
              ndata = caml_make_vect(nsize$0, 0),
              _d0_ = h.length - 1 < 4 ? 1 : 0,
              _d1_ = _d0_ || (h[4] < 0 ? 1 : 0),
              inplace = 1 - _d1_;
             h[2] = ndata;
             var
         ...
         var
          node_names$0 =
            symbol
             (symbol(node_names, function(_dZ_){return map(_dx_, _dZ_);}),
              to_list);
                  ...
                  return symbol_bind
                          (yield$0(0),
                           function(param){
                            return symbol_bind
                                    (load_image
                                      (caml_jsstring_of_string("thumbnails/" + img + cst_jpg)),
         ...
         var
          ...
          edges = caml_make_vect(tree_edge_count(root), _cv_),
         ...
         var
          tree = layout_rec(root, weights, 1, [0, zero, one], 6., _cw_),
         ...
         function compute_frontiers(node){
          ...
          if(0 === l.length - 1)
           var _dK_ = [0, status(i)], _dL_ = [0, [0, status(i)], _dK_];
          else
           var
            _dM_ = l.length - 2 | 0,
            _dN_ = caml_check_bound(l, _dM_)[1 + _dM_][1],
            _dO_ = caml_check_bound(frontiers, _dN_)[1 + _dN_][2],
            _dP_ = caml_check_bound(l, 0)[1][1],
            _dL_ = [0, caml_check_bound(frontiers, _dP_)[1 + _dP_][1], _dO_];
          caml_check_bound(frontiers, i)[1 + i] = _dL_;
          return 0;
         }
         ...
         function compute_neigh(node, parent, lft, rght){
          ...
          caml_check_bound(neighboors, i)[1 + i] = _dy_;
          var
          ...
          if(_dA_ >= 0){
           ...
           for(;;){
            if(0 < j)
             var
              _dB_ = j - 1 | 0,
              _dC_ = caml_check_bound(ch, _dB_)[1 + _dB_][1],
              lft$0 = caml_check_bound(frontiers, _dC_)[1 + _dC_][2];
            else if(is_root)
             var
              _dI_ = n - 1 | 0,
              _dJ_ = caml_check_bound(ch, _dI_)[1 + _dI_][1],
              lft$0 = caml_check_bound(frontiers, _dJ_)[1 + _dJ_][2];
            else
             var lft$0 = lft;
            if(j < (n - 1 | 0))
             var
              _dD_ = j + 1 | 0,
              _dE_ = caml_check_bound(ch, _dD_)[1 + _dD_][1],
              rght$0 = caml_check_bound(frontiers, _dE_)[1 + _dE_][1];
            else if(is_root)
             var
              _dH_ = caml_check_bound(ch, 0)[1][1],
              rght$0 = caml_check_bound(frontiers, _dH_)[1 + _dH_][1];
            else
             var rght$0 = rght;
            var _dF_ = [0, status(i)];
            compute_neigh(caml_check_bound(ch, j)[1 + j], _dF_, lft$0, rght$0);
            var _dG_ = j + 1 | 0;
            if(_dA_ === j) break;
            j = _dG_;
           }
         ...
         var _dv_ = nodes.length - 2 | 0, _du_ = 0;
         if(_dv_ >= 0){
          var i = _du_;
          for(;;){
           var info = caml_check_bound(nodes, i)[1 + i][2];
   ...
   function start(param){
    try{
           ...
           return symbol_bind
                   (all_messages,
                    function(all_messages){
                     ...
                     redraw_funct[1] =
                      function(param){
                       ...
                       var
                        ...
                        _ds_ = t687 !== element.width ? 1 : 0,
                        _dt_ = _ds_ || (t689 !== element.height ? 1 : 0);
                       if(_dt_){element.width = t687; element.height = t689;}
                       var
                        param$0 = tr$0[1],
                        t = param$0[2],
                        p = param$0[1],
                        c = mul(conj(p), t),
                        _dp_ = vertices.length - 2 | 0,
                        _do_ = 0;
                       if(_dp_ >= 0){
                        var i = _do_;
                        for(;;){
                         ...
                         caml_check_bound(vertices$0, i)[1 + i] = _dq_;
                         var _dr_ = i + 1 | 0;
                         if(_dp_ === i) break;
                         i = _dr_;
                        }
                        ...
                        handler
                         (function(param){
                           var
                            ...
                            w = page.clientWidth,
                            h = page.clientHeight,
                            _dm_ = w !== element.width ? 1 : 0,
                            _dn_ = _dm_ || (h !== element.height ? 1 : 0);
                           if(_dn_) schedule_redraw(0);
                           return true$0;
                          });
                     global.onresize = t698;
                     function find_box(boxes, x, y){
                      var p = [0, -1], _dh_ = boxes[3].length - 2 | 0, _dg_ = 0;
                      if(_dh_ >= 0){
                       var i = _dg_;
                       for(;;){
                        var _di_ = 0. < boxes[3][1 + i] ? 1 : 0;
                        if(_di_)
                         var
                          _dj_ =
                               ...
                               (document,
                                ...
                                handler
                                 (function(t25){
                                   ...
                                   if(_dd_)
                                    var
                                     _de_ = 4 < abs(x1 - x0 | 0) ? 1 : 0,
                                     _df_ = _de_ || (4 < abs(y1 - y0 | 0) ? 1 : 0);
                                   else
                                    var _df_ = _dd_;
                                   if(_df_){
                                    started[1] = 1;
                                      ...
                                      for(;;){
                                       iter$2
                                        (t45.changedTouches.item(i),
                                         function(touch){
                                          var _c8_ = touch.identifier === id ? 1 : 0;
                                          if(_c8_){
                                           var
                                            x1 = touch.clientX,
                                            y1 = touch.clientY,
                                           ...
                                           if(_c9_)
                                            var
                                             _c__ = 4 < abs(x1 - x0 | 0) ? 1 : 0,
                                             _c$_ = _c__ || (4 < abs(y1 - y0 | 0) ? 1 : 0);
                                           else
                                            var _c$_ = _c9_;
                                           if(_c$_){
                                            started[1] = 1;
                                    ...
                                    for(;;){
                                     iter$2
                                      (t56.changedTouches.item(i),
                                       function(touch){
                                        var _c1_ = touch.identifier === id ? 1 : 0;
                                        if(! _c1_) return _c1_;
                                        ...
                                        var i = find_box(boxes, x, y), _c2_ = 0 < i ? 1 : 0;
                                        if(_c2_){
                                         var _c3_ = caml_check_bound(nodes, i)[1 + i][2];
                                         if(typeof _c3_ !== "number" && 3654627 === _c3_[1]){
                                          var match = _c3_[2], name = match[2], img = match[1];
                                          show_image(all_messages, image_info, name, img);
                                          return 0;
                                         }
                                         var _c4_ = 0;
                                    ...
                                    for(;;){
                                     iter$2
                                      (t67.changedTouches.item(i),
                                       function(touch){
                                        var _cX_ = touch.identifier === id ? 1 : 0;
                                        if(! _cX_) return _cX_;
                                        touch.clientX;
                                        touch.clientY;
                                        removeEventListener(c1);
                     ...
                     function make_buttons(param){
                      ...
                      var
                       t735 =
                         handler
                          (function(param){
                            try{var _cR_ = assq(language[1], tree_i18n)[2], info = _cR_;
                            }
                            catch(_cS_){
                             var _cN_ = caml_wrap_exception(_cS_);
                             if(_cN_ !== Not_found)
                              throw caml_maybe_attach_backtrace(_cN_, 0);
                             try{var _cQ_ = assq(cst_en, tree_i18n)[2], _cP_ = _cQ_;}
                             catch(_cT_){
                              var _cO_ = caml_wrap_exception(_cT_);
                              if(_cO_ !== Not_found)
                               throw caml_maybe_attach_backtrace(_cO_, 0);
                              var _cP_ = information_en;
                             }
                             var info = _cP_;
                            }
                      ...
                      var lang = img_button(0, 38, _cG_), t746 = lang.style;
                     ...
                     make_buttons(0);
                     var t802 = createImg(document), t801 = icon(_cI_);
                     t802.src = t801;
     ...
     var _cL_ = caml_wrap_exception(_cM_);
     if(_cL_ !== Canvas_not_available)
      throw caml_maybe_attach_backtrace(_cL_, 0);
