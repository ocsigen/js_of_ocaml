...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.9.1+480cee7
(function
  (Object){
...
(function(globalThis){
   ...
   var
    ...
    _cn_ = [0, 0, 0, 0.],
    _co_ = [254, -1., 0.],
    _cm_ = [0, "examples/hyperbolic/hypertree.ml", 988, 2],
    _cl_ = "<TITLE>",
    _ck_ = cst,
    _cj_ = "messages.json";
   ...
   global.Date;
   var math = global.Math, error_constr = global.Error;
   function to_string$0(t14){return caml_string_of_jsstring(t14.toString());}
   global.JSON;
   function escape(s){return global.escape(s);}
   register_printer
    (function(e){
      if(e instanceof error_constr) return [0, to_string$0(e)];
      if(e[1] !== Error) return 0;
      var e$0 = e[2];
      return [0, to_string$0(e$0)];
     });
   function appendChild(t4, t3){t4.appendChild(t3); return 0;}
   function removeChild(t6, t5){t6.removeChild(t5);}
   function handler(f){
                               ...
                               (document,
                                ...
                                handler
                                 (function(t25){
                                   ...
                                   if(_c0_)
                                    var
                                     _c1_ = 4. < Math.abs(x1 - x0) ? 1 : 0,
                                     _c2_ = _c1_ || (4. < Math.abs(y1 - y0) ? 1 : 0);
                                   else
                                    var _c2_ = _c0_;
                                   if(_c2_){
                                    started[1] = 1;
                                    ...
                                    for(;;){
                                     ...
                                     if(1 - (touch === undefined$0 ? 1 : 0))
                                      ...
                                      if(touch.identifier === id){
                                       ...
                                       if(_cV_)
                                        var
                                         _cW_ = 4. < Math.abs(x1 - x0) ? 1 : 0,
                                         _cX_ = _cW_ || (4. < Math.abs(y1 - y0) ? 1 : 0);
                                       else
                                        var _cX_ = _cV_;
                                       if(_cX_){
                                        started[1] = 1;
