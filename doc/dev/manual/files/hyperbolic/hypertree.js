...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.8.0+a2275df
(function
  (Object){
...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gz_ = caml_wrap_exception(_gA_);
      if(_gz_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gz_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function fold_left(f, x, a){
    var r = [0, x], _gr_ = a.length - 2 | 0, _gq_ = 0;
    if(_gr_ >= 0){
     var i = _gq_;
     for(;;){
   ...
   var key_counter = [0, 0], parent_keys = [0, 0], _r_ = "Array.blit";
   ...
   var at_exit_key = new_key(0, function(param, _gp_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _go_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _go_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gn_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gn_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gn_[1];
   ...
   function string_to_caml_string(str){
    ...
    var
     str$0 = caml_string_of_bytes(_gi_),
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fZ_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fZ_ >>> 0){
           if(55 === _fZ_) break a;
          }
          else if(21 < _fZ_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _fR_ = fmt$0[1];
        if(0 === _fR_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _fR_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _fR_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _fS_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _fS_);
     }
    }
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bk_), _fN_, _fM_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_fL_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _fI_ = field(e, 1),
       _fK_ = caml_call2(sprintf(_bl_), _fI_, _fH_);
     else
      switch(match){
        case 0:
         var _fK_ = _bm_; break;
        case 1:
         var _fK_ = _bn_; break;
        default:
         var _fJ_ = field(e, 1), _fK_ = caml_call1(sprintf(_bo_), _fJ_);
      }
     var match$0 = [0, constructor, [0, _fK_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _fx_ = slot[4],
        _fy_ = slot[3],
        _fz_ = slot[6] ? _by_ : _bA_,
        _fA_ = slot[2],
        _fB_ = slot[7],
        _fC_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _fC_, _fB_, _fA_, _fz_, _fy_, _fx_, _fw_)];
      else if(slot[1])
       var match = 0;
      else
       var _fD_ = info(0), match = [0, caml_call1(sprintf(_bB_), _fD_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_fu_){}
      try{
       var _fk_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _fk_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _fl_ = abs(status);
        prerr_endline(caml_check_bound(errors, _fl_)[1 + _fl_]);
       }
       var _fr_ = caml_ml_flush(stderr), _fp_ = _fr_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _fn_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _fn_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fo_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _fo_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _fp_ = caml_ml_flush(stderr);
      }
      var _fq_ = _fp_;
     }
     catch(_ft_){
      var _fm_ = caml_wrap_exception(_ft_);
      if(_fm_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_fm_, 0);
      var _fq_ = prerr_endline(_bD_);
     }
     return _fq_;
    }
    catch(_fs_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    ...
    var i3$0 = caml_notequal(i3, _bF_) ? i3 : _bI_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bG_) ? i4 : _bH_;
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _fg_ = get_int64_le(d2, 8),
     _fh_ = get_int64_le(d2, 0),
     _fi_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _fi_, _fh_, _fg_);
    return s;
   }
   var
   ...
   var
    ...
    _m_ = cst,
    _l_ = "String.concat",
    _bR_ = "Hashtbl: unsupported hash table format",
    _bP_ = cst,
    _bS_ = "Jsoo_runtime.Error.Exn",
    _bW_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _bX_ = "[\\][()\\\\|+*.?{}^$]",
    ...
    _cc_ = cst,
    _cb_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cd_ = "Exception during Lwt.async: ",
    _ct_ = cst_info_38_png,
    _cu_ = cst_globe_38_png,
    _cv_ = cst_meeting_point_38_png,
    _cw_ = cst_ocsigen_powered_png,
    _cq_ = cst,
    _cr_ = cst_commons_38_png,
    _cs_ = cst_wikipedia_38_png,
    _co_ = cst_on,
    _cp_ = cst_off,
    _cm_ = cst_on,
    _cn_ = cst_off,
    _cl_ = "image_info.json",
    _cj_ = [0, 0, 0, 0.],
    _ck_ = [254, -1., 0.],
    ...
    _cg_ = cst,
    _cf_ = "messages.json";
   try{var _cy_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _cy_;}
   catch(_fc_){
    var _bN_ = caml_wrap_exception(_fc_);
    if(_bN_ !== Not_found) throw caml_maybe_attach_backtrace(_bN_, 0);
    try{var _cx_ = caml_sys_getenv("CAMLRUNPARAM"), _bQ_ = _cx_;}
    catch(_fd_){
     var _bO_ = caml_wrap_exception(_fd_);
     if(_bO_ !== Not_found) throw caml_maybe_attach_backtrace(_bO_, 0);
     var _bQ_ = _bP_;
    }
    var params = _bQ_;
   }
   ...
   if(l < 0)
    ...
    try{index_rec(params, l, i, c); var _q_ = 1, randomized_default = _q_;}
     ...
     var _p_ = caml_wrap_exception(_fb_);
   ...
   function find(h, key){
    var
     _fa_ = key_index(h, key),
     match = caml_check_bound(h[2], _fa_)[1 + _fa_];
   ...
   function iter$1(x, f){
    var _e$_ = 1 - (x == no_handler ? 1 : 0);
    return _e$_ ? caml_call1(f, x) : _e$_;
   }
   ...
   function addEventListener(t28, typ, t44, capt){
    ...
    function callback(e){
     var _e8_ = [0, t44, e, [0]];
     return function(_e9_, _e__){return caml_js_call(_e8_, _e9_, _e__);};
    }
   ...
   var Canvas_not_available = [248, _bW_, caml_fresh_oo_id(0)];
   ...
   var
    ...
    quote_re = regexp(_bX_),
    Local_exn = [248, _bY_, caml_fresh_oo_id(0)];
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _e7_){return 0;},
     t41 = function(param, _e6_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b0_ = caml_wrap_exception(_e5_);
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l >= i){
       var _e3_ = index_rec(path_string, l, i, c);
       break a;
      }
      var _e3_ = invalid_arg(_n_);
     }
     var j = _e3_;
    }
    catch(_e4_){
     var _e2_ = caml_wrap_exception(_e4_);
   ...
   if(a && a[1] === cst){
    var _bZ_ = a[2];
    if(! _bZ_ || _bZ_[1] === cst && ! _bZ_[2]) break a;
   }
   var t49 = t43.search;
   if(t49.charAt(0) == "?")
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
      var t3 = arr[idx$0], _eX_ = idx$0 - 1 | 0;
      if(t3 === undefined$0)
       var _eZ_ = interrupt(0);
      else{
       var
       ...
       if(0 <= index)
        var
         t7 = index + 1 | 0,
         _eV_ = t3.slice(t7),
         x$0 = [0, t3.slice(0, index), _eV_];
       else
        var x$0 = undefined$0;
       if(x$0 === undefined$0)
        var _e0_ = interrupt(0);
       else
        var
         y = x$0[2],
         x = x$0[1],
         _eY_ = urldecode_js_string_string(y),
         _e0_ = [0, urldecode_js_string_string(x), _eY_];
       var _eZ_ = _e0_;
      }
      aux$0([0, _eZ_, acc], _eX_);
      return;
     }
     catch(_e1_){
      var _eW_ = caml_wrap_exception(_e1_);
      if(_eW_ !== Local_exn) throw caml_maybe_attach_backtrace(_eW_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _eU_ = caml_call1(f, v); return _eU_;}
    catch(exn$0){
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      if(! _eS_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _eS_[1];
      if(_eS_[2]){
       var next = _eS_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    ...
    switch(_eR_[0]){
      ...
      case 2:
       ...
       resolve(_b4_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _b2_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_b5_, r, [0, v]);}
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       var p$0 = underlying(p);
       resolve(_b9_, 0, p$0, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _eQ_ = caml_call1(f, v), user_provided_promise = _eQ_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p1 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_b8_, 0, outer_promise, p1[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          p1[1] = state;
          break;
         default: resolve(_b7_, 0, outer_promise, p1[1]);
       }
      }
      return 0;
     }
   ...
   function transf(a, b, c, d, z){
    var _eN_ = add_mul(c, z, d);
    return div(add_mul(a, z, b), _eN_);
   }
   function transl(p){
    var c = mul(conj(p), one);
    return function(z){return transf(one, p, c, one, z);};
   }
   function compose(param, _eL_){
    var
     t2 = _eL_[2],
     p2 = _eL_[1],
     t1 = param[2],
     ...
     _eM_ = div(conj(den), den),
     c = mul(mul(t1, t2), _eM_),
     _eK_ = sdiv(c, norm(c));
    return [0, div(add$0(t2p1, p2), den), _eK_];
   }
   function compute_translation(z0, z1){
    var dz = sub$1(z1, z0), z0z1 = mul(z0, z1), _eJ_ = 1. - sq_norm(z0z1);
    return sdiv(add$0(mul(z0z1, conj(dz)), dz), _eJ_);
   }
   var json = JSON;
   function getfile(url){
    try{var _eD_ = return$0(caml_read_file_content(url)); return _eD_;}
    catch(_eE_){
     var _eC_ = caml_wrap_exception(_eE_);
     if(_eC_ !== Not_found) throw caml_maybe_attach_backtrace(_eC_, 0);
     var
      content_type$2 = 0,
      check_headers = function(param, _eI_){return 1;},
      contents = 0,
      _eB_ =
        function(r){
         var cod = r[2], msg = r[4];
           ...
           switch(req.readyState){
             ...
             case 4:
              ...
              var
               ...
               _eG_ = x == no_handler ? _cc_ : g(x),
               response = [0, url, code, headers, _eG_, _eF_];
     ...
     if(contents){
      var match$3 = contents[1], _eA_ = match$3[1];
      if(-836918635 === _eA_){
       ...
       if(891486873 <= match$4[1]){
        ...
        if(l$1){
         ...
         a:
         {
          ...
          var _ey_ = caml_ml_string_length(hd) + acc | 0;
         }
         var dst$1 = caml_create_bytes(_ey_);
         a:
         {
          b:
          {
         ...
         var _ez_ = caml_string_of_bytes(dst$1);
        }
        else
         var _ez_ = _m_;
        var t60 = caml_jsstring_of_string(_ez_);
        req.send(t60);
       }
       else{var t62 = match$4[2]; req.send(t62);}
      }
      else if(737307005 <= _eA_){
       var t66 = match$3[2];
       req.send(t66);
      }
      else{
   ...
   if(t132 === undefined$0)
    var _ce_ = default_language(0);
   else
    var
     x = t132.getItem(cst_hyp_lang),
     _bT_ = x == no_handler ? default_language(0) : x,
     _ce_ = _bT_;
   var language = [0, _ce_], t133 = language[1];
   console$0.log(t133);
   function local_messages(msgs){return option(msgs[language[1]]);}
   function screen_transform(canvas){
    var
     _ew_ = opt_style(style.padding, 0.),
     offset = opt_style(style.border, 0.5) + _ew_,
     w = canvas.width,
     h = canvas.height,
     rx = w / 2.,
     ry = h / 2.,
      ...
      if(typeof img !== "number"){
       if(4204112 <= img[1]){
        ...
        var
         min_scale =
           function(l, w, h, s){
            var s$0 = [0, s], _et_ = l.length - 2 | 0, _es_ = 0;
            if(_et_ >= 0){
             var i = _es_;
             for(;;){
              var
               ...
               _eu_ = z[1],
               sx =
                 Math.abs(caml_check_bound(vertices, j)[1 + j][1] - _eu_) / w,
        ...
        if(caml_obj_tag(img$0) !== 246){
         ...
         if(250 === _ek_)
          ...
          if(246 !== _ek_ && 244 !== _ek_){var _el_ = img$0; break c;}
          var _el_ = force_lazy_block(img$0);
         }
         var match$1 = poll(_el_);
         if(match$1){
          var
           t205 = match$1[1],
           w$1 = t205.width,
          ...
          if(_en_){
           ...
           var
            _eo_ = 2. <= w$2 ? 1 : 0,
            _ep_ = _eo_ ? 2. <= h$2 ? 1 : 0 : _eo_;
           if(_ep_) large_image_count[1]++;
          }
         }
        }
        else{
         ...
         if(1. < s$0 * max(rx$2, ry$2)){
          var _eq_ = caml_obj_tag(img$0);
          c:
          if(250 !== _eq_){
           if(246 !== _eq_ && 244 !== _eq_) break c;
    ...
    if(1 - need_redraw[1]){
     ...
     var
      t249 =
        caml_js_wrap_callback
         (function(param){
           var _eb_ = need_redraw[1];
           return _eb_ ? perform_redraw(0) : _eb_;
          });
   ...
   function compute_text_nodes(node_names, nodes){
    try{var _d8_ = assq(language[1], node_names)[1], names = _d8_;}
    catch(_d$_){
     var _dV_ = caml_wrap_exception(_d$_);
     if(_dV_ !== Not_found) throw caml_maybe_attach_backtrace(_dV_, 0);
     try{var _d7_ = assq(cst_en, node_names)[1], _dX_ = _d7_;}
     catch(_ea_){
      var _dW_ = caml_wrap_exception(_ea_);
      if(_dW_ !== Not_found) throw caml_maybe_attach_backtrace(_dW_, 0);
      var _dX_ = create$0(0, 11);
     }
     var names = _dX_;
    }
    try{var _d6_ = find(names, _ch_), _dZ_ = _d6_;}
    catch(_d__){
     var _dY_ = caml_wrap_exception(_d__);
     if(_dY_ !== Not_found) throw caml_maybe_attach_backtrace(_dY_, 0);
     var _dZ_ = _cg_;
    }
    var t271 = caml_jsstring_of_string(_dZ_);
    document.title = t271;
    var _d1_ = nodes.length - 2 | 0, _d0_ = 0;
    if(_d1_ >= 0){
     var i = _d0_;
     for(;;){
      var match = caml_check_bound(nodes, i)[1 + i], _d2_ = match[2];
      a:
      if(typeof _d2_ !== "number" && 4204112 === _d2_[1]){
       var
        match$0 = _d2_[2],
        info = match$0[3],
        is_root = match$0[1],
       ...
       try{
        var
         ...
         _dU_ = caml_obj_tag(text_size_div);
        b:
        if(250 === _dU_)
         var t116 = text_size_div[1];
        else{
         if(246 !== _dU_ && 244 !== _dU_){var t116 = text_size_div; break b;}
        ...
        var _d5_ = [0, canvas], canvas$0 = _d5_;
       }
       catch(_d9_){
        var _d4_ = caml_wrap_exception(_d9_);
        if(_d4_ !== Not_found) throw caml_maybe_attach_backtrace(_d4_, 0);
        var canvas$0 = 0;
       }
   ...
   function close_button(over){
    ...
    t280.stroke();
    t280.restore();
    var _dT_ = over ? _cm_ : _cn_, t304 = caml_jsstring_of_string(_dT_);
            ...
            (image_info,
             function(image_info){
              ...
              if(0 <= i[1]){
               var
                _dM_ = i[1],
                info = caml_check_bound(image_info, _dM_)[1 + _dM_],
                t363 = i[1];
               ...
               var
                ...
                _dN_ = caml_obj_tag(small_image);
               a:
               if(250 === _dN_)
                var _dO_ = small_image[1];
               else{
                if(246 !== _dN_ && 244 !== _dN_){
                 var _dO_ = small_image;
                 break a;
                }
                var _dO_ = force_lazy_block(small_image);
               }
               var match = poll(_dO_);
               if(match){
                var
               ...
               var
                ...
                commons =
                  img_button([0, caml_jsstring_of_string(url$0)], 52, _cr_),
                t550 =
                  tooltip
                   (opt_style
               ...
               var
                wikipedia = img_button(0, 34, _cs_),
                ...
                list =
                  function(title, lang){
                   ...
                   if(! _dR_) return _dR_;
                   count[1]++;
                   var dd = createElement(document, _bU_);
                   appendChild(dd, document.createTextNode(title));
                   appendChild(dl, dd);
                   var dt = createElement(document, _bV_);
                   appendChild(dt, ul);
                   return appendChild(dl, dt);
                  },
                _dP_ = language[1];
               list(opt_style(messages.language, cst_In_English), _dP_);
       ...
       (getfile(tree_url),
        function(s){
             ...
             (function(param){
               ...
               iter$0
                (function(param){
                  ...
                  h[1] = h[1] + 1 | 0;
                  var _dJ_ = h[2].length - 1 << 1 < h[1] ? 1 : 0;
                  if(! _dJ_) return _dJ_;
                  var
                   odata = h[2],
                   osize = odata.length - 1,
                   nsize$0 = osize * 2 | 0,
                   _dI_ = nsize$0 < max_array_length ? 1 : 0;
                  if(! _dI_) return _dI_;
                  var
                   ndata = caml_make_vect(nsize$0, 0),
                   _dz_ = h.length - 1 < 4 ? 1 : 0,
                   _dA_ = _dz_ || (h[4] < 0 ? 1 : 0),
                   inplace = 1 - _dA_;
                  h[2] = ndata;
                  var
         ...
         (current, current_weights, is_root, transf, lineWidth, dir){
          ...
          vi[1]++;
          var _dw_ = transf[1];
          caml_check_bound(vertices, i$0)[1 + i$0] = _dw_;
          var l$0 = ch.length - 1;
          if(0 === l$0)
           var ch$0 = [0];
          else{
           ...
           if(0 === l)
            ...
            var
             _dq_ = caml_check_bound(ch_weights, 0)[1],
             r = caml_make_vect(l, f(caml_check_bound(ch, 0)[1], _dq_)),
             _ds_ = l - 1 | 0,
             _dr_ = 1;
            if(_ds_ >= 1){
             var i = _dr_;
             for(;;){
              var
               _dt_ = caml_check_bound(ch_weights, i)[1 + i],
               _du_ = f(caml_check_bound(ch, i)[1 + i], _dt_);
              caml_check_bound(r, i)[1 + i] = _du_;
              var _dv_ = i + 1 | 0;
              if(_ds_ === i) break;
              i = _dv_;
             }
         ...
         function compute_frontiers(node){
          ...
          if(0 === l.length - 1)
           var _dm_ = [0, status(i)], _dn_ = [0, [0, status(i)], _dm_];
          else
           var
            _do_ = l.length - 2 | 0,
            i$1 = caml_check_bound(l, _do_)[1 + _do_][1],
            _dp_ = caml_check_bound(frontiers, i$1)[1 + i$1][2],
            i$0 = caml_check_bound(l, 0)[1][1],
            _dn_ = [0, caml_check_bound(frontiers, i$0)[1 + i$0][1], _dp_];
          caml_check_bound(frontiers, i)[1 + i] = _dn_;
          return 0;
         }
         ...
         function compute_neigh(node, parent, lft, rght){
          ...
          caml_check_bound(neighboors, i$0)[1 + i$0] = _de_;
          var
          ...
          if(_dg_ >= 0){
           ...
           for(;;){
            if(0 < j)
             var
              _dh_ = j - 1 | 0,
              i$3 = caml_check_bound(ch, _dh_)[1 + _dh_][1],
              lft$0 = caml_check_bound(frontiers, i$3)[1 + i$3][2];
            else if(is_root)
             var
              _dl_ = n - 1 | 0,
              i = caml_check_bound(ch, _dl_)[1 + _dl_][1],
            ...
            if(j < (n - 1 | 0))
             var
              _di_ = j + 1 | 0,
              i$1 = caml_check_bound(ch, _di_)[1 + _di_][1],
             ...
             var rght$0 = rght;
            var _dj_ = [0, status(i$0)];
            compute_neigh(caml_check_bound(ch, j)[1 + j], _dj_, lft$0, rght$0);
            var _dk_ = j + 1 | 0;
            if(_dg_ === j) break;
            j = _dk_;
           }
         ...
         var _dc_ = nodes.length - 2 | 0, _db_ = 0;
         if(_dc_ >= 0){
          var i$2 = _db_;
          for(;;){
   ...
   function start(param){
    try{
                   ...
                   (all_messages,
                    function(all_messages){
                     ...
                     redraw_funct[1] =
                      function(param){
                       ...
                       var
                        ...
                        _c$_ = t687 !== element.width ? 1 : 0,
                        _da_ = _c$_ || (t689 !== element.height ? 1 : 0);
                       if(_da_){element.width = t687; element.height = t689;}
                       var
                        param$0 = tr$0[1],
                        t = param$0[2],
                        p = param$0[1],
                        c = mul(conj(p), t),
                        _c8_ = vertices.length - 2 | 0,
                        _c7_ = 0;
                       if(_c8_ >= 0){
                        var i = _c7_;
                        for(;;){
                         ...
                         caml_check_bound(vertices$0, i)[1 + i] = _c9_;
                         var _c__ = i + 1 | 0;
                         if(_c8_ === i) break;
                         i = _c__;
                        }
                        ...
                        handler
                         (function(param){
                           var
                            ...
                            w = page.clientWidth,
                            h = page.clientHeight,
                            _c5_ = w !== element.width ? 1 : 0,
                            _c6_ = _c5_ || (h !== element.height ? 1 : 0);
                           if(_c6_) schedule_redraw(0);
                           return true$0;
                          });
                     global.onresize = t698;
                     function find_box(boxes, x, y){
                      var p = [0, -1], _c0_ = boxes[3].length - 2 | 0, _cZ_ = 0;
                      if(_c0_ >= 0){
                       var i = _cZ_;
                       for(;;){
                        var _c1_ = 0. < boxes[3][1 + i] ? 1 : 0;
                        if(_c1_)
                         var
                          _c2_ =
                               ...
                               (document,
                                ...
                                handler
                                 (function(t25){
                                   ...
                                   if(_cW_)
                                    var
                                     _cX_ = 4 < abs(x1 - x0 | 0) ? 1 : 0,
                                     _cY_ = _cX_ || (4 < abs(y1 - y0 | 0) ? 1 : 0);
                                   else
                                    var _cY_ = _cW_;
                                   if(_cY_){
                                    started[1] = 1;
                              ...
                              handler
                               (function(t34){
                                 ...
                                 if(started[1]){
                                  ...
                                  a:
                                  if(0 < i){
                                   var _cV_ = caml_check_bound(nodes, i)[1 + i][2];
                                   if(typeof _cV_ !== "number" && 3654627 === _cV_[1]){
                                    var match = _cV_[2], name = match[2], img = match[1];
                                    ...
                                    for(;;){
                                     ...
                                     if(1 - (touch === undefined$0 ? 1 : 0))
                                      ...
                                      if(touch.identifier === id){
                                       ...
                                       if(_cR_)
                                        var
                                         _cS_ = 4 < abs(x1 - x0 | 0) ? 1 : 0,
                                         _cT_ = _cS_ || (4 < abs(y1 - y0 | 0) ? 1 : 0);
                                       else
                                        var _cT_ = _cR_;
                                       if(_cT_){
                                        started[1] = 1;
                                   ...
                                   if(1 - (touch === undefined$0 ? 1 : 0))
                                    ...
                                    if(touch.identifier === id){
                                     ...
                                     if(started[1]){
                                      ...
                                      var i = find_box(boxes, x, y);
                                      if(0 < i){
                                       var _cO_ = caml_check_bound(nodes, i)[1 + i][2];
                                       if(typeof _cO_ !== "number" && 3654627 === _cO_[1]){
                                        var match = _cO_[2], name = match[2], img = match[1];
                                        show_image(all_messages, image_info, name, img);
                                        break a;
                                       }
                                      }
                     ...
                     function make_buttons(param){
                      ...
                      var lang = img_button(0, 38, _cu_), t746 = lang.style;
                      ...
                      iter
                       (function(param){
                        ...
                        languages);
                      var
                       dd = createElement(document, _bU_),
     ...
     var _cz_ = caml_wrap_exception(_cA_);
     if(_cz_ !== Canvas_not_available)
