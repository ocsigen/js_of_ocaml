...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.7.1+a28514e
(function
  (Object){
...
(function(globalThis){
   ...
   function fold_left(f, x, a){
    var r = [0, x], _he_ = a.length - 2 | 0, _hd_ = 0;
    if(_he_ >= 0){
     var i = _hd_;
     for(;;){
   ...
   if(a && a[1] === cst$0){
    var _b$_ = a[2];
    if(! _b$_ || _b$_[1] === cst$0 && ! _b$_[2]) break a;
   }
   var
      ...
      if(typeof img !== "number"){
       if(4204112 <= img[1]){
        ...
        var
         min_scale =
           function(l, w, h, s){
            var s$0 = [0, s], _fh_ = l.length - 2 | 0, _fg_ = 0;
            if(_fh_ >= 0){
             var i = _fg_;
             for(;;){
              var
   ...
   function compute_text_nodes(node_names, nodes){
    ...
    document.title = t271;
    var _eN_ = nodes.length - 2 | 0, _eM_ = 0;
    if(_eN_ >= 0){
     var i = _eM_;
     for(;;){
      ...
      symbol_bind
       (getfile(tree_url),
        function(s){
         ...
         var _dQ_ = nodes.length - 2 | 0, _dP_ = 0;
         if(_dQ_ >= 0){
          var i = _dP_;
          for(;;){
           var info = caml_check_bound(nodes, i)[1 + i][2];
                   ...
                   (all_messages,
                    function(all_messages){
                     ...
                     function find_box(boxes, x, y){
                      var p = [0, -1], _dC_ = boxes[3].length - 2 | 0, _dB_ = 0;
                      if(_dC_ >= 0){
                       var i = _dB_;
                       for(;;){
