...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.5.0+git-1a605b2
(function
  (Object){
...
(function(globalThis){
   ...
   var
    ...
    _cJ_ = [0, 0, 0, 0.],
    _cK_ = [254, -1., 0.],
    _cI_ = [0, "examples/hyperbolic/hypertree.ml", 998, 2],
    _cH_ = "<TITLE>",
    _cG_ = cst$0,
    _cE_ = cst_jpg,
    _cF_ = "thumbnails/",
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _im_ = caml_wrap_exception(_in_);
      if(_im_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_im_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function prerr_string(s){output_string(stderr, s); return;}
   ...
   function iter$0(f, a){
    var _ik_ = a.length - 1 - 1 | 0, _ij_ = 0;
    if(_ik_ >= 0){
     var i = _ij_;
     for(;;){
      caml_call1(f, a[1 + i]);
   ...
   function fold_left(f, x, a){
    var r = [0, x], _ie_ = a.length - 1 - 1 | 0, _id_ = 0;
    if(_ie_ >= 0){
     var i = _id_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _ic_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _hT_ = function(param){af(0); return;};
        return [0, function(param){fa(0); return;}, _hT_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _hU_ = function(param){af$0(0); return;};
        return [0, function(param){fa$0(0); return;}, _hU_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _hV_ = function(param){af$1(0); return;};
        return [0, function(param){fa$1(0); return;}, _hV_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _hW_ = function(param){af$2(0); return;};
        return [0, function(param){fa$2(0); return;}, _hW_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _hX_ = function(param){af$3(0); return;};
        return [0, function(param){fa$3(0); return;}, _hX_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _hY_ = function(param){af$4(0); return;};
        return [0, function(param){fa$4(0); return;}, _hY_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _hZ_ = function(param){af$5(0); return;};
        return [0, function(param){fa$5(0); return;}, _hZ_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _h0_ = function(param){af$6(0); return;};
        return [0, function(param){fa$6(0); return;}, _h0_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _h1_ = function(param){af$7(0); return;};
        return [0, function(param){fa$7(0); return;}, _h1_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _h2_ = function(param){jd(0); de$8(0); return;},
         _h3_ = function(param){ed$8(0); dj(0); return;},
         _h4_ = function(param){ga(0); af$8(0); return;};
        return [0, function(param){fa$8(0); ag(0); return;}, _h4_, _h3_, _h2_];
       case 10:
        var
         rest$9 = param[1],
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _h5_ = function(param){af$9(0); return;};
        return [0, function(param){fa$9(0); return;}, _h5_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _h6_ = function(param){af$10(0); return;};
        return [0, function(param){fa$10(0); return;}, _h6_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _h7_ = function(param){af$11(0); return;};
        return [0, function(param){fa$11(0); return;}, _h7_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _h8_ = function(param){de$12(0); return;},
         _h9_ = function(param){ed$12(0); return;},
         _h__ = function(param){af$12(0); return;};
        return [0, function(param){fa$12(0); return;}, _h__, _h9_, _h8_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _h$_ = function(param){de$13(0); return;},
         _ia_ = function(param){ed$13(0); return;},
         _ib_ = function(param){af$13(0); return;};
        return [0, function(param){fa$13(0); return;}, _ib_, _ia_, _h$_];
     }
    function _hQ_(param){return;}
    function _hR_(param){return;}
    function _hS_(param){return;}
    return [0, function(param){return;}, _hS_, _hR_, _hQ_];
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _hP_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _hP_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _hN_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _hN_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _hO_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _hO_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _hO_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _hL_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _hL_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _hM_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _hM_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _hC_ = caml_ml_bytes_length(b) - 1 | 0,
     _hB_ = 0;
    if(_hC_ >= 0){
     var i$0 = _hB_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _hE_ = caml_ml_bytes_length(b) - 1 | 0, _hD_ = 0;
     if(_hE_ >= 0){
      var i = _hD_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _hw_ = caml_ml_string_length(s) - 1 | 0, _hv_ = 0;
    if(_hw_ >= 0){
     var i$0 = _hv_;
     for(;;){
    ...
    var
     ...
     _hy_ = caml_ml_string_length(s) - 1 | 0,
     _hx_ = 0;
    if(_hy_ >= 0){
     var i = _hx_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _hu_ = _an_; break;
      default: var _hu_ = _aw_;
    }
    return transform_int_alt(iconv, caml_format_int(_hu_, n));
   }
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ht_ = _aN_; break;
      default: var _ht_ = _aW_;
    }
    return transform_int_alt(iconv, caml_format_int(_ht_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _hs_ = _a0_; break;
      default: var _hs_ = _a9_;
    }
    return transform_int_alt(iconv, caml_format_int(_hs_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _hr_ = _aA_; break;
      default: var _hr_ = _aJ_;
    }
    return transform_int_alt(iconv, caml_int64_format(_hr_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _ho_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _ho_ >>> 0){
           if(55 === _ho_) break a;
          }
          else if(21 < _ho_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _hp_ = 1;
        }
        var _hq_ = _hp_ ? str : symbol(str, _a__);
        return caml_special_val(_hq_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _hk_ = l - 1 | 0, _hj_ = 0;
        if(_hk_ >= 0){
         var i = _hj_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _hl_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _hl_);
          var _hm_ = i + 1 | 0;
          if(_hk_ === i) break;
          var i = _hm_;
         }
       ...
       return caml_string_of_bytes(_hn_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _hi_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _hi_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _hi_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _hh_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _hh_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _he_ = [8, acc, _bh_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _he_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _he_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _hd_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _hd_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _hd_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _hc_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _hc_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _ha_ = other_fields(x, i + 1 | 0), _hb_ = field(x, i);
    return caml_call2(sprintf(_bq_), _hb_, _ha_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_g$_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _g7_ = other_fields(e, 2),
       _g8_ = field(e, 1),
       _g__ = caml_call2(sprintf(_br_), _g8_, _g7_);
     else
      switch(match){
        case 0:
         var _g__ = _bs_; break;
        case 1:
         var _g__ = _bt_; break;
        default:
         var _g9_ = field(e, 1), _g__ = caml_call1(sprintf(_bu_), _g9_);
      }
     var match$0 = [0, constructor, [0, _g__]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
       ...
       info$0 =
         function(pos){
          function info(is_raise){
           return is_raise ? 0 === pos ? _bA_ : _bB_ : 0 === pos ? _bC_ : _bD_;
          }
          return info;
         },
       info = info$0(pos);
      if(0 === slot[0])
       var
        ...
        _gX_ = slot[4],
        _gY_ = slot[3],
        _gZ_ = slot[6] ? _bE_ : _bG_,
        _g0_ = slot[2],
        _g1_ = slot[7],
        _g2_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bF_), _g2_, _g1_, _g0_, _gZ_, _gY_, _gX_, _gW_)];
      else if(slot[1])
       var match = 0;
      else
       var _g3_ = info(0), match = [0, caml_call1(sprintf(_bH_), _g3_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_gU_){}
      try{
       var _gK_ = to_string(exn$0);
       caml_call1(eprintf(_bK_), _gK_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _gL_ = abs(status);
        prerr_endline(caml_check_bound(errors, _gL_)[1 + _gL_]);
       }
       var _gM_ = caml_ml_flush(stderr), _gQ_ = _gM_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _gO_ = to_string(exn$0);
       caml_call1(eprintf(_bM_), _gO_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _gP_ = to_string(exn);
       caml_call1(eprintf(_bN_), _gP_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _gQ_ = caml_ml_flush(stderr);
      }
      var _gR_ = _gQ_;
     }
     catch(_gT_){
      var _gN_ = caml_wrap_exception(_gT_);
      if(_gN_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_gN_, 0);
      var _gR_ = prerr_endline(_bL_);
     }
     return _gR_;
    }
    catch(_gS_){return 0;}
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _gG_ = get_int64_le(d2, 8),
     _gH_ = get_int64_le(d2, 0),
     _gI_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _gI_, _gH_, _gG_);
    return s;
   }
   function split(s){
    var
   ...
   if(l < 0)
    ...
    try{index_rec(params, l, i, c); var _s_ = 1, randomized_default = _s_;}
     ...
     var _r_ = caml_wrap_exception(_gB_);
   ...
   function find(h, key){
    var
     _gA_ = key_index(h, key),
     match = caml_check_bound(h[2], _gA_)[1 + _gA_];
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    function callback(e){
     var _gv_ = [0, h, e, [0]];
     return function(_gw_, _gx_){return caml_js_call(_gv_, _gw_, _gx_);};
    }
   ...
   function stopPropagation(t109){
    function _gt_(param){return t109.stopPropagation();}
    function _gu_(param){return t109.cancelBubble = true$0;}
    case$1(t109.stopPropagation, _gu_, _gt_);
    return;
   }
   global.FormData;
   global.FormData;
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _gs_){return 0;},
     t41 = function(param, _gr_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _ce_ = caml_wrap_exception(_gq_);
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l >= i){
       var _go_ = index_rec(path_string, l, i, c);
       break a;
      }
      var _go_ = invalid_arg(_p_);
     }
     var j = _go_;
    }
    catch(_gp_){
     var _gn_ = caml_wrap_exception(_gp_);
     if(_gn_ !== Not_found) throw caml_maybe_attach_backtrace(_gn_, 0);
     var j = l$0;
    }
         ...
         function(s){
          function _gl_(param){
           var
            y = param[2],
            x = param[1],
            _gm_ = urldecode_js_string_string(y);
           return [0, urldecode_js_string_string(x), _gm_];
          }
          var index = s.indexOf(caml_jsstring_of_string(make$0(1, 61)));
          if(0 <= index)
           var
            _gj_ = s.slice(index + 1 | 0),
            _gk_ = [0, s.slice(0, index), _gj_];
          else
           var _gk_ = undefined$0;
          return case$1(_gk_, interrupt, _gl_);
         };
      aux$0([0, case$1(arr[idx$0], interrupt, _gh_), acc], _gg_);
      return;
     }
     catch(_gi_){
      var _gf_ = caml_wrap_exception(_gi_);
      if(_gf_ !== Local_exn) throw caml_maybe_attach_backtrace(_gf_, 0);
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _ge_ = caml_call1(f, v); return _ge_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _gd_ = result[1] === Canceled ? 1 : 0, is_canceled = _gd_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
      ...
      iter_callback_list =
        function(fs, rest){
         ...
         for(;;){
          if(typeof fs$0 === "number"){iter_list(rest$0); return;}
          switch(fs$0[0]){
            case 0:
             var
              fs$1 = fs$0[2],
      ...
      switch(fs$0[0]){
        ...
        default:
         ...
         if(counter >= 50)
          return caml_trampoline_return(iter_list$0, [0, rest$0]);
         var counter$3 = counter + 1 | 0;
         return iter_list$0(counter$3, rest$0);
      }
     }
    }
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _gc_ = deferred_callbacks[2];
      if(! _gc_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _gc_[1];
      if(_gc_[2]){
       var next = _gc_[2];
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _ga_ = caml_call1(f, v), user_provided_promise = _ga_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_cp_, function(param){return caml_call1(f, v);}, _f$_);
    }
   }
   ...
   function yield$0(param){
    ...
    function callback(_f9_){return wakeup(w, _f9_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_f8_){return loop(remain, _f8_);};
   ...
   function transf(a, b, c, d, z){
    var _f7_ = add_mul(c, z, d);
    return div(add_mul(a, z, b), _f7_);
   }
   function transl(p){
    var c = mul(conj(p), one);
    return function(z){return transf(one, p, c, one, z);};
   }
   function compose(param, _f5_){
    var
     t2 = _f5_[2],
     p2 = _f5_[1],
     t1 = param[2],
     ...
     _f6_ = div(conj(den), den),
     c = mul(mul(t1, t2), _f6_),
     _f4_ = sdiv(c, norm(c));
    return [0, div(add$0(t2p1, p2), den), _f4_];
   }
   function compute_translation(z0, z1){
    var dz = sub$1(z1, z0), z0z1 = mul(z0, z1), _f3_ = 1. - sq_norm(z0z1);
    return sdiv(add$0(mul(z0z1, conj(dz)), dz), _f3_);
   }
   var json = JSON;
   function getfile(url){
    try{var _fR_ = return$0(caml_read_file_content(url)); return _fR_;}
     ...
     var
      ...
      content_type$1 = 0,
      headers$0 = 0,
      check_headers = function(param, _f2_){return 1;},
      contents = 0;
     ...
     var
      headers =
        function(s){
         function _f0_(v){return [0, caml_string_of_jsstring(v)];}
         function _f1_(param){return 0;}
         return case$0
   ...
   function draw(canvas, vertices, edges, nodes, boxes){
    ...
    function _fm_(color){t192.fillStyle = color; return t192.fill();}
             ...
             if(_fE_ >= 0){
              ...
              for(;;){
               var
                ...
                _fF_ = z[1],
                sx =
                  Math.abs(caml_check_bound(vertices, j)[1 + j][1] - _fF_) / w,
   ...
   function compute_text_nodes(node_names, nodes){
    ...
    var t275 = caml_jsstring_of_string(_e3_);
    document.title = t275;
   ...
   function close_button(over){
    ...
    t286.stroke();
    t286.restore();
    var _eW_ = over ? _cO_ : _cP_, t308 = caml_jsstring_of_string(_eW_);
   ...
   function img_button(href, h, src){
    function decoration(over){
     ...
     t326.width = cst_38px;
     var
      t328 = caml_jsstring_of_string(symbol("" + max(38, h), _cQ_)),
      t329 = t321.style;
     t329.height = t328;
     var t332 = t321.style;
     t332.margin = cst_2px;
     ...
     var
      _eV_ = over ? _cT_ : _cV_,
      t339 = caml_jsstring_of_string(symbol(_cU_, _eV_));
     t321.className = t339;
    ...
    t345.width = cst_48px;
    var
     t347 = caml_jsstring_of_string(symbol("" + (8 + max(38, h) | 0), _cW_)),
     t348 = button.style;
    t348.height = t347;
    if(href){
     ...
     (image_info,
      function(image_info){
       ...
       if(_eK_ >= 0){
        var j = _eJ_;
        for(;;){
         if(name_js === caml_check_bound(image_info, j)[1 + j][1]) i[1] = j;
         var _eP_ = j + 1 | 0;
         if(_eK_ === j) break;
         var j = _eP_;
        }
       ...
       if(0 <= i[1]){
        var _eL_ = i[1], info = caml_check_bound(image_info, _eL_)[1 + _eL_];
        ...
        t386.right = cst_0;
        var img_container = createDiv(document), t389 = img_container.style;
        ...
        var
         wrap =
           function(elt){
            ...
            var
             t421 = caml_jsstring_of_string(symbol("" + info[5], _cX_)),
             t422 = t402.style;
            t422.maxHeight = t421;
        ...
        if(250 === _eM_)
         ...
         if(246 !== _eM_ && 244 !== _eM_){var _eN_ = small_image; break a;}
        ...
        if(match){
         ...
         var
          t452 =
            handler
             (function(param){removeChild(img_container, w); return false$0;});
         t453.onload = t452;
        }
        var match$0 = info[7];
        if(match$0)
         ...
         var t454 = caml_jsstring_of_string(symbol(_c6_, symbol(name, _c5_)));
        t453.src = t454;
        var t456 = info[4];
        t453.width = t456;
        var t458 = info[5];
        ...
        var
         w$0 = wrap(t453),
         handle_error =
           function(param){removeChild(img_container, w$0); return false$0;},
        ...
        var t487 = handler(function(ev){stopPropagation(ev); return true$0;});
        legend.onclick = t487;
        ...
        var
         t538 =
           tooltip
            (opt_style(messages.close, "Click anywhere to return to the tree")),
         t540 = t538.style;
        t540.right = "32px";
        var t543 = t538.style;
        t543.top = "20px";
        ...
        var
         ...
         url$0 =
           symbol(_cZ_, symbol(caml_string_of_jsstring(info[2]), suffix)),
         commons = img_button([0, caml_jsstring_of_string(url$0)], 52, _c0_),
         t554 =
           tooltip
            (opt_style
        ...
        var t586 = handler(function(ev){stopPropagation(ev); return true$0;});
        t573.onclick = t586;
        show_on_click(wikipedia, t573);
        var t588 = handler(function(ev){stopPropagation(ev); return true$0;});
                   ...
                   (all_messages,
                    function(all_messages){
                     ...
                     redraw_funct[1] =
                      function(param){
                       ...
                       var
                        ...
                        _d0_ = t691 !== element.width ? 1 : 0,
                        _d1_ = _d0_ || (t693 !== element.height ? 1 : 0);
                       if(_d1_){element.width = t691; element.height = t693;}
                       var
                        param$0 = tr$0[1],
                        t = param$0[2],
                        p = param$0[1],
                     ...
                     function make_buttons(param){
                      ...
                      var lang = img_button(0, 38, _c8_), t750 = lang.style;
                     ...
                     make_buttons(0);
                     var t806 = createImg(document), t805 = icon(_c__);
                     t806.src = t805;
