...
(function(globalThis){
   ...
   function symbol$0(l1, l2){
    if(! l1) return l2;
    var _ef_ = l1[2], h1 = l1[1];
    if(! _ef_) return [0, h1, l2];
    ...
    for(;;){
     if(l1$0){
      var _eg_ = l1$0[2], h1$0 = l1$0[1];
      if(_eg_){
       var match$0 = _eg_[2], h2$0 = _eg_[1];
       if(match$0){
   ...
   function make_matrix(sx, sy, init){
    var res = caml_make_vect(sx, [0]), _ea_ = sx - 1 | 0, _d$_ = 0;
    if(_ea_ >= 0){
     var x = _d$_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _d__){return 0;});
    ...
    if(_dn_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _bs_ : _bt_ : 0 === pos$0 ? _bu_ : _bv_;
      }
      if(0 === slot[0])
       var
        _de_ = slot[5],
