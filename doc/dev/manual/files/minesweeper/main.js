...
(function(globalThis){
   ...
   function symbol$0(l1, l2){
    if(! l1) return l2;
    var _eD_ = l1[2], h1 = l1[1];
    if(! _eD_) return [0, h1, l2];
    var match = _eD_[2], h2 = _eD_[1];
    ...
    for(;;){
     if(l1$0){
      var _eE_ = l1$0[2], h1$0 = l1$0[1];
      if(_eE_){
       var match$0 = _eE_[2], h2$0 = _eE_[1];
       if(match$0){
   ...
   function make_matrix(sx, sy, init){
    var res = caml_make_vect(sx, [0]), _ey_ = sx - 1 | 0, _ex_ = 0;
    if(_ey_ >= 0){
     var x = _ex_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _ew_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _eb_ = function(param){af(0); return;};
        return [0, function(param){fa(0); return;}, _eb_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _ec_ = function(param){af$0(0); return;};
        return [0, function(param){fa$0(0); return;}, _ec_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _ed_ = function(param){af$1(0); return;};
        return [0, function(param){fa$1(0); return;}, _ed_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _ee_ = function(param){af$2(0); return;};
        return [0, function(param){fa$2(0); return;}, _ee_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _ef_ = function(param){af$3(0); return;};
        return [0, function(param){fa$3(0); return;}, _ef_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _eg_ = function(param){af$4(0); return;};
        return [0, function(param){fa$4(0); return;}, _eg_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _eh_ = function(param){af$5(0); return;};
        return [0, function(param){fa$5(0); return;}, _eh_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _ei_ = function(param){af$6(0); return;};
        return [0, function(param){fa$6(0); return;}, _ei_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _ej_ = function(param){af$7(0); return;};
        return [0, function(param){fa$7(0); return;}, _ej_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _ek_ = function(param){jd(0); de$8(0); return;},
         _el_ = function(param){ed$8(0); dj(0); return;},
         _em_ = function(param){ga(0); af$8(0); return;};
        return [0, function(param){fa$8(0); ag(0); return;}, _em_, _el_, _ek_];
       case 10:
        var
         rest$9 = param[1],
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _en_ = function(param){af$9(0); return;};
        return [0, function(param){fa$9(0); return;}, _en_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _eo_ = function(param){af$10(0); return;};
        return [0, function(param){fa$10(0); return;}, _eo_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _ep_ = function(param){af$11(0); return;};
        return [0, function(param){fa$11(0); return;}, _ep_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _eq_ = function(param){de$12(0); return;},
         _er_ = function(param){ed$12(0); return;},
         _es_ = function(param){af$12(0); return;};
        return [0, function(param){fa$12(0); return;}, _es_, _er_, _eq_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _et_ = function(param){de$13(0); return;},
         _eu_ = function(param){ed$13(0); return;},
         _ev_ = function(param){af$13(0); return;};
        return [0, function(param){fa$13(0); return;}, _ev_, _eu_, _et_];
     }
    function _d__(param){return;}
    function _d$_(param){return;}
    function _ea_(param){return;}
    return [0, function(param){return;}, _ea_, _d$_, _d__];
   }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        return make_custom$0(counter$15, k$0, acc$0, rest$23, arity, _dB_);
     }
    }
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dt_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
   ...
   function neighbours(cf, param$1){
    ...
    function p(param){
     var j = param[2], i = param[1], _cO_ = 0 <= i ? 1 : 0;
     if(_cO_){
      var _cP_ = i < cf[1] ? 1 : 0;
      if(_cP_)
   ...
   function run(board_div, nb_c, nb_r, nb_m){
    ...
    var
     d2 = bytes(b),
     _b__ = get_int64_le(d2, 8),
     _b$_ = get_int64_le(d2, 0),
     _ca_ = get_int64_le(d1, 8);
    set(s$0, get_int64_le(d1, 0), _ca_, _b$_, _b__);
    var
     _ce_ = 0,
     _cf_ = caml_mul(cf[2], cf[1]) - cf[3] | 0,
     _cg_ = 0,
     _ch_ = caml_make_vect(nbr, [0]);
    ...
    for(;;){
      ...
      b:
      {
       ...
       for(;;){
        ...
        var
         l$0 = param$0[2],
         a$0 = param$0[1],
         _b7_ = 0 === caml_compare(a$0, n$0) ? 1 : 0;
        if(_b7_) break b;
        var param$0 = l$0;
       }
       var _cc_ = 0;
     ...
     if(1 - _cc_) cell_list[1] = [0, n$0, cell_list[1]];
    }
    var
     list_mined = cell_list[1],
     _cd_ = cell_init(0),
     board = make_matrix(cf[1], cf[2], _cd_);
    iter_on_cell
     (cf,
      function(param){
       var j = param[2], i = param[1], _cz_ = cell_init(0);
       caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j] = _cz_;
       return 0;
      });
    iter
     (function(n){
       var _cx_ = caml_mod(n, cf[2]), _cy_ = caml_div(n, cf[2]);
       caml_check_bound(caml_check_bound(board, _cy_)[1 + _cy_], _cx_)
         [1 + _cx_]
        [1]
       = 1;
       return 0;
            ...
            var
             ...
             _cv_ =
               caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j]
                [1],
             _cw_ = _cv_ ? (x[1]++, 0) : _cv_;
            return _cw_;
           };
        iter(inc_if_mined, neighbours(cf, [0, i, j]));
        var _cs_ = x[1];
        caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j][4] = _cs_;
        var _cu_ = 0;
       }
       else
        var _cu_ = _ct_;
    ...
    var
     d = [0, board, _ch_, cf, _cg_, _cf_, _ce_],
     mode = [0, 0],
    ...
    if(_cj_ >= 0){
     var y$0 = _ci_;
     for(;;){
      var imgs = [0, 0], _cl_ = d[3][1] - 1 | 0, _ck_ = 0;
      if(_cl_ >= 0){
       var x$0 = _ck_;
       for(;;){
      ...
      if(l2){
       ...
       var _cm_ = [0];
      caml_check_bound(d[2], y$0)[1 + y$0] = _cm_;
      var _cn_ = y$0 + 1 | 0;
      if(_cj_ === y$0) break;
      var y$0 = _cn_;
     }
       ...
       handler
        (function(param){
          try{
           ...
           var _b5_ = caml_wrap_exception(_b6_);
           if(_b5_[1] !== Invalid_argument)
   ...
   function onload(param){
    ...
    function callback(param){
     var div = unsafeCreateElement(document$1, _bR_);
