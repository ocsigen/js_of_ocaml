...
(function(globalThis){
   ...
   function symbol(l1, l2){
    if(! l1) return l2;
    var _d3_ = l1[2], h1 = l1[1];
    if(! _d3_) return [0, h1, l2];
    var match = _d3_[2], h2 = _d3_[1];
    ...
    for(;;){
     if(l1$0){
      var _d4_ = l1$0[2], h1$0 = l1$0[1];
      if(_d4_){
       var match$0 = _d4_[2], h2$0 = _d4_[1];
       if(match$0){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _d1_ = caml_wrap_exception(_d2_);
      if(_d1_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_d1_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function make_matrix(sx, sy, init){
    var res = caml_make_vect(sx, [0]), _dY_ = sx - 1 | 0, _dX_ = 0;
    if(_dY_ >= 0){
     var x = _dX_;
     for(;;){
   ...
   var key_counter = [0, 0], parent_keys = [0, 0], _l_ = "Array.blit";
   ...
   var at_exit_key = new_key(0, function(param, _dW_){return 0;});
   ...
   var
    ...
    _I_ = "%r",
    _J_ = "%_r",
    _K_ = [0, cst_camlinternalFormat_ml, 850, 23],
    _L_ = [0, cst_camlinternalFormat_ml, 837, 26],
    _M_ = [0, cst_camlinternalFormat_ml, 847, 28],
    _N_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _O_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _P_ = [0, cst_camlinternalFormat_ml, 823, 19],
    _Q_ = [0, cst_camlinternalFormat_ml, 827, 22],
    _R_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _S_ = [0, cst_camlinternalFormat_ml, 851, 23],
    _U_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _V_ = [0, cst_camlinternalFormat_ml, 846, 28],
    _W_ = [0, cst_camlinternalFormat_ml, 814, 21],
    _X_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _Y_ = [0, cst_camlinternalFormat_ml, 822, 19],
    _Z_ = [0, cst_camlinternalFormat_ml, 826, 22],
    ___ = [0, cst_camlinternalFormat_ml, 831, 30];
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _dV_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _dV_];
                  case 10:
                   break a;
                  case 11:
                   break b;
   ...
   var
    ...
    _a0_ = "infinity",
    _a1_ = "nan",
    _a2_ = [0, cst_camlinternalFormat_ml, 1558, 4],
    _a3_ = "Printf: bad conversion %[",
    _a4_ = [0, cst_camlinternalFormat_ml, 1626, 39],
    _a5_ = [0, cst_camlinternalFormat_ml, 1649, 31],
    _a6_ = [0, cst_camlinternalFormat_ml, 1650, 31],
    _a7_ = "Printf: bad conversion %_",
    _a8_ = cst,
    _a9_ = cst$0,
    _a__ = cst,
    _a$_ = cst$0;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _dT_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _dT_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dU_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dU_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dU_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _dR_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _dR_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _dS_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _dS_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _dQ_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _dQ_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _dI_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _dH_ = 0;
    if(_dI_ >= 0){
     var i$0 = _dH_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _dK_ = caml_ml_bytes_length(s$0) - 1 | 0, _dJ_ = 0;
     if(_dK_ >= 0){
      var i = _dJ_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_dP_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var
     ...
     _dE_ = caml_ml_string_length(s) - 1 | 0,
     _dD_ = 0;
    if(_dE_ >= 0){
     var i = _dD_;
     for(;;){
   ...
   function convert_float(fconv, prec, x){
    ...
    function caml_special_val(str){
     ...
     return 3 === match ? x < 0. ? _aZ_ : _a0_ : 4 <= match ? _a1_ : str;
    }
    switch(fconv[2]){
      case 5:
       var
   ...
   function make_printf$0(counter, k, acc, fmt){
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 20:
        var rest$19 = fmt$0[3], new_acc = [8, acc$0, _a3_];
     ...
     switch(acc$0[0]){
       ...
       case 1:
        ...
        if(0 === match[0]){
         var acc$1 = match[1];
         output_acc(o, p$0);
         output_string(o, _a8_);
         acc$0 = acc$1;
        }
        else{
         var acc$2 = match[1];
         output_acc(o, p$0);
         output_string(o, _a9_);
         acc$0 = acc$2;
        }
        break;
       case 6:
   ...
   var
    ...
    _ba_ = [0, [3, 0, 0], "%S"],
    _bb_ = "_",
    _bc_ = [0, [4, 0, 0, 0, 0], cst_d],
    _bd_ = cst$1,
    _be_ = [0, [11, ", ", [2, 0, [2, 0, 0]]], ", %s%s"],
    _bf_ = [0, [12, 40, [2, 0, [2, 0, [12, 41, 0]]]], "(%s%s)"],
    _bg_ = cst$1,
    _bh_ = cst$1,
    _bi_ = [0, [12, 40, [2, 0, [12, 41, 0]]], "(%s)"],
    _bj_ = "Out of memory",
    _bk_ = "Stack overflow",
    _bl_ = "Pattern matching failed",
    _bm_ = "Assertion failed",
    _bn_ = "Undefined recursive module",
    _bo_ = "Raised at",
    _bp_ = "Re-raised at",
    _bq_ = "Raised by primitive operation at",
    _br_ = "Called from",
    _bs_ = " (inlined)",
    _bt_ =
      [0,
    ...
    _bu_ = cst$1,
    _bv_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bw_ = [0, [2, 0, [12, 10, 0]], "%s\n"];
   function field(x, i$1){
    var f = x[1 + i$1];
    if(! (1 - (typeof f === "number" ? 1 : 0)))
     return caml_call1(sprintf(_bc_), f);
    if(caml_obj_tag(f) === 252) return caml_call1(sprintf(_ba_), f);
    if(caml_obj_tag(f) !== 253) return _bb_;
    var
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_be_), _di_, _dh_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dd_ = field(e, 1),
       _df_ = caml_call2(sprintf(_bf_), _dd_, _dc_);
     else
      switch(match){
        case 0:
         var _df_ = _bg_; break;
        case 1:
         var _df_ = _bh_; break;
        default:
         var _de_ = field(e, 1), _df_ = caml_call1(sprintf(_bi_), _de_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _c4_ = slot[4],
        _c5_ = slot[3],
        _c6_ = slot[6] ? _bs_ : _bu_,
        _c7_ = slot[2],
        _c8_ = slot[7],
        _c9_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bt_), _c9_, _c8_, _c7_, _c6_, _c5_, _c4_, _c3_)];
      else if(slot[1])
       var match = 0;
      else
       var _c__ = info(0), match = [0, caml_call1(sprintf(_bv_), _c__)];
   ...
   var
    errors =
      [0,
       ...
       (),
    empty_backtrace = [0],
    _bx_ = "Fatal error: out of memory in uncaught exception handler";
    ...
    try{
     try{
      ...
      try{
       ...
       caml_call1(fprintf(stderr, fmt), _cR_);
       ...
       var _cY_ = caml_ml_flush(stderr), _cW_ = _cY_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cU_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _cU_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cV_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _cV_);
      ...
      var _cT_ = caml_wrap_exception(_c0_);
      if(_cT_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cT_, 0);
      var _cX_ = prerr_endline(_bx_);
     }
     return _cX_;
    }
    catch(_cZ_){return 0;}
   ...
   var
    ...
    _bz_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bA_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bB_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bC_ = caml_int64_create_lo_mi_hi(1, 0, 0);
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _by_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bz_) ? i3 : _bC_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bA_) ? i4 : _bB_;
   ...
   var
    _bE_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bF_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bG_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bH_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520);
   function split(s){
    var
     i1 = caml_lxm_next(s),
     i2 = caml_lxm_next(s),
   ...
   function mk_default(param){return mk(_bH_, _bG_, _bF_, _bE_);}
   var
    random_key = new_key([0, split], mk_default),
    Error = [248, "Jsoo_runtime.Error.Exn", caml_fresh_oo_id(0)],
    exn = [0, Error, [0]],
    _bD_ = "Random.int",
    _bK_ = cst_sprites_flag_png,
    _bL_ = cst_sprites_bomb_png,
    _bM_ = "sprites/empty.png",
    _bN_ = cst_sprites_normal_png,
    _bJ_ = [0, 0, 0],
    _bO_ = [0, "examples/minesweeper/main.ml", 39, 74],
    _bP_ = "Number of columns",
    _bQ_ = "Number of rows",
    _bR_ = "Number of mines",
   ...
   function iter_on_cell(cf, f){
    var _cG_ = cf[1] - 1 | 0, _cF_ = 0;
    if(_cG_ >= 0){
     var i = _cF_;
     for(;;){
      var _cI_ = cf[2] - 1 | 0, _cH_ = 0;
      if(_cI_ >= 0){
       var j = _cH_;
       for(;;){
        caml_call1(f, [0, i, j]);
   ...
   function neighbours(cf, param$1){
    ...
    function p(param){
     var j = param[2], i = param[1], _cB_ = 0 <= i ? 1 : 0;
     if(_cB_){
      var _cC_ = i < cf[1] ? 1 : 0;
      if(_cC_)
       var _cD_ = 0 <= j ? 1 : 0, _cE_ = _cD_ ? j < cf[2] ? 1 : 0 : _cD_;
      else
       var _cE_ = _cC_;
     }
     else
   ...
   function draw_cell(dom, bd){
    if(bd[3])
     ...
     if(0 === bd[4])
      ...
      var n = bd[4], s1 = "" + n, s2 = s1 + ".png", _cA_ = "sprites/" + s2;
    else
     var _cA_ = _bN_;
    var t1 = caml_jsstring_of_string(_cA_);
    dom.src = t1;
    return;
   }
   function draw_board(d){
    var _cu_ = d[3][2] - 1 | 0, _ct_ = 0;
    if(_cu_ >= 0){
     var y = _ct_;
     for(;;){
      var _cw_ = d[3][1] - 1 | 0, _cv_ = 0;
      if(_cw_ >= 0){
       var x = _cv_;
       for(;;){
        var
         _cy_ = caml_check_bound(caml_check_bound(d[1], x)[1 + x], y)[1 + y];
        draw_cell
         (caml_check_bound(caml_check_bound(d[2], y)[1 + y], x)[1 + x], _cy_);
        var _cz_ = x + 1 | 0;
        if(_cw_ === x) break;
        x = _cz_;
       }
   ...
   function int_input(name, value){
    ...
    var
     type = [0, "text"],
     input = unsafeCreateElementEx(type, 0, document$1, _bI_),
     n = value[1],
   ...
   function onload(param){
    ...
    appendChild(main, int_input(_bP_, nbr));
    appendChild(main, createElement(document$1, name$0));
    appendChild(main, int_input(_bQ_, nbc));
    appendChild(main, createElement(document$1, name$0));
    appendChild(main, int_input(_bR_, nbm));
    appendChild(main, createElement(document$1, name$0));
    function callback(param$3){
     ...
     var
      d2 = bytes(b),
      _bV_ = get_int64_le(d2, 8),
      _bW_ = get_int64_le(d2, 0),
      _bX_ = get_int64_le(d1, 8);
     set(s$0, get_int64_le(d1, 0), _bX_, _bW_, _bV_);
     ...
     var
      ...
      cell_list = [0, 0],
      _b1_ = 0,
      _b2_ = caml_mul(cf[2], cf[1]) - cf[3] | 0,
      _b3_ = 0,
      _b4_ = caml_make_vect(nbr$0, [0]);
     for(;;){
       ...
       b:
       {
        ...
        for(;;){
         ...
         var
          l$0 = param$0[2],
          a$0 = param$0[1],
          _bS_ = 0 === caml_compare(a$0, x$0) ? 1 : 0;
         if(_bS_) break b;
         param$0 = l$0;
        }
        var _bZ_ = 0;
      ...
      if(1 - _bZ_) cell_list[1] = [0, x$0, cell_list[1]];
     }
     var
      list_mined = cell_list[1],
      _b0_ = cell_init(0),
      board = make_matrix(cf[1], cf[2], _b0_);
     iter_on_cell
      (cf,
       function(param){
        var j = param[2], i = param[1], _ck_ = cell_init(0);
        caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j] = _ck_;
        return 0;
       });
     iter
      (function(n){
        var _ci_ = caml_mod(n, cf[2]), _cj_ = caml_div(n, cf[2]);
        caml_check_bound(caml_check_bound(board, _cj_)[1 + _cj_], _ci_)
          [1 + _ci_]
         [1]
        = 1;
        return 0;
             ...
             var
              ...
              _cg_ =
                caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j]
                 [1],
              _ch_ = _cg_ ? (x[1]++, 0) : _cg_;
             return _ch_;
            };
         iter(inc_if_mined, neighbours(cf, [0, i, j]));
         var _cd_ = x[1];
         caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j][4] = _cd_;
         var _cf_ = 0;
        }
        else
         var _cf_ = _ce_;
     ...
     var
      d = [0, board, _b4_, cf, _b3_, _b2_, _b1_],
      mode = [0, 0],
     ...
     var _b6_ = d[3][2] - 1 | 0, _b5_ = 0;
     if(_b6_ >= 0){
      var y$0 = _b5_;
      for(;;){
       var imgs = [0, 0], _b8_ = d[3][1] - 1 | 0, _b7_ = 0;
       if(_b8_ >= 0){
        var x$2 = _b7_;
        for(;;){
       ...
       if(l2){
        ...
        var _b9_ = [0];
       caml_check_bound(d[2], y$0)[1 + y$0] = _b9_;
       var _b__ = y$0 + 1 | 0;
       if(_b6_ === y$0) break;
       y$0 = _b__;
      }
