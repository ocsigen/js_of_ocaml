...
(function(globalThis){
   ...
   function symbol(l1, l2){
    if(! l1) return l2;
    var _d8_ = l1[2], h1 = l1[1];
    if(! _d8_) return [0, h1, l2];
    var match = _d8_[2], h2 = _d8_[1];
    ...
    for(;;){
     if(l1$0){
      var _d9_ = l1$0[2], h1$0 = l1$0[1];
      if(_d9_){
       var match$0 = _d9_[2], h2$0 = _d9_[1];
       if(match$0){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _d6_ = caml_wrap_exception(_d7_);
      if(_d6_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_d6_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function sub_string(b, ofs, len){
    a:
    {
     ...
     var _d5_ = invalid_arg(_i_);
    }
    return caml_string_of_bytes(_d5_);
   }
   ...
   function make_matrix(sx, sy, init){
    var res = caml_make_vect(sx, [0]), _d3_ = sx - 1 | 0, _d2_ = 0;
    if(_d3_ >= 0){
     var x = _d2_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _d1_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _d0_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _d0_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _dY_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _dY_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dZ_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dZ_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dZ_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _dW_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _dW_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _dX_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _dX_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _dV_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _dV_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dN_ = caml_ml_bytes_length(b) - 1 | 0,
     _dM_ = 0;
    if(_dN_ >= 0){
     var i$0 = _dM_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _dP_ = caml_ml_bytes_length(b) - 1 | 0, _dO_ = 0;
     if(_dP_ >= 0){
      var i = _dO_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dH_ = caml_ml_string_length(s) - 1 | 0, _dG_ = 0;
    if(_dH_ >= 0){
     var i$0 = _dG_;
     for(;;){
    ...
    var
     ...
     _dJ_ = caml_ml_string_length(s) - 1 | 0,
     _dI_ = 0;
    if(_dJ_ >= 0){
     var i = _dI_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dF_ = _ac_; break;
      default: var _dF_ = _al_;
    }
    return transform_int_alt(iconv, caml_format_int(_dF_, n));
   }
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dE_ = _aC_; break;
      default: var _dE_ = _aL_;
    }
    return transform_int_alt(iconv, caml_format_int(_dE_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dD_ = _aP_; break;
      default: var _dD_ = _aY_;
    }
    return transform_int_alt(iconv, caml_format_int(_dD_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dC_ = _ap_; break;
      default: var _dC_ = _ay_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dC_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dz_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dz_ >>> 0){
           if(55 === _dz_) break a;
          }
          else if(21 < _dz_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dB_ = _dA_ ? str : str + cst$2;
        return caml_special_val(_dB_);
       }
      case 6:
       return hex(0);
      case 7:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dr_ = fmt$0[1];
        if(0 === _dr_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dr_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dr_[1][1];
   ...
   function other_fields(x, i){
    ...
    var _dm_ = other_fields(x, i + 1 | 0), _dn_ = field(x, i);
    return caml_call2(sprintf(_be_), _dn_, _dm_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dl_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _dh_ = other_fields(e, 2),
       _di_ = field(e, 1),
       _dk_ = caml_call2(sprintf(_bf_), _di_, _dh_);
     else
      switch(match){
        case 0:
         var _dk_ = _bg_; break;
        case 1:
         var _dk_ = _bh_; break;
        default:
         var _dj_ = field(e, 1), _dk_ = caml_call1(sprintf(_bi_), _dj_);
      }
     var match$0 = [0, constructor, [0, _dk_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _c9_ = slot[4],
        _c__ = slot[3],
        _c$_ = slot[6] ? _bs_ : _bu_,
        _da_ = slot[2],
        _db_ = slot[7],
        _dc_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bt_), _dc_, _db_, _da_, _c$_, _c__, _c9_, _c8_)];
      else if(slot[1])
       var match = 0;
      else
       var _dd_ = info(0), match = [0, caml_call1(sprintf(_bv_), _dd_)];
   ...
   var
    ...
    _by_ = "Fatal error: out of memory in uncaught exception handler",
    _bz_ =
      [0,
       [11, cst_Fatal_error_exception, [2, 0, [12, 10, 0]]],
       cst_Fatal_error_exception_s],
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_c6_){}
      try{
       var _cW_ = to_string(exn$0);
       caml_call1(eprintf(_bx_), _cW_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cX_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cX_)[1 + _cX_]);
       }
       var _cY_ = caml_ml_flush(stderr), _c2_ = _cY_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _c0_ = to_string(exn$0);
       caml_call1(eprintf(_bz_), _c0_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _c1_ = to_string(exn);
       caml_call1(eprintf(_bA_), _c1_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _c2_ = caml_ml_flush(stderr);
      }
      var _c3_ = _c2_;
     }
     catch(_c5_){
      var _cZ_ = caml_wrap_exception(_c5_);
      if(_cZ_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cZ_, 0);
      var _c3_ = prerr_endline(_by_);
     }
     return _c3_;
    }
    catch(_c4_){return 0;}
   ...
   var
    _bB_ = caml_int64_create_lo_mi_hi(1, 0, 0),
    _bC_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bD_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bE_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bF_ = caml_int64_create_lo_mi_hi(1, 0, 0);
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bB_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bC_) ? i3 : _bF_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bD_) ? i4 : _bE_;
   ...
   var
    _bH_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bI_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bJ_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bK_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520);
   function split(s){
    var
     i1 = caml_lxm_next(s),
     i2 = caml_lxm_next(s),
   ...
   function mk_default(param){return mk(_bK_, _bJ_, _bI_, _bH_);}
   var
   ...
   function createInput(type, name, doc){
    for(;;){
     ...
     if(785140586 !== _cQ_) break;
     try{
      var
       t49 = document.createElement('<input name="x">'),
       _cT_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
   ...
   function createBr(doc){return unsafeCreateElement(doc, _bM_);}
   function createImg(doc){return unsafeCreateElement(doc, _bN_);}
     ...
     _cF_ =
       bd[3]
        ...
        : bd
          ...
          : bd
             [2]
            ? 0 === bd[4] ? _bR_ : "sprites/" + "" + bd[4] + ".png"
            : _bS_,
     t1 = caml_jsstring_of_string(_cF_);
    dom.src = t1;
    return;
   }
   ...
   function run(board_div, nb_c, nb_r, nb_m){
    var
     nbc = max(default_config[1], nb_c),
     nbr = max(default_config[2], nb_r),
     y = max(1, nb_m),
     x = caml_mul(nbc, nbr),
     nbm = caml_lessequal(x, y) ? x : y,
     cf = [0, nbc, nbr, nbm],
     t$0 = caml_sys_time(0),
     n$1 = t$0 * 1000. | 0,
     seed$0 = n$1 % 100000 | 0,
    ...
    var
     d2 = bytes(b),
     _b2_ = get_int64_le(d2, 8),
     _b3_ = get_int64_le(d2, 0),
     _b4_ = get_int64_le(d1, 8);
    set(s$0, get_int64_le(d1, 0), _b4_, _b3_, _b2_);
    ...
    var
     ...
     cell_list = [0, 0],
     _b8_ = 0,
     _b9_ = caml_mul(cf[2], cf[1]) - cf[3] | 0,
     _b__ = 0,
     _b$_ = caml_make_vect(nbr, [0]);
    for(;;){
      ...
      b:
      {
       ...
       for(;;){
        ...
        var
         l$0 = param$0[2],
         a$0 = param$0[1],
         _bZ_ = 0 === caml_compare(a$0, n$0) ? 1 : 0;
        if(_bZ_) break b;
        param$0 = l$0;
       }
       var _b6_ = 0;
     ...
     if(1 - _b6_) cell_list[1] = [0, n$0, cell_list[1]];
    }
    var
     list_mined = cell_list[1],
     _b7_ = cell_init(0),
     board = make_matrix(cf[1], cf[2], _b7_);
    iter_on_cell
     (cf,
      function(param){
       var j = param[2], i = param[1], _cr_ = cell_init(0);
       caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j] = _cr_;
       return 0;
      });
    iter
     (function(n){
       var _cp_ = caml_mod(n, cf[2]), _cq_ = caml_div(n, cf[2]);
       caml_check_bound(caml_check_bound(board, _cq_)[1 + _cq_], _cp_)
         [1 + _cp_]
        [1]
       = 1;
       return 0;
     ...
     (cf,
      function(param){
       var
        ...
        i = param[1],
        _cl_ =
          1 - caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j][1];
       if(_cl_){
        var
         x = [0, 0],
         inc_if_mined =
            ...
            var
             ...
             _cn_ =
               caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j]
                [1],
             _co_ = _cn_ ? (x[1]++, 0) : _cn_;
            return _co_;
           };
        iter(inc_if_mined, neighbours(cf, [0, i, j]));
        var _ck_ = x[1];
        caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j][4] = _ck_;
        var _cm_ = 0;
       }
       else
        var _cm_ = _cl_;
    ...
    var
     d = [0, board, _b$_, cf, _b__, _b9_, _b8_],
     mode = [0, 0],
    ...
    if(_cb_ >= 0){
     var y$0 = _ca_;
     for(;;){
      var imgs = [0, 0], _cd_ = d[3][1] - 1 | 0, _cc_ = 0;
      if(_cd_ >= 0){
       var x$0 = _cc_;
       for(;;){
                ...
                _ci_ =
                  ...
                  -
                   caml_check_bound(caml_check_bound(d[1], x)[1 + x], y)[1 + y]
                    [3];
               caml_check_bound(caml_check_bound(d[1], x)[1 + x], y)[1 + y][3]
               = _ci_;
               draw_cell
                (img,
                 caml_check_bound(caml_check_bound(d[1], x)[1 + x], y)[1 + y]);
      ...
      if(l2){
       ...
       var _ce_ = [0];
      caml_check_bound(d[2], y$0)[1 + y$0] = _ce_;
      var _cf_ = y$0 + 1 | 0;
      if(_cb_ === y$0) break;
      y$0 = _cf_;
     }
    ...
    t28.lineHeight = "0";
    return appendChild(board_div, buf);
   }
       ...
       handler
        (function(param){
          try{
           ...
           var _bX_ = caml_wrap_exception(_bY_);
           if(_bX_[1] !== Invalid_argument)
   ...
   function onload(param){
    ...
    function callback(param){
     var div = unsafeCreateElement(document$1, _bL_);
