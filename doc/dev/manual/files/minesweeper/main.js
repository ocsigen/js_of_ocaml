...
(function(globalThis){
   ...
   function symbol$0(l1, l2){
    if(! l1) return l2;
    var _eb_ = l1[2], h1 = l1[1];
    if(! _eb_) return [0, h1, l2];
    var match = _eb_[2], h2 = _eb_[1];
    ...
    for(;;){
     if(l1$0){
      var _ec_ = l1$0[2], h1$0 = l1$0[1];
      if(_ec_){
       var match$0 = _ec_[2], h2$0 = _ec_[1];
       if(match$0){
   ...
   function sub_string(b, ofs, len){
    a:
    {
     ...
     var _d__ = invalid_arg(_j_);
    }
    return caml_string_of_bytes(_d__);
   }
   ...
   function make_matrix(sx, sy, init){
    var res = caml_make_vect(sx, [0]), _d8_ = sx - 1 | 0, _d7_ = 0;
    if(_d8_ >= 0){
     var x = _d7_;
     for(;;){
   ...
   var key_counter = [0, 0], parent_keys = [0, 0], _m_ = "Array.blit";
   ...
   var at_exit_key = new_key(0, function(param, _d6_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _d5_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _d5_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _d3_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _d3_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _d4_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _d4_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _d4_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _d1_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _d1_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _d2_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _d2_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _d0_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _d0_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dS_ = caml_ml_bytes_length(b) - 1 | 0,
     _dR_ = 0;
    if(_dS_ >= 0){
     var i$0 = _dR_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _dU_ = caml_ml_bytes_length(b) - 1 | 0, _dT_ = 0;
     if(_dU_ >= 0){
      var i = _dT_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var
     ...
     _dO_ = caml_ml_string_length(s) - 1 | 0,
     _dN_ = 0;
    if(_dO_ >= 0){
     var i = _dN_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dH_ = _ar_; break;
      default: var _dH_ = _aA_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dH_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dE_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dE_ >>> 0){
           if(55 === _dE_) break a;
          }
          else if(21 < _dE_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _dF_ = 1;
        }
        var _dG_ = _dF_ ? str : symbol(str, _a1_);
        return caml_special_val(_dG_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dA_ = l - 1 | 0, _dz_ = 0;
        if(_dA_ >= 0){
         var i = _dz_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dB_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dB_);
          var _dC_ = i + 1 | 0;
          if(_dA_ === i) break;
          var i = _dC_;
         }
       ...
       return caml_string_of_bytes(_dD_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _dy_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _dy_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _dy_[1];
       ...
       case 18:
        var _dw_ = fmt$0[1];
        if(0 === _dw_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dw_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dw_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dx_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dx_);
     }
    }
   }
   ...
   var
    ...
    _bx_ = cst$2,
    _by_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bz_ = [0, [2, 0, [12, 10, 0]], "%s\n"];
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bh_), _ds_, _dr_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dn_ = field(e, 1),
       _dp_ = caml_call2(sprintf(_bi_), _dn_, _dm_);
     else
      switch(match){
        case 0:
         var _dp_ = _bj_; break;
        case 1:
         var _dp_ = _bk_; break;
        default:
         var _do_ = field(e, 1), _dp_ = caml_call1(sprintf(_bl_), _do_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dc_ = slot[4],
        _dd_ = slot[3],
        _de_ = slot[6] ? _bv_ : _bx_,
        _df_ = slot[2],
        _dg_ = slot[7],
        _dh_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bw_), _dh_, _dg_, _df_, _de_, _dd_, _dc_, _db_)];
      else if(slot[1])
       var match = 0;
      else
       var _di_ = info(0), match = [0, caml_call1(sprintf(_by_), _di_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_c$_){}
      try{
       var _c1_ = to_string(exn$0);
       ...
       var _c3_ = caml_ml_flush(stderr), _c7_ = _c3_;
      }
      catch(exn$1){
       var
       ...
       caml_call1(eprintf(_bC_), _c5_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _c6_ = to_string(exn);
       caml_call1(eprintf(_bD_), _c6_);
   ...
   var
    _bK_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bL_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bM_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bN_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520);
   function split(s){
    var
     i1 = caml_lxm_next(s),
     i2 = caml_lxm_next(s),
   ...
   function mk_default(param){return mk(_bN_, _bM_, _bL_, _bK_);}
   var
    ...
    _bP_ = "br",
    _bO_ = "div",
    _bS_ = cst_sprites_flag_png,
    _bT_ = cst_sprites_bomb_png,
    _bU_ = "sprites/empty.png",
    _bV_ = ".png",
    _bW_ = "sprites/",
    _bX_ = cst_sprites_normal_png,
    _bR_ = [0, 0, 0],
    _bY_ = [0, "examples/minesweeper/main.ml", 39, 74],
    _bZ_ = "Number of columns",
    _b0_ = "Number of rows",
    _b1_ = "Number of mines",
   ...
   function createInput(type, name, doc){
    for(;;){
     ...
     var _cV_ = createElementSyntax[1];
     if(785140586 !== _cV_) break;
     try{
      var
       t49 = document.createElement('<input name="x">'),
       _cY_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _cZ_ = _cY_ ? t49.name == "x" ? 1 : 0 : _cY_,
       _cW_ = _cZ_;
     }
     catch(_c0_){var _cW_ = 0;}
     var _cX_ = _cW_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _cX_;
    }
    if(982028505 <= _cV_){
   ...
   function iter_on_cell(cf, f){
    var _cQ_ = cf[1] - 1 | 0, _cP_ = 0;
    if(_cQ_ >= 0){
     var i = _cP_;
     for(;;){
      var _cS_ = cf[2] - 1 | 0, _cR_ = 0;
      if(_cS_ >= 0){
       var j = _cR_;
       for(;;){
        caml_call1(f, [0, i, j]);
   ...
   function neighbours(cf, param$1){
    ...
    function p(param){
     var j = param[2], i = param[1], _cL_ = 0 <= i ? 1 : 0;
     if(_cL_){
      var _cM_ = i < cf[1] ? 1 : 0;
      if(_cM_)
       var _cN_ = 0 <= j ? 1 : 0, _cO_ = _cN_ ? j < cf[2] ? 1 : 0 : _cN_;
      else
       var _cO_ = _cM_;
     }
     else
     ...
     _cK_ =
       bd[3]
        ...
        : bd
          ...
          : bd
             [2]
            ? 0 === bd[4] ? _bU_ : symbol(_bW_, symbol("" + bd[4], _bV_))
            : _bX_,
     t1 = caml_jsstring_of_string(_cK_);
    dom.src = t1;
    return;
   }
   function draw_board(d){
    var _cE_ = d[3][2] - 1 | 0, _cD_ = 0;
    if(_cE_ >= 0){
     var y = _cD_;
     for(;;){
      var _cG_ = d[3][1] - 1 | 0, _cF_ = 0;
      if(_cG_ >= 0){
       var x = _cF_;
       for(;;){
        var
         _cI_ = caml_check_bound(caml_check_bound(d[1], x)[1 + x], y)[1 + y];
        draw_cell
         (caml_check_bound(caml_check_bound(d[2], y)[1 + y], x)[1 + x], _cI_);
        var _cJ_ = x + 1 | 0;
        if(_cG_ === x) break;
        var x = _cJ_;
       }
   ...
   function disable_events(d){
    var _cy_ = d[3][2] - 1 | 0, _cx_ = 0;
    if(_cy_ >= 0){
     var y = _cx_;
     for(;;){
      var _cA_ = d[3][1] - 1 | 0, _cz_ = 0;
      if(_cA_ >= 0){
       var x = _cz_;
       for(;;){
        var
   ...
   function run(board_div, nb_c, nb_r, nb_m){
    ...
    var
     d2 = bytes(b),
     _b7_ = get_int64_le(d2, 8),
     _b8_ = get_int64_le(d2, 0),
     _b9_ = get_int64_le(d1, 8);
    set(s$0, get_int64_le(d1, 0), _b9_, _b8_, _b7_);
    ...
    var
     ...
     cell_list = [0, 0],
     _cb_ = 0,
     _cc_ = caml_mul(cf[2], cf[1]) - cf[3] | 0,
     _cd_ = 0,
     _ce_ = caml_make_vect(nbr, [0]);
    for(;;){
      ...
      b:
      {
       ...
       for(;;){
        ...
        var
         l$0 = param$0[2],
         a$0 = param$0[1],
         _b4_ = 0 === caml_compare(a$0, n$0) ? 1 : 0;
        if(_b4_) break b;
        var param$0 = l$0;
       }
       var _b$_ = 0;
     ...
     if(1 - _b$_) cell_list[1] = [0, n$0, cell_list[1]];
    }
    var
     list_mined = cell_list[1],
     _ca_ = cell_init(0),
     board = make_matrix(cf[1], cf[2], _ca_);
    iter_on_cell
     (cf,
      function(param){
       var j = param[2], i = param[1], _cw_ = cell_init(0);
       caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j] = _cw_;
       return 0;
      });
    iter
     (function(n){
       var _cu_ = caml_mod(n, cf[2]), _cv_ = caml_div(n, cf[2]);
       caml_check_bound(caml_check_bound(board, _cv_)[1 + _cv_], _cu_)
         [1 + _cu_]
        [1]
       = 1;
       return 0;
            ...
            var
             ...
             _cs_ =
               caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j]
                [1],
             _ct_ = _cs_ ? (x[1]++, 0) : _cs_;
            return _ct_;
           };
        iter(inc_if_mined, neighbours(cf, [0, i, j]));
        var _cp_ = x[1];
        caml_check_bound(caml_check_bound(board, i)[1 + i], j)[1 + j][4] = _cp_;
        var _cr_ = 0;
       }
       else
        var _cr_ = _cq_;
    ...
    var
     d = [0, board, _ce_, cf, _cd_, _cc_, _cb_],
     mode = [0, 0],
    ...
    var _cg_ = d[3][2] - 1 | 0, _cf_ = 0;
    if(_cg_ >= 0){
     var y$0 = _cf_;
     for(;;){
      var imgs = [0, 0], _ci_ = d[3][1] - 1 | 0, _ch_ = 0;
      if(_ci_ >= 0){
       var x$0 = _ch_;
       for(;;){
      ...
      if(l2){
       ...
       for(;;){
        if(! param$1) break;
        var t = param$1[2], accu$0 = accu + 1 | 0, accu = accu$0, param$1 = t;
       }
       ...
       var _cj_ = [0];
      caml_check_bound(d[2], y$0)[1 + y$0] = _cj_;
      var _ck_ = y$0 + 1 | 0;
      if(_cg_ === y$0) break;
      var y$0 = _ck_;
     }
       ...
       handler
        (function(param){
          try{
           ...
           var _b2_ = caml_wrap_exception(_b3_);
           if(_b2_[1] !== Invalid_argument)
            throw caml_maybe_attach_backtrace(_b2_, 0);
          }
   ...
   function onload(param){
    ...
    function callback(param){
     var div = unsafeCreateElement(document$1, _bO_);
