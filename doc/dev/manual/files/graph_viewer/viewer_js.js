...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gy_ = caml_wrap_exception(_gz_);
      if(_gy_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gy_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _gx_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_gx_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   function iteri(f, a){
    var _gv_ = a.length - 1 - 1 | 0, _gu_ = 0;
    if(_gv_ >= 0){
     var i = _gu_;
     for(;;){
   ...
   function _x_(Ord){
    ...
    function create(l, x, d, r){
     var
      hl = height(l),
      hr = height(r),
      _gt_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
     return [0, l, x, d, r, _gt_];
    }
    function bal(l, x, d, r){
     ...
     if((hr + 2 | 0) < hl){
      ...
      var lr = l[4], ld = l[3], lv = l[2], ll = l[1], _go_ = height(lr);
      if(_go_ <= height(ll)) return create(ll, lv, ld, create(lr, x, d, r));
      ...
      var
       ...
       lrv = lr[2],
       lrl = lr[1],
       _gp_ = create(lrr, x, d, r);
      return create(create(ll, lv, ld, lrl), lrv, lrd, _gp_);
     }
     if((hl + 2 | 0) >= hr){
      var _gs_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
      return [0, l, x, d, r, _gs_];
     }
     if(! r) return invalid_arg(_w_);
     var rr = r[4], rd = r[3], rv = r[2], rl = r[1], _gq_ = height(rl);
     if(_gq_ <= height(rr)) return create(create(l, x, d, rl), rv, rd, rr);
     ...
     var
      ...
      rlv = rl[2],
      rll = rl[1],
      _gr_ = create(rlr, rv, rd, rr);
     return create(create(l, x, d, rll), rlv, rld, _gr_);
    }
    var empty = 0;
   ...
   var at_exit_key = new_key(0, function(param, _gn_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _gm_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _gm_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _gk_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _gk_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gl_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gl_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gl_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _f$_ = caml_ml_bytes_length(b) - 1 | 0,
     _f__ = 0;
    if(_f$_ >= 0){
     var i$0 = _f__;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _gb_ = caml_ml_bytes_length(b) - 1 | 0, _ga_ = 0;
     if(_gb_ >= 0){
      var i = _ga_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fX_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fX_ >>> 0){
           if(55 === _fX_) break a;
          }
          else if(21 < _fX_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _fY_ = 1;
        }
        var _fZ_ = _fY_ ? str : symbol(str, _bc_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _fQ_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _fQ_);
     }
    }
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _fL_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bu_), _fK_, _fJ_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_fI_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _fF_ = field(e, 1),
       _fH_ = caml_call2(sprintf(_bv_), _fF_, _fE_);
     else
      switch(match){
        case 0:
         var _fH_ = _bw_; break;
        case 1:
         var _fH_ = _bx_; break;
        default:
         var _fG_ = field(e, 1), _fH_ = caml_call1(sprintf(_by_), _fG_);
      }
     var match$0 = [0, constructor, [0, _fH_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _fu_ = slot[4],
        _fv_ = slot[3],
        _fw_ = slot[6] ? _bI_ : _bK_,
        _fx_ = slot[2],
        _fy_ = slot[7],
        _fz_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bJ_), _fz_, _fy_, _fx_, _fw_, _fv_, _fu_, _ft_)];
      else if(slot[1])
       var match = 0;
      else
       var _fA_ = info(0), match = [0, caml_call1(sprintf(_bL_), _fA_)];
    ...
    try{
     try{
      ...
      try{
       ...
       var _fj_ = caml_ml_flush(stderr), _fn_ = _fj_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _fl_ = to_string(exn$0);
       caml_call1(eprintf(_bQ_), _fl_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fm_ = to_string(exn);
       caml_call1(eprintf(_bR_), _fm_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _fn_ = caml_ml_flush(stderr);
      }
      var _fo_ = _fn_;
     }
     catch(_fq_){
      var _fk_ = caml_wrap_exception(_fq_);
      if(_fk_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_fk_, 0);
      var _fo_ = prerr_endline(_bP_);
     }
     return _fo_;
    }
    catch(_fp_){return 0;}
   ...
   function public_method_label(s){
    var accu = [0, 0], _fe_ = caml_ml_string_length(s) - 1 | 0, _fd_ = 0;
    if(_fe_ >= 0){
     var i = _fd_;
     for(;;){
      var _ff_ = caml_string_get(s, i);
      accu[1] = (223 * accu[1] | 0) + _ff_ | 0;
      var _fg_ = i + 1 | 0;
      if(_fe_ === i) break;
      var i = _fg_;
     }
   ...
   function new_table(pub_labels){
    ...
    var _e9_ = ((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
    caml_check_bound(methods, 1)[2] = _e9_;
    var _e$_ = len - 1 | 0, _e__ = 0;
    if(_e$_ >= 0){
     var i = _e__;
     for(;;){
      var
       _fb_ = (i * 2 | 0) + 3 | 0,
       _fa_ = caml_check_bound(pub_labels, i)[1 + i];
      caml_check_bound(methods, _fb_)[1 + _fb_] = _fa_;
      var _fc_ = i + 1 | 0;
      if(_e$_ === i) break;
      var i = _fc_;
     }
   ...
   function addEventListenerWithOptions(t28, typ, capture, once, passive, h){
    ...
    function callback(e){
     var _e6_ = [0, h, e, [0]];
     return function(_e7_, _e8_){return caml_js_call(_e6_, _e7_, _e8_);};
    }
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _e5_){return 0;},
     t41 = function(param, _e4_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _co_ = caml_wrap_exception(_e3_);
   ...
   function aux(ofs){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= ofs && l >= ofs){
       var _e1_ = index_rec(path_string, l, ofs, c);
       break a;
      }
      var _e1_ = invalid_arg(_o_);
     }
     var j = _e1_;
    }
    catch(_e2_){
     var _e0_ = caml_wrap_exception(_e2_);
           ...
           function(s){
            ...
            function _eY_(param){
             var
              y = param[2],
              x = param[1],
              _eZ_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _eZ_];
            }
            if(0 <= index)
             var
              _eW_ = s.slice(index + 1 | 0),
              _eX_ = [0, s.slice(0, index), _eW_];
            else
             var _eX_ = undefined$0;
            return case$1(_eX_, interrupt, _eY_);
           }),
         acc],
        _eU_);
      return;
   ...
   (opt,
    ...
    if(_es_) var sth$0 = _es_[1], get_args = sth$0; else var get_args = 0;
    if(_er_)
     var sth$1 = _er_[1], check_headers = sth$1;
    else
     var check_headers = function(param, _eN_){return 1;};
    if(contents){
     var c$0 = contents[1], _et_ = c$0[1];
     if(440620227 === _et_){
      var args = c$0[2];
      a:
      {
       b:
       {
        ...
        for(;;){
         if(! param) break;
         var l = param[2], a = param[1], _eu_ = a[2];
         c:
         {
          if(typeof _eu_ !== "number" && -976970511 === _eu_[1]){var _en_ = 1; break c;}
          var _en_ = 0;
         }
         if(! _en_) break b;
         var param = l;
      ...
      if(only_strings)
       ...
       if(match)
        var constr = match[1], _ev_ = [0, 808620462, new constr];
       else
        var _ev_ = [0, 891486873, [0, 0]];
       var form_contents = _ev_;
      }
      iter
       (function(param){
         var
        ...
        args);
      var _ew_ = [0, -836918635, form_contents];
     }
     else if(737307005 <= _et_)
      var b = c$0[2], _ew_ = [0, 737307005, b];
     else
      var _ew_ = c$0;
     var contents$0 = [0, _ew_];
    }
    else
     var contents$0 = 0;
          ...
          map
           (function(param){
             var
              v = param[2],
              n = param[1],
              _eM_ = symbol(_cm_, urlencode(0, v));
             return symbol(urlencode(0, n), _eM_);
            },
            get_args));
     try{
      index_rec(url, caml_ml_string_length(url), 0, 63);
      var _eq_ = 1, _ey_ = _eq_;
     }
     catch(_eL_){
      var _ep_ = caml_wrap_exception(_eL_);
      if(_ep_ !== Not_found) throw caml_maybe_attach_backtrace(_ep_, 0);
      var _ey_ = 0;
     }
     var _ez_ = _ey_ ? _cU_ : _cV_, url$0 = symbol(url, symbol(_ez_, _eo_));
    }
    var
     match$1 = task(0),
     w = match$1[2],
             ...
             switch(response_type){
               case 0:
                var
                 ...
                 _eJ_ = e$1 instanceof arrayBuffer ? e$1 : no_handler,
                 response = [0, url$0, code, headers$0, _eJ_, _eI_];
                break;
               case 1:
                var
                 code$0 = req.status,
                 ...
                 _eH_ = e$0 instanceof blob_constr ? e$0 : no_handler,
                 response = [0, url$0, code$0, headers$0, _eH_, _eG_];
                break;
               case 2:
                var
                 code$1 = req.status,
                 ...
                 _eF_ = e instanceof doc_constr ? e : no_handler,
                 response = [0, url$0, code$1, headers$0, _eF_, _eE_];
                break;
               case 3:
                var
                 code$2 = req.status,
                ...
                var
                 ...
                 response =
                   [0,
                    ...
                    headers$0,
                    case$0
                     (req.responseText, function(param){return _cG_;}, _eD_),
                    _eC_];
             }
    ...
    if(contents$0){
     var match$2 = contents$0[1], _ex_ = match$2[1];
     if(-836918635 === _ex_){
             ...
             map
              (function(param){
                ...
                if(781515420 <= match[1]){
                 ...
                 return symbol(urlencode(0, name), _eA_);
                }
                var
                 s = match[2],
                 _eB_ = symbol(_cD_, urlencode(0, caml_string_of_jsstring(s)));
                return symbol(urlencode(0, name), _eB_);
               },
               l$1))));
      }
      else{var f = match$3[2]; req.send(f);}
     }
     else if(737307005 <= _ex_){
      var b$0 = match$2[2];
      req.send(b$0);
     }
   ...
   function put_pixmap(param, x, y, xsrc, ysrc, width, height, _em_){
    var p = _em_[1], c = param[2];
   ...
   function _c1_(st, scale, x$2, y$2, x$1, y$1, w, h){
    ...
    ctx.save();
    var
     _eh_ = 0 === st[1].length - 1 ? 1 : 0,
     _ei_ = _eh_ ? 0 < st[2].length - 1 ? 1 : 0 : _eh_;
    if(_ei_) throw caml_maybe_attach_backtrace([0, Assert_failure, _c7_], 1);
    ctx.beginPath();
    ...
    if(_ek_ >= 0){
     ...
     for(;;){
      var
       ...
       _ed_ = x1$0 <= x4 ? 1 : 0;
      if(_ed_){
       var _ee_ = y1$0 <= y4 ? 1 : 0;
       if(_ee_)
        var
         _ef_ = x3$0 <= x2$0 ? 1 : 0,
         _eg_ = _ef_ ? y3$0 <= y2$0 ? 1 : 0 : _ef_;
       else
        var _eg_ = _ee_;
      }
      else
   ...
   function redraw(st, scale, x0, y0, window, a, x, y, width$0, height$0){
    ...
    a:
    {
     b:
     {
      ...
      var
       ...
       _d__ = 0 !== dx ? 1 : 0,
       _d$_ = _d__ || (0 !== dy ? 1 : 0);
      if(_d$_) put_pixmap(p, dx, dy, 0, 0, r$2[3], r$2[4], p);
      var
       offset =
         function(p, l, d, m){
          return 0 < ((p + d | 0) + l | 0)
    ...
    if(_d5_)
     ...
     if(_d8_)
      ...
      var
       _d9_ = r$0[3] < (x + width$0 | 0) ? 1 : 0,
       _d6_ = _d9_ || (r$0[4] < (y + height$0 | 0) ? 1 : 0);
    }
    if(_d6_){
     _c1_(st, scale, x0$2, y0$2, 0, 0, a[3], a[4]);
     pm[4] = [0, x0$2, y0$2, a[3], a[4]];
    }
    var _d7_ = get_pixmap(pm);
    return put_pixmap
            (get_drawable(window), x, y, x, y, width$0, height$0, _d7_);
   }
   var json = JSON;
   if(0 === public_methods)
   ...
   if(_b6_ >= 0){
    ...
    for(;;){
     ...
     try{var _b2_ = Meths[17].call(null, name$0, table$0[3]), _ca_ = _b2_;}
      ...
      var _b1_ = caml_wrap_exception(_d0_);
   ...
   if(_b8_ >= 0){
    ...
    for(;;){
     ...
     try{var _b4_ = Vars[17].call(null, name, table$0[7]), _b9_ = _b4_;}
      ...
      var _b3_ = caml_wrap_exception(_dZ_);
    ...
    var
     ...
     next =
       function(param){
        i$2[1]++;
        var _dY_ = i$2[1];
        return caml_check_bound(methods, _dY_)[1 + _dY_];
       },
     clo = next(0);
     ...
     switch(clo){
       ...
       case 19:
        ...
        var
         element =
           function(obj){
            var _dX_ = caml_call1(obj[1][1 + m$10], obj);
            return caml_call2(obj[1][1 + n$22], obj, _dX_);
           };
        break;
       case 20:
       ...
       case 21:
        ...
        var
         element =
           function(obj){
            var _dW_ = obj[1 + n$21];
            return caml_call1(caml_get_public_method(_dW_, m$8, 0), _dW_);
           };
        break;
       case 22:
        ...
        var
         element =
           function(obj){
            var _dV_ = obj[1 + e$5][1 + n$20];
            return caml_call1(caml_get_public_method(_dV_, m$7, 0), _dV_);
           };
        break;
       default:
        ...
        var
         element =
           function(obj){
            var _dU_ = caml_call1(obj[1][1 + n$19], obj);
            return caml_call1(caml_get_public_method(_dU_, m$6, 0), _dU_);
           };
     }
    else
     var element = clo;
      ...
      return function(opt){
       ...
       return function(opt){
        ...
        return function(opt){
         ...
         return function(_dS_){
          if(obj_0)
           var _dT_ = obj_0;
          else{
           var obj = caml_obj_block(248, table$0[1]);
           obj[1] = table$0[2];
           var _dT_ = caml_set_oo_id(obj);
          }
          _dT_[1 + _de_] = sth$0;
          _dT_[1 + _df_] = sth$1;
          _dT_[1 + _dg_] = sth$2;
    ...
    t185 =
      handler
       (function(param){
         ...
         function loop(d, param){
          ...
          var
           cb =
             remain == 0.
              ? callback
              : function(_dQ_){return loop(remain, _dQ_);};
         ...
         function _dt_(s){
          var
           _dw_ = json.parse(caml_jsstring_of_string(s)),
           scene = _dw_[3],
           bboxes = _dw_[2],
           match = _dw_[1],
           y2 = match[4],
          ...
          handle_drag
           (canvas,
            function(dx, dy){
             ...
             function offset(a, d){
              var
               _dE_ = caml_call1(caml_get_public_method(a, 307110897, 423), a),
               _dF_ =
          ...
          addEventListenerWithOptions
           (canvas,
            ...
            handler
             (function(t176){
               get(t176.wheelDeltaX, function(param){return 0;});
               var
                dy =
                  (-
                  get
                   (t176.wheelDeltaY, function(param){return t176.wheelDelta;})
                  | 0)
                  / 40
                  | 0,
         ...
         try{
          var
           _dr_ = return$0(caml_read_file_content(cst_scene_json)),
           _du_ = _dr_;
         }
         catch(_dv_){
          var _dq_ = caml_wrap_exception(_dv_);
          if(_dq_ !== Not_found) throw caml_maybe_attach_backtrace(_dq_, 0);
          var
           _du_ =
             symbol_bind
