...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ga_ = caml_wrap_exception(_gb_);
      if(_ga_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ga_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _f$_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_f$_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   function _w_(Ord){
    ...
    function create(l, x, d, r){
     var
      hl = height(l),
      hr = height(r),
      _f7_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
     return [0, l, x, d, r, _f7_];
    }
    function bal(l, x, d, r){
     ...
     if((hr + 2 | 0) < hl){
      ...
      var lr = l[4], ld = l[3], lv = l[2], ll = l[1], _f2_ = height(lr);
      if(_f2_ <= height(ll)) return create(ll, lv, ld, create(lr, x, d, r));
      ...
      var
       ...
       lrv = lr[2],
       lrl = lr[1],
       _f3_ = create(lrr, x, d, r);
      return create(create(ll, lv, ld, lrl), lrv, lrd, _f3_);
     }
     if((hl + 2 | 0) >= hr){
      var _f6_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
      return [0, l, x, d, r, _f6_];
     }
     if(! r) return invalid_arg(_v_);
     var rr = r[4], rd = r[3], rv = r[2], rl = r[1], _f4_ = height(rl);
     if(_f4_ <= height(rr)) return create(create(l, x, d, rl), rv, rd, rr);
     ...
     var
      ...
      rlv = rl[2],
      rll = rl[1],
      _f5_ = create(rlr, rv, rd, rr);
     return create(create(l, x, d, rll), rlv, rld, _f5_);
    }
   ...
   var at_exit_key = new_key(0, function(param, _f1_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _f0_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _f0_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fZ_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fZ_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fZ_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _fN_ = caml_ml_bytes_length(b) - 1 | 0,
     _fM_ = 0;
    if(_fN_ >= 0){
     var i$0 = _fM_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _fP_ = caml_ml_bytes_length(b) - 1 | 0, _fO_ = 0;
     if(_fP_ >= 0){
      var i = _fO_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _fH_ = caml_ml_string_length(s) - 1 | 0, _fG_ = 0;
    if(_fH_ >= 0){
     var i$0 = _fG_;
     for(;;){
    ...
    var
     ...
     _fJ_ = caml_ml_string_length(s) - 1 | 0,
     _fI_ = 0;
    if(_fJ_ >= 0){
     var i = _fI_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fC_ = _aA_; break;
      default: var _fC_ = _aJ_;
    }
    return transform_int_alt(iconv, caml_int64_format(_fC_, n));
   }
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _fB_ = _fA_ ? str : str + cst$4;
        return caml_special_val(_fB_);
       }
      case 6:
       return hex(0);
      case 7:
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bp_), _fn_, _fm_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _fi_ = field(e, 1),
       _fk_ = caml_call2(sprintf(_bq_), _fi_, _fh_);
     else
      switch(match){
        case 0:
         var _fk_ = _br_; break;
        case 1:
         var _fk_ = _bs_; break;
        default:
         var _fj_ = field(e, 1), _fk_ = caml_call1(sprintf(_bt_), _fj_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _e9_ = slot[4],
        _e__ = slot[3],
        _e$_ = slot[6] ? _bD_ : _bF_,
        _fa_ = slot[2],
        _fb_ = slot[7],
        _fc_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bE_), _fc_, _fb_, _fa_, _e$_, _e__, _e9_, _e8_)];
      else if(slot[1])
       var match = 0;
      else
       var _fd_ = info(0), match = [0, caml_call1(sprintf(_bG_), _fd_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_e6_){}
      try{
       var _eW_ = to_string(exn$0);
       caml_call1(eprintf(_bI_), _eW_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _eX_ = abs(status);
        prerr_endline(caml_check_bound(errors, _eX_)[1 + _eX_]);
       }
       var _eY_ = caml_ml_flush(stderr), _e2_ = _eY_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _e0_ = to_string(exn$0);
       caml_call1(eprintf(_bK_), _e0_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _e1_ = to_string(exn);
       caml_call1(eprintf(_bL_), _e1_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _e2_ = caml_ml_flush(stderr);
      }
      var _e3_ = _e2_;
     }
     catch(_e5_){
      var _eZ_ = caml_wrap_exception(_e5_);
      if(_eZ_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_eZ_, 0);
      var _e3_ = prerr_endline(_bJ_);
     }
     return _e3_;
    }
    catch(_e4_){return 0;}
   ...
   function mk(i1, i2, i3$0, i4$0){
    ...
    var i3 = caml_notequal(i3$0, _bN_) ? i3$0 : _bQ_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bO_) ? i4$0 : _bP_;
   ...
   function public_method_label(s){
    var accu = [0, 0], _eT_ = caml_ml_string_length(s) - 1 | 0, _eS_ = 0;
    if(_eT_ >= 0){
     var i = _eS_;
     for(;;){
      var _eU_ = caml_string_get(s, i);
      accu[1] = (223 * accu[1] | 0) + _eU_ | 0;
      var _eV_ = i + 1 | 0;
      if(_eT_ === i) break;
      i = _eV_;
     }
   ...
   function new_table(pub_labels){
    ...
    var _eM_ = ((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
    caml_check_bound(methods, 1)[2] = _eM_;
    var _eO_ = len - 1 | 0, _eN_ = 0;
    if(_eO_ >= 0){
     var i = _eN_;
     for(;;){
      var
       _eQ_ = (i * 2 | 0) + 3 | 0,
       _eP_ = caml_check_bound(pub_labels, i)[1 + i];
      caml_check_bound(methods, _eQ_)[1 + _eQ_] = _eP_;
      var _eR_ = i + 1 | 0;
      if(_eO_ === i) break;
      i = _eR_;
     }
   ...
   var
    ...
    _b$_ = "p",
    _b__ = "div",
    _ca_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _cc_ = "[\\][()\\\\|+*.?{}^$]",
    _cf_ = cst$2,
    _cd_ = "Js_of_ocaml__Url.Local_exn",
    _cs_ = [0, 0],
    _ct_ = [0, 1],
    _cq_ = [0, 0],
    _cr_ = [0, 1],
    ...
    _cn_ = "wakeup_exn",
    _cm_ = "wakeup",
    _cj_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _ck_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cl_ = [0, 0],
    _ch_ = cst_Fatal_error_exception,
    _ci_ = "Lwt.Resolution_loop.Canceled",
    _cC_ = "PATCH",
    _cD_ = cst_POST,
    _cE_ = "HEAD",
    _cF_ = "DELETE",
    ...
    _cK_ = cst$2,
    _cL_ = cst$3,
    _cB_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 98, 29],
    _cA_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 90, 29],
    _cz_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 82, 29],
    _cy_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 74, 29],
    _cx_ = [0, cst_lib_lwt_lwt_xmlHttpRequest, 66, 29],
    _cw_ = cst,
    _cu_ = cst$2,
    _cv_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cP_ = "Exception during Lwt.async: ",
    _cS_ = [0, 0, 0],
    _cV_ = [0, cst_examples_graph_viewer_view, 299, 10],
    _cW_ = [0, cst_examples_graph_viewer_view, 302, 10],
    _cT_ = [0, cst_examples_graph_viewer_view, 306, 8],
    _cU_ = [0, cst_examples_graph_viewer_view, 309, 8],
    _cQ_ = [0, cst_examples_graph_viewer_view, 157, 14],
    _c8_ = [0, [4, 0, 0, 0, [11, "px", 0]], "%dpx"],
    _c4_ = [0, 0.],
    _c5_ = [0, 0.],
    _c6_ = [0, 1.],
    _c7_ = [0, 20.],
    _cX_ = [0, "examples/graph_viewer/viewer_js.ml", 161, 26],
   ...
   function addEventListenerWithOptions(t28, typ, capture, once, passive, h){
    ...
    function callback(e){
     var _eJ_ = [0, h, e, [0]];
     return function(_eK_, _eL_){return caml_js_call(_eJ_, _eK_, _eL_);};
    }
   ...
   var Canvas_not_available = [248, _ca_, caml_fresh_oo_id(0)];
   function createCanvas(doc){
    var t52 = unsafeCreateElement(doc, _cb_);
   ...
   var
    ...
    quote_re = regexp(_cc_),
    Local_exn = [248, _cd_, caml_fresh_oo_id(0)];
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _eI_){return 0;},
     t41 = function(param, _eH_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _cg_ = caml_wrap_exception(_eG_);
    if(_cg_[1] !== Failure) throw caml_maybe_attach_backtrace(_cg_, 0);
   }
   var
   ...
   function aux(ofs){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= ofs && l >= ofs){
       var _eE_ = index_rec(path_string, l, ofs, c);
       break a;
      }
   ...
   if(a$0 && a$0[1] === cst){
    var _ce_ = a$0[2];
    if(! _ce_ || _ce_[1] === cst && ! _ce_[2]) break a;
   }
   var
    s$0 = t43.search.charAt(0) == cst$3 ? t43.search.slice(1) : t43.search,
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
           ...
           function(s){
            ...
            function _eB_(param){
             var
              y = param[2],
              x = param[1],
              _eC_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _eC_];
            }
            if(0 <= index)
             var
              _ez_ = s.slice(index + 1 | 0),
              _eA_ = [0, s.slice(0, index), _ez_];
            else
             var _eA_ = undefined$0;
            return case$1(_eA_, interrupt, _eB_);
           }),
         acc],
        idx$0 - 1 | 0);
      return;
      ...
      var _ex_ = caml_wrap_exception(_ey_);
      if(_ex_ !== Local_exn) throw caml_maybe_attach_backtrace(_ex_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _ew_ = caml_call1(f, v); return _ew_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _ev_ = result[1] === Canceled ? 1 : 0, is_canceled = _ev_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _eu_ = deferred_callbacks[2];
      if(! _eu_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _eu_[1];
      if(_eu_[2]){
       var next = _eu_[2];
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_cq_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _es_ = caml_call1(f, v), user_provided_promise = _es_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_cp_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_co_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
   ...
   (opt,
    ...
    if(_d__) var sth$0 = _d__[1], get_args = sth$0; else var get_args = 0;
    if(_d9_)
     var sth$1 = _d9_[1], check_headers = sth$1;
    else
     var check_headers = function(param, _er_){return 1;};
    if(contents){
     var c$0 = contents[1], _d$_ = c$0[1];
     if(440620227 === _d$_){
      var args = c$0[2];
      a:
      {
       b:
       {
        ...
        for(;;){
         if(! param) break;
         var l = param[2], a = param[1], _ea_ = a[2];
         c:
         {
          if(typeof _ea_ !== "number" && -976970511 === _ea_[1]){var _d5_ = 1; break c;}
          var _d5_ = 0;
         }
         if(! _d5_) break b;
         param = l;
      ...
      if(only_strings)
       ...
       if(match)
        var constr = match[1], _eb_ = [0, 808620462, new constr];
       else
        var _eb_ = [0, 891486873, [0, 0]];
       var form_contents = _eb_;
      }
      iter
       (function(param){
         var
        ...
        args);
      var _ec_ = [0, -836918635, form_contents];
     }
     else if(737307005 <= _d$_)
      var b = c$0[2], _ec_ = [0, 737307005, b];
     else
      var _ec_ = c$0;
     var contents$0 = [0, _ec_];
    }
    else
     var contents$0 = 0;
    function override_method$0(m){
     ...
     return 492530731 <= v
             ? 891112544
               <= v
               ? 994393768 <= v ? _cC_ : _cD_
               : 801894688 <= v ? _cE_ : _cF_
             : 3546230 === v ? _cG_ : 3997359 <= v ? _cH_ : _cI_;
    }
    if(contents$0){
     ...
     if(-836918635 === match$0[1]){
      ...
      if(891486873 <= form[1])
       var
        ...
        method = override_method$0(_cJ_);
      else
       var content_type$1 = content_type, method = override_method$0(_cM_);
     }
     else
      var content_type$1 = content_type, method = override_method$0(_cN_);
    }
    else
     var
      method$0 = override_method$0(_cO_),
      ...
      _d6_ =
        concat
         (_cf_,
          map
           (function(param){
             var v = param[2], n = param[1], _eq_ = cst$6 + urlencode(0, v);
             return urlencode(0, n) + _eq_;
            },
            get_args));
     try{
      index_rec(url, caml_ml_string_length(url), 0, 63);
      var _d8_ = 1, _ee_ = _d8_;
     }
     catch(_ep_){
      var _d7_ = caml_wrap_exception(_ep_);
      if(_d7_ !== Not_found) throw caml_maybe_attach_backtrace(_d7_, 0);
      var _ee_ = 0;
     }
     var _ef_ = _ee_ ? _cK_ : _cL_, url$0 = url + _ef_ + _d6_;
    }
    var
     match$1 = task(0),
     w = match$1[2],
                 ...
                 _em_ =
                   function(param){
                    throw caml_maybe_attach_backtrace
                           ([0, Assert_failure, _cB_], 1);
                   },
                 _en_ = e$1 instanceof arrayBuffer ? e$1 : no_handler,
                 response = [0, url$0, code, headers$0, _en_, _em_];
                break;
               case 1:
                var
                 code$0 = req.status,
                 ...
                 _el_ = e$0 instanceof blob_constr ? e$0 : no_handler,
                 response = [0, url$0, code$0, headers$0, _el_, _ek_];
                break;
               case 2:
                var
                 code$1 = req.status,
                 ...
                 _ei_ =
                   function(param){
                    throw caml_maybe_attach_backtrace
                           ([0, Assert_failure, _cy_], 1);
                   },
                 _ej_ = e instanceof doc_constr ? e : no_handler,
                 response = [0, url$0, code$1, headers$0, _ej_, _ei_];
                break;
               case 3:
                var
                 code$2 = req.status,
                ...
                var
                 ...
                 response =
                   [0,
                    ...
                    case$0
                     (req.responseText,
                      function(param){return cst;},
                      function(x){return x;}),
                    function(param){
                     throw caml_maybe_attach_backtrace
                            ([0, Assert_failure, _cx_], 1);
                    }];
                break;
               default:
                var
    ...
    if(contents$0){
     var match$2 = contents$0[1], _ed_ = match$2[1];
     if(-836918635 === _ed_){
              ...
              (function(param){
                ...
                if(781515420 <= match[1]){
                 var
                  t0 = match[2],
                  _eg_ =
                    cst$6 + urlencode(0, caml_string_of_jsstring(t0.name));
                 return urlencode(0, name) + _eg_;
                }
                var
                 s = match[2],
                 _eh_ = cst$6 + urlencode(0, caml_string_of_jsstring(s));
                return urlencode(0, name) + _eh_;
               },
               l$1))));
      }
      else{var f = match$3[2]; req.send(f);}
     }
     else if(737307005 <= _ed_){
      var b$0 = match$2[2];
      req.send(b$0);
     }
   ...
   function put_pixmap(param, x, y, xsrc, ysrc, width, height, _d4_){
    var p = _d4_[1], c = param[2];
   ...
   function _cR_(st, scale, x$2, y$2, x$1, y$1, w, h){
    var ctx = get_pixmap(st[8])[2];
    ctx.save();
    var
     _dZ_ = 0 === st[1].length - 1 ? 1 : 0,
     _d0_ = _dZ_ ? 0 < st[2].length - 1 ? 1 : 0 : _dZ_;
    if(_d0_) throw caml_maybe_attach_backtrace([0, Assert_failure, _cX_], 1);
    ctx.beginPath();
    ...
    if(_d2_ >= 0){
     ...
     for(;;){
      var
       ...
       _dV_ = x1$0 <= x4 ? 1 : 0;
      if(_dV_){
       var _dW_ = y1$0 <= y4 ? 1 : 0;
       if(_dW_)
        var
         _dX_ = x3$0 <= x2$0 ? 1 : 0,
         _dY_ = _dX_ ? y3$0 <= y2$0 ? 1 : 0 : _dX_;
       else
        var _dY_ = _dW_;
      }
      else
   ...
   function redraw(st, scale, x0, y0, window, a, x, y, width$0, height$0){
    ...
    a:
    {
     b:
     {
      ...
      var
       ...
       _dQ_ = 0 !== dx ? 1 : 0,
       _dR_ = _dQ_ || (0 !== dy ? 1 : 0);
      if(_dR_) put_pixmap(p, dx, dy, 0, 0, r$2[3], r$2[4], p);
      var
       offset =
         function(p, l, d, m){
          return 0 < ((p + d | 0) + l | 0)
      ...
      if(0 < height$2)
       if(0 < x$0){
        ...
        _cR_(st, scale, x0$2, y0$2, 0, y$0, x$0, height$2);
       }
       else{
        if(0 !== x$0)
      ...
      if(0 < y$0){
       ...
       _cR_(st, scale, x0$2, y0$2, 0, 0, a[3], y$0);
      }
      else{
       if(0 !== y$0)
        throw caml_maybe_attach_backtrace([0, Assert_failure, _cU_], 1);
       if(height$2 < a[4])
        _cR_(st, scale, x0$2, y0$2, 0, height$2, a[3], a[4] - height$2 | 0);
      }
    ...
    if(_dL_)
     ...
     if(_dO_)
      ...
      var
       _dP_ = r$0[3] < (x + width$0 | 0) ? 1 : 0,
       _dM_ = _dP_ || (r$0[4] < (y + height$0 | 0) ? 1 : 0);
    }
    if(_dM_){
     _cR_(st, scale, x0$2, y0$2, 0, 0, a[3], a[4]);
     pm[4] = [0, x0$2, y0$2, a[3], a[4]];
    }
    var _dN_ = get_pixmap(pm);
    return put_pixmap
            (get_drawable(window), x, y, x, y, width$0, height$0, _dN_);
   }
   var json = JSON;
   if(0 === public_methods)
   ...
   if(_b0_ >= 0){
    ...
    for(;;){
     ...
     try{var _bW_ = Meths[17].call(null, name$0, table$0[3]), _b6_ = _bW_;}
     catch(_dG_){
      var _bV_ = caml_wrap_exception(_dG_);
   ...
   if(_b2_ >= 0){
    ...
    for(;;){
     ...
     try{var _bY_ = Vars[17].call(null, name, table$0[7]), _b3_ = _bY_;}
     catch(_dF_){
      var _bX_ = caml_wrap_exception(_dF_);
   ...
   var
    ...
    methods =
      [0,
       res[1],
       function(self_1){return self_1[1 + _cY_];},
       res[8],
       function(self_1){return self_1[1 + _cZ_];},
       res[2],
       function(self_1){return self_1[1 + _c0_];},
       res[3],
       function(self_1){return self_1[1 + _c1_];},
       res[7],
       function(self_1){return self_1[1 + _c2_];},
       res[6],
       function(self_1){return self_1[1 + _c3_];},
       res[4],
       function(self_1, v){self_1[1 + _cY_] = v; return 0;},
       res[5],
       function(self_1, lower, upper, step_incr, page_incr, page_size, param){
        if(lower){var v = lower[1]; self_1[1 + _cZ_] = v;}
        if(upper){var v$0 = upper[1]; self_1[1 + _c0_] = v$0;}
        if(step_incr){var v$1 = step_incr[1]; self_1[1 + _c1_] = v$1;}
        if(page_incr){var v$2 = page_incr[1]; self_1[1 + _c2_] = v$2;}
   ...
   for(;;){
    ...
    var
     _b9_ = i$2[1],
     label$0 = caml_check_bound(methods, _b9_)[1 + _b9_],
     next =
       function(param){
        i$2[1]++;
        var _dE_ = i$2[1];
    ...
    t185 =
      handler
       (function(param){
         ...
         t107.margin = cst_0px;
         var started = [0, 0], t109 = unsafeCreateElement(document, _b$_);
         ...
         function loop(d, param){
          ...
          var
           cb =
             remain == 0.
              ? callback
              : function(_dw_){return loop(remain, _dw_);};
         ...
         function _c$_(s){
          var
           _dc_ = json.parse(caml_jsstring_of_string(s)),
           scene = _dc_[3],
           bboxes = _dc_[2],
           match = _dc_[1],
           y2 = match[4],
          ...
          var
           hadj = caml_call5(_b8_(0, 0)(0), 0, 0, 0, 0, 0),
           vadj = caml_call5(_b8_(0, 0)(0), 0, 0, 0, 0, 0),
           sadj = caml_call5(_b8_(0, 0)(0), _c7_, _c6_, _c5_, _c4_, 0);
          ...
          var height = 284;
          function points(d){
           return caml_jsstring_of_string(caml_call1(sprintf(_c8_), d));
          }
          var
           size_px = points(16),
           pos = [0, height],
          ...
          handle_drag
           (canvas,
            function(dx, dy){
             ...
             function offset(a, d){
              var
               _dk_ = caml_call1(caml_get_public_method(a, 307110897, 423), a),
               _dl_ =
         ...
         try{
          var
           _c__ = return$0(caml_read_file_content(cst_scene_json)),
           _da_ = _c__;
         }
         catch(_db_){
          var _c9_ = caml_wrap_exception(_db_);
          if(_c9_ !== Not_found) throw caml_maybe_attach_backtrace(_c9_, 0);
          var
           _da_ =
             symbol_bind
