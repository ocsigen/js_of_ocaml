...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _fz_ = caml_wrap_exception(_fA_);
      if(_fz_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fz_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _fx_ = l - 1 | 0, _fw_ = 1;
    if(_fx_ >= 1){
     var i = _fw_;
     for(;;){
   ...
   function take(q){
    var _fv_ = q[2];
    if(! _fv_) throw caml_maybe_attach_backtrace(Empty, 1);
    var content = _fv_[1];
    if(_fv_[2]){
     var next = _fv_[2];
     q[1] = q[1] - 1 | 0;
   ...
   var
    at_exit_key = new_key(0, function(param, _fu_){return 0;}),
    _q_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _ft_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _ft_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fs_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fs_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fs_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _fg_ = caml_ml_bytes_length(b) - 1 | 0,
     _ff_ = 0;
    if(_fg_ >= 0){
     var i$0 = _ff_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _fi_ = caml_ml_bytes_length(b) - 1 | 0, _fh_ = 0;
     if(_fi_ >= 0){
      var i = _fh_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _e4_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _e4_ >>> 0){
           if(55 === _e4_) break a;
          }
          else if(21 < _e4_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _e5_ = 1;
        }
        var _e6_ = _e5_ ? str : symbol(str, _a6_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _eY_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _eY_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _eY_[1];
       ...
       case 18:
        var _eW_ = fmt$0[1];
        if(0 === _eW_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _eW_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _eW_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _eX_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _eX_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _eU_ = [8, acc, _bd_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _eU_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _eU_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _eT_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _eT_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _eT_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bm_), _eS_, _eR_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_eQ_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _eN_ = field(e, 1),
       _eP_ = caml_call2(sprintf(_bn_), _eN_, _eM_);
     else
      switch(match){
        case 0:
         var _eP_ = _bo_; break;
        case 1:
         var _eP_ = _bp_; break;
        default:
         var _eO_ = field(e, 1), _eP_ = caml_call1(sprintf(_bq_), _eO_);
      }
     var match$0 = [0, constructor, [0, _eP_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _eC_ = slot[4],
        _eD_ = slot[3],
        _eE_ = slot[6] ? _bA_ : _bC_,
        _eF_ = slot[2],
        _eG_ = slot[7],
        _eH_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bB_), _eH_, _eG_, _eF_, _eE_, _eD_, _eC_, _eB_)];
      else if(slot[1])
       var match = 0;
      else
       var _eI_ = info(0), match = [0, caml_call1(sprintf(_bD_), _eI_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_ez_){}
      try{
       var _ep_ = to_string(exn$0);
       caml_call1(eprintf(_bF_), _ep_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _eq_ = abs(status);
        prerr_endline(caml_check_bound(errors, _eq_)[1 + _eq_]);
       }
       var _er_ = caml_ml_flush(stderr), _ev_ = _er_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _et_ = to_string(exn$0);
       caml_call1(eprintf(_bH_), _et_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eu_ = to_string(exn);
       caml_call1(eprintf(_bI_), _eu_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _ev_ = caml_ml_flush(stderr);
      }
      var _ew_ = _ev_;
     }
     catch(_ey_){
      var _es_ = caml_wrap_exception(_ey_);
      if(_es_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_es_, 0);
      var _ew_ = prerr_endline(_bG_);
     }
     return _ew_;
    }
    catch(_ex_){return 0;}
   ...
   var
    ...
    _bT_ = "script",
    _bS_ = cst_canvas,
    _bU_ = [0, "lib/js_of_ocaml/regexp.ml", 34, 64],
    _bV_ = "[\\][()\\\\|+*.?{}^$]",
    _bW_ = "Js_of_ocaml__Url.Local_exn",
    _cH_ = cst$3,
    _cd_ = [0, 0],
    _ce_ = [0, 1],
    _cb_ = [0, 0],
    ...
    _b3_ = [0, 0],
    _bZ_ = cst_Fatal_error_exception,
    _b0_ = "Lwt.Resolution_loop.Canceled",
    _cl_ = cst_POST,
    _cj_ = cst_POST,
    _ck_ = cst_POST,
    _ci_ = cst$0,
    _cf_ = cst$4,
    _cg_ = cst$4,
    _ch_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cm_ = "Exception during Lwt.async: ",
    _cG_ =
      [0, [11, "uncaught exception: ", [2, 0, 0]], "uncaught exception: %s"],
    _cF_ = [0, [11, cst_fetching_model, 0], cst_fetching_model],
    _cE_ = [0, [8, [0, 0, 0], 0, [0, 1], 0], "%.1f"],
    _cx_ = [0, [11, cst_init_canvas, 0], cst_init_canvas],
    _cy_ = [0, [11, cst_create_program, 0], cst_create_program],
    _cz_ = "fragment-shader",
    _cA_ = "vertex-shader",
    _cB_ = [0, [11, cst_use_program, 0], cst_use_program],
    _cC_ = [0, [11, cst_program_loaded, 0], cst_program_loaded],
    _cD_ = [0, [11, cst_ready, 0], cst_ready],
    _cw_ = "\n",
    _cv_ = [0, 1, [0, 2, [0, 3, [0, 4, 0]]]],
    _cu_ = [0, 1, [0, 2, 0]],
    _cr_ =
      [0,
    ...
    _cn_ = [0, [11, cst_WebGL_error, 0], cst_WebGL_error],
    _cs_ = "(v|vn|f)\\ ([^\\ ]+)\\ ([^\\ ]+)\\ ([^\\ ]+)",
    _ct_ = "([0-9]+)//([0-9]+)",
   ...
   function to_option(x){
    return case$0(x, function(param){return 0;}, function(x){return [0, x];});
   }
   ...
   function canvas(e){return unsafeCoerce(_bS_, e);}
   function script(e){return unsafeCoerce(_bT_, e);}
   global.FormData;
   global.FormData;
   ({alpha: true$0,
     depth: true$0,
   ...
   function matched_group(r, i){
    ...
    return case$1
            (x$0, function(param){return 0;}, function(x){return [0, x];});
   }
   var
    quote_repl_re = new regExp("[$]", cst_g),
    quote_re = regexp(_bV_),
    Local_exn = [248, _bW_, caml_fresh_oo_id(0)];
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _bY_ = caml_wrap_exception(_el_);
    if(_bY_[1] !== Failure) throw caml_maybe_attach_backtrace(_bY_, 0);
   }
   var
     ...
     a:
     {
      ...
      if(0 <= ofs && lim >= ofs){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _ej_ = i; break a;}
        var i$0 = i + 1 | 0, i = i$0;
       }
      }
      var _ej_ = invalid_arg(_o_);
     }
     var j = _ej_;
    }
    catch(_ek_){
   ...
   if(a && ! caml_string_notequal(a[1], cst$0)){
    var _bX_ = a[2];
    if(! _bX_ || ! caml_string_notequal(_bX_[1], cst$0) && ! _bX_[2]) break a;
   }
   var
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
           ...
           function(s){
            ...
            function _eg_(param){
             var
              y = param[2],
              x = param[1],
              _eh_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _eh_];
            }
            if(0 <= index)
             var
              _ee_ = s.slice(index + 1 | 0),
              _ef_ = [0, s.slice(0, index), _ee_];
            else
             var _ef_ = undefined$0;
      ...
      var _ec_ = caml_wrap_exception(_ed_);
      if(_ec_ !== Local_exn) throw caml_maybe_attach_backtrace(_ec_, 0);
   ...
   symbol(s$0, symbol(_cH_, git_version));
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _eb_ = caml_call1(f, v); return _eb_;}
    catch(exn$0){
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _d$_ = p[1];
    switch(_d$_[0]){
      case 1:
       return _d$_[1] === Canceled
               ? 0
      ...
      case 2:
       ...
       resolve(_b3_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _b1_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_b4_, r, [0, v]);}
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_b7_, 0, outer_promise, p[1]);
      case 2:
       var
        p_callbacks = match[1],
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_b8_, 0, p$2, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _d__ = caml_call1(f, v), p$0 = _d__;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_b$_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _d9_ = [0, caml_call1(f, v)], p_result$0 = _d9_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
       if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_ca_,
                function(param){
                 try{var _d8_ = [0, caml_call1(f, v)], _d7_ = _d8_;}
                 catch(exn$0){
                  var exn = caml_wrap_exception(exn$0);
                  if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
                  var _d7_ = [1, exn];
   ...
   function load_shader(t15, shader, text){
    ...
    return caml_call2(error(_cp_), caml_string_of_jsstring(text), _d4_);
   }
     ...
     script$0 =
       get
        (bind
         ...
         function(param){return caml_call1(error(_cr_), src_id);});
   ...
   function mult(m1, m2){
    function v(p){
     var
      j = p % 4 | 0,
      i = p / 4 | 0,
      _dT_ = caml_array_get(m2, c$0(3, j)),
      _dU_ = caml_array_get(m1, c$0(i, 3)) * _dT_,
      _dV_ = caml_array_get(m2, c$0(2, j)),
      _dW_ = caml_array_get(m1, c$0(i, 2)) * _dV_,
      _dX_ = caml_array_get(m2, c$0(1, j)),
      _dY_ = caml_array_get(m1, c$0(i, 1)) * _dX_,
      _dZ_ = caml_array_get(m2, c$0(0, j));
     return caml_array_get(m1, c$0(i, 0)) * _dZ_ + _dY_ + _dW_ + _dU_;
    }
    return init(16, v);
   }
   var line_regexp = regexp(_cs_), couple_regexp = regexp(_ct_);
   function read_coord_couple(c){
    var match = string_match(couple_regexp, c, 0);
    if(! match) return 0;
    var
     res = match[1],
     match$0 = map(function(_dS_){return matched_group(res, _dS_);}, _cu_);
    if(match$0){
     var _dO_ = match$0[1];
     if(_dO_){
      var _dP_ = match$0[2];
      if(_dP_){
       var _dQ_ = _dP_[1];
       if(_dQ_ && ! _dP_[2]){
        var vn = _dQ_[1], v = _dO_[1], _dR_ = caml_int_of_string(vn);
        return [0, [0, caml_int_of_string(v), _dR_]];
       }
      }
     }
    }
   ...
   function concat(a){
    var r = [0, 0], _dL_ = a.length - 1 - 1 | 0, _dK_ = 0;
    if(_dL_ >= 0){
     var i = _dK_;
     for(;;){
    ...
    function next(param){
     for(;;){
      ...
      pos[1]++;
      var _dN_ = pos[1];
      l$1[1] = caml_check_bound(a, _dN_)[1 + _dN_];
     }
    }
   ...
   function start(param){
    ...
    var
     canvas$0 =
       get
        (bind(document.getElementById(cst_canvas), canvas),
         function(param){return caml_call1(error(_co_), canvas_id);});
    function _dD_(param){
     return ksprintf
             (function(s){
    ...
    try{
     var
      ...
      _dF_ = test(ctx) ? ctx : canvas$0.getContext("experimental-webgl"),
      _dE_ = _dF_;
    }
    catch(_dJ_){var _dE_ = no_handler;}
    var t102 = get(_dE_, _dD_);
    debug(_cy_);
    var
     frag_src = get_source(_cz_),
     vert_src = get_source(_cA_),
    ...
    function f$0(param){
     ...
     var
      fps = 1. / accu * _dG_ * 1000.,
      t138 = caml_jsstring_of_string(caml_call1(sprintf(_cE_), fps));
     fps_text.data = t138;
   ...
   function go(param$2){
    ...
    function h(exn){
     ...
     return caml_call1(error(_cG_), _dC_);
    }
    try{
     var
      _cP_ =
         ...
         if(_cZ_ >= 0){
          ...
          for(;;){
           ...
           if(match){
            ...
            var
             match$0 =
               map(function(_dB_){return matched_group(res$0, _dB_);}, _cv_);
            if(match$0){
             var _c1_ = match$0[1];
             if(_c1_){
              var _c2_ = _c1_[1];
              if(caml_string_notequal(_c2_, "f"))
               if(caml_string_notequal(_c2_, "v")){
                if(! caml_string_notequal(_c2_, "vn")){
                 var _c3_ = match$0[2];
                 if(_c3_){
                  var _c4_ = _c3_[1];
                  if(_c4_){
                     ...
                     if(_c7_){
                      ...
                      if(_c8_ && ! _c7_[2]){
                       var
                        ...
                        y = _c6_[1],
                        x$0 = _c4_[1],
                        _c9_ = caml_float_of_string(z),
                        _c__ = caml_float_of_string(y),
                        match$2 =
                          [0, [1, [0, caml_float_of_string(x$0), _c__, _c9_]]];
                       break a;
                      }
                     }
                    }
                    ...
                    if(_dd_){
                     ...
                     if(_de_ && ! _dd_[2]){
                      var
                       ...
                       y$0 = _dc_[1],
                       x$1 = _da_[1],
                       _df_ = caml_float_of_string(z$0),
                       _dg_ = caml_float_of_string(y$0),
                       match$2 =
                         [0, [0, [0, caml_float_of_string(x$1), _dg_, _df_]]];
                      break a;
                     }
                    }
                   }
          ...
          vertex =
            init
             (face$0.length - 1,
              function(i){
               var
                _dx_ = caml_check_bound(face$0, i)[1 + i],
                cv = _dx_[3][1],
                bv = _dx_[2][1],
                av = _dx_[1][1],
                _dy_ = av - 1 | 0,
                match = caml_check_bound(vertex$2, _dy_)[1 + _dy_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dz_ = bv - 1 | 0,
                match$0 = caml_check_bound(vertex$2, _dz_)[1 + _dz_],
                b3 = match$0[3],
                b2 = match$0[2],
                b1 = match$0[1],
                _dA_ = cv - 1 | 0,
                match$1 = caml_check_bound(vertex$2, _dA_)[1 + _dA_],
                c3 = match$1[3],
                c2 = match$1[2],
                c1 = match$1[1];
               return [0,
             ...
             (face$0.length - 1,
              function(i){
               var
                ...
                an = _dt_[1][2],
                _du_ = an - 1 | 0,
                match = caml_check_bound(norm$2, _du_)[1 + _du_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dv_ = bn - 1 | 0,
                match$0 = caml_check_bound(norm$2, _dv_)[1 + _dv_],
                b3 = match$0[3],
                b2 = match$0[2],
                b1 = match$0[1],
                _dw_ = cn - 1 | 0,
                match$1 = caml_check_bound(norm$2, _dw_)[1 + _dw_],
                c3 = match$1[3],
                c2 = match$1[2],
                c1 = match$1[1];
               return [0,
     ...
     try{
      var
       _cO_ = return$0(caml_read_file_content(cst_monkey_model)),
       _cQ_ = _cO_;
     }
     catch(_cT_){
      var _cM_ = caml_wrap_exception(_cT_);
      if(_cM_ !== Not_found) throw caml_maybe_attach_backtrace(_cM_, 0);
      var
       content_type$2 = 0,
       check_headers = function(param, _cX_){return 1;},
       contents = 0,
       _cN_ = function(s){return s;},
       _cL_ =
         function(r){
          var cod = r[2], msg = r[4];
      ...
      if(contents){
       ...
       if(-836918635 === match$0[1]){
        ...
        if(891486873 <= form[1])
         ...
         var content_type$0 = content_type$2, method$0 = _ck_;
       }
       else
        var content_type$0 = content_type$2, method$0 = _cl_;
      }
      else
      ...
      if(contents){
       var match$2 = contents[1], _cK_ = match$2[1];
       if(-836918635 === _cK_){
             ...
             (function(param){
               ...
               if(781515420 <= match[1]){
                var
                 t0 = match[2],
                 _cU_ =
                   symbol(_cf_, urlencode(0, caml_string_of_jsstring(t0.name)));
                return symbol(urlencode(0, name), _cU_);
               }
               var
                s = match[2],
                _cV_ = symbol(_cg_, urlencode(0, caml_string_of_jsstring(s)));
               return symbol(urlencode(0, name), _cV_);
              },
              l$2);
         if(l$0){
          ...
          a:
          {
           ...
           var _cI_ = caml_ml_string_length(hd) + acc | 0;
          }
          var dst = caml_create_bytes(_cI_);
          a:
          {
           b:
           {
          ...
          var _cJ_ = caml_string_of_bytes(dst);
         }
         else
          var _cJ_ = _n_;
         req.send(caml_jsstring_of_string(_cJ_));
        }
        else{var f$0 = match$3[2]; req.send(f$0);}
       }
       else if(737307005 <= _cK_){
        var b = match$2[2];
        req.send(b);
       }
      ...
      var _cQ_ = symbol$0(symbol_bind(res, _cL_), _cN_);
     }
     var _cR_ = symbol_bind(symbol$0(_cQ_, _cP_), start), p = _cR_;
    }
