...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _fH_ = caml_wrap_exception(_fI_);
      if(_fH_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fH_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _fF_ = l - 1 | 0, _fE_ = 1;
    if(_fF_ >= 1){
     var i = _fE_;
     for(;;){
   ...
   function take(q){
    var _fD_ = q[2];
    if(! _fD_) throw caml_maybe_attach_backtrace(Empty, 1);
    var content = _fD_[1];
    if(_fD_[2]){
     var next = _fD_[2];
     q[1] = q[1] - 1 | 0;
   ...
   var at_exit_key = new_key(0, function(param, _fC_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _fB_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _fB_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fA_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fA_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fA_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _fo_ = caml_ml_bytes_length(b) - 1 | 0,
     _fn_ = 0;
    if(_fo_ >= 0){
     var i$0 = _fn_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _fq_ = caml_ml_bytes_length(b) - 1 | 0, _fp_ = 0;
     if(_fq_ >= 0){
      var i = _fp_;
      for(;;){
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fa_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fa_ >>> 0){
           if(55 === _fa_) break a;
          }
          else if(21 < _fa_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _fb_ = 1;
        }
        var _fc_ = _fb_ ? str : symbol(str, _a8_);
      ...
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _e8_ = l - 1 | 0, _e7_ = 0;
        if(_e8_ >= 0){
         var i = _e7_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _e9_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _e9_);
          var _e__ = i + 1 | 0;
          if(_e8_ === i) break;
          var i = _e__;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _e6_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _e6_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _e6_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _e5_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _e5_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _e2_ = [8, acc, _bf_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _e2_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _e2_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _e1_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _e1_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _e1_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _e0_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _e0_, fmt);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_eX_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
     ...
     if(2 < match >>> 0)
      ...
      switch(match){
        ...
        case 1:
         var _eW_ = _br_; break;
        default:
         var _eV_ = field(e, 1), _eW_ = caml_call1(sprintf(_bs_), _eV_);
      }
     var match$0 = [0, constructor, [0, _eW_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        match =
          [0,
           caml_call7(sprintf(_bD_), _eO_, _eN_, _eM_, _eL_, _eK_, _eJ_, _eI_)];
      else if(slot[1])
       var match = 0;
      else
    ...
    try{
     try{
      ...
      try{
       ...
       var _ey_ = caml_ml_flush(stderr), _eC_ = _ey_;
      }
      catch(exn$1){
       var
       ...
       caml_call1(eprintf(_bK_), _eA_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eB_ = to_string(exn);
       caml_call1(eprintf(_bL_), _eB_);
   ...
   function string_match(t10, s, t9){
    ...
    var
     ...
     _ev_ = x == no_handler ? no_handler : x;
    return to_option(_ev_);
   }
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _eu_){return 0;},
     t41 = function(param, _et_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b2_ = caml_wrap_exception(_es_);
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
           ...
           function(s){
            ...
            function _en_(param){
             var
              y = param[2],
              x = param[1],
              _eo_ = urldecode_js_string_string(y);
             return [0, urldecode_js_string_string(x), _eo_];
            }
            if(0 <= index)
             var
              _el_ = s.slice(index + 1 | 0),
              _em_ = [0, s.slice(0, index), _el_];
            else
             var _em_ = undefined$0;
            return case$1(_em_, interrupt, _en_);
           }),
         acc],
        _ej_);
      return;
      ...
      if(_ei_ !== Local_exn) throw caml_maybe_attach_backtrace(_ei_, 0);
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _ef_ = p[1];
    switch(_ef_[0]){
      case 1:
       return _ef_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _ee_ = caml_call1(f, v), p$0 = _ee_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function symbol$0(p$1, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _ed_ = [0, caml_call1(f, v)], p_result$0 = _ed_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
       if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_ce_,
                function(param){
                 try{var _ec_ = [0, caml_call1(f, v)], _eb_ = _ec_;}
                 catch(exn$0){
                  var exn = caml_wrap_exception(exn$0);
                  if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
                  var _eb_ = [1, exn];
   ...
   function check_error(gl){
    var _d$_ = gl.NO_ERROR, _ea_ = caml_notequal(gl.getError(), _d$_);
    return _ea_ ? error(_cr_) : _ea_;
   }
   function load_shader(t15, shader, text){
    t15.shaderSource(shader, text);
    t15.compileShader(shader);
    var _d9_ = 1 - (t15.getShaderParameter(shader, t15.COMPILE_STATUS) | 0);
    if(! _d9_) return _d9_;
    var _d__ = caml_string_of_jsstring(t15.getShaderInfoLog(shader));
    return caml_call2(error(_ct_), caml_string_of_jsstring(text), _d__);
   }
     ...
     script$0 =
       get
        (bind
         ...
         function(param){return caml_call1(error(_cv_), src_id);});
   ...
   function mult(m1, m2){
    function v(p){
     var
      j = p % 4 | 0,
      i = p / 4 | 0,
      _dZ_ = caml_array_get(m2, c$0(3, j)),
      _d0_ = caml_array_get(m1, c$0(i, 3)) * _dZ_,
      _d1_ = caml_array_get(m2, c$0(2, j)),
      _d2_ = caml_array_get(m1, c$0(i, 2)) * _d1_,
      _d3_ = caml_array_get(m2, c$0(1, j)),
      _d4_ = caml_array_get(m1, c$0(i, 1)) * _d3_,
      _d5_ = caml_array_get(m2, c$0(0, j));
     return caml_array_get(m1, c$0(i, 0)) * _d5_ + _d4_ + _d2_ + _d0_;
    }
    return init(16, v);
   }
   ...
   function read_coord_couple(c){
    ...
    var
     res = match[1],
     match$0 = map(function(_dY_){return matched_group(res, _dY_);}, _cy_);
    if(match$0){
     var _dU_ = match$0[1];
     if(_dU_){
      var _dV_ = match$0[2];
   ...
   function concat(a){
    var r = [0, 0], _dR_ = a.length - 1 - 1 | 0, _dQ_ = 0;
    if(_dR_ >= 0){
     var i = _dQ_;
     for(;;){
    ...
    function next(param){
     for(;;){
      ...
      pos[1]++;
      var _dT_ = pos[1];
      l$1[1] = caml_check_bound(a, _dT_)[1 + _dT_];
     }
    }
   ...
   function start(param){
     ...
     canvas$0 =
       get
        (bind(document.getElementById(cst_canvas), canvas),
         function(param){return caml_call1(error(_cs_), canvas_id);});
    function _dJ_(param){
     return ksprintf
             (function(s){
    ...
    try{
     var
      ...
      _dL_ = test(ctx) ? ctx : canvas$0.getContext("experimental-webgl"),
      _dK_ = _dL_;
    }
    catch(_dP_){var _dK_ = no_handler;}
    var t102 = get(_dK_, _dJ_);
    debug(_cC_);
    var
   ...
   function go(param$2){
    ...
    function h(exn){
     ...
     return caml_call1(error(_cK_), _dI_);
    }
    try{
     var
      _cT_ =
         ...
         if(_c5_ >= 0){
          ...
          for(;;){
           ...
           if(match){
            ...
            var
             match$0 =
               map(function(_dH_){return matched_group(res$0, _dH_);}, _cz_);
            if(match$0){
             var _c7_ = match$0[1];
             if(_c7_){
              var _c8_ = _c7_[1];
              if(caml_string_notequal(_c8_, "f"))
               if(caml_string_notequal(_c8_, "v")){
                if(! caml_string_notequal(_c8_, "vn")){
                 var _c9_ = match$0[2];
                 if(_c9_){
                  var _c__ = _c9_[1];
                  if(_c__){
                     ...
                     if(_db_){
                      ...
                      if(_dc_ && ! _db_[2]){
                       var
                        ...
                        y = _da_[1],
                        x$0 = _c__[1],
                        _dd_ = caml_float_of_string(z),
                        _de_ = caml_float_of_string(y),
                        match$2 =
                          [0, [1, [0, caml_float_of_string(x$0), _de_, _dd_]]];
                       break a;
                      }
                     }
                    }
                    ...
                    if(_dj_){
                     ...
                     if(_dk_ && ! _dj_[2]){
                      var
                       ...
                       y$0 = _di_[1],
                       x$1 = _dg_[1],
                       _dl_ = caml_float_of_string(z$0),
                       _dm_ = caml_float_of_string(y$0),
                       match$2 =
                         [0, [0, [0, caml_float_of_string(x$1), _dm_, _dl_]]];
                      break a;
                     }
                    }
                   }
             ...
             (face$0.length - 1,
              function(i){
               var
                ...
                av = _dD_[1][1],
                _dE_ = av - 1 | 0,
                match = caml_check_bound(vertex$2, _dE_)[1 + _dE_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dF_ = bv - 1 | 0,
                match$0 = caml_check_bound(vertex$2, _dF_)[1 + _dF_],
                b3 = match$0[3],
                b2 = match$0[2],
                b1 = match$0[1],
                _dG_ = cv - 1 | 0,
                match$1 = caml_check_bound(vertex$2, _dG_)[1 + _dG_],
                c3 = match$1[3],
                c2 = match$1[2],
                c1 = match$1[1];
               return [0,
          ...
          norm =
            init
             (face$0.length - 1,
              function(i){
               var
                _dz_ = caml_check_bound(face$0, i)[1 + i],
                cn = _dz_[3][2],
                bn = _dz_[2][2],
                an = _dz_[1][2],
                _dA_ = an - 1 | 0,
                match = caml_check_bound(norm$2, _dA_)[1 + _dA_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dB_ = bn - 1 | 0,
                match$0 = caml_check_bound(norm$2, _dB_)[1 + _dB_],
                b3 = match$0[3],
                b2 = match$0[2],
                b1 = match$0[1],
                _dC_ = cn - 1 | 0,
                match$1 = caml_check_bound(norm$2, _dC_)[1 + _dC_],
                c3 = match$1[3],
                c2 = match$1[2],
                c1 = match$1[1];
               return [0,
     ...
     try{
      ...
      var
       ...
       content_type$1 = 0,
       headers$0 = 0,
       check_headers = function(param, _c3_){return 1;},
       contents = 0;
               ...
               var
                ...
                response =
                  [0,
                   ...
                   headers,
                   case$0
                    (req.responseText, function(param){return _cm_;}, _c1_),
                   _c0_];
