...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ft_ = caml_wrap_exception(_fu_);
      if(_ft_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ft_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _fr_ = l - 1 | 0, _fq_ = 1;
    if(_fr_ >= 1){
     var i = _fq_;
     for(;;){
   ...
   function take(q){
    var _fp_ = q[2];
    if(! _fp_) throw caml_maybe_attach_backtrace(Empty, 1);
    var content = _fp_[1];
    if(_fp_[2]){
     var next = _fp_[2];
     q[1] = q[1] - 1 | 0;
   ...
   var
    at_exit_key = new_key(0, function(param, _fo_){return 0;}),
    _p_ = "Array.blit";
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _e6_ = caml_ml_string_length(s) - 1 | 0, _e5_ = 0;
    if(_e6_ >= 0){
     var i$0 = _e5_;
     for(;;){
    ...
    var
     ...
     _e8_ = caml_ml_string_length(s) - 1 | 0,
     _e7_ = 0;
    if(_e8_ >= 0){
     var i = _e7_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _e4_ = _ah_; break;
      default: var _e4_ = _aq_;
    }
    return transform_int_alt(iconv, caml_format_int(_e4_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _e1_ = _au_; break;
      default: var _e1_ = _aD_;
    }
    return transform_int_alt(iconv, caml_int64_format(_e1_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _eY_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _eY_ >>> 0){
           if(55 === _eY_) break a;
          }
          else if(21 < _eY_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _e0_ = _eZ_ ? str : str + cst$2;
        return caml_special_val(_e0_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _eU_ = l - 1 | 0, _eT_ = 0;
        if(_eU_ >= 0){
         var i = _eT_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _eV_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _eV_);
          var _eW_ = i + 1 | 0;
          if(_eU_ === i) break;
          i = _eW_;
         }
       ...
       return caml_string_of_bytes(_eX_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _eQ_ = fmt$0[1];
        if(0 === _eQ_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _eQ_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _eQ_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _eR_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _eR_);
     }
    }
   }
   ...
   function other_fields(x, i){
    ...
    var _eL_ = other_fields(x, i + 1 | 0), _eM_ = field(x, i);
    return caml_call2(sprintf(_bj_), _eM_, _eL_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_eK_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _eG_ = other_fields(e, 2),
       _eH_ = field(e, 1),
       _eJ_ = caml_call2(sprintf(_bk_), _eH_, _eG_);
     else
      switch(match){
        case 0:
         var _eJ_ = _bl_; break;
        case 1:
         var _eJ_ = _bm_; break;
        default:
         var _eI_ = field(e, 1), _eJ_ = caml_call1(sprintf(_bn_), _eI_);
      }
     var match$0 = [0, constructor, [0, _eJ_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _ew_ = slot[4],
        _ex_ = slot[3],
        _ey_ = slot[6] ? _bx_ : _bz_,
        _ez_ = slot[2],
        _eA_ = slot[7],
        _eB_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_by_), _eB_, _eA_, _ez_, _ey_, _ex_, _ew_, _ev_)];
      else if(slot[1])
       var match = 0;
      else
       var _eC_ = info(0), match = [0, caml_call1(sprintf(_bA_), _eC_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_et_){}
      try{
       var _ej_ = to_string(exn$0);
       caml_call1(eprintf(_bC_), _ej_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _ek_ = abs(status);
        prerr_endline(caml_check_bound(errors, _ek_)[1 + _ek_]);
       }
       var _el_ = caml_ml_flush(stderr), _ep_ = _el_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _en_ = to_string(exn$0);
       caml_call1(eprintf(_bE_), _en_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eo_ = to_string(exn);
       caml_call1(eprintf(_bF_), _eo_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _ep_ = caml_ml_flush(stderr);
      }
      var _eq_ = _ep_;
     }
     catch(_es_){
      var _em_ = caml_wrap_exception(_es_);
      if(_em_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_em_, 0);
      var _eq_ = prerr_endline(_bD_);
     }
     return _eq_;
    }
    catch(_er_){return 0;}
   ...
   function mk(i1, i2, i3$0, i4$0){
    ...
    var i3 = caml_notequal(i3$0, _bH_) ? i3$0 : _bK_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bI_) ? i4$0 : _bJ_;
    caml_ba_set_1(s, 3, i4);
    return s;
   }
   var
    _bL_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bM_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bN_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bO_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520);
   function split(s){
    var
     i1 = caml_lxm_next(s),
     i2 = caml_lxm_next(s),
   ...
   function mk_default(param){return mk(_bO_, _bN_, _bM_, _bL_);}
   ...
   var
    ...
    _bQ_ = "script",
    _bP_ = cst_canvas,
    _bR_ = [0, "lib/js_of_ocaml/regexp.ml", 34, 64],
    _bS_ = "[\\][()\\\\|+*.?{}^$]",
    _bT_ = "Js_of_ocaml__Url.Local_exn",
    _ca_ = [0, 0],
    _cb_ = [0, 1],
    _b__ = [0, 0],
    _b$_ = [0, 1],
    ...
    _b0_ = [0, 0],
    _bW_ = cst_Fatal_error_exception,
    ...
    _cA_ = [0, [11, cst_fetching_model, 0], cst_fetching_model],
    _cz_ = [0, [8, [0, 0, 0], 0, [0, 1], 0], "%.1f"],
    _cs_ = [0, [11, cst_init_canvas, 0], cst_init_canvas],
    _ct_ = [0, [11, cst_create_program, 0], cst_create_program],
    _cu_ = "fragment-shader",
    _cv_ = "vertex-shader",
    _cw_ = [0, [11, cst_use_program, 0], cst_use_program],
    _cx_ = [0, [11, cst_program_loaded, 0], cst_program_loaded],
    _cy_ = [0, [11, cst_ready, 0], cst_ready],
    _cr_ = "\n",
    _cq_ = [0, 1, [0, 2, [0, 3, [0, 4, 0]]]],
    _cp_ = [0, 1, [0, 2, 0]],
    _cm_ =
      [0,
    ...
    _ci_ = [0, [11, cst_WebGL_error, 0], cst_WebGL_error],
    _cn_ = "(v|vn|f)\\ ([^\\ ]+)\\ ([^\\ ]+)\\ ([^\\ ]+)",
    _co_ = "([0-9]+)//([0-9]+)",
   ...
   function canvas(e){return unsafeCoerce(_bP_, e);}
   function script(e){return unsafeCoerce(_bQ_, e);}
   global.FormData;
   global.FormData;
   ({alpha: true$0,
     depth: true$0,
   ...
   function string_match(t10, s, t9){
    ...
    var
     ...
     _ei_ = x == no_handler ? no_handler : x;
    return to_option(_ei_);
   }
   ...
   var
    ...
    quote_re = regexp(_bS_),
    Local_exn = [248, _bT_, caml_fresh_oo_id(0)];
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _bV_ = caml_wrap_exception(_ef_);
    if(_bV_[1] !== Failure) throw caml_maybe_attach_backtrace(_bV_, 0);
   }
   var
     ...
     a:
     {
      ...
      if(0 <= ofs && lim >= ofs){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _ed_ = i; break a;}
        var i$0 = i + 1 | 0;
        i = i$0;
       }
      }
      var _ed_ = invalid_arg(_n_);
     }
     var j = _ed_;
    }
    catch(_ee_){
   ...
   if(a && a[1] === cst){
    var _bU_ = a[2];
    if(! _bU_ || _bU_[1] === cst && ! _bU_[2]) break a;
   }
   var
   ...
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
         ...
         case$1
          (arr[idx$0],
           ...
           function(s){
            ...
            if(0 <= index)
             var
              _d__ = s.slice(index + 1 | 0),
              _d$_ = [0, s.slice(0, index), _d__];
            else
             var _d$_ = undefined$0;
            return case$1(_d$_, interrupt, _ea_);
           }),
         acc],
        idx$0 - 1 | 0);
      return;
      ...
      var _d8_ = caml_wrap_exception(_d9_);
      if(_d8_ !== Local_exn) throw caml_maybe_attach_backtrace(_d8_, 0);
      var idx$1 = idx$0 - 1 | 0;
      idx$0 = idx$1;
     }
    }
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_b4_, 0, outer_promise, p[1]);
      case 2:
       var
        p_callbacks = match[1],
   ...
   function check_error(gl){
    ...
    return _d0_ ? error(_ci_) : _d0_;
   }
   function load_shader(t15, shader, text){
    t15.shaderSource(shader, text);
    t15.compileShader(shader);
    var _dX_ = 1 - (t15.getShaderParameter(shader, t15.COMPILE_STATUS) | 0);
    if(! _dX_) return _dX_;
    var _dY_ = caml_string_of_jsstring(t15.getShaderInfoLog(shader));
    return caml_call2(error(_ck_), caml_string_of_jsstring(text), _dY_);
   }
     ...
     script$0 =
       get
        (bind
         ...
         function(param){return caml_call1(error(_cm_), src_id);});
   ...
   function mult(m1, m2){
    function v(p){
     var
      j = p % 4 | 0,
      i = p / 4 | 0,
      _dN_ = caml_array_get(m2, c$0(3, j)),
      _dO_ = caml_array_get(m1, c$0(i, 3)) * _dN_,
      _dP_ = caml_array_get(m2, c$0(2, j)),
      _dQ_ = caml_array_get(m1, c$0(i, 2)) * _dP_,
      _dR_ = caml_array_get(m2, c$0(1, j)),
      _dS_ = caml_array_get(m1, c$0(i, 1)) * _dR_,
      _dT_ = caml_array_get(m2, c$0(0, j));
     return caml_array_get(m1, c$0(i, 0)) * _dT_ + _dS_ + _dQ_ + _dO_;
    }
    return init(16, v);
   }
   var line_regexp = regexp(_cn_), couple_regexp = regexp(_co_);
   function read_coord_couple(c){
    var match = string_match(couple_regexp, c, 0);
    if(! match) return 0;
    var
     res = match[1],
     match$0 = map(function(_dM_){return matched_group(res, _dM_);}, _cp_);
    if(match$0){
     var _dI_ = match$0[1];
     if(_dI_){
      var _dJ_ = match$0[2];
   ...
   function concat(a){
    var r = [0, 0], _dF_ = a.length - 2 | 0, _dE_ = 0;
    if(_dF_ >= 0){
     var i = _dE_;
     for(;;){
    ...
    function next(param){
     for(;;){
      ...
      pos[1]++;
      var _dH_ = pos[1];
      l$1[1] = caml_check_bound(a, _dH_)[1 + _dH_];
     }
    }
   ...
   function start(param){
     ...
     canvas$0 =
       get
        (bind(document.getElementById(cst_canvas), canvas),
         function(param){return caml_call1(error(_cj_), canvas_id);});
    function _dx_(param){
     return ksprintf
             (function(s){
    ...
    try{
     var
      ...
      _dz_ = test(ctx) ? ctx : canvas$0.getContext("experimental-webgl"),
      _dy_ = _dz_;
    }
    catch(_dD_){var _dy_ = no_handler;}
    var t102 = get(_dy_, _dx_);
    debug(_ct_);
    var
     frag_src = get_source(_cu_),
     vert_src = get_source(_cv_),
    ...
    function f$0(param){
     ...
     var
      fps = 1. / accu * _dA_ * 1000.,
      t138 = caml_jsstring_of_string(caml_call1(sprintf(_cz_), fps));
     fps_text.data = t138;
   ...
   function go(param$2){
    ...
    function h(exn){
     ...
     return caml_call1(error(_cB_), _dw_);
    }
    try{
     var
      _cJ_ =
        function(s$0){
         ...
         for(;;){
          ...
          var accu$0 = [0, caml_string_of_jsbytes(x), accu];
          accu = accu$0;
          idx = idx$0;
         }
         var
         ...
         if(_cT_ >= 0){
          ...
          for(;;){
           ...
           if(match){
            ...
            var
             match$0 =
               map(function(_dv_){return matched_group(res$0, _dv_);}, _cq_);
            if(match$0){
             var _cV_ = match$0[1];
             if(_cV_){
              var _cW_ = _cV_[1];
                     ...
                     if(_c1_){
                      ...
                      if(_c2_ && ! _c1_[2]){
                       var
                        ...
                        y = _c0_[1],
                        x$0 = _cY_[1],
                        _c3_ = caml_float_of_string(z),
                        _c4_ = caml_float_of_string(y),
                        match$2 =
                          [0, [1, [0, caml_float_of_string(x$0), _c4_, _c3_]]];
                       break a;
                      }
                     }
                    }
                    ...
                    if(_c9_){
                     ...
                     if(_c__ && ! _c9_[2]){
                      var
                       ...
                       y$0 = _c8_[1],
                       x$1 = _c6_[1],
                       _c$_ = caml_float_of_string(z$0),
                       _da_ = caml_float_of_string(y$0),
                       match$2 =
                         [0, [0, [0, caml_float_of_string(x$1), _da_, _c$_]]];
                      break a;
                     }
                    }
                   }
             ...
             (face$0.length - 1,
              function(i){
               var
                ...
                av = _dr_[1][1],
                _ds_ = av - 1 | 0,
                match = caml_check_bound(vertex$2, _ds_)[1 + _ds_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dt_ = bv - 1 | 0,
                match$0 = caml_check_bound(vertex$2, _dt_)[1 + _dt_],
                b3 = match$0[3],
                b2 = match$0[2],
                b1 = match$0[1],
                _du_ = cv - 1 | 0,
                match$1 = caml_check_bound(vertex$2, _du_)[1 + _du_],
                c3 = match$1[3],
                c2 = match$1[2],
                c1 = match$1[1];
               return [0,
          ...
          norm =
            init
             (face$0.length - 1,
              function(i){
               var
                _dn_ = caml_check_bound(face$0, i)[1 + i],
                cn = _dn_[3][2],
                bn = _dn_[2][2],
                an = _dn_[1][2],
                _do_ = an - 1 | 0,
                match = caml_check_bound(norm$2, _do_)[1 + _do_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dp_ = bn - 1 | 0,
                match$0 = caml_check_bound(norm$2, _dp_)[1 + _dp_],
                b3 = match$0[3],
                b2 = match$0[2],
                b1 = match$0[1],
                _dq_ = cn - 1 | 0,
                match$1 = caml_check_bound(norm$2, _dq_)[1 + _dq_],
                c3 = match$1[3],
                c2 = match$1[2],
                c1 = match$1[1];
               return [0,
     ...
     try{
      var
       _cI_ = return$0(caml_read_file_content(cst_monkey_model)),
       _cK_ = _cI_;
     }
     catch(_cN_){
      ...
      var
       content_type$2 = 0,
       check_headers = function(param, _cR_){return 1;},
       contents = 0,
       _cH_ = function(s){return s;},
       _cF_ =
         function(r){
          var cod = r[2], msg = r[4];
      ...
      if(contents){
       ...
       if(-836918635 === match$0[1]){
        ...
        if(891486873 <= form[1])
         ...
         var content_type$0 = content_type$2, method$0 = _cf_;
       }
       else
        var content_type$0 = content_type$2, method$0 = _cg_;
      }
      else
      ...
      if(contents){
       var match$2 = contents[1], _cE_ = match$2[1];
       if(-836918635 === _cE_){
            ...
            map
             (function(param){
               ...
               if(781515420 <= match[1]){
                var
                 t0 = match[2],
                 _cO_ = cst$4 + urlencode(0, caml_string_of_jsstring(t0.name));
                return urlencode(0, name) + _cO_;
               }
               var
                s = match[2],
                _cP_ = cst$4 + urlencode(0, caml_string_of_jsstring(s));
               return urlencode(0, name) + _cP_;
              },
              l$2);
         if(l$0){
          ...
          a:
          {
           ...
           var _cC_ = caml_ml_string_length(hd) + acc | 0;
          }
          var dst = caml_create_bytes(_cC_);
          a:
          {
           b:
           {
          ...
          var _cD_ = caml_string_of_bytes(dst);
         }
         else
          var _cD_ = _m_;
         req.send(caml_jsstring_of_string(_cD_));
        }
        else{var f$0 = match$3[2]; req.send(f$0);}
       }
       else if(737307005 <= _cE_){
        var b = match$2[2];
        req.send(b);
       }
      ...
      var _cK_ = symbol(symbol_bind(res, _cF_), _cH_);
     }
     var _cL_ = symbol_bind(symbol(_cK_, _cJ_), start), p = _cL_;
    }
