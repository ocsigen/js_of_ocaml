...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      if(_dC_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_dC_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _dz_ = l - 1 | 0, _dy_ = 1;
    if(_dz_ >= 1){
     var i = _dy_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _dx_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _dw_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _dw_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _du_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _du_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dv_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dv_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dv_[1];
   ...
   function fix_padding(padty, width, str){
    ...
    var _dr_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _dr_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dj_ = caml_ml_bytes_length(b) - 1 | 0,
     _di_ = 0;
    if(_dj_ >= 0){
     var i$0 = _di_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _dl_ = caml_ml_bytes_length(b) - 1 | 0, _dk_ = 0;
     if(_dl_ >= 0){
      var i = _dk_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _c7_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _c7_ >>> 0){
           if(55 === _c7_) break a;
          }
          else if(21 < _c7_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _cZ_ = fmt$0[1];
        if(0 === _cZ_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _cZ_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _cZ_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _c0_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _c0_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _cX_ = [8, acc, _a8_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _cX_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _cX_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _cW_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _cW_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _cW_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _cU_ = other_fields(x, i + 1 | 0), _cV_ = field(x, i);
    return caml_call2(sprintf(_bf_), _cV_, _cU_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_cT_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _cP_ = other_fields(e, 2),
       _cQ_ = field(e, 1),
       _cS_ = caml_call2(sprintf(_bg_), _cQ_, _cP_);
     else
      switch(match){
        case 0:
         var _cS_ = _bh_; break;
        case 1:
         var _cS_ = _bi_; break;
        default:
         var _cR_ = field(e, 1), _cS_ = caml_call1(sprintf(_bj_), _cR_);
      }
     var match$0 = [0, constructor, [0, _cS_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _cF_ = slot[4],
        _cG_ = slot[3],
        _cH_ = slot[6] ? _bt_ : _bv_,
        _cI_ = slot[2],
        _cJ_ = slot[7],
        _cK_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bu_), _cK_, _cJ_, _cI_, _cH_, _cG_, _cF_, _cE_)];
      else if(slot[1])
       var match = 0;
      else
       var _cL_ = info(0), match = [0, caml_call1(sprintf(_bw_), _cL_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cC_){}
      try{
       var _cs_ = to_string(exn$0);
       caml_call1(eprintf(_by_), _cs_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _ct_ = abs(status);
        prerr_endline(caml_check_bound(errors, _ct_)[1 + _ct_]);
       }
       var _cu_ = caml_ml_flush(stderr), _cy_ = _cu_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cw_ = to_string(exn$0);
       caml_call1(eprintf(_bA_), _cw_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cx_ = to_string(exn);
       caml_call1(eprintf(_bB_), _cx_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _cy_ = caml_ml_flush(stderr);
      }
      var _cz_ = _cy_;
     }
     catch(_cB_){
      var _cv_ = caml_wrap_exception(_cB_);
      if(_cv_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cv_, 0);
      var _cz_ = prerr_endline(_bz_);
     }
     return _cz_;
    }
    catch(_cA_){return 0;}
   ...
   var
    ...
    _bF_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bG_ = caml_int64_create_lo_mi_hi(1, 0, 0);
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bC_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bD_) ? i3 : _bG_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bE_) ? i4 : _bF_;
   ...
   var random_key = new_key([0, split], mk_default), _bN_ = "Random.int";
   function int$0(bound){
    ...
    return invalid_arg(_bN_);
   }
   var
    Error = [248, "Jsoo_runtime.Error.Exn", caml_fresh_oo_id(0)],
    exn = [0, Error, [0]],
    _bS_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b2_ = [0, 0],
    _b3_ = [0, 1],
    _b0_ = [0, 0],
    _b1_ = [0, 1],
   ...
   global.document;
   var
    Canvas_not_available = [248, _bS_, caml_fresh_oo_id(0)],
   ...
   var
    d2 = bytes(b),
    _bJ_ = get_int64_le(d2, 8),
    _bK_ = get_int64_le(d2, 0),
    _bL_ = get_int64_le(d1, 8);
   set(s$0, get_int64_le(d1, 0), _bL_, _bK_, _bJ_);
