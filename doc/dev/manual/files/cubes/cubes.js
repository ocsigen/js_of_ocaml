...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _dy_ = caml_wrap_exception(_dz_);
      if(_dy_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_dy_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _dv_ = l - 1 | 0, _du_ = 1;
    if(_dv_ >= 1){
     var i = _du_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _dt_){return 0;});
   ...
   var
    ...
    _J_ = "%r",
    _K_ = "%_r",
    _L_ = [0, cst_camlinternalFormat_ml, 850, 23],
    _M_ = [0, cst_camlinternalFormat_ml, 837, 26],
    _N_ = [0, cst_camlinternalFormat_ml, 847, 28],
    _O_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _P_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _Q_ = [0, cst_camlinternalFormat_ml, 823, 19],
    _R_ = [0, cst_camlinternalFormat_ml, 827, 22],
    _S_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _U_ = [0, cst_camlinternalFormat_ml, 851, 23],
    _V_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _W_ = [0, cst_camlinternalFormat_ml, 846, 28],
    _X_ = [0, cst_camlinternalFormat_ml, 814, 21],
    _Y_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _Z_ = [0, cst_camlinternalFormat_ml, 822, 19],
    ___ = [0, cst_camlinternalFormat_ml, 826, 22],
    _$_ = [0, cst_camlinternalFormat_ml, 831, 30];
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _ds_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _ds_];
                  case 10:
                   break a;
                  case 11:
                   break b;
   ...
   var
    ...
    _a1_ = "infinity",
    _a2_ = "nan",
    _a3_ = [0, cst_camlinternalFormat_ml, 1558, 4],
    _a4_ = "Printf: bad conversion %[",
    _a5_ = [0, cst_camlinternalFormat_ml, 1626, 39],
    _a6_ = [0, cst_camlinternalFormat_ml, 1649, 31],
    _a7_ = [0, cst_camlinternalFormat_ml, 1650, 31],
    _a8_ = "Printf: bad conversion %_",
    _a9_ = cst,
    _a__ = cst$0,
    _a$_ = cst,
    _ba_ = cst$0;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dr_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dr_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dr_[1];
   ...
   function string_to_caml_string(str){
    ...
    var
     str$0 = caml_string_of_bytes(_dm_),
   ...
   function convert_float(fconv, prec, x){
    ...
    function caml_special_val(str){
     ...
     return 3 === match ? x < 0. ? _a0_ : _a1_ : 4 <= match ? _a2_ : str;
    }
    switch(fconv[2]){
      case 5:
       var
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _c3_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _c3_ >>> 0){
           if(55 === _c3_) break a;
          }
          else if(21 < _c3_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _cV_ = fmt$0[1];
        if(0 === _cV_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _cV_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _cV_[1][1];
       ...
       case 20:
        var rest$19 = fmt$0[3], new_acc = [8, acc$0, _a4_];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _cW_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _cW_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _cT_ = [8, acc, _a8_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _cT_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _cT_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _cS_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _cS_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _cS_, rest);
   }
   ...
   var
    ...
    _bb_ = [0, [3, 0, 0], "%S"],
    _bc_ = "_",
    _bd_ = [0, [4, 0, 0, 0, 0], cst_d],
    _be_ = cst$1,
    _bf_ = [0, [11, ", ", [2, 0, [2, 0, 0]]], ", %s%s"],
    _bg_ = [0, [12, 40, [2, 0, [2, 0, [12, 41, 0]]]], "(%s%s)"],
    _bh_ = cst$1,
    _bi_ = cst$1,
    _bj_ = [0, [12, 40, [2, 0, [12, 41, 0]]], "(%s)"],
    _bk_ = "Out of memory",
    _bl_ = "Stack overflow",
    _bm_ = "Pattern matching failed",
    _bn_ = "Assertion failed",
    _bo_ = "Undefined recursive module",
    _bp_ = "Raised at",
    _bq_ = "Re-raised at",
    _br_ = "Raised by primitive operation at",
    _bs_ = "Called from",
    _bt_ = " (inlined)",
    _bu_ =
      [0,
    ...
    _bv_ = cst$1,
    _bw_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bx_ = [0, [2, 0, [12, 10, 0]], "%s\n"];
   function field(x, i$1){
    var f = x[1 + i$1];
    if(! (1 - (typeof f === "number" ? 1 : 0)))
     return caml_call1(sprintf(_bd_), f);
    if(caml_obj_tag(f) === 252) return caml_call1(sprintf(_bb_), f);
    if(caml_obj_tag(f) !== 253) return _bc_;
    var
   ...
   function other_fields(x, i){
    if(x.length - 1 <= i) return _be_;
    var _cQ_ = other_fields(x, i + 1 | 0), _cR_ = field(x, i);
    return caml_call2(sprintf(_bf_), _cR_, _cQ_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_cP_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(e === Out_of_memory) return _bk_;
    if(e === Stack_overflow) return _bl_;
    if(e[1] === Match_failure){
     var
      ...
      file = match$1[1];
     return caml_call5
             (sprintf(locfmt), file, line, char$0, char$0 + 5 | 0, _bm_);
    }
    if(e[1] === Assert_failure){
     var
      ...
      file$0 = match$2[1];
     return caml_call5
             (sprintf(locfmt), file$0, line$0, char$1, char$1 + 6 | 0, _bn_);
    }
    if(e[1] === Undefined_recursive_module){
     var
      ...
      file$1 = match$3[1];
     return caml_call5
             (sprintf(locfmt), file$1, line$1, char$2, char$2 + 6 | 0, _bo_);
    }
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _cM_ = field(e, 1),
       _cO_ = caml_call2(sprintf(_bg_), _cM_, _cL_);
     else
      switch(match){
        case 0:
         var _cO_ = _bh_; break;
        case 1:
         var _cO_ = _bi_; break;
        default:
         var _cN_ = field(e, 1), _cO_ = caml_call1(sprintf(_bj_), _cN_);
      }
     var match$0 = [0, constructor, [0, _cO_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _cB_ = slot[4],
        _cC_ = slot[3],
        _cD_ = slot[6] ? _bt_ : _bv_,
        _cE_ = slot[2],
        _cF_ = slot[7],
        _cG_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bu_), _cG_, _cF_, _cE_, _cD_, _cC_, _cB_, _cA_)];
      else if(slot[1])
       var match = 0;
      else
       var _cH_ = info(0), match = [0, caml_call1(sprintf(_bw_), _cH_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bx_), str);}
      var _cK_ = pos + 1 | 0;
      if(_cJ_ === pos) break;
      pos = _cK_;
     }
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cy_){}
      try{
       var _co_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _co_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cp_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cp_)[1 + _cp_]);
       }
       var _cv_ = caml_ml_flush(stderr), _ct_ = _cv_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cr_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _cr_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cs_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _cs_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _ct_ = caml_ml_flush(stderr);
      }
      var _cu_ = _ct_;
     }
     catch(_cx_){
      var _cq_ = caml_wrap_exception(_cx_);
      if(_cq_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cq_, 0);
      var _cu_ = prerr_endline(_by_);
     }
     return _cu_;
    }
    catch(_cw_){return 0;}
   ...
   var
    ...
    _bC_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bD_ = caml_int64_create_lo_mi_hi(1, 0, 0);
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bz_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bA_) ? i3 : _bD_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bB_) ? i4 : _bC_;
   ...
   var random_key = new_key([0, split], mk_default), _bK_ = "Random.int";
   ...
   var
    ...
    exn = [0, Error, [0]],
    _bP_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _bY_ = [0, 0],
    _bZ_ = [0, 1],
    _bW_ = [0, 0],
    _bX_ = [0, 1],
    ...
    _bT_ = [0, 0],
    _bQ_ = "Lwt.Resolution_loop.Canceled",
    _b0_ = "Exception during Lwt.async: ",
   ...
   global.document;
   var
    Canvas_not_available = [248, _bP_, caml_fresh_oo_id(0)],
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cn_ = caml_call1(f, v); return _cn_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _bQ_, caml_fresh_oo_id(0)];
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cm_ = result[1] === Canceled ? 1 : 0, is_canceled = _cm_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      if(! _cl_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cl_[1];
      if(_cl_[2]){
       var next = _cl_[2];
   ...
   var
    d2 = bytes(b),
    _bG_ = get_int64_le(d2, 8),
    _bH_ = get_int64_le(d2, 0),
    _bI_ = get_int64_le(d1, 8);
   set(s$0, get_int64_le(d1, 0), _bI_, _bH_, _bG_);
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i$1)[1 + i$1], _cc_)
             [1 + _cc_],
            k$1)
          [1 + k$1])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, _b$_)[1 + _b$_], j$0)
             [1 + j$0],
            k$0)
          [1 + k$0])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], _b8_)
          [1 + _b8_])
        break;
       k[1]--;
      }
   ...
   function loop(c$0, c, a){
    ...
    function callback$0(v){
     var result$0 = [0, v], p$0 = underlying(p), _b3_ = p$0[1];
     switch(_b3_[0]){
       case 1:
        return _b3_[1] === Canceled
                ? 0
                : caml_call1(ksprintf(invalid_arg, _bS_), api_function_name);
       case 2:
        if(0 === result$0[0])
         var x = result$0[1], result = [0, x];
        else
         var exn = result$0[1], result = [1, exn];
        resolve(_bT_, 0, p$0, result);
        return 0;
       default:
        return caml_call1(ksprintf(invalid_arg, _bR_), api_function_name);
     }
    }
    var id = [0, 0];
    function loop$0(d, param){
     ...
     var
      cb =
        remain == 0.
         ? callback$0
         : function(_b2_){return loop$0(remain, _b2_);},
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       var p$0 = underlying(p);
       resolve(_bW_, 0, p$0, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _b1_ = f$0(v), user_provided_promise = _b1_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p1 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_bV_, 0, outer_promise, p1[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          p1[1] = state;
          break;
         default: resolve(_bU_, 0, outer_promise, p1[1]);
       }
      }
      return 0;
     }
