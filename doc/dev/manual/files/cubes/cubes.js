...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _dF_ = caml_wrap_exception(_dG_);
      if(_dF_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_dF_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _dC_ = l - 1 | 0, _dB_ = 1;
    if(_dC_ >= 1){
     var i = _dB_;
     for(;;){
   ...
   var key_counter = [0, 0], parent_keys = [0, 0], _n_ = "Array.blit";
   ...
   var at_exit_key = new_key(0, function(param, _dA_){return 0;});
   ...
   function string_of_formatting_lit(formatting_lit){
    ...
    switch(formatting_lit[0]){
      ...
      default:
       ...
       return symbol(_v_, caml_string_of_bytes(make(1, c)));
    }
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _dz_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _dz_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _dx_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _dx_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dy_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dy_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dy_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _dv_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _dv_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _dw_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _dw_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _du_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _du_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dm_ = caml_ml_bytes_length(b) - 1 | 0,
     _dl_ = 0;
    if(_dm_ >= 0){
     var i$0 = _dl_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _do_ = caml_ml_bytes_length(b) - 1 | 0, _dn_ = 0;
     if(_do_ >= 0){
      var i = _dn_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var
     ...
     _di_ = caml_ml_string_length(s) - 1 | 0,
     _dh_ = 0;
    if(_di_ >= 0){
     var i = _dh_;
     for(;;){
   ...
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dc_ = _aS_; break;
      default: var _dc_ = _a1_;
    }
    return transform_int_alt(iconv, caml_format_int(_dc_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _db_ = _as_; break;
      default: var _db_ = _aB_;
    }
    return transform_int_alt(iconv, caml_int64_format(_db_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _c__ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _c__ >>> 0){
           if(55 === _c__) break a;
          }
          else if(21 < _c__ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _c$_ = 1;
        }
        var _da_ = _c$_ ? str : symbol(str, _a2_);
        return caml_special_val(_da_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _c6_ = l - 1 | 0, _c5_ = 0;
        if(_c6_ >= 0){
         var i = _c5_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _c7_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _c7_);
          var _c8_ = i + 1 | 0;
          if(_c6_ === i) break;
          var i = _c8_;
         }
       ...
       return caml_string_of_bytes(_c9_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _c4_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _c4_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _c4_[1];
       ...
       case 18:
        var _c2_ = fmt$0[1];
        if(0 === _c2_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _c2_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _c2_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _c3_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _c3_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _c0_ = [8, acc, _a$_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c0_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c0_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _cZ_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _cZ_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _cZ_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _cX_ = other_fields(x, i + 1 | 0), _cY_ = field(x, i);
    return caml_call2(sprintf(_bi_), _cY_, _cX_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_cW_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _cS_ = other_fields(e, 2),
       _cT_ = field(e, 1),
       _cV_ = caml_call2(sprintf(_bj_), _cT_, _cS_);
     else
      switch(match){
        case 0:
         var _cV_ = _bk_; break;
        case 1:
         var _cV_ = _bl_; break;
        default:
         var _cU_ = field(e, 1), _cV_ = caml_call1(sprintf(_bm_), _cU_);
      }
     var match$0 = [0, constructor, [0, _cV_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _cI_ = slot[4],
        _cJ_ = slot[3],
        _cK_ = slot[6] ? _bw_ : _by_,
        _cL_ = slot[2],
        _cM_ = slot[7],
        _cN_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bx_), _cN_, _cM_, _cL_, _cK_, _cJ_, _cI_, _cH_)];
      else if(slot[1])
       var match = 0;
      else
       var _cO_ = info(0), match = [0, caml_call1(sprintf(_bz_), _cO_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cF_){}
      try{
       var _cv_ = to_string(exn$0);
       caml_call1(eprintf(_bB_), _cv_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cw_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cw_)[1 + _cw_]);
       }
       var _cx_ = caml_ml_flush(stderr), _cB_ = _cx_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cz_ = to_string(exn$0);
       caml_call1(eprintf(_bD_), _cz_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cA_ = to_string(exn);
       caml_call1(eprintf(_bE_), _cA_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _cB_ = caml_ml_flush(stderr);
      }
      var _cC_ = _cB_;
     }
     catch(_cE_){
      var _cy_ = caml_wrap_exception(_cE_);
      if(_cy_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cy_, 0);
      var _cC_ = prerr_endline(_bC_);
     }
     return _cC_;
    }
    catch(_cD_){return 0;}
   ...
   var
    ...
    _bI_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bJ_ = caml_int64_create_lo_mi_hi(1, 0, 0);
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bF_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bG_) ? i3 : _bJ_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bH_) ? i4 : _bI_;
   ...
   var random_key = new_key([0, split], mk_default), _bQ_ = "Random.int";
   ...
   var
    ...
    exn = [0, Error, [0]],
    _bV_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b5_ = [0, 0],
    _b6_ = [0, 1],
    _b3_ = [0, 0],
    _b4_ = [0, 1],
    ...
    _b7_ = "Exception during Lwt.async: ",
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cu_ = caml_call1(f, v); return _cu_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _ct_ = result[1] === Canceled ? 1 : 0, is_canceled = _ct_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cs_ = deferred_callbacks[2];
      if(! _cs_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cs_[1];
      if(_cs_[2]){
       var next = _cs_[2];
   ...
   var
    d2 = bytes(b),
    _bM_ = get_int64_le(d2, 8),
    _bN_ = get_int64_le(d2, 0),
    _bO_ = get_int64_le(d1, 8);
   set(s$0, get_int64_le(d1, 0), _bO_, _bN_, _bM_);
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i$1)[1 + i$1], _cj_)
             [1 + _cj_],
            k$1)
          [1 + k$1])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, _cg_)[1 + _cg_], j$0)
             [1 + j$0],
            k$0)
          [1 + k$0])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], _cd_)
          [1 + _cd_])
        break;
       k[1] += -1;
      }
   ...
   function loop(c$0, c, a){
    ...
    function callback$0(v){
     var result$0 = [0, v], p$0 = underlying(p), _b__ = p$0[1];
     switch(_b__[0]){
       case 1:
        return _b__[1] === Canceled
                ? 0
    ...
    function loop$0(d, param){
     ...
     var
      cb =
        remain == 0.
         ? callback$0
         : function(_b9_){return loop$0(remain, _b9_);};
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_b3_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _b8_ = f$0(v), user_provided_promise = _b8_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_b2_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_b1_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
