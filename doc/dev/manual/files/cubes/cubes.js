...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _dG_ = caml_wrap_exception(_dH_);
      if(_dG_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_dG_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function init(l, f){
    if(0 === l) return [0];
    if(0 > l) return invalid_arg(_l_);
    var res = caml_make_vect(l, caml_call1(f, 0)), _dD_ = l - 1 | 0, _dC_ = 1;
    if(_dD_ >= 1){
     var i = _dC_;
     for(;;){
   ...
   function get(param){
    ...
    for(;;){
     ...
     var
      ...
      _dB_ = curval === oldval ? (st$1[1 + idx] = new_obj, 1) : 0;
     if(_dB_) return new_obj;
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _dA_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _dA_];
                  case 10:
                   break a;
                  case 11:
                   break b;
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _dn_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _dm_ = 0;
    if(_dn_ >= 0){
     var i$0 = _dm_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _dp_ = caml_ml_bytes_length(s$0) - 1 | 0, _do_ = 0;
     if(_dp_ >= 0){
      var i = _do_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_du_),
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _c$_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _c$_ >>> 0){
           if(55 === _c$_) break a;
          }
          else if(21 < _c$_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
      ...
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _c7_ = l - 1 | 0, _c6_ = 0;
        if(_c7_ >= 0){
         var i = _c6_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s$0, i),
           _c8_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _c8_);
          var _c9_ = i + 1 | 0;
          if(_c7_ === i) break;
          i = _c9_;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _c5_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _c5_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _c5_[1];
       ...
       case 18:
        var _c3_ = fmt$0[1];
        if(0 === _c3_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _c3_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _c3_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _c4_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _c4_);
     }
    }
   }
   ...
   function other_fields(x, i){
    ...
    var _cY_ = other_fields(x, i + 1 | 0), _cZ_ = field(x, i);
    return caml_call2(sprintf(_bg_), _cZ_, _cY_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_cX_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _cT_ = other_fields(e, 2),
       _cU_ = field(e, 1),
       _cW_ = caml_call2(sprintf(_bh_), _cU_, _cT_);
     else
      switch(match){
        case 0:
         var _cW_ = _bi_; break;
        case 1:
         var _cW_ = _bj_; break;
        default:
         var _cV_ = field(e, 1), _cW_ = caml_call1(sprintf(_bk_), _cV_);
      }
     var match$0 = [0, constructor, [0, _cW_]];
    }
    else
     var match$0 = [0, e[1], 0];
   ...
   function print_raw_backtrace(outchan, raw_backtrace){
    ...
    if(_cR_ >= 0){
     ...
     for(;;){
      ...
      if(0 === slot[0]){
       if(slot[3] === slot[6])
        var _cG_ = slot[3], lines = caml_call1(sprintf(_bu_), _cG_);
       else
        var
         _cN_ = slot[6],
         _cO_ = slot[3],
         lines = caml_call2(sprintf(_by_), _cO_, _cN_);
       var
        _cH_ = slot[7],
        _cI_ = slot[4],
        _cJ_ = slot[8] ? _bv_ : _bx_,
        _cK_ = slot[2],
        _cL_ = slot[9],
        _cM_ = info(slot[1]),
        match =
          [0,
           caml_call7
            (sprintf(_bw_), _cM_, _cL_, _cK_, _cJ_, lines, _cI_, _cH_)];
      }
      else if(slot[1])
       var match = 0;
      else
       var _cP_ = info(0), match = [0, caml_call1(sprintf(_bz_), _cP_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cE_){}
      try{
       var _cu_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _cu_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cv_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cv_)[1 + _cv_]);
       }
       var _cB_ = caml_ml_flush(stderr), _cz_ = _cB_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cx_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _cx_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cy_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _cy_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _cz_ = caml_ml_flush(stderr);
      }
      var _cA_ = _cz_;
     }
     catch(_cD_){
      var _cw_ = caml_wrap_exception(_cD_);
      if(_cw_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cw_, 0);
      var _cA_ = prerr_endline(_bB_);
     }
     return _cA_;
    }
    catch(_cC_){return 0;}
   ...
   function BLAKE2(X){
    var _cs_ = X[1] < 1 ? 1 : 0, _ct_ = _cs_ || (64 < X[1] ? 1 : 0);
    if(_ct_) invalid_arg(_bC_);
   }
   BLAKE2([0, 16]);
   BLAKE2([0, 32]);
   BLAKE2([0, 64]);
   ...
   var random_key = new_key([0, split], mk_default), _bO_ = "Random.int";
    ...
    if(1073741823 >= bound && 0 < bound)
     for(;;){
      var
       ...
       v = caml_mod(r, bound);
      if(((1073741823 - bound | 0) + 1 | 0) >= (r - v | 0)) return v;
     }
    return invalid_arg(_bO_);
   }
   var
    Error = [248, "Jsoo_runtime.Error.Exn", caml_fresh_oo_id(0)],
    exn = [0, Error, [0]],
    _bT_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b2_ = [0, 0],
    _b3_ = [0, 1],
    _b0_ = [0, 0],
    _b1_ = [0, 1],
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cr_ = caml_call1(f, v); return _cr_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cq_ = result[1] === Canceled ? 1 : 0, is_canceled = _cq_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cp_ = deferred_callbacks[2];
      if(! _cp_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cp_[1];
      if(_cp_[2]){
       var next = _cp_[2];
   ...
   var
    d2 = bytes(b),
    _bK_ = get_int64_le(d2, 8),
    _bL_ = get_int64_le(d2, 0),
    _bM_ = get_int64_le(d1, 8);
   set(s$0, get_int64_le(d1, 0), _bM_, _bL_, _bK_);
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i$1)[1 + i$1], _cg_)
             [1 + _cg_],
            k$1)
          [1 + k$1])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, _cd_)[1 + _cd_], j$0)
             [1 + j$0],
            k$0)
          [1 + k$0])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], _ca_)
          [1 + _ca_])
        break;
       k[1]--;
      }
   ...
   function redraw(t135, canvas, a){
    var t113 = canvas.getContext(cst_2d);
   ...
   function loop(c$0, c, a){
    ...
    function callback$0(v){
     var result$0 = [0, v], p$0 = underlying(p), _b7_ = p$0[1];
     switch(_b7_[0]){
       case 1:
        return _b7_[1] === Canceled
                ? 0
    ...
    function loop$0(d, param){
     ...
     var
      cb =
        remain === 0.
         ? callback$0
         : function(_b6_){return loop$0(remain, _b6_);},
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       var p$0 = underlying(p);
       resolve(_b0_, 0, p$0, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _b5_ = f$0(v), user_provided_promise = _b5_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p1 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_bZ_, 0, outer_promise, p1[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          p1[1] = state;
          break;
         default: resolve(_bY_, 0, outer_promise, p1[1]);
       }
      }
      return 0;
     }
   ...
   function start(param){
    var
     ...
     t4 = t137.body;
    t4.appendChild(t139);
    var t141 = t139.getContext(cst_2d);
