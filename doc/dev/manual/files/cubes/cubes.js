...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      if(_dK_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_dK_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _dH_ = l - 1 | 0, _dG_ = 1;
    if(_dH_ >= 1){
     var i = _dG_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _dF_){return 0;});
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _dC_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _dC_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dD_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dD_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dD_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _dA_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _dA_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _dB_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _dB_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dr_ = caml_ml_bytes_length(b) - 1 | 0,
     _dq_ = 0;
    if(_dr_ >= 0){
     var i$0 = _dq_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _dt_ = caml_ml_bytes_length(b) - 1 | 0, _ds_ = 0;
     if(_dt_ >= 0){
      var i = _ds_;
      for(;;){
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _df_ = _de_ ? str : symbol(str, _a4_);
      ...
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _c$_ = l - 1 | 0, _c__ = 0;
        if(_c$_ >= 0){
         var i = _c__;
         for(;;){
          var
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _c9_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _c9_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _c9_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _c8_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _c8_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _c5_ = [8, acc, _bb_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c5_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c5_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _c4_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c4_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c4_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _c3_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _c3_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _c1_ = other_fields(x, i + 1 | 0), _c2_ = field(x, i);
    return caml_call2(sprintf(_bk_), _c2_, _c1_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_c0_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _cX_ = field(e, 1),
       _cZ_ = caml_call2(sprintf(_bl_), _cX_, _cW_);
     else
      switch(match){
        case 0:
         var _cZ_ = _bm_; break;
        case 1:
         var _cZ_ = _bn_; break;
        default:
         var _cY_ = field(e, 1), _cZ_ = caml_call1(sprintf(_bo_), _cY_);
      }
     var match$0 = [0, constructor, [0, _cZ_]];
    }
    else
     var match$0 = [0, e[1], 0];
    ...
    if(_cU_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _bu_ : _bv_ : 0 === pos$0 ? _bw_ : _bx_;
      }
      if(0 === slot[0])
       var
        _cL_ = slot[5],
        _cM_ = slot[4],
        _cN_ = slot[3],
        _cO_ = slot[6] ? _by_ : _bA_,
        _cP_ = slot[2],
        _cQ_ = slot[7],
        _cR_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _cR_, _cQ_, _cP_, _cO_, _cN_, _cM_, _cL_)];
      else if(slot[1])
       var match = 0;
      else
       var _cS_ = info(0), match = [0, caml_call1(sprintf(_bB_), _cS_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cJ_){}
      try{
       var _cz_ = to_string(exn$0);
       caml_call1(eprintf(_bE_), _cz_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cA_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cA_)[1 + _cA_]);
       }
       var _cB_ = caml_ml_flush(stderr), _cF_ = _cB_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cD_ = to_string(exn$0);
       caml_call1(eprintf(_bG_), _cD_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cE_ = to_string(exn);
       caml_call1(eprintf(_bH_), _cE_);
      ...
      var _cC_ = caml_wrap_exception(_cI_);
      if(_cC_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cC_, 0);
      var _cG_ = prerr_endline(_bF_);
     }
     return _cG_;
    }
    catch(_cH_){return 0;}
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i$1)[1 + i$1], _cn_)
             [1 + _cn_],
            k$1)
          [1 + k$1])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, _ck_)[1 + _ck_], j$0)
             [1 + j$0],
            k$0)
          [1 + k$0])
        break;
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], _ch_)
          [1 + _ch_])
        break;
       k[1] += -1;
      }
   ...
   function loop(c$0, c, a){
    ...
    function callback$0(v){
     var result$0 = [0, v], p$0 = underlying(p), _cc_ = p$0[1];
     switch(_cc_[0]){
       case 1:
    ...
    function loop$0(d, param){
     ...
     var
      cb =
        remain == 0.
         ? callback$0
         : function(_cb_){return loop$0(remain, _cb_);};
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _ca_ = f$0(v), user_provided_promise = _ca_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
