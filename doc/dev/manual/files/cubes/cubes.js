...
(function(globalThis){
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _d7_ = l - 1 | 0, _d6_ = 1;
    if(_d7_ >= 1){
     var i = _d6_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _d5_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _dK_ = function(param){af(0); return;};
        return [0, function(param){fa(0); return;}, _dK_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _dL_ = function(param){af$0(0); return;};
        return [0, function(param){fa$0(0); return;}, _dL_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _dM_ = function(param){af$1(0); return;};
        return [0, function(param){fa$1(0); return;}, _dM_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _dN_ = function(param){af$2(0); return;};
        return [0, function(param){fa$2(0); return;}, _dN_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _dO_ = function(param){af$3(0); return;};
        return [0, function(param){fa$3(0); return;}, _dO_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _dP_ = function(param){af$4(0); return;};
        return [0, function(param){fa$4(0); return;}, _dP_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _dQ_ = function(param){af$5(0); return;};
        return [0, function(param){fa$5(0); return;}, _dQ_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _dR_ = function(param){af$6(0); return;};
        return [0, function(param){fa$6(0); return;}, _dR_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _dS_ = function(param){af$7(0); return;};
        return [0, function(param){fa$7(0); return;}, _dS_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _dT_ = function(param){jd(0); de$8(0); return;},
         _dU_ = function(param){ed$8(0); dj(0); return;},
         _dV_ = function(param){ga(0); af$8(0); return;};
        return [0, function(param){fa$8(0); ag(0); return;}, _dV_, _dU_, _dT_];
       case 10:
        var
         rest$9 = param[1],
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _dW_ = function(param){af$9(0); return;};
        return [0, function(param){fa$9(0); return;}, _dW_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _dX_ = function(param){af$10(0); return;};
        return [0, function(param){fa$10(0); return;}, _dX_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _dY_ = function(param){af$11(0); return;};
        return [0, function(param){fa$11(0); return;}, _dY_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _dZ_ = function(param){de$12(0); return;},
         _d0_ = function(param){ed$12(0); return;},
         _d1_ = function(param){af$12(0); return;};
        return [0, function(param){fa$12(0); return;}, _d1_, _d0_, _dZ_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _d2_ = function(param){de$13(0); return;},
         _d3_ = function(param){ed$13(0); return;},
         _d4_ = function(param){af$13(0); return;};
        return [0, function(param){fa$13(0); return;}, _d4_, _d3_, _d2_];
     }
    function _dH_(param){return;}
    function _dI_(param){return;}
    function _dJ_(param){return;}
    return [0, function(param){return;}, _dJ_, _dI_, _dH_];
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _dG_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _dG_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _dE_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _dE_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dF_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dF_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dF_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _dC_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _dC_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _dD_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _dD_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _dB_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _dB_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dt_ = caml_ml_bytes_length(b) - 1 | 0,
     _ds_ = 0;
    if(_dt_ >= 0){
     var i$0 = _ds_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _dv_ = caml_ml_bytes_length(b) - 1 | 0, _du_ = 0;
     if(_dv_ >= 0){
      var i = _du_;
      for(;;){
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _dh_ = _dg_ ? str : symbol(str, _a4_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _c$_ = type_format_gen(fmt$0, fmtty$0);
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _c__]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _c__);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _c7_ = [8, acc, _bb_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c7_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c7_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _c6_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c6_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c6_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _c5_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _c5_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _c3_ = other_fields(x, i + 1 | 0), _c4_ = field(x, i);
    return caml_call2(sprintf(_bk_), _c4_, _c3_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_c2_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _cZ_ = field(e, 1),
       _c1_ = caml_call2(sprintf(_bl_), _cZ_, _cY_);
     else
      switch(match){
        case 0:
         var _c1_ = _bm_; break;
        case 1:
         var _c1_ = _bn_; break;
        default:
         var _c0_ = field(e, 1), _c1_ = caml_call1(sprintf(_bo_), _c0_);
      }
     var match$0 = [0, constructor, [0, _c1_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _cO_ = slot[4],
        _cP_ = slot[3],
        _cQ_ = slot[6] ? _by_ : _bA_,
        _cR_ = slot[2],
        _cS_ = slot[7],
        _cT_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _cT_, _cS_, _cR_, _cQ_, _cP_, _cO_, _cN_)];
      else if(slot[1])
       var match = 0;
      else
       var _cU_ = info(0), match = [0, caml_call1(sprintf(_bB_), _cU_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cL_){}
      try{
       var _cB_ = to_string(exn$0);
       caml_call1(eprintf(_bE_), _cB_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cC_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cC_)[1 + _cC_]);
       }
       var _cD_ = caml_ml_flush(stderr), _cH_ = _cD_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cF_ = to_string(exn$0);
       caml_call1(eprintf(_bG_), _cF_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cG_ = to_string(exn);
       caml_call1(eprintf(_bH_), _cG_);
      ...
      var _cE_ = caml_wrap_exception(_cK_);
      if(_cE_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cE_, 0);
      var _cI_ = prerr_endline(_bF_);
     }
     return _cI_;
    }
    catch(_cJ_){return 0;}
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cA_ = caml_call1(f, v); return _cA_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cz_ = result[1] === Canceled ? 1 : 0, is_canceled = _cz_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _cy_ = deferred_callbacks[2];
      if(! _cy_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _cy_[1];
      if(_cy_[2]){
       var next = _cy_[2];
    ...
    for(;;){
     ...
     for(;;){
      for(;;){
       ...
       if
        (caml_check_bound
           (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], _cj_)
          [1 + _cj_])
        break;
       k[1] += -1;
      }
   ...
   function loop(c$0, c, a){
    ...
    function callback$0(v){
     var result$0 = [0, v], p$0 = underlying(p), _ce_ = p$0[1];
     switch(_ce_[0]){
       case 1:
        return _ce_[1] === Canceled
                ? 0
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _cc_ = f$0(v), user_provided_promise = _cc_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_b8_, function(param){return f$0(v);}, _ca_);
    }
   }
