...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ef_ = caml_wrap_exception(_eg_);
      if(_ef_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ef_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function sub_string(b, ofs, len){
    a:
    {
     ...
     var _ee_ = invalid_arg(_i_);
    }
    return caml_string_of_bytes(_ee_);
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _ed_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_ed_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   var
    at_exit_key = new_key(0, function(param, _ec_){return 0;}),
    _n_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _eb_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _eb_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _d$_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _d$_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ea_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ea_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ea_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _d9_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _d9_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _d__ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _d__))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _d8_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _d8_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _d0_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _dZ_ = 0;
    if(_d0_ >= 0){
     var i$0 = _dZ_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _d2_ = caml_ml_bytes_length(s$0) - 1 | 0, _d1_ = 0;
     if(_d2_ >= 0){
      var i = _d1_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_d7_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dU_ = caml_ml_string_length(s) - 1 | 0, _dT_ = 0;
    if(_dU_ >= 0){
     var i$0 = _dT_;
     for(;;){
   ...
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dQ_ = _aR_; break;
      default: var _dQ_ = _a0_;
    }
    return transform_int_alt(iconv, caml_format_int(_dQ_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dP_ = _ar_; break;
      default: var _dP_ = _aA_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dP_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dM_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dM_ >>> 0){
           if(55 === _dM_) break a;
          }
          else if(21 < _dM_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dO_ = _dN_ ? str : str + cst$5;
        return caml_special_val(_dO_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dI_ = l - 1 | 0, _dH_ = 0;
        if(_dI_ >= 0){
         var i = _dH_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dJ_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dJ_);
          var _dK_ = i + 1 | 0;
          if(_dI_ === i) break;
          i = _dK_;
         }
       ...
       return caml_string_of_bytes(_dL_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _dG_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _dG_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _dG_[1];
       ...
       case 18:
        var _dE_ = fmt$0[1];
        if(0 === _dE_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dE_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dE_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dF_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dF_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dC_ = [8, acc, _a9_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dC_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dC_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dB_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dB_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dB_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _dz_ = other_fields(x, i + 1 | 0), _dA_ = field(x, i);
    return caml_call2(sprintf(_bg_), _dA_, _dz_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dy_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _du_ = other_fields(e, 2),
       _dv_ = field(e, 1),
       _dx_ = caml_call2(sprintf(_bh_), _dv_, _du_);
     else
      switch(match){
        case 0:
         var _dx_ = _bi_; break;
        case 1:
         var _dx_ = _bj_; break;
        default:
         var _dw_ = field(e, 1), _dx_ = caml_call1(sprintf(_bk_), _dw_);
      }
     var match$0 = [0, constructor, [0, _dx_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dk_ = slot[4],
        _dl_ = slot[3],
        _dm_ = slot[6] ? _bu_ : _bw_,
        _dn_ = slot[2],
        _do_ = slot[7],
        _dp_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bv_), _dp_, _do_, _dn_, _dm_, _dl_, _dk_, _dj_)];
      else if(slot[1])
       var match = 0;
      else
       var _dq_ = info(0), match = [0, caml_call1(sprintf(_bx_), _dq_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _c9_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _c9_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _c__ = abs(status);
        prerr_endline(caml_check_bound(errors, _c__)[1 + _c__]);
       }
       var _de_ = caml_ml_flush(stderr), _dc_ = _de_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _da_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _da_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _db_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _db_);
      ...
      var _c$_ = caml_wrap_exception(_dg_);
      if(_c$_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_c$_, 0);
      var _dd_ = prerr_endline(_bz_);
     }
     return _dd_;
    }
    catch(_df_){return 0;}
   ...
   var
    ...
    _bP_ = [0, 0],
    _bQ_ = [0, 0],
    _bM_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bN_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bO_ = [0, 0],
    _bL_ = "Lwt.Resolution_loop.Canceled",
    _bV_ = "Exception during Lwt.async: ",
    _ca_ = "^error_in_anchor^",
    _b3_ = [0, cst_examples_wysiwyg_main_ml, 85, 77],
    _b5_ = [0, cst$3, 0],
    _b6_ = cst$4,
    _b7_ = cst$0,
    _b8_ = [0, cst$3, 0],
    ...
    _b__ = cst$4,
    _b$_ = cst$0,
    _b4_ = "^error2_in_anchor^",
    _b2_ = [0, cst_examples_wysiwyg_main_ml, 79, 44],
    _b0_ = cst,
    _b1_ = [0, "**"],
    _bY_ = [0, "//"],
    _bZ_ = "----",
    ...
    _cx_ = "Enter a link",
    _cy_ = "desc",
    _cz_ = "Enter description",
    _cA_ = [0, cst_a, 0],
    _cB_ = '" wysitype="global">',
    _cC_ = cst_a_href,
    _cD_ = cst$0,
    _cc_ = "inserthorizontalrule",
    _cd_ = "hr",
    _ce_ = "removeformat",
    _cf_ = "remove format",
    _cg_ = "bold",
    ...
    _ci_ = "italic",
    _cj_ = cst_I,
    _ck_ = cst_formatblock,
    _cl_ = cst_p,
    _cm_ = [0, [0, cst_p]],
    _cn_ = cst_formatblock,
    _co_ = cst_h1,
    _cp_ = [0, [0, cst_h1]],
    _cq_ = cst_formatblock,
    _cr_ = cst_h2,
    _cs_ = [0, [0, cst_h2]],
    _ct_ = cst_formatblock,
    _cu_ = cst_h3,
    _cv_ = [0, [0, cst_h3]],
    _cE_ = cst_inserthtml,
    _cF_ = "link",
    ...
    _cN_ = "link2wiki",
    _cO_ = cst$0,
    _cb_ = [0, cst_examples_wysiwyg_main_ml, 108, 70],
    _bW_ = "Dune__exe__Main.Break",
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _c3_ = createElementSyntax[1];
     if(785140586 !== _c3_){
      if(982028505 <= _c3_){
     ...
     try{
      var
       ...
       t50 = t49.tagName,
       _c6_ = t50.toLowerCase() == cst_input ? 1 : 0,
       _c7_ = _c6_ ? t49.name == "x" ? 1 : 0 : _c6_,
       _c4_ = _c7_;
     }
     catch(_c8_){var _c4_ = 0;}
     var _c5_ = _c4_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _c5_;
    }
   }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c2_ = caml_call1(f, v); return _c2_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _bL_, caml_fresh_oo_id(0)];
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c1_ = result[1] === Canceled ? 1 : 0, is_canceled = _c1_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _c0_ = deferred_callbacks[2];
      if(! _c0_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _c0_[1];
      if(_c0_[2]){
       var next = _c0_[2];
   ...
   var Break = [248, _bW_, caml_fresh_oo_id(0)], overflow_limit = 2147483000.;
   function html2wiki(body){
    var ans = create(10);
    function add_str(opt, s1){
     if(opt) var sth = opt[1], surr = sth; else var surr = _bX_;
     var len = caml_ml_string_length(s1);
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _cY_ = 0, _cZ_ = _cY_; break;}
       if
        ...
        b:
        {
         if(0 <= switch$0){
          if(0 < switch$0 && hh !== "H2" && hh !== "H3"){
           if(hh === "HR"){add_string(ans, _bZ_); break a;}
           if(hh === cst_I){
            var inner$0 = html2wiki(node);
            add_str(_bY_, inner$0);
            break a;
           }
           if(hh !== "P") break b;
         ...
         if(hh === "A"){
          ...
          if(x$1 == no_handler){add_string(ans, _ca_); break a;}
          ...
          if(match$0 === "global"){
           ...
           add_string
            (ans,
             concat(_b$_, [0, _b__, [0, url, [0, _b9_, [0, desc, _b8_]]]]));
           break a;
          }
          if(match$0 !== "wiki"){add_string(ans, _b4_); break a;}
          var x$0 = concat(_b7_, [0, _b6_, [0, url, _b5_]]);
          add_string(ans, x$0);
          break a;
         }
         if(hh === cst_B){
          var inner$3 = html2wiki(node);
          add_str(_b1_, inner$3);
          break a;
         }
         if(hh === "BR"){add_string(ans, _b0_); break a;}
         if(hh === "DIV"){
   ...
   function onload(param){
    ...
    if(1 - (iDoc == no_handler ? 1 : 0)){
     ...
     var
      createButton =
        function(opt, _cU_, title, action){
         if(opt) var sth = opt[1], show = sth; else var show = false$0;
         if(_cU_) var sth$0 = _cU_[1], value = sth$0; else var value = 0;
         var
          type = [0, "submit"],
          but = unsafeCreateElementEx(type, 0, document, _bJ_),
     ...
     var
      ...
      t45 =
        handler
         (function(param){
           var
            link = prompt(_cx_, _cw_),
            desc = prompt(_cz_, _cy_),
            link$0 =
              concat(_cD_, [0, _cC_, [0, link, [0, _cB_, [0, desc, _cA_]]]]),
      ...
      t46 = createButton(0, 0, _cF_, _cE_);
     t46.onclick = t45;
     var
      t53 =
        handler
         (function(param){
           var
            link = prompt(_cH_, _cG_),
            x = [0, _cL_, [0, link, [0, _cK_, [0, link, _cJ_]]]],
            link$0 = concat(_cI_, x),
      ...
      t54 = createButton(0, 0, _cN_, _cM_);
     t54.onclick = t53;
     appendChild(body, createElement(document, name));
     var preview = unsafeCreateElementEx(0, 0, document, _bK_);
     ...
     var wikiFrame = unsafeCreateElementEx(0, 0, document, _bK_);
        ...
        function(old_text, n){
         ...
         if(text !== old_text){
          ...
          var
           y = n - 1 | 0,
           x = 0,
           _cP_ = caml_greaterequal(0, y) ? x : y,
           n$0 = _cP_;
         var d$0 = 0 === n$0 ? 0.5 : 0.1, p = new_pending(1), d = d$0 * 1000.;
         function callback$0(v){
          var result$0 = [0, v], p$0 = underlying(p), _cS_ = p$0[1];
          switch(_cS_[0]){
            case 1:
             return _cS_[1] === Canceled
                     ? 0
                     : caml_call1(ksprintf(invalid_arg, _bN_), api_function_name);
            case 2:
             if(0 === result$0[0])
              var x = result$0[1], result = [0, x];
             else
              var exn = result$0[1], result = [1, exn];
             resolve(_bO_, 0, p$0, result);
             return 0;
            default:
             return caml_call1(ksprintf(invalid_arg, _bM_), api_function_name);
          }
         }
         var id = [0, 0];
         function loop(d, param){
          ...
          var
           cb =
             remain == 0.
              ? callback$0
              : function(_cR_){return loop(remain, _cR_);},
         ...
         function create_result_promise_and_call(param){
          ...
          function callback(p_result){
           if(1 === p_result[0]){
            var p$0 = underlying(p);
            resolve(_bR_, 0, p$0, p_result);
            return 0;
           }
           current_storage[1] = saved_storage;
           try{
            var _cQ_ = dyn_preview(text, n$0), user_provided_promise = _cQ_;
           }
           catch(exn$0){
            var exn = caml_wrap_exception(exn$0);
           ...
           if(p1 !== outer_promise){
            ...
            switch(match[0]){
              case 1:
               resolve(_bQ_, 0, outer_promise, p1[1]); break;
              case 2:
               var
                p_callbacks = match[1],
               ...
               p1[1] = state;
               break;
              default: resolve(_bP_, 0, outer_promise, p1[1]);
            }
           }
           return 0;
          }
