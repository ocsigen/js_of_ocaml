...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _eL_ = caml_wrap_exception(_eM_);
      if(_eL_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_eL_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _eJ_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_eJ_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   var at_exit_key = new_key(0, function(param, _eI_){return 0;});
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _eu_ = caml_ml_bytes_length(b) - 1 | 0,
     _et_ = 0;
    if(_eu_ >= 0){
     var i$0 = _et_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _ew_ = caml_ml_bytes_length(b) - 1 | 0, _ev_ = 0;
     if(_ew_ >= 0){
      var i = _ev_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _eg_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _eg_ >>> 0){
           if(55 === _eg_) break a;
          }
          else if(21 < _eg_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _eh_ = 1;
        }
        var _ei_ = _eh_ ? str : symbol(str, _a5_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _d$_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _d$_);
     }
    }
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _d6_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _d6_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _d4_ = other_fields(x, i + 1 | 0), _d5_ = field(x, i);
    return caml_call2(sprintf(_bl_), _d5_, _d4_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_d3_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _d0_ = field(e, 1),
       _d2_ = caml_call2(sprintf(_bm_), _d0_, _dZ_);
     else
      switch(match){
        case 0:
         var _d2_ = _bn_; break;
        case 1:
         var _d2_ = _bo_; break;
        default:
         var _d1_ = field(e, 1), _d2_ = caml_call1(sprintf(_bp_), _d1_);
      }
     var match$0 = [0, constructor, [0, _d2_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dP_ = slot[4],
        _dQ_ = slot[3],
        _dR_ = slot[6] ? _bz_ : _bB_,
        _dS_ = slot[2],
        _dT_ = slot[7],
        _dU_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bA_), _dU_, _dT_, _dS_, _dR_, _dQ_, _dP_, _dO_)];
      else if(slot[1])
       var match = 0;
      else
       var _dV_ = info(0), match = [0, caml_call1(sprintf(_bC_), _dV_)];
    ...
    try{
     try{
      ...
      try{
       ...
       caml_call1(eprintf(_bH_), _dG_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dH_ = to_string(exn);
       caml_call1(eprintf(_bI_), _dH_);
   ...
   function iter(x, f){
    var _dB_ = 1 - (x == no_handler ? 1 : 0);
    return _dB_ ? caml_call1(f, x) : _dB_;
   }
    ...
    for(;;){
     ...
     try{
      var
       ...
       _dy_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _dz_ = _dy_ ? t49.name == "x" ? 1 : 0 : _dy_,
       _dw_ = _dz_;
     }
     catch(_dA_){var _dw_ = 0;}
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _du_ = caml_call1(f, v); return _du_;}
    catch(exn$0){
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      if(! _ds_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _ds_[1];
      if(_ds_[2]){
       var next = _ds_[2];
   ...
   function html2wiki(body){
    ...
    function add_str(opt, s){
     ...
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _dq_ = 0, _dr_ = _dq_; break;}
       if
     ...
     return _dr_ ? add_string(ans, symbol(surr, symbol(s, surr))) : 0;
    }
    var
     childNodes = body.childNodes,
     _dh_ = childNodes.length - 1 | 0,
     _dg_ = 0;
    if(_dh_ >= 0){
     var i = _dg_;
     for(;;){
          ...
          a:
          {
           ...
           if(! caml_string_notequal(hh, "A")){
            var
             ...
             _dk_ =
               function(s){
                var _dm_ = caml_string_of_jsstring;
                function _dn_(param){
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _ci_], 1);
                }
                var
                 url = symbol$0(get(el.getAttribute("href"), _dn_), _dm_),
                ...
                function _do_(_dp_){return add_string(ans, _dp_);}
                return symbol$0(concat(_cm_, [0, _cl_, [0, url, _ck_]]), _do_);
               },
             _dl_ = function(param){return add_string(ans, _cr_);};
            return case$0(el.getAttribute("wysitype"), _dl_, _dk_);
           }
   ...
   function onload(param){
    ...
    function _c7_(iDoc){
     ...
     function createButton(opt, _de_, title, action){
      if(opt) var sth = opt[1], show = sth; else var show = false$0;
      if(_de_) var sth$0 = _de_[1], value = sth$0; else var value = 0;
      var
       type = [0, "submit"],
       ...
       t34 =
         handler
          (function(param){
            iWin.focus();
            if(value)
             var s = value[1], _df_ = caml_jsstring_of_string(s);
            else
             var _df_ = no_handler;
            iDoc.execCommand(caml_jsstring_of_string(action), show, _df_);
            return true$0;
           });
      but.onclick = t34;
     ...
     function prompt(query, default$0){
      var _dc_ = caml_string_of_jsstring;
      function _dd_(param){return caml_jsstring_of_string(default$0);}
      return symbol$0
              (get
                (iWin.prompt
            ...
            link$0 =
              symbol$0
               ([0, _c2_, [0, link, [0, _c1_, [0, link, _c0_]]]],
                function(_db_){return concat(_cZ_, _db_);});
           iWin.alert(caml_jsstring_of_string(link$0));
           iDoc.execCommand
            (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
           return true$0;
     ...
     function dyn_preview(old_text, n){
      ...
      function loop(d, param){
       ...
       var
        cb =
          remain == 0.
           ? callback$0
           : function(_c__){return loop(remain, _c__);};
      ...
      function create_result_promise_and_call(param){
       ...
       function callback(p_result){
        ...
        try{var _c9_ = f$0(v), user_provided_promise = _c9_;}
        catch(exn$0){
         var exn = caml_wrap_exception(exn$0);
