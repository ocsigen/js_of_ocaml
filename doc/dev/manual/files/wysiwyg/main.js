...
(function(globalThis){
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _eB_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_eB_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   var at_exit_key = new_key(0, function(param, _eA_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _ez_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _ez_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _ex_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _ex_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ey_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ey_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ey_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _em_ = caml_ml_bytes_length(b) - 1 | 0,
     _el_ = 0;
    if(_em_ >= 0){
     var i$0 = _el_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _eo_ = caml_ml_bytes_length(b) - 1 | 0, _en_ = 0;
     if(_eo_ >= 0){
      var i = _en_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _eg_ = caml_ml_string_length(s) - 1 | 0, _ef_ = 0;
    if(_eg_ >= 0){
     var i$0 = _ef_;
     for(;;){
    ...
    var
     ...
     _ei_ = caml_ml_string_length(s) - 1 | 0,
     _eh_ = 0;
    if(_ei_ >= 0){
     var i = _eh_;
     for(;;){
   ...
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ed_ = _aI_; break;
      default: var _ed_ = _aR_;
    }
    return transform_int_alt(iconv, caml_format_int(_ed_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ec_ = _aV_; break;
      default: var _ec_ = _a4_;
    }
    return transform_int_alt(iconv, caml_format_int(_ec_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _eb_ = _av_; break;
      default: var _eb_ = _aE_;
    }
    return transform_int_alt(iconv, caml_int64_format(_eb_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _d__ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _d__ >>> 0){
           if(55 === _d__) break a;
          }
          else if(21 < _d__ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _d$_ = 1;
        }
        var _ea_ = _d$_ ? str : symbol(str, _a5_);
        return caml_special_val(_ea_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _d6_ = l - 1 | 0, _d5_ = 0;
        if(_d6_ >= 0){
         var i = _d5_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _d7_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _d7_);
          var _d8_ = i + 1 | 0;
          if(_d6_ === i) break;
          var i = _d8_;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _d4_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _d4_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _d4_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _d3_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _d3_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _d0_ = [8, acc, _bc_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _d0_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _d0_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dZ_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dZ_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dZ_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _dY_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _dY_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _dW_ = other_fields(x, i + 1 | 0), _dX_ = field(x, i);
    return caml_call2(sprintf(_bl_), _dX_, _dW_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dV_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _dR_ = other_fields(e, 2),
       _dS_ = field(e, 1),
       _dU_ = caml_call2(sprintf(_bm_), _dS_, _dR_);
     else
      switch(match){
        case 0:
         var _dU_ = _bn_; break;
        case 1:
         var _dU_ = _bo_; break;
        default:
         var _dT_ = field(e, 1), _dU_ = caml_call1(sprintf(_bp_), _dT_);
      }
     var match$0 = [0, constructor, [0, _dU_]];
    }
    else
     var match$0 = [0, e[1], 0];
    ...
    if(_dP_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _bv_ : _bw_ : 0 === pos$0 ? _bx_ : _by_;
      }
      if(0 === slot[0])
       var
        _dG_ = slot[5],
        _dH_ = slot[4],
        _dI_ = slot[3],
        _dJ_ = slot[6] ? _bz_ : _bB_,
        _dK_ = slot[2],
        _dL_ = slot[7],
        _dM_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bA_), _dM_, _dL_, _dK_, _dJ_, _dI_, _dH_, _dG_)];
      else if(slot[1])
       var match = 0;
      else
       var _dN_ = info(0), match = [0, caml_call1(sprintf(_bC_), _dN_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dE_){}
      try{
       var _du_ = to_string(exn$0);
       caml_call1(eprintf(_bF_), _du_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _dv_ = abs(status);
        prerr_endline(caml_check_bound(errors, _dv_)[1 + _dv_]);
       }
       var _dw_ = caml_ml_flush(stderr), _dA_ = _dw_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dy_ = to_string(exn$0);
       caml_call1(eprintf(_bH_), _dy_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dz_ = to_string(exn);
       caml_call1(eprintf(_bI_), _dz_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _dA_ = caml_ml_flush(stderr);
      }
      var _dB_ = _dA_;
     }
     catch(_dD_){
      var _dx_ = caml_wrap_exception(_dD_);
      if(_dx_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_dx_, 0);
      var _dB_ = prerr_endline(_bG_);
     }
     return _dB_;
    }
    catch(_dC_){return 0;}
   ...
   function iter(x, f){
    var _dt_ = 1 - (x == no_handler ? 1 : 0);
    return _dt_ ? caml_call1(f, x) : _dt_;
   }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _dn_ = createElementSyntax[1];
     if(785140586 !== _dn_){
      if(982028505 <= _dn_){
     ...
     try{
      var
       ...
       _dq_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _dr_ = _dq_ ? t49.name == "x" ? 1 : 0 : _dq_,
       _do_ = _dr_;
     }
     catch(_ds_){var _do_ = 0;}
     var _dp_ = _do_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _dp_;
    }
   }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _dm_ = caml_call1(f, v); return _dm_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _dl_ = result[1] === Canceled ? 1 : 0, is_canceled = _dl_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      if(! _dk_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _dk_[1];
      if(_dk_[2]){
       var next = _dk_[2];
   ...
   function html2wiki(body){
    ...
    function add_str(opt, s){
     ...
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _di_ = 0, _dj_ = _di_; break;}
       if
     ...
     return _dj_ ? add_string(ans, symbol(surr, symbol(s, surr))) : 0;
    }
    var
     childNodes = body.childNodes,
     _de_ = childNodes.length - 1 | 0,
     _dd_ = 0;
    if(_de_ >= 0){
     var i = _dd_;
     for(;;){
         ...
         a:
         {
          if(0 <= switch$0){
           if
            ...
            if(! caml_string_notequal(hh, "HR")) return add_string(ans, _cd_);
          ...
          if(! caml_string_notequal(hh, "A")){
           ...
           return case$0
                   (el.getAttribute("wysitype"),
                    function(param){return add_string(ans, _cr_);},
                    function(s){
                     var
                      _dg_ = caml_string_of_jsstring,
                      url =
                        symbol$0
                         (get
                     ...
                     if(caml_string_notequal(match, "global"))
                      return caml_string_notequal(match, "wiki")
                              ? add_string(ans, _cj_)
                              : symbol$0
                                (concat(_cm_, [0, _cl_, [0, url, _ck_]]),
                                 function(_dh_){return add_string(ans, _dh_);});
    ...
    iter
     (iframe.contentDocument,
      function(iDoc){
       ...
       function createButton(opt, _db_, title, action){
        if(opt) var sth = opt[1], show = sth; else var show = false$0;
        if(_db_) var sth$0 = _db_[1], value = sth$0; else var value = 0;
        var
         type = [0, "submit"],
         ...
         t34 =
           handler
            (function(param){
              iWin.focus();
              if(value)
               var s = value[1], _dc_ = caml_jsstring_of_string(s);
              else
               var _dc_ = no_handler;
              iDoc.execCommand(caml_jsstring_of_string(action), show, _dc_);
              return true$0;
             });
        but.onclick = t34;
       ...
       function prompt(query, default$0){
        var _da_ = caml_string_of_jsstring;
        return symbol$0
                (get
                  (iWin.prompt
              ...
              link$0 =
                symbol$0
                 ([0, _c2_, [0, link, [0, _c1_, [0, link, _c0_]]]],
                  function(_c$_){return concat(_cZ_, _c$_);});
             iWin.alert(caml_jsstring_of_string(link$0));
             iDoc.execCommand
              (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
             return true$0;
       ...
       function dyn_preview(old_text, n){
        ...
        function loop(d, param){
         ...
         var
          cb =
            remain == 0.
             ? callback$0
             : function(_c8_){return loop(remain, _c8_);};
        ...
        function create_result_promise_and_call(param){
         ...
         function callback(p_result){
          ...
          try{var _c7_ = f$0(v), user_provided_promise = _c7_;}
          catch(exn$0){
           var exn = caml_wrap_exception(exn$0);
