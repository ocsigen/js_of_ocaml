...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ew_ = caml_wrap_exception(_ex_);
      if(_ew_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ew_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   var _m_ = "String.concat", _n_ = cst$1;
   ...
   var
    at_exit_key = new_key(0, function(param, _et_){return 0;}),
    _o_ = "Array.blit";
   ...
   function string_of_formatting_lit(formatting_lit){
    ...
    switch(formatting_lit[0]){
      ...
      default: var c = formatting_lit[1]; return symbol(_w_, make$0(1, c));
    }
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _d3_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _d3_ >>> 0){
           if(55 === _d3_) break a;
          }
          else if(21 < _d3_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _d4_ = 1;
        }
        var _d5_ = _d4_ ? str : symbol(str, _a3_);
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bj_), _dR_, _dQ_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dM_ = field(e, 1),
       _dO_ = caml_call2(sprintf(_bk_), _dM_, _dL_);
     else
      switch(match){
        case 0:
         var _dO_ = _bl_; break;
        case 1:
         var _dO_ = _bm_; break;
        default:
         var _dN_ = field(e, 1), _dO_ = caml_call1(sprintf(_bn_), _dN_);
      }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dB_ = slot[4],
        _dC_ = slot[3],
        _dD_ = slot[6] ? _bx_ : _bz_,
        _dE_ = slot[2],
        _dF_ = slot[7],
        _dG_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_by_), _dG_, _dF_, _dE_, _dD_, _dC_, _dB_, _dA_)];
      else if(slot[1])
       var match = 0;
      else
       var _dH_ = info(0), match = [0, caml_call1(sprintf(_bA_), _dH_)];
    ...
    try{
     try{
      ...
      try{
       ...
       caml_call1(eprintf(_bE_), _ds_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dt_ = to_string(exn);
       caml_call1(eprintf(_bF_), _dt_);
   ...
   var
    ...
    _bX_ = [0, 0],
    _bT_ = cst_Fatal_error_exception,
    _bU_ = "Lwt.Resolution_loop.Canceled",
    _b4_ = "Exception during Lwt.async: ",
    _cn_ = "^error_in_anchor^",
    _ce_ = [0, cst_examples_wysiwyg_main_ml, 85, 77],
    _cg_ = [0, cst$4, 0],
    _ch_ = cst$5,
    _ci_ = cst$1,
    _cj_ = [0, cst$4, 0],
    ...
    _cl_ = cst$5,
    _cm_ = cst$1,
    _cf_ = "^error2_in_anchor^",
    _cd_ = [0, cst_examples_wysiwyg_main_ml, 79, 44],
    _cb_ = cst$0,
    _cc_ = [0, "**"],
    _b9_ = cst$6,
    _b__ = [0, "//"],
    ...
    _cK_ = "Enter a link",
    _cL_ = "desc",
    _cM_ = "Enter description",
    _cN_ = [0, cst_a, 0],
    _cO_ = '" wysitype="global">',
    _cP_ = cst_a_href,
    _cQ_ = cst$1,
    _cp_ = "inserthorizontalrule",
    _cq_ = "hr",
    _cr_ = "removeformat",
    _cs_ = "remove format",
    _ct_ = "bold",
    ...
    _cy_ = cst_p,
    _cz_ = [0, [0, cst_p]],
    _cA_ = cst_formatblock,
    _cB_ = cst_h1,
    _cC_ = [0, [0, cst_h1]],
    _cD_ = cst_formatblock,
    _cE_ = cst_h2,
    _cF_ = [0, [0, cst_h2]],
    _cG_ = cst_formatblock,
    _cH_ = cst_h3,
    _cI_ = [0, [0, cst_h3]],
    _cR_ = cst_inserthtml,
    _cS_ = "link",
    ...
    _c0_ = "link2wiki",
    _c1_ = cst$1,
    _co_ = [0, cst_examples_wysiwyg_main_ml, 108, 70],
    _b5_ = "Dune__exe__Main.Break",
   ...
   function iter(x, f){
    var _dn_ = 1 - (x == no_handler ? 1 : 0);
    return _dn_ ? caml_call1(f, x) : _dn_;
   }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _dh_ = createElementSyntax[1];
     if(785140586 !== _dh_){
      if(982028505 <= _dh_){
     ...
     try{
      var
       ...
       _dk_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _dl_ = _dk_ ? t49.name == "x" ? 1 : 0 : _dk_,
       _di_ = _dl_;
     }
     catch(_dm_){var _di_ = 0;}
     var _dj_ = _di_ ? 982028505 : -1003883683;
     createElementSyntax[1] = _dj_;
    }
   }
   function createTextarea(type, name, doc){
    return unsafeCreateElementEx(type, name, doc, _bQ_);
   }
   function createBr(doc){return unsafeCreateElement(doc, _bR_);}
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _dg_ = caml_call1(f, v); return _dg_;}
    catch(exn$0){
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _de_ = deferred_callbacks[2];
      if(! _de_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _de_[1];
      if(_de_[2]){
       var next = _de_[2];
   ...
   var Break = [248, _b5_, caml_fresh_oo_id(0)], overflow_limit = 2147483000.;
   function html2wiki(body){
    ...
    function add_str(opt, s){
     ...
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _dc_ = 0, _dd_ = _dc_; break;}
       if
     ...
     return _dd_ ? add_string(ans, symbol(surr, symbol(s, surr))) : 0;
    }
    var
     childNodes = body.childNodes,
     _c$_ = childNodes.length - 1 | 0,
     _c__ = 0;
    if(_c$_ >= 0){
     var i = _c__;
     for(;;){
         ...
         a:
         {
          if(0 <= switch$0){
           if
            ...
            if(! caml_string_notequal(hh, "HR")) return add_string(ans, _b$_);
            if(! caml_string_notequal(hh, cst_I)){
             var inner$0 = html2wiki(node);
             return add_str(_b__, inner$0);
            }
          ...
          if(! caml_string_notequal(hh, "A")){
           ...
           return case$0
                   (el.getAttribute("wysitype"),
                    function(param){return add_string(ans, _cn_);},
                    function(s){
                     var
                      url =
                        symbol$0
                     ...
                     if(caml_string_notequal(match, "global"))
                      return caml_string_notequal(match, "wiki")
                              ? add_string(ans, _cf_)
                              : symbol$0
                                (concat(_ci_, [0, _ch_, [0, url, _cg_]]),
                                 function(_db_){return add_string(ans, _db_);});
                     var desc = html2wiki(node);
                     return add_string
                             (ans,
                              concat
                               (_cm_, [0, _cl_, [0, url, [0, _ck_, [0, desc, _cj_]]]]));
                    });
          }
          if(! caml_string_notequal(hh, cst_B)){
           var inner$3 = html2wiki(node);
           return add_str(_cc_, inner$3);
          }
          if(! caml_string_notequal(hh, "BR")) return add_string(ans, _cb_);
   ...
   function onload(param){
    var
     ...
     iframe = unsafeCreateElement(document, _bS_),
     t14 = iframe.style;
    ...
    iter
     (iframe.contentDocument,
      function(iDoc){
       ...
       function createButton(opt, _c8_, title, action){
        if(opt) var sth = opt[1], show = sth; else var show = false$0;
        if(_c8_) var sth$0 = _c8_[1], value = sth$0; else var value = 0;
        var
         type = [0, "submit"],
         but = unsafeCreateElementEx(type, 0, document, _bP_),
         ...
         t34 =
           handler
            (function(param){
              iWin.focus();
              if(value)
               var s = value[1], _c9_ = caml_jsstring_of_string(s);
              else
               var _c9_ = no_handler;
              iDoc.execCommand(caml_jsstring_of_string(action), show, _c9_);
              return true$0;
             });
        but.onclick = t34;
       ...
       var
        t45 =
          handler
           (function(param){
             var
              link = prompt(_cK_, _cJ_),
              desc = prompt(_cM_, _cL_),
              link$0 =
                concat(_cQ_, [0, _cP_, [0, link, [0, _cO_, [0, desc, _cN_]]]]);
             iWin.alert(caml_jsstring_of_string(link$0));
             iDoc.execCommand
              (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
             return true$0;
            }),
        t46 = createButton(0, 0, _cS_, _cR_);
       t46.onclick = t45;
       var
        t53 =
          handler
           (function(param){
             var
              link = prompt(_cU_, _cT_),
              link$0 =
                symbol$0
                 ([0, _cY_, [0, link, [0, _cX_, [0, link, _cW_]]]],
                  function(_c7_){return concat(_cV_, _c7_);});
             iWin.alert(caml_jsstring_of_string(link$0));
             iDoc.execCommand
              (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
             return true$0;
            }),
        t54 = createButton(0, 0, _c0_, _cZ_);
       t54.onclick = t53;
       appendChild(body, createBr(document));
        ...
        function loop(d, param){
         ...
         var
          cb =
            remain == 0.
             ? callback$0
             : function(_c4_){return loop(remain, _c4_);};
        ...
        function create_result_promise_and_call(param){
         ...
         function callback(p_result){
          if(1 === p_result[0]){
           ...
           resolve(_b0_, 0, p$1, p_result);
           return 0;
          }
          var v = p_result[1];
          current_storage[1] = saved_storage;
          try{var _c3_ = f$0(v), user_provided_promise = _c3_;}
          catch(exn$0){
           var exn = caml_wrap_exception(exn$0);
          ...
          if(p$0 !== outer_promise){
           ...
           switch(match[0]){
             case 1:
              resolve(_bZ_, 0, outer_promise, p$0[1]); break;
             case 2:
              var
               p_callbacks = match[1],
              ...
              break;
             default: resolve(_bY_, 0, outer_promise, p$0[1]);
           }
          }
          return 0;
         }
