...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ep_ = caml_wrap_exception(_eq_);
      if(_ep_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ep_, 0);
     }
     param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _en_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_en_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   var
    at_exit_key = new_key(0, function(param, _em_){return 0;}),
    _n_ = "Array.blit";
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _el_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _el_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ek_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ek_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ek_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _eh_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _eh_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _ei_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _ei_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _eg_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _eg_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _d__ = caml_ml_bytes_length(b) - 1 | 0,
     _d9_ = 0;
    if(_d__ >= 0){
     var i$0 = _d9_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _ea_ = caml_ml_bytes_length(b) - 1 | 0, _d$_ = 0;
     if(_ea_ >= 0){
      var i = _d$_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _d4_ = caml_ml_string_length(s) - 1 | 0, _d3_ = 0;
    if(_d4_ >= 0){
     var i$0 = _d3_;
     for(;;){
    ...
    var
     ...
     _d6_ = caml_ml_string_length(s) - 1 | 0,
     _d5_ = 0;
    if(_d6_ >= 0){
     var i = _d5_;
     for(;;){
   ...
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _d1_ = _aE_; break;
      default: var _d1_ = _aN_;
    }
    return transform_int_alt(iconv, caml_format_int(_d1_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dZ_ = _ar_; break;
      default: var _dZ_ = _aA_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dZ_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dW_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dW_ >>> 0){
           if(55 === _dW_) break a;
          }
          else if(21 < _dW_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dY_ = _dX_ ? str : str + cst$5;
        return caml_special_val(_dY_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dS_ = l - 1 | 0, _dR_ = 0;
        if(_dS_ >= 0){
         var i = _dR_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dT_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dT_);
          var _dU_ = i + 1 | 0;
          if(_dS_ === i) break;
          i = _dU_;
         }
       ...
       return caml_string_of_bytes(_dV_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dO_ = fmt$0[1];
        if(0 === _dO_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dO_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dO_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dP_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dP_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dM_ = [8, acc, _a9_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dM_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dM_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dL_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dL_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dL_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bg_), _dK_, _dJ_);
   }
    ...
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dI_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _dF_ = field(e, 1),
       _dH_ = caml_call2(sprintf(_bh_), _dF_, _dE_);
     else
      switch(match){
        case 0:
         var _dH_ = _bi_; break;
        case 1:
         var _dH_ = _bj_; break;
        default:
         var _dG_ = field(e, 1), _dH_ = caml_call1(sprintf(_bk_), _dG_);
      }
     var match$0 = [0, constructor, [0, _dH_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _du_ = slot[4],
        _dv_ = slot[3],
        _dw_ = slot[6] ? _bu_ : _bw_,
        _dx_ = slot[2],
        _dy_ = slot[7],
        _dz_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bv_), _dz_, _dy_, _dx_, _dw_, _dv_, _du_, _dt_)];
      else if(slot[1])
       var match = 0;
      else
       var _dA_ = info(0), match = [0, caml_call1(sprintf(_bx_), _dA_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dr_){}
      try{
       var _dh_ = to_string(exn$0);
       caml_call1(eprintf(_bz_), _dh_);
       ...
       var _dj_ = caml_ml_flush(stderr), _dn_ = _dj_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dl_ = to_string(exn$0);
       caml_call1(eprintf(_bB_), _dl_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dm_ = to_string(exn);
       caml_call1(eprintf(_bC_), _dm_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _dn_ = caml_ml_flush(stderr);
      }
      var _do_ = _dn_;
     }
     catch(_dq_){
      var _dk_ = caml_wrap_exception(_dq_);
      if(_dk_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_dk_, 0);
      var _do_ = prerr_endline(_bA_);
     }
     return _do_;
    }
    catch(_dp_){return 0;}
   ...
   var
    ...
    _bU_ = [0, 0],
    _bQ_ = cst_Fatal_error_exception,
    _bR_ = "Lwt.Resolution_loop.Canceled",
    _b1_ = "Exception during Lwt.async: ",
    _cg_ = "^error_in_anchor^",
    _b9_ = [0, cst_examples_wysiwyg_main_ml, 85, 77],
    _b$_ = [0, cst$3, 0],
    _ca_ = cst$4,
    _cb_ = cst$0,
    _cc_ = [0, cst$3, 0],
    ...
    _ce_ = cst$4,
    _cf_ = cst$0,
    _b__ = "^error2_in_anchor^",
    _b8_ = [0, cst_examples_wysiwyg_main_ml, 79, 44],
    _b6_ = cst,
    _b7_ = [0, "**"],
    _b4_ = [0, "//"],
    _b5_ = "----",
    ...
    _cD_ = "Enter a link",
    _cE_ = "desc",
    _cF_ = "Enter description",
    _cG_ = [0, cst_a, 0],
    _cH_ = '" wysitype="global">',
    _cI_ = cst_a_href,
    _cJ_ = cst$0,
    _ci_ = "inserthorizontalrule",
    _cj_ = "hr",
    _ck_ = "removeformat",
    _cl_ = "remove format",
    _cm_ = "bold",
    ...
    _cu_ = cst_h1,
    _cv_ = [0, [0, cst_h1]],
    _cw_ = cst_formatblock,
    _cx_ = cst_h2,
    _cy_ = [0, [0, cst_h2]],
    _cz_ = cst_formatblock,
    _cA_ = cst_h3,
    _cB_ = [0, [0, cst_h3]],
    _cK_ = cst_inserthtml,
    _cL_ = "link",
    ...
    _cT_ = "link2wiki",
    _cU_ = cst$0,
    _ch_ = [0, cst_examples_wysiwyg_main_ml, 108, 70],
    _b2_ = "Dune__exe__Main.Break",
   ...
   function iter(x, f){
    var _dg_ = 1 - (x == no_handler ? 1 : 0);
    return _dg_ ? caml_call1(f, x) : _dg_;
   }
    ...
    for(;;){
     ...
     if(785140586 !== _da_){
      if(982028505 <= _da_){
       ...
       opt_iter
        (type,
         function(t){
          a.push(' type="', caml_js_html_escape(t), cst$6);
          return 0;
         });
       opt_iter
        (name,
         function(n){
          a.push(' name="', caml_js_html_escape(n), cst$6);
          return 0;
         });
       a.push(">");
       return doc.createElement(a.join(cst$0));
      }
     ...
     try{
      var
       ...
       _dd_ = t49.tagName.toLowerCase() == cst_input ? 1 : 0,
       _de_ = _dd_ ? t49.name == "x" ? 1 : 0 : _dd_,
       _db_ = _de_;
     }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c$_ = caml_call1(f, v); return _c$_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c__ = result[1] === Canceled ? 1 : 0, is_canceled = _c__;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _c9_ = deferred_callbacks[2];
      if(! _c9_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _c9_[1];
      if(_c9_[2]){
       var next = _c9_[2];
   ...
   var Break = [248, _b2_, caml_fresh_oo_id(0)], overflow_limit = 2147483000.;
   function html2wiki(body){
    var ans = create(10);
    function add_str(opt, s){
     if(opt) var sth = opt[1], surr = sth; else var surr = _b3_;
     var len = caml_ml_string_length(s);
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _c7_ = 0, _c8_ = _c7_; break;}
       if
     ...
     return _c8_ ? add_string(ans, surr + s + surr) : 0;
    }
    var
     childNodes = body.childNodes,
     _c4_ = childNodes.length - 1 | 0,
     _c3_ = 0;
    if(_c4_ >= 0){
     var i = _c3_;
     for(;;){
         ...
         a:
         {
          if(0 <= switch$0){
           if(0 < switch$0 && hh !== "H2" && hh !== "H3"){
            if(hh === "HR") return add_string(ans, _b5_);
            if(hh === cst_I){
             var inner$0 = html2wiki(node);
             return add_str(_b4_, inner$0);
            }
            if(hh !== "P") break a;
            var inner = html2wiki(node);
            return add_str(0, inner + cst$7);
           }
           var
            n = (caml_string_get(hh, 1) - 48 | 0) + 1 | 0,
            prefix = make$0(n, 61),
            inner$1 = html2wiki(node);
           return add_string(ans, prefix + inner$1 + cst$7);
          }
          if(hh === "#text"){
           var
            x = node.nodeValue,
          ...
          if(hh === "A"){
           ...
           return case$0
                   (el.getAttribute("wysitype"),
                    function(param){return add_string(ans, _cg_);},
                    function(s){
                     var
                      url =
                        symbol
                     ...
                     if(match !== "global")
                      return match !== "wiki"
                              ? add_string(ans, _b__)
                              : symbol
                                (concat(_cb_, [0, _ca_, [0, url, _b$_]]),
                                 function(_c6_){return add_string(ans, _c6_);});
                     var desc = html2wiki(node);
                     return add_string
                             (ans,
                              concat
                               (_cf_, [0, _ce_, [0, url, [0, _cd_, [0, desc, _cc_]]]]));
                    });
          }
          if(hh === cst_B){
           var inner$3 = html2wiki(node);
           return add_str(_b7_, inner$3);
          }
          if(hh === "BR") return add_string(ans, _b6_);
          if(hh === "DIV"){
           var inner$2 = html2wiki(node);
           return add_string(ans, inner$2);
          }
         }
         return add_string(ans, cst$8 + hh + cst$8);
        });
      var _c5_ = i + 1 | 0;
      if(_c4_ === i) break;
      i = _c5_;
   ...
   function onload(param){
    var
     body =
       get
        (document.getElementById("wiki_demo"),
         function(param){
          throw caml_maybe_attach_backtrace([0, Assert_failure, _ch_], 1);
         }),
     iframe = unsafeCreateElement(document, _bP_),
     t14 = iframe.style;
    ...
    iter
     (iframe.contentDocument,
      function(iDoc){
       ...
       function createButton(opt, _c1_, title, action){
        if(opt) var sth = opt[1], show = sth; else var show = false$0;
        if(_c1_) var sth$0 = _c1_[1], value = sth$0; else var value = 0;
        var
         type = [0, "submit"],
         but = unsafeCreateElementEx(type, 0, document, _bM_),
         ...
         t34 =
           handler
            (function(param){
              iWin.focus();
              if(value)
               var s = value[1], _c2_ = caml_jsstring_of_string(s);
              else
               var _c2_ = no_handler;
              iDoc.execCommand(caml_jsstring_of_string(action), show, _c2_);
              return true$0;
             });
        but.onclick = t34;
       ...
       createButton(0, 0, _cp_, _co_);
       appendChild(body, createBr(document));
       createButton(0, _cs_, _cr_, _cq_);
       createButton(0, _cv_, _cu_, _ct_);
       createButton(0, _cy_, _cx_, _cw_);
       createButton(0, _cB_, _cA_, _cz_);
        ...
        return symbol
                (get
                  (iWin.prompt
                   ...
                   function(param){return caml_jsstring_of_string(default$0);}),
                 caml_string_of_jsstring);
       }
       var
        t45 =
          handler
           (function(param){
             var
              link = prompt(_cD_, _cC_),
              desc = prompt(_cF_, _cE_),
              link$0 =
                concat(_cJ_, [0, _cI_, [0, link, [0, _cH_, [0, desc, _cG_]]]]);
             iWin.alert(caml_jsstring_of_string(link$0));
             iDoc.execCommand
              (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
             return true$0;
            }),
        t46 = createButton(0, 0, _cL_, _cK_);
       t46.onclick = t45;
       var
        t53 =
          handler
           (function(param){
             var
              link = prompt(_cN_, _cM_),
              link$0 =
                symbol
                 ([0, _cR_, [0, link, [0, _cQ_, [0, link, _cP_]]]],
                  function(_c0_){return concat(_cO_, _c0_);});
             iWin.alert(caml_jsstring_of_string(link$0));
             iDoc.execCommand
              (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
             return true$0;
            }),
        t54 = createButton(0, 0, _cT_, _cS_);
       t54.onclick = t53;
       appendChild(body, createBr(document));
        ...
        function loop(d, param){
         ...
         var
          cb =
            remain == 0.
             ? callback$0
             : function(_cX_){return loop(remain, _cX_);};
        ...
        function create_result_promise_and_call(param){
         ...
         function callback(p_result){
          if(1 === p_result[0]){
           ...
           resolve(_bX_, 0, p$1, p_result);
           return 0;
          }
          var v = p_result[1];
          current_storage[1] = saved_storage;
          try{var _cW_ = f$0(v), user_provided_promise = _cW_;}
          catch(exn$0){
           var exn = caml_wrap_exception(exn$0);
          ...
          if(p$0 !== outer_promise){
           ...
           switch(match[0]){
             case 1:
              resolve(_bW_, 0, outer_promise, p$0[1]); break;
             case 2:
              var
               p_callbacks = match[1],
              ...
              break;
             default: resolve(_bV_, 0, outer_promise, p$0[1]);
           }
          }
          return 0;
         }
