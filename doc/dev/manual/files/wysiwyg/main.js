...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _en_ = caml_wrap_exception(_eo_);
      if(_en_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_en_, 0);
     }
     param$0 = l;
    }
   }
   ...
   var _l_ = "String.concat", _m_ = cst$0;
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _el_ = caml_ml_string_length(hd) + acc | 0;
    }
    var dst = caml_create_bytes(_el_), pos = pos$1, param$0 = l;
    for(;;){
     if(param$0){
      var hd$0 = param$0[1];
      if(param$0[2]){
   ...
   function do_at_exit$0(param){
    ...
    if(oldval !== none)
     ...
     var
      ...
      _ek_ = curval === oldval ? (st$1[1 + idx] = new_obj, 1) : 0;
     if(_ek_)
      var f = new_obj;
     else{
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _ej_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _ej_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ei_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ei_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ei_[1];
   ...
   function string_to_caml_string(str){
    var
     ...
     n = [0, 0],
     _d8_ = caml_ml_bytes_length(s$0) - 1 | 0,
     _d7_ = 0;
    if(_d8_ >= 0){
     var i$0 = _d7_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(s$0))
     ...
     n[1] = 0;
     var _d__ = caml_ml_bytes_length(s$0) - 1 | 0, _d9_ = 0;
     if(_d__ >= 0){
      var i = _d9_;
      for(;;){
    ...
    var
     str$0 = caml_string_of_bytes(_ed_),
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _d2_ = caml_ml_string_length(s) - 1 | 0, _d1_ = 0;
    if(_d2_ >= 0){
     var i$0 = _d1_;
     for(;;){
    ...
    var
     ...
     _d4_ = caml_ml_string_length(s) - 1 | 0,
     _d3_ = 0;
    if(_d4_ >= 0){
     var i = _d3_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _d0_ = _af_; break;
      default: var _d0_ = _ao_;
    }
    return transform_int_alt(iconv, caml_format_int(_d0_, n));
   }
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dZ_ = _aF_; break;
      default: var _dZ_ = _aO_;
    }
    return transform_int_alt(iconv, caml_format_int(_dZ_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dY_ = _aS_; break;
      default: var _dY_ = _a1_;
    }
    return transform_int_alt(iconv, caml_format_int(_dY_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dX_ = _as_; break;
      default: var _dX_ = _aB_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dX_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dU_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dU_ >>> 0){
           if(55 === _dU_) break a;
          }
          else if(21 < _dU_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0;
          i$0 = i$1;
          continue;
         }
        ...
        var _dW_ = _dV_ ? str : str + cst$5;
        return caml_special_val(_dW_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _dQ_ = l - 1 | 0, _dP_ = 0;
        if(_dQ_ >= 0){
         var i = _dP_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dR_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dR_);
          var _dS_ = i + 1 | 0;
          if(_dQ_ === i) break;
          i = _dS_;
         }
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _dM_ = fmt$0[1];
        if(0 === _dM_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _dM_[1][1];
         ...
         var rest$18 = fmt$0[2], fmt$2 = _dM_[1][1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dN_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dN_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dK_ = [8, acc, _a__];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dK_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dK_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dJ_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dJ_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dJ_, rest);
   }
   ...
   function other_fields(x, i){
    ...
    var _dH_ = other_fields(x, i + 1 | 0), _dI_ = field(x, i);
    return caml_call2(sprintf(_bh_), _dI_, _dH_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_dG_){break c;}
        if(val) break b;
       }
       param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _dC_ = other_fields(e, 2),
       _dD_ = field(e, 1),
       _dF_ = caml_call2(sprintf(_bi_), _dD_, _dC_);
     else
      switch(match){
        case 0:
         var _dF_ = _bj_; break;
        case 1:
         var _dF_ = _bk_; break;
        default:
         var _dE_ = field(e, 1), _dF_ = caml_call1(sprintf(_bl_), _dE_);
      }
     var match$0 = [0, constructor, [0, _dF_]];
    }
    else
     var match$0 = [0, e[1], 0];
   ...
   function print_raw_backtrace(outchan, raw_backtrace){
    ...
    if(_dA_ >= 0){
     ...
     for(;;){
      ...
      if(0 === slot[0]){
       if(slot[3] === slot[6])
        var _dp_ = slot[3], lines = caml_call1(sprintf(_bv_), _dp_);
       else
        var
         _dw_ = slot[6],
         _dx_ = slot[3],
         lines = caml_call2(sprintf(_bz_), _dx_, _dw_);
       var
        _dq_ = slot[7],
        _dr_ = slot[4],
        _ds_ = slot[8] ? _bw_ : _by_,
        _dt_ = slot[2],
        _du_ = slot[9],
        _dv_ = info(slot[1]),
        match =
          [0,
           caml_call7
            (sprintf(_bx_), _dv_, _du_, _dt_, _ds_, lines, _dr_, _dq_)];
      }
      else if(slot[1])
       var match = 0;
      else
       var _dy_ = info(0), match = [0, caml_call1(sprintf(_bA_), _dy_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dn_){}
      try{
       var _dd_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt), _dd_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _de_ = abs(status);
        prerr_endline(caml_check_bound(errors, _de_)[1 + _de_]);
       }
       var _dk_ = caml_ml_flush(stderr), _di_ = _dk_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dg_ = to_string(exn$0);
       caml_call1(fprintf(stderr, fmt$0), _dg_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dh_ = to_string(exn);
       caml_call1(fprintf(stderr, fmt$1), _dh_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _di_ = caml_ml_flush(stderr);
      }
      var _dj_ = _di_;
     }
     catch(_dm_){
      var _df_ = caml_wrap_exception(_dm_);
      if(_df_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_df_, 0);
      var _dj_ = prerr_endline(_bC_);
     }
     return _dj_;
    }
    catch(_dl_){return 0;}
   ...
   function BLAKE2(X){
    var _db_ = X[1] < 1 ? 1 : 0, _dc_ = _db_ || (64 < X[1] ? 1 : 0);
    if(_dc_) invalid_arg(_bD_);
   }
   BLAKE2([0, 16]);
   BLAKE2([0, 32]);
   BLAKE2([0, 64]);
   ...
   var
    ...
    _bT_ = [0, 0],
    _bU_ = [0, 0],
    _bQ_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bR_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _bS_ = [0, 0],
    _bP_ = "Lwt.Resolution_loop.Canceled",
    _bZ_ = "Exception during Lwt.async: ",
    _ce_ = "^error_in_anchor^",
    _b7_ = [0, cst_examples_wysiwyg_main_ml, 85, 77],
    _b9_ = [0, cst$3, 0],
    _b__ = cst$4,
    _b$_ = cst$0,
    _ca_ = [0, cst$3, 0],
    ...
    _cc_ = cst$4,
    _cd_ = cst$0,
    _b8_ = "^error2_in_anchor^",
    _b6_ = [0, cst_examples_wysiwyg_main_ml, 79, 44],
    _b4_ = cst,
    _b5_ = [0, "**"],
    _b2_ = [0, "//"],
    _b3_ = "----",
    ...
    _cB_ = "Enter a link",
    _cC_ = "desc",
    _cD_ = "Enter description",
    _cE_ = [0, cst_a, 0],
    _cF_ = '" wysitype="global">',
    _cG_ = cst_a_href,
    _cH_ = cst$0,
    _cg_ = "inserthorizontalrule",
    _ch_ = "hr",
    _ci_ = "removeformat",
    _cj_ = "remove format",
    _ck_ = "bold",
    ...
    _cm_ = "italic",
    _cn_ = cst_I,
    _co_ = cst_formatblock,
    _cp_ = cst_p,
    _cq_ = [0, [0, cst_p]],
    _cr_ = cst_formatblock,
    _cs_ = cst_h1,
    _ct_ = [0, [0, cst_h1]],
    _cu_ = cst_formatblock,
    _cv_ = cst_h2,
    _cw_ = [0, [0, cst_h2]],
    _cx_ = cst_formatblock,
    _cy_ = cst_h3,
    _cz_ = [0, [0, cst_h3]],
    _cI_ = cst_inserthtml,
    _cJ_ = "link",
    ...
    _cR_ = "link2wiki",
    _cS_ = cst$0,
    _cf_ = [0, cst_examples_wysiwyg_main_ml, 108, 70],
    _b0_ = "Dune__exe__Main.Break",
    ...
    for(;;){
     ...
     if(785140586 !== _c7_){
      if(982028505 <= _c7_){
       ...
       if(type){
        ...
        t32.push(' type="', t34, cst$6);
       }
       if(name){
        var v = name[1], t38 = caml_js_html_escape(v);
        t32.push(' name="', t38, cst$6);
       }
       t32.push(">");
       var t45 = t32.join(cst$0);
     ...
     try{
      var
       ...
       t50 = t49.tagName,
       _c__ = t50.toLowerCase() == cst_input ? 1 : 0,
       _c$_ = _c__ ? t49.name == "x" ? 1 : 0 : _c__,
       _c8_ = _c$_;
     }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c6_ = caml_call1(f, v); return _c6_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c5_ = result[1] === Canceled ? 1 : 0, is_canceled = _c5_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _c4_ = deferred_callbacks[2];
      if(! _c4_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _c4_[1];
      if(_c4_[2]){
       var next = _c4_[2];
   ...
   var Break = [248, _b0_, caml_fresh_oo_id(0)], overflow_limit = 2147483000.;
   function html2wiki(body){
    var ans = create(10);
    function add_str(opt, s1){
     var surr = opt ? opt[1] : _b1_, len = caml_ml_string_length(s1);
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _c2_ = 0, _c3_ = _c2_; break;}
       if
        (92 === caml_string_get(s1, i)
         && i < (len - 1 | 0) && 92 === caml_string_get(s1, i + 1 | 0)){var i$0 = i + 2 | 0; i = i$0; continue;}
       if(10 !== caml_string_get(s1, i))
     ...
     if(! _c3_) return;
     var s2 = s1 + surr;
     return add_string(ans, surr + s2);
    }
    var
     childNodes = body.childNodes,
     _c0_ = childNodes.length - 1 | 0,
     _cZ_ = 0;
    if(_c0_ >= 0){
     var t2 = _cZ_;
     for(;;){
      var node = childNodes.item(t2);
      if(1 - (node == no_handler ? 1 : 0)){
       var
       ...
       a:
       {
        ...
        {
         if(0 <= switch$0){
          if(0 < switch$0 && hh !== "H2" && hh !== "H3"){
           if(hh === "HR"){add_string(ans, _b3_); break a;}
           if(hh === cst_I){
            var inner$0 = html2wiki(node);
            add_str(_b2_, inner$0);
            break a;
           }
           if(hh !== "P") break b;
           var inner = html2wiki(node);
           add_str(0, inner + cst$7);
           break a;
          }
          var
           ...
           s2$0 = inner$1 + cst$7;
          add_string(ans, prefix + s2$0);
          break a;
         }
         if(hh === "#text"){
          var x$2 = node.nodeValue, match = x$2 == no_handler ? 0 : [0, x$2];
          if(! match) break a;
          var x$3 = match[1];
          add_string(ans, caml_string_of_jsstring(x$3));
          break a;
         }
         if(hh === "A"){
          if(node == no_handler)
           throw caml_maybe_attach_backtrace([0, Assert_failure, _b6_], 1);
          var x$1 = node.getAttribute("wysitype");
          if(x$1 == no_handler){add_string(ans, _ce_); break a;}
          var x = node.getAttribute("href");
          if(x == no_handler)
           throw caml_maybe_attach_backtrace([0, Assert_failure, _b7_], 1);
          var
           url = caml_string_of_jsstring(x),
           match$0 = caml_string_of_jsstring(x$1);
          if(match$0 === "global"){
           var desc = html2wiki(node);
           add_string
            (ans,
             concat(_cd_, [0, _cc_, [0, url, [0, _cb_, [0, desc, _ca_]]]]));
           break a;
          }
          if(match$0 !== "wiki"){add_string(ans, _b8_); break a;}
          var x$0 = concat(_b$_, [0, _b__, [0, url, _b9_]]);
          add_string(ans, x$0);
          break a;
         }
         if(hh === cst_B){
          var inner$3 = html2wiki(node);
          add_str(_b5_, inner$3);
          break a;
         }
         if(hh === "BR"){add_string(ans, _b4_); break a;}
         if(hh === "DIV"){
          var inner$2 = html2wiki(node);
          add_string(ans, inner$2);
          break a;
         }
        }
        var s2 = hh + cst$8;
        add_string(ans, cst$8 + s2);
       }
      }
      var _c1_ = t2 + 1 | 0;
      if(_c0_ === t2) break;
   ...
   function onload(param){
    ...
    var iframe = createElement(document, name$0), t14 = iframe.style;
    t14.border = "2px green solid";
    iframe.src = "#";
    iframe.id = "wysiFrame";
    appendChild(body, iframe);
    var iDoc = iframe.contentDocument;
    if(1 - (iDoc == no_handler ? 1 : 0)){
     iDoc.open();
     iDoc.write
     ...
     appendChild(body, createElement(document, name));
     var
      createButton =
        function(_cY_, opt, title, action){
         var
          show = _cY_ ? _cY_[1] : false$0,
          value = opt ? opt[1] : 0,
          type = [0, "submit"],
          but = unsafeCreateElementEx(type, 0, document, _bN_),
          ...
          t34 =
            handler
             (function(param){
               iWin.focus();
               if(value)
                var s = value[1], t32 = caml_jsstring_of_string(s);
               else
                var t32 = no_handler;
               var t30 = caml_jsstring_of_string(action);
               iDoc.execCommand(t30, show, t32);
               return true$0;
              });
         but.onclick = t34;
     ...
     createButton(0, 0, _cl_, _ck_);
     createButton(0, 0, _cn_, _cm_);
     appendChild(body, createElement(document, name));
     ...
     var
      prompt =
        function(query, default$0){
         var
          t37 = caml_jsstring_of_string(default$0),
          t36 = caml_jsstring_of_string(query),
          x = iWin.prompt(t36, t37),
          x$0 = x == no_handler ? caml_jsstring_of_string(default$0) : x;
         return caml_string_of_jsstring(x$0);
        },
      t45 =
        handler
         (function(param){
           var
            link = prompt(_cB_, _cA_),
            desc = prompt(_cD_, _cC_),
            link$0 =
              concat(_cH_, [0, _cG_, [0, link, [0, _cF_, [0, desc, _cE_]]]]),
            t39 = caml_jsstring_of_string(link$0);
           iWin.alert(t39);
           var t43 = caml_jsstring_of_string(link$0);
           iDoc.execCommand(cst_inserthtml, false$0, t43);
           return true$0;
          }),
      t46 = createButton(0, 0, _cJ_, _cI_);
     t46.onclick = t45;
     var
      t53 =
        handler
         (function(param){
           var
            link = prompt(_cL_, _cK_),
            x = [0, _cP_, [0, link, [0, _cO_, [0, link, _cN_]]]],
            link$0 = concat(_cM_, x),
            t47 = caml_jsstring_of_string(link$0);
           iWin.alert(t47);
           var t51 = caml_jsstring_of_string(link$0);
           iDoc.execCommand(cst_inserthtml, false$0, t51);
           return true$0;
          }),
      t54 = createButton(0, 0, _cR_, _cQ_);
     t54.onclick = t53;
     appendChild(body, createElement(document, name));
     var preview = unsafeCreateElementEx(0, 0, document, _bO_);
     ...
     var wikiFrame = unsafeCreateElementEx(0, 0, document, _bO_);
        ...
        function(old_text, n){
         ...
         if(text !== old_text){
          ...
          var
           y = n - 1 | 0,
           x = 0,
           _cT_ = caml_greaterequal(0, y) ? x : y,
           n$0 = _cT_;
         var d$0 = 0 === n$0 ? 0.5 : 0.1, p = new_pending(1), d = d$0 * 1000.;
         function callback$0(v){
          var result$0 = [0, v], p$0 = underlying(p), _cW_ = p$0[1];
          switch(_cW_[0]){
            case 1:
             return _cW_[1] === Canceled
                     ? 0
         ...
         function loop(d, param){
          ...
          var
           cb =
             remain === 0.
              ? callback$0
              : function(_cV_){return loop(remain, _cV_);},
         ...
         function create_result_promise_and_call(param){
          ...
          function callback(p_result){
           if(1 === p_result[0]){
            var p$0 = underlying(p);
            resolve(_bV_, 0, p$0, p_result);
            return 0;
           }
           current_storage[1] = saved_storage;
           try{
            var _cU_ = dyn_preview(text, n$0), user_provided_promise = _cU_;
           }
           catch(exn$0){
            var exn = caml_wrap_exception(exn$0);
           ...
           if(p1 !== outer_promise){
            ...
            switch(match[0]){
              case 1:
               resolve(_bU_, 0, outer_promise, p1[1]); break;
              case 2:
               var
                p_callbacks = match[1],
               ...
               p1[1] = state;
               break;
              default: resolve(_bT_, 0, outer_promise, p1[1]);
            }
           }
           return 0;
          }
         ...
         switch(result[0]){
           ...
           case 2:
            var
             ...
             node =
               typeof existing === "number" ? node$0 : [0, node$0, existing];
            p_callbacks[1] = node;
            return p$1;
           default:
