...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     s$2=caml_string_of_jsbytes("3.7.0"),
    ...
    var
     ...
     _x_=[0,0,0,0],
     _y_=[0,caml_string_of_jsbytes("map.ml"),398,10],
     _z_=[0,0,0],
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_hJ_ = caml_wrap_exception(_hJ_);
              if(_hJ_[1] !== Sys_error)throw _hJ_;
              var _hI_=_hJ_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function iteri(f,a)
     {var _hG_=a.length - 1 - 1 | 0,_hF_=0;
      if(! (_hG_ < 0))
       {var i=_hF_;
        for(;;)
    ...
    function _A_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_hE_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
           ...
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_hz_=height(lr);
            ...
            if(lr)
             {var
               ...
               lrv=lr[2],
               lrl=lr[1],
               _hA_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_hA_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_hB_=height(rl);
            if(_hB_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _hC_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_hC_)}
            return invalid_arg(_u_)}
          return invalid_arg(_v_)}
        var _hD_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_hD_]}
      var empty=0;
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _g$_=c;
          return function(_ha_){return seq_of_enum(_g$_,_ha_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_gO_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_gO_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_gP_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_gP_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_gQ_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_gQ_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_gR_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_gR_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_gS_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_gS_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_gT_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_gT_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_gU_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_gU_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_gV_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_gV_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_gW_=ty1[2],_gX_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_gY_=trans(_gW_,rest2$7);
              return [8,trans(_gX_,ty2),_gY_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_gZ_=ty1[3],_g0_=ty1[2],_g1_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_g0_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_g1_,ty22,trans(_gZ_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_g2_,rest2$9)]}
          throw [0,Assert_failure,_am_];
         case 11:
          var switch$11=0,_g3_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_g3_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_an_];
          break;
         case 12:
          var switch$12=0,_g4_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_g4_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ao_];
          break;
         case 13:
          var switch$13=0,_g5_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_g5_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ap_];
          break;
         default:
          var switch$14=0,_g6_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_g6_,rest2$13)];
             default:switch$14 = 1}
       ...
       {if(prec)
         {var _gp_=match[2];
          if(typeof _gp_ !== "number" && 2 === _gp_[0])
           {var rest=_gp_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _gn_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_gn_))
             throw Type_mismatch;
            var _go_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_go_))
             throw Type_mismatch;
            var
         ...
         case 4:
          ...
          if(typeof _ga_ !== "number" && 2 === _ga_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_f$_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           _gc_=match$7[3],
           _gb_=match$7[1];
          if(typeof _gc_ !== "number" && 3 === _gc_[0])
           {var
             fmtty_rest$4=_gc_[1],
             prec$2=match$7[2],
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_gb_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _ge_=match$9[3],
           _gd_=match$9[1];
          if(typeof _ge_ !== "number" && 4 === _ge_[0])
           {var
             fmtty_rest$5=_ge_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_gd_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _gg_=match$11[3],
           _gf_=match$11[1];
          if(typeof _gg_ !== "number" && 5 === _gg_[0])
           {var
             fmtty_rest$6=_gg_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_gf_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _gi_=match$13[3],
           _gh_=match$13[1];
          if(typeof _gi_ !== "number" && 6 === _gi_[0])
           {var
             fmtty_rest$7=_gi_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_gh_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _gk_=match$15[2],
           _gj_=match$15[1];
          if(typeof _gk_ !== "number" && 7 === _gk_[0])
           {var
             fmtty_rest$8=_gk_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_gj_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _gl_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_gl_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _gm_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_gm_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_gm_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _f6_=2 === padty$0?48:32,res=make(width$0,_f6_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _f4_ >>> 0)
           {if(33 < (_f4_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _f4_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _fX_=caml_ml_bytes_length(s$0) - 1 | 0,
           _fW_=0;
          if(! (_fX_ < 0))
           {var i$0=_fW_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _f1_=match - 34 | 0,switch$2=0;
                if(58 < _f1_ >>> 0)
                 {if(93 <= _f1_)switch$2 = 1}
                else
                 if(56 < (_f1_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _f2_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _f2_=4;break;case 1:var _f2_=2;break}
              n[1] = n[1] + _f2_ | 0;
              var _f3_=i$0 + 1 | 0;
              if(_fX_ !== i$0){var i$0=_f3_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _fZ_=caml_ml_bytes_length(s$0) - 1 | 0,_fY_=0;
            if(! (_fZ_ < 0))
             {var i=_fY_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _f5_=s}
          var str$0=caml_string_of_bytes(_f5_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_fR_=caml_ml_string_length(s) - 1 | 0,_fQ_=0;
        if(! (_fR_ < 0))
         {var i$0=_fQ_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _fV_=i$0 + 1 | 0;
            if(_fR_ !== i$0){var i$0=_fV_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _fT_=caml_ml_string_length(s) - 1 | 0,
         _fS_=0;
        if(! (_fT_ < 0))
         {var i=_fS_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _fP_=_at_;break;
        ...
        case 8:var _fP_=_aA_;break;
        case 9:var _fP_=_aB_;break;
        case 10:var _fP_=_aC_;break;
        case 11:var _fP_=_aD_;break;
        case 0:
        case 13:var _fP_=_as_;break;
        case 3:
        case 14:var _fP_=_av_;break;
        default:var _fP_=_aE_}
      return transform_int_alt(iconv,caml_format_int(_fP_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _fO_=_aT_;break;
        case 2:var _fO_=_aU_;break;
        case 4:var _fO_=_aW_;break;
        case 5:var _fO_=_aX_;break;
        case 6:var _fO_=_aY_;break;
        case 7:var _fO_=_aZ_;break;
        case 8:var _fO_=_a0_;break;
        case 9:var _fO_=_a1_;break;
        case 10:var _fO_=_a2_;break;
        case 11:var _fO_=_a3_;break;
        case 0:
        case 13:var _fO_=_aS_;break;
        case 3:
        case 14:var _fO_=_aV_;break;
        default:var _fO_=_a4_}
      return transform_int_alt(iconv,caml_format_int(_fO_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _fN_=_a6_;break;
        case 2:var _fN_=_a7_;break;
        case 4:var _fN_=_a9_;break;
        case 5:var _fN_=_a__;break;
        case 6:var _fN_=_a$_;break;
        case 7:var _fN_=_ba_;break;
        case 8:var _fN_=_bb_;break;
        case 9:var _fN_=_bc_;break;
        case 10:var _fN_=_bd_;break;
        case 11:var _fN_=_be_;break;
        case 0:
        case 13:var _fN_=_a5_;break;
        case 3:
        case 14:var _fN_=_a8_;break;
        default:var _fN_=_bf_}
      return transform_int_alt(iconv,caml_format_int(_fN_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _fM_=_aG_;break;
        case 2:var _fM_=_aH_;break;
        case 4:var _fM_=_aJ_;break;
        case 5:var _fM_=_aK_;break;
        case 6:var _fM_=_aL_;break;
        case 7:var _fM_=_aM_;break;
        case 8:var _fM_=_aN_;break;
        case 9:var _fM_=_aO_;break;
        case 10:var _fM_=_aP_;break;
        case 11:var _fM_=_aQ_;break;
        case 0:
        case 13:var _fM_=_aF_;break;
        case 3:
        case 14:var _fM_=_aI_;break;
        default:var _fM_=_aR_}
      return transform_int_alt(iconv,caml_int64_format(_fM_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _fJ_ >>> 0)
              {if(55 === _fJ_)switch$0 = 1}
             else
              if(21 < (_fJ_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _fK_=1}
           var _fL_=_fK_?str:symbol(str,_bg_);
           return caml_special_val(_fL_)}
        case 6:return hex(0);
        case 7:
            ...
            {var i=_fE_;
             for(;;)
              {var c=caml_bytes_unsafe_get(s,i),switch$1=0;
               if(97 <= c && ! (122 < c)){var _fG_=c - 32 | 0;switch$1 = 1}
               if(! switch$1)var _fG_=c;
               caml_bytes_unsafe_set(r,i,_fG_);
               var _fH_=i + 1 | 0;
               if(_fF_ !== i){var i=_fH_;continue}
               break}}
           var _fI_=r}
         return caml_string_of_bytes(_fI_);
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _fA_=pad$5[2],_fB_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_fB_,_fA_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_fB_,_fA_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_fB_,_fA_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _fC_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_fC_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_fC_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_fC_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_fn_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_fn_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _by_;
      var _fl_=other_fields(x,i + 1 | 0),_fm_=field(x,i);
      return caml_call2(sprintf(_bz_),_fm_,_fl_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _fg_=other_fields(e,2),
          _fh_=field(e,1),
          _fj_=caml_call2(sprintf(_bA_),_fh_,_fg_);
        else
         switch(match)
          {case 0:var _fj_=_bB_;break;
           case 1:var _fj_=_bC_;break;
           default:var _fi_=field(e,1),_fj_=caml_call1(sprintf(_bD_),_fi_)}
        return symbol(constructor,_fj_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _fe_=a.length - 1 - 1 | 0,_fd_=0;
        if(! (_fe_ < 0))
         {var i=_fd_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _fb_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bO_),_fb_,_fa_,_e$_,_e__,_e9_,_e8_)];
            else
             if(slot[1])
              var match=0;
             else
              var _fc_=info(0),match=[0,caml_call1(sprintf(_bQ_),_fc_)];
    ...
    function get_method_label(table,name)
     {try
       {var _eT_=caml_call2(Meths[27],name,table[3]);return _eT_}
      catch(_eU_)
    ...
    function new_variable(table,name)
     {try
       {var _eR_=caml_call2(Vars[27],name,table[7]);return _eR_}
      catch(_eS_)
    ...
    var
     ...
     arr=_ch_.split(caml_jsstring_of_string(make$0(1,38))),
     len$0=arr.length;
            ...
            function(s)
             {function _eE_(param)
              ...
              if(index < 0)
               ...
               var _eC_=s.slice(index + 1 | 0),_eD_=[0,s.slice(0,index),_eC_];
    ...
    function put_pixmap(param,x,y,xsrc,ysrc,width,height,_ed_)
    ...
    function http_get(url)
     {var opt=[0,0];
      ...
      req.open("GET",caml_jsstring_of_string(url),capt);
      req.responseType = "";
      if(content_type$0)
         ...
         headers$0=
          function(s)
           {function _d0_(v){return [0,caml_string_of_jsstring(v)]}
            ...
            return case$0
                    (req.getResponseHeader(caml_jsbytes_of_string(s)),_d1_,_d0_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
           {if(382334108 === st[1])
                ...
                {var
                  ...
                  response=
                   [0,
                    ...
                    code,
                    headers$0,
                    case$0(req.responseText,_dX_,_dW_),
                    _dV_];
        ...
        handler
         (function(param)
           {var page=doc.documentElement;
            ...
            function _c__(s)
             {var
               _c$_=json.parse(caml_jsstring_of_string(s)),
               scene=_c$_[3],
               bboxes=_c$_[2],
               match=_c$_[1],
               y2=match[4],
