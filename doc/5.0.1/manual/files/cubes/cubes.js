...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     _y_=caml_string_of_jsbytes("%c"),
     _z_=caml_string_of_jsbytes("%s"),
     _A_=caml_string_of_jsbytes("%i"),
     _B_=caml_string_of_jsbytes("%li"),
     _C_=caml_string_of_jsbytes("%ni"),
     _D_=caml_string_of_jsbytes("%Li"),
     _E_=caml_string_of_jsbytes("%f"),
     _F_=caml_string_of_jsbytes("%B"),
     _G_=caml_string_of_jsbytes("%{"),
     _H_=caml_string_of_jsbytes("%}"),
     _I_=caml_string_of_jsbytes("%("),
     _J_=caml_string_of_jsbytes("%)"),
     _K_=caml_string_of_jsbytes("%a"),
     _L_=caml_string_of_jsbytes("%t"),
     _M_=caml_string_of_jsbytes("%?"),
     _N_=caml_string_of_jsbytes("%r"),
     _O_=caml_string_of_jsbytes("%_r"),
     _P_=[0,caml_string_of_jsbytes("camlinternalFormat.ml"),850,23],
     _$_=[0,caml_string_of_jsbytes("camlinternalFormat.ml"),814,21],
     _S_=[0,caml_string_of_jsbytes("camlinternalFormat.ml"),815,21],
     ...
     _Q_=[0,caml_string_of_jsbytes("camlinternalFormat.ml"),837,26],
     ___=[0,caml_string_of_jsbytes("camlinternalFormat.ml"),846,28],
     _R_=[0,caml_string_of_jsbytes("camlinternalFormat.ml"),847,28],
     ...
     _bW_=caml_int64_create_lo_mi_hi(14371852,15349651,22696),
     _bX_=caml_int64_create_lo_mi_hi(12230193,11438743,35013),
     _bY_=caml_int64_create_lo_mi_hi(1424933,15549263,2083),
     _bZ_=caml_int64_create_lo_mi_hi(9492471,4696708,43520),
     _bV_=caml_string_of_jsbytes("Random.int"),
     ...
     _b0_=caml_string_of_jsbytes("Jsoo_runtime.Error.Exn"),
     ...
     _cc_=caml_string_of_jsbytes("Exception during Lwt.async: ");
         ...
         {if(! param$0)return 0;
          ...
          try
           ...
           {_e$_ = caml_wrap_exception(_e$_);
            if(_e$_[1] !== Sys_error)throw _e$_}
          var param$0=l}}
     ...
     {var switch$0=0;
      if(0 <= ofs && 0 <= len && (caml_ml_bytes_length(b) - len | 0) >= ofs)
       {var r=caml_create_bytes(len);
        ...
        var _e__=r;
        switch$0 = 1}
      if(! switch$0)var _e__=invalid_arg(_k_);
      return caml_string_of_bytes(_e__)}
    ...
    function init(l,f)
     {if(0 === l)return [0];
      ...
      var res=caml_make_vect(l,caml_call1(f,0)),_e8_=l - 1 | 0,_e7_=1;
      if(_e8_ >= 1)
       {var i=_e7_;
        for(;;)
         {res[1 + i] = caml_call1(f,i);
          var _e9_=i + 1 | 0;
          if(_e8_ !== i){var i=_e9_;continue}
          break}}
      return res}
    var Empty=[248,_p_,caml_fresh_oo_id(0)];
    function add(x,q)
     {var cell=[0,x,0],_e6_=q[3];
      return _e6_
              ?(q[1] = q[1] + 1 | 0,_e6_[2] = cell,q[3] = cell,0)
    ...
    function get(param)
     {var
      ...
      return v$0}
    var at_exit_key=new_key(0,function(param,_e5_){return 0});
      ...
      switch(formatting_lit[0])
       {case 0:var str=formatting_lit[1];return str;
        ...
        default:
         ...
         return cat(_x_,caml_string_of_bytes(make(1,c)))}}
        ...
        {case 0:
         ...
         case 10:
          ...
          if(typeof ty2 !== "number" && 10 === ty2[0])
           {var rest2$9=ty2[1];return [10,trans(_eA_,rest2$9)]}
          throw [0,Assert_failure,_$_];
         case 11:
          var switch$11=0,_eB_=ty1[1];
          if(typeof ty2 === "number")
           switch$11 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:var rest2$10=ty2[1];return [11,trans(_eB_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_aa_];
          break;
         case 12:
          var switch$12=0,_eC_=ty1[1];
          if(typeof ty2 === "number")
           switch$12 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=ty2[1];return [12,trans(_eC_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ab_];
          break;
         case 13:
          var switch$13=0,_eD_=ty1[1];
          if(typeof ty2 === "number")
           switch$13 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=ty2[1];return [13,trans(_eD_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ac_];
          break;
         default:
          var switch$14=0,_eE_=ty1[1];
          if(typeof ty2 === "number")
           switch$14 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=ty2[1];return [14,trans(_eE_,rest2$13)];
             default:switch$14 = 1}
    ...
    function type_padprec(pad,prec,fmtty)
     {var match=type_padding(pad,fmtty);
      ...
      var _el_=match[2];
      if(typeof _el_ !== "number" && 2 === _el_[0])
       {var rest=_el_[1],pad$0=match[1];return [0,pad$0,1,rest]}
      throw Type_mismatch}
       ...
       {var i$0=_dT_;
        for(;;)
         {var match=caml_bytes_unsafe_get(s$0,i$0),switch$0=0;
          if(32 <= match)
           {var _dY_=match - 34 | 0,switch$1=0;
            if(58 < _dY_ >>> 0)
             {if(93 <= _dY_)switch$1 = 1}
            else
             if(56 < _dY_ - 1 >>> 0){switch$0 = 1;switch$1 = 1}
            if(! switch$1){var _dZ_=1;switch$0 = 2}}
          else
           if(11 <= match)
            {if(13 === match)switch$0 = 1}
           else
            if(8 <= match)switch$0 = 1;
          switch(switch$0){case 0:var _dZ_=4;break;case 1:var _dZ_=2;break}
          n[1] = n[1] + _dZ_ | 0;
          var _d0_=i$0 + 1 | 0;
          if(_dU_ !== i$0){var i$0=_d0_;continue}
          break}}
       ...
       {var i$0=_dN_;
        for(;;)
         {var match=caml_string_unsafe_get(s,i$0);
          if(9 >= match - 48 >>> 0)n[1]++;
          var _dS_=i$0 + 1 | 0;
          if(_dO_ !== i$0){var i$0=_dS_;continue}
          break}}
      var
       digits=n[1],
       buf=
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _dM_=_ag_;break;
        case 2:var _dM_=_ah_;break;
        case 4:var _dM_=_aj_;break;
        case 5:var _dM_=_ak_;break;
        case 6:var _dM_=_al_;break;
        case 7:var _dM_=_am_;break;
        case 8:var _dM_=_an_;break;
        case 9:var _dM_=_ao_;break;
        case 10:var _dM_=_ap_;break;
        case 11:var _dM_=_aq_;break;
        case 0:
        case 13:var _dM_=_af_;break;
        case 3:
        case 14:var _dM_=_ai_;break;
        default:var _dM_=_ar_}
      return transform_int_alt(iconv,caml_format_int(_dM_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _dL_=_aG_;break;
        case 2:var _dL_=_aH_;break;
        case 4:var _dL_=_aJ_;break;
        case 5:var _dL_=_aK_;break;
        case 6:var _dL_=_aL_;break;
        case 7:var _dL_=_aM_;break;
        case 8:var _dL_=_aN_;break;
        case 9:var _dL_=_aO_;break;
        case 10:var _dL_=_aP_;break;
        case 11:var _dL_=_aQ_;break;
        case 0:
        case 13:var _dL_=_aF_;break;
        case 3:
        case 14:var _dL_=_aI_;break;
        default:var _dL_=_aR_}
      return transform_int_alt(iconv,caml_format_int(_dL_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _dK_=_aT_;break;
        case 2:var _dK_=_aU_;break;
        case 4:var _dK_=_aW_;break;
        case 5:var _dK_=_aX_;break;
        case 6:var _dK_=_aY_;break;
        case 7:var _dK_=_aZ_;break;
        case 8:var _dK_=_a0_;break;
        case 9:var _dK_=_a1_;break;
        case 10:var _dK_=_a2_;break;
        case 11:var _dK_=_a3_;break;
        case 0:
        case 13:var _dK_=_aS_;break;
        case 3:
        case 14:var _dK_=_aV_;break;
        default:var _dK_=_a4_}
      return transform_int_alt(iconv,caml_format_int(_dK_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _dJ_=_at_;break;
        case 2:var _dJ_=_au_;break;
        case 4:var _dJ_=_aw_;break;
        case 5:var _dJ_=_ax_;break;
        case 6:var _dJ_=_ay_;break;
        case 7:var _dJ_=_az_;break;
        case 8:var _dJ_=_aA_;break;
        case 9:var _dJ_=_aB_;break;
        case 10:var _dJ_=_aC_;break;
        case 11:var _dJ_=_aD_;break;
        case 0:
        case 13:var _dJ_=_as_;break;
        case 3:
        case 14:var _dJ_=_av_;break;
        default:var _dJ_=_aE_}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _dG_ >>> 0)
              {if(55 === _dG_)switch$0 = 1}
             else
              if(21 < _dG_ - 1 >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _dH_=1}
           var _dI_=_dH_?str:cat(str,_a5_);
         ...
         return prec
                 ?function(p,x)
                   {var
                     str=
                      fix_padding
                       (_dz_,_dy_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(x)
                   {var str=fix_padding(_dz_,_dy_,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$0=prec[1];
        return function(x)
         {var
           str=
            fix_padding
             (_dz_,_dy_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}
      var _dA_=pad[1];
      if(typeof prec === "number")
       return prec
               ?function(w,p,x)
                 {var
                   str=
                    fix_padding
                     (_dA_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                  return make_printf(k,[4,acc,str],fmt)}
               :function(w,x)
                 {var str=fix_padding(_dA_,w,caml_call2(trans,iconv,x));
                  return make_printf(k,[4,acc,str],fmt)};
      var p$1=prec[1];
      return function(w,x)
       {var
         str=
          fix_padding(_dA_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
        return make_printf(k,[4,acc,str],fmt)}}
        ...
        switch(fmt$0[0])
         {case 0:
            ...
            {if(typeof prec$3 === "number")
             ...
             return function(x)
              {var str=convert_float(fconv,p,x);
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
           if(0 === pad$5[0])
            {var _du_=pad$5[2],_dv_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(p,x)
                        {var str=fix_padding(_dv_,_du_,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_dv_,_du_,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$0=prec$3[1];
             return function(x)
              {var str=fix_padding(_dv_,_du_,convert_float(fconv,p$0,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
           var _dw_=pad$5[1];
           if(typeof prec$3 === "number")
            return prec$3
                    ?function(w,p,x)
                      {var str=fix_padding(_dw_,w,convert_float(fconv,p,x));
                       return make_printf(k$0,[4,acc$0,str],rest$7)}
                    :function(w,x)
                      {var
                        str=convert_float(fconv,default_float_precision(fconv),x),
                        str$0=fix_padding(_dw_,w,str);
                       return make_printf(k$0,[4,acc$0,str$0],rest$7)};
           var p$1=prec$3[1];
           return function(w,x)
            {var str=fix_padding(_dw_,w,convert_float(fconv,p$1,x));
             return make_printf(k$0,[4,acc$0,str],rest$7)};
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
             ...
             if(typeof _dx_[2] !== "number")throw Type_mismatch;
             var fmt=_dx_[1];
          ...
          default:
           ...
           if(counter >= 50)
            return caml_trampoline_return
                    (make_custom$0,[0,k$0,acc$0,rest$19,arity,_dt_]);
           var counter$0=counter + 1 | 0;
           return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_dt_)}}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _dq_=[8,acc,_bd_];
      if(counter >= 50)
       return caml_trampoline_return(make_printf$0,[0,k,_dq_,fmt]);
      var counter$0=counter + 1 | 0;
      return make_printf$0(counter$0,k,_dq_,fmt)}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      var _dp_=[4,acc,f];
      if(counter >= 50)
       return caml_trampoline_return(make_printf$0,[0,k,_dp_,rest]);
      var counter$0=counter + 1 | 0;
      return make_printf$0(counter$0,k,_dp_,rest)}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_dk_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_dk_,fmt)}
    ...
    function field(x,i$1)
     {var a=x[1 + i$1];
      ...
      if(caml_obj_tag(a) !== 253)return _bj_;
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bl_;
      var _di_=other_fields(x,i + 1 | 0),_dj_=field(x,i);
      return caml_call2(sprintf(_bm_),_dj_,_di_)}
     ...
     {function conv(param)
       {var param$0=param;
        for(;;)
         {if(! param$0)return 0;
          ...
          try {var switch$0=0,val=caml_call1(hd,e);switch$0 = 1}catch(_dh_){}
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _dd_=other_fields(e,2),
          _de_=field(e,1),
          _dg_=caml_call2(sprintf(_bn_),_de_,_dd_);
        else
         switch(match)
          {case 0:var _dg_=_bo_;break;
           case 1:var _dg_=_bp_;break;
           default:var _df_=field(e,1),_dg_=caml_call1(sprintf(_bq_),_df_)}
        var match$1=[0,constructor,[0,_dg_]]}
      else
       var match$1=[0,e[1],0];
         ...
         {var
          ...
          if(0 === slot[0])
           var
            ...
            _c5_=slot[4],
            _c6_=slot[3],
            _c7_=slot[6]?_bA_:_bC_,
            _c8_=slot[2],
            _c9_=slot[7],
            _c__=info(slot[1]),
            match=
             [0,caml_call7(sprintf(_bB_),_c__,_c9_,_c8_,_c7_,_c6_,_c5_,_c4_)];
          else
           if(slot[1])
            var match=0;
           else
            var _c$_=info(0),match=[0,caml_call1(sprintf(_bD_),_c$_)];
    ...
    function default_uncaught_exception_han(exn,raw_backtrace)
     {var _c1_=to_string(exn);
      caml_call1(eprintf(_bG_),_c1_);
      print_raw_backtrace(stderr,raw_backtrace);
      var status=caml_ml_debug_info_status(0);
      if(status < 0)
       {var _c2_=abs(status);
        prerr_endline(caml_check_bound(errors,_c2_)[1 + _c2_])}
      return caml_ml_flush(stderr)}
     ...
     {try
       {try
         {var
          ...
          try {do_at_exit(0)}catch(_c0_){}
          try
           {var
             _cW_=default_uncaught_exception_han(exn,raw_backtrace),
             _cV_=_cW_}
          catch(exn$0)
           {exn$0 = caml_wrap_exception(exn$0);
            var
             ...
             _cT_=to_string(exn);
            caml_call1(eprintf(_bI_),_cT_);
            print_raw_backtrace(stderr,raw_backtrace);
            var _cU_=to_string(exn$0);
            caml_call1(eprintf(_bJ_),_cU_);
            print_raw_backtrace(stderr,raw_backtrace$0);
            var _cV_=caml_ml_flush(stderr)}
          var _cX_=_cV_}
        catch(_cZ_)
         {_cZ_ = caml_wrap_exception(_cZ_);
          if(_cZ_ !== Out_of_memory)throw _cZ_;
          var _cX_=prerr_endline(_bH_)}
        return _cX_}
      catch(_cY_){return 0}}
    caml_register_named_value
    ...
    function mk_default(param){return mk(_bZ_,_bY_,_bX_,_bW_)}
     ...
     {var _cS_=p[1];
      switch(_cS_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_cS_[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _cR_=caml_call1(f,v);return _cR_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _cP_=result[1] === Canceled?1:0,is_canceled=_cP_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_cN_,0)}
      var _cO_=callbacks[1];
      ...
      return iter_callback_list$0(_cO_,0)}
    var
       ...
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _cL_=deferred_callbacks[2];
           ...
           var result=_cM_[2],callbacks=_cM_[1];
      ...
      switch(_cJ_[0])
       {case 1:return resolve(_b8_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _cH_=p_callbacks[2],
          _cI_=outer_callbacks[2],
          cancel_callbacks=
           typeof _cI_ === "number"
            ?_cH_
            :typeof _cH_ === "number"?_cI_:[0,_cI_,_cH_];
    ...
    var pause_hook=[0,function(_cG_){return 0}],s1=create(0),_cb_=[0,0];
    ...
    var
     d2=bytes(b),
     _bR_=get_int64_le(d2,8),
     _bS_=get_int64_le(d2,0),
     _bT_=get_int64_le(d1,8);
    set(s$0,get_int64_le(d1,0),_bT_,_bS_,_bR_);
    ...
    function draw_top(t20)
     {t20.fillStyle = "#a8a8f6";
      ...
      t20.lineTo(0.,10.);
      return t20.fill()}
    function top_edges(t31)
     {t31.beginPath();
      t31.moveTo(0.,10.);
      t31.lineTo(17.,0.);
      t31.lineTo(34.,10.);
      return t31.stroke()}
    function draw_right(t47)
     {t47.fillStyle = "#767676";
      ...
      t47.lineTo(34.,10.);
      return t47.fill()}
    function right_edges(t58)
     {t58.beginPath();
      t58.moveTo(17.,40.);
      t58.lineTo(17.,20.);
      t58.lineTo(34.,10.);
      return t58.stroke()}
    function draw_left(t74)
          ...
          {if(0 <= j$1[1])
            {var _cw_=j$1[1];
             if
              (!
               caml_check_bound
                 (caml_check_bound(caml_check_bound(a,i$1)[1 + i$1],_cw_)
                   [1 + _cw_],
                  k$1)
                [1 + k$1])
              {j$1[1] += -1;continue}}
               ...
               {if(0 <= i$0[1])
                 {var _ct_=i$0[1];
                  if
                   (!
                    caml_check_bound
                      (caml_check_bound(caml_check_bound(a,_ct_)[1 + _ct_],j$0)
                        [1 + j$0],
                       k$0)
                     [1 + k$0])
                   {i$0[1] += -1;continue}}
    ...
    function loop(c$0,c,a)
     {function f$0(param)
      ...
      function callback$0(_cl_){return wakeup(t,_cl_)}
      var id=[0,0];
      function loop$0(d,param)
       {if(2147483000. < d)
         ...
         var remain=0.,step=d;
        var
         cb=remain == 0.?callback$0:function(_ck_){return loop$0(remain,_ck_)},
         t125=caml_js_wrap_callback(cb);
        id[1] = [0,t143.setTimeout(t125,step)];
        return 0}
      loop$0(d,0);
      function f(param)
       {var _cj_=id[1];
        ...
        var x=_cj_[1];
        id[1] = 0;
        return t143.clearTimeout(x)}
      var p$1=underlying(t),_cg_=p$1[1];
      switch(_cg_[0])
       {case 1:
         if(_cg_[1] === Canceled)
          {var
      ...
      function create_result_promise_and_call(param)
       {var p$0=new_pending([0,p]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$2=underlying(p$0);resolve(_b9_,0,p$2,p_result);return 0}
          var v=p_result[1];
          current_storage[1] = saved_storage;
          try
           {var _ci_=f$0(v),p=_ci_}
       ...
       {case 1:return [0,_ce_];
        case 2:
         var
          ...
          node$0=[1,callback],
          _cd_=p_callbacks[1],
          node=typeof _cd_ === "number"?node$0:[0,node$0,_cd_];
         p_callbacks[1] = node;
         return p$0;
        default:
         var
         ...
         return run_callback_or_defer_it
                 (_b__,function(param){return f$0(v)},_cf_)}}
    function f$0(param)
     {var
