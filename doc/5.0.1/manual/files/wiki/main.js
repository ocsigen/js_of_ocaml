...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     _b0_=caml_string_of_jsbytes("iframe"),
     _bZ_=caml_string_of_jsbytes("img"),
     _bY_=caml_string_of_jsbytes("a"),
     _bX_=caml_string_of_jsbytes("br"),
     _bW_=caml_string_of_jsbytes("div"),
     _bV_=caml_string_of_jsbytes("textarea"),
     _b__=[0,0],
     _b$_=[0,1],
     _b8_=[0,0],
     _b9_=[0,1],
     ...
     _cb_=caml_string_of_jsbytes("Exception during Lwt.async: "),
     _cf_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),207,32],
     _cg_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),216,6],
     _ch_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),231,6],
     _cj_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),285,6],
     _ck_=caml_string_of_jsbytes("*"),
     _ci_=[5,0],
     _ce_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),158,6],
     _cc_=caml_string_of_jsbytes("//"),
     _cd_=caml_string_of_jsbytes("**"),
     _cD_=caml_string_of_jsbytes("http://youtube.com/embed/"),
     _ct_=caml_string_of_jsbytes("ul"),
     _cr_=caml_string_of_jsbytes("ol"),
     _cn_=caml_string_of_jsbytes("th"),
     _co_=caml_string_of_jsbytes("td"),
     _cK_=[0,caml_string_of_jsbytes("examples/wiki/main.ml"),33,70],
    ...
    function engine(tbl,state,buf)
     {var
       ...
       _gt_=0 <= result?1:0,
       _gu_=_gt_?buf[12] !== dummy_pos?1:0:_gt_;
      if(_gu_)
       {buf[11] = buf[12];
        var _gv_=buf[12];
        buf[12] = [0,_gv_[1],_gv_[2],_gv_[3],buf[4] + buf[6] | 0]}
      return result}
    ...
    function add(x,q)
     {var cell=[0,x,0],_gs_=q[3];
      return _gs_
              ?(q[1] = q[1] + 1 | 0,_gs_[2] = cell,q[3] = cell,0)
       ...
       {var split=split_from_parent[1],ki=[0,k,split];
        for(;;)
         {var l=caml_atomic_load(parent_keys);
          ...
          break}}
      return k}
    var param=new_key(0,function(param,_gr_){return 0});
     ...
     {if(typeof param !== "number")
       switch(param[0])
        {case 0:
          ...
          return [0,function(param){caml_call1(fa,0);return 0},_f6_,ed,de];
         case 1:
          var
           rest$0=param[1],
    ...
    function trans(ty1,ty2)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_fK_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 0:var rest2=ty2[1];return [0,trans(_fK_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_fL_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 1:var rest2$0=ty2[1];return [1,trans(_fL_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_fM_=ty1[1];
          if(typeof ty2 === "number")
           switch$3 = 1;
          else
           switch(ty2[0])
            {case 2:var rest2$1=ty2[1];return [2,trans(_fM_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_fN_=ty1[1];
          if(typeof ty2 === "number")
           switch$4 = 1;
          else
           switch(ty2[0])
            {case 3:var rest2$2=ty2[1];return [3,trans(_fN_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_fO_=ty1[1];
          if(typeof ty2 === "number")
           switch$5 = 1;
          else
           switch(ty2[0])
            {case 4:var rest2$3=ty2[1];return [4,trans(_fO_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_fP_=ty1[1];
          if(typeof ty2 === "number")
           switch$6 = 1;
          else
           switch(ty2[0])
            {case 5:var rest2$4=ty2[1];return [5,trans(_fP_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_fQ_=ty1[1];
          if(typeof ty2 === "number")
           switch$7 = 1;
          else
           switch(ty2[0])
            {case 6:var rest2$5=ty2[1];return [6,trans(_fQ_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_fR_=ty1[1];
          if(typeof ty2 === "number")
           switch$8 = 1;
          else
           switch(ty2[0])
            {case 7:var rest2$6=ty2[1];return [7,trans(_fR_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_fS_=ty1[2],_fT_=ty1[1];
          if(typeof ty2 === "number")
           switch$9 = 1;
          else
           switch(ty2[0])
            {case 8:
              var rest2$7=ty2[2],ty2$0=ty2[1],_fU_=trans(_fS_,rest2$7);
              return [8,trans(_fT_,ty2$0),_fU_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_fV_=ty1[3],_fW_=ty1[2],_fX_=ty1[1];
          if(typeof ty2 === "number")
           switch$10 = 1;
          else
           switch(ty2[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=ty2[2],
               ty21=ty2[1],
               ty=trans(symm(_fW_),ty21),
               match=fmtty_rel_det(ty),
               f4=match[4],
               f2=match[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fX_,ty22,trans(_fV_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof ty2 !== "number" && 10 === ty2[0])
           {var rest2$9=ty2[1];return [10,trans(_fY_,rest2$9)]}
          throw [0,Assert_failure,_aa_];
         case 11:
          var switch$11=0,_fZ_=ty1[1];
          if(typeof ty2 === "number")
           switch$11 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:var rest2$10=ty2[1];return [11,trans(_fZ_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ab_];
          break;
         case 12:
          var switch$12=0,_f0_=ty1[1];
          if(typeof ty2 === "number")
           switch$12 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=ty2[1];return [12,trans(_f0_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ac_];
          break;
         case 13:
          var switch$13=0,_f1_=ty1[1];
          if(typeof ty2 === "number")
           switch$13 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=ty2[1];return [13,trans(_f1_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ad_];
          break;
         default:
          var switch$14=0,_f2_=ty1[1];
          if(typeof ty2 === "number")
           switch$14 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=ty2[1];return [14,trans(_f2_,rest2$13)];
             default:switch$14 = 1}
    ...
    function type_padprec(pad,prec,fmtty)
     {var match=type_padding(pad,fmtty);
      ...
      if(typeof _fJ_ !== "number" && 2 === _fJ_[0])
       {var rest=_fJ_[1],pad$0=match[1];return [0,pad$0,1,rest]}
      throw Type_mismatch}
       ...
       {case 0:
        ...
        case 3:
         var
          ...
          _fu_=match$3[2],
          _ft_=match$3[1];
         if(typeof _fu_ !== "number" && 1 === _fu_[0])
          {var
            fmtty_rest$2=_fu_[1],
            match$4=type_format_gen(fmt_rest$2,fmtty_rest$2),
            fmtty$3=match$4[2],
            fmt$3=match$4[1];
           return [0,[3,_ft_,fmt$3],fmtty$3]}
         throw Type_mismatch;
        case 4:
         var
          fmt_rest$3=fmt[4],
         ...
         if(typeof _fw_ !== "number" && 2 === _fw_[0])
          {var
            ...
            fmtty$4=match$6[2],
            fmt$4=match$6[1];
           return [0,[4,iconv,_fv_,prec$0,fmt$4],fmtty$4]}
         throw Type_mismatch;
        case 5:
         var
          fmt_rest$4=fmt[4],
         ...
         if(typeof _fy_ !== "number" && 3 === _fy_[0])
          {var
            ...
            fmtty$5=match$8[2],
            fmt$5=match$8[1];
           return [0,[5,iconv$0,_fx_,prec$2,fmt$5],fmtty$5]}
         throw Type_mismatch;
        case 6:
         var
          fmt_rest$5=fmt[4],
         ...
         if(typeof _fA_ !== "number" && 4 === _fA_[0])
          {var
            ...
            fmtty$6=match$10[2],
            fmt$6=match$10[1];
           return [0,[6,iconv$1,_fz_,prec$4,fmt$6],fmtty$6]}
         throw Type_mismatch;
        case 7:
         var
          fmt_rest$6=fmt[4],
         ...
         if(typeof _fC_ !== "number" && 5 === _fC_[0])
          {var
            ...
            fmtty$7=match$12[2],
            fmt$7=match$12[1];
           return [0,[7,iconv$2,_fB_,prec$6,fmt$7],fmtty$7]}
         throw Type_mismatch;
        case 8:
         var
          fmt_rest$7=fmt[4],
          ...
          _fE_=match$13[3],
          _fD_=match$13[1];
         if(typeof _fE_ !== "number" && 6 === _fE_[0])
          {var
            fmtty_rest$7=_fE_[1],
            prec$8=match$13[2],
            ...
            fmtty$8=match$14[2],
            fmt$8=match$14[1];
           return [0,[8,fconv,_fD_,prec$8,fmt$8],fmtty$8]}
         throw Type_mismatch;
        case 9:
         var
          fmt_rest$8=fmt[2],
          ...
          _fG_=match$15[2],
          _fF_=match$15[1];
         if(typeof _fG_ !== "number" && 7 === _fG_[0])
          {var
            fmtty_rest$8=_fG_[1],
            match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
            fmtty$9=match$16[2],
            fmt$9=match$16[1];
           return [0,[9,_fF_,fmt$9],fmtty$9]}
         throw Type_mismatch;
        case 10:
         var
          fmt_rest$9=fmt[1],
           ...
           {case 0:return type_ignored_param_one(ign,rest,fmtty);
            ...
            case 9:
             var
              sub_fmtty$3=ign[2],
              pad_opt$2=ign[1],
              _fI_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
              match$35=_fI_[2],
              fmtty$22=match$35[2],
              fmt$22=match$35[1],
              sub_fmtty$4=_fI_[1];
        ...
        case 9:
         if(typeof fmtty !== "number" && 9 === fmtty[0])
          {var
            ...
            _fp_=[0,erase_rel(sub1_fmtty)];
           if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_fp_))
            throw Type_mismatch;
           var _fq_=[0,erase_rel(sub2_fmtty$1)];
           if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_fq_))
            throw Type_mismatch;
           var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _fo_=2 === padty$0?48:32,res=make(width$0,_fo_);
      switch(padty$0)
       ...
       {var i$0=_ff_;
        for(;;)
         {var match=caml_bytes_unsafe_get(s$0,i$0),switch$0=0;
          if(32 <= match)
           {var _fk_=match - 34 | 0,switch$1=0;
            if(58 < _fk_ >>> 0)
             {if(93 <= _fk_)switch$1 = 1}
            else
             if(56 < _fk_ - 1 >>> 0){switch$0 = 1;switch$1 = 1}
            if(! switch$1){var _fl_=1;switch$0 = 2}}
          else
           if(11 <= match)
            {if(13 === match)switch$0 = 1}
           else
            if(8 <= match)switch$0 = 1;
          switch(switch$0){case 0:var _fl_=4;break;case 1:var _fl_=2;break}
          n[1] = n[1] + _fl_ | 0;
          var _fm_=i$0 + 1 | 0;
    ...
    function transform_int_alt(iconv,s)
     {if(13 > iconv)return s;
      var n=[0,0],_fa_=caml_ml_string_length(s) - 1 | 0,_e$_=0;
      if(_fa_ >= 0)
       {var i$0=_e$_;
        for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _e__=_ah_;break;
        case 2:var _e__=_ai_;break;
        case 4:var _e__=_ak_;break;
        case 5:var _e__=_al_;break;
        case 6:var _e__=_am_;break;
        case 7:var _e__=_an_;break;
        case 8:var _e__=_ao_;break;
        case 9:var _e__=_ap_;break;
        case 10:var _e__=_aq_;break;
        case 11:var _e__=_ar_;break;
        case 0:
        case 13:var _e__=_ag_;break;
        case 3:
        case 14:var _e__=_aj_;break;
        default:var _e__=_as_}
      return transform_int_alt(iconv,caml_format_int(_e__,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _e9_=_aH_;break;
        case 2:var _e9_=_aI_;break;
        case 4:var _e9_=_aK_;break;
        case 5:var _e9_=_aL_;break;
        case 6:var _e9_=_aM_;break;
        case 7:var _e9_=_aN_;break;
        case 8:var _e9_=_aO_;break;
        case 9:var _e9_=_aP_;break;
        case 10:var _e9_=_aQ_;break;
        case 11:var _e9_=_aR_;break;
        case 0:
        case 13:var _e9_=_aG_;break;
        case 3:
        case 14:var _e9_=_aJ_;break;
        default:var _e9_=_aS_}
      return transform_int_alt(iconv,caml_format_int(_e9_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _e8_=_aU_;break;
        case 2:var _e8_=_aV_;break;
        case 4:var _e8_=_aX_;break;
        case 5:var _e8_=_aY_;break;
        case 6:var _e8_=_aZ_;break;
        case 7:var _e8_=_a0_;break;
        case 8:var _e8_=_a1_;break;
        case 9:var _e8_=_a2_;break;
        case 10:var _e8_=_a3_;break;
        case 11:var _e8_=_a4_;break;
        case 0:
        case 13:var _e8_=_aT_;break;
        case 3:
        case 14:var _e8_=_aW_;break;
        default:var _e8_=_a5_}
      return transform_int_alt(iconv,caml_format_int(_e8_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _e7_=_au_;break;
        case 2:var _e7_=_av_;break;
        case 4:var _e7_=_ax_;break;
        case 5:var _e7_=_ay_;break;
        case 6:var _e7_=_az_;break;
        case 7:var _e7_=_aA_;break;
        case 8:var _e7_=_aB_;break;
        case 9:var _e7_=_aC_;break;
        case 10:var _e7_=_aD_;break;
        case 11:var _e7_=_aE_;break;
        case 0:
        case 13:var _e7_=_at_;break;
        case 3:
        case 14:var _e7_=_aw_;break;
        default:var _e7_=_aF_}
      return transform_int_alt(iconv,caml_int64_format(_e7_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _e4_ >>> 0)
              {if(55 === _e4_)switch$0 = 1}
             else
              if(21 < _e4_ - 1 >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _e5_=1}
           var _e6_=_e5_?str:cat(str,_a6_);
           return caml_special_val(_e6_)}
        case 6:return hex(0);
        case 7:
            ...
            {var i=_eZ_;
             for(;;)
              {var
                ...
                _e1_=25 < c - 97 >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_e1_);
               var _e2_=i + 1 | 0;
    ...
    function make_int_padding_precision(k,acc,fmt,pad,prec,trans,iconv)
     {if(typeof pad === "number")
      ...
      return function(w,x)
       {var
         str=
          fix_padding(_eY_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
        return make_printf(k,[4,acc,str],fmt)}}
          ...
          case 14:
           ...
           return function(param)
            {var
             ...
             if(typeof _eV_[2] !== "number")throw Type_mismatch;
             var fmt=_eV_[1];
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_eI_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_eI_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bm_;
      var _eG_=other_fields(x,i + 1 | 0),_eH_=field(x,i);
      return caml_call2(sprintf(_bn_),_eH_,_eG_)}
     ...
     {function conv(param)
       {var param$0=param;
        for(;;)
         {if(! param$0)return 0;
          ...
          try {var switch$0=0,val=caml_call1(hd,e);switch$0 = 1}catch(_eF_){}
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _eB_=other_fields(e,2),
          _eC_=field(e,1),
          _eE_=caml_call2(sprintf(_bo_),_eC_,_eB_);
        else
         switch(match)
          {case 0:var _eE_=_bp_;break;
           case 1:var _eE_=_bq_;break;
           default:var _eD_=field(e,1),_eE_=caml_call1(sprintf(_br_),_eD_)}
        var match$1=[0,constructor,[0,_eE_]]}
      else
       var match$1=[0,e[1],0];
         ...
         {var
          ...
          if(0 === slot[0])
           var
            ...
            _er_=slot[4],
            _es_=slot[3],
            _et_=slot[6]?_bB_:_bD_,
            _eu_=slot[2],
            _ev_=slot[7],
            _ew_=info(slot[1]),
            match=
             [0,caml_call7(sprintf(_bC_),_ew_,_ev_,_eu_,_et_,_es_,_er_,_eq_)];
          else
           if(slot[1])
            var match=0;
           else
            var _ex_=info(0),match=[0,caml_call1(sprintf(_bE_),_ex_)];
    ...
    function default_uncaught_exception_han(exn,raw_backtrace)
     {var _en_=to_string(exn);
      caml_call1(eprintf(_bH_),_en_);
     ...
     {try
       {try
         {var
          ...
          try {do_at_exit(0)}catch(_em_){}
          try
           {var
             _ei_=default_uncaught_exception_han(exn,raw_backtrace),
             _eh_=_ei_}
          catch(exn$0)
           {exn$0 = caml_wrap_exception(exn$0);
            var
             ...
             _ef_=to_string(exn);
            caml_call1(eprintf(_bJ_),_ef_);
            print_raw_backtrace(stderr,raw_backtrace);
            var _eg_=to_string(exn$0);
            caml_call1(eprintf(_bK_),_eg_);
            print_raw_backtrace(stderr,raw_backtrace$0);
            var _eh_=caml_ml_flush(stderr)}
          var _ej_=_eh_}
        catch(_el_)
         {_el_ = caml_wrap_exception(_el_);
          if(_el_ !== Out_of_memory)throw _el_;
          var _ej_=prerr_endline(_bI_)}
        return _ej_}
      catch(_ek_){return 0}}
    caml_register_named_value
     ...
     {var _d__=p[1];
      switch(_d__[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_d__[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _d9_=caml_call1(f,v);return _d9_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _d7_=result[1] === Canceled?1:0,is_canceled=_d7_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_d5_,0)}
      var _d6_=callbacks[1];
      ...
      return iter_callback_list$0(_d6_,0)}
    var
       ...
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _d3_=deferred_callbacks[2];
           ...
           var result=_d4_[2],callbacks=_d4_[1];
    ...
    function wakeup(r,v)
     {var p=underlying(r),_d2_=p[1];
      switch(_d2_[0])
       {case 1:
         return _d2_[1] === Canceled
                 ?0
                 :caml_call1(ksprintf(invalid_arg,_b4_),api_function_name);
        case 2:var result=[0,v];resolve(_b5_,0,p,result);return 0;
        default:
    ...
    function make_into_proxy(outer_promise,user_provided_promise)
     {var p=underlying(user_provided_promise);
      ...
      var _d1_=p[1];
      switch(_d1_[0])
       {case 1:return resolve(_b7_,0,outer_promise,p[1]);
        case 2:
         var
          p_callbacks=_d1_[1],
         ...
         var
          _dZ_=p_callbacks[2],
          _d0_=outer_callbacks[2],
          cancel_callbacks=
           typeof _d0_ === "number"
            ?_dZ_
            :typeof _dZ_ === "number"?_d0_:[0,_d0_,_dZ_];
        ...
        default:return resolve(_b6_,0,outer_promise,p[1])}}
      ...
      function create_result_promise_and_call(param)
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$2=underlying(p);resolve(_b8_,0,p$2,p_result);return 0}
          var v=p_result[1];
       ...
       {case 1:return [0,_dW_];
        case 2:
         var
          ...
          node$0=[1,callback],
          _dV_=p_callbacks[1],
          node=typeof _dV_ === "number"?node$0:[0,node$0,_dV_];
         p_callbacks[1] = node;
         return p$1;
        default:
         var
         ...
         return run_callback_or_defer_it
                 (_b9_,function(param){return caml_call1(f,v)},_dX_)}}
    var pause_hook=[0,function(_dU_){return 0}],s1=create(0),_ca_=[0,0];
    ...
    function sleep(d)
     {var t=new_pending(1),d$0=d * 1000.;
      function callback(_dS_){return wakeup(t,_dS_)}
      var id=[0,0];
      function loop(d,param)
       {if(2147483000. < d)
         ...
         var remain=0.,step=d;
        var
         cb=remain == 0.?callback:function(_dR_){return loop(remain,_dR_)},
         t125=caml_js_wrap_callback(cb);
        id[1] = [0,t17.setTimeout(t125,step)];
        return 0}
      loop(d$0,0);
      function f(param)
       {var _dQ_=id[1];
        ...
        var x=_dQ_[1];
        id[1] = 0;
        return t17.clearTimeout(x)}
      var p=underlying(t),_dO_=p[1];
      switch(_dO_[0])
       {case 1:
         if(_dO_[1] === Canceled)
          {var
    ...
    function count(c,s)
     {var n=[0,0],_dM_=caml_ml_string_length(s) - 1 | 0,_dL_=0;
      if(_dM_ >= 0)
       {var i=_dL_;
        for(;;)
    ...
    function push(c,v)
     {var _dJ_=c[12];
      ...
      var _dK_=c[7];
      c[7] = [0,caml_call1(c[1][21],v),_dK_];
      return 0}
    ...
    function style_change(c,style)
     {var _dH_=style?c[2]:c[3];
      if(! _dH_)
       {c[12] = [0,style,c[7],c[12]];c[7] = 0;return set_style(c,style,1)}
      var _dI_=c[12];
      if(typeof _dI_ !== "number" && 0 === _dI_[0])
       {var stack=_dI_[3],inline=_dI_[2],s=_dI_[1];
        if(s === style)return pop_style(c,style,inline,stack)}
      return style?push_string(c,_cc_):push_string(c,_cd_)}
    function pop_link(c,addr,stack)
     {c[12] = stack;
      var _dF_=c[7],_dG_=rev(c[8]);
      c[7] = [0,caml_call2(c[1][7],addr,_dG_),_dF_];
      c[8] = 0;
      c[5] = 0;
      return 0}
     ...
     {var _dC_=c[12];
      if(typeof _dC_ !== "number")
       switch(_dC_[0])
        {case 5:
          var _dD_=c[12];
          c[12] = [6,[0,[0,0,rev(c[7])],0],_dD_];
          c[7] = 0;
          return 1;
         case 6:return 1;
         case 7:
          var _dE_=_dC_[2];
          if(typeof _dE_ !== "number" && 6 === _dE_[0])
           {var stack=_dE_[2],entries=_dE_[1],heading=_dC_[1];
      ...
      if(typeof _dA_ !== "number")
       switch(_dA_[0])
        {case 5:return 1;
         case 6:
          var _dB_=_dA_[2];
          if(typeof _dB_ !== "number" && 5 === _dB_[0])
           {var rows=_dB_[1],entries=_dA_[1];
     ...
     {for(;;)
       {var _dq_=c[12];
        if(typeof _dq_ === "number")
         {if(0 !== c[7])
           {var _dr_=c[11],_ds_=rev(c[7]);
            c[11] = [0,caml_call1(c[1][9],_ds_),_dr_];
            c[7] = 0}
          c[12] = 0;
          return 0}
        switch(_dq_[0])
         {case 0:
           var stack=_dq_[3],inline=_dq_[2],style=_dq_[1];
           pop_style(c,style,inline,stack);
           continue;
          case 1:
           var stack$0=_dq_[2],addr=_dq_[1];pop_link(c,addr,stack$0);continue;
          case 2:
           var l=_dq_[1],switcher=l - 1 | 0;
           if(4 < switcher >>> 0)
            var f=c[1][16];
           else
            switch(switcher)
           ...
           var _dt_=c[11];
           c[11] = [0,caml_call1(f,rev(c[7])),_dt_];
           c[7] = 0;
           c[4] = 0;
           c[12] = 0;
           return 0;
          case 3:
           var stack$1=_dq_[1],_du_=c[10];
           c[10] = [0,[0,rev(c[7]),0],_du_];
           c[12] = stack$1;
           c[7] = 0;
           continue;
          case 4:
           var stack$2=_dq_[3],lst=_dq_[2],kind=_dq_[1],_dv_=lev < c[6]?1:0;
           if(! _dv_)return _dv_;
           c[6] = c[6] - 1 | 0;
           var elt=kind?c[1][18]:c[1][17],cur_lst=caml_call1(elt,rev(c[10]));
           if(0 === c[6])
            c[11] = [0,cur_lst,c[11]];
           else
            {var switch$0=0;
             if(lst)
              {var _dw_=lst[1];
               if(! _dw_[2])
                {var rem=lst[2],l$0=_dw_[1];
                 c[10] = [0,[0,l$0,[0,cur_lst]],rem];
                 switch$0 = 1}}
             if(! switch$0)throw [0,Assert_failure,_cf_]}
           c[12] = stack$2;
           continue;
          case 5:
           var rows=_dq_[1],_dx_=c[11],_dy_=rev(rows);
           c[11] = [0,caml_call1(c[1][20],_dy_),_dx_];
           c[12] = 0;
           return 0;
          case 6:throw [0,Assert_failure,_cg_];
          default:close_row(c);continue}}}
    function start_list_item(c,kind,lev)
     {var _dn_=lev === (c[6] + 1 | 0)?1:0,switch$0=0;
      if(_dn_)
       var _do_=_dn_;
      else
       {var _dp_=lev <= c[6]?1:0;
        if(_dp_)
         {var n$1=c[6] - lev | 0,stack=c[12],n=n$1;
          for(;;)
           {var switch$1=0;
            ...
            if(! switch$1)throw [0,Assert_failure,_ch_];
            break}}
        else
         var _do_=_dp_}
      if(! switch$0)var correct=_do_;
    ...
    function start_table_row(c,heading)
     {if(1 - close_row(c)){end_paragraph(c,0);c[12] = _ci_}
         ...
         {var
          ...
          switch(ocaml_lex_state$0)
           {case 0:end_paragraph(c,0);continue a;
            case 1:
             end_paragraph(c,0);
             if(0 !== c[12])throw [0,Assert_failure,_cj_];
            ...
            case 4:
             end_paragraph(c,0);
             var _di_=c[11];
             c[11] = [0,caml_call1(c[1][19],0),_di_];
             continue a;
            case 5:
             end_paragraph(c,0);
             b:
               ...
               for(;;)
                {var
                 ...
                 switch(ocaml_lex_state$2)
                  {case 0:
                    var s$0=lexeme(lexbuf),_dj_=c[9];
                    c[9]
                    =
                    [0,sub$0(s$0,1,caml_ml_string_length(s$0) - 1 | 0),_dj_];
                    continue b;
                   case 1:
                    var _dk_=c[11],_dl_=rev(c[9]);
                    c[11] = [0,caml_call1(c[1][10],_dl_),_dk_];
                    c[9] = 0;
                    if(counter >= 50)
                   ...
                   default:
                    var _dm_=c[9];c[9] = [0,lexeme(lexbuf),_dm_];continue b}}}
            case 6:
             start_table_row(c,0);
             if(counter >= 50)
              return caml_trampoline_return(parse_rem,[0,c,lexbuf]);
    ...
    function parse_rem(counter,c,lexbuf)
     {var _de_=25;
      if(counter >= 50)
       return caml_trampoline_return
               (ocaml_lex_parse_rem_rec,[0,c,lexbuf,_de_]);
      var counter$0=counter + 1 | 0;
      return ocaml_lex_parse_rem_rec(counter$0,c,lexbuf,_de_)}
         ...
         {case 0:
          ...
          case 4:
           ...
           var
            ...
            _c7_=c[7],
            _c8_=[0,caml_call1(c[1][1],addr),0];
           c[7] = [0,caml_call2(c[1][7],addr,_c8_),_c7_];
           if(counter >= 50)
            return caml_trampoline_return(parse_rem,[0,c,lexbuf]);
           var counter$2=counter + 1 | 0;
           return parse_rem(counter$2,c,lexbuf);
          case 5:
           ...
           var
            ...
            _c9_=c[7],
            _c__=[0,caml_call1(c[1][1],addr$0),0];
           c[7] = [0,caml_call2(c[1][8],addr$0,_c__),_c9_];
           if(counter >= 50)
            return caml_trampoline_return(parse_rem,[0,c,lexbuf]);
           var counter$3=counter + 1 | 0;
           return parse_rem(counter$3,c,lexbuf);
          case 6:
           ...
           return parse_rem(counter$4,c,lexbuf);
          case 7:
           var _c$_=c[12],switch$0=0;
           if(typeof _c$_ !== "number" && 1 === _c$_[0])
            {var stack=_c$_[2],addr$2=_c$_[1];
          ...
          case 8:
           ...
           var
            ...
            _da_=c[7],
            _db_=[0,caml_call1(c[1][1],addr$3),0];
           c[7] = [0,caml_call2(c[1][7],addr$3,_db_),_da_];
           if(counter >= 50)
            return caml_trampoline_return(parse_rem,[0,c,lexbuf]);
           var counter$6=counter + 1 | 0;
          ...
          case 11:
           var
            ...
            _dc_=caml_call1(c[1][1],txt),
            _dd_=[0,caml_call1(c[1][21],_dc_),0];
           push(c,caml_call1(c[1][6],_dd_));
           if(counter >= 50)
            return caml_trampoline_return(parse_rem,[0,c,lexbuf]);
           var counter$9=counter + 1 | 0;
        ...
        map
         (function(param)
           {var l=param[2],c=param[1];
            if(l)var v=l[1],_c5_=[0,v,0];else var _c5_=0;
            var _c6_=append(c,_c5_);
            return symbol(d.createElement("li"),_c6_)},
          c),
       t0=caml_jsstring_of_string(tag);
      return symbol(d.createElement(t0),_c4_)}
    function _cl_(x){return x}
    function _cm_(rows)
     {var
       rows$0=
        map
             ...
             _c3_=
              map
               (function(param)
                ...
                entries);
            return symbol(t2.createElement("tr"),_c3_)},
          rows),
       _c2_=[0,symbol(t2.createElement("tbody"),rows$0),0];
      return symbol(t2.createElement("table"),_c2_)}
    function _cp_(param){return t2.createElement("hr")}
    function _cq_(s){return list_builder(t2,_cr_,s)}
    function _cs_(s){return list_builder(t2,_ct_,s)}
    function _cu_(s){return symbol(t2.createElement("h6"),s)}
    function _cv_(s){return symbol(t2.createElement("h5"),s)}
    function _cw_(s){return symbol(t2.createElement("h4"),s)}
    function _cx_(s){return symbol(t2.createElement("h3"),s)}
    function _cy_(s){return symbol(t2.createElement("h2"),s)}
    function _cz_(s){return symbol(t2.createElement("h1"),s)}
    function _cA_(s)
         ...
         {if(param)
           {var _cY_=param[1];
            if(param[2])
             {var
               tl=param[2],
               x=(caml_ml_string_length(_cY_) | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_n_),
               acc=acc$0,
               param=tl;
              continue}
            var _c0_=caml_ml_string_length(_cY_) + acc | 0}
          else
           var _c0_=acc;
          var dst=caml_create_bytes(_c0_),pos=pos$1,param$0=s;
          for(;;)
           {if(param$0)
             {var _cZ_=param$0[1];
              if(param$0[2])
               {var tl$0=param$0[2];
                caml_blit_string(_cZ_,0,dst,pos,caml_ml_string_length(_cZ_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_cZ_) | 0,0);
                var
                 pos$0=pos + caml_ml_string_length(_cZ_) | 0 | 0,
                 pos=pos$0,
                 param$0=tl$0;
                continue}
              caml_blit_string(_cZ_,0,dst,pos,caml_ml_string_length(_cZ_))}
            var _c1_=caml_string_of_bytes(dst);
            break}
          break}}
      else
       var _c1_=_o_;
      var t32=caml_jsstring_of_string(_c1_);
      appendChild(p,t2.createTextNode(t32));
      return p}
    function _cB_(s){return symbol(t2.createElement("p"),s)}
    function _cC_(addr,s)
     {var t19=unsafeCreateElement(t2,_b0_);
      t19.width = "480";
      t19.height = "360";
      var
       s$0=caml_jsstring_of_string(addr),
       video_link=cat(_cD_,caml_string_of_jsstring(t17.encodeURI(s$0))),
       t16=caml_jsstring_of_string(video_link);
      t19.src = t16;
      t19.frameBorder = "0";
      return t19}
    function _cE_(addr,s)
     {var t11=unsafeCreateElement(t2,_bY_),t10=caml_jsstring_of_string(addr);
      t11.href = t10;
      return symbol(t11,s)}
    function _cF_(s){return symbol(t2.createElement("tt"),s)}
    function _cG_(addr,alt)
     {var t25=unsafeCreateElement(t2,_bZ_),t22=caml_jsstring_of_string(addr);
      t25.src = t22;
      var t24=caml_jsstring_of_string(alt);
      t25.alt = t24;
      return t25}
    function _cH_(param){return t2.createElement("br")}
    function _cI_(s){return symbol(t2.createElement("em"),s)}
    function _cJ_(s){return symbol(t2.createElement("strong"),s)}
    var
     b=
      [0,
       function(s)
    ...
    function xml_of_wiki(s$0)
     {var
      ...
      var
       ...
       _cU_=0,
       _cV_=0,
       _cW_=caml_ml_string_length(s$0),
       lexbuf=
        [0,
      ...
      parse_bol(c,lexbuf);
      var _cX_=rev(c[11]);
      return symbol(createDiv(t2),_cX_)}
    ...
    function f$0(param)
     {var body=t2.getElementById("wiki_demo");
      if(body == no_handler)throw [0,Assert_failure,_cK_];
      var t8=unsafeCreateElementEx(0,0,t2,_bV_);
      t8.rows = 20;
      t8.cols = 80;
      t8.value
      =
      ...
      t14.padding = "5px";
      appendChild(body,t8);
      appendChild(body,unsafeCreateElement(t2,_bX_));
      ...
      function dyn_preview(old_text,n)
       {var text=caml_string_of_jsstring(t8.value);
        if(caml_string_notequal(text,old_text))
         ...
         var n$0=max(0,n - 1 | 0);
        function _cM_(param){return dyn_preview(text,n$0)}
        var _cN_=0 === n$0?0.5:0.1;
        return symbol_bind(sleep(_cN_),_cM_)}
      dyn_preview(_cL_,0);
      return false$0}
    var
     t16=
