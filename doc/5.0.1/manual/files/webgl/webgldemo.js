...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     _r_=caml_string_of_jsbytes("Buffer.add: cannot grow buffer"),
     ...
     _bX_=caml_string_of_jsbytes("script"),
     _bW_=caml_string_of_jsbytes("canvas"),
     _bY_=[0,caml_string_of_jsbytes("lib/js_of_ocaml/regexp.ml"),34,64],
     _bZ_=caml_string_of_jsbytes("[\\][()\\\\|+*.?{}^$]"),
     _b1_=caml_string_of_jsbytes(""),
     _b3_=caml_string_of_jsbytes(""),
     _b0_=caml_string_of_jsbytes("Js_of_ocaml__Url.Local_exn"),
     _b4_=
      caml_string_of_jsbytes
     ...
     _ce_=[0,0],
     _cf_=[0,0],
     _cd_=caml_string_of_jsbytes("wakeup_exn"),
     _cc_=caml_string_of_jsbytes("wakeup"),
     _b$_=
      [0,
     ...
     _ca_=
      [0,
       ...
       caml_string_of_jsbytes("Lwt.%s")],
     _cb_=[0,0],
     _b9_=caml_string_of_jsbytes("Fatal error: exception "),
     _b__=caml_string_of_jsbytes("Lwt.Resolution_loop.Canceled"),
     _cr_=caml_string_of_jsbytes(""),
     _cq_=
      caml_string_of_jsbytes
       ("Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers"),
     _cs_=caml_string_of_jsbytes("Exception during Lwt.async: "),
     _cQ_=
      [0,
     ...
     _cO_=[0,[8,[0,0,0],0,[0,1],0],caml_string_of_jsbytes("%.1f")],
     _cG_=
      [0,
       [11,caml_string_of_jsbytes("init canvas"),0],
       caml_string_of_jsbytes("init canvas")],
     _cH_=caml_string_of_jsbytes("canvas"),
     _cI_=
      [0,
       [11,caml_string_of_jsbytes("create program"),0],
       caml_string_of_jsbytes("create program")],
     _cJ_=caml_string_of_jsbytes("fragment-shader"),
     _cK_=caml_string_of_jsbytes("vertex-shader"),
     _cL_=
      [0,
     ...
     _cB_=[0,1,[0,2,[0,3,[0,4,0]]]],
     _cC_=caml_string_of_jsbytes("f"),
     _cD_=caml_string_of_jsbytes("v"),
     _cE_=caml_string_of_jsbytes("vn"),
     _cA_=[0,1,[0,2,0]],
     _cx_=
      [0,
     ...
     _cz_=caml_string_of_jsbytes("([0-9]+)//([0-9]+)");
    ...
    function init(l,f)
     {if(0 === l)return [0];
      ...
      var res=caml_make_vect(l,caml_call1(f,0)),_hh_=l - 1 | 0,_hg_=1;
      if(_hh_ >= 1)
       {var i=_hg_;
        for(;;)
    ...
    function add(x,q)
     {var cell=[0,x,0],_hf_=q[3];
      return _hf_
              ?(q[1] = q[1] + 1 | 0,_hf_[2] = cell,q[3] = cell,0)
    ...
    function take(q)
     {var _hd_=q[2];
      ...
      var _he_=_hd_[1];
      if(_hd_[2])
       {var next=_hd_[2];q[1] = q[1] - 1 | 0;q[2] = next;return _he_}
      q[1] = 0;
      q[2] = 0;
      q[3] = 0;
      return _he_}
       ...
       {var split=split_from_parent[1],ki=[0,k,split];
        for(;;)
         {var l=caml_atomic_load(parent_keys);
          ...
          break}}
      return k}
    var param=new_key(0,function(param,_hc_){return 0});
    ...
    function fmtty_rel_det(param)
     {if(typeof param !== "number")
        ...
        {case 0:
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _g0_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _g1_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _g2_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _g3_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _g4_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _g5_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _g6_=function(param){caml_call1(de$12,0);return 0},
           _g7_=function(param){caml_call1(ed$12,0);return 0},
           _g8_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _g9_=function(param){caml_call1(de$13,0);return 0},
           _g__=function(param){caml_call1(ed$13,0);return 0},
           _g$_=function(param){caml_call1(af$13,0);return 0};
          return [0,
      ...
      function _gP_(param){return 0}
      function _gQ_(param){return 0}
    ...
    function trans(ty1,ty2)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_gv_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 0:var rest2=ty2[1];return [0,trans(_gv_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_gw_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 1:var rest2$0=ty2[1];return [1,trans(_gw_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_gx_=ty1[1];
          if(typeof ty2 === "number")
           switch$3 = 1;
          else
           switch(ty2[0])
            {case 2:var rest2$1=ty2[1];return [2,trans(_gx_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_gy_=ty1[1];
          if(typeof ty2 === "number")
           switch$4 = 1;
          else
           switch(ty2[0])
            {case 3:var rest2$2=ty2[1];return [3,trans(_gy_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_gz_=ty1[1];
          if(typeof ty2 === "number")
           switch$5 = 1;
          else
           switch(ty2[0])
            {case 4:var rest2$3=ty2[1];return [4,trans(_gz_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_gA_=ty1[1];
          if(typeof ty2 === "number")
           switch$6 = 1;
          else
           switch(ty2[0])
            {case 5:var rest2$4=ty2[1];return [5,trans(_gA_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_gB_=ty1[1];
          if(typeof ty2 === "number")
           switch$7 = 1;
          else
           switch(ty2[0])
            {case 6:var rest2$5=ty2[1];return [6,trans(_gB_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_gC_=ty1[1];
          if(typeof ty2 === "number")
           switch$8 = 1;
          else
           switch(ty2[0])
            {case 7:var rest2$6=ty2[1];return [7,trans(_gC_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_gD_=ty1[2],_gE_=ty1[1];
          if(typeof ty2 === "number")
           switch$9 = 1;
          else
           switch(ty2[0])
            {case 8:
              var rest2$7=ty2[2],ty2$0=ty2[1],_gF_=trans(_gD_,rest2$7);
              return [8,trans(_gE_,ty2$0),_gF_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_gG_=ty1[3],_gH_=ty1[2],_gI_=ty1[1];
          if(typeof ty2 === "number")
           switch$10 = 1;
          else
           switch(ty2[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=ty2[2],
               ty21=ty2[1],
               ty=trans(symm(_gH_),ty21),
               match=fmtty_rel_det(ty),
               f4=match[4],
               f2=match[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_gI_,ty22,trans(_gG_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof ty2 !== "number" && 10 === ty2[0])
           {var rest2$9=ty2[1];return [10,trans(_gJ_,rest2$9)]}
          throw [0,Assert_failure,_ab_];
         case 11:
          var switch$11=0,_gK_=ty1[1];
          if(typeof ty2 === "number")
           switch$11 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:var rest2$10=ty2[1];return [11,trans(_gK_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ac_];
          break;
         case 12:
          var switch$12=0,_gL_=ty1[1];
          if(typeof ty2 === "number")
           switch$12 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=ty2[1];return [12,trans(_gL_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ad_];
          break;
         case 13:
          var switch$13=0,_gM_=ty1[1];
          if(typeof ty2 === "number")
           switch$13 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=ty2[1];return [13,trans(_gM_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ae_];
          break;
         default:
          var switch$14=0,_gN_=ty1[1];
          if(typeof ty2 === "number")
           switch$14 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=ty2[1];return [14,trans(_gN_,rest2$13)];
             default:switch$14 = 1}
    ...
    function type_padprec(pad,prec,fmtty)
     {var match=type_padding(pad,fmtty);
      ...
      var _gu_=match[2];
      if(typeof _gu_ !== "number" && 2 === _gu_[0])
       {var rest=_gu_[1],pad$0=match[1];return [0,pad$0,1,rest]}
      throw Type_mismatch}
        ...
        case 4:
         ...
         if(typeof _gh_ !== "number" && 2 === _gh_[0])
          {var
            ...
            fmtty$4=match$6[2],
            fmt$4=match$6[1];
           return [0,[4,iconv,_gg_,prec$0,fmt$4],fmtty$4]}
         throw Type_mismatch;
        case 5:
         var
          fmt_rest$4=fmt[4],
         ...
         if(typeof _gj_ !== "number" && 3 === _gj_[0])
          {var
            ...
            fmtty$5=match$8[2],
            fmt$5=match$8[1];
           return [0,[5,iconv$0,_gi_,prec$2,fmt$5],fmtty$5]}
         throw Type_mismatch;
        case 6:
         var
          fmt_rest$5=fmt[4],
          ...
          _gl_=match$9[3],
          _gk_=match$9[1];
         if(typeof _gl_ !== "number" && 4 === _gl_[0])
          {var
            fmtty_rest$5=_gl_[1],
            prec$4=match$9[2],
            ...
            fmtty$6=match$10[2],
            fmt$6=match$10[1];
           return [0,[6,iconv$1,_gk_,prec$4,fmt$6],fmtty$6]}
         throw Type_mismatch;
        case 7:
         var
          fmt_rest$6=fmt[4],
          ...
          _gn_=match$11[3],
          _gm_=match$11[1];
         if(typeof _gn_ !== "number" && 5 === _gn_[0])
          {var
            fmtty_rest$6=_gn_[1],
            prec$6=match$11[2],
            ...
            fmtty$7=match$12[2],
            fmt$7=match$12[1];
           return [0,[7,iconv$2,_gm_,prec$6,fmt$7],fmtty$7]}
         throw Type_mismatch;
        case 8:
         var
          fmt_rest$7=fmt[4],
          ...
          _gp_=match$13[3],
          _go_=match$13[1];
         if(typeof _gp_ !== "number" && 6 === _gp_[0])
          {var
            fmtty_rest$7=_gp_[1],
            prec$8=match$13[2],
            ...
            fmtty$8=match$14[2],
            fmt$8=match$14[1];
           return [0,[8,fconv,_go_,prec$8,fmt$8],fmtty$8]}
         throw Type_mismatch;
        case 9:
         var
          fmt_rest$8=fmt[2],
          ...
          _gr_=match$15[2],
          _gq_=match$15[1];
         if(typeof _gr_ !== "number" && 7 === _gr_[0])
          {var
            fmtty_rest$8=_gr_[1],
            match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
            fmtty$9=match$16[2],
            fmt$9=match$16[1];
           return [0,[9,_gq_,fmt$9],fmtty$9]}
         throw Type_mismatch;
        case 10:
         var
          fmt_rest$9=fmt[1],
        ...
        case 14:
         if(typeof fmtty !== "number" && 9 === fmtty[0])
          {var
            ...
            sub_fmtty$1=fmt[2],
            pad_opt$0=fmt[1],
            _gs_=[0,erase_rel(sub_fmtty1)];
           if(caml_notequal([0,erase_rel(sub_fmtty$1)],_gs_))
            throw Type_mismatch;
           var
           ...
           {case 0:return type_ignored_param_one(ign,rest,fmtty);
            ...
            case 9:
             var
              sub_fmtty$3=ign[2],
              pad_opt$2=ign[1],
              _gt_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
              match$35=_gt_[2],
              fmtty$22=match$35[2],
              fmt$22=match$35[1],
              sub_fmtty$4=_gt_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _f$_=2 === padty$0?48:32,res=make(width$0,_f$_);
      switch(padty$0)
    ...
    function string_to_caml_string(str$0)
     {var
       ...
       n=[0,0],
       _f3_=caml_ml_bytes_length(s$0) - 1 | 0,
       _f2_=0;
      if(_f3_ >= 0)
       {var i$0=_f2_;
        for(;;)
         {var match=caml_bytes_unsafe_get(s$0,i$0),switch$0=0;
          if(32 <= match)
           {var _f7_=match - 34 | 0,switch$1=0;
            if(58 < _f7_ >>> 0)
             {if(93 <= _f7_)switch$1 = 1}
            else
             if(56 < _f7_ - 1 >>> 0){switch$0 = 1;switch$1 = 1}
            if(! switch$1){var _f8_=1;switch$0 = 2}}
          else
           if(11 <= match)
            {if(13 === match)switch$0 = 1}
           else
            if(8 <= match)switch$0 = 1;
          switch(switch$0){case 0:var _f8_=4;break;case 1:var _f8_=2;break}
          n[1] = n[1] + _f8_ | 0;
          var _f9_=i$0 + 1 | 0;
          if(_f3_ !== i$0){var i$0=_f9_;continue}
          break}}
      if(n[1] === caml_ml_bytes_length(s$0))
       ...
       {var s=caml_create_bytes(n[1]);
        n[1] = 0;
        var _f5_=caml_ml_bytes_length(s$0) - 1 | 0,_f4_=0;
        if(_f5_ >= 0)
         {var i=_f4_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _fV_=_ai_;break;
        case 2:var _fV_=_aj_;break;
        case 4:var _fV_=_al_;break;
        case 5:var _fV_=_am_;break;
        case 6:var _fV_=_an_;break;
        case 7:var _fV_=_ao_;break;
        case 8:var _fV_=_ap_;break;
        case 9:var _fV_=_aq_;break;
        case 10:var _fV_=_ar_;break;
        case 11:var _fV_=_as_;break;
        case 0:
        case 13:var _fV_=_ah_;break;
        case 3:
        case 14:var _fV_=_ak_;break;
        default:var _fV_=_at_}
      return transform_int_alt(iconv,caml_format_int(_fV_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _fU_=_aI_;break;
        case 2:var _fU_=_aJ_;break;
        case 4:var _fU_=_aL_;break;
        case 5:var _fU_=_aM_;break;
        case 6:var _fU_=_aN_;break;
        case 7:var _fU_=_aO_;break;
        case 8:var _fU_=_aP_;break;
        case 9:var _fU_=_aQ_;break;
        case 10:var _fU_=_aR_;break;
        case 11:var _fU_=_aS_;break;
        case 0:
        case 13:var _fU_=_aH_;break;
        case 3:
        case 14:var _fU_=_aK_;break;
        default:var _fU_=_aT_}
      return transform_int_alt(iconv,caml_format_int(_fU_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _fT_=_aV_;break;
        case 2:var _fT_=_aW_;break;
        case 4:var _fT_=_aY_;break;
        case 5:var _fT_=_aZ_;break;
        case 6:var _fT_=_a0_;break;
        case 7:var _fT_=_a1_;break;
        case 8:var _fT_=_a2_;break;
        case 9:var _fT_=_a3_;break;
        case 10:var _fT_=_a4_;break;
        case 11:var _fT_=_a5_;break;
        case 0:
        case 13:var _fT_=_aU_;break;
        case 3:
        case 14:var _fT_=_aX_;break;
        default:var _fT_=_a6_}
      return transform_int_alt(iconv,caml_format_int(_fT_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _fS_=_av_;break;
        case 2:var _fS_=_aw_;break;
        case 4:var _fS_=_ay_;break;
        case 5:var _fS_=_az_;break;
        case 6:var _fS_=_aA_;break;
        case 7:var _fS_=_aB_;break;
        case 8:var _fS_=_aC_;break;
        case 9:var _fS_=_aD_;break;
        case 10:var _fS_=_aE_;break;
        case 11:var _fS_=_aF_;break;
        case 0:
        case 13:var _fS_=_au_;break;
        case 3:
        case 14:var _fS_=_ax_;break;
        default:var _fS_=_aG_}
      return transform_int_alt(iconv,caml_int64_format(_fS_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _fP_ >>> 0)
              {if(55 === _fP_)switch$0 = 1}
             else
              if(21 < _fP_ - 1 >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _fQ_=1}
           var _fR_=_fQ_?str:cat(str,_a7_);
           return caml_special_val(_fR_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_fL_=l - 1 | 0,_fK_=0;
           if(_fL_ >= 0)
            {var i=_fK_;
             for(;;)
              {var
                c=caml_bytes_unsafe_get(s,i),
                _fM_=25 < c - 97 >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_fM_);
               var _fN_=i + 1 | 0;
               if(_fL_ !== i){var i=_fN_;continue}
               break}}
           var _fO_=r}
         return caml_string_of_bytes(_fO_);
         ...
         return prec
                 ?function(p,x)
                   {var
                     str=
                      fix_padding
                       (_fI_,_fH_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(x)
                   {var str=fix_padding(_fI_,_fH_,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$0=prec[1];
        return function(x)
         {var
           str=
            fix_padding
             (_fI_,_fH_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}
      var _fJ_=pad[1];
      if(typeof prec === "number")
       return prec
               ?function(w,p,x)
                 {var
                   str=
                    fix_padding
                     (_fJ_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                  return make_printf(k,[4,acc,str],fmt)}
               :function(w,x)
                 {var str=fix_padding(_fJ_,w,caml_call2(trans,iconv,x));
                  return make_printf(k,[4,acc,str],fmt)};
      var p$1=prec[1];
      return function(w,x)
       {var
         str=
          fix_padding(_fJ_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
        return make_printf(k,[4,acc,str],fmt)}}
        ...
        switch(fmt$0[0])
         {case 0:
            ...
            {if(typeof prec$3 === "number")
             ...
             return function(x)
              {var str=convert_float(fconv,p,x);
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
           if(0 === pad$5[0])
            {var _fD_=pad$5[2],_fE_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(p,x)
                        {var str=fix_padding(_fE_,_fD_,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_fE_,_fD_,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$0=prec$3[1];
             return function(x)
              {var str=fix_padding(_fE_,_fD_,convert_float(fconv,p$0,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
           var _fF_=pad$5[1];
           if(typeof prec$3 === "number")
            return prec$3
                    ?function(w,p,x)
                      {var str=fix_padding(_fF_,w,convert_float(fconv,p,x));
                       return make_printf(k$0,[4,acc$0,str],rest$7)}
                    :function(w,x)
                      {var
                        str=convert_float(fconv,default_float_precision(fconv),x),
                        str$0=fix_padding(_fF_,w,str);
                       return make_printf(k$0,[4,acc$0,str$0],rest$7)};
           var p$1=prec$3[1];
           return function(w,x)
            {var str=fix_padding(_fF_,w,convert_float(fconv,p$1,x));
             return make_printf(k$0,[4,acc$0,str],rest$7)};
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _fG_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _fG_[2] !== "number")throw Type_mismatch;
             var fmt=_fG_[1];
          ...
          default:
           ...
           if(counter >= 50)
            return caml_trampoline_return
                    (make_custom$0,[0,k$0,acc$0,rest$19,arity,_fC_]);
           var counter$0=counter + 1 | 0;
           return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_fC_)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_ft_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_ft_,fmt)}
    ...
    function field(x,i$1)
     {var a=x[1 + i$1];
      ...
      if(caml_obj_tag(a) !== 253)return _bl_;
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bn_;
      ...
      return caml_call2(sprintf(_bo_),_fs_,_fr_)}
     ...
     {function conv(param)
       {var param$0=param;
        for(;;)
         {if(! param$0)return 0;
          ...
          try {var switch$0=0,val=caml_call1(hd,e);switch$0 = 1}catch(_fq_){}
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _fm_=other_fields(e,2),
          _fn_=field(e,1),
          _fp_=caml_call2(sprintf(_bp_),_fn_,_fm_);
        else
         switch(match)
          {case 0:var _fp_=_bq_;break;
           case 1:var _fp_=_br_;break;
           default:var _fo_=field(e,1),_fp_=caml_call1(sprintf(_bs_),_fo_)}
        var match$1=[0,constructor,[0,_fp_]]}
      else
       var match$1=[0,e[1],0];
         ...
         {var
          ...
          if(0 === slot[0])
           var
            ...
            _fc_=slot[4],
            _fd_=slot[3],
            _fe_=slot[6]?_bC_:_bE_,
            _ff_=slot[2],
            _fg_=slot[7],
            _fh_=info(slot[1]),
            match=
             [0,caml_call7(sprintf(_bD_),_fh_,_fg_,_ff_,_fe_,_fd_,_fc_,_fb_)];
          else
           if(slot[1])
            var match=0;
           else
            var _fi_=info(0),match=[0,caml_call1(sprintf(_bF_),_fi_)];
    ...
    function default_uncaught_exception_han(exn,raw_backtrace)
     {var _e__=to_string(exn);
      caml_call1(eprintf(_bI_),_e__);
     ...
     {try
       {try
         {var
          ...
          try {do_at_exit(0)}catch(_e9_){}
          try
           {var
             _e5_=default_uncaught_exception_han(exn,raw_backtrace),
             _e4_=_e5_}
          catch(exn$0)
           {exn$0 = caml_wrap_exception(exn$0);
            var
             ...
             _e2_=to_string(exn);
            caml_call1(eprintf(_bK_),_e2_);
            print_raw_backtrace(stderr,raw_backtrace);
            var _e3_=to_string(exn$0);
            caml_call1(eprintf(_bL_),_e3_);
            print_raw_backtrace(stderr,raw_backtrace$0);
            var _e4_=caml_ml_flush(stderr)}
          var _e6_=_e4_}
        catch(_e8_)
         {_e8_ = caml_wrap_exception(_e8_);
          if(_e8_ !== Out_of_memory)throw _e8_;
          var _e6_=prerr_endline(_bJ_)}
        return _e6_}
      catch(_e7_){return 0}}
    caml_register_named_value
    ...
    function to_option(x)
     {function _e1_(x){return [0,x]}
      return case$0(x,function(param){return 0},_e1_)}
    function case$1(x,f,g){return x === t39?caml_call1(f,0):caml_call1(g,x)}
    var t11=true,t125=false;
    t141.String;
    var t22=t141.RegExp;
    t141.Object;
    var array_length=t141.Array,t122=t141.Date;
    t141.Math;
    t141.Error;
    t141.JSON;
    register_printer
    ...
    function unsafeCoerce(tag,e)
     {var t56=e.tagName,_e0_=caml_jsstring_of_string(tag);
      return t56.toLowerCase() === _e0_?e:t58}
    function canvas(e){return unsafeCoerce(_bW_,e)}
    function script(e){return unsafeCoerce(_bX_,e)}
    t141.FormData;
    t141.FormData;
    ({"alpha":t11,
      "depth":t11,
    ...
    function string_match(r,s,i)
     {r.lastIndex = i;
      var t11=caml_jsbytes_of_string(s),x=r.exec(t11),_eZ_=x == t58?t58:x;
      return to_option(_eZ_)}
    function matched_group(r,i)
     {var x=r[i],_eY_=x === t39?t39:caml_string_of_jsbytes(x);
      function _eX_(x){return [0,x]}
      return case$1(_eY_,function(param){return 0},_eX_)}
    new t22("[$]","g");
    var t48$0=regexp(_bZ_),Local_exn=[248,_b0_,caml_fresh_oo_id(0)];
    ...
    var t19=caml_jsbytes_of_string(_b4_);
    new t22(t19);
    var t21=caml_jsbytes_of_string(_b5_);
    new t22(t21);
    var x=t141.location;
    if(x !== t39)
     var _b6_=t141.location;
    else
     var
      t42=function(param,_eW_){return 0},
      t41=function(param,_eV_){return 0},
    ...
    urldecode_js_string_string(_b6_.hostname);
    urldecode_js_string_string(_b6_.protocol);
    var _b7_=0;
    (function(param)
       {try
         {var _eT_=[0,caml_int_of_string(caml_string_of_jsbytes(_b6_.port))];
          return _eT_}
        catch(_eU_)
      ...
      (_b7_));
    var
     s$0=urldecode_js_string_string(_b6_.pathname),
     l=caml_ml_string_length(s$0);
    function aux(i)
     {try
       {var _eR_=index_from(s$0,i,47),j=_eR_}
      catch(_eS_)
    ...
    if(a && ! caml_string_notequal(a[1],_b1_))
     {var _b2_=a[2];
      if(! _b2_ || ! caml_string_notequal(_b2_[1],_b3_) && ! _b2_[2])
       switch$0 = 1}
    var t49=_b6_.search;
    if(t49.charAt(0) === "?")
     var t52=_b6_.search,_b8_=t52.slice(1);
    else
     var _b8_=_b6_.search;
    var
        ...
        try
         {var
           ...
           _eK_=
            function(s)
             {function _eP_(param)
               {var y=param[2],x=param[1],_eQ_=urldecode_js_string_string(y);
                return [0,urldecode_js_string_string(x),_eQ_]}
              var t2=caml_jsstring_of_string(make$0(1,61)),t5=s.indexOf(t2);
              if(t5 < 0)
               var _eO_=t39;
              else
               var t7=t5 + 1 | 0,_eN_=s.slice(t7),_eO_=[0,s.slice(0,t5),_eN_];
              return case$1(_eO_,interrupt,_eP_)},
           _eL_=aux$0([0,case$1(t18[idx$0],interrupt,_eK_),acc],_eJ_);
          return _eL_}
        catch(_eM_)
         {_eM_ = caml_wrap_exception(_eM_);
          if(_eM_ !== Local_exn)throw _eM_;
          var idx$1=idx$0 - 1 | 0,idx$0=idx$1;
          continue}}}
    aux$0(0,len - 1 | 0);
    urldecode_js_string_string(_b6_.href);
    cat(s$1,cat(_cR_,git_version));
     ...
     {var _eI_=p[1];
      switch(_eI_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_eI_[1],p$1=underlying(p$0);
    ...
    function add_implicitly_removed_callbac(callbacks,f)
     {var
       node$0=[1,f],
       _eH_=callbacks[1],
       node=typeof _eH_ === "number"?node$0:[0,node$0,_eH_];
      callbacks[1] = node;
      return 0}
    var
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _eG_=caml_call1(f,v);return _eG_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        return caml_call1(async_exception_hook[1],exn)}}
    var Canceled=[248,_b__,caml_fresh_oo_id(0)];
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _eE_=result[1] === Canceled?1:0,is_canceled=_eE_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_eC_,0)}
      var _eD_=callbacks[1];
      ...
      return iter_callback_list$0(_eD_,0)}
    var
      ...
      switch(_eB_[0])
       {case 1:
         return _eB_[1] === Canceled
                 ?0
                 :caml_call1(ksprintf(invalid_arg,_ca_),api_function_name);
        case 2:
         if(0 === result[0])
          var x=result[1],result$0=[0,x];
         else
          var exn=result[1],result$0=[1,exn];
         resolve(_cb_,0,p$0,result$0);
         return 0;
        default:
         return caml_call1(ksprintf(invalid_arg,_b$_),api_function_name)}}
    function wakeup(r,v){return wakeup_general(_cc_,r,[0,v])}
    ...
    function make_into_proxy(outer_promise,user_provided_promise)
     {var p=underlying(user_provided_promise);
      ...
      var _eA_=p[1];
      switch(_eA_[0])
       {case 1:return resolve(_cf_,0,outer_promise,p[1]);
        case 2:
         var
          p_callbacks=_eA_[1],
      ...
      function create_result_promise_and_call(param)
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$2=underlying(p);resolve(_cg_,0,p$2,p_result);return 0}
          var v=p_result[1];
       ...
       {case 1:return [0,_ev_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_ch_,function(param){return caml_call1(f,v)},_ew_)}}
     ...
     {try
      ...
      function create_result_promise_and_call(param)
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 !== p_result[0])
           {var p$0=underlying(p);resolve(_cl_,0,p$0,p_result);return 0}
          var exn=p_result[1];
          current_storage[1] = saved_storage;
          try
          ...
          _es_=
           function(param)
            {var
             ...
             return [0,p,callback,p$0[1]]};
         return run_callback_or_defer_it
                 (_cm_,function(param){return caml_call1(h,exn)},_es_);
        case 2:
         var
          p_callbacks=_er_[1],
          match=create_result_promise_and_call(0),
      ...
      switch(_ep_[0])
       {case 1:
        ...
        case 2:
         ...
         return 0;
        default:return 0}}
    var pause_hook=[0,function(_eo_){return 0}],s1=create$0(0),_cp_=[0,0];
     ...
     {var p=underlying(p$1);
      function create_result_promise_and_call(param)
       {var p$0=new_pending([0,p]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$1=underlying(p$0);resolve(_cj_,0,p$1,p_result);return 0}
          var v=p_result[1];
          current_storage[1] = saved_storage;
          try
           {var _em_=[0,caml_call1(f,v)],p_result$0=_em_}
          catch(exn){exn = caml_wrap_exception(exn);var p_result$0=[1,exn]}
          var p=underlying(p$0);
          resolve(_ci_,0,p,p_result$0);
          return 0}
        return [0,p$0,callback]}
      var _ei_=p[1];
      switch(_ei_[0])
       {case 1:return [0,_ei_];
        case 2:
         var
          p_callbacks=_ei_[1],
          match=create_result_promise_and_call(0),
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_ck_,
                  function(param)
                   {try
                     {var _el_=[0,caml_call1(f,v)],_ek_=_el_}
                    catch(exn){exn = caml_wrap_exception(exn);var _ek_=[1,exn]}
                    return [0,_ek_]},
                  _ej_)}}
    ...
    function check_error(gl)
     {var _eg_=gl.NO_ERROR,_eh_=caml_notequal(gl.getError(),_eg_);
      return _eh_?error(_ct_):_eh_}
    function init_canvas(canvas_id)
     {function _eb_(param){return caml_call1(error(_cu_),canvas_id)}
      var
       canvas$0=
        get
       ...
       {return ksprintf
                (function(s)
                  {var t4=caml_jsstring_of_string(s);
                   ...
                   return failwith(s)},
                 f$0)}
      try {var _ee_=getContext(canvas$0),_ed_=_ee_}catch(_ef_){var _ed_=t58}
      var gl=get(_ed_,_ec_);
    ...
    function load_shader(gl,shader,text)
     {gl.shaderSource(shader,text);
      ...
      var
       ...
       _d__=1 - (gl.getShaderParameter(shader,t17) | 0);
      if(! _d__)return _d__;
      var
       _d$_=caml_string_of_jsstring(gl.getShaderInfoLog(shader)),
       _ea_=caml_string_of_jsstring(text);
      return caml_call2(error(_cv_),_ea_,_d$_)}
    function get_source(src_id)
     {function _d9_(param){return caml_call1(error(_cx_),src_id)}
      var
       t40=caml_jsstring_of_string(src_id),
       t42=get(bind(t48.getElementById(t40),script),_d9_);
      return t42.text}
    ...
    function mult(m1,m2)
     {function v(p)
       {var
         j=p % 4 | 0,
         i=p / 4 | 0,
         _dZ_=caml_array_get(m2,c(3,j)),
         _d0_=caml_array_get(m1,c(i,3)) * _dZ_,
         _d1_=caml_array_get(m2,c(2,j)),
         _d2_=caml_array_get(m1,c(i,2)) * _d1_,
         _d3_=caml_array_get(m2,c(1,j)),
         _d4_=caml_array_get(m1,c(i,1)) * _d3_,
         _d5_=caml_array_get(m2,c(0,j));
        return caml_array_get(m1,c(i,0)) * _d5_ + _d4_ + _d2_ + _d0_}
      return init(16,v)}
    var line_regexp=regexp(_cy_),couple_regexp=regexp(_cz_);
    function read_coord_couple(c)
     {var match=string_match(couple_regexp,c,0);
      if(! match)return 0;
      var
       res=match[1],
       match$0=map(function(_dY_){return matched_group(res,_dY_)},_cA_);
      if(match$0)
       {var _dU_=match$0[1];
        if(_dU_)
         {var _dV_=match$0[2];
          if(_dV_)
           {var _dW_=_dV_[1];
            if(_dW_ && ! _dV_[2])
             {var vn=_dW_[1],v=_dU_[1],_dX_=caml_int_of_string(vn);
              return [0,[0,caml_int_of_string(v),_dX_]]}}}}
      return 0}
    function concat(a)
     {var r=[0,0],_dO_=a.length - 1 - 1 | 0,_dN_=0;
      if(_dO_ >= 0)
       {var i=_dN_;
        a:
        for(;;)
         {var l=a[1 + i],len=0,param=l,_dQ_=r[1];
          for(;;)
           {if(param)
            ...
            r[1] = _dQ_ + len | 0;
            var _dR_=i + 1 | 0;
            if(_dO_ !== i){var i=_dR_;continue a}
            break}
          break}}
      var pos=[0,-1],l$0=[0,0],_dP_=r[1];
      function next(param)
       {for(;;)
         {var _dS_=l$0[1];
          if(_dS_){var q=_dS_[2],t=_dS_[1];l$0[1] = q;return t}
          pos[1]++;
          var _dT_=pos[1];
          l$0[1] = caml_check_bound(a,_dT_)[1 + _dT_]}}
      return init(_dP_,next)}
     ...
     {function _dG_(r)
      ...
      for(;;)
       {if(param)
         ...
         headers=
          function(s)
           {function _dL_(v){return [0,caml_string_of_jsstring(v)]}
            ...
            return case$0(t26.getResponseHeader(t35),_dM_,_dL_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
               ...
               {case 2:if(! onIE){do_check_headers(0);return 0}break;
                ...
                case 4:
                 ...
                 var
                  ...
                  _dI_=function(x){return caml_string_of_jsstring(x)},
                  _dJ_=function(param){return _cr_},
                  response=
                   [0,url,code,headers,case$0(t26.responseText,_dJ_,_dI_),_dH_];
        ...
        return symbol_bind(res,_dG_)}}
    function getfile(f)
     {try
       {var _dE_=return$0(caml_read_file_content(f));return _dE_}
      catch(_dF_)
       {_dF_ = caml_wrap_exception(_dF_);
        if(_dF_ !== Not_found)throw _dF_;
        var _dD_=function(s){return s};
        return symbol(http_get(f),_dD_)}}
    function start(param)
     {var
      ...
      debug(_cG_);
      var match=init_canvas(_cH_),gl=match[2];
      debug(_cI_);
      var
       frag_src=get_source(_cJ_),
       vert_src=get_source(_cK_),
      ...
      if(1 - (gl.getProgramParameter(t96,t38) | 0))error(_cw_);
      debug(_cL_);
      gl.useProgram(t96);
      check_error(gl);
      debug(_cM_);
        ...
        for(;;)
         {if(cell)
           {var
            ...
            continue}
          var
           fps=1. / accu * _dz_ * 1000.,
           t138=caml_jsstring_of_string(caml_call1(sprintf(_cO_),fps));
          t139.data = t138;
          var
           match=task(0),
           w=match[2],
           t=match[1],
           d=20.,
           callback=function(_dC_){return wakeup(w,_dC_)},
           id=[0,0],
           loop=
            function(d,param)
             {if(2147483000. < d)
              ...
              var
               cb=
                remain == 0.?callback:function(_dB_){return loop(remain,_dB_)},
               t125=caml_js_wrap_callback(cb);
              id[1] = [0,t141.setTimeout(t125,step)];
              return 0};
          loop(d,0);
          on_cancel
           (t,
            function(param)
             {var _dA_=id[1];
              ...
              var x=_dA_[1];
              id[1] = 0;
              return t141.clearTimeout(x)});
          return symbol_bind(t,f)}}
      return f(0)}
    function f$1(param)
     {debug(_cP_);
      function _cS_(exn)
       {var _dy_=to_string(exn);return caml_call1(error(_cQ_),_dy_)}
      catch$0
       (function(param)
         {function _cT_(s$0)
           {var r=regexp(_cF_);
            ...
            for(;;)
             {if(idx >= 0)
               {var idx$0=idx - 1 | 0,x=a[idx];
                if(x === t39)throw [0,Assert_failure,_bY_];
                var
                  ...
                  if(match)
                   {var
                     ...
                     match$0=
                      map
                       (function(res)
                          {return function(_dx_){return matched_group(res,_dx_)}}
                         (res),
                        _cB_),
                     switch$0=0;
                    if(match$0)
                     {var _cX_=match$0[1];
                      if(_cX_)
                       {var _cY_=_cX_[1];
                        if(caml_string_notequal(_cY_,_cC_))
                         if(caml_string_notequal(_cY_,_cD_))
                          {if(! caml_string_notequal(_cY_,_cE_))
                            {var _cZ_=match$0[2];
                             if(_cZ_)
                              {var _c0_=_cZ_[1];
                               if(_c0_)
                                      ...
                                      {var _c4_=_c3_[1];
                                       if(_c4_ && ! _c3_[2])
                                        {var
                                          ...
                                          y=_c2_[1],
                                          x$0=_c0_[1],
                                          _c5_=caml_float_of_string(z),
                                          _c6_=caml_float_of_string(y),
                                          match$2=[0,[1,[0,caml_float_of_string(x$0),_c6_,_c5_]]];
                                         switch$0 = 1}}}}}}}}
                         else
                          {var _c7_=match$0[2];
                           if(_c7_)
                                    ...
                                    {var _da_=_c$_[1];
                                     if(_da_ && ! _c$_[2])
                                      {var
                                        ...
                                        y$0=_c__[1],
                                        x$1=_c8_[1],
                                        _db_=caml_float_of_string(z$0),
                                        _dc_=caml_float_of_string(y$0),
                                        match$2=[0,[0,[0,caml_float_of_string(x$1),_dc_,_db_]]];
                                       switch$0 = 1}}}}}}}
                        else
                         {var _dd_=match$0[2];
                          if(_dd_)
               ...
               vertex=
                init
                 (face$0.length - 1,
                  function(i)
                   {var
                     _dt_=caml_check_bound(face$0,i)[1 + i],
                     cv=_dt_[3][1],
                     bv=_dt_[2][1],
                     match=_dt_[1],
                     av=match[1],
                     _du_=av - 1 | 0,
                     match$0=caml_check_bound(vertex$2,_du_)[1 + _du_],
                     a3=match$0[3],
                     a2=match$0[2],
                     a1=match$0[1],
                     _dv_=bv - 1 | 0,
                     match$1=caml_check_bound(vertex$2,_dv_)[1 + _dv_],
                     b3=match$1[3],
                     b2=match$1[2],
                     b1=match$1[1],
                     _dw_=cv - 1 | 0,
                     match$2=caml_check_bound(vertex$2,_dw_)[1 + _dw_],
                     c3=match$2[3],
                     c2=match$2[2],
                     c1=match$2[1];
                    return [0,
               ...
               norm=
                init
                 (face$0.length - 1,
                  function(i)
                   {var
                     _dp_=caml_check_bound(face$0,i)[1 + i],
                     cn=_dp_[3][2],
                     bn=_dp_[2][2],
                     match=_dp_[1],
                     an=match[2],
                     _dq_=an - 1 | 0,
                     match$0=caml_check_bound(norm$2,_dq_)[1 + _dq_],
                     a3=match$0[3],
                     a2=match$0[2],
                     a1=match$0[1],
                     _dr_=bn - 1 | 0,
                     match$1=caml_check_bound(norm$2,_dr_)[1 + _dr_],
                     b3=match$1[3],
                     b2=match$1[2],
                     b1=match$1[1],
                     _ds_=cn - 1 | 0,
                     match$2=caml_check_bound(norm$2,_ds_)[1 + _ds_],
                     c3=match$2[3],
                     c2=match$2[2],
                     c1=match$2[1];
                    return [0,
          ...
          return symbol_bind(symbol(getfile(s$2),_cT_),start)},
        _cS_);
      return t11}
    var
     t140=
