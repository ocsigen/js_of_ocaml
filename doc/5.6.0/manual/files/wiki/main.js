...
(function(globalThis){
   ...
   function engine(tbl, state, buf){
    var
     ...
     _fe_ = 0 <= result ? 1 : 0,
     _ff_ = _fe_ ? buf[12] !== dummy_pos ? 1 : 0 : _fe_;
    if(_ff_){
     buf[11] = buf[12];
     var _fg_ = buf[12];
     buf[12] = [0, _fg_[1], _fg_[2], _fg_[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _eU_ = function(param){af(0); return;};
        return [0, function(param){fa(0); return;}, _eU_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _eV_ = function(param){af$0(0); return;};
        return [0, function(param){fa$0(0); return;}, _eV_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _eW_ = function(param){af$1(0); return;};
        return [0, function(param){fa$1(0); return;}, _eW_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _eX_ = function(param){af$2(0); return;};
        return [0, function(param){fa$2(0); return;}, _eX_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _eY_ = function(param){af$3(0); return;};
        return [0, function(param){fa$3(0); return;}, _eY_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _eZ_ = function(param){af$4(0); return;};
        return [0, function(param){fa$4(0); return;}, _eZ_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _e0_ = function(param){af$5(0); return;};
        return [0, function(param){fa$5(0); return;}, _e0_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _e1_ = function(param){af$6(0); return;};
        return [0, function(param){fa$6(0); return;}, _e1_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _e2_ = function(param){af$7(0); return;};
        return [0, function(param){fa$7(0); return;}, _e2_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _e3_ = function(param){jd(0); de$8(0); return;},
         _e4_ = function(param){ed$8(0); dj(0); return;},
         _e5_ = function(param){ga(0); af$8(0); return;};
        return [0, function(param){fa$8(0); ag(0); return;}, _e5_, _e4_, _e3_];
       case 10:
        var
         rest$9 = param[1],
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _e6_ = function(param){af$9(0); return;};
        return [0, function(param){fa$9(0); return;}, _e6_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _e7_ = function(param){af$10(0); return;};
        return [0, function(param){fa$10(0); return;}, _e7_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _e8_ = function(param){af$11(0); return;};
        return [0, function(param){fa$11(0); return;}, _e8_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _e9_ = function(param){de$12(0); return;},
         _e__ = function(param){ed$12(0); return;},
         _e$_ = function(param){af$12(0); return;};
        return [0, function(param){fa$12(0); return;}, _e$_, _e__, _e9_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _fa_ = function(param){de$13(0); return;},
         _fb_ = function(param){ed$13(0); return;},
         _fc_ = function(param){af$13(0); return;};
        return [0, function(param){fa$13(0); return;}, _fc_, _fb_, _fa_];
     }
    function _eR_(param){return;}
    function _eS_(param){return;}
    function _eT_(param){return;}
    return [0, function(param){return;}, _eT_, _eS_, _eR_];
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _eQ_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _eQ_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _eO_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _eO_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _eP_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _eP_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _eP_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _eM_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _eM_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _eN_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _eN_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _eD_ = caml_ml_bytes_length(b) - 1 | 0,
     _eC_ = 0;
    if(_eD_ >= 0){
     var i$0 = _eC_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _eF_ = caml_ml_bytes_length(b) - 1 | 0, _eE_ = 0;
     if(_eF_ >= 0){
      var i = _eE_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _ep_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _ep_ >>> 0){
           if(55 === _ep_) break a;
          }
          else if(21 < _ep_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _eq_ = 1;
        }
        var _er_ = _eq_ ? str : symbol(str, _a5_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _ei_]);
        var counter$15 = counter + 1 | 0;
        return make_custom$0(counter$15, k$0, acc$0, rest$23, arity, _ei_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _ef_ = [8, acc, _bc_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _ef_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _ef_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _ee_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _ee_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _ee_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _ed_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _eb_ = other_fields(x, i + 1 | 0), _ec_ = field(x, i);
    return caml_call2(sprintf(_bl_), _ec_, _eb_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_ea_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _d8_ = other_fields(e, 2),
       _d9_ = field(e, 1),
       _d$_ = caml_call2(sprintf(_bm_), _d9_, _d8_);
     else
      switch(match){
        case 0:
         var _d$_ = _bn_; break;
        case 1:
         var _d$_ = _bo_; break;
        default:
         var _d__ = field(e, 1), _d$_ = caml_call1(sprintf(_bp_), _d__);
      }
     var match$0 = [0, constructor, [0, _d$_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dY_ = slot[4],
        _dZ_ = slot[3],
        _d0_ = slot[6] ? _bz_ : _bB_,
        _d1_ = slot[2],
        _d2_ = slot[7],
        _d3_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bA_), _d3_, _d2_, _d1_, _d0_, _dZ_, _dY_, _dX_)];
      else if(slot[1])
       var match = 0;
      else
       var _d4_ = info(0), match = [0, caml_call1(sprintf(_bC_), _d4_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dV_){}
      try{
       var _dL_ = to_string(exn$0);
       caml_call1(eprintf(_bF_), _dL_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _dM_ = abs(status);
        prerr_endline(caml_check_bound(errors, _dM_)[1 + _dM_]);
       }
       var _dN_ = caml_ml_flush(stderr), _dR_ = _dN_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dP_ = to_string(exn$0);
       caml_call1(eprintf(_bH_), _dP_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dQ_ = to_string(exn);
       caml_call1(eprintf(_bI_), _dQ_);
      ...
      var _dO_ = caml_wrap_exception(_dU_);
      if(_dO_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_dO_, 0);
      var _dS_ = prerr_endline(_bG_);
     }
     return _dS_;
    }
    catch(_dT_){return 0;}
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _dK_ = caml_call1(f, v); return _dK_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _dJ_ = result[1] === Canceled ? 1 : 0, is_canceled = _dJ_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _dI_ = deferred_callbacks[2];
      if(! _dI_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _dI_[1];
      if(_dI_[2]){
       var next = _dI_[2];
   ...
   function push(c, v){
    var _dD_ = c[12];
    if(typeof _dD_ !== "number" && 1 === _dD_[0]){c[8] = [0, v, c[8]]; return;}
    var _dE_ = c[7];
       ...
       case 5:
        ...
        for(;;){
         ...
         switch(ocaml_lex_state$2){
           ...
           default: var _dk_ = c[9]; c[9] = [0, lexeme(lexbuf), _dk_];
         }
        }
        break;
       case 6:
      ...
      switch(ocaml_lex_state$1){
        ...
        case 10:
         ...
         for(;;){
          ...
          if(caml_string_unsafe_get(s$2, i) === 124){
           ...
           return parse_rem(counter$16, c, lexbuf);
          }
          var i$0 = i + 1 | 0, i = i$0;
         }
         break;
        ...
        case 15:
         ...
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$14 = counter + 1 | 0;
         return parse_rem(counter$14, c, lexbuf);
        case 16:
         push_chars(c, lexbuf);
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$15 = counter + 1 | 0;
         return parse_rem(counter$15, c, lexbuf);
