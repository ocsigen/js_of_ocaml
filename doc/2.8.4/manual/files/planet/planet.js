...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _v_=[0,0,0,0],
     _w_=[0,caml_new_string("map.ml"),274,10],
     _x_=[0,0,0],
     ...
     _A_=caml_new_string("Buffer.add_substring/add_subbytes"),
     ...
     ___=[0,caml_new_string("camlinternalFormat.ml"),845,23],
     _aj_=[0,caml_new_string("camlinternalFormat.ml"),809,21],
     _ab_=[0,caml_new_string("camlinternalFormat.ml"),810,21],
     _ak_=[0,caml_new_string("camlinternalFormat.ml"),813,21],
     _ac_=[0,caml_new_string("camlinternalFormat.ml"),814,21],
     _al_=[0,caml_new_string("camlinternalFormat.ml"),817,19],
     _ad_=[0,caml_new_string("camlinternalFormat.ml"),818,19],
     _am_=[0,caml_new_string("camlinternalFormat.ml"),821,22],
     _ae_=[0,caml_new_string("camlinternalFormat.ml"),822,22],
     _an_=[0,caml_new_string("camlinternalFormat.ml"),826,30],
     _af_=[0,caml_new_string("camlinternalFormat.ml"),827,30],
     _ah_=[0,caml_new_string("camlinternalFormat.ml"),831,26],
     _$_=[0,caml_new_string("camlinternalFormat.ml"),832,26],
     _ai_=[0,caml_new_string("camlinternalFormat.ml"),841,28],
     ...
     _bi_=[0,caml_new_string("camlinternalFormat.ml"),1520,4],
     _bj_=caml_new_string("Printf: bad conversion %["),
     _bl_=[0,caml_new_string("camlinternalFormat.ml"),1588,39],
     _bm_=[0,caml_new_string("camlinternalFormat.ml"),1611,31],
     _bn_=[0,caml_new_string("camlinternalFormat.ml"),1612,31],
     ...
     _b7_=[0,caml_new_string("src/core/lwt.ml"),837,35],
     _b8_=[0,caml_new_string("src/core/lwt.ml"),839,8],
     _b5_=[0,caml_new_string("src/core/lwt.ml"),672,35],
     _b6_=[0,caml_new_string("src/core/lwt.ml"),675,8],
     _b4_=[0,caml_new_string("src/core/lwt.ml"),511,8],
     _b3_=[0,caml_new_string("src/core/lwt.ml"),500,9],
     _b2_=caml_new_string("Lwt.wakeup_result"),
     _b1_=caml_new_string("Fatal error: exception "),
     _b0_=caml_new_string("Lwt.Canceled"),
     _b__=caml_new_string("Js.Error"),
     _b$_=caml_new_string("jsError"),
     _cj_=caml_new_string("canvas"),
     _ch_=caml_new_string("img"),
     _cg_=caml_new_string("br"),
     _cf_=caml_new_string("p"),
     _ce_=caml_new_string("div"),
     _cd_=caml_new_string("label"),
     _cc_=caml_new_string("input"),
     _cb_=caml_new_string("select"),
     ...
     _co_=[0,caml_new_string("planet.ml"),415,0],
     _cn_=[0,caml_new_string("planet.ml"),416,0],
     _cm_=[0,caml_new_string("planet.ml"),417,0],
     _cl_=[0,caml_new_string("planet.ml"),418,0];
        ...
        for(;;)
         {if(param$0)
           {var l=param$0[2],a=param$0[1];
            try {caml_ml_flush(a)}catch(_g4_){}
            var param$0=l;
            continue}
          return 0}}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(!(l < i))
        try
         {index_rec(s,l,i,c);var _g2_=1;return _g2_}
        catch(_g3_)
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_g0_=l - 1 | 0,_gZ_=1;
      if(!(_g0_ < 1))
       {var i=_gZ_;
        for(;;)
         {r[i + 1] = caml_call1(f,a[i + 1]);
          var _g1_=i + 1 | 0;
          if(_g0_ !== i){var i=_g1_;continue}
          break}}
      return r}
    caml_fresh_oo_id(0);
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_gY_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gT_=height(lr);
            if(_gT_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _gU_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_gU_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gV_=height(rl);
            if(_gV_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _gW_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_gW_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _gX_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gX_]}
      var empty=0;
         ...
         {var _gN_=param[1];
          if(_gN_)
           {var r=param[4],d=param[3],x=param[2];
            return bal(remove_min_binding(_gN_),x,d,r)}
          var r$0=param[4];
          return r$0}
        ...
        for(;;)
         {if(param$0)
           {var
            ...
            if(_gK_)
             {var _gL_=for_all(p,l);
              if(_gL_){var param$0=r;continue}
              var _gM_=_gL_}
            else
             var _gM_=_gK_;
            return _gM_}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _gD_=merge(f,r1,r2),
             _gE_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_gE_,_gD_)}}
        else
         if(!s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _gF_=merge(f,r1$0,r2$0),
           _gG_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_gG_,_gF_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _gB_=concat(lf,rf);return [0,join(lt,v,d,rt),_gB_]}
          var _gC_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_gC_]}
        return _x_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _gy_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_gy_)
               {var _gz_=caml_call2(cmp,d1,d2);
                if(_gz_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_gx_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _gx_ | 0}
        return 0}
     ...
     {if(typeof formatting_lit === "number")
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:var c=formatting_lit[1];return _a_(_I_,make$0(1,c))}}
       ...
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _ga_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_ga_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _gb_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _gc_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _gd_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _ge_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _gf_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _gg_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _gh_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _gi_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _gj_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _gk_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _gl_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _gm_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _gn_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _go_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _gp_=function(param){caml_call1(de$12,0);return 0},
           _gq_=function(param){caml_call1(ed$12,0);return 0},
           _gr_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _gs_=function(param){caml_call1(de$13,0);return 0},
           _gt_=function(param){caml_call1(ed$13,0);return 0},
           _gu_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_fQ_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fR_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fS_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fT_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_fU_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fV_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fW_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fX_,rest2$6)];
         ...
         case 8:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_f0_=trans(_fY_,rest2$7);
              return [8,trans(_fZ_,ty2),_f0_];
            ...
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_f2_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_f3_,ty22,trans(_f1_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_f4_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_f5_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_f6_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_f7_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_f8_,rest2$13)];
      ...
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        if(typeof _fP_ !== "number" && 2 === _fP_[0])
         {var rest$0=_fP_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _fo_ !== "number" && 1 === _fo_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_fp_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _fq_=type_padding(pad$0,fmtty),
           _fr_=_fq_[2],
           _fs_=_fq_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _ft_=type_padprec(pad$1,prec,fmtty),
           _fu_=_ft_[3],
           _fv_=_ft_[2],
           _fw_=_ft_[1];
          if(typeof _fu_ !== "number" && 2 === _fu_[0])
           {var
             ...
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_fw_,_fv_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _fx_=type_padprec(pad$2,prec$0,fmtty),
           _fy_=_fx_[3],
           _fz_=_fx_[2],
           _fA_=_fx_[1];
          if(typeof _fy_ !== "number" && 3 === _fy_[0])
           {var
             ...
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_fA_,_fz_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _fB_=type_padprec(pad$3,prec$1,fmtty),
           _fC_=_fB_[3],
           _fD_=_fB_[2],
           _fE_=_fB_[1];
          if(typeof _fC_ !== "number" && 4 === _fC_[0])
           {var
             ...
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_fE_,_fD_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _fF_=type_padprec(pad$4,prec$2,fmtty),
           _fG_=_fF_[3],
           _fH_=_fF_[2],
           _fI_=_fF_[1];
          if(typeof _fG_ !== "number" && 5 === _fG_[0])
           {var
             ...
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_fI_,_fH_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _fJ_=type_padprec(pad$5,prec$3,fmtty),
           _fK_=_fJ_[3],
           _fL_=_fJ_[2],
           _fM_=_fJ_[1];
          if(typeof _fK_ !== "number" && 6 === _fK_[0])
           {var
             ...
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_fM_,_fL_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _fN_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_fN_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 8:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fO_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_fO_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_fO_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _fl_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_fl_))
             throw Type_mismatch;
            var _fm_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_fm_))
             throw Type_mismatch;
            var
      ...
      for(;;)
       {if(caml_ml_string_length(str) <= i$1)
         ...
         {var match$0=caml_string_unsafe_get(str,i$1);
          if(32 <= match$0)
           {var _fi_=match$0 - 34 | 0;
            if(58 < _fi_ >>> 0)
             if(93 <= _fi_)var switch$0=0,switch$1=0;else var switch$1=1;
            else
             if(56 < (_fi_ - 1 | 0) >>> 0)
              var switch$0=1,switch$1=0;
             else
          ...
          var _fj_=switch$0?1:1}
        if(_fj_)
         {var n=[0,0],_fb_=caml_ml_string_length(str) - 1 | 0,_fa_=0;
          if(!(_fb_ < 0))
           {var i$0=_fa_;
            for(;;)
             {var match=caml_string_unsafe_get(str,i$0);
              if(32 <= match)
               {var _ff_=match - 34 | 0;
                if(58 < _ff_ >>> 0)
                 if(93 <= _ff_)var switch$2=0,switch$3=0;else var switch$3=1;
                else
                 if(56 < (_ff_ - 1 | 0) >>> 0)
                  var switch$2=1,switch$3=0;
                 else
                  var switch$3=1;
                if(switch$3)var _fg_=1,switch$2=2}
              else
               var switch$2=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$2)
               {case 0:var _fg_=4;break;case 1:var _fg_=2;break}
              n[1] = n[1] + _fg_ | 0;
              var _fh_=i$0 + 1 | 0;
              if(_fb_ !== i$0){var i$0=_fh_;continue}
              break}}
          if(n[1] === caml_ml_string_length(str))
           ...
           {var s=caml_create_string(n[1]);
            n[1] = 0;
            var _fd_=caml_ml_string_length(str) - 1 | 0,_fc_=0;
            if(!(_fd_ < 0))
             {var i=_fc_;
              for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _e$_=_ap_;break;
        case 1:var _e$_=_aq_;break;
        case 2:var _e$_=_ar_;break;
        case 3:var _e$_=_as_;break;
        case 4:var _e$_=_at_;break;
        case 5:var _e$_=_au_;break;
        case 6:var _e$_=_av_;break;
        case 7:var _e$_=_aw_;break;
        case 8:var _e$_=_ax_;break;
        case 9:var _e$_=_ay_;break;
        case 10:var _e$_=_az_;break;
        case 11:var _e$_=_aA_;break;
        default:var _e$_=_aB_}
      return caml_format_int(_e$_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _e__=_aP_;break;
        case 1:var _e__=_aQ_;break;
        case 2:var _e__=_aR_;break;
        case 3:var _e__=_aS_;break;
        case 4:var _e__=_aT_;break;
        case 5:var _e__=_aU_;break;
        case 6:var _e__=_aV_;break;
        case 7:var _e__=_aW_;break;
        case 8:var _e__=_aX_;break;
        case 9:var _e__=_aY_;break;
        case 10:var _e__=_aZ_;break;
        case 11:var _e__=_a0_;break;
        default:var _e__=_a1_}
      return caml_format_int(_e__,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _e9_=_a2_;break;
        case 1:var _e9_=_a3_;break;
        case 2:var _e9_=_a4_;break;
        case 3:var _e9_=_a5_;break;
        case 4:var _e9_=_a6_;break;
        case 5:var _e9_=_a7_;break;
        case 6:var _e9_=_a8_;break;
        case 7:var _e9_=_a9_;break;
        case 8:var _e9_=_a__;break;
        case 9:var _e9_=_a$_;break;
        case 10:var _e9_=_ba_;break;
        case 11:var _e9_=_bb_;break;
        default:var _e9_=_bc_}
      return caml_format_int(_e9_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _e8_=_aC_;break;
        case 1:var _e8_=_aD_;break;
        case 2:var _e8_=_aE_;break;
        case 3:var _e8_=_aF_;break;
        case 4:var _e8_=_aG_;break;
        case 5:var _e8_=_aH_;break;
        case 6:var _e8_=_aI_;break;
        case 7:var _e8_=_aJ_;break;
        case 8:var _e8_=_aK_;break;
        case 9:var _e8_=_aL_;break;
        case 10:var _e8_=_aM_;break;
        case 11:var _e8_=_aN_;break;
        default:var _e8_=_aO_}
      return caml_int64_format(_e8_,n)}
     ...
     {if(16 <= fconv)
       {if(17 <= fconv)
        ...
        if(19 <= fconv)
         {var l=caml_ml_string_length(s);
          if(0 === l)return s;
          var r=caml_create_string(l),_e2_=l - 1 | 0,_e1_=0;
          if(!(_e2_ < 0))
           {var i=_e1_;
            for(;;)
             {var c=caml_string_unsafe_get(s,i);
              if(97 <= c)
               if(122 < c)var switch$1=0;else var _e3_=c - 32 | 0,switch$1=1;
              else
               var switch$1=0;
              if(!switch$1)var _e3_=c;
              caml_string_unsafe_set(r,i,_e3_);
              var _e4_=i + 1 | 0;
              if(_e2_ !== i){var i=_e4_;continue}
              break}}
          return r}
        return s}
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _e5_=buffer_contents(buf)}
      var str=caml_format_float(_e5_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _e6_=match - 46 | 0,
             switch$2=
              23 < _e6_ >>> 0?55 === _e6_?1:0:21 < (_e6_ - 1 | 0) >>> 0?1:0;
            if(!switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _e7_=1}
          return _e7_?str:_a_(str,_bh_)}}
      return str}
     ...
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
        ...
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_e0_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_e0_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_e0_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
        ...
        switch(fmt$0[0])
         {case 0:
          ...
          case 9:
           ...
           return function(b)
            {var _eX_=b?_b_:_c_;
             return make_printf(k$0,o,[4,acc$0,_eX_],rest$8)};
          case 10:
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_eS_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_eS_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _eP_=[8,acc,_bo_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_eP_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_eP_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_eO_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_eO_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_eJ_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_eJ_,fmt)}
    ...
    function field(x,i$1)
     {var f=x[i$1 + 1];
      if(caml_obj_is_block(f))
       {if(caml_obj_tag(f) === 252)return caml_call1(sprintf(_bt_),f);
         ...
         {var s=caml_format_float(_e_,f),l=caml_ml_string_length(s),i=0;
          for(;;)
           {if(l <= i)return _a_(s,_d_);
            ...
            return s}}
        return _bu_}
      return caml_call1(sprintf(_bv_),f)}
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bw_;
      var _eH_=other_fields(x,i + 1 | 0),_eI_=field(x,i);
      return caml_call2(sprintf(_bx_),_eI_,_eH_)}
    function fields(x)
     {var n=x.length - 1;
      if(2 < n >>> 0)
       {var _eE_=other_fields(x,2),_eF_=field(x,1);
        return caml_call2(sprintf(_by_),_eF_,_eE_)}
      switch(n)
       {case 0:return _bz_;
        case 1:return _bA_;
        default:var _eG_=field(x,1);return caml_call1(sprintf(_bB_),_eG_)}}
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call5
                 (sprintf(_bL_),_et_,filename,lineno,startchar,endchar)];
            else
             if(0 === slot[1])
              var _eu_=info(0),match=[0,caml_call1(sprintf(_bM_),_eu_)];
             else
              var match=0;
    ...
    try
     ...
     {_er_ = caml_wrap_exception(_er_);
      ...
      try
       {var _cx_=caml_sys_getenv(_cw_),_bQ_=_cx_}
      catch(_es_)
    ...
    function add_queue(x,q)
     {var c=[0,[0,x,0]],_eq_=q[1];
      if(_eq_){var cell=_eq_[1];q[1] = c;cell[2] = c;return 0}
      q[1] = c;
      q[2] = c;
      return 0}
    ...
    function take_queue(q)
     {var _ep_=q[2];
      if(_ep_)
       {var match=_ep_[1],x=match[1],tl=match[2];
        q[2] = tl;
        if(0 === tl)q[1] = 0;
        return x}
      throw Empty_queue}
    ...
    function break_new_line(state,offset,width)
     {pp_output_newline(state);
      ...
      var
       ...
       _eo_=state[8],
       real_indent=caml_lessequal(_eo_,y)?_eo_:y;
     ...
     {if(typeof param === "number")
       switch(param)
        {case 0:
         ...
         case 1:
          var _eb_=state[2];
          if(_eb_){var ls=_eb_[2];state[2] = ls;return 0}
          return 0;
         case 2:
          var _ec_=state[3];
          if(_ec_){var ls$0=_ec_[2];state[3] = ls$0;return 0}
          return 0;
         case 3:
          var _ed_=state[2];
          if(_ed_)
           {var match$0=_ed_[1],width=match$0[2];
            return break_line(state,width)}
          return pp_output_newline(state);
         case 4:
          var _ee_=state[10] !== (state[6] - state[9] | 0)?1:0;
          return _ee_?pp_skip_token(state):_ee_;
         default:
          var _ef_=state[5];
          if(_ef_)
           {var
       ...
       switch(param[0])
        {case 0:
          ...
          return 0;
         case 1:
          var off=param[2],n=param[1],_eg_=state[2];
          if(_eg_)
           {var match$1=_eg_[1],width$0=match$1[2],ty=match$1[1];
            switch(ty)
          ...
          if(_eh_)
           {var
            ...
            if(_ei_)
             {var x=_ei_[1];
              try
               {var _ej_=find(insertion_point,tabs$0[1]),x$0=_ej_}
              catch(_ek_)
       ...
       {var _d8_=state[27][2];
        if(_d8_)
         {var
           ...
           tok=x[2],
           _d9_=size < 0?1:0,
           _d__=_d9_?(state[13] - state[12] | 0) < state[9]?1:0:_d9_,
           _d$_=1 - _d__;
          if(_d$_)
           {take_queue(state[27]);
    ...
    function advance_left(state)
     {try
       {var _d6_=advance_loop(state);return _d6_}
      catch(_d7_)
       {_d7_ = caml_wrap_exception(_d7_);
        if(_d7_ === Empty_queue)return 0;
        throw _d7_}}
    var q_elem=[0,-1,_bS_,0],scan_stack_bottom=[0,[0,-1,q_elem],0];
         ...
         switch(tok[0])
          {case 3:
            var
             _d4_=1 - ty,
             _d5_=
              _d4_?(queue_elem[1] = state[13] + size | 0,state[1] = t,0):_d4_;
            return _d5_;
           case 1:
           case 2:
            var
    ...
    function default_pp_mark_open_tag(s){return _a_(_bV_,_a_(s,_bU_))}
    function default_pp_mark_close_tag(s){return _a_(_bX_,_a_(s,_bW_))}
    function default_pp_print_open_tag(_d1_){return 0}
    function default_pp_print_close_tag(_d0_){return 0}
    function make_formatter(output,flush)
     {function i(_dZ_){return 0}
      function h(_dY_){return 0}
      var pp_queue=[0,0,0],sys_tok=[0,-1,_bY_,0];
      ...
      var
       ...
       ppf=
        [0,
         ...
         pp_queue];
      ppf[19] = function(_dX_){return caml_call3(ppf[17],_bT_,0,1)};
      ppf[20]
      =
      function(n$1)
       {var n=n$1;
    ...
    function formatter_of_out_channel(oc)
     {function _dV_(param){return caml_ml_flush(oc)}
    ...
    function formatter_of_buffer(b)
     {function _dQ_(_dU_){return 0}
      return make_formatter
              (function(s,offset,len)
                {var _dR_=offset < 0?1:0;
                 if(_dR_)
                  var _dS_=_dR_;
                 else
                  var
       ...
       {if(1 < state[14])
        ...
        if(state[14] < state[15])
         ...
         if(state[14] === state[15])
          {var
            _dO_=state[16],
            size=caml_ml_string_length(_dO_),
            tok=[0,size,[0,_dO_],size];
    ...
    var
     Canceled=[248,_b0_,caml_fresh_oo_id(0)],
     compare=caml_compare,
     Int_map=_y_([0,compare]),
     current_data=[0,Int_map[1]];
    function repr_rec(t)
     {var _dM_=t[1];
      if(3 === _dM_[0])
       {var t$0=_dM_[1],t$1=repr_rec(t$0);
    ...
    function call_unsafe(f,x)
     {try
       {var _dL_=caml_call1(f,x);return _dL_}
      catch(exn)
    ...
    function wakeup(t$0,v)
     {var t=repr_rec(t$0),_dJ_=t[1];
      switch(_dJ_[0])
       {case 1:if(_dJ_[1] === Canceled)return 0;break;
        case 2:
         var sleeper=_dJ_[1],state=[0,v];
         t[1] = state;
         var
         ...
         for(;;)
          {if(0 === q[1]){wakening[1] = 0;current_data[1] = snapshot;return 0}
           var _dG_=q[2];
           if(_dG_)
            {var _dH_=_dG_[1],_dI_=_dG_[2];
             if(_dI_)
              {q[1] = q[1] - 1 | 0;q[2] = _dI_}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
     ...
     {if(typeof ws !== "number")
       switch(ws[0])
        {case 0:if(!ws[1][1])return 0;break;
         case 2:
          var l2=ws[2],l1=ws[1],_dF_=cleanup(l2);
          return append(cleanup(l1),_dF_)
         }
      return ws}
    function connect(t1,t2)
     {var t1$0=repr(t1),t2$0=repr(t2),_dA_=t1$0[1];
      if(2 === _dA_[0])
       {var sleeper1=_dA_[1];
         ...
         {var sleeper2=_dB_[1];
          ...
          var
           ...
           _dE_=
            typeof _dD_ === "number"
             ?_dC_
             :typeof _dC_ === "number"?_dD_:[2,_dD_,_dC_];
          sleeper1[4] = _dE_;
          return 0}
        t1$0[1] = _dB_;
        return unsafe_run_waiters(sleeper1,_dB_)}
      throw [0,Assert_failure,_b3_]}
    function fast_connect(t,state)
     {var t$0=repr(t),_dz_=t$0[1];
      if(2 === _dz_[0])
       {var sleeper=_dz_[1];
        t$0[1] = state;
    ...
    function add_immutable_waiter(sleeper,waiter$0)
     {var
       waiter$1=[1,waiter$0],
       _dy_=sleeper[2],
       waiter=typeof _dy_ === "number"?waiter$1:[2,waiter$1,_dy_];
      sleeper[2] = waiter;
      return 0}
    function bind(t,f)
     {var t$0=repr(t),_dv_=t$0[1];
      switch(_dv_[0])
       {case 0:var v=_dv_[1];return caml_call1(f,v);
        case 1:return [0,_dv_];
        case 2:
         var
          sleeper=_dv_[1],
           ...
           function(state)
            {switch(state[0])
              {case 0:
                ...
                current_data[1] = data;
                try
                 {var _dx_=caml_call1(f,v),_dw_=_dx_}
                catch(exn){exn = caml_wrap_exception(exn);var _dw_=fail(exn)}
                return connect(res,_dw_);
               case 1:return fast_connect(res,state);
               default:throw [0,Assert_failure,_b5_]}});
         return res;
        default:throw [0,Assert_failure,_b6_]}}
    var pause_hook=[0,function(_du_){return 0}],s1=create$1(0),_b9_=[0,0];
    function wakeup_paused(param)
     {if(s1[2] === s1){_b9_[1] = 0;return 0}
      var seq=create$1(0);
      seq[1][2] = s1[2];
      s1[2][1] = seq[1];
      seq[1] = s1[1];
    ...
    function test(x){return 1 - (x == jsoo_c64afb46?1:0)}
    var
     jsoo_824000b9=true,
     false$0=false,
    ...
    function unsafeCreateElementEx(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc$0,elt);
        var _dk_=createElementSyntax[1];
        if(785140586 === _dk_)
         {try
           {var
    ...
    function createInput(type,name,doc)
     {return unsafeCreateElementEx(type,name,doc,_cc_)}
    function createLabel(doc){return unsafeCreateElement(doc,_cd_)}
    function createDiv(doc){return unsafeCreateElement(doc,_ce_)}
    var
     Canvas_not_available=[248,_ci_,caml_fresh_oo_id(0)],
     ...
     {var match=task(0),w=match[2],t=match[1],d$0=d * 1e3;
      ...
      function loop(step,param)
       {if(2147483e3 < step)
        ...
        var cb=remain == 0?callback:function(_di_){return loop(remain,_di_)};
        id[1] = [0,window.setTimeout(caml_js_wrap_callback(cb),step$0)];
        return 0}
      loop(d$0,0);
      function f(param)
       {var _dh_=id[1];
        if(_dh_){var x=_dh_[1];id[1] = 0;return window.clearTimeout(x)}
        return 0}
      var _df_=repr(t)[1];
      switch(_df_[0])
       {case 1:var switch$0=_df_[1] === Canceled?(call_unsafe(f,0),1):0;break;
        case 2:
         var
          sleeper=_df_[1],
          handler=[0,current_data[1],f],
          _dg_=sleeper[4],
          handler$0=typeof _dg_ === "number"?handler:[2,handler,_dg_];
         sleeper[4] = handler$0;
         var switch$0=1;
         break;
        default:var switch$0=0}
    ...
    function toggle_button(txt1,txt2,action)
     {var
       ...
       jsoo_obj=createInput([0,button_type],0,doc);
      jsoo_obj.value = txt1$0;
      jsoo_obj.onclick
      =
      handler
       (function(param)
    ...
    function matrix_mul(m$0,m)
     {var
       m$1=matrix_transp(m),
       _dc_=matrix_vect_mul(m$1,m$0[3]),
       _dd_=matrix_vect_mul(m$1,m$0[2]);
      return [0,matrix_vect_mul(m$1,m$0[1]),_dd_,_dc_]}
    ...
    function rotate_object(m,o)
     {var _da_=o[2],_db_=o[1];
      return [0,map(function(v){return matrix_vect_mul(m,v)},_db_),_da_]}
    function tesselate_sphere(p_div,t_div)
     {var
      ...
      var _cY_=p_div - 1 | 0,_cX_=0;
      if(!(_cY_ < 0))
       {var i=_cX_;
        for(;;)
         {var _c0_=t_div - 1 | 0,_cZ_=0;
          if(!(_c0_ < 0))
           {var j=_cZ_;
            for(;;)
             {var
              ...
              if(0 === j)
               {var
                 _c3_=2 * k | 0,
                 _c2_=[0,north,k,caml_mod(k + t_div | 0,north)];
                caml_check_bound(faces,_c3_)[_c3_ + 1] = _c2_;
                var
                 _c5_=(2 * k | 0) + 1 | 0,
                 _c4_=
                  [0,
               ...
               {var
                 _c8_=2 * k | 0,
                 _c7_=[0,k,caml_mod(k + t_div | 0,north),k - 1 | 0];
                caml_check_bound(faces,_c8_)[_c8_ + 1] = _c7_;
                var
                 _c9_=caml_mod((k + t_div | 0) - 1 | 0,north),
                 _c$_=(2 * k | 0) + 1 | 0,
                 _c__=[0,k - 1 | 0,caml_mod(k + t_div | 0,north),_c9_];
                caml_check_bound(faces,_c$_)[_c$_ + 1] = _c__}
              var _c6_=j + 1 | 0;
              if(_c0_ !== j){var j=_c6_;continue}
              break}}
          var _c1_=i + 1 | 0;
    ...
    function create_canvas(w,h)
     {var c=unsafeCreateElement(doc,_cj_);
      if(test(c.getContext)){c.width = w;c.height = h;return c}
    ...
    function draw(jsoo_self,img,jsoo_b62335d6,o,uv,normals,face_info,dir)
     {var _cW_=o[2],_cU_=_cW_.length - 1 - 1 | 0,_cT_=0;
      if(!(_cU_ < 0))
       {var i=_cT_;
        for(;;)
         {var
          ...
          if(0 <= x1 * x2 + y1 * y2 + z1 * z2)
           {jsoo_self.beginPath();
            ...
            var
             ...
             e=dy2 * du3 - dy3 * du2,
             f=y1$0 - d * u1 - e * v1$0;
            jsoo_self.transform(a,d,b,e,c,f);
    ...
    function start(param$0)
     {function _cC_(texture)
       {var
         ...
         ctx=canvas.getContext(jsoo_d80b4786),
         h$0=h / 8 | 0,
         w$0=w / 8 | 0,
               ...
               {var i=_cP_;
                for(;;)
                 {var
                  ...
                  data[k$0 + 3 | 0] = c$1;
                  var _cS_=i + 1 | 0;
                  if(_cQ_ !== i){var i=_cS_;continue}
                  break}}
              var _cR_=j + 1 | 0;
              if(_cO_ !== j){var j=_cR_;continue}
              break}}
        ...
        var
         ctx$1=canvas$0.getContext(jsoo_d80b4786),
         ctx$2=canvas$1.getContext(jsoo_d80b4786),
         tw=texture.width,
         th=texture.height,
         _cD_=o[1],
         uv=
        ...
        function br(param){return unsafeCreateElement(doc,_cg_)}
        add(form,toggle_button(_cq_,_cp_,function(p){paused[1] = p;return 0}));
        add(form,br(0));
        add(form,toggle_button(_cs_,_cr_,function(f){follow[1] = f;return 0}));
        add(form,br(0));
        var jsoo_obj=createInput([0,button_type],0,doc);
        jsoo_obj.value = "Reset orientation";
        jsoo_obj.onclick
        =
        handler
         (function(param)
        ...
        for(;;)
         {if(param$0)
          ...
          add(form$0,checkbox(_ct_,1,function(l){lighting[1] = l;return 0}));
          add(form$0,br(0));
          add(form$0,checkbox(_cu_,1,function(l){clipped[1] = l;return 0}));
          add(form$0,br(0));
          add(form$0,doc.createTextNode("Frames per second: "));
          add(form$0,rateText);
          add(ctrl,form$0);
          add(doc.body,ctrl);
          var p=unsafeCreateElement(doc,_cf_);
          p.innerHTML
          =
               ...
               (doc,
                ...
                handler
                 (function(param)
                   {f(c1);
                    var _cK_=c2[1];
                    if(_cK_ != jsoo_c64afb46)f(_cK_);
                    return jsoo_824000b9}),
                jsoo_824000b9);
              return false$0});
          var
           ti=[0,new jsoo_0d6e75e4().getTime()],
           fps=[0,0],
           loop=
            function(t,phi)
             {var rotation=xz_rotation(phi - phi_rot[1]);
              ...
              var
               _cG_=matrix_mul(m_obliq[1],rotation),
               m$0=matrix_mul(m[1],_cG_),
              ...
              try {ctx$1.getImageData(0,0,1,1)}catch(_cJ_){}
              var
              ...
              fps[1] = hz$0;
              var _cH_=fps[1];
              rateText.data = caml_call1(sprintf(_cv_),_cH_).toString();
              ti[1] = t$0;
              function _cI_(param)
               {var
                 t$0=new jsoo_0d6e75e4().getTime(),
      ...
      var v$0=unsafeCreateElement(doc,_ch_);
      function _cB_(param){return [0,[0,v$0]]}
      var match=task(0),w=match[2],t=match[1];
      v$0.onload = handler(function(param){wakeup(w,0);return false$0});
      v$0.src = jsoo_arg;
      var t$0=bind(bind(t,_cB_),_cC_),_cA_=repr(t$0)[1];
      switch(_cA_[0])
       {case 0:break;
        case 1:var e=_cA_[1];throw e;
        case 2:
         var sleeper=_cA_[1];
         add_immutable_waiter
          (sleeper,
