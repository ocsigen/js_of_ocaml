...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _b9_=[0,caml_new_string("wikicreole.mll"),207,32],
     _b__=[0,caml_new_string("wikicreole.mll"),216,6],
     _b$_=[0,caml_new_string("wikicreole.mll"),231,6],
     _cb_=[0,caml_new_string("wikicreole.mll"),285,6],
     _cc_=caml_new_string("*"),
     _ca_=[5,0],
     _b8_=[0,caml_new_string("wikicreole.mll"),158,6],
     ...
     _cD_=[0,caml_new_string("main.ml"),33,17],
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_f7_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_f8_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_f9_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_f__,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_f$_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_ga_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_gb_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_gc_,rest2$6)];
          ...
          break;
         case 8:
          var _gd_=ty1[2],_ge_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_gf_=trans(_gd_,rest2$7);
              return [8,trans(_ge_,ty2),_gf_];
          ...
          break;
         case 9:
          var _gg_=ty1[3],_gh_=ty1[2],_gi_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_gj_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_gk_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_gl_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_gm_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_gn_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _f6_=match[2];
        if(typeof _f6_ !== "number" && 2 === _f6_[0])
         {var rest$0=_f6_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          var
           fmt_rest$1=fmt[2],
           pad=fmt[1],
           _fE_=type_padding(pad,fmtty),
           _fF_=_fE_[2],
           _fG_=_fE_[1];
          if(typeof _fF_ !== "number" && 1 === _fF_[0])
           {var
             fmtty_rest$1=_fF_[1],
             match$1=type_format_gen(fmt_rest$1,fmtty_rest$1),
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_fG_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _fH_=type_padding(pad$0,fmtty),
           _fI_=_fH_[2],
           _fJ_=_fH_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _fK_=type_padprec(pad$1,prec,fmtty),
           _fL_=_fK_[3],
           _fM_=_fK_[2],
           _fN_=_fK_[1];
          if(typeof _fL_ !== "number" && 2 === _fL_[0])
           {var
             fmtty_rest$3=_fL_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_fN_,_fM_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _fO_=type_padprec(pad$2,prec$0,fmtty),
           _fP_=_fO_[3],
           _fQ_=_fO_[2],
           _fR_=_fO_[1];
          if(typeof _fP_ !== "number" && 3 === _fP_[0])
           {var
             ...
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_fR_,_fQ_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _fS_=type_padprec(pad$3,prec$1,fmtty),
           _fT_=_fS_[3],
           _fU_=_fS_[2],
           _fV_=_fS_[1];
          if(typeof _fT_ !== "number" && 4 === _fT_[0])
           {var
             ...
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_fV_,_fU_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _fW_=type_padprec(pad$4,prec$2,fmtty),
           _fX_=_fW_[3],
           _fY_=_fW_[2],
           _fZ_=_fW_[1];
          if(typeof _fX_ !== "number" && 5 === _fX_[0])
           {var
             fmtty_rest$6=_fX_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_fZ_,_fY_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _f0_=type_padprec(pad$5,prec$3,fmtty),
           _f1_=_f0_[3],
           _f2_=_f0_[2],
           _f3_=_f0_[1];
          if(typeof _f1_ !== "number" && 6 === _f1_[0])
           {var
             fmtty_rest$7=_f1_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_f3_,_f2_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _f4_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_f4_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 8:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _f5_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_f5_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_f5_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _fC_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_fC_))
             throw Type_mismatch;
            var _fD_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_fD_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _fB_=2 === padty$0?48:32,res=make(width$0,_fB_);
      switch(padty$0)
      ...
      for(;;)
       {if(caml_ml_string_length(str) <= i$1)
         ...
         {var match$0=caml_string_unsafe_get(str,i$1);
          if(32 <= match$0)
           {var _fz_=match$0 - 34 | 0;
            if(58 < _fz_ >>> 0)
             if(93 <= _fz_)var switch$0=0,switch$1=0;else var switch$1=1;
            else
             if(56 < (_fz_ - 1 | 0) >>> 0)
              var switch$0=1,switch$1=0;
             else
            ...
            for(;;)
             {var match=caml_string_unsafe_get(str,i$0);
              if(32 <= match)
               {var _fw_=match - 34 | 0;
                if(58 < _fw_ >>> 0)
                 if(93 <= _fw_)var switch$2=0,switch$3=0;else var switch$3=1;
                else
                 if(56 < (_fw_ - 1 | 0) >>> 0)
                  var switch$2=1,switch$3=0;
                 else
                  var switch$3=1;
                if(switch$3)var _fx_=1,switch$2=2}
              else
               var switch$2=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$2)
               {case 0:var _fx_=4;break;case 1:var _fx_=2;break}
              n[1] = n[1] + _fx_ | 0;
              var _fy_=i$0 + 1 | 0;
    ...
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _fp_=_aG_;break;
        case 1:var _fp_=_aH_;break;
        case 2:var _fp_=_aI_;break;
        case 3:var _fp_=_aJ_;break;
        case 4:var _fp_=_aK_;break;
        case 5:var _fp_=_aL_;break;
        case 6:var _fp_=_aM_;break;
        case 7:var _fp_=_aN_;break;
        case 8:var _fp_=_aO_;break;
        case 9:var _fp_=_aP_;break;
        case 10:var _fp_=_aQ_;break;
        case 11:var _fp_=_aR_;break;
        default:var _fp_=_aS_}
    ...
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _fo_=_aT_;break;
        ...
        case 7:var _fo_=_a0_;break;
        case 8:var _fo_=_a1_;break;
        case 9:var _fo_=_a2_;break;
        case 10:var _fo_=_a3_;break;
        case 11:var _fo_=_a4_;break;
        default:var _fo_=_a5_}
      return caml_format_int(_fo_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _fn_=_at_;break;
        case 1:var _fn_=_au_;break;
        case 2:var _fn_=_av_;break;
        case 3:var _fn_=_aw_;break;
        case 4:var _fn_=_ax_;break;
        case 5:var _fn_=_ay_;break;
        case 6:var _fn_=_az_;break;
        case 7:var _fn_=_aA_;break;
        case 8:var _fn_=_aB_;break;
        case 9:var _fn_=_aC_;break;
        case 10:var _fn_=_aD_;break;
        case 11:var _fn_=_aE_;break;
        default:var _fn_=_aF_}
      return caml_int64_format(_fn_,n)}
       ...
       {if(17 <= fconv)
        ...
        if(19 <= fconv)
         {var l=caml_ml_string_length(s);
          if(0 === l)return s;
          var r=caml_create_string(l),_fh_=l - 1 | 0,_fg_=0;
          if(!(_fh_ < 0))
           {var i=_fg_;
            for(;;)
             {var c=caml_string_unsafe_get(s,i);
              if(97 <= c)
               if(122 < c)var switch$1=0;else var _fi_=c - 32 | 0,switch$1=1;
              else
               var switch$1=0;
              if(!switch$1)var _fi_=c;
              caml_string_unsafe_set(r,i,_fi_);
              var _fj_=i + 1 | 0;
       ...
       {if(0 === pad[0])
         {var _fd_=pad[2],_fe_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_fe_,_fd_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_fe_,_fd_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_fe_,_fd_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _ff_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_ff_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_ff_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_ff_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _e__=pad$5[2],_e$_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_e$_,_e__,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_e$_,_e__,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_e$_,_e__,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _fa_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
          ...
          case 9:
           ...
           return function(b)
            {var _fc_=b?_b_:_c_;
             return make_printf(k$0,o,[4,acc$0,_fc_],rest$8)};
          case 10:
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_e9_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_e9_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _e6_=[8,acc,_bf_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_e6_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_e6_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_e5_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_e5_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_e0_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_e0_,fmt)}
    ...
    function fields(x)
     {var n=x.length - 1;
      if(2 < n >>> 0)
       {var _eV_=other_fields(x,2),_eW_=field(x,1);
        return caml_call2(sprintf(_bp_),_eW_,_eV_)}
      switch(n)
       {case 0:return _bq_;
        case 1:return _br_;
        default:var _eX_=field(x,1);return caml_call1(sprintf(_bs_),_eX_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _eT_=caml_call1(hd,x),_eS_=_eT_}catch(_eU_){var _eS_=0}
            if(_eS_){var s=_eS_[1];return s}
            var param$0=tl;
            continue}
     ...
     {try
       {var
         _eP_=
          [0,
           map$0
            (function(_eR_){return caml_convert_raw_backtrace_slot(_eR_)},
             rbckt)];
        return _eP_}
      catch(_eQ_)
    ...
    function print_backtrace(outchan)
     {var
      ...
      if(backtrace)
       {var a=backtrace[1],_eN_=a.length - 1 - 1 | 0,_eM_=0;
        if(!(_eN_ < 0))
         {var i=_eM_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call5
                 (sprintf(_bC_),_eK_,filename,lineno,startchar,endchar)];
            else
             if(0 === slot[1])
              var _eL_=info(0),match=[0,caml_call1(sprintf(_bD_),_eL_)];
             else
              var match=0;
    ...
    function add_queue(x,q)
     {var c=[0,[0,x,0]],_eJ_=q[1];
      if(_eJ_){var cell=_eJ_[1];q[1] = c;cell[2] = c;return 0}
      q[1] = c;
      q[2] = c;
      return 0}
    ...
    function take_queue(q)
     {var _eI_=q[2];
      if(_eI_)
       {var match=_eI_[1],x=match[1],tl=match[2];
        q[2] = tl;
        if(0 === tl)q[1] = 0;
        return x}
      throw Empty_queue}
    ...
    function break_new_line(state,offset,width)
     {pp_output_newline(state);
      ...
      var
       ...
       _eH_=state[8],
       real_indent=caml_lessequal(_eH_,y)?_eH_:y;
     ...
     {if(typeof param === "number")
       switch(param)
        {case 0:
         ...
         case 1:
          var _eu_=state[2];
          if(_eu_){var ls=_eu_[2];state[2] = ls;return 0}
          return 0;
         case 2:
          var _ev_=state[3];
          if(_ev_){var ls$0=_ev_[2];state[3] = ls$0;return 0}
          return 0;
         case 3:
          var _ew_=state[2];
          if(_ew_)
           {var match$0=_ew_[1],width=match$0[2];
            return break_line(state,width)}
          return pp_output_newline(state);
         case 4:
          var _ex_=state[10] !== (state[6] - state[9] | 0)?1:0;
          return _ex_?pp_skip_token(state):_ex_;
         default:
          var _ey_=state[5];
          if(_ey_)
           {var
       ...
       switch(param[0])
        {case 0:
          ...
          return 0;
         case 1:
          var off=param[2],n=param[1],_ez_=state[2];
          if(_ez_)
           {var match$1=_ez_[1],width$0=match$1[2],ty=match$1[1];
            switch(ty)
          ...
          if(_eA_)
           {var
            ...
            if(_eB_)
             {var x=_eB_[1];
              try
               {var _eC_=find(insertion_point,tabs$0[1]),x$0=_eC_}
              catch(_eD_)
       ...
       {var _ep_=state[27][2];
        if(_ep_)
         {var
           ...
           tok=x[2],
           _eq_=size < 0?1:0,
           _er_=_eq_?(state[13] - state[12] | 0) < state[9]?1:0:_eq_,
           _es_=1 - _er_;
          if(_es_)
           {take_queue(state[27]);
    ...
    function advance_left(state)
     {try
       {var _en_=advance_loop(state);return _en_}
      catch(_eo_)
       {_eo_ = caml_wrap_exception(_eo_);
        if(_eo_ === Empty_queue)return 0;
        throw _eo_}}
         ...
         switch(tok[0])
          {case 3:
            var
             _el_=1 - ty,
             _em_=
              _el_?(queue_elem[1] = state[13] + size | 0,state[1] = t,0):_el_;
            return _em_;
           case 1:
           case 2:
            var
    ...
    function default_pp_print_open_tag(_ei_){return 0}
    function default_pp_print_close_tag(_eh_){return 0}
    function make_formatter(output,flush)
     {function i(_eg_){return 0}
      function h(_ef_){return 0}
      ...
      var
       ...
       ppf=
        [0,
         ...
         pp_queue];
      ppf[19] = function(_ee_){return caml_call3(ppf[17],_bI_,0,1)};
      ppf[20]
      =
      function(n$1)
       {var n=n$1;
    ...
    function formatter_of_out_channel(oc)
     {function _ec_(param){return caml_ml_flush(oc)}
    ...
    function _bP_(_eb_){return 0}
    make_formatter
     (function(s,offset,len)
       {var _d__=offset < 0?1:0;
        if(_d__)
         var _d$_=_d__;
        else
         var
          _ea_=len < 0?1:0,
          _d$_=_ea_ || (caml_ml_string_length(s) < (offset + len | 0)?1:0);
        if(_d$_)invalid_arg(_r_);
       ...
       {if(1 < state[14])
        ...
        if(state[14] < state[15])
         ...
         if(state[14] === state[15])
          {var
            _d9_=state[16],
            size=caml_ml_string_length(_d9_),
            tok=[0,size,[0,_d9_],size];
    ...
    function repr_rec(t)
     {var _d7_=t[1];
      if(3 === _d7_[0])
       {var t$0=_d7_[1],t$1=repr_rec(t$0);
    ...
    function call_unsafe(f,x)
     {try
       {var _d6_=caml_call1(f,x);return _d6_}
      catch(exn)
    ...
    function wakeup(t$0,v)
     {var t=repr_rec(t$0),_d4_=t[1];
      switch(_d4_[0])
       {case 1:if(_d4_[1] === Canceled)return 0;break;
        case 2:
         var sleeper=_d4_[1],state=[0,v];
         t[1] = state;
         var
         ...
         for(;;)
          {if(0 === to_wakeup[1])
           ...
           var _d1_=to_wakeup[2];
           if(_d1_)
            {var _d2_=_d1_[1],_d3_=_d1_[2];
             if(_d3_)
              {to_wakeup[1] = to_wakeup[1] - 1 | 0;to_wakeup[2] = _d3_}
             else
              {to_wakeup[1] = 0;to_wakeup[2] = 0;to_wakeup[3] = 0}
             unsafe_run_waiters(_d2_[1],_d2_[2]);
             continue}
           throw Empty}
        }
     ...
     {if(typeof ws !== "number")
       switch(ws[0])
        {case 0:if(!ws[1][1])return 0;break;
         case 2:
          var l2=ws[2],l1=ws[1],_d0_=cleanup(l2);
          return append$0(cleanup(l1),_d0_)
         }
      return ws}
    function connect(t1,t2)
     {var t1$0=repr(t1),t2$0=repr(t2),_dV_=t1$0[1];
      if(2 === _dV_[0])
       {var sleeper1=_dV_[1];
         ...
         {var sleeper2=_dW_[1];
          ...
          var
           ...
           _dZ_=
            typeof _dY_ === "number"
             ?_dX_
             :typeof _dX_ === "number"?_dY_:[2,_dY_,_dX_];
          sleeper1[4] = _dZ_;
          return 0}
        t1$0[1] = _dW_;
        return unsafe_run_waiters(sleeper1,_dW_)}
      throw [0,Assert_failure,_bT_]}
    function fast_connect(t,state)
     {var t$0=repr(t),_dU_=t$0[1];
      if(2 === _dU_[0])
       {var sleeper=_dU_[1];
        t$0[1] = state;
    ...
    function bind(t,f)
     {var t$0=repr(t),_dR_=t$0[1];
      switch(_dR_[0])
       {case 0:var v=_dR_[1];return caml_call1(f,v);
        case 1:return [0,_dR_];
        case 2:
         var
          sleeper=_dR_[1],
           ...
           function(state)
            {switch(state[0])
              {case 0:
                ...
                current_data[1] = data;
                try
                 {var _dT_=caml_call1(f,v),_dS_=_dT_}
                catch(exn){exn = caml_wrap_exception(exn);var _dS_=fail(exn)}
                return connect(res,_dS_);
               case 1:return fast_connect(res,state);
               default:throw [0,Assert_failure,_bV_]}},
          waiter$0=[1,waiter$1],
          _dQ_=sleeper[2],
          waiter=typeof _dQ_ === "number"?waiter$0:[2,waiter$0,_dQ_];
         sleeper[2] = waiter;
         return res;
        default:throw [0,Assert_failure,_bW_]}}
    var pause_hook=[0,function(_dP_){return 0}],s1=create$0(0),_bX_=[0,0];
    ...
    function unsafeCreateElementEx(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc$0,elt);
        var _dI_=createElementSyntax[1];
        if(785140586 === _dI_)
         {try
           {var
             el=doc.createElement('<input name="x">'),
             _dL_=el.tagName.toLowerCase() === "input"?1:0,
             _dM_=_dL_?el.name === "x"?1:0:_dL_,
             _dJ_=_dM_}
          catch(_dN_){var _dJ_=0}
          var _dK_=_dJ_?982028505:-1003883683;
          createElementSyntax[1] = _dK_;
          continue}
        if(982028505 <= _dI_)
    ...
    function sleep(d)
     {var t=[0,[2,[0,1,0,0,0]]],d$0=d * 1e3;
      ...
      var _dD_=repr(t)[1];
      switch(_dD_[0])
       {case 1:var switch$0=_dD_[1] === Canceled?(call_unsafe(f,0),1):0;break;
        case 2:
         var
          sleeper=_dD_[1],
          handler=[0,current_data[1],f],
          _dE_=sleeper[4],
          handler$0=typeof _dE_ === "number"?handler:[2,handler,_dE_];
         sleeper[4] = handler$0;
         var switch$0=1;
         break;
        default:var switch$0=0}
         ...
         switch(_dg_[0])
          {case 0:
           ...
           case 3:
            ...
            continue;
           case 4:
            var stack$2=_dg_[3],lst=_dg_[2],kind=_dg_[1];
            if(lev < c[6])
             {c[6] = c[6] - 1 | 0;
              var
            ...
            return 0;
           case 5:
            var rows=_dg_[1],_dm_=c[11],_dn_=rev(rows);
    ...
    function start_table_row(c,heading)
     {if(!close_row(c)){end_paragraph(c,0);c[12] = _ca_}
          ...
          switch(ocaml_lex_state$0)
           {case 0:end_paragraph(c,0);continue a;
            ...
            case 3:
             ...
             if(!start_list_item(c,1,lev$0))push_chars(c,lexbuf);
             if(counter < 50)
              {var counter$2=counter + 1 | 0;
         ...
         {var
          ...
          switch(ocaml_lex_state$0)
           {case 0:
            ...
            case 13:
             if(!close_row(c))push_chars(c,lexbuf);
             if(counter < 50)
              {var counter$2=counter + 1 | 0;
    ...
    function replace_child(p,n)
     {var c=p.firstChild;
      if(c != no_handler)p.removeChild(c);
