...
(function
   ...
   {"use strict";
              ...
              if(32 <= match)
               {var _gg_=match - 34 | 0,switch$2=0;
                if(58 < _gg_ >>> 0)
                 ...
                 if(56 < (_gg_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _f6_=_at_;break;
        case 2:var _f6_=_au_;break;
        case 4:var _f6_=_aw_;break;
        case 5:var _f6_=_ax_;break;
        case 6:var _f6_=_ay_;break;
        case 7:var _f6_=_az_;break;
        case 8:var _f6_=_aA_;break;
        case 9:var _f6_=_aB_;break;
        case 10:var _f6_=_aC_;break;
        case 11:var _f6_=_aD_;break;
        case 0:
        case 13:var _f6_=_as_;break;
        case 3:
        case 14:var _f6_=_av_;break;
        default:var _f6_=_aE_}
      return transform_int_alt(iconv,caml_format_int(_f6_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _f5_=_aT_;break;
        case 2:var _f5_=_aU_;break;
        case 4:var _f5_=_aW_;break;
        case 5:var _f5_=_aX_;break;
        case 6:var _f5_=_aY_;break;
        case 7:var _f5_=_aZ_;break;
        case 8:var _f5_=_a0_;break;
        case 9:var _f5_=_a1_;break;
        case 10:var _f5_=_a2_;break;
        case 11:var _f5_=_a3_;break;
        case 0:
        case 13:var _f5_=_aS_;break;
        case 3:
        case 14:var _f5_=_aV_;break;
        default:var _f5_=_a4_}
      return transform_int_alt(iconv,caml_format_int(_f5_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _f4_=_a6_;break;
        case 2:var _f4_=_a7_;break;
        case 4:var _f4_=_a9_;break;
        case 5:var _f4_=_a__;break;
        case 6:var _f4_=_a$_;break;
        case 7:var _f4_=_ba_;break;
        case 8:var _f4_=_bb_;break;
        case 9:var _f4_=_bc_;break;
        case 10:var _f4_=_bd_;break;
        case 11:var _f4_=_be_;break;
        case 0:
        case 13:var _f4_=_a5_;break;
        case 3:
        case 14:var _f4_=_a8_;break;
        default:var _f4_=_bf_}
      return transform_int_alt(iconv,caml_format_int(_f4_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _f3_=_aG_;break;
        case 2:var _f3_=_aH_;break;
        case 4:var _f3_=_aJ_;break;
        case 5:var _f3_=_aK_;break;
        case 6:var _f3_=_aL_;break;
        case 7:var _f3_=_aM_;break;
        case 8:var _f3_=_aN_;break;
        case 9:var _f3_=_aO_;break;
        case 10:var _f3_=_aP_;break;
        case 11:var _f3_=_aQ_;break;
        case 0:
        case 13:var _f3_=_aF_;break;
        case 3:
        case 14:var _f3_=_aI_;break;
        default:var _f3_=_aR_}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
             ...
             var _f1_=1}
           var _f2_=_f1_?str:cat(str,_bg_);
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _by_;
      ...
      return caml_call2(sprintf(_bz_),_fD_,_fC_)}
       ...
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          ...
          _fy_=field(e,1),
          _fA_=caml_call2(sprintf(_bA_),_fy_,_fx_);
        else
         switch(match)
          {case 0:var _fA_=_bB_;break;
           case 1:var _fA_=_bC_;break;
           default:var _fz_=field(e,1),_fA_=caml_call1(sprintf(_bD_),_fz_)}
        return cat(constructor,_fA_)}
      return e[1]}
    function print_raw_backtrace(outchan,raw_backtrace)
     {var a=caml_convert_raw_backtrace(raw_backtrace),backtrace=[0,a];
      if(backtrace)
       {var _fv_=a.length - 1 - 1 | 0,_fu_=0;
        if(! (_fv_ < 0))
         {var i=_fu_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _fn_=slot[4],
              _fo_=slot[3],
              _fp_=slot[6]?_bN_:_bP_,
              _fq_=slot[2],
              _fr_=slot[7],
              _fs_=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bO_),_fs_,_fr_,_fq_,_fp_,_fo_,_fn_,_fm_)];
            else
             if(slot[1])
              var match=0;
             else
              var _ft_=info(0),match=[0,caml_call1(sprintf(_bQ_),_ft_)];
      ...
      for(;;)
       {if(param)
        ...
        var
         headers$0=
          function(s)
           {function _d5_(v){return [0,caml_string_of_jsstring(v)]}
            var t35=caml_jsbytes_of_string(s);
            function _d6_(param){return 0}
            return case$0(t59.getResponseHeader(t35),_d6_,_d5_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
           {if(382334108 === st[1])
                  ...
                  _d0_=
                   function(param)
                    {var x=t59.responseXML;
                     function _d4_(x){return [0,x]}
                     var match=case$0(x,function(param){return 0},_d4_);
                     if(match)
                      {var doc=match[1];
                       return doc.documentElement === t58?0:[0,doc]}
                     return 0},
                  _d1_=function(x){return caml_string_of_jsstring(x)},
                  _d2_=function(param){return _cC_},
                  response=
                   [0,
                    url,
                    code,
                    headers$0,
                    case$0(t59.responseText,_d2_,_d1_),
                    _d0_];
        ...
        handler
         (function(param)
           {var page=doc.documentElement;
            ...
            var started=[0,0],p=unsafeCreateElement(doc,_ca_);
            ...
            function callback(_dN_){return wakeup(w,_dN_)}
            var id=[0,0];
            function loop(step,param)
             {if(2147483000. < step)
              ...
              var
               cb=
                remain == 0.?callback:function(_dM_){return loop(remain,_dM_)},
            ...
            on_cancel
             (t,
              function(param)
               {var _dL_=id[1];
                if(_dL_){var x=_dL_[1];id[1] = 0;return t2.clearTimeout(x)}
                return 0});
            symbol_bind(t,_dc_);
            function _dd_(s)
             {var
                            ...
                            caml_js_wrap_callback
                             (function(param)
                               {redraw_queued[1] = 0;
                                   ...
                                   {var
                                    ...
                                    if(1 - _dB_)
                                     {var
                                       ...
                                       _dI_=0 !== dx?1:0,
                                       _dJ_=_dI_ || (0 !== dy?1:0);
                                      if(_dJ_)put_pixmap(p,dx,dy,0,0,r$1[3],r$1[4],p);
                                      var
                                       offset=
                                        function(p,l,d,m)
                                         {return 0 < ((p + d | 0) + l | 0)
                                ...
                                var
                                 r$0=pm[4],
                                 _dG_=r$0[3] < (width$1 | 0)?1:0,
                                 _dE_=_dG_ || (r$0[4] < (height$1 | 0)?1:0);
                                if(_dE_)
                                 {_cF_(st,scale,x0$1,y0$1,0,0,width$1,height$1);
                                  pm[4] = [0,x0$1,y0$1,width$1,height$1]}
                                var _dF_=get_pixmap(pm);
                                return put_pixmap
                                        (get_drawable(window),x$0,y$0,x$0,y$0,width$1,height$1,_dF_)})))
                        :_dz_}
              var
               a=allocation(0),
              ...
              function set_slider_position(pos$0)
               {var _dr_=pos$0 !== pos[1]?1:0;
                if(_dr_)
                 {var _ds_=points(pos$0);
                  thumb.style.top = _ds_;
                  pos[1] = pos$0;
                  caml_call2
               ...
               (window,
                function(dx,dy)
                 {var scale=get_scale(0);
                  function offset(a,d)
                   {var
                     _dp_=caml_call1(caml_get_public_method(a,307110897,425),a),
                     _dq_=
