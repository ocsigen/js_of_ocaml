...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      if(_fN_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fN_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _fL_ = l - 1 | 0, _fK_ = 1;
    if(_fL_ >= 1){
     var i = _fK_;
     for(;;){
   ...
   function take(q){
    var _fJ_ = q[2];
    if(! _fJ_) throw caml_maybe_attach_backtrace(Empty, 1);
    var content = _fJ_[1];
    if(_fJ_[2]){
     var next = _fJ_[2];
     q[1] = q[1] - 1 | 0;
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _fH_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _fH_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _fF_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _fF_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fG_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fG_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fG_[1];
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _fi_ = _fh_ ? str : symbol(str, _a8_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _e$_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _e$_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _e8_ = [8, acc, _bf_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _e8_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _e8_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _e7_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _e7_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _e7_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _e6_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _e6_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _e4_ = other_fields(x, i + 1 | 0), _e5_ = field(x, i);
    return caml_call2(sprintf(_bo_), _e5_, _e4_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_e3_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _eZ_ = other_fields(e, 2),
       _e0_ = field(e, 1),
       _e2_ = caml_call2(sprintf(_bp_), _e0_, _eZ_);
     else
      switch(match){
        case 0:
         var _e2_ = _bq_; break;
        case 1:
         var _e2_ = _br_; break;
        default:
         var _e1_ = field(e, 1), _e2_ = caml_call1(sprintf(_bs_), _e1_);
      }
     var match$0 = [0, constructor, [0, _e2_]];
    }
    else
     var match$0 = [0, e[1], 0];
    ...
    if(_eX_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _by_ : _bz_ : 0 === pos$0 ? _bA_ : _bB_;
      }
      if(0 === slot[0])
       var
        _eO_ = slot[5],
        _eP_ = slot[4],
        _eQ_ = slot[3],
        _eR_ = slot[6] ? _bC_ : _bE_,
        _eS_ = slot[2],
        _eT_ = slot[7],
        _eU_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bD_), _eU_, _eT_, _eS_, _eR_, _eQ_, _eP_, _eO_)];
      else if(slot[1])
       var match = 0;
      else
       var _eV_ = info(0), match = [0, caml_call1(sprintf(_bF_), _eV_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _eC_ = to_string(exn$0);
       caml_call1(eprintf(_bI_), _eC_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _eD_ = abs(status);
        prerr_endline(caml_check_bound(errors, _eD_)[1 + _eD_]);
       }
       var _eE_ = caml_ml_flush(stderr), _eI_ = _eE_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _eG_ = to_string(exn$0);
       caml_call1(eprintf(_bK_), _eG_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eH_ = to_string(exn);
       caml_call1(eprintf(_bL_), _eH_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _eI_ = caml_ml_flush(stderr);
      }
      var _eJ_ = _eI_;
     }
     catch(_eL_){
      var _eF_ = caml_wrap_exception(_eL_);
      if(_eF_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_eF_, 0);
      var _eJ_ = prerr_endline(_bJ_);
     }
     return _eJ_;
    }
    catch(_eK_){return 0;}
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _eA_){return 0;},
     t41 = function(param, _ez_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b2_ = caml_wrap_exception(_ey_);
     ...
     a:
     {
      ...
      if(0 <= ofs && lim >= ofs){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _ew_ = i; break a;}
        var i$0 = i + 1 | 0, i = i$0;
       }
      }
      var _ew_ = invalid_arg(_o_);
     }
     var j = _ew_;
    }
    catch(_ex_){
     var _ev_ = caml_wrap_exception(_ex_);
         ...
         function(s){
          function _et_(param){
           var
            y = param[2],
            x = param[1],
            _eu_ = urldecode_js_string_string(y);
           return [0, urldecode_js_string_string(x), _eu_];
          }
          var index = s.indexOf(caml_jsstring_of_string(make$0(1, 61)));
          if(0 <= index)
           var
            _er_ = s.slice(index + 1 | 0),
            _es_ = [0, s.slice(0, index), _er_];
          else
           var _es_ = undefined$0;
          return case$1(_es_, interrupt, _et_);
         };
      aux$0([0, case$1(arr[idx$0], interrupt, _ep_), acc], _eo_);
      return;
     }
     catch(_eq_){
      var _en_ = caml_wrap_exception(_eq_);
      if(_en_ !== Local_exn) throw caml_maybe_attach_backtrace(_en_, 0);
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _em_ = caml_call1(f, v); return _em_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _el_ = result[1] === Canceled ? 1 : 0, is_canceled = _el_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _ek_ = p[1];
    switch(_ek_[0]){
      case 1:
       return _ek_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _ej_ = caml_call1(f, v), p$0 = _ej_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   function symbol$0(p$1, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _ei_ = [0, caml_call1(f, v)], p_result$0 = _ei_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
       if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_ce_,
                function(param){
                 try{var _eh_ = [0, caml_call1(f, v)], _eg_ = _eh_;}
                 catch(exn$0){
                  var exn = caml_wrap_exception(exn$0);
                  if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
                  var _eg_ = [1, exn];
   ...
   function check_error(gl){
    var _ee_ = gl.NO_ERROR, _ef_ = caml_notequal(gl.getError(), _ee_);
    return _ef_ ? error(_cr_) : _ef_;
   }
   function load_shader(t15, shader, text){
    t15.shaderSource(shader, text);
    t15.compileShader(shader);
    var _ec_ = 1 - (t15.getShaderParameter(shader, t15.COMPILE_STATUS) | 0);
    if(! _ec_) return _ec_;
    var _ed_ = caml_string_of_jsstring(t15.getShaderInfoLog(shader));
    return caml_call2(error(_ct_), caml_string_of_jsstring(text), _ed_);
   }
   function get_source(src_id){
    function _eb_(param){return caml_call1(error(_cv_), src_id);}
    var
     script$0 =
       get
        (bind
   ...
   function mult(m1, m2){
    function v(p){
     var
      j = p % 4 | 0,
      i = p / 4 | 0,
      _d3_ = caml_array_get(m2, c$0(3, j)),
      _d4_ = caml_array_get(m1, c$0(i, 3)) * _d3_,
      _d5_ = caml_array_get(m2, c$0(2, j)),
      _d6_ = caml_array_get(m1, c$0(i, 2)) * _d5_,
      _d7_ = caml_array_get(m2, c$0(1, j)),
      _d8_ = caml_array_get(m1, c$0(i, 1)) * _d7_,
      _d9_ = caml_array_get(m2, c$0(0, j));
     return caml_array_get(m1, c$0(i, 0)) * _d9_ + _d8_ + _d6_ + _d4_;
    }
    return init(16, v);
   }
   ...
   function read_coord_couple(c){
    ...
    var
     res = match[1],
     match$0 = map(function(_d2_){return matched_group(res, _d2_);}, _cy_);
    if(match$0){
     var _dY_ = match$0[1];
     if(_dY_){
      var _dZ_ = match$0[2];
      if(_dZ_){
       var _d0_ = _dZ_[1];
       if(_d0_ && ! _dZ_[2]){
        var vn = _d0_[1], v = _dY_[1], _d1_ = caml_int_of_string(vn);
        return [0, [0, caml_int_of_string(v), _d1_]];
       }
      }
     }
    }
   ...
   function concat(a){
    var r = [0, 0], _dV_ = a.length - 1 - 1 | 0, _dU_ = 0;
    if(_dV_ >= 0){
     var i = _dU_;
     for(;;){
    ...
    function next(param){
     for(;;){
      ...
      pos[1]++;
      var _dX_ = pos[1];
      l$1[1] = caml_check_bound(a, _dX_)[1 + _dX_];
     }
    }
   ...
   function start(param){
    ...
    debug(_cB_);
    function _dM_(param){return caml_call1(error(_cs_), canvas_id);}
    var
     canvas$0 = get(bind(document.getElementById(cst_canvas), canvas), _dM_);
    function _dN_(param){
     return ksprintf
             (function(s){
    ...
    try{
     var
      ...
      _dP_ = test(ctx) ? ctx : canvas$0.getContext("experimental-webgl"),
      _dO_ = _dP_;
    }
    catch(_dT_){var _dO_ = no_handler;}
    var t102 = get(_dO_, _dN_);
    debug(_cC_);
    var
    ...
    function f$0(param){
     ...
     function loop(d, param){
      ...
      var
       cb =
         remain == 0. ? callback : function(_dR_){return loop(remain, _dR_);};
   ...
   function go(param$2){
    debug(_cJ_);
    function h(exn){
     var _dL_ = to_string(exn);
     return caml_call1(error(_cK_), _dL_);
    }
    try{
     var
      _cT_ =
         ...
         if(_c8_ >= 0){
          ...
          for(;;){
           ...
           if(match){
            ...
            var
             match$0 =
               map(function(_dK_){return matched_group(res$0, _dK_);}, _cz_);
            if(match$0){
             var _c__ = match$0[1];
             if(_c__){
              var _c$_ = _c__[1];
              if(caml_string_notequal(_c$_, "f"))
               if(caml_string_notequal(_c$_, "v")){
                if(! caml_string_notequal(_c$_, "vn")){
                 var _da_ = match$0[2];
                 if(_da_){
                  var _db_ = _da_[1];
                  if(_db_){
                     ...
                     if(_de_){
                      ...
                      if(_df_ && ! _de_[2]){
                       var
                        ...
                        y = _dd_[1],
                        x$0 = _db_[1],
                        _dg_ = caml_float_of_string(z),
                        _dh_ = caml_float_of_string(y),
                        match$2 =
                          [0, [1, [0, caml_float_of_string(x$0), _dh_, _dg_]]];
                       break a;
                      }
                     }
                    }
                    ...
                    if(_dm_){
                     ...
                     if(_dn_ && ! _dm_[2]){
                      var
                       ...
                       y$0 = _dl_[1],
                       x$1 = _dj_[1],
                       _do_ = caml_float_of_string(z$0),
                       _dp_ = caml_float_of_string(y$0),
                       match$2 =
                         [0, [0, [0, caml_float_of_string(x$1), _dp_, _do_]]];
                      break a;
                     }
                    }
                   }
             ...
             (face$0.length - 1,
              function(i){
               var
                ...
                av = _dG_[1][1],
                _dH_ = av - 1 | 0,
                match = caml_check_bound(vertex$2, _dH_)[1 + _dH_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dI_ = bv - 1 | 0,
             ...
             (face$0.length - 1,
              function(i){
               var
                ...
                an = _dC_[1][2],
                _dD_ = an - 1 | 0,
                match = caml_check_bound(norm$2, _dD_)[1 + _dD_],
                a3 = match[3],
                a2 = match[2],
                a1 = match[1],
                _dE_ = bn - 1 | 0,
     ...
     try{
      var
       _cS_ = return$0(caml_read_file_content(cst_monkey_model)),
       _cU_ = _cS_;
     }
     catch(_cX_){
      var _cQ_ = caml_wrap_exception(_cX_);
      if(_cQ_ !== Not_found) throw caml_maybe_attach_backtrace(_cQ_, 0);
      var
       _cR_ = function(s){return s;},
       content_type$2 = 0,
       _cP_ =
         function(r){
          var cod = r[2], msg = r[4];
       ...
       headers$0 = 0,
       check_headers = function(param, _c6_){return 1;},
       contents = 0;
      if(contents){
      ...
      var
       headers =
         function(s){
          function _c4_(v){return [0, caml_string_of_jsstring(v)];}
          function _c5_(param){return 0;}
          return case$0
            ...
            switch(req.readyState){
              ...
              case 4:
               ...
               var
                ...
                _c1_ = caml_string_of_jsstring,
                _c2_ = function(param){return _cm_;},
                response =
                  [0,
                   url,
                   code,
                   headers,
                   case$0(req.responseText, _c2_, _c1_),
                   _c0_];
      ...
      if(contents){
       var match$2 = contents[1], _cO_ = match$2[1];
       if(-836918635 === _cO_){
        ...
        if(891486873 <= match$3[1]){
            ...
            map
             (function(param){
               ...
               if(781515420 <= match[1]){
                ...
                return symbol(urlencode(0, name), _cY_);
               }
               var
                s = match[2],
                _cZ_ = symbol(_ck_, urlencode(0, caml_string_of_jsstring(s)));
         ...
         if(l$0){
          ...
          var _cN_ = caml_string_of_bytes(dst);
         }
         else
          var _cN_ = _n_;
         req.send(caml_jsstring_of_string(_cN_));
        }
        else{var f$0 = match$3[2]; req.send(f$0);}
       }
       else if(737307005 <= _cO_){
        var b = match$2[2];
        req.send(b);
       }
      ...
      var _cU_ = symbol$0(symbol_bind(res, _cP_), _cR_);
     }
     var _cV_ = symbol_bind(symbol$0(_cU_, _cT_), start), p = _cV_;
    }
