...
(function
   ...
   {"use strict";
    ...
    var
     ...
     public_methods=
      [0,
       ...
       caml_string_of_jsbytes("reload"),
       caml_string_of_jsbytes("replace")],
     s$0=caml_string_of_jsbytes("3.10.0"),
    ...
    var
     ...
     _do_=caml_string_of_jsbytes("OCAMLRUNPARAM"),
     _dm_=caml_string_of_jsbytes("CAMLRUNPARAM"),
     ...
     _db_=caml_string_of_jsbytes("info-38.png"),
     _dc_=caml_string_of_jsbytes("globe-38.png"),
     _dd_=caml_string_of_jsbytes("meeting-point-38.png"),
     _de_=caml_string_of_jsbytes("ocsigen-powered.png"),
     _c6_=caml_string_of_jsbytes(".wikipedia.org/wiki/"),
     _c7_=caml_string_of_jsbytes("http://"),
     _c1_=caml_string_of_jsbytes("px"),
     _c9_=caml_string_of_jsbytes(".jpg"),
     _c__=caml_string_of_jsbytes("images/"),
     _c2_=caml_string_of_jsbytes(""),
     _c8_=caml_string_of_jsbytes("?uselang="),
     _c3_=caml_string_of_jsbytes("http://commons.wikimedia.org/wiki/File:"),
     _c4_=caml_string_of_jsbytes("commons-38.png"),
     _c5_=caml_string_of_jsbytes("wikipedia-38.png"),
     _cU_=caml_string_of_jsbytes("px"),
     _cV_=caml_string_of_jsbytes("px 3px"),
     _cW_=caml_string_of_jsbytes("px 3px "),
     _cX_=caml_string_of_jsbytes("on"),
     _cZ_=caml_string_of_jsbytes("off"),
     _cY_=caml_string_of_jsbytes("filled_button "),
     _c0_=caml_string_of_jsbytes("px"),
     _cS_=caml_string_of_jsbytes("on"),
     _cT_=caml_string_of_jsbytes("off"),
     _cR_=caml_string_of_jsbytes("image_info.json"),
     _cP_=[0,0,0,0.],
     _cQ_=[254,-1.,0.],
     _cO_=[0,caml_string_of_jsbytes("examples/hyperbolic/hypertree.ml"),987,2],
     _cN_=caml_string_of_jsbytes("<TITLE>"),
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _lq_=1;return _lq_}
       catch(_lr_)
    ...
    function iter$0(f,a)
     {var _lo_=a.length - 1 - 1 | 0,_ln_=0;
      if(! (_lo_ < 0))
       {var i=_ln_;
        for(;;)
         {caml_call1(f,a[1 + i]);
    ...
    function fold_left(f,x,a)
     {var r=[0,x],_li_=a.length - 1 - 1 | 0,_lh_=0;
      if(! (_li_ < 0))
       {var i=_lh_;
        for(;;)
    ...
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_lg_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_lb_=height(lr);
            if(_lb_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _lc_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_lc_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_ld_=height(rl);
            if(_ld_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _le_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_le_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _lf_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function rev_seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_kN_=snoc_enum(t,rest);
          return [0,[0,k,v],function(_kO_){return rev_seq_of_enum(_kN_,_kO_)}]}
        return 0}
      function to_rev_seq(c)
       {var _kL_=snoc_enum(c,0);
        return function(_kM_){return rev_seq_of_enum(_kL_,_kM_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _kJ_=c;
          return function(_kK_){return seq_of_enum(_kJ_,_kK_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_kH_=q[3];
      return _kH_
              ?(q[1] = q[1] + 1 | 0,_kH_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,ty2)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_km_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 0:var rest2=ty2[1];return [0,trans(_km_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_kn_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 1:var rest2$0=ty2[1];return [1,trans(_kn_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_ko_=ty1[1];
          if(typeof ty2 === "number")
           switch$3 = 1;
          else
           switch(ty2[0])
            {case 2:var rest2$1=ty2[1];return [2,trans(_ko_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_kp_=ty1[1];
          if(typeof ty2 === "number")
           switch$4 = 1;
          else
           switch(ty2[0])
            {case 3:var rest2$2=ty2[1];return [3,trans(_kp_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_kq_=ty1[1];
          if(typeof ty2 === "number")
           switch$5 = 1;
          else
           switch(ty2[0])
            {case 4:var rest2$3=ty2[1];return [4,trans(_kq_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_kr_=ty1[1];
          if(typeof ty2 === "number")
           switch$6 = 1;
          else
           switch(ty2[0])
            {case 5:var rest2$4=ty2[1];return [5,trans(_kr_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_ks_=ty1[1];
          if(typeof ty2 === "number")
           switch$7 = 1;
          else
           switch(ty2[0])
            {case 6:var rest2$5=ty2[1];return [6,trans(_ks_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_kt_=ty1[1];
          if(typeof ty2 === "number")
           switch$8 = 1;
          else
           switch(ty2[0])
            {case 7:var rest2$6=ty2[1];return [7,trans(_kt_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_ku_=ty1[2],_kv_=ty1[1];
          if(typeof ty2 === "number")
           switch$9 = 1;
          else
           switch(ty2[0])
            {case 8:
              var rest2$7=ty2[2],ty2$0=ty2[1],_kw_=trans(_ku_,rest2$7);
              return [8,trans(_kv_,ty2$0),_kw_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_kx_=ty1[3],_ky_=ty1[2],_kz_=ty1[1];
          if(typeof ty2 === "number")
           switch$10 = 1;
          else
           switch(ty2[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=ty2[2],
               ty21=ty2[1],
               ty=trans(symm(_ky_),ty21),
               match=fmtty_rel_det(ty),
               f4=match[4],
               f2=match[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_kz_,ty22,trans(_kx_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof ty2 !== "number" && 10 === ty2[0])
           {var rest2$9=ty2[1];return [10,trans(_kA_,rest2$9)]}
          throw [0,Assert_failure,_al_];
         case 11:
          var switch$11=0,_kB_=ty1[1];
          if(typeof ty2 === "number")
           switch$11 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:var rest2$10=ty2[1];return [11,trans(_kB_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_am_];
          break;
         case 12:
          var switch$12=0,_kC_=ty1[1];
          if(typeof ty2 === "number")
           switch$12 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=ty2[1];return [12,trans(_kC_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_an_];
          break;
         case 13:
          var switch$13=0,_kD_=ty1[1];
          if(typeof ty2 === "number")
           switch$13 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=ty2[1];return [13,trans(_kD_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ao_];
          break;
         default:
          var switch$14=0,_kE_=ty1[1];
          if(typeof ty2 === "number")
           switch$14 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=ty2[1];return [14,trans(_kE_,rest2$13)];
             default:switch$14 = 1}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _j0_=function(param){return 0},
         _j1_=function(param){return 0},
         _j2_=function(param){return 0};
        return [0,function(param){return 0},_j2_,_j1_,_j0_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _j3_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_j3_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _j4_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _j5_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _j6_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _j7_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _j8_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _j9_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _j__=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _j$_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _ka_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _kb_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _kc_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _kd_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _ke_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _kf_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _kg_=function(param){caml_call1(de$12,0);return 0},
           _kh_=function(param){caml_call1(ed$12,0);return 0},
           _ki_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _kj_=function(param){caml_call1(de$13,0);return 0},
           _kk_=function(param){caml_call1(ed$13,0);return 0},
           _kl_=function(param){caml_call1(af$13,0);return 0};
          return [0,
    ...
    function type_padprec(pad,prec,fmtty)
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(prec)
         {var _jZ_=match[2];
          if(typeof _jZ_ !== "number" && 2 === _jZ_[0])
           {var rest=_jZ_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             _jX_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_jX_))
             throw Type_mismatch;
            var _jY_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_jY_))
             throw Type_mismatch;
            var
         ...
         case 4:
          ...
          if(typeof _jK_ !== "number" && 2 === _jK_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_jJ_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _jM_ !== "number" && 3 === _jM_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_jL_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _jO_=match$9[3],
           _jN_=match$9[1];
          if(typeof _jO_ !== "number" && 4 === _jO_[0])
           {var
             fmtty_rest$5=_jO_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_jN_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _jQ_=match$11[3],
           _jP_=match$11[1];
          if(typeof _jQ_ !== "number" && 5 === _jQ_[0])
           {var
             fmtty_rest$6=_jQ_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_jP_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
          ...
          if(typeof _jS_ !== "number" && 6 === _jS_[0])
           {var
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_jR_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _jV_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_jV_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _jW_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_jW_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_jW_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _jE_=2 === padty$0?48:32,res=make(width$0,_jE_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _jC_ >>> 0)
           {if(33 < (_jC_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _jC_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _jv_=caml_ml_bytes_length(s$0) - 1 | 0,
           _ju_=0;
          if(! (_jv_ < 0))
           {var i$0=_ju_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _jz_=match - 34 | 0,switch$2=0;
                if(58 < _jz_ >>> 0)
                 {if(93 <= _jz_)switch$2 = 1}
                else
                 if(56 < (_jz_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _jA_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _jA_=4;break;case 1:var _jA_=2;break}
              n[1] = n[1] + _jA_ | 0;
              var _jB_=i$0 + 1 | 0;
              if(_jv_ !== i$0){var i$0=_jB_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _jx_=caml_ml_bytes_length(s$0) - 1 | 0,_jw_=0;
            if(! (_jx_ < 0))
             {var i=_jw_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                n[1]++;
                var _jy_=i + 1 | 0;
                if(_jx_ !== i){var i=_jy_;continue}
                break}}
            var _jD_=s}
          var str$0=caml_string_of_bytes(_jD_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_jp_=caml_ml_string_length(s) - 1 | 0,_jo_=0;
        if(! (_jp_ < 0))
         {var i$0=_jo_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _jt_=i$0 + 1 | 0;
            if(_jp_ !== i$0){var i$0=_jt_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _jr_=caml_ml_string_length(s) - 1 | 0,
         _jq_=0;
        if(! (_jr_ < 0))
         {var i=_jq_;
          for(;;)
           {var c=caml_string_unsafe_get(s,i),switcher=c - 48 | 0;
            ...
            var _js_=i + 1 | 0;
            if(_jr_ !== i){var i=_js_;continue}
            break}}
        return caml_string_of_bytes(buf)}
      return s}
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _jn_=_as_;break;
        case 2:var _jn_=_at_;break;
        case 4:var _jn_=_av_;break;
        case 5:var _jn_=_aw_;break;
        case 6:var _jn_=_ax_;break;
        case 7:var _jn_=_ay_;break;
        case 8:var _jn_=_az_;break;
        case 9:var _jn_=_aA_;break;
        case 10:var _jn_=_aB_;break;
        case 11:var _jn_=_aC_;break;
        case 0:
        case 13:var _jn_=_ar_;break;
        case 3:
        case 14:var _jn_=_au_;break;
        default:var _jn_=_aD_}
      return transform_int_alt(iconv,caml_format_int(_jn_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _jm_=_aS_;break;
        case 2:var _jm_=_aT_;break;
        case 4:var _jm_=_aV_;break;
        case 5:var _jm_=_aW_;break;
        case 6:var _jm_=_aX_;break;
        case 7:var _jm_=_aY_;break;
        case 8:var _jm_=_aZ_;break;
        case 9:var _jm_=_a0_;break;
        case 10:var _jm_=_a1_;break;
        case 11:var _jm_=_a2_;break;
        case 0:
        case 13:var _jm_=_aR_;break;
        case 3:
        case 14:var _jm_=_aU_;break;
        default:var _jm_=_a3_}
      return transform_int_alt(iconv,caml_format_int(_jm_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _jl_=_a5_;break;
        case 2:var _jl_=_a6_;break;
        case 4:var _jl_=_a8_;break;
        case 5:var _jl_=_a9_;break;
        case 6:var _jl_=_a__;break;
        case 7:var _jl_=_a$_;break;
        case 8:var _jl_=_ba_;break;
        case 9:var _jl_=_bb_;break;
        case 10:var _jl_=_bc_;break;
        case 11:var _jl_=_bd_;break;
        case 0:
        case 13:var _jl_=_a4_;break;
        case 3:
        case 14:var _jl_=_a7_;break;
        default:var _jl_=_be_}
      return transform_int_alt(iconv,caml_format_int(_jl_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _jk_=_aF_;break;
        case 2:var _jk_=_aG_;break;
        case 4:var _jk_=_aI_;break;
        case 5:var _jk_=_aJ_;break;
        case 6:var _jk_=_aK_;break;
        case 7:var _jk_=_aL_;break;
        case 8:var _jk_=_aM_;break;
        case 9:var _jk_=_aN_;break;
        case 10:var _jk_=_aO_;break;
        case 11:var _jk_=_aP_;break;
        case 0:
        case 13:var _jk_=_aE_;break;
        case 3:
        case 14:var _jk_=_aH_;break;
        default:var _jk_=_aQ_}
      return transform_int_alt(iconv,caml_int64_format(_jk_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _jh_ >>> 0)
              {if(55 === _jh_)switch$0 = 1}
             else
              if(21 < (_jh_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _ji_=1}
           var _jj_=_ji_?str:cat(str,_bf_);
           return caml_special_val(_jj_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_jd_=l - 1 | 0,_jc_=0;
           if(! (_jd_ < 0))
            {var i=_jc_;
             for(;;)
              {var
                ...
                switcher=c - 97 | 0,
                _je_=25 < switcher >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_je_);
               var _jf_=i + 1 | 0;
               if(_jd_ !== i){var i=_jf_;continue}
               break}}
           var _jg_=r}
         return caml_string_of_bytes(_jg_);
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _i__=pad$5[2],_i$_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_i$_,_i__,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_i$_,_i__,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_i$_,_i__,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _ja_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_ja_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_ja_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_ja_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _jb_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _jb_[2] === "number")
              {var fmt=_jb_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_i9_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_i9_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _i6_=[8,acc,_bp_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_i6_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_i6_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_i5_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_i5_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_iX_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_iX_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bx_;
      var _iV_=other_fields(x,i + 1 | 0),_iW_=field(x,i);
      return caml_call2(sprintf(_by_),_iW_,_iV_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _iQ_=other_fields(e,2),
          _iR_=field(e,1),
          _iT_=caml_call2(sprintf(_bz_),_iR_,_iQ_);
        else
         switch(match)
          {case 0:var _iT_=_bA_;break;
           case 1:var _iT_=_bB_;break;
           default:var _iS_=field(e,1),_iT_=caml_call1(sprintf(_bC_),_iS_)}
        return cat(constructor,_iT_)}
      return e[1]}
    function print_raw_backtrace(outchan,raw_backtrace)
     {var a=caml_convert_raw_backtrace(raw_backtrace),backtrace=[0,a];
      if(backtrace)
       {var _iO_=a.length - 1 - 1 | 0,_iN_=0;
        if(! (_iO_ < 0))
         {var i=_iN_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _iG_=slot[4],
              _iH_=slot[3],
              _iI_=slot[6]?_bM_:_bO_,
              _iJ_=slot[2],
              _iK_=slot[7],
              _iL_=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bN_),_iL_,_iK_,_iJ_,_iI_,_iH_,_iG_,_iF_)];
            else
             if(slot[1])
              var match=0;
             else
              var _iM_=info(0),match=[0,caml_call1(sprintf(_bP_),_iM_)];
            if(match){var str=match[1];caml_call1(fprintf(outchan,_bQ_),str)}
            var _iP_=i + 1 | 0;
            if(_iO_ !== i){var i=_iP_;continue}
            break}}
        return 0}
    ...
    function default_uncaught_exception_han(exn,raw_backtrace)
     {var _iC_=to_string(exn);
      caml_call1(eprintf(_bT_),_iC_);
      print_raw_backtrace(stderr,raw_backtrace);
      var status=caml_ml_debug_info_status(0);
      if(status < 0)
       {var _iD_=abs(status);
        prerr_endline(caml_check_bound(errors,_iD_)[1 + _iD_])}
      return caml_ml_flush(stderr)}
     ...
     {try
       {try
         {var
          ...
          try {do_at_exit(0)}catch(_iB_){}
          try
           {var
             _ix_=default_uncaught_exception_han(exn,raw_backtrace),
             _iw_=_ix_}
          catch(exn$0)
           {exn$0 = caml_wrap_exception(exn$0);
            var
             ...
             _iu_=to_string(exn);
            caml_call1(eprintf(_bV_),_iu_);
            print_raw_backtrace(stderr,raw_backtrace);
            var _iv_=to_string(exn$0);
            caml_call1(eprintf(_bW_),_iv_);
            print_raw_backtrace(stderr,raw_backtrace$0);
            var _iw_=caml_ml_flush(stderr)}
          var _iy_=_iw_}
        catch(_iA_)
         {_iA_ = caml_wrap_exception(_iA_);
          if(_iA_ !== Out_of_memory)throw _iA_;
          var _iy_=prerr_endline(_bU_)}
        return _iy_}
      catch(_iz_){return 0}}
    caml_register_named_value
    ...
    try
     {var _dp_=caml_sys_getenv(_do_),params=_dp_}
    catch(_is_)
     {_is_ = caml_wrap_exception(_is_);
      if(_is_ !== Not_found)throw _is_;
      try
       {var _dn_=caml_sys_getenv(_dm_),_bZ_=_dn_}
      catch(_it_)
       {_it_ = caml_wrap_exception(_it_);
        if(_it_ !== Not_found)throw _it_;
        var _bZ_=_bY_}
      var params=_bZ_}
    var
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _iq_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_iq_;continue}
           var accu=[0,_bX_],_im_=54 + max$0(55,l) | 0,_il_=0;
           if(! (_im_ < 0))
            {var i=_il_;
             for(;;)
              {var
               ...
               var
                _in_=accu[1],
                _ih_=caml_string_get(_in_,3) << 24,
                _ii_=caml_string_get(_in_,2) << 16,
                _ij_=caml_string_get(_in_,1) << 8,
                _ik_=
                 ((caml_string_get(_in_,0) + _ij_ | 0) + _ii_ | 0)
                 +
                 _ih_
                 |
                 0,
                _io_=
                 (caml_check_bound(result[1],j)[1 + j] ^ _ik_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[1 + j] = _io_;
               var _ip_=i + 1 | 0;
               if(_im_ !== i){var i=_ip_;continue}
               break}}
           result[2] = 0;
           return result}}];
     ...
     {if(opt)var sth=opt[1],random=sth;else var random=randomized_default;
      ...
      for(;;)
       {if(! (initial_size <= x) && ! (max_array_length < (x * 2 | 0)))
        ...
        if(random)
         {var
           _if_=caml_obj_tag(prng),
           _ig_=250 === _if_?prng[1]:246 === _if_?force_lazy_block(prng):prng;
          _ig_[2] = (_ig_[2] + 1 | 0) % 55 | 0;
          var
           _ic_=_ig_[2],
           curval=caml_check_bound(_ig_[1],_ic_)[1 + _ic_],
           _id_=(_ig_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_ig_[1],_id_)[1 + _id_]
            +
           ...
           _ie_=_ig_[2];
          caml_check_bound(_ig_[1],_ie_)[1 + _ie_] = newval30;
          var seed=newval30}
        else
         var seed=0;
    ...
    function find$0(h,key)
     {var _ib_=indexfun(h,key),match=caml_check_bound(h[2],_ib_)[1 + _ib_];
      if(match)
    ...
    function public_method_label(s)
     {var accu=[0,0],_h__=caml_ml_string_length(s) - 1 | 0,_h9_=0;
      if(! (_h__ < 0))
       {var i=_h9_;
        for(;;)
         {var _h$_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _h$_ | 0;
          var _ia_=i + 1 | 0;
          if(_h__ !== i){var i=_ia_;continue}
          break}}
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _h3_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _h3_;
      var _h5_=len - 1 | 0,_h4_=0;
      if(! (_h5_ < 0))
       {var i=_h4_;
        for(;;)
         {var
           _h7_=(i * 2 | 0) + 3 | 0,
           _h6_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_h7_)[1 + _h7_] = _h6_;
          var _h8_=i + 1 | 0;
          if(_h5_ !== i){var i=_h8_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_h0_=len < new_size?1:0;
      if(_h0_)
       {var a2=caml_make_vect(new_size,dummy_met),_h1_=array[2],switch$0=0;
        if
         (0
          <=
          len
          &&
          !
          ((_h1_.length - 1 - len | 0) < 0)
          &&
          !
          ((a2.length - 1 - len | 0) < 0))
         {caml_array_blit(_h1_,0,a2,0,len);switch$0 = 1}
    ...
    function new_variable(table,name)
     {try
       {var _hW_=caml_call2(Vars[28],name,table[7]);return _hW_}
      catch(_hX_)
    ...
    function iter$1(x,f)
     {var _hV_=1 - (x == t58?1:0);return _hV_?caml_call1(f,x):_hV_}
    function case$0(x,f,g){return x == t58?caml_call1(f,0):caml_call1(g,x)}
    function test$0(x){return x !== undefined$0?1:0}
    function iter$2(x,f)
     {var _hU_=x !== undefined$0?1:0;return _hU_?caml_call1(f,x):_hU_}
      ...
      if(e.addEventListener === undefined$0)
       {var
         ...
         t35=
          function(e)
           {var _hR_=[0,h,e,[0]];
            return function(_hS_,_hT_){return caml_js_call(_hR_,_hS_,_hT_)}};
    ...
    function unsafeCreateElementEx(type,name,doc,elt)
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        var _hL_=createElementSyntax[1];
        if(785140586 === _hL_)
         {try
           {var
             el=t766.createElement('<input name="x">'),
             _hO_=el.tagName.toLowerCase() === "input"?1:0,
             _hP_=_hO_?el.name === "x"?1:0:_hO_,
             _hM_=_hP_}
          catch(_hQ_){var _hM_=0}
          var _hN_=_hM_?982028505:-1003883683;
          createElementSyntax[1] = _hN_;
          continue}
        if(982028505 <= _hL_)
         {var t40=new t0();
    ...
    function createCanvas(doc)
     {var c=unsafeCreateElement(doc,_cc_);
      if(1 - test(c.getContext))throw Canvas_not_available;
      return c}
    var html_element=t2.HTMLElement;
    html_element === undefined$0;
    function stopPropagation(ev)
     {function _hJ_(param){return ev.stopPropagation()}
      function _hK_(param){return ev.cancelBubble = t11}
      return case$1(ev.stopPropagation,_hK_,_hJ_)}
    var
         ...
         {var
          ...
          try
           {var
             ...
             _hH_=function(callback){return req(callback)};
            return _hH_}
          catch(_hI_)
    ...
    function path_of_path_string(s)
     {var l=caml_ml_string_length(s);
      function aux(i)
       {try
         {var _hF_=index_from(s,i,47),j=_hF_}
        catch(_hG_)
      ...
      if(a && ! caml_string_notequal(a[1],_cg_))
       {var _hE_=a[2];
        if(! _hE_)return 0;
        if(! caml_string_notequal(_hE_[1],_ch_) && ! _hE_[2])return _ci_}
      return a}
              ...
              function(s)
               {function _hC_(param)
                 {var
                   y=param[2],
                   x=param[1],
                   _hD_=urldecode_js_string_string(y);
                  return [0,urldecode_js_string_string(x),_hD_]}
                var t2=caml_jsstring_of_string(make$0(1,61)),t5=s.indexOf(t2);
                if(t5 < 0)
                 var _hB_=undefined$0;
                else
                 var
                  t7=t5 + 1 | 0,
                  _hA_=s.slice(t7),
                  _hB_=[0,s.slice(0,t5),_hA_];
                return case$1(_hB_,interrupt,_hC_)},
             _hy_=aux([0,case$1(arr[idx$0],interrupt,_hx_),acc],_hw_);
            return _hy_}
          catch(_hz_)
           {_hz_ = caml_wrap_exception(_hz_);
            if(_hz_ === Local_exn)
    ...
    new t2$0(caml_jsbytes_of_string(_cj_));
    new t2$0(caml_jsbytes_of_string(_ck_));
    if(test$0(t2.location))
     var _cl_=t2.location;
    else
     var
      empty="",
      _dg_=[0,0,0,0],
      _dh_=
       function
        ...
        {if(! _dg_[1])
          {if(0 === public_methods)
            var _g0_=new_table([0]);
           else
            {var
              tags=map(public_method_label,public_methods),
              table=new_table(tags),
              _gW_=public_methods.length - 1 - 1 | 0,
              _gV_=0;
             if(! (_gW_ < 0))
              {var i=_gV_;
               for(;;)
             ...
             var _g0_=table}
           var
            _g1_=new_variable(_g0_,_di_),
            _gY_=map(function(_hv_){return get_method_label(_g0_,_hv_)},names),
            _g2_=_gY_[1],
            _g3_=_gY_[2],
            _g4_=_gY_[3],
            _g5_=_gY_[4],
            ...
            _hc_=
             function(self_1)
              {var env=self_1[1 + _g1_];return caml_call1(env[2],env[1])},
            _hd_=
             function(self_1)
              {var env=self_1[1 + _g1_];return caml_call1(env[3],env[1])},
            _he_=
             function(self_1)
              {var env=self_1[1 + _g1_];return caml_call1(env[4],env[1])},
            _hf_=function(self_1){var env=self_1[1 + _g1_];return env[5]},
            _hg_=function(self_1){var env=self_1[1 + _g1_];return env[6]},
            _hh_=function(self_1){var env=self_1[1 + _g1_];return env[7]},
            _hi_=function(self_1){var env=self_1[1 + _g1_];return env[8]},
            _hj_=function(self_1){var env=self_1[1 + _g1_];return env[9]},
            _hk_=function(self_1){var env=self_1[1 + _g1_];return env[10]},
            _hl_=function(self_1){var env=self_1[1 + _g1_];return env[11]},
            _hm_=function(self_1){var env=self_1[1 + _g1_];return env[12]},
            methods=
             [0,
              _g9_,
              function(self_1){var env=self_1[1 + _g1_];return env[13]},
              _g5_,
              _hm_,
              _g$_,
              _hl_,
           ...
           for(;;)
            {if(i$0[1] < len)
              {var
                _gZ_=i$0[1],
                label=caml_check_bound(methods,_gZ_)[1 + _gZ_],
                next=
                 function(param)
                  {i$0[1]++;
                   var _hu_=i$0[1];
                   return caml_check_bound(methods,_hu_)[1 + _hu_]},
                clo=next(0);
                  ...
                  case 19:
                   var
                    ...
                    clo$0=
                     function(n,m)
                       {return function(obj)
                         {var _hs_=caml_call1(obj[1][1 + m],obj);
                          return caml_call2(obj[1][1 + n],obj,_hs_)}}
                      (n$15,m$1);
                   break;
                  case 20:
                   ...
                   var
                    clo$0=
                     function(m,n)
                       {return function(obj)
                         {var _hr_=obj[1 + n];
                          return caml_call1(caml_get_public_method(_hr_,m,0),_hr_)}}
                      (m$3,n$16);
                   break;
                  case 22:
                  ...
                  default:
                   ...
                   var
                    clo$0=
                     function(m,n)
                       {return function(obj)
                         {var _ht_=caml_call1(obj[1][1 + n],obj);
                          return caml_call1(caml_get_public_method(_ht_,m,0),_ht_)}}
                      (m$5,n$18)}
               else
                var clo$0=clo;
               method_count[1]++;
               if(caml_call2(Labs[28],label,_g0_[4]))
                {resize$0(_g0_,label + 1 | 0);
                 caml_check_bound(_g0_[2],label)[1 + label] = clo$0}
               else
                _g0_[6] = [0,[0,label,clo$0],_g0_[6]];
               i$0[1]++;
               continue}
             var
              _hn_=
               function(_hp_)
                {var obj=caml_obj_block(248,_g0_[1]);
                 obj[1] = _g0_[2];
                 var _ho_=caml_set_oo_id(obj);
                 _ho_[1 + _g1_] = _hp_;
                 return _ho_};
             inst_var_count[1] = (inst_var_count[1] + _g0_[1] | 0) - 1 | 0;
             var l1=_g0_[8],l2=0;
             for(;;)
              {if(l1)
               ...
               resize$0
                (_g0_,
                 3 + ((caml_check_bound(_g0_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
               _dg_[1] = _hn_;
               break}
             break}}
         return caml_call1
                 (_dg_[1],
                  [0,
                   ...
                   protocol,
                   href])},
      _dj_=function(param,_gU_){return 0},
      _dk_=function(param,_gT_){return 0},
      _dl_=function(param){return 0},
      _cl_=
    ...
    try
     ...
     {_gS_ = caml_wrap_exception(_gS_);if(_gS_[1] !== Failure)throw _gS_}
     ...
     {var _gR_=p[1];
      switch(_gR_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_gR_[1],p$1=underlying(p$0);
    ...
    function add_implicitly_removed_callbac(callbacks,f)
     {var
       node$0=[1,f],
       _gQ_=callbacks[1],
       node=typeof _gQ_ === "number"?node$0:[0,node$0,_gQ_];
      callbacks[1] = node;
      return 0}
    var
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _gP_=caml_call1(f,v);return _gP_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _gN_=result[1] === Canceled?1:0,is_canceled=_gN_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_gL_,0)}
      var _gM_=callbacks[1];
      ...
      return iter_callback_list$0(_gM_,0)}
    var
        ...
        {if(0 !== q[1])
          {var _gJ_=q[2];
           if(_gJ_)
            {var _gK_=_gJ_[1];
             if(_gJ_[2])
              {var next=_gJ_[2];q[1] = q[1] - 1 | 0;q[2] = next}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             var result=_gK_[2],callbacks=_gK_[1];
    ...
    function wakeup_general(api_function_name,p,result)
     {var p$0=underlying(p),_gI_=p$0[1];
      switch(_gI_[0])
       {case 1:
         return _gI_[1] === Canceled
                 ?0
      ...
      switch(_gH_[0])
       {case 1:return resolve(_cv_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _gF_=p_callbacks[2],
          _gG_=outer_callbacks[2],
          cancel_callbacks=
           typeof _gG_ === "number"
            ?_gF_
            :typeof _gF_ === "number"?_gG_:[0,_gG_,_gF_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _gE_=caml_call1(f,v),p$0=_gE_}
       ...
       {case 1:return [0,_gC_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_cx_,function(param){return caml_call1(f,v)},_gD_)}}
     ...
     {var p$0=underlying(p),_gA_=p$0[1];
      switch(_gA_[0])
       {case 1:
        ...
        default:return 0}}
    function poll(p)
     {var _gz_=underlying(p)[1];
      switch(_gz_[0])
       {case 1:var e=_gz_[1];throw e;
        case 2:return 0;
        default:var v=_gz_[1];return [0,v]}}
    var pause_hook=[0,function(_gy_){return 0}],s1=create$1(0),_cA_=[0,0];
    ...
    function yield$0(param)
     {var match=task(0),w=match[2],t=match[1],d=0.;
      function callback(_gw_){return wakeup(w,_gw_)}
      var id=[0,0];
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var
         cb=remain == 0.?callback:function(_gv_){return loop(remain,_gv_)},
      ...
      on_cancel
       (t,
        function(param)
         {var _gu_=id[1];
          if(_gu_){var x=_gu_[1];id[1] = 0;return t2.clearTimeout(x)}
          return 0});
      return t}
    ...
    function transf(a,b,c,d,z)
     {var _gt_=add_mul(c,z,d);return div(add_mul(a,z,b),_gt_)}
    function transl(p)
     {var c=mul(conj(p),t);return function(z){return transf(t,p,c,t,z)}}
    function compose(param,_gr_)
     {var
       t2=_gr_[2],
       p2=_gr_[1],
       t1=param[2],
       ...
       _gs_=div(conj(den),den),
       c=mul(mul(t1,t2),_gs_),
       _gq_=sdiv(c,norm(c));
      return [0,div(add$0(t2p1,p2),den),_gq_]}
    function compute_translation(z0,z1)
     {var dz=sub$1(z1,z0),z0z1=mul(z0,z1),_gp_=1. - sq_norm(z0z1);
      return sdiv(add$0(mul(z0z1,conj(dz)),dz),_gp_)}
    var t278=JSON;
    function http_get(url)
     {var opt=[0,0];
      ...
      function headers$0(s)
       {function _gn_(v){return [0,caml_string_of_jsstring(v)]}
        var t35=caml_jsbytes_of_string(s);
        function _go_(param){return 0}
        return case$0(t59.getResponseHeader(t35),_go_,_gn_)}
      var st=[0,382334108];
                ...
                _gi_=
                 function(param)
                  {var x=t59.responseXML;
                   ...
                   var match=case$0(x,function(param){return 0},_gm_);
                   if(match)
                    {var doc=match[1];
                     return doc.documentElement === t58?0:[0,doc]}
                   return 0},
                _gj_=function(x){return caml_string_of_jsstring(x)},
                _gk_=function(param){return _cC_},
                response=
                 [0,
                  url,
                  code,
                  headers$0,
                  case$0(t59.responseText,_gk_,_gj_),
                  _gi_];
               return wakeup(w,response)}
             return _gl_
            }
          return 0});
      function _gf_(upload){return 0}
      iter$2(t59.upload,_gf_);
      t59.send(t58);
      on_cancel(res,function(param){return t59.abort()});
      return symbol_bind(res,_gh_)}
    function getfile(f)
     {try
    ...
    function load_image(src)
     {var img=createImg(t766);
      function _gc_(param){return return$0(img)}
    ...
    function tree_vertice_count(n)
     {var l=n[2],_f8_=1;
      return fold_left
              (function(s,n){return s + tree_vertice_count(n) | 0},_f8_,l)}
    ...
    function randomize_tree(n)
     {var ch=n[2],_f4_=ch.length - 1 - 1 | 0;
      if(! (_f4_ < 0))
       {var i=_f4_;
        for(;;)
         {var
           ...
           _f5_=caml_check_bound(ch,j)[1 + j];
          caml_check_bound(ch,i)[1 + i] = _f5_;
          caml_check_bound(ch,j)[1 + j] = v;
          var _f6_=i - 1 | 0;
          if(0 !== i){var i=_f6_;continue}
          break}}
              ...
              ?(need_redraw[1]
                ...
                caml_call1
                 (requestAnimationFrame,
                  caml_js_wrap_callback
                   (function(param)
                     {var _f3_=need_redraw[1];return _f3_?perform_redraw(0):_f3_})))
              :_f2_}
    regexp(_cJ_);
    regexp(_cK_);
    regexp(_cL_);
    function compute_text_node(info)
     {var
       ...
       _f1_=caml_obj_tag(text_size_div),
       d=
        250 === _f1_
         ?text_size_div[1]
         :246 === _f1_?force_lazy_block(text_size_div):text_size_div;
      d.style.font = font;
    ...
    function compute_text_nodes(node_names,nodes)
     {try
       {var _fV_=assq(language[1],node_names)[1],names=_fV_}
      catch(_fZ_)
       {_fZ_ = caml_wrap_exception(_fZ_);
        if(_fZ_ !== Not_found)throw _fZ_;
        try
         {var _fU_=assq("en",node_names)[1],_fM_=_fU_}
        catch(_f0_)
         {_f0_ = caml_wrap_exception(_f0_);
          if(_f0_ !== Not_found)throw _f0_;
          var _fM_=create$0(0,11)}
        var names=_fM_}
      try
       {var _fT_=find$0(names,_cN_),_fN_=_fT_}
      catch(_fY_)
       {_fY_ = caml_wrap_exception(_fY_);
        if(_fY_ !== Not_found)throw _fY_;
        var _fN_=_cM_}
      t766.title = caml_jsstring_of_string(_fN_);
      var _fP_=nodes.length - 1 - 1 | 0,_fO_=0;
      if(! (_fP_ < 0))
       {var i=_fO_;
        for(;;)
         {var match=caml_check_bound(nodes,i)[1 + i],_fQ_=match[2],switch$0=0;
          if(typeof _fQ_ !== "number" && 4204112 === _fQ_[1])
           {var
             match$0=_fQ_[2],
             info=match$0[3],
             is_root=match$0[1],
             neigh=match[1];
            try
             {var _fS_=[0,compute_text_node(find$0(names,info))],canvas=_fS_}
            catch(_fX_)
             {_fX_ = caml_wrap_exception(_fX_);
              if(_fX_ !== Not_found)throw _fX_;
              var canvas=0,_fW_=_fX_}
    ...
    function weight_sum(l)
     {var _fL_=0.;
      return fold_left(function(s,n){var w=n[1];return s + w},_fL_,l)}
     ...
     {function _e1_(s)
       {var
          ...
          iter$0
           (function(param)
             {var
              ...
              h[1] = h[1] + 1 | 0;
              var _fK_=h[2].length - 1 << 1 < h[1]?1:0;
              if(_fK_)
               {var
                 odata=h[2],
                 osize=odata.length - 1,
                 nsize$0=osize * 2 | 0,
                 _fJ_=nsize$0 < max_array_length?1:0;
                if(_fJ_)
                 {var
                   ndata=caml_make_vect(nsize$0,0),
                   _fA_=h.length - 1 < 4?1:0,
                   _fB_=_fA_ || (h[4] < 0?1:0),
                   inplace=1 - _fB_;
                  h[2] = ndata;
                  var
                      ...
                      for(;;)
                       {if(cell)
                         {var
                          ...
                          continue}
                        var _fI_=i$0 + 1 | 0;
                        if(_fD_ !== i$0){var i$0=_fI_;continue a}
                        break}
                      break}}
                  if(inplace)
                   {var _fF_=nsize - 1 | 0,_fE_=0;
                    if(! (_fF_ < 0))
                     {var i=_fE_;
                      for(;;)
        ...
        var
         node_names$0=
          symbol
           (symbol(node_names,function(_fz_){return map(_e6_,_fz_)}),to_list);
              ...
              [0,
               ...
               [0,
                [246,
                 function(_fw_)
                  {function _fx_(param)
                    {function _fy_(img){schedule_redraw(0);return return$0(img)}
                     return symbol_bind
                             (load_image
                               (caml_jsstring_of_string(cat(_cI_,cat(img,_cH_)))),
                              _fy_)}
                   return symbol_bind(yield$0(0),_fx_)}],
                img]];
           else
        ...
        var
         ...
         edges=caml_make_vect(tree_edge_count(root),_cP_),
        ...
        function layout_rec
         ...
         {var
          ...
          vi[1]++;
          var _ft_=transf[1];
          caml_check_bound(vertices,i$0)[1 + i$0] = _ft_;
          var l$0=ch.length - 1;
          if(0 === l$0)
           var ch$0=[0];
          else
             ...
             f=
              function(node,weights)
               {var
                ...
                return ch},
             l=ch.length - 1;
            if(ch_weights.length - 1 !== l)throw [0,Assert_failure,_cO_];
            if(0 === l)
             var _fv_=[0];
            else
             {var
               _fn_=caml_check_bound(ch_weights,0)[1],
               r=caml_make_vect(l,f(caml_check_bound(ch,0)[1],_fn_)),
               _fp_=l - 1 | 0,
               _fo_=1;
              if(! (_fp_ < 1))
               {var i=_fo_;
                for(;;)
                 {var
                   _fq_=caml_check_bound(ch_weights,i)[1 + i],
                   _fr_=f(caml_check_bound(ch,i)[1 + i],_fq_);
                  caml_check_bound(r,i)[1 + i] = _fr_;
                  var _fs_=i + 1 | 0;
          ...
          return [0,i$0,ch$0]}
        var
         tree=layout_rec(root,weights,1,[0,zero,t],6.,_cQ_),
        ...
        function compute_frontiers(node)
         {var l=node[2],i=node[1];
          ...
          if(0 === l.length - 1)
           var _fh_=[0,status(i)],_fi_=[0,[0,status(i)],_fh_];
          else
           var
            _fj_=l.length - 1 - 1 | 0,
            _fk_=caml_check_bound(l,_fj_)[1 + _fj_][1],
            _fl_=caml_check_bound(frontiers,_fk_)[1 + _fk_][2],
            _fm_=caml_check_bound(l,0)[1][1],
            _fi_=[0,caml_check_bound(frontiers,_fm_)[1 + _fm_][1],_fl_];
          caml_check_bound(frontiers,i)[1 + i] = _fi_;
          return 0}
        ...
        function compute_neigh(node,parent,lft,rght)
         {var
           ...
           _e7_=caml_array_concat([0,parent,[0,lft,[0,rght,[0,children,0]]]]);
          caml_check_bound(neighboors,i)[1 + i] = _e7_;
          var
            ...
            for(;;)
             {if(0 < j)
               ...
               if(is_root)
                var
                 _ff_=n - 1 | 0,
                 _fg_=caml_check_bound(ch,_ff_)[1 + _ff_][1],
                 lft$0=caml_check_bound(frontiers,_fg_)[1 + _fg_][2];
               else
                var lft$0=lft;
              if(j < (n - 1 | 0))
               var
                _fa_=j + 1 | 0,
                _fb_=caml_check_bound(ch,_fa_)[1 + _fa_][1],
                rght$0=caml_check_bound(frontiers,_fb_)[1 + _fb_][1];
              else
               if(is_root)
                var
                 _fe_=caml_check_bound(ch,0)[1][1],
                 rght$0=caml_check_bound(frontiers,_fe_)[1 + _fe_][1];
               else
                var rght$0=rght;
              var _fc_=[0,status(i)];
              compute_neigh(caml_check_bound(ch,j)[1 + j],_fc_,lft$0,rght$0);
              var _fd_=j + 1 | 0;
              if(_e9_ !== j){var j=_fd_;continue}
              break}}
          return 0}
         ...
         {var i=_e2_;
          for(;;)
           {var
             ...
             info=match[2],
             _e4_=[0,caml_check_bound(neighboors,i)[1 + i],info];
            caml_check_bound(nodes,i)[1 + i] = _e4_;
            var _e5_=i + 1 | 0;
    ...
    function close_button(over)
     {var
      ...
      t305.stroke();
      t305.restore();
      var _eZ_=over?_cS_:_cT_;
      t281.className = caml_jsstring_of_string(_eZ_);
    ...
    function img_button(href,h,src)
     {function decoration(over)
        ...
        var
         _eW_=
          caml_jsstring_of_string
           (cat(caml_string_of_jsbytes("" + max(38,h)),_cU_));
        div.style.height = _eW_;
               ...
               (_cW_,
                cat
                 (caml_string_of_jsbytes("" + (extra - (extra / 2 | 0) | 0)),
                  _cV_))));
        div.style.padding = _eX_;
        var _eY_=over?_cX_:_cZ_;
        div.className = caml_jsstring_of_string(cat(_cY_,_eY_));
        appendChild(div,img);
        return div}
      ...
      var
       _eV_=
        caml_jsstring_of_string
         (cat(caml_string_of_jsbytes("" + (8 + max(38,h) | 0)),_c0_));
      button.style.height = _eV_;
      if(href)
              ...
              (image_info,
               function(image_info)
                {var
                 ...
                 if(0 <= i[1])
                  {var
                     ...
                     function(elt)
                      {var w=createDiv(t766);
                       ...
                       var
                        _eT_=
                         caml_jsstring_of_string
                          (cat(caml_string_of_jsbytes("" + info[5]),_c1_));
                       w.style.maxHeight = _eT_;
                       appendChild(w,elt);
                       return w},
                    img=createImg(t766),
                   ...
                   if(_eL_)
                    ...
                    var url$0=caml_jsstring_of_string(cat(_c__,cat(name,_c9_)));
                   img.src = url$0;
                   img.width = info[4];
                   img.height = info[5];
                   ...
                   var
                    suffix=
                     language[1] === "en"
                      ?_c2_
                      :cat(_c8_,caml_string_of_jsstring(language[1])),
                    url$1=cat(_c3_,cat(caml_string_of_jsstring(info[2]),suffix)),
                    commons=
                     img_button([0,caml_jsstring_of_string(url$1)],52,_c4_),
                    tt$0=
                     tooltip
                      (opt_style
                   ...
                   var
                    wikipedia=img_button(0,34,_c5_),
                    txt=createDiv(t766),
                    count=[0,0],
                    dl=createDl(t766),
                    list=
                     function(title,lang)
                      {var ul=createUl(t766),empty=[0,1],_eO_=info[6];
                       iter$0
                        (function(param)
                          {var
                            refer=param[3],
                             ...
                             var
                              ...
                              _eR_=
                               0 === caml_ml_string_length(refer$0)
                                ...
                                :refer$0,
                              _eS_=cat(_c6_,_eR_),
                              url=cat(_c7_,cat(caml_string_of_jsstring(lang),_eS_));
                       ...
                       return _eP_},
                    _eM_=language[1];
                   list(opt_style(messages.language,"In English"),_eM_);
                 ...
                 return return$0(0)})}
    var information_en=caml_jsstring_of_string(_c$_);
    ...
    function _da_(param)
     {var
                     ...
                     function(all_messages)
                      {var page=t766.documentElement;
                       ...
                       function(param)
                        {need_redraw[1] = 0;
                         ...
                         var
                          ...
                          _et_=w$4 !== canvas.width?1:0,
                          _eu_=_et_ || (h$3 !== canvas.height?1:0);
                         if(_eu_){canvas.width = w$4;canvas.height = h$3}
                         var
                          _ev_=tr$0[1],
                          t$0=_ev_[2],
                          p=_ev_[1],
                          c=mul(conj(p),t$0),
                          _d__=vertices.length - 1 - 1 | 0,
                          _d9_=0;
                         if(! (_d__ < 0))
                          {var i=_d9_;
                           for(;;)
                            {var
                             ...
                             caml_check_bound(vertices$0,i)[1 + i] = _d$_;
                             var _ea_=i + 1 | 0;
                         ...
                         iter$2(style.backgroundColor,_eb_);
                         function _ec_(color)
                          {t225.lineWidth = 1.;
                           t225.strokeStyle = color;
                           return t225.stroke()}
                         iter$2(style.boundaryColor,_ec_);
                         t225.lineWidth = 2.;
                         t225.lineCap = "round";
                              ...
                              {t225.lineWidth = w$3;
                               ...
                               if(Math.abs(d) < 0.05)
                                ...
                                {var
                                 ...
                                 t225.stroke()}}
                             var _es_=i$1 + 1 | 0;
                             if(_ee_ !== i$1){var i$1=_es_;continue}
                             break}}
                         var
                          image_count=[0,0],
                          large_image_count=[0,0],
                          _eg_=nodes.length - 1 - 1 | 0,
                          _ef_=0;
                         if(! (_eg_ < 0))
                          {var i$0=_ef_;
                           for(;;)
                               ...
                               if(4204112 <= img[1])
                                ...
                                {var match$0=img[2],img$0=match$0[1];
                                  ...
                                  min_scale$0=
                                   function(z)
                                    {function min_scale(l,w,h,s)
                                      {var s$0=[0,s],_ex_=l.length - 1 - 1 | 0,_ew_=0;
                                       if(! (_ex_ < 0))
                                        {var i=_ew_;
                                         for(;;)
                                          {var
                                            ...
                                            _ey_=z[1],
                                            sx=
                                             Math.abs(caml_check_bound(vertices$0,j)[1 + j][1] - _ey_)
                                             /
                                             w,
                                            _ez_=z[2],
                                            sy=
                                             Math.abs(caml_check_bound(vertices$0,j)[1 + j][2] - _ez_)
                                             /
                                             h,
                                            s$1=sy < sx?sx:sy,
                                 ...
                                 if(caml_obj_tag(img$0) !== 246)
                                  {var
                                    _el_=caml_obj_tag(img$0),
                                    _em_=
                                     250 === _el_
                                      ?img$0[1]
                                      :246 === _el_?force_lazy_block(img$0):img$0,
                                    match$1=poll(_em_);
                                   if(match$1)
                                    {var
                                      img$1=match$1[1],
                                     ...
                                     if(_eo_)
                                      {var
                                       ...
                                       image_count[1]++;
                                       var _ep_=2. <= w$2?1:0,_eq_=_ep_?2. <= h$2?1:0:_ep_;
                                       if(_eq_)large_image_count[1]++}}}
                                 else
                                  {var s$0=min_scale(l,1.,1.,1.);
                                   if(1. < s$0 * max(rx$2,ry$2))
                                    {var _er_=caml_obj_tag(img$0);
                                     if(250 !== _er_ && 246 === _er_)force_lazy_block(img$0)}}}
                       ...
                       handler
                        (function(param)
                          {var
                            ...
                            w=page.clientWidth,
                            h=page.clientHeight,
                            _d7_=w !== canvas.width?1:0,
                            _d8_=_d7_ || (h !== canvas.height?1:0);
                           if(_d8_)schedule_redraw(0);
                           return t11});
                       function find_box(boxes,x,y)
                        {var p=[0,-1],_d2_=boxes[3].length - 1 - 1 | 0,_d1_=0;
                         if(! (_d2_ < 0))
                          {var i=_d1_;
                           for(;;)
                            {var _d3_=0. < boxes[3][1 + i]?1:0;
                             if(_d3_)
                              var
                               _d4_=Math.abs(x - boxes[1][1 + i]) < boxes[3][1 + i]?1:0,
                               _d5_=
                                _d4_
                       ...
                       function update_cursor(x,y)
                        {var i=find_box(boxes,x,y);
                         if(-1 === i)
                          {var
                            _dX_=on_image[1],
                            _dY_=_dX_?(canvas.style.cursor = "",on_image[1] = 0,0):_dX_;
                           return _dY_}
                         var
                          _dZ_=1 - on_image[1],
                          _d0_=
                            ...
                            c1=
                             addEventListener
                              (t766,
                               ...
                               handler
                                (function(ev)
                                  {var x1=ev.clientX,y1=ev.clientY,_dU_=1 - started[1];
                                   if(_dU_)
                                    var
                                     _dV_=4 < abs(x1 - x0 | 0)?1:0,
                                     _dW_=_dV_ || (4 < abs(y1 - y0 | 0)?1:0);
                                   else
                                    var _dW_=_dU_;
                                   if(_dW_){started[1] = 1;canvas.style.cursor = "move"}
                                   if(started[1])
                                    {var
                                  ...
                                  {var
                                   ...
                                   if(0 < i)
                                    {var
                                      ...
                                      _dT_=match[2],
                                      switch$1=0;
                                     if(typeof _dT_ !== "number" && 3654627 === _dT_[1])
                                      {var match$0=_dT_[2],name=match$0[2],img=match$0[1];
                              ...
                              {var
                                ...
                                c1=
                                 addEventListener
                                  (t766,
                                   ...
                                   handler
                                    (function(ev)
                                      {var _dK_=ev.changedTouches.length - 1 | 0,_dJ_=0;
                                       if(! (_dK_ < 0))
                                        {var i=_dJ_;
                                         for(;;)
                                          {var
                                            _dL_=
                                             function(touch)
                                              {var _dN_=touch.identifier === id?1:0;
                                               if(_dN_)
                                                {var x1=touch.clientX,y1=touch.clientY,_dO_=1 - started[1];
                                                 if(_dO_)
                                                  var
                               ...
                               addEventListener
                                (t766,
                                 ...
                                 handler
                                  (function(ev)
                                    {var _dC_=ev.changedTouches.length - 1 | 0,_dB_=0;
                                     if(! (_dC_ < 0))
                                      {var i=_dB_;
                                       for(;;)
                                        {var
                                          _dD_=
                                           function(touch)
                                            {var _dF_=touch.identifier === id?1:0;
                                             if(_dF_)
                                              {var x=touch.clientX,y=touch.clientY;
                                               ...
                                               var i=find_box(boxes,x,y),_dG_=0 < i?1:0;
                                               if(_dG_)
                                                {var match=caml_check_bound(nodes,i)[1 + i],_dH_=match[2];
                                                 if(typeof _dH_ !== "number" && 3654627 === _dH_[1])
                                                  {var match$0=_dH_[2],name=match$0[2],img=match$0[1];
                                                   show_image(all_messages,image_info,name,img);
                                                   return 0}
                                                 var _dI_=0}
                                               else
                       ...
                       function make_buttons(param)
                        {var _dt_=prev_buttons[1];
                         if(_dt_){var buttons=_dt_[1];removeChild(t766.body,buttons)}
                             ...
                             handler
                              (function(param)
                                {var lang=caml_jsstring_of_string(id);
                                 function _du_(t138){return t138.setItem("hyp_lang",lang)}
                                 iter$2(t2.localStorage,_du_);
                                 language[1] = lang;
                                 make_buttons(0);
                         ...
                         var recenter=img_button(0,38,_dd_);
       ...
       _ds_=underlying(p)[1];
      switch(_ds_[0])
       {case 1:var exn=_ds_[1];throw exn;
        case 2:
         var
          p_callbacks=_ds_[1],
          callback=
    ...
    function start(param)
     {try
       {createCanvas(t2.document);var _dq_=_da_(0);return _dq_}
      catch(_dr_)
       {_dr_ = caml_wrap_exception(_dr_);
        if(_dr_ === Canvas_not_available){unsupported_messages(0);return t238}
        throw _dr_}}
