...
(function
   ...
   {"use strict";
              ...
              if(32 <= match)
               {var _fc_=match - 34 | 0,switch$2=0;
                if(58 < _fc_ >>> 0)
                 ...
                 if(56 < (_fc_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
    ...
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _e1_=_aH_;break;
        case 2:var _e1_=_aI_;break;
        case 4:var _e1_=_aK_;break;
        case 5:var _e1_=_aL_;break;
        case 6:var _e1_=_aM_;break;
        case 7:var _e1_=_aN_;break;
        case 8:var _e1_=_aO_;break;
        case 9:var _e1_=_aP_;break;
        case 10:var _e1_=_aQ_;break;
        case 11:var _e1_=_aR_;break;
        case 0:
        case 13:var _e1_=_aG_;break;
        case 3:
        case 14:var _e1_=_aJ_;break;
        default:var _e1_=_aS_}
    ...
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _e0_=_aU_;break;
        ...
        case 7:var _e0_=_a0_;break;
        case 8:var _e0_=_a1_;break;
        case 9:var _e0_=_a2_;break;
        case 10:var _e0_=_a3_;break;
        case 11:var _e0_=_a4_;break;
        case 0:
        case 13:var _e0_=_aT_;break;
        case 3:
        case 14:var _e0_=_aW_;break;
        default:var _e0_=_a5_}
      return transform_int_alt(iconv,caml_format_int(_e0_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _eZ_=_au_;break;
        case 2:var _eZ_=_av_;break;
        case 4:var _eZ_=_ax_;break;
        case 5:var _eZ_=_ay_;break;
        case 6:var _eZ_=_az_;break;
        case 7:var _eZ_=_aA_;break;
        case 8:var _eZ_=_aB_;break;
        case 9:var _eZ_=_aC_;break;
        case 10:var _eZ_=_aD_;break;
        case 11:var _eZ_=_aE_;break;
        case 0:
        case 13:var _eZ_=_at_;break;
        case 3:
        case 14:var _eZ_=_aw_;break;
        default:var _eZ_=_aF_}
          ...
          {if(i$0 === len)
            ...
            {var
             ...
             if(23 < _eW_ >>> 0)
              ...
              if(21 < (_eW_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _eX_=1}
           var _eY_=_eX_?str:cat(str,_a6_);
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bm_;
      ...
      return caml_call2(sprintf(_bn_),_ez_,_ey_)}
       ...
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          ...
          _eu_=field(e,1),
          _ew_=caml_call2(sprintf(_bo_),_eu_,_et_);
        else
         switch(match)
          {case 0:var _ew_=_bp_;break;
           case 1:var _ew_=_bq_;break;
           default:var _ev_=field(e,1),_ew_=caml_call1(sprintf(_br_),_ev_)}
        return cat(constructor,_ew_)}
      return e[1]}
    function print_raw_backtrace(outchan,raw_backtrace)
     {var a=caml_convert_raw_backtrace(raw_backtrace),backtrace=[0,a];
      if(backtrace)
       {var _er_=a.length - 1 - 1 | 0,_eq_=0;
        if(! (_er_ < 0))
         {var i=_eq_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _ej_=slot[4],
              _ek_=slot[3],
              _el_=slot[6]?_bB_:_bD_,
              _em_=slot[2],
              _en_=slot[7],
              _eo_=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bC_),_eo_,_en_,_em_,_el_,_ek_,_ej_,_ei_)];
            else
             if(slot[1])
              var match=0;
             else
              var _ep_=info(0),match=[0,caml_call1(sprintf(_bE_),_ep_)];
    ...
    function sleep(d)
     {var t=new_pending(1),d$0=d * 1000.;
      ...
      function f(param)
       {var _dI_=id[1];
        if(_dI_){var x=_dI_[1];id[1] = 0;return t2.clearTimeout(x)}
        return 0}
              ...
              map
               (function(param)
                 {var
                  ...
                  return symbol(t2$0.createElement(t50),c)},
                entries);
            return symbol(t2$0.createElement("tr"),_cW_)},
          rows),
       _cV_=[0,symbol(t2$0.createElement("tbody"),rows$0),0];
      return symbol(t2$0.createElement("table"),_cV_)}
    function _ch_(param){return t2$0.createElement("hr")}
    function _ci_(s){return list_builder(t2$0,_cj_,s)}
    function _ck_(s){return list_builder(t2$0,_cl_,s)}
    function _cm_(s){return symbol(t2$0.createElement("h6"),s)}
    function _cn_(s){return symbol(t2$0.createElement("h5"),s)}
    function _co_(s){return symbol(t2$0.createElement("h4"),s)}
    function _cp_(s){return symbol(t2$0.createElement("h3"),s)}
    function _cq_(s){return symbol(t2$0.createElement("h2"),s)}
    function _cr_(s){return symbol(t2$0.createElement("h1"),s)}
    function _cs_(s)
     {var p=t2$0.createElement("pre");
      ...
      return p}
    function _ct_(s){return symbol(t2$0.createElement("p"),s)}
    function _cu_(addr,s)
     {var i=unsafeCreateElement(t2$0,_bS_);
      i.width = "480";
      i.height = "360";
      var
       s$0=caml_jsstring_of_string(addr),
       video_link=cat(_cv_,caml_string_of_jsstring(t2.encodeURI(s$0)));
      i.src = caml_jsstring_of_string(video_link);
      i.frameBorder = "0";
      return i}
    function _cw_(addr,s)
     {var a=unsafeCreateElement(t2$0,_bQ_);
      a.href = caml_jsstring_of_string(addr);
      return symbol(a,s)}
    function _cx_(s){return symbol(t2$0.createElement("tt"),s)}
    function _cy_(addr,alt)
     {var i=unsafeCreateElement(t2$0,_bR_);
      i.src = caml_jsstring_of_string(addr);
      i.alt = caml_jsstring_of_string(alt);
      return i}
    function _cz_(param){return t2$0.createElement("br")}
    function _cA_(s){return symbol(t2$0.createElement("em"),s)}
    function _cB_(s){return symbol(t2$0.createElement("strong"),s)}
    var
     b=
      [0,
       function(s)
    ...
    function xml_of_wiki(s)
     {var
      ...
      parse_bol(c,lexbuf);
      var _cQ_=rev(c[11]);
      return symbol(createDiv(t2$0),_cQ_)}
    ...
    function f$0(param)
     {var body=t2$0.getElementById("wiki_demo");
      ...
      var textbox=unsafeCreateElementEx(0,0,t2$0,_bN_);
      textbox.rows = 20;
      textbox.cols = 80;
      textbox.value
      =
      ...
      appendChild(body,unsafeCreateElement(t2$0,_bP_));
