...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _bM_=[0,caml_string_of_jsbytes("lib/js_of_ocaml/regexp.ml"),34,64],
     _bN_=caml_string_of_jsbytes("[\\][()\\\\|+*.?{}^$]"),
     _bP_=caml_string_of_jsbytes(""),
     _bR_=caml_string_of_jsbytes(""),
     _bO_=caml_string_of_jsbytes("Js_of_ocaml__Url.Local_exn"),
     _bS_=
      caml_string_of_jsbytes
     ...
     _b4_=[0,0],
     _b5_=[0,0],
     _b3_=caml_string_of_jsbytes("wakeup_exn"),
     _b2_=caml_string_of_jsbytes("wakeup"),
     _bZ_=
      [0,
     ...
     _b0_=
      [0,
       ...
       caml_string_of_jsbytes("Lwt.%s")],
     _b1_=[0,0],
     _bX_=caml_string_of_jsbytes("Fatal error: exception "),
     _bY_=caml_string_of_jsbytes("Lwt.Resolution_loop.Canceled"),
     _cf_=caml_string_of_jsbytes(""),
     _ce_=
      caml_string_of_jsbytes
       ("Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers"),
     _cg_=caml_string_of_jsbytes("Exception during Lwt.async: "),
     _cE_=
      [0,
     ...
     _cC_=[0,[8,[0,0,0],0,[0,1],0],caml_string_of_jsbytes("%.1f")],
     _cu_=
      [0,
       [11,caml_string_of_jsbytes("init canvas"),0],
       caml_string_of_jsbytes("init canvas")],
     _cv_=caml_string_of_jsbytes("canvas"),
     _cw_=
      [0,
       [11,caml_string_of_jsbytes("create program"),0],
       caml_string_of_jsbytes("create program")],
     _cx_=caml_string_of_jsbytes("fragment-shader"),
     _cy_=caml_string_of_jsbytes("vertex-shader"),
     _cz_=
      [0,
     ...
     _cq_=caml_string_of_jsbytes("f"),
     _cr_=caml_string_of_jsbytes("v"),
     _cs_=caml_string_of_jsbytes("vn"),
     _co_=[0,1,[0,2,0]],
     _cl_=
      [0,
     ...
     _cn_=caml_string_of_jsbytes("([0-9]+)//([0-9]+)");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_g7_ = caml_wrap_exception(_g7_);
              if(_g7_[1] !== Sys_error)throw _g7_;
              var _g6_=_g7_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function init(l,f)
     {if(0 === l)return [0];
      if(0 <= l)
       {var res=caml_make_vect(l,caml_call1(f,0)),_g4_=l - 1 | 0,_g3_=1;
        if(! (_g4_ < 1))
         {var i=_g3_;
          for(;;)
    ...
    function add(x,q)
     {var cell=[0,x,0],_g2_=q[3];
      return _g2_
              ?(q[1] = q[1] + 1 | 0,_g2_[2] = cell,q[3] = cell,0)
    ...
    function take(q)
     {var _g0_=q[2];
      if(_g0_)
       {var _g1_=_g0_[1];
        if(_g0_[2])
         {var next=_g0_[2];q[1] = q[1] - 1 | 0;q[2] = next;return _g1_}
        q[1] = 0;
        q[2] = 0;
        q[3] = 0;
        return _g1_}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         ...
         _gC_=function(param){return 0};
        return [0,function(param){return 0},_gC_,_gB_,_gA_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _gD_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_gD_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _gE_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _gF_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _gG_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _gH_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _gI_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _gJ_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _gK_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _gL_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _gM_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _gN_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _gO_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _gP_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _gQ_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _gR_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _gS_=function(param){caml_call1(de$12,0);return 0},
           _gT_=function(param){caml_call1(ed$12,0);return 0},
           _gU_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _gV_=function(param){caml_call1(de$13,0);return 0},
           _gW_=function(param){caml_call1(ed$13,0);return 0},
           _gX_=function(param){caml_call1(af$13,0);return 0};
          return [0,
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_gh_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_gh_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_gi_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_gi_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_gj_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_gj_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_gk_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_gk_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_gl_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_gl_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_gm_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_gm_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_gn_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_gn_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_go_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_go_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_gp_=ty1[2],_gq_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_gr_=trans(_gp_,rest2$7);
              return [8,trans(_gq_,ty2),_gr_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_gs_=ty1[3],_gt_=ty1[2],_gu_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_gt_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_gu_,ty22,trans(_gs_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_gv_,rest2$9)]}
          throw [0,Assert_failure,_ab_];
         case 11:
          var switch$11=0,_gw_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_gw_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ac_];
          break;
         case 12:
          var switch$12=0,_gx_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_gx_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ad_];
          break;
         case 13:
          var switch$13=0,_gy_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_gy_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ae_];
          break;
         default:
          var switch$14=0,_gz_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_gz_,rest2$13)];
             default:switch$14 = 1}
        ...
        {case 0:
         ...
         case 2:
          var
           ...
           _f1_=match$1[2],
           _f0_=match$1[1];
          if(typeof _f1_ !== "number" && 1 === _f1_[0])
           {var
             fmtty_rest$1=_f1_[1],
         ...
         case 4:
          ...
          if(typeof _f5_ !== "number" && 2 === _f5_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_f4_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _f7_ !== "number" && 3 === _f7_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_f6_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
          ...
          if(typeof _f9_ !== "number" && 4 === _f9_[0])
           {var
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_f8_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
          ...
          if(typeof _f$_ !== "number" && 5 === _f$_[0])
           {var
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_f__,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
          ...
          if(typeof _gb_ !== "number" && 6 === _gb_[0])
           {var
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_ga_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _gd_=match$15[2],
           _gc_=match$15[1];
          if(typeof _gd_ !== "number" && 7 === _gd_[0])
           {var
             fmtty_rest$8=_gd_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_gc_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _ge_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_ge_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _gf_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_gf_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_gf_[1];
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _fV_ >>> 0)
           {if(33 < (_fV_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _fV_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _fO_=caml_ml_bytes_length(s$0) - 1 | 0,
           _fN_=0;
          if(! (_fO_ < 0))
           {var i$0=_fN_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _fS_=match - 34 | 0,switch$2=0;
                if(58 < _fS_ >>> 0)
                 {if(93 <= _fS_)switch$2 = 1}
                else
                 if(56 < (_fS_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _fT_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _fT_=4;break;case 1:var _fT_=2;break}
              n[1] = n[1] + _fT_ | 0;
              var _fU_=i$0 + 1 | 0;
              if(_fO_ !== i$0){var i$0=_fU_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _fQ_=caml_ml_bytes_length(s$0) - 1 | 0,_fP_=0;
            if(! (_fQ_ < 0))
             {var i=_fP_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _fW_=s}
          var str$0=caml_string_of_bytes(_fW_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_fI_=caml_ml_string_length(s) - 1 | 0,_fH_=0;
        if(! (_fI_ < 0))
         {var i$0=_fH_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _fM_=i$0 + 1 | 0;
            if(_fI_ !== i$0){var i$0=_fM_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _fK_=caml_ml_string_length(s) - 1 | 0,
         _fJ_=0;
        if(! (_fK_ < 0))
         {var i=_fJ_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _fG_=_ai_;break;
        case 2:var _fG_=_aj_;break;
        case 4:var _fG_=_al_;break;
        case 5:var _fG_=_am_;break;
        case 6:var _fG_=_an_;break;
        case 7:var _fG_=_ao_;break;
        case 8:var _fG_=_ap_;break;
        case 9:var _fG_=_aq_;break;
        case 10:var _fG_=_ar_;break;
        case 11:var _fG_=_as_;break;
        case 0:
        case 13:var _fG_=_ah_;break;
        case 3:
        case 14:var _fG_=_ak_;break;
        default:var _fG_=_at_}
      return transform_int_alt(iconv,caml_format_int(_fG_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _fF_=_aI_;break;
        case 2:var _fF_=_aJ_;break;
        case 4:var _fF_=_aL_;break;
        case 5:var _fF_=_aM_;break;
        case 6:var _fF_=_aN_;break;
        case 7:var _fF_=_aO_;break;
        case 8:var _fF_=_aP_;break;
        case 9:var _fF_=_aQ_;break;
        case 10:var _fF_=_aR_;break;
        case 11:var _fF_=_aS_;break;
        case 0:
        case 13:var _fF_=_aH_;break;
        case 3:
        case 14:var _fF_=_aK_;break;
        default:var _fF_=_aT_}
      return transform_int_alt(iconv,caml_format_int(_fF_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _fE_=_aV_;break;
        case 2:var _fE_=_aW_;break;
        case 4:var _fE_=_aY_;break;
        case 5:var _fE_=_aZ_;break;
        case 6:var _fE_=_a0_;break;
        case 7:var _fE_=_a1_;break;
        case 8:var _fE_=_a2_;break;
        case 9:var _fE_=_a3_;break;
        case 10:var _fE_=_a4_;break;
        case 11:var _fE_=_a5_;break;
        case 0:
        case 13:var _fE_=_aU_;break;
        case 3:
        case 14:var _fE_=_aX_;break;
        default:var _fE_=_a6_}
      return transform_int_alt(iconv,caml_format_int(_fE_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _fD_=_av_;break;
        case 2:var _fD_=_aw_;break;
        case 4:var _fD_=_ay_;break;
        case 5:var _fD_=_az_;break;
        case 6:var _fD_=_aA_;break;
        case 7:var _fD_=_aB_;break;
        case 8:var _fD_=_aC_;break;
        case 9:var _fD_=_aD_;break;
        case 10:var _fD_=_aE_;break;
        case 11:var _fD_=_aF_;break;
        case 0:
        case 13:var _fD_=_au_;break;
        case 3:
        case 14:var _fD_=_ax_;break;
        default:var _fD_=_aG_}
      return transform_int_alt(iconv,caml_int64_format(_fD_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _fA_ >>> 0)
              {if(55 === _fA_)switch$0 = 1}
             else
              if(21 < (_fA_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _fB_=1}
           var _fC_=_fB_?str:symbol(str,_a7_);
           return caml_special_val(_fC_)}
        case 6:return hex(0);
        case 7:
            ...
            {var i=_fv_;
             for(;;)
              {var c=caml_bytes_unsafe_get(s,i),switch$1=0;
               if(97 <= c && ! (122 < c)){var _fx_=c - 32 | 0;switch$1 = 1}
               if(! switch$1)var _fx_=c;
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bn_;
      ...
      return caml_call2(sprintf(_bo_),_fd_,_fc_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _e9_=other_fields(e,2),
          _e__=field(e,1),
          _fa_=caml_call2(sprintf(_bp_),_e__,_e9_);
        else
         switch(match)
          {case 0:var _fa_=_bq_;break;
           case 1:var _fa_=_br_;break;
           default:var _e$_=field(e,1),_fa_=caml_call1(sprintf(_bs_),_e$_)}
        return symbol(constructor,_fa_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _e7_=a.length - 1 - 1 | 0,_e6_=0;
        if(! (_e7_ < 0))
         {var i=_e6_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _e0_=slot[4],
              _e1_=slot[3],
              _e2_=slot[6]?_bC_:_bE_,
              _e3_=slot[2],
              _e4_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bD_),_e4_,_e3_,_e2_,_e1_,_e0_,_eZ_)];
            else
             if(slot[1])
              var match=0;
             else
              var _e5_=info(0),match=[0,caml_call1(sprintf(_bF_),_e5_)];
    ...
    function unsafeCoerce(tag,e)
     {var _eX_=caml_jsstring_of_string(tag);
      return e.tagName.toLowerCase() === _eX_?e:no_handler}
    ...
    function create$0(param)
     {var
      ...
      try
       {var _eS_=new xmlHttpRequest();return _eS_}
      catch(_eT_)
       {try
         {var _eR_=new activeXObject("Msxml2.XMLHTTP");return _eR_}
        catch(_eU_)
         {try
           {var _eQ_=new activeXObject("Msxml3.XMLHTTP");return _eQ_}
          catch(_eV_)
           {try
             {var _eP_=new activeXObject("Microsoft.XMLHTTP");return _eP_}
            catch(_eW_){throw [0,Assert_failure,_bL_]}}}}}
    ({"alpha":true$0,
      "depth":true$0,
      "stencil":false$0,
      "antialias":true$0,
    ...
    function string_match(r,s,i)
     {r.lastIndex = i;
      var
       ...
       _eO_=x == no_handler?no_handler:x;
      return to_option(_eO_)}
    function matched_group(r,i)
     {var x=r[i],_eN_=x === t37?t37:caml_string_of_jsbytes(x);
      function _eM_(x){return [0,x]}
      return case$1(_eN_,function(param){return 0},_eM_)}
    ...
    (function(param)
       {try
         {var _eI_=[0,caml_int_of_string(caml_string_of_jsbytes(_bU_.port))];
          return _eI_}
        catch(_eJ_)
    ...
    function aux(i)
     {try
       {var _eG_=index_from(s$0,i,47),j=_eG_}
      catch(_eH_)
    ...
    if(a && ! caml_string_notequal(a[1],_bP_))
     {var _bQ_=a[2];
      if(! _bQ_ || ! caml_string_notequal(_bQ_[1],_bR_) && ! _bQ_[2])
       switch$0 = 1}
    var
     _bW_=_bU_.search.charAt(0) === "?"?_bU_.search.slice(1):_bU_.search,
     arr=_bW_.split(caml_jsstring_of_string(make$0(1,38))),
     len=arr.length;
    ...
    function add_implicitly_removed_callbac(callbacks,f)
     {var
       node$0=[1,f],
       _ew_=callbacks[1],
       node=typeof _ew_ === "number"?node$0:[0,node$0,_ew_];
      callbacks[1] = node;
      return 0}
    var
       ...
       {case 1:return [0,_ek_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_b7_,function(param){return caml_call1(f,v)},_el_)}}
    function catch$0(f,h)
     {try
       {var _ei_=caml_call1(f,0),p=_ei_}
        ...
        function callback(p_result)
         {if(1 === p_result[0])
           {var exn=p_result[1];
            current_storage[1] = saved_storage;
            try
             {var _ej_=caml_call1(h,exn),p$1=_ej_}
          ...
          _eh_=
           function(param)
            {var
             ...
             return [0,p,callback,p$0[1]]};
         return run_callback_or_defer_it
                 (_ca_,function(param){return caml_call1(h,exn)},_eh_);
        case 2:
         var
          p_callbacks=_eg_[1],
          match=create_result_promise_and_call(0),
      ...
      switch(_ee_[0])
       {case 1:
        ...
        case 2:
         ...
         return 0;
        default:return 0}}
    var pause_hook=[0,function(_ed_){return 0}],s1=create$1(0),_cd_=[0,0];
       ...
       {var p$0=new_pending([0,p]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          current_storage[1] = saved_storage;
          try
           {var _eb_=[0,caml_call1(f,v)],p_result$0=_eb_}
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_b__,
                  function(param)
                   {try
                     {var _ea_=[0,caml_call1(f,v)],_d$_=_ea_}
                    catch(exn){exn = caml_wrap_exception(exn);var _d$_=[1,exn]}
                    return [0,_d$_]},
                  _d__)}}
    ...
    function error(f)
     {return ksprintf
              (function(s)
                {console.error(caml_jsstring_of_string(s));return failwith(s)},
               f)}
    function debug(f)
     {return ksprintf
              (function(s){return console.log(caml_jsstring_of_string(s))},f)}
    function check_error(gl)
     {var _d7_=gl.NO_ERROR,_d8_=caml_notequal(gl.getError(),_d7_);
      return _d8_?error(_ch_):_d8_}
    function init_canvas(canvas_id)
     {function _d2_(param){return caml_call1(error(_ci_),canvas_id)}
      var
       canvas$0=
        get
         (bind
           (document.getElementById(caml_jsstring_of_string(canvas_id)),
            canvas),
          _d2_);
      function _d3_(param)
       {return ksprintf
                (function(s)
                  {window.alert(caml_jsstring_of_string(s));
                   return failwith(s)},
                 f$0)}
      try
       {var _d5_=getContext(canvas$0),_d4_=_d5_}
      catch(_d6_){var _d4_=no_handler}
      var gl=get(_d4_,_d3_);
    ...
    function load_shader(gl,shader,text)
     {gl.shaderSource(shader,text);
      ...
      if(_dZ_)
       {var
         _d0_=caml_string_of_jsstring(gl.getShaderInfoLog(shader)),
         _d1_=caml_string_of_jsstring(text);
        return caml_call2(error(_cj_),_d1_,_d0_)}
      return _dZ_}
      ...
      for(;;)
       {if(param)
        ...
        var
         headers$0=
          function(s)
           {function _dA_(v){return [0,caml_string_of_jsstring(v)]}
       ...
       {var
        ...
        for(;;)
         {if(cell)
          ...
          n.data = caml_jsstring_of_string(caml_call1(sprintf(_cC_),fps));
          var
           match=task(0),
           w=match[2],
           t=match[1],
