...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.7.0+8f34006
(function
  (Object){
...
(function(globalThis){
   ...
   var
    ...
    _q_ = "String.contains_from / Bytes.contains_from",
    _p_ = "String.index_from / Bytes.index_from",
    _o_ = cst$0,
    _n_ = "String.concat",
    _t_ = "Array.blit",
    _u_ = "Stdlib.Queue.Empty",
    _D_ = "%c",
    _E_ = "%s",
    _F_ = cst_i,
    _G_ = cst_li,
    ...
    _S_ = "%r",
    _U_ = "%_r",
    _V_ = [0, cst_camlinternalFormat_ml, 850, 23],
    _ae_ = [0, cst_camlinternalFormat_ml, 814, 21],
    _Y_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _af_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _Z_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _ag_ = [0, cst_camlinternalFormat_ml, 822, 19],
    ___ = [0, cst_camlinternalFormat_ml, 823, 19],
    _ah_ = [0, cst_camlinternalFormat_ml, 826, 22],
    _$_ = [0, cst_camlinternalFormat_ml, 827, 22],
    _ai_ = [0, cst_camlinternalFormat_ml, 831, 30],
    _aa_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _ac_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _W_ = [0, cst_camlinternalFormat_ml, 837, 26],
    _ad_ = [0, cst_camlinternalFormat_ml, 846, 28],
    _X_ = [0, cst_camlinternalFormat_ml, 847, 28],
    _ab_ = [0, cst_camlinternalFormat_ml, 851, 23],
    ...
    _B_ = "@%",
    _C_ = "@",
    _aj_ = "CamlinternalFormat.Type_mismatch",
    _bp_ = cst$0,
    ...
    _bH_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bv_ = "Out of memory",
    _bw_ = "Stack overflow",
    ...
    _bT_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bU_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bV_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bW_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520),
    _bO_ = caml_int64_create_lo_mi_hi(1, 0, 0),
    _bP_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bS_ = caml_int64_create_lo_mi_hi(1, 0, 0),
    _bQ_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bR_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _b1_ = "Hashtbl: unsupported hash table format",
    _bZ_ = cst$0,
    _b2_ = "Jsoo_runtime.Error.Exn",
    _ca_ = "canvas",
    _b__ = "dt",
    _b9_ = "dd",
    _b8_ = "img",
    ...
    _b4_ = "dl",
    _b3_ = "ul",
    _b$_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _cb_ = "[\\][()\\\\|+*.?{}^$]",
    _cc_ = "Js_of_ocaml__Url.Local_exn",
    _c$_ = cst$3,
    _cq_ = [0, 0],
    _cr_ = [0, 1],
    _co_ = [0, 0],
    ...
    _ci_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cj_ = [0, 0],
    _cf_ = cst_Fatal_error_exception,
    _cg_ = "Lwt.Resolution_loop.Canceled",
    _cy_ = cst_POST,
    _cw_ = cst_POST,
    _cx_ = cst_POST,
    _cv_ = cst$0,
    _cs_ = cst$4,
    _ct_ = cst$4,
    _cu_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cz_ = "Exception during Lwt.async: ",
    _c7_ = cst_info_38_png,
    _c8_ = cst_globe_38_png,
    _c9_ = cst_meeting_point_38_png,
    _c__ = cst_ocsigen_powered_png,
    _c2_ = ".wikipedia.org/wiki/",
    _c3_ = "http://",
    _cX_ = cst_px,
    _c5_ = cst_jpg,
    _c6_ = "images/",
    _cY_ = cst$0,
    _c4_ = "?uselang=",
    _cZ_ = "http://commons.wikimedia.org/wiki/File:",
    _c0_ = cst_commons_38_png,
    _c1_ = cst_wikipedia_38_png,
    _cQ_ = cst_px,
    _cR_ = "px 3px",
    _cS_ = "px 3px ",
    _cT_ = cst_on,
    ...
    _cO_ = cst_on,
    _cP_ = cst_off,
    _cN_ = "image_info.json",
    _cJ_ = [0, 0, 0, 0.],
    _cK_ = [254, -1., 0.],
    _cI_ = [0, "examples/hyperbolic/hypertree.ml", 972, 2],
    _cH_ = "<TITLE>",
    _cG_ = cst$0,
    _cE_ = cst_jpg,
    _cF_ = "thumbnails/",
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _hX_ = caml_wrap_exception(_hY_);
      if(_hX_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_hX_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function iter$0(f, a){
    var _hV_ = a.length - 1 - 1 | 0, _hU_ = 0;
    if(_hV_ >= 0){
     var i = _hU_;
     for(;;){
      caml_call1(f, a[1 + i]);
   ...
   function fold_left(f, x, a){
    var r = [0, x], _hP_ = a.length - 1 - 1 | 0, _hO_ = 0;
    if(_hP_ >= 0){
     var i = _hO_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _hN_){return 0;});
   ...
   function string_of_formatting_lit(formatting_lit){
    ...
    switch(formatting_lit[0]){
      ...
      default: var c = formatting_lit[1]; return symbol(_C_, make$0(1, c));
    }
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _hM_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _hM_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _hK_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _hK_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _hL_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _hL_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _hL_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _hI_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _hI_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _hJ_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _hJ_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _hH_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _hH_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _hz_ = caml_ml_bytes_length(b) - 1 | 0,
     _hy_ = 0;
    if(_hz_ >= 0){
     var i$0 = _hy_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _hB_ = caml_ml_bytes_length(b) - 1 | 0, _hA_ = 0;
     if(_hB_ >= 0){
      var i = _hA_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _ht_ = caml_ml_string_length(s) - 1 | 0, _hs_ = 0;
    if(_ht_ >= 0){
     var i$0 = _hs_;
     for(;;){
    ...
    var
     ...
     _hv_ = caml_ml_string_length(s) - 1 | 0,
     _hu_ = 0;
    if(_hv_ >= 0){
     var i = _hu_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _hr_ = _an_; break;
      default: var _hr_ = _aw_;
    }
    return transform_int_alt(iconv, caml_format_int(_hr_, n));
   }
   function convert_int32(iconv, n){
    ...
    return transform_int_alt(iconv, caml_format_int(_hq_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ho_ = _aA_; break;
      default: var _ho_ = _aJ_;
    }
    return transform_int_alt(iconv, caml_int64_format(_ho_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _hl_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _hl_ >>> 0){
           if(55 === _hl_) break a;
          }
          else if(21 < _hl_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _hm_ = 1;
        }
        var _hn_ = _hm_ ? str : symbol(str, _a__);
        return caml_special_val(_hn_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _hh_ = l - 1 | 0, _hg_ = 0;
        if(_hh_ >= 0){
         var i = _hg_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _hi_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _hi_);
          var _hj_ = i + 1 | 0;
          if(_hh_ === i) break;
          var i = _hj_;
         }
       ...
       return caml_string_of_bytes(_hk_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 18:
        var _hd_ = fmt$0[1];
        if(0 === _hd_[0]){
         var rest$17 = fmt$0[2], fmt$1 = _hd_[1][1];
         let acc = acc$0, k$1 = k$0, rest = rest$17;
         function k(kacc){return make_printf(k$1, [1, acc, [0, kacc]], rest);}
         var k$0 = k, acc$0 = 0, fmt$0 = fmt$1;
        }
        else{
         var rest$18 = fmt$0[2], fmt$2 = _hd_[1][1];
         let acc = acc$0, k$1 = k$0, rest = rest$18;
         function k(kacc){return make_printf(k$1, [1, acc, [1, kacc]], rest);}
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _he_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _he_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _hb_ = [8, acc, _bh_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _hb_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _hb_, fmt);
   }
   ...
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _ha_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _ha_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _ha_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _g$_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _g$_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _g9_ = other_fields(x, i + 1 | 0), _g__ = field(x, i);
    return caml_call2(sprintf(_bq_), _g__, _g9_);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_g8_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _g4_ = other_fields(e, 2),
       _g5_ = field(e, 1),
       _g7_ = caml_call2(sprintf(_br_), _g5_, _g4_);
     else
      switch(match){
        case 0:
         var _g7_ = _bs_; break;
        case 1:
         var _g7_ = _bt_; break;
        default:
         var _g6_ = field(e, 1), _g7_ = caml_call1(sprintf(_bu_), _g6_);
      }
     var match$0 = [0, constructor, [0, _g7_]];
    }
    else
     var match$0 = [0, e[1], 0];
    ...
    if(_g2_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _bA_ : _bB_ : 0 === pos$0 ? _bC_ : _bD_;
      }
      if(0 === slot[0])
       var
        _gT_ = slot[5],
        _gU_ = slot[4],
        _gV_ = slot[3],
        _gW_ = slot[6] ? _bE_ : _bG_,
        _gX_ = slot[2],
        _gY_ = slot[7],
        _gZ_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bF_), _gZ_, _gY_, _gX_, _gW_, _gV_, _gU_, _gT_)];
      else if(slot[1])
       var match = 0;
      else
       var _g0_ = info(0), match = [0, caml_call1(sprintf(_bH_), _g0_)];
   ...
   var errors = _bJ_.slice(), empty_backtrace = [0];
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_gR_){}
      try{
       var _gH_ = to_string(exn$0);
       caml_call1(eprintf(_bK_), _gH_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _gI_ = abs(status);
        prerr_endline(caml_check_bound(errors, _gI_)[1 + _gI_]);
       }
       var _gJ_ = caml_ml_flush(stderr), _gN_ = _gJ_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _gL_ = to_string(exn$0);
       caml_call1(eprintf(_bM_), _gL_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _gM_ = to_string(exn);
       caml_call1(eprintf(_bN_), _gM_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _gN_ = caml_ml_flush(stderr);
      }
      var _gO_ = _gN_;
     }
     catch(_gQ_){
      var _gK_ = caml_wrap_exception(_gQ_);
      if(_gK_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_gK_, 0);
      var _gO_ = prerr_endline(_bL_);
     }
     return _gO_;
    }
    catch(_gP_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bO_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bP_) ? i3 : _bS_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bQ_) ? i4 : _bR_;
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _gD_ = get_int64_le(d2, 8),
     _gE_ = get_int64_le(d2, 0),
     _gF_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _gF_, _gE_, _gD_);
    return s;
   }
   function split(s){
    var
   ...
   function mk_default(param){return mk(_bW_, _bV_, _bU_, _bT_);}
   new_key([0, split], mk_default);
   try{var _db_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _db_;}
   catch(_gz_){
    var _bX_ = caml_wrap_exception(_gz_);
    if(_bX_ !== Not_found) throw caml_maybe_attach_backtrace(_bX_, 0);
    try{var _da_ = caml_sys_getenv("CAMLRUNPARAM"), _b0_ = _da_;}
    catch(_gA_){
     var _bY_ = caml_wrap_exception(_gA_);
     if(_bY_ !== Not_found) throw caml_maybe_attach_backtrace(_bY_, 0);
     var _b0_ = _bZ_;
    }
    var params = _b0_;
   }
   ...
   if(l < 0)
    var randomized_default = invalid_arg(_q_);
   else
    try{index_rec(params, l, i, c); var _s_ = 1, randomized_default = _s_;}
    catch(_gy_){
     var _r_ = caml_wrap_exception(_gy_);
     if(_r_ !== Not_found) throw caml_maybe_attach_backtrace(_r_, 0);
   ...
   function find(h, key){
    var
     _gx_ = key_index(h, key),
     match = caml_check_bound(h[2], _gx_)[1 + _gx_];
   ...
   function iter$1(x, f){
    var _gw_ = 1 - (x == no_handler ? 1 : 0);
    return _gw_ ? caml_call1(f, x) : _gw_;
   }
   ...
   function iter$2(x, f){
    var _gv_ = 1 - (x === undefined$0 ? 1 : 0);
    return _gv_ ? caml_call1(f, x) : _gv_;
   }
   ...
   function addEventListener(t28, typ, h, capt){
    ...
    var ev = cst_on.concat(typ);
    function callback(e){
     var _gs_ = [0, h, e, [0]];
     return function(_gt_, _gu_){return caml_js_call(_gs_, _gt_, _gu_);};
    }
   ...
   function createUl(doc){return unsafeCreateElement(doc, _b3_);}
   function createDl(doc){return unsafeCreateElement(doc, _b4_);}
   function createLi(doc){return unsafeCreateElement(doc, _b5_);}
   function createDiv(doc){return unsafeCreateElement(doc, _b6_);}
   function createA(doc){return unsafeCreateElement(doc, _b7_);}
   function createImg(doc){return unsafeCreateElement(doc, _b8_);}
   function createDd(doc){return createElement(doc, _b9_);}
   function createDt(doc){return createElement(doc, _b__);}
   var Canvas_not_available = [248, _b$_, caml_fresh_oo_id(0)];
   function createCanvas(doc){
    var t52 = unsafeCreateElement(doc, _ca_);
   ...
   function stopPropagation(t109){
    function _gq_(param){return t109.stopPropagation();}
    function _gr_(param){return t109.cancelBubble = true$0;}
    return case$1(t109.stopPropagation, _gr_, _gq_);
   }
   global.FormData;
   global.FormData;
   ...
   var
    ...
    quote_re = regexp(_cb_),
    Local_exn = [248, _cc_, caml_fresh_oo_id(0)];
   ...
   function urlencode(opt, s){
    ...
    return caml_string_of_jsbytes
            (caml_jsbytes_of_string(s$0).replace
              (plus_re, "%2B".replace(quote_repl_re, "$$$$")));
   }
   new
    regExp
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _gp_){return 0;},
     t41 = function(param, _go_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _ce_ = caml_wrap_exception(_gn_);
    if(_ce_[1] !== Failure) throw caml_maybe_attach_backtrace(_ce_, 0);
   }
   var
   ...
   function aux(i){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= i && l >= i){
       var _gl_ = index_rec(path_string, l, i, c);
       break a;
      }
      var _gl_ = invalid_arg(_p_);
     }
     var j = _gl_;
    }
    catch(_gm_){
     var _gk_ = caml_wrap_exception(_gm_);
     if(_gk_ !== Not_found) throw caml_maybe_attach_backtrace(_gk_, 0);
     var j = l$0;
    }
   ...
   var a = aux(0);
   a:
   if(a && ! caml_string_notequal(a[1], cst$0)){
    var _cd_ = a[2];
    if(! _cd_ || ! caml_string_notequal(_cd_[1], cst$0) && ! _cd_[2]) break a;
   }
   var
         ...
         function(s){
          function _gi_(param){
           var
            y = param[2],
            x = param[1],
            _gj_ = urldecode_js_string_string(y);
           return [0, urldecode_js_string_string(x), _gj_];
          }
          var index = s.indexOf(caml_jsstring_of_string(make$0(1, 61)));
          if(0 <= index)
           var
            _gg_ = s.slice(index + 1 | 0),
            _gh_ = [0, s.slice(0, index), _gg_];
          else
           var _gh_ = undefined$0;
          return case$1(_gh_, interrupt, _gi_);
         };
      aux$0([0, case$1(arr[idx$0], interrupt, _ge_), acc], _gd_);
      return;
     }
     catch(_gf_){
      var _gc_ = caml_wrap_exception(_gf_);
      if(_gc_ !== Local_exn) throw caml_maybe_attach_backtrace(_gc_, 0);
   ...
   symbol(s$1, symbol(_c$_, git_version));
   var console$0 = caml_js_get_console(0), empty = 0;
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _gb_ = caml_call1(f, v); return _gb_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _cg_, caml_fresh_oo_id(0)];
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _ga_ = result[1] === Canceled ? 1 : 0, is_canceled = _ga_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _f$_ = deferred_callbacks[2];
      if(! _f$_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _f$_[1];
      if(_f$_[2]){
       var next = _f$_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _f__ = p[1];
    switch(_f__[0]){
      case 1:
       return _f__[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _ci_), api_function_name);
      case 2:
       if(0 === result[0])
        var x = result[1], result$0 = [0, x];
       else
        var exn = result[1], result$0 = [1, exn];
       resolve(_cj_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _ch_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_ck_, r, [0, v]);}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_co_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _f9_ = caml_call1(f, v), user_provided_promise = _f9_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_cn_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_cm_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
   ...
   var Wrong_headers = [248, _cu_, caml_fresh_oo_id(0)];
   function yield$0(param){
    var match = task(0), w = match[2], t = match[1], d = 0.;
    function callback(_f8_){return wakeup(w, _f8_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_f7_){return loop(remain, _f7_);};
   ...
   function prerr_string$0(s){
    console$0.log(caml_jsstring_of_string(s));
    return;
   }
   ...
   function icon(nm){return caml_jsstring_of_string(symbol(_cA_, nm));}
   ...
   function transf(a, b, c, d, z){
    var _f6_ = add_mul(c, z, d);
    return div(add_mul(a, z, b), _f6_);
   }
   function transl(p){
    var c = mul(conj(p), one);
    return function(z){return transf(one, p, c, one, z);};
   }
   function compose(param, _f4_){
    var
     t2 = _f4_[2],
     p2 = _f4_[1],
     t1 = param[2],
     ...
     _f5_ = div(conj(den), den),
     c = mul(mul(t1, t2), _f5_),
     _f3_ = sdiv(c, norm(c));
    return [0, div(add$0(t2p1, p2), den), _f3_];
   }
   function compute_translation(z0, z1){
    var dz = sub$1(z1, z0), z0z1 = mul(z0, z1), _f2_ = 1. - sq_norm(z0z1);
    return sdiv(add$0(mul(z0z1, conj(dz)), dz), _f2_);
   }
   var json = JSON;
   function getfile(url){
    try{var _fR_ = return$0(caml_read_file_content(url)); return _fR_;}
    catch(_fS_){
     var _fQ_ = caml_wrap_exception(_fS_);
     if(_fQ_ !== Not_found) throw caml_maybe_attach_backtrace(_fQ_, 0);
     var
      content_type$2 = 0,
      _fP_ =
        function(r){
      ...
      headers$0 = 0,
      check_headers = function(param, _f1_){return 1;},
      contents = 0;
     if(contents){
      ...
      if(-836918635 === match$1[1]){
       ...
       if(891486873 <= form[1])
        ...
        var content_type$0 = content_type$2, method$0 = _cx_;
      }
      else
       var content_type$0 = content_type$2, method$0 = _cy_;
     }
     else
     ...
     req.open
      (caml_jsstring_of_string(method$0),
       caml_jsstring_of_string(url),
       true$0);
     req.responseType = cst$0;
     if(content_type$0){
      var content_type$1 = content_type$0[1];
      req.setRequestHeader
       ("Content-type", caml_jsstring_of_string(content_type$1));
     }
     iter
      (function(param){
     ...
     var
      headers =
        function(s){
         function _fZ_(v){return [0, caml_string_of_jsstring(v)];}
               ...
               _fV_ =
                 function(param){
                  var
                   ...
                   match =
                     case$0
                      (x, function(param){return 0;}, function(x){return [0, x];});
                  if(! match) return 0;
                  var doc = match[1];
                  return doc.documentElement === no_handler ? 0 : [0, doc];
                 },
               _fW_ = caml_string_of_jsstring,
               _fX_ = function(param){return _cv_;},
               response =
                 [0,
                  url,
                  code,
                  headers,
                  case$0(req.responseText, _fX_, _fW_),
                  _fV_];
     ...
     var _fN_ = function(upload){return 0;};
     iter$2(req.upload, _fN_);
     if(contents){
      var match$3 = contents[1], _fO_ = match$3[1];
      if(-836918635 === _fO_){
       ...
       if(891486873 <= match$4[1]){
           ...
           function(param){
            ...
            if(781515420 <= match[1]){
             var
              t0 = match[2],
              _fT_ =
                symbol(_cs_, urlencode(0, caml_string_of_jsstring(t0.name)));
             return symbol(urlencode(0, name), _fT_);
            }
            var
             s = match[2],
             _fU_ = symbol(_ct_, urlencode(0, caml_string_of_jsstring(s)));
            return symbol(urlencode(0, name), _fU_);
           };
        if(l$3){
          ...
          a:
          {
           b:
           {
            ...
            for(;;){
             ...
             var dst = dst$0, offset = 1, param = l$0;
            }
            dst[1 + offset] = 0;
            break a;
           }
        ...
        if(l$1){
         ...
         a:
         {
          ...
          var _fL_ = caml_ml_string_length(hd) + acc | 0;
         }
         var dst$1 = caml_create_bytes(_fL_);
         a:
         {
          b:
          {
         ...
         var _fM_ = caml_string_of_bytes(dst$1);
        }
        else
         var _fM_ = _o_;
        req.send(caml_jsstring_of_string(_fM_));
       }
       else{var f$0 = match$4[2]; req.send(f$0);}
      }
      else if(737307005 <= _fO_){
       var b = match$3[2];
       req.send(b);
      }
      else{var s = match$3[2]; req.send(caml_jsstring_of_string(s));}
     }
     else
      req.send(no_handler);
     on_cancel(res, function(param){return req.abort();});
     return symbol_bind(res, _fP_);
    }
   }
   function load_image(src){
    var img = createImg(document);
    function _fK_(param){return return$0(img);}
    var
     match = task(0),
     w = match[2],
     t = match[1],
   ...
   function default_language(param){
    function _fI_(param){
     function _fJ_(param){return cst_en;}
     var t126 = global.navigator;
     return get$0(t126.userLanguage, _fJ_);
    }
    var t124 = global.navigator;
    return get$0(t124.language, _fI_).substring(0, 2);
   }
   function _cB_(st){
    var x = st.getItem(cst_hyp_lang);
    return x == no_handler ? default_language(0) : x;
   }
   var language = [0, case$1(global.localStorage, default_language, _cB_)];
   console$0.log(language[1]);
   function local_messages(msgs){return option(msgs[language[1]]);}
   function screen_transform(canvas){
    var
     _fH_ = opt_style(style.padding, 0.),
     offset = opt_style(style.border, 0.5) + _fH_,
     w = canvas.width,
     h = canvas.height,
     rx = w / 2.,
     ry = h / 2.,
   ...
   function draw(canvas, vertices, edges, nodes, boxes){
    ...
    var
     t188 = canvas.getContext(cst_2d),
     transf = screen_transform(canvas),
     dy$1 = transf[4],
     dx$1 = transf[3],
     ry$1 = transf[2],
     rx$1 = transf[1];
    t188.clearRect(0., 0., canvas.width, canvas.height);
    var padding = opt_style(style.padding, 0.);
    t188.beginPath();
    t188.ellipse
     (dx$1, dy$1, rx$1 + padding, ry$1 + padding, 0., 0., 7., false$0);
    function _fm_(color){t188.fillStyle = color; return t188.fill();}
    iter$2(style.backgroundColor, _fm_);
    function _fn_(color){
     t188.lineWidth = 1.;
     t188.strokeStyle = color;
     return t188.stroke();
    }
    iter$2(style.boundaryColor, _fn_);
    t188.lineWidth = 2.;
    t188.lineCap = "round";
    var t201 = opt_style(style.treeColor, tree_color);
    t188.strokeStyle = t201;
    var
     ry$2 = transf[2],
     rx$2 = transf[1],
     _fp_ = edges.length - 1 - 1 | 0,
     _fo_ = 0;
    if(_fp_ >= 0){
     var i$0 = _fo_;
     for(;;){
      ...
      if(4. < rx$2 * ry$2 * (x * x + y * y)){
       ...
       if(Math.abs(d) < 0.05){
        var
         ...
         rx$0 = transf[1];
        t188.beginPath();
        t188.moveTo(z1[1] * rx$0 + dx$0, z1[2] * ry$0 + dy$0);
        t188.lineTo(z2[1] * rx$0 + dx$0, z2[2] * ry$0 + dy$0);
        t188.stroke();
       }
       else{
        var
      ...
      if(typeof img !== "number"){
       if(4204112 <= img[1]){
        ...
        function min_scale(l, w, h, s){
         var s$0 = [0, s], _fE_ = l.length - 1 - 1 | 0, _fD_ = 0;
         if(_fE_ >= 0){
          var i = _fD_;
          for(;;){
           var
            ...
            j = match[1],
            _fF_ = z[1],
            sx = Math.abs(caml_check_bound(vertices, j)[1 + j][1] - _fF_) / w,
        ...
        if(caml_obj_tag(img$0) !== 246){
         ...
         if(250 === _fv_)
          ...
          if(246 !== _fv_ && 244 !== _fv_){var _fw_ = img$0; break c;}
          var _fw_ = force_lazy_block(img$0);
         }
         var match$1 = poll(_fw_);
         if(match$1){
          var
           t205 = match$1[1],
           w$1 = t205.width,
           ...
           h$2 = h$1 * scale / 2.,
           _fx_ = 1. < w$2 ? 1 : 0,
           _fy_ = _fx_ ? 1. < h$2 ? 1 : 0 : _fx_;
          if(_fy_){
           var x$0 = z$0[1] * rx$2 + dx$1, y$0 = z$0[2] * ry$2 + dy$1;
           t188.drawImage(t205, x$0 - w$2, y$0 - h$2, 2. * w$2, 2. * h$2);
           ...
           var
            _fz_ = 2. <= w$2 ? 1 : 0,
            _fA_ = _fz_ ? 2. <= h$2 ? 1 : 0 : _fz_;
           if(_fA_) large_image_count[1]++;
          }
         }
        }
        else{
         ...
         if(1. < s$0 * max(rx$2, ry$2)){
          var _fB_ = caml_obj_tag(img$0);
          c:
          if(250 !== _fB_){
           if(246 !== _fB_ && 244 !== _fB_) break c;
       ...
       _ff_
        ? (need_redraw
          ...
          global.requestAnimationFrame
           (caml_js_wrap_callback
             (function(param){
               var _fh_ = need_redraw[1];
               return _fh_ ? perform_redraw(0) : _fh_;
              })),
          0)
        : _ff_;
    return _fg_;
   ...
   function compute_text_nodes(node_names, nodes){
    try{var _fa_ = assq(language[1], node_names)[1], names = _fa_;}
    catch(_fd_){
     var _eZ_ = caml_wrap_exception(_fd_);
     if(_eZ_ !== Not_found) throw caml_maybe_attach_backtrace(_eZ_, 0);
     try{var _e$_ = assq(cst_en, node_names)[1], _e1_ = _e$_;}
     catch(_fe_){
      var _e0_ = caml_wrap_exception(_fe_);
      if(_e0_ !== Not_found) throw caml_maybe_attach_backtrace(_e0_, 0);
      var _e1_ = create$0(0, 11);
     }
     var names = _e1_;
    }
    try{var _e__ = find(names, _cH_), _e3_ = _e__;}
    catch(_fc_){
     var _e2_ = caml_wrap_exception(_fc_);
     if(_e2_ !== Not_found) throw caml_maybe_attach_backtrace(_e2_, 0);
     var _e3_ = _cG_;
    }
    var t271 = caml_jsstring_of_string(_e3_);
    document.title = t271;
    var _e5_ = nodes.length - 1 - 1 | 0, _e4_ = 0;
    if(_e5_ >= 0){
     var i = _e4_;
     for(;;){
      var match = caml_check_bound(nodes, i)[1 + i], _e6_ = match[2];
      a:
      if(typeof _e6_ !== "number" && 4204112 === _e6_[1]){
       var
        match$0 = _e6_[2],
        info = match$0[3],
        is_root = match$0[1],
       ...
       try{
        var
         ...
         _eY_ = caml_obj_tag(text_size_div);
        b:
        if(250 === _eY_)
         var t116 = text_size_div[1];
        else{
         if(246 !== _eY_ && 244 !== _eY_){var t116 = text_size_div; break b;}
        ...
        var
         ...
         t256 = canvas.getContext(cst_2d),
         t255 = opt_style(style.nodeBackgroundColor, tree_color);
        t256.fillStyle = t255;
        var r = min(4., min(w$0, h$0) / 2.);
        t256.beginPath();
        t256.moveTo(0. + r, 0.);
        t256.arcTo(0. + w$0, 0., 0. + w$0, 0. + r, r);
        t256.arcTo(0. + w$0, 0. + h$0, 0. + w$0 - r, 0. + h$0, r);
        t256.arcTo(0., 0. + h$0, 0., 0. + h$0 - r, r);
        t256.arcTo(0., 0., 0. + r, 0., r);
        t256.fill();
        t256.font = font;
        var t261 = opt_style(style.nodeColor, "black");
        t256.fillStyle = t261;
        t256.textAlign = cst_center;
        t256.textBaseline = cst_middle;
        t256.fillText(caml_jsstring_of_string(info$0), w$0 / 2., h$0 / 2.);
        var _e9_ = [0, canvas], canvas$0 = _e9_;
       }
       catch(_fb_){
        var _e8_ = caml_wrap_exception(_fb_);
        if(_e8_ !== Not_found) throw caml_maybe_attach_backtrace(_e8_, 0);
        var canvas$0 = 0;
       }
   ...
   function weight_sum(l){
    var _eX_ = 0.;
    return fold_left(function(s, n){var w = n[1]; return s + w;}, _eX_, l);
   }
   ...
   function close_button(over){
    var
     ...
     t282 = canvas.getContext(cst_2d);
    t282.save();
    t282.lineWidth = 2.;
    t282.strokeStyle = color;
    if(over){t282.shadowBlur = 4.; t282.shadowColor = color;}
    t282.beginPath();
    t282.moveTo(6.82842712474619, 6.82842712474619);
    t282.lineTo(25.17157287525381, 25.17157287525381);
    t282.moveTo(6.82842712474619, 25.17157287525381);
    t282.lineTo(25.17157287525381, 6.82842712474619);
    t282.stroke();
    t282.restore();
    var _eW_ = over ? _cO_ : _cP_, t304 = caml_jsstring_of_string(_eW_);
   ...
   function img_button(href, h, src){
    function decoration(over){
     var t316 = createImg(document), t315 = icon(src);
     t316.src = t315;
     var t317 = createDiv(document), t319 = t317.style;
     t319.position = cst_absolute;
     var t322 = t317.style;
     t322.width = cst_38px;
     var
      t324 = caml_jsstring_of_string(symbol("" + max(38, h), _cQ_)),
      t325 = t317.style;
     t325.height = t324;
     var t328 = t317.style;
     t328.margin = cst_2px;
     ...
     var
      ...
      t333 =
        caml_jsstring_of_string
         (symbol
           ("" + (extra / 2 | 0),
            symbol(_cS_, symbol("" + (extra - (extra / 2 | 0) | 0), _cR_)))),
      t334 = t317.style;
     t334.padding = t333;
     var
      _eV_ = over ? _cT_ : _cV_,
      t335 = caml_jsstring_of_string(symbol(_cU_, _eV_));
     t317.className = t335;
    ...
    t341.width = cst_48px;
    var
     t343 = caml_jsstring_of_string(symbol("" + (8 + max(38, h) | 0), _cW_)),
     t344 = button.style;
    t344.height = t343;
    if(href){
     var t347 = href[1], t346 = createA(document);
   ...
   function tooltip(t354){
    var tooltip = createDiv(document), t351 = tooltip.style;
            ...
            (image_info,
             function(image_info){
              ...
              if(0 <= i[1]){
               var
                _eL_ = i[1],
                info = caml_check_bound(image_info, _eL_)[1 + _eL_];
               console$0.log(name, i[1]);
               var container = createDiv(document), t367 = container.style;
               t367.margin = "10px";
               ...
               var
                wrap =
                  function(elt){
                   var t398 = createDiv(document), t400 = t398.style;
                   ...
                   var
                    t417 = caml_jsstring_of_string(symbol("" + info[5], _cX_)),
                    t418 = t398.style;
                   t418.maxHeight = t417;
                   appendChild(t398, elt);
                   return t398;
                  },
                t449 = createImg(document),
                _eM_ = caml_obj_tag(small_image);
               a:
               if(250 === _eM_)
                var _eN_ = small_image[1];
               else{
                if(246 !== _eM_ && 244 !== _eM_){
                 var _eN_ = small_image;
                 break a;
                }
                var _eN_ = force_lazy_block(small_image);
               }
               var match = poll(_eN_);
               if(match){
                var
               ...
               if(match$0)
                ...
                var
                 t450 =
                   caml_jsstring_of_string(symbol(_c6_, symbol(name, _c5_)));
               t449.src = t450;
               var t452 = info[4];
               t449.width = t452;
               var t454 = info[5];
               ...
               var legend = createDiv(document), t481 = info[3];
               ...
               var buttons = createDiv(document), t542 = buttons.style;
               ...
               var
                suffix =
                  language[1] === cst_en
                   ? _cY_
                   : symbol(_c4_, caml_string_of_jsstring(language[1])),
                url$0 =
                  symbol
                   (_cZ_, symbol(caml_string_of_jsstring(info[2]), suffix)),
                commons =
                  img_button([0, caml_jsstring_of_string(url$0)], 52, _c0_),
                t550 =
                  tooltip
                   (opt_style
               ...
               var
                wikipedia = img_button(0, 34, _c1_),
                t569 = createDiv(document),
                count = [0, 0],
                dl = createDl(document),
                list =
                  function(title, lang){
                   var ul = createUl(document), empty = [0, 1], _eQ_ = info[6];
                   iter$0
                    (function(param){
                      var
                       refer = param[3],
                       lang$0 = param[2],
                       name = param[1],
                       _eS_ = lang$0 === lang ? 1 : 0;
                      if(! _eS_) return _eS_;
                      empty[1] = 0;
                      var t559 = createA(document);
                      ...
                      var
                       ...
                       url =
                         symbol
                          (_c3_,
                           symbol(caml_string_of_jsstring(lang), symbol(_c2_, _eT_))),
                ...
                _eO_ = language[1];
               list(opt_style(messages.language, cst_In_English), _eO_);
   ...
   function _cC_(s){return return$0(json.parse(caml_jsstring_of_string(s)));}
   var all_messages = symbol_bind(getfile(_cD_), _cC_);
   function _cL_(s){
    var
     ...
     iter$0
      (function(param){
        ...
        var
         ...
         nsize$0 = osize * 2 | 0,
         _eH_ = nsize$0 < max_array_length ? 1 : 0;
        if(! _eH_) return _eH_;
        var
         ndata = caml_make_vect(nsize$0, 0),
         _ey_ = h.length - 1 < 4 ? 1 : 0,
         _ez_ = _ey_ || (h[4] < 0 ? 1 : 0),
         inplace = 1 - _ez_;
        h[2] = ndata;
        var
    ...
    var
     node_names$0 =
       symbol$0
        (symbol$0(node_names, function(_ex_){return map(_d5_, _ex_);}),
         to_list);
         ...
         [0,
          ...
          [0,
           [246,
            function(param){
             function _ev_(param){
              function _ew_(img){schedule_redraw(0); return return$0(img);}
              return symbol_bind
                      (load_image
                        (caml_jsstring_of_string(symbol(_cF_, symbol(img, _cE_)))),
                       _ew_);
             }
             return symbol_bind(yield$0(0), _ev_);
            }],
           img]];
     else
    ...
    (current, current_weights, is_root, transf, lineWidth, dir){
     ...
     vi[1]++;
     var _es_ = transf[1];
     caml_check_bound(vertices, i$0)[1 + i$0] = _es_;
     var l$0 = ch.length - 1;
     if(0 === l$0)
      var ch$0 = [0];
     else{
      ...
      if(0 === l)
       ...
       var
        _em_ = caml_check_bound(ch_weights, 0)[1],
        r = caml_make_vect(l, f(caml_check_bound(ch, 0)[1], _em_)),
        _eo_ = l - 1 | 0,
        _en_ = 1;
       if(_eo_ >= 1){
        var i = _en_;
        for(;;){
         var
          _ep_ = caml_check_bound(ch_weights, i)[1 + i],
          _eq_ = f(caml_check_bound(ch, i)[1 + i], _ep_);
         caml_check_bound(r, i)[1 + i] = _eq_;
         var _er_ = i + 1 | 0;
         if(_eo_ === i) break;
         var i = _er_;
        }
    ...
    var
     tree = layout_rec(root, weights, 1, [0, zero, one], 6., _cK_),
    ...
    function compute_frontiers(node){
     ...
     if(0 === l.length - 1)
      var _eg_ = [0, status(i)], _eh_ = [0, [0, status(i)], _eg_];
     else
      var
       _ei_ = l.length - 1 - 1 | 0,
       _ej_ = caml_check_bound(l, _ei_)[1 + _ei_][1],
       _ek_ = caml_check_bound(frontiers, _ej_)[1 + _ej_][2],
       _el_ = caml_check_bound(l, 0)[1][1],
       _eh_ = [0, caml_check_bound(frontiers, _el_)[1 + _el_][1], _ek_];
     caml_check_bound(frontiers, i)[1 + i] = _eh_;
     return 0;
    }
    ...
    function compute_neigh(node, parent, lft, rght){
     ...
     caml_check_bound(neighboors, i)[1 + i] = _d6_;
     var
      ...
      for(;;){
       if(0 < j)
        var
         ...
         lft$0 = caml_check_bound(frontiers, _d__)[1 + _d__][2];
       else if(is_root)
        var
         _ee_ = n - 1 | 0,
         _ef_ = caml_check_bound(ch, _ee_)[1 + _ee_][1],
         lft$0 = caml_check_bound(frontiers, _ef_)[1 + _ef_][2];
       else
        var lft$0 = lft;
       if(j < (n - 1 | 0))
        var
         _d$_ = j + 1 | 0,
         _ea_ = caml_check_bound(ch, _d$_)[1 + _d$_][1],
         rght$0 = caml_check_bound(frontiers, _ea_)[1 + _ea_][1];
       else if(is_root)
        var
         _ed_ = caml_check_bound(ch, 0)[1][1],
         rght$0 = caml_check_bound(frontiers, _ed_)[1 + _ed_][1];
       else
        var rght$0 = rght;
       var _eb_ = [0, status(i)];
       compute_neigh(caml_check_bound(ch, j)[1 + j], _eb_, lft$0, rght$0);
       var _ec_ = j + 1 | 0;
       if(_d8_ === j) break;
       var j = _ec_;
      }
    ...
    var _d3_ = nodes.length - 1 - 1 | 0, _d2_ = 0;
    if(_d3_ >= 0){
     var i = _d2_;
     for(;;){
      var info = caml_check_bound(nodes, i)[1 + i][2];
   ...
   var tree_info = symbol_bind(getfile(tree_url), _cL_);
   function _cM_(s){return return$0(json.parse(caml_jsstring_of_string(s)));}
   var image_info = symbol_bind(getfile(_cN_), _cM_);
   function start(param){
    try{
                   ...
                   (all_messages,
                    function(all_messages){
                     ...
                     redraw_funct[1] =
                      function(param){
                       ...
                       var
                        ...
                        _d0_ = t687 !== element.width ? 1 : 0,
                        _d1_ = _d0_ || (t689 !== element.height ? 1 : 0);
                       if(_d1_){element.width = t687; element.height = t689;}
                       var
                        param$0 = tr$0[1],
                        t = param$0[2],
                        p = param$0[1],
                        c = mul(conj(p), t),
                        _dX_ = vertices.length - 1 - 1 | 0,
                        _dW_ = 0;
                       if(_dX_ >= 0){
                        var i = _dW_;
                        for(;;){
                         ...
                         caml_check_bound(vertices$0, i)[1 + i] = _dY_;
                         var _dZ_ = i + 1 | 0;
                         if(_dX_ === i) break;
                         var i = _dZ_;
                        }
                        ...
                        handler
                         (function(param){
                           var
                            ...
                            w = page.clientWidth,
                            h = page.clientHeight,
                            _dU_ = w !== element.width ? 1 : 0,
                            _dV_ = _dU_ || (h !== element.height ? 1 : 0);
                           if(_dV_) schedule_redraw(0);
                           return true$0;
                          });
                     ...
                     function find_box(boxes, x, y){
                      var
                       p = [0, -1],
                       _dP_ = boxes[3].length - 1 - 1 | 0,
                       _dO_ = 0;
                      if(_dP_ >= 0){
                       var i = _dO_;
                       for(;;){
                        var _dQ_ = 0. < boxes[3][1 + i] ? 1 : 0;
                        if(_dQ_)
                         var
                          _dR_ =
                              ...
                              handler
                               (function(t34){
                                 ...
                                 if(started[1]){
                                  ...
                                  a:
                                  if(0 < i){
                                   var _dK_ = caml_check_bound(nodes, i)[1 + i][2];
                                   if(typeof _dK_ !== "number" && 3654627 === _dK_[1]){
                                    var match = _dK_[2], name = match[2], img = match[1];
                      ...
                      (element,
                       ...
                       handler
                        (function(t39){
                                 ...
                                 (function(t45){
                                   ...
                                   if(_dB_ >= 0){
                                    ...
                                    for(;;){
                                     ...
                                     iter$2(t45.changedTouches.item(i), _dC_);
                                     var _dD_ = i + 1 | 0;
                                     if(_dB_ === i) break;
                                     var i = _dD_;
                                    }
                                 ...
                                 if(_dt_ >= 0){
                                  ...
                                  for(;;){
                                   var
                                    _du_ =
                                      function(touch){
                                       var _dw_ = touch.identifier === id ? 1 : 0;
                                       if(! _dw_) return _dw_;
                                       ...
                                       var i = find_box(boxes, x, y), _dx_ = 0 < i ? 1 : 0;
                                       if(_dx_){
                                        var _dy_ = caml_check_bound(nodes, i)[1 + i][2];
                                        if(typeof _dy_ !== "number" && 3654627 === _dy_[1]){
                                         var match = _dy_[2], name = match[2], img = match[1];
                                         show_image(all_messages, image_info, name, img);
                                         return 0;
                                        }
                                        var _dz_ = 0;
                                   ...
                                   iter$2(t56.changedTouches.item(i), _du_);
                                   var _dv_ = i + 1 | 0;
                                   if(_dt_ === i) break;
                                   var i = _dv_;
                                  }
                                   ...
                                   var
                                    _dp_ =
                                      function(touch){
                                       ...
                                       iter$1(c2[1], removeEventListener);
                                       iter$1(c3[1], removeEventListener);
                                       if(started[1]){var t77 = element.style; t77.cursor = cst$0;}
                                       tr[1] = tr$0[1];
                                       return 0;
                                      };
                                   iter$2(t67.changedTouches.item(i), _dp_);
                                   var _dq_ = i + 1 | 0;
                                   if(_do_ === i) break;
                                   var i = _dq_;
                                  }
                          ...
                          iter$2(t39.changedTouches.item(0), _dm_);
                          return false$0;
                         }),
                       true$0);
                     ...
                     function make_buttons(param){
                      ...
                      var buttons$0 = createDiv(document), t716 = buttons$0.style;
                      ...
                      var
                       t735 =
                         handler
                          (function(param){
                            try{var _dj_ = assq(language[1], tree_i18n)[2], info = _dj_;
                            }
                            catch(_dk_){
                             var _df_ = caml_wrap_exception(_dk_);
                             if(_df_ !== Not_found)
                              throw caml_maybe_attach_backtrace(_df_, 0);
                             try{var _di_ = assq(cst_en, tree_i18n)[2], _dh_ = _di_;}
                             catch(_dl_){
                              var _dg_ = caml_wrap_exception(_dl_);
                              if(_dg_ !== Not_found)
                               throw caml_maybe_attach_backtrace(_dg_, 0);
                              var _dh_ = information_en;
                             }
                             var info = _dh_;
                            }
                            var t591 = createDiv(document);
                            ...
                            t591.innerHTML = info;
                            var cell = createDiv(document), t602 = cell.style;
                            t602.display = cst_table_cell;
                            var t605 = cell.style;
                            t605.verticalAlign = cst_middle;
                            appendChild(cell, t591);
                            var table = createDiv(document), t608 = table.style;
                            t608.width = cst_100;
                      ...
                      var lang = img_button(0, 38, _c8_), t746 = lang.style;
                          ...
                          t760 =
                            handler
                             (function(param){
                               ...
                               function _de_(st){return st.setItem(cst_hyp_lang, lang);}
                               iter$2(global.localStorage, _de_);
                               language[1] = lang;
                               make_buttons(0);
                     ...
                     make_buttons(0);
                     var t802 = createImg(document), t801 = icon(_c__);
                     t802.src = t801;
                     var t804 = createA(document);
                     t804.target = cst_blank;
                     t804.href = "http://ocsigen.org/";
                     appendChild(t804, t802);
                     var logo = createDiv(document), t809 = logo.style;
     ...
     var _dc_ = caml_wrap_exception(_dd_);
     if(_dc_ !== Canvas_not_available)
      throw caml_maybe_attach_backtrace(_dc_, 0);
     var t632 = createDiv(document);
     ...
     var cell = createDiv(document), t643 = cell.style;
     t643.display = cst_table_cell;
     var t646 = cell.style;
     t646.verticalAlign = cst_middle;
     appendChild(cell, t632);
     var table = createDiv(document), t649 = table.style;
     t649.width = cst_100;
