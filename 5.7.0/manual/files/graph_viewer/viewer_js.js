...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gJ_ = caml_wrap_exception(_gK_);
      if(_gJ_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gJ_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    a:
    {
     ...
     var _gI_ = caml_ml_string_length(hd) + acc | 0;
    }
   ...
   function iteri(f, a){
    var _gG_ = a.length - 1 - 1 | 0, _gF_ = 0;
    if(_gG_ >= 0){
     var i = _gF_;
     for(;;){
   ...
   function _x_(Ord){
    ...
    function create(l, x, d, r){
     var
      hl = height(l),
      hr = height(r),
      _gE_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
     return [0, l, x, d, r, _gE_];
    }
    function bal(l, x, d, r){
     ...
     if((hr + 2 | 0) < hl){
      ...
      var lr = l[4], ld = l[3], lv = l[2], ll = l[1], _gz_ = height(lr);
      if(_gz_ <= height(ll)) return create(ll, lv, ld, create(lr, x, d, r));
      ...
      var
       ...
       lrv = lr[2],
       lrl = lr[1],
       _gA_ = create(lrr, x, d, r);
      return create(create(ll, lv, ld, lrl), lrv, lrd, _gA_);
     }
     if((hl + 2 | 0) >= hr){
      var _gD_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
      return [0, l, x, d, r, _gD_];
     }
     if(! r) return invalid_arg(_w_);
     var rr = r[4], rd = r[3], rv = r[2], rl = r[1], _gB_ = height(rl);
     if(_gB_ <= height(rr)) return create(create(l, x, d, rl), rv, rd, rr);
     ...
     var
      ...
      rlv = rl[2],
      rll = rl[1],
      _gC_ = create(rlr, rv, rd, rr);
     return create(create(l, x, d, rll), rlv, rld, _gC_);
    }
    var empty = 0;
   ...
   var at_exit_key = new_key(0, function(param, _gy_){return 0;});
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _gx_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _gx_];
                  case 10:
                   break a;
                  case 11:
                   break b;
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _gv_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _gv_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gw_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gw_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gw_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _gt_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _gt_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _gu_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _gu_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _gs_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _gs_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _gk_ = caml_ml_bytes_length(b) - 1 | 0,
     _gj_ = 0;
    if(_gk_ >= 0){
     var i$0 = _gj_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _gm_ = caml_ml_bytes_length(b) - 1 | 0, _gl_ = 0;
     if(_gm_ >= 0){
      var i = _gl_;
      for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _f$_ = _aE_; break;
      default: var _f$_ = _aN_;
    }
    return transform_int_alt(iconv, caml_int64_format(_f$_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _f8_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _f8_ >>> 0){
           if(55 === _f8_) break a;
          }
          else if(21 < _f8_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _f9_ = 1;
        }
        var _f__ = _f9_ ? str : symbol(str, _bc_);
        return caml_special_val(_f__);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _f4_ = l - 1 | 0, _f3_ = 0;
        if(_f4_ >= 0){
         var i = _f3_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _f5_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _f5_);
          var _f6_ = i + 1 | 0;
          if(_f4_ === i) break;
          var i = _f6_;
         }
       ...
       return caml_string_of_bytes(_f7_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _f2_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _f2_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _f2_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _f1_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _f1_);
     }
    }
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _fW_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bu_), _fV_, _fU_);
   }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       ...
       _fQ_ = field(e, 1),
       _fS_ = caml_call2(sprintf(_bv_), _fQ_, _fP_);
     else
      switch(match){
        case 0:
         var _fS_ = _bw_; break;
        case 1:
         var _fS_ = _bx_; break;
        default:
         var _fR_ = field(e, 1), _fS_ = caml_call1(sprintf(_by_), _fR_);
      }
    ...
    if(_fN_ >= 0){
     ...
     for(;;){
      ...
      function info(is_raise){
       return is_raise ? 0 === pos$0 ? _bE_ : _bF_ : 0 === pos$0 ? _bG_ : _bH_;
      }
      if(0 === slot[0])
       var
        _fE_ = slot[5],
        _fF_ = slot[4],
        _fG_ = slot[3],
        _fH_ = slot[6] ? _bI_ : _bK_,
        _fI_ = slot[2],
        _fJ_ = slot[7],
        _fK_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bJ_), _fK_, _fJ_, _fI_, _fH_, _fG_, _fF_, _fE_)];
      else if(slot[1])
       var match = 0;
      else
       var _fL_ = info(0), match = [0, caml_call1(sprintf(_bL_), _fL_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_fC_){}
      try{
       var _fs_ = to_string(exn$0);
       caml_call1(eprintf(_bO_), _fs_);
       ...
       var _fu_ = caml_ml_flush(stderr), _fy_ = _fu_;
      }
      catch(exn$1){
       var
       ...
       caml_call1(eprintf(_bQ_), _fw_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fx_ = to_string(exn);
       caml_call1(eprintf(_bR_), _fx_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _fy_ = caml_ml_flush(stderr);
      }
      var _fz_ = _fy_;
     }
     catch(_fB_){
      var _fv_ = caml_wrap_exception(_fB_);
      if(_fv_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_fv_, 0);
      var _fz_ = prerr_endline(_bP_);
     }
     return _fz_;
    }
    catch(_fA_){return 0;}
   ...
   function public_method_label(s){
    var accu = [0, 0], _fp_ = caml_ml_string_length(s) - 1 | 0, _fo_ = 0;
    if(_fp_ >= 0){
     var i = _fo_;
     for(;;){
      var _fq_ = caml_string_get(s, i);
      accu[1] = (223 * accu[1] | 0) + _fq_ | 0;
      var _fr_ = i + 1 | 0;
      if(_fp_ === i) break;
      var i = _fr_;
     }
   ...
   function new_table(pub_labels){
    ...
    var _fi_ = ((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
    caml_check_bound(methods, 1)[2] = _fi_;
    var _fk_ = len - 1 | 0, _fj_ = 0;
    if(_fk_ >= 0){
     var i = _fj_;
     for(;;){
      var
       _fm_ = (i * 2 | 0) + 3 | 0,
       _fl_ = caml_check_bound(pub_labels, i)[1 + i];
      caml_check_bound(methods, _fm_)[1 + _fm_] = _fl_;
      var _fn_ = i + 1 | 0;
      if(_fk_ === i) break;
      var i = _fn_;
     }
   ...
   function addEventListenerWithOptions(t28, typ, capture, once, passive, h){
    ...
    function callback(e){
     var _ff_ = [0, h, e, [0]];
     return function(_fg_, _fh_){return caml_js_call(_ff_, _fg_, _fh_);};
    }
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _fe_){return 0;},
     t41 = function(param, _fd_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _co_ = caml_wrap_exception(_fc_);
   ...
   function aux(ofs){
    try{
     ...
     a:
     {
      var c = 47;
      if(0 <= ofs && l >= ofs){
       var _fa_ = index_rec(path_string, l, ofs, c);
       break a;
      }
      var _fa_ = invalid_arg(_o_);
     }
     var j = _fa_;
    }
    catch(_fb_){
     var _e$_ = caml_wrap_exception(_fb_);
     if(_e$_ !== Not_found) throw caml_maybe_attach_backtrace(_e$_, 0);
     var j = l$0;
    }
    var
     len = j - ofs | 0,
         ...
         function(s){
          function _e9_(param){
           var
            y = param[2],
            x = param[1],
            _e__ = urldecode_js_string_string(y);
           return [0, urldecode_js_string_string(x), _e__];
          }
          var index = s.indexOf(caml_jsstring_of_string(make$0(1, 61)));
          if(0 <= index)
           var
            _e7_ = s.slice(index + 1 | 0),
            _e8_ = [0, s.slice(0, index), _e7_];
          else
           var _e8_ = undefined$0;
          return case$1(_e8_, interrupt, _e9_);
         };
      aux$0([0, case$1(arr[idx$0], interrupt, _e5_), acc], _e4_);
      return;
     }
     catch(_e6_){
      var _e3_ = caml_wrap_exception(_e6_);
      if(_e3_ !== Local_exn) throw caml_maybe_attach_backtrace(_e3_, 0);
   ...
   symbol(s$1, symbol(_dp_, git_version));
   var
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _e2_ = caml_call1(f, v); return _e2_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _e1_ = result[1] === Canceled ? 1 : 0, is_canceled = _e1_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      var _e0_ = deferred_callbacks[2];
      if(! _e0_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _e0_[1];
      if(_e0_[2]){
       var next = _e0_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _eZ_ = p[1];
    switch(_eZ_[0]){
      case 1:
       return _eZ_[1] === Canceled
               ? 0
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _eY_ = caml_call1(f, v), user_provided_promise = _eY_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
   ...
   (opt,
    ...
    if(_ev_) var sth$0 = _ev_[1], get_args = sth$0; else var get_args = 0;
    if(_eu_)
     var sth$1 = _eu_[1], check_headers = sth$1;
    else
     var check_headers = function(param, _eX_){return 1;};
    if(contents){
     var c$0 = contents[1], _ew_ = c$0[1];
     if(440620227 === _ew_){
      var args = c$0[2];
      a:
      {
       b:
       {
        ...
        for(;;){
         if(! param) break;
         var l = param[2], a = param[1], _ex_ = a[2];
         c:
         {
          if(typeof _ex_ !== "number" && -976970511 === _ex_[1]){var _eq_ = 1; break c;}
          var _eq_ = 0;
         }
         if(! _eq_) break b;
         var param = l;
      ...
      if(only_strings)
       ...
       var
        match =
          case$1
           (formData, function(param){return 0;}, function(x){return [0, x];});
       if(match)
        var constr = match[1], _ey_ = [0, 808620462, new constr];
       else
        var _ey_ = [0, 891486873, [0, 0]];
       var form_contents = _ey_;
      }
      iter
       (function(param){
         var
        ...
        args);
      var _ez_ = [0, -836918635, form_contents];
     }
     else if(737307005 <= _ew_)
      var b = c$0[2], _ez_ = [0, 737307005, b];
     else
      var _ez_ = c$0;
     var contents$0 = [0, _ez_];
    }
    else
     var contents$0 = 0;
          ...
          map
           (function(param){
             var
              v = param[2],
              n = param[1],
              _eW_ = symbol(_cm_, urlencode(0, v));
             return symbol(urlencode(0, n), _eW_);
            },
            get_args));
     try{
      index_rec(url, caml_ml_string_length(url), 0, 63);
      var _et_ = 1, _eB_ = _et_;
     }
     catch(_eV_){
      var _es_ = caml_wrap_exception(_eV_);
      if(_es_ !== Not_found) throw caml_maybe_attach_backtrace(_es_, 0);
      var _eB_ = 0;
     }
     var _eC_ = _eB_ ? _cU_ : _cV_, url$0 = symbol(url, symbol(_eC_, _er_));
    }
    var
     match$1 = task(0),
     w = match$1[2],
    ...
    function headers$0(s){
     function _eT_(v){return [0, caml_string_of_jsstring(v)];}
     function _eU_(param){return 0;}
     return case$0
             (req.getResponseHeader(caml_jsbytes_of_string(s)), _eU_, _eT_);
    }
    var st = [0, 382334108];
             ...
             switch(response_type){
               case 0:
                var
                 ...
                 e$1 = req.response,
                 _eR_ = e$1 instanceof arrayBuffer ? e$1 : no_handler,
                 response = [0, url$0, code, headers$0, _eR_, _eQ_];
                break;
               case 1:
                var
                 code$0 = req.status,
                 ...
                 e$0 = req.response,
                 _eP_ = e$0 instanceof blob_constr ? e$0 : no_handler,
                 response = [0, url$0, code$0, headers$0, _eP_, _eO_];
                break;
               case 2:
                var
                 code$1 = req.status,
                 ...
                 e = req.response,
                 _eM_ = e instanceof doc_constr ? e : no_handler,
                 response = [0, url$0, code$1, headers$0, _eM_, _eL_];
                break;
               case 3:
                var
                 code$2 = req.status,
                 ...
                 response = [0, url$0, code$2, headers$0, req.response, _eN_];
                break;
               case 4:
                var
                 code$3 = req.status,
                 ...
                 _eJ_ = function(x){return x;},
                 _eK_ = function(param){return cst$0;},
                 response =
                   [0,
                    url$0,
                    code$3,
                    headers$0,
                    case$0(req.responseText, _eK_, _eJ_),
                    _eI_];
                break;
               default:
                var
                 ...
                 _eG_ = caml_string_of_jsstring,
                 _eH_ = function(param){return _cG_;},
                 response =
                   [0,
                    url$0,
                    code$4,
                    headers$0,
                    case$0(req.responseText, _eH_, _eG_),
                    _eF_];
             }
    ...
    if(contents$0){
     var match$2 = contents$0[1], _eA_ = match$2[1];
     if(-836918635 === _eA_){
             ...
             map
              (function(param){
                ...
                if(781515420 <= match[1]){
                 ...
                 return symbol(urlencode(0, name), _eD_);
                }
                var
                 s = match[2],
                 _eE_ = symbol(_cD_, urlencode(0, caml_string_of_jsstring(s)));
                return symbol(urlencode(0, name), _eE_);
               },
               l$1))));
      }
   ...
   function put_pixmap(param, x, y, xsrc, ysrc, width, height, _ep_){
    var p = _ep_[1], c = param[2];
   ...
   function _c1_(st, scale, x$2, y$2, x$1, y$1, w, h){
    ...
    if(_el_) throw caml_maybe_attach_backtrace([0, Assert_failure, _c7_], 1);
    ctx.beginPath();
   ...
   function redraw(st, scale, x0, y0, window, a, x, y, width$0, height$0){
    ...
    a:
    {
     b:
     {
      ...
      var
       ...
       _eb_ = 0 !== dx ? 1 : 0,
       _ec_ = _eb_ || (0 !== dy ? 1 : 0);
      if(_ec_) put_pixmap(p, dx, dy, 0, 0, r$2[3], r$2[4], p);
      var
       offset =
         function(p, l, d, m){
          return 0 < ((p + d | 0) + l | 0)
    ...
    if(_d8_)
     ...
     if(_d$_)
      ...
      var
       _ea_ = r$0[3] < (x + width$0 | 0) ? 1 : 0,
       _d9_ = _ea_ || (r$0[4] < (y + height$0 | 0) ? 1 : 0);
    }
    if(_d9_){
     _c1_(st, scale, x0$2, y0$2, 0, 0, a[3], a[4]);
     pm[4] = [0, x0$2, y0$2, a[3], a[4]];
    }
    var _d__ = get_pixmap(pm);
    return put_pixmap
            (get_drawable(window), x, y, x, y, width$0, height$0, _d__);
   }
   var json = JSON;
   if(0 === public_methods)
   ...
   if(_b6_ >= 0){
    ...
    for(;;){
     ...
     try{var _b2_ = Meths[17].call(null, name$0, table$0[3]), _ca_ = _b2_;}
      ...
      var _b1_ = caml_wrap_exception(_d3_);
   ...
   if(_b8_ >= 0){
    ...
    for(;;){
     ...
     try{var _b4_ = Vars[17].call(null, name, table$0[7]), _b9_ = _b4_;}
      ...
      var _b3_ = caml_wrap_exception(_d2_);
   ...
   var
    ...
    methods =
      [0,
       ...
       _dd_,
       function(self_1){return self_1[1 + _df_];},
       _c9_,
       function(self_1){return self_1[1 + _dg_];},
       _c__,
       function(self_1){return self_1[1 + _dh_];},
       _dc_,
       function(self_1){return self_1[1 + _di_];},
       _db_,
       function(self_1){return self_1[1 + _dj_];},
       _c$_,
       function(self_1, v){self_1[1 + _de_] = v; return 0;},
       _da_,
    ...
    var
     ...
     next =
       function(param){
        i$2[1]++;
        var _d1_ = i$2[1];
        return caml_check_bound(methods, _d1_)[1 + _d1_];
       },
     clo = next(0);
     ...
     switch(clo){
       ...
       case 19:
        ...
        var
         element =
           function(obj){
            var _d0_ = caml_call1(obj[1][1 + m$10], obj);
            return caml_call2(obj[1][1 + n$22], obj, _d0_);
           };
        break;
       case 20:
       ...
       case 21:
        ...
        var
         element =
           function(obj){
            var _dZ_ = obj[1 + n$21];
            return caml_call1(caml_get_public_method(_dZ_, m$8, 0), _dZ_);
           };
        break;
       case 22:
        ...
        var
         element =
           function(obj){
            var _dY_ = obj[1 + e$5][1 + n$20];
            return caml_call1(caml_get_public_method(_dY_, m$7, 0), _dY_);
           };
        break;
       default:
        ...
        var
         element =
           function(obj){
            var _dX_ = caml_call1(obj[1][1 + n$19], obj);
            return caml_call1(caml_get_public_method(_dX_, m$6, 0), _dX_);
           };
     }
    else
     var element = clo;
    ...
    t185 =
      handler
       (function(param){
         ...
         function _dt_(param){
          if(1 - started[1]){var t116 = t109.style; t116.display = "inline";}
          return return$0(0);
         }
         ...
         function loop(d, param){
          ...
          var
           cb =
             remain == 0.
              ? callback
              : function(_dT_){return loop(remain, _dT_);};
         ...
         function _du_(s){
          var
           _dx_ = json.parse(caml_jsstring_of_string(s)),
           scene = _dx_[3],
           bboxes = _dx_[2],
           match = _dx_[1],
           y2 = match[4],
          ...
          var
           ...
           sadj = caml_call5(_cc_(0, 0)(0), _dn_, _dm_, _dl_, _dk_, 0);
          ...
          var height = 284, size = 16;
          function points(d){
           return caml_jsstring_of_string(caml_call1(sprintf(_do_), d));
          }
          var
           size_px = points(size),
           pos = [0, height],
          ...
          handle_drag
           (canvas,
            function(dx, dy){
             ...
             function offset(a, d){
              var
               _dH_ = caml_call1(caml_get_public_method(a, 307110897, 423), a),
               _dI_ =
           ...
           (canvas,
            ...
            handler
             (function(t176){
               ...
               get(t176.wheelDeltaX, _dC_);
               function _dD_(param){return t176.wheelDelta;}
               var
                dy = (- get(t176.wheelDeltaY, _dD_) | 0) / 40 | 0,
         ...
         try{
          var
           _ds_ = return$0(caml_read_file_content(cst_scene_json)),
           _dv_ = _ds_;
         }
         catch(_dw_){
          var _dr_ = caml_wrap_exception(_dw_);
          if(_dr_ !== Not_found) throw caml_maybe_attach_backtrace(_dr_, 0);
          var
           _dq_ =
             function(param){
