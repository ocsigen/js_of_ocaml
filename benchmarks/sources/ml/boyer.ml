...
type term = Var of int | Prop of head * term list

and head = {name: string; mutable props: (term * term) list}
...
let _ =
    ...
    (CProp
       ...
       , [ CProp ("compile", [CVar 5])
         ; CProp
             ...
             , [ CProp
                   ( "codegen"
                   , [CProp ("optimize", [CVar 5]); CProp ("nil", [])] ) ] ) ]
       )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("assume_true", [CVar 21; CVar 0])
         ; CProp
             ("cons", [CProp ("cons", [CVar 21; CProp ("true", [])]); CVar 0])
         ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp ("assume_false", [CVar 21; CVar 0])
         ; CProp
             ("cons", [CProp ("cons", [CVar 21; CProp ("false", [])]); CVar 0])
         ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp ("tautology_checker", [CVar 23])
         ; CProp
             ("tautologyp", [CProp ("normalize", [CVar 23]); CProp ("nil", [])])
         ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp ("falsify", [CVar 23])
         ; CProp
             ("falsify1", [CProp ("normalize", [CVar 23]); CProp ("nil", [])])
         ] )) ;
  add
    (CProp
       ( "equal"
    ...
    (CProp
       ...
       , [ CProp ("and", [CVar 15; CVar 16])
         ; CProp
             ...
             , [ CVar 15
               ; CProp
                   ("if", [CVar 16; CProp ("true", []); CProp ("false", [])])
               ; CProp ("false", []) ] ) ] )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("fix", [CVar 23])
         ; CProp
             ("if", [CProp ("numberp", [CVar 23]); CVar 23; CProp ("zero", [])])
         ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp
             ("if", [CProp ("if", [CVar 0; CVar 1; CVar 2]); CVar 3; CVar 4])
         ; CProp
             ( "if"
             , [ CVar 0
  ...
  add
    (CProp
       ( "equal"
       , [ CProp
             ("equal", [CProp ("plus", [CVar 0; CVar 1]); CProp ("zero", [])])
  ...
  add
    (CProp
       ...
       , [ CProp
             ( "equal"
             , [CProp ("zero", []); CProp ("difference", [CVar 23; CVar 24])]
             )
  ...
  add
    (CProp
       ...
       , [ CProp
             ( "meaning"
             , [ CProp ("plus_tree", [CProp ("append", [CVar 23; CVar 24])])
               ; CVar 0 ] )
         ; CProp
             ( "plus"
  ...
  add
    (CProp
       ...
       , [ CProp ("reverse", [CProp ("append", [CVar 0; CVar 1])])
         ; CProp
             ( "append"
             , [CProp ("reverse", [CVar 1]); CProp ("reverse", [CVar 0])] ) ]
       )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp
             ( "equal"
             , [CProp ("times", [CVar 23; CVar 24]); CProp ("zero", [])] )
         ; CProp
             ("or", [CProp ("zerop", [CVar 23]); CProp ("zerop", [CVar 24])])
         ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp
             ("exec", [CProp ("append", [CVar 23; CVar 24]); CVar 15; CVar 4])
         ; CProp
             ( "exec"
             , [CVar 24; CProp ("exec", [CVar 23; CVar 15; CVar 4]); CVar 4] )
         ] )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [CProp ("nth", [CProp ("zero", []); CVar 8]); CProp ("zero", [])] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp ("exp", [CVar 8; CProp ("plus", [CVar 9; CVar 10])])
         ; CProp
             ( "times"
             , [ CProp ("exp", [CVar 8; CVar 9])
               ; CProp ("exp", [CVar 8; CVar 10]) ] ) ] )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [ CProp
             ("count_list", [CVar 25; CProp ("sort_lp", [CVar 23; CVar 24])])
         ; CProp
             ( "plus"
    ...
    (CProp
       ...
       , [ CProp
             ...
             , [ CProp ("remainder", [CVar 23; CVar 24])
               ; CProp
                   ("times", [CVar 24; CProp ("quotient", [CVar 23; CVar 24])])
               ] )
         ; CProp ("fix", [CVar 23]) ] )) ;
  add
    (CProp
       ...
       , [ CProp
             ( "power_eval"
             , [CProp ("big_plus", [CVar 11; CVar 8; CVar 1]); CVar 1] )
         ...
         ; CProp
             ...
             , [ CProp ("not", [CProp ("zerop", [CVar 8])])
               ; CProp
                   ...
                   , [ CProp ("zerop", [CVar 9])
                     ; CProp
                         ("not", [CProp ("equal", [CVar 9; CProp ("one", [])])])
                     ] ) ] ) ] )) ;
  add
    (CProp
       ( "equal"
         ...
         ; CProp
             ...
             , [ CProp ("nth", [CVar 0; CVar 8])
               ; CProp
                   ...
                   , [ CVar 1
                     ; CProp
                         ("difference", [CVar 8; CProp ("length", [CVar 0])])
                     ] ) ] ) ] )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp
             ( "difference"
             , [ CProp ("plus", [CVar 1; CProp ("plus", [CVar 0; CVar 2])])
               ; CVar 0 ] )
  ...
  add
    (CProp
       ...
       , [ CProp
         ...
         ; CProp
             ( "and"
             , [ CProp ("nlistp", [CVar 23])
               ; CProp ("equal", [CVar 23; CVar 24]) ] ) ] )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("samefringe", [CVar 23; CVar 24])
         ; CProp
             ( "equal"
             , [CProp ("flatten", [CVar 23]); CProp ("flatten", [CVar 24])] )
         ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp
             ( "equal"
             , [ CProp ("greatest_factor", [CVar 23; CVar 24])
               ; CProp ("zero", []) ] )
         ; CProp
             ( "and"
             , [ CProp
  ...
  add
    (CProp
       ...
       , [ CProp ("times_list", [CProp ("append", [CVar 23; CVar 24])])
         ; CProp
             ( "times"
             , [ CProp ("times_list", [CVar 23])
               ; CProp ("times_list", [CVar 24]) ] ) ] )) ;
  add
    (CProp
       ( "equal"
       , [ CProp ("prime_list", [CProp ("append", [CVar 23; CVar 24])])
         ; CProp
             ( "and"
             , [ CProp ("prime_list", [CVar 23])
               ; CProp ("prime_list", [CVar 24]) ] ) ] )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [ CProp
             ("equal", [CProp ("times", [CVar 0; CVar 1]); CProp ("one", [])])
         ; CProp
             ( "and"
  ...
  add
    (CProp ("equal", [CProp ("dsort", [CVar 23]); CProp ("sort2", [CVar 23])])) ;
  add
    (CProp
       ( "equal"
       , [ CProp
  ...
  add
    (CProp
       ...
       , [ CProp
         ...
         ; CProp
             ( "plus"
             , [CVar 23; CProp ("quotient", [CVar 24; CProp ("two", [])])] ) ]
       )) ;
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp
             ( "meaning"
             , [ CProp ("plus_tree", [CProp ("delete", [CVar 23; CVar 24])])
               ; CVar 0 ] )
         ; CProp
             ( "if"
             , [ CProp ("member", [CVar 23; CVar 24])
               ; CProp
                   ( "difference"
                   , [ CProp
                         ("meaning", [CProp ("plus_tree", [CVar 24]); CVar 0])
...
(* if !ok then print_string "Proved!\n" else print_string "Cannot prove!\n";
   exit 0 *)

(********* with failure s -> print_string "Exception failure("; print_string s;
  print_string ")\n" | Unify -> print_string "Exception Unify\n" |
  match_failure(file,start,stop) -> print_string "Exception match_failure(";
  print_string file; print_string ","; print_int start; print_string ",";
  print_int stop; print_string ")\n" | _ -> print_string "Exception ?\n"
