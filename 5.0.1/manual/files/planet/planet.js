...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     _t_=caml_string_of_jsbytes("Map.remove_min_elt"),
     _u_=[0,0,0,0],
     _v_=[0,caml_string_of_jsbytes("map.ml"),400,10],
     _w_=[0,0,0],
     ...
     _H_=caml_string_of_jsbytes("%c"),
     _I_=caml_string_of_jsbytes("%s"),
     _J_=caml_string_of_jsbytes("%i"),
     _K_=caml_string_of_jsbytes("%li"),
     _L_=caml_string_of_jsbytes("%ni"),
     _M_=caml_string_of_jsbytes("%Li"),
     _N_=caml_string_of_jsbytes("%f"),
     ...
     _bY_=caml_int64_create_lo_mi_hi(14371852,15349651,22696),
     _bZ_=caml_int64_create_lo_mi_hi(12230193,11438743,35013),
     _b0_=caml_int64_create_lo_mi_hi(1424933,15549263,2083),
     _b1_=caml_int64_create_lo_mi_hi(9492471,4696708,43520),
     _bT_=caml_int64_create_lo_mi_hi(1,0,0),
     _bU_=caml_int64_create_lo_mi_hi(0,0,0),
     _bX_=caml_int64_create_lo_mi_hi(1,0,0),
     _bV_=caml_int64_create_lo_mi_hi(0,0,0),
     _bW_=caml_int64_create_lo_mi_hi(2,0,0),
     _cE_=caml_string_of_jsbytes("OCAMLRUNPARAM"),
     _cC_=caml_string_of_jsbytes("CAMLRUNPARAM"),
     _b2_=caml_string_of_jsbytes(""),
     _b4_=caml_string_of_jsbytes("Jsoo_runtime.Error.Exn"),
     _b5_=caml_string_of_jsbytes("jsError"),
     _cd_=caml_string_of_jsbytes("canvas"),
     _cb_=caml_string_of_jsbytes("img"),
     _ca_=caml_string_of_jsbytes("br"),
     _b$_=caml_string_of_jsbytes("p"),
     _b__=caml_string_of_jsbytes("div"),
     _b9_=caml_string_of_jsbytes("label"),
     _b8_=caml_string_of_jsbytes("input"),
     _b7_=caml_string_of_jsbytes("select"),
     _b6_=caml_string_of_jsbytes("option"),
     _cc_=caml_string_of_jsbytes("Js_of_ocaml__Dom_html.Canvas_not_available"),
     _cn_=[0,0],
     _co_=[0,1],
     _cl_=[0,0],
     _cm_=[0,1],
     ...
     _ch_=
      [0,
       ...
       caml_string_of_jsbytes("Lwt.%s")],
     _ci_=[0,0],
     _ce_=caml_string_of_jsbytes("Fatal error: exception "),
     _cf_=caml_string_of_jsbytes("Lwt.Resolution_loop.Canceled"),
     _cq_=caml_string_of_jsbytes("Exception during Lwt.async: "),
     _cB_=[0,[8,[0,0,0],0,[0,2],0],caml_string_of_jsbytes("%.2f")],
     _cv_=caml_string_of_jsbytes("Resume"),
     _cw_=caml_string_of_jsbytes("Pause"),
     _cx_=caml_string_of_jsbytes("Fixed position"),
     _cy_=caml_string_of_jsbytes("Follow rotation"),
     _cz_=caml_string_of_jsbytes("Lighting"),
     _cA_=caml_string_of_jsbytes("Clip"),
     _cu_=[0,caml_string_of_jsbytes("examples/planet/planet.ml"),428,2],
     _ct_=[0,caml_string_of_jsbytes("examples/planet/planet.ml"),429,2],
     _cs_=[0,caml_string_of_jsbytes("examples/planet/planet.ml"),430,2],
     _cr_=[0,caml_string_of_jsbytes("examples/planet/planet.ml"),431,2];
         ...
         {if(! param$0)return 0;
          ...
          try
           ...
           {_gW_ = caml_wrap_exception(_gW_);
            if(_gW_[1] !== Sys_error)throw _gW_}
          var param$0=l}}
     ...
     {var switch$0=0;
      if(0 <= ofs && 0 <= len && (caml_ml_bytes_length(b) - len | 0) >= ofs)
       {var r=caml_create_bytes(len);
        ...
        var _gV_=r;
        switch$0 = 1}
      if(! switch$0)var _gV_=invalid_arg(_k_);
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && l >= i)
       try
        {index_rec(s,l,i,c);var _gT_=1;return _gT_}
       catch(_gU_)
        {_gU_ = caml_wrap_exception(_gU_);
         if(_gU_ === Not_found)return 0;
         throw _gU_}
    ...
    function _x_(Ord)
     {function height(param){if(! param)return 0;var h=param[5];return h}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_gP_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gP_]}
      function singleton(x,d){return [0,0,x,d,0,1]}
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        if(r)var h$0=r[5],hr=h$0;else var hr=0;
        if((hr + 2 | 0) < hl)
         {if(! l)return invalid_arg(_q_);
          var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gK_=height(lr);
          if(_gK_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
          if(! lr)return invalid_arg(_p_);
          var lrr=lr[4],lrd=lr[3],lrv=lr[2],lrl=lr[1],_gL_=create(lrr,x,d,r);
          return create(create(ll,lv,ld,lrl),lrv,lrd,_gL_)}
        if((hl + 2 | 0) >= hr)
         {var _gO_=hr <= hl?hl + 1 | 0:hr + 1 | 0;return [0,l,x,d,r,_gO_]}
        if(! r)return invalid_arg(_s_);
        var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gM_=height(rl);
        if(_gM_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
        if(! rl)return invalid_arg(_r_);
        var rlr=rl[4],rld=rl[3],rlv=rl[2],rll=rl[1],_gN_=create(rlr,rv,rd,rr);
        return create(create(l,x,d,rll),rlv,rld,_gN_)}
      var empty=0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(! param$0)throw Not_found;
          var _gI_=param$0[1];
          if(_gI_){var param$0=_gI_;continue}
      ...
      function remove_min_binding(param)
       {if(! param)return invalid_arg(_t_);
        var _gG_=param[1];
        if(_gG_)
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _gw_=merge(f,r1,r2),
             _gx_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_gx_,_gw_)}}
        else
         if(! s2)return 0;
        if(! s2)throw [0,Assert_failure,_v_];
        var
         r2$0=s2[4],
         d2$0=s2[3],
         v2=s2[2],
         ...
         d1$0=match$0[2],
         l1$0=match$0[1],
         _gy_=merge(f,r1$0,r2$0),
         _gz_=caml_call3(f,v2,d1$0,[0,d2$0]);
        return concat_or_join(merge(f,l1$0,l2$0),v2,_gz_,_gy_)}
      ...
      function partition(p,param)
       {if(! param)return _w_;
        var
         ...
         rf=match$0[2],
         rt=match$0[1];
        if(pvd){var _gu_=concat(lf,rf);return [0,join(lt,v,d,rt),_gu_]}
        var _gv_=join(lf,v,d,rf);
        return [0,concat(lt,rt),_gv_]}
        ...
        for(;;)
         {if(! e1)return e2?0:1;
          ...
          var
           ...
           d1=e1[2],
           v1=e1[1],
           _gr_=0 === caml_call2(Ord[1],v1,v2)?1:0;
          if(_gr_)
           {var _gs_=caml_call2(cmp,d1,d2);
            if(_gs_)
             {var
      ...
      function cardinal(param)
       {if(! param)return 0;
        var r=param[4],l=param[1],_gq_=cardinal(r);
        return (cardinal(l) + 1 | 0) + _gq_ | 0}
      ...
      function seq_of_enum(c,param)
       {if(! c)return 0;
        var rest=c[4],t=c[3],v=c[2],k=c[1],_go_=cons_enum(t,rest);
        return [0,[0,k,v],function(_gp_){return seq_of_enum(_go_,_gp_)}]}
      function to_seq(m)
       {var _gm_=cons_enum(m,0);
        return function(_gn_){return seq_of_enum(_gm_,_gn_)}}
      ...
      function rev_seq_of_enum(c,param)
       {if(! c)return 0;
        var rest=c[4],t=c[3],v=c[2],k=c[1],_gk_=snoc_enum(t,rest);
        return [0,[0,k,v],function(_gl_){return rev_seq_of_enum(_gk_,_gl_)}]}
      function to_rev_seq(c)
       {var _gi_=snoc_enum(c,0);
        return function(_gj_){return rev_seq_of_enum(_gi_,_gj_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _gg_=c;
          return function(_gh_){return seq_of_enum(_gg_,_gh_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_ge_=q[3];
      return _ge_
              ?(q[1] = q[1] + 1 | 0,_ge_[2] = cell,q[3] = cell,0)
       ...
       {var split=split_from_parent[1],ki=[0,k,split];
        for(;;)
         {var l=caml_atomic_load(parent_keys);
          ...
          break}}
      return k}
    var param=new_key(0,function(param,_gd_){return 0});
      ...
      switch(formatting_lit[0])
       {case 0:var str=formatting_lit[1];return str;
        ...
        default:
         ...
         return cat(_G_,caml_string_of_bytes(make(1,c)))}}
       ...
       switch(ty1[0])
        {case 0:
         ...
         case 3:
          ...
          break;
         case 4:
          var switch$5=0,_fA_=ty1[1];
          if(typeof ty2 === "number")
           switch$5 = 1;
          else
           switch(ty2[0])
            {case 4:var rest2$3=ty2[1];return [4,trans(_fA_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_fB_=ty1[1];
          if(typeof ty2 === "number")
           switch$6 = 1;
          else
           switch(ty2[0])
            {case 5:var rest2$4=ty2[1];return [5,trans(_fB_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_fC_=ty1[1];
          if(typeof ty2 === "number")
           switch$7 = 1;
          else
           switch(ty2[0])
            {case 6:var rest2$5=ty2[1];return [6,trans(_fC_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_fD_=ty1[1];
          if(typeof ty2 === "number")
           switch$8 = 1;
          else
           switch(ty2[0])
            {case 7:var rest2$6=ty2[1];return [7,trans(_fD_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_fE_=ty1[2],_fF_=ty1[1];
          if(typeof ty2 === "number")
           switch$9 = 1;
          else
           switch(ty2[0])
            {case 8:
              var rest2$7=ty2[2],ty2$0=ty2[1],_fG_=trans(_fE_,rest2$7);
              return [8,trans(_fF_,ty2$0),_fG_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_fH_=ty1[3],_fI_=ty1[2],_fJ_=ty1[1];
          if(typeof ty2 === "number")
           switch$10 = 1;
          else
           switch(ty2[0])
         ...
         case 10:
          ...
          if(typeof ty2 !== "number" && 10 === ty2[0])
           {var rest2$9=ty2[1];return [10,trans(_fK_,rest2$9)]}
          throw [0,Assert_failure,_ai_];
         case 11:
          var switch$11=0,_fL_=ty1[1];
          if(typeof ty2 === "number")
           switch$11 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:var rest2$10=ty2[1];return [11,trans(_fL_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_aj_];
          break;
         case 12:
          var switch$12=0,_fM_=ty1[1];
          if(typeof ty2 === "number")
           switch$12 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=ty2[1];return [12,trans(_fM_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ak_];
          break;
         case 13:
          var switch$13=0,_fN_=ty1[1];
          if(typeof ty2 === "number")
           switch$13 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=ty2[1];return [13,trans(_fN_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_al_];
          break;
         default:
          var switch$14=0,_fO_=ty1[1];
          if(typeof ty2 === "number")
           switch$14 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=ty2[1];return [14,trans(_fO_,rest2$13)];
             default:switch$14 = 1}
    ...
    function string_to_caml_string(str$0)
     {var
       ...
       n=[0,0],
       _e4_=caml_ml_bytes_length(s$0) - 1 | 0,
       _e3_=0;
      if(_e4_ >= 0)
       {var i$0=_e3_;
        for(;;)
         {var match=caml_bytes_unsafe_get(s$0,i$0),switch$0=0;
          if(32 <= match)
           {var _e8_=match - 34 | 0,switch$1=0;
            if(58 < _e8_ >>> 0)
             {if(93 <= _e8_)switch$1 = 1}
            else
             if(56 < _e8_ - 1 >>> 0){switch$0 = 1;switch$1 = 1}
            if(! switch$1){var _e9_=1;switch$0 = 2}}
          else
           if(11 <= match)
            {if(13 === match)switch$0 = 1}
           else
            if(8 <= match)switch$0 = 1;
          switch(switch$0){case 0:var _e9_=4;break;case 1:var _e9_=2;break}
          n[1] = n[1] + _e9_ | 0;
          var _e__=i$0 + 1 | 0;
      ...
      if(n[1] === caml_ml_bytes_length(s$0))
       ...
       {var s=caml_create_bytes(n[1]);
        n[1] = 0;
        var _e6_=caml_ml_bytes_length(s$0) - 1 | 0,_e5_=0;
        if(_e6_ >= 0)
         {var i=_e5_;
          for(;;)
    ...
    function transform_int_alt(iconv,s)
     {if(13 > iconv)return s;
       ...
       {var i$0=_eX_;
        for(;;)
         {var match=caml_string_unsafe_get(s,i$0);
          if(9 >= match - 48 >>> 0)n[1]++;
          var _e2_=i$0 + 1 | 0;
          if(_eY_ !== i$0){var i$0=_e2_;continue}
          break}}
      var
       digits=n[1],
       buf=
      ...
      var
       ...
       _e0_=caml_ml_string_length(s) - 1 | 0,
       _eZ_=0;
      if(_e0_ >= 0)
       {var i=_eZ_;
        for(;;)
         {var c=caml_string_unsafe_get(s,i);
          ...
          var _e1_=i + 1 | 0;
          if(_e0_ !== i){var i=_e1_;continue}
          break}}
      return caml_string_of_bytes(buf)}
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _eW_=_ap_;break;
        case 2:var _eW_=_aq_;break;
        case 4:var _eW_=_as_;break;
        case 5:var _eW_=_at_;break;
        case 6:var _eW_=_au_;break;
        case 7:var _eW_=_av_;break;
        case 8:var _eW_=_aw_;break;
        case 9:var _eW_=_ax_;break;
        case 10:var _eW_=_ay_;break;
        case 11:var _eW_=_az_;break;
        case 0:
        case 13:var _eW_=_ao_;break;
        case 3:
        case 14:var _eW_=_ar_;break;
        default:var _eW_=_aA_}
      return transform_int_alt(iconv,caml_format_int(_eW_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _eV_=_aP_;break;
        case 2:var _eV_=_aQ_;break;
        case 4:var _eV_=_aS_;break;
        case 5:var _eV_=_aT_;break;
        case 6:var _eV_=_aU_;break;
        case 7:var _eV_=_aV_;break;
        case 8:var _eV_=_aW_;break;
        case 9:var _eV_=_aX_;break;
        case 10:var _eV_=_aY_;break;
        case 11:var _eV_=_aZ_;break;
        case 0:
        case 13:var _eV_=_aO_;break;
        case 3:
        case 14:var _eV_=_aR_;break;
        default:var _eV_=_a0_}
      return transform_int_alt(iconv,caml_format_int(_eV_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _eU_=_a2_;break;
        case 2:var _eU_=_a3_;break;
        case 4:var _eU_=_a5_;break;
        case 5:var _eU_=_a6_;break;
        case 6:var _eU_=_a7_;break;
        case 7:var _eU_=_a8_;break;
        case 8:var _eU_=_a9_;break;
        case 9:var _eU_=_a__;break;
        case 10:var _eU_=_a$_;break;
        case 11:var _eU_=_ba_;break;
        case 0:
        case 13:var _eU_=_a1_;break;
        case 3:
        case 14:var _eU_=_a4_;break;
        default:var _eU_=_bb_}
      return transform_int_alt(iconv,caml_format_int(_eU_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _eT_=_aC_;break;
        case 2:var _eT_=_aD_;break;
        case 4:var _eT_=_aF_;break;
        case 5:var _eT_=_aG_;break;
        case 6:var _eT_=_aH_;break;
        case 7:var _eT_=_aI_;break;
        case 8:var _eT_=_aJ_;break;
        case 9:var _eT_=_aK_;break;
        case 10:var _eT_=_aL_;break;
        case 11:var _eT_=_aM_;break;
        case 0:
        case 13:var _eT_=_aB_;break;
        case 3:
        case 14:var _eT_=_aE_;break;
        default:var _eT_=_aN_}
      return transform_int_alt(iconv,caml_int64_format(_eT_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _eQ_ >>> 0)
              {if(55 === _eQ_)switch$0 = 1}
             else
              if(21 < _eQ_ - 1 >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _eR_=1}
           var _eS_=_eR_?str:cat(str,_bc_);
           return caml_special_val(_eS_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_eM_=l - 1 | 0,_eL_=0;
           if(_eM_ >= 0)
            {var i=_eL_;
             for(;;)
              {var
                c=caml_bytes_unsafe_get(s,i),
                _eN_=25 < c - 97 >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_eN_);
               var _eO_=i + 1 | 0;
         ...
         return prec
                 ?function(p,x)
                   {var
                     str=
                      fix_padding
                       (_eJ_,_eI_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(x)
                   {var str=fix_padding(_eJ_,_eI_,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$0=prec[1];
        return function(x)
         {var
           str=
            fix_padding
             (_eJ_,_eI_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}
      var _eK_=pad[1];
      if(typeof prec === "number")
       return prec
               ?function(w,p,x)
                 {var
                   str=
                    fix_padding
                     (_eK_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                  return make_printf(k,[4,acc,str],fmt)}
               :function(w,x)
                 {var str=fix_padding(_eK_,w,caml_call2(trans,iconv,x));
                  return make_printf(k,[4,acc,str],fmt)};
      var p$1=prec[1];
      return function(w,x)
       {var
         str=
          fix_padding(_eK_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
        return make_printf(k,[4,acc,str],fmt)}}
        ...
        switch(fmt$0[0])
         {case 0:
            ...
            {if(typeof prec$3 === "number")
             ...
             return function(x)
              {var str=convert_float(fconv,p,x);
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
           if(0 === pad$5[0])
            {var _eE_=pad$5[2],_eF_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(p,x)
                        {var str=fix_padding(_eF_,_eE_,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_eF_,_eE_,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$0=prec$3[1];
             return function(x)
              {var str=fix_padding(_eF_,_eE_,convert_float(fconv,p$0,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
           var _eG_=pad$5[1];
           if(typeof prec$3 === "number")
            return prec$3
                    ?function(w,p,x)
                      {var str=fix_padding(_eG_,w,convert_float(fconv,p,x));
                       return make_printf(k$0,[4,acc$0,str],rest$7)}
                    :function(w,x)
                      {var
                        str=convert_float(fconv,default_float_precision(fconv),x),
                        str$0=fix_padding(_eG_,w,str);
                       return make_printf(k$0,[4,acc$0,str$0],rest$7)};
           var p$1=prec$3[1];
           return function(w,x)
            {var str=fix_padding(_eG_,w,convert_float(fconv,p$1,x));
             return make_printf(k$0,[4,acc$0,str],rest$7)};
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
             ...
             if(typeof _eH_[2] !== "number")throw Type_mismatch;
             var fmt=_eH_[1];
          ...
          default:
           ...
           if(counter >= 50)
            return caml_trampoline_return
                    (make_custom$0,[0,k$0,acc$0,rest$19,arity,_eD_]);
           var counter$0=counter + 1 | 0;
           return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_eD_)}}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _eA_=[8,acc,_bm_];
      if(counter >= 50)
       return caml_trampoline_return(make_printf$0,[0,k,_eA_,fmt]);
      var counter$0=counter + 1 | 0;
      return make_printf$0(counter$0,k,_eA_,fmt)}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_eu_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_eu_,fmt)}
    ...
    function field(x,i$1)
     {var a=x[1 + i$1];
      ...
      if(caml_obj_tag(a) !== 253)return _bs_;
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bu_;
      var _es_=other_fields(x,i + 1 | 0),_et_=field(x,i);
      return caml_call2(sprintf(_bv_),_et_,_es_)}
     ...
     {function conv(param)
       {var param$0=param;
        for(;;)
         {if(! param$0)return 0;
          ...
          try {var switch$0=0,val=caml_call1(hd,e);switch$0 = 1}catch(_er_){}
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _en_=other_fields(e,2),
          _eo_=field(e,1),
          _eq_=caml_call2(sprintf(_bw_),_eo_,_en_);
        else
         switch(match)
          {case 0:var _eq_=_bx_;break;
           case 1:var _eq_=_by_;break;
           default:var _ep_=field(e,1),_eq_=caml_call1(sprintf(_bz_),_ep_)}
        var match$1=[0,constructor,[0,_eq_]]}
      else
       var match$1=[0,e[1],0];
         ...
         {var
          ...
          if(0 === slot[0])
           var
            ...
            _ed_=slot[4],
            _ee_=slot[3],
            _ef_=slot[6]?_bJ_:_bL_,
            _eg_=slot[2],
            _eh_=slot[7],
            _ei_=info(slot[1]),
            match=
             [0,caml_call7(sprintf(_bK_),_ei_,_eh_,_eg_,_ef_,_ee_,_ed_,_ec_)];
          else
           if(slot[1])
            var match=0;
           else
            var _ej_=info(0),match=[0,caml_call1(sprintf(_bM_),_ej_)];
    ...
    function default_uncaught_exception_han(exn,raw_backtrace)
     {var _d$_=to_string(exn);
      caml_call1(eprintf(_bP_),_d$_);
     ...
     {try
       {try
         {var
          ...
          try {do_at_exit(0)}catch(_d__){}
          try
           {var
             _d6_=default_uncaught_exception_han(exn,raw_backtrace),
             _d5_=_d6_}
          catch(exn$0)
           {exn$0 = caml_wrap_exception(exn$0);
            var
             ...
             _d3_=to_string(exn);
            caml_call1(eprintf(_bR_),_d3_);
            print_raw_backtrace(stderr,raw_backtrace);
            var _d4_=to_string(exn$0);
            caml_call1(eprintf(_bS_),_d4_);
            print_raw_backtrace(stderr,raw_backtrace$0);
            var _d5_=caml_ml_flush(stderr)}
          var _d7_=_d5_}
        catch(_d9_)
         {_d9_ = caml_wrap_exception(_d9_);
          if(_d9_ !== Out_of_memory)throw _d9_;
          var _d7_=prerr_endline(_bQ_)}
        return _d7_}
      catch(_d8_){return 0}}
    caml_register_named_value
    ...
    function set(s,i1,i2,i3,i4)
     {caml_ba_set_1(s,0,caml_int64_or(i1,_bT_));
      caml_ba_set_1(s,1,i2);
      var i3$0=caml_notequal(i3,_bU_)?i3:_bX_;
      caml_ba_set_1(s,2,i3$0);
      var i4$0=caml_notequal(i4,_bV_)?i4:_bW_;
    ...
    function make_self_init(param)
     {var
      ...
      var
       d2=bytes(b),
       _dZ_=get_int64_le(d2,8),
       _d0_=get_int64_le(d2,0),
       _d1_=get_int64_le(d1,8);
      set(s,get_int64_le(d1,0),_d1_,_d0_,_dZ_);
      return s}
    function split(s)
     {var
       i1=caml_lxm_next(s),
    ...
    function mk_default(param){return mk(_b1_,_b0_,_bZ_,_bY_)}
    ...
    try
     ...
     {_dV_ = caml_wrap_exception(_dV_);
      ...
      try
       {var _cD_=caml_sys_getenv(_cC_),_b3_=_cD_}
      catch(_dW_)
    ...
    var Error=[248,_b4_,caml_fresh_oo_id(0)];
    register_exception(_b5_,[0,Error,[0]]);
      ...
      if(e.addEventListener === undefined$0)
       {var
         ...
         t35=
          function(e)
           {var _dS_=[0,h,e,[0]];
            return function(_dT_,_dU_){return caml_js_call(_dS_,_dT_,_dU_)}};
    ...
    function unsafeCreateElementEx(type,name,doc,elt)
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        var _dM_=createElementSyntax[1];
        if(785140586 === _dM_)
         {try
           {var
             el=t132.createElement('<input name="x">'),
             _dP_=el.tagName.toLowerCase() === "input"?1:0,
             _dQ_=_dP_?el.name === "x"?1:0:_dP_,
             _dN_=_dQ_}
          catch(_dR_){var _dN_=0}
          var _dO_=_dN_?982028505:-1003883683;
          createElementSyntax[1] = _dO_;
          continue}
        if(982028505 <= _dM_)
    ...
    function createInput(type,name,doc)
     {return unsafeCreateElementEx(type,name,doc,_b8_)}
    function createLabel(doc){return unsafeCreateElement(doc,_b9_)}
    function createDiv(doc){return unsafeCreateElement(doc,_b__)}
    var
     Canvas_not_available=[248,_cc_,caml_fresh_oo_id(0)],
     ...
     {var _dL_=p[1];
      switch(_dL_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_dL_[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _dJ_=caml_call1(f,v);return _dJ_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        return caml_call1(async_exception_hook[1],exn)}}
    var Canceled=[248,_cf_,caml_fresh_oo_id(0)];
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _dH_=result[1] === Canceled?1:0,is_canceled=_dH_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_dF_,0)}
      var _dG_=callbacks[1];
      ...
      return iter_callback_list$0(_dG_,0)}
    var
       ...
       for(;;)
        {if(0 !== q[1])
          {var _dD_=q[2];
           ...
           var _dE_=_dD_[1];
           if(_dD_[2])
            {var next=_dD_[2];q[1] = q[1] - 1 | 0;q[2] = next}
           else
            {q[1] = 0;q[2] = 0;q[3] = 0}
           var result=_dE_[2],callbacks=_dE_[1];
    ...
    function wakeup(r,v)
     {var p=underlying(r),_dC_=p[1];
      switch(_dC_[0])
       {case 1:
         return _dC_[1] === Canceled
                 ?0
                 :caml_call1(ksprintf(invalid_arg,_ch_),api_function_name);
        case 2:var result=[0,v];resolve(_ci_,0,p,result);return 0;
        default:
    ...
    function make_into_proxy(outer_promise,user_provided_promise)
     {var p=underlying(user_provided_promise);
      ...
      var _dB_=p[1];
      switch(_dB_[0])
       {case 1:return resolve(_ck_,0,outer_promise,p[1]);
        case 2:
         var
          p_callbacks=_dB_[1],
         ...
         var
          _dz_=p_callbacks[2],
          _dA_=outer_callbacks[2],
          cancel_callbacks=
           typeof _dA_ === "number"
            ?_dz_
            :typeof _dz_ === "number"?_dA_:[0,_dA_,_dz_];
        ...
        default:return resolve(_cj_,0,outer_promise,p[1])}}
      ...
      function create_result_promise_and_call(param)
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$2=underlying(p);resolve(_cl_,0,p$2,p_result);return 0}
          var v=p_result[1];
          current_storage[1] = saved_storage;
          try
           {var _dy_=caml_call1(f,v),p$0=_dy_}
       ...
       {case 1:return [0,_dw_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_cm_,function(param){return caml_call1(f,v)},_dx_)}}
    var pause_hook=[0,function(_dv_){return 0}],s1=create$1(0),_cp_=[0,0];
    ...
    function sleep(d)
     {var match=task(0),w=match[2],t=match[1],d$0=d * 1000.;
      function callback(_dt_){return wakeup(w,_dt_)}
      var id=[0,0];
      function loop(d,param)
       {if(2147483000. < d)
         ...
         var remain=0.,step=d;
        var
         cb=remain == 0.?callback:function(_ds_){return loop(remain,_ds_)},
         t125=caml_js_wrap_callback(cb);
        id[1] = [0,t2.setTimeout(t125,step)];
        return 0}
      loop(d$0,0);
      function f(param)
       {var _dr_=id[1];
        ...
        var x=_dr_[1];
        id[1] = 0;
        return t2.clearTimeout(x)}
      var p=underlying(t),_dp_=p[1];
      switch(_dp_[0])
       {case 1:
         if(_dp_[1] === Canceled)
          {var
    ...
    function matrix_mul(m$0,m)
     {var
       m$1=matrix_transp(m),
       _dm_=matrix_vect_mul(m$1,m$0[3]),
       _dn_=matrix_vect_mul(m$1,m$0[2]);
      return [0,matrix_vect_mul(m$1,m$0[1]),_dn_,_dm_]}
    ...
    function rotate_object(m,o)
     {var _dk_=o[2],_dl_=o[1];
      return [0,map(function(v){return matrix_vect_mul(m,v)},_dl_),_dk_]}
    function tesselate_sphere(p_div,t_div)
     {var
      ...
      var _c8_=p_div - 1 | 0,_c7_=0;
      if(_c8_ >= 0)
       {var i=_c7_;
        for(;;)
         {var _c__=t_div - 1 | 0,_c9_=0;
          if(_c__ >= 0)
           {var j=_c9_;
            for(;;)
             {var
              ...
              if(0 === j)
               {var
                 _db_=2 * k | 0,
                 _da_=[0,north,k,caml_mod(k + t_div | 0,north)];
               ...
               {var
                 _dg_=2 * k | 0,
                 _df_=[0,k,caml_mod(k + t_div | 0,north),k - 1 | 0];
                caml_check_bound(faces,_dg_)[1 + _dg_] = _df_;
                var
                 _dh_=caml_mod((k + t_div | 0) - 1 | 0,north),
                 _dj_=(2 * k | 0) + 1 | 0,
                 _di_=[0,k - 1 | 0,caml_mod(k + t_div | 0,north),_dh_];
                caml_check_bound(faces,_dj_)[1 + _dj_] = _di_}
              var _de_=j + 1 | 0;
              if(_c__ !== j){var j=_de_;continue}
              break}}
          var _c$_=i + 1 | 0;
    ...
    function create_canvas(w,h)
     {var t20=unsafeCreateElement(t132,_cd_);
    ...
    function draw(t103,img,shd,o,uv,normals,face_info,dir)
     {var _c6_=o[2],_c4_=_c6_.length - 1 - 1 | 0,_c3_=0;
      if(_c4_ >= 0)
       {var i=_c3_;
        for(;;)
         {var
    ...
    function start(param)
     {function _cI_(texture)
       {var
               ...
               {var i=_cZ_;
                for(;;)
                 {var
                  ...
                  data[k$0 + 3 | 0] = c$1;
                  var _c2_=i + 1 | 0;
                  if(_c0_ !== i){var i=_c2_;continue}
                  break}}
              var _c1_=j + 1 | 0;
              if(_cY_ !== j){var j=_c1_;continue}
              break}}
        ...
        function update_texture(lighting,phi)
         {if(lighting)
          ...
          var
           _cV_=1 - no_lighting[1],
           _cW_=_cV_?(t72.drawImage(texture,0.,0.),no_lighting[1] = 1,0):_cV_;
          return _cW_}
        var
          ...
          map
           (function(v$0)
             {var
              ...
              if(! (0. <= u))throw [0,Assert_failure,_cu_];
              if(! (u < tw))throw [0,Assert_failure,_ct_];
              if(! (0. <= v))throw [0,Assert_failure,_cs_];
        ...
        function br(param){return unsafeCreateElement(t132,_ca_)}
        add$0
         (form,toggle_button(_cw_,_cv_,function(p){paused[1] = p;return 0}));
        add$0(form,br(0));
        add$0
         (form,toggle_button(_cy_,_cx_,function(f){follow[1] = f;return 0}));
        add$0(form,br(0));
        ...
        var t126=unsafeCreateElementEx(0,0,t132,_b7_),param=param$0;
        for(;;)
         {if(param)
           {var
             l=param[2],
             a=param[1],
             t121=unsafeCreateElement(t132,_b6_),
          ...
          add$0(form$0,checkbox(_cz_,1,function(l){lighting[1] = l;return 0}));
          add$0(form$0,br(0));
          add$0(form$0,checkbox(_cA_,1,function(l){clipped[1] = l;return 0}));
          add$0(form$0,br(0));
          add$0(form$0,t132.createTextNode("Frames per second: "));
          add$0(form$0,rateText);
          add$0(t114,form$0);
          add$0(t132.body,t114);
          var t131=unsafeCreateElement(t132,_b$_);
          t131.innerHTML
          =
                    ...
                    handler
                     (function(ev)
                       {var
                        ...
                        if(0 !== dx)
                         {var _cT_=m[1];
                          m[1] = matrix_mul(xz_rotation(2. * dx / 600),_cT_)}
                        mx[1] = x;
                        my[1] = y;
                        return true$0}),
                    true$0),
           ...
           loop=
            function(t,phi)
             {var rotation=xz_rotation(phi - phi_rot[1]);
              ...
              var
               _cM_=matrix_mul(m_obliq[1],rotation),
               m$0=matrix_mul(m[1],_cM_),
              ...
              try {ctx.getImageData(0.,0.,1.,1.)}catch(_cR_){}
              var
              ...
              rateText.data
              =
              caml_jsstring_of_string(caml_call1(sprintf(_cB_),_cN_));
              ti[1] = t$0;
              function _cO_(param)
               {var
                 t182=new t183(),
                 ...
                 _cP_=1 - paused[1],
                 _cQ_=_cP_?follow[1]:_cP_;
                if(_cQ_)phi_rot[1] = phi_rot[1] + angle;
                var phi$0=paused[1]?phi:phi + angle;
                return loop(t$0,phi$0)}
              return symbol_bind(sleep(0.01),_cO_)},
           t184=new t183();
          return loop(t184.getTime(),0.)}}
      var v$0=unsafeCreateElement(t132,_cb_);
      function _cH_(param){return [0,[0,v$0]]}
      var
       match=task(0),
       w=match[2],
       t=match[1],
      ...
      var p=symbol_bind(symbol_bind(t,_cH_),_cI_),_cG_=underlying(p)[1];
      switch(_cG_[0])
       {case 1:var exn=_cG_[1];throw exn;
        case 2:
         var
          p_callbacks=_cG_[1],
          callback=
