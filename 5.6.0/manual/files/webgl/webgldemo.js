...
(function(globalThis){
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        return make_custom$0(counter$15, k$0, acc$0, rest$23, arity, _ff_);
     }
    }
   }
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_b$_, 0, outer_promise, p[1]);
      case 2:
       var
        p_callbacks = match[1],
      ...
      default: return resolve(_b__, 0, outer_promise, p[1]);
    }
   }
   ...
   function load_shader(t15, shader, text){
    ...
    return caml_call2(error(_ct_), caml_string_of_jsstring(text), _ee_);
   }
