...
(function(joo_global_object)
   {"use strict";
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_eY_ = caml_wrap_exception(_eY_);
              if(_eY_[1] !== Sys_error)throw _eY_;
              var _eX_=_eY_}
            var param$0=l;
            continue}
          return 0}}
     ...
     {var switch$0=0;
      if
       ...
       {var r=caml_create_bytes(len);
        ...
        var _eW_=r;
        switch$0 = 1}
      if(! switch$0)var _eW_=invalid_arg(_k_);
    ...
    function init(l,f)
     {if(0 === l)return [0];
      if(0 <= l)
       {var res=caml_make_vect(l,caml_call1(f,0)),_eU_=l - 1 | 0,_eT_=1;
        if(! (_eU_ < 1))
         {var i=_eT_;
          for(;;)
    ...
    function add(x,q)
     {var cell=[0,x,0],_eS_=q[3];
      return _eS_
              ?(q[1] = q[1] + 1 | 0,_eS_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_ex_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_ex_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_ey_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_ey_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_ez_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_ez_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
        ...
        return [0,function(param){return 0},_eb_,_ea_,_d$_]}
      else
       switch(param[0])
        {case 0:
          var
       ...
       {if(prec)
         {var _d__=match[2];
          if(typeof _d__ !== "number" && 2 === _d__[0])
           {var rest=_d__[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _d8_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_d8_))
             throw Type_mismatch;
            var _d9_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_d9_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _dP_=2 === padty$0?48:32,res=make(width$0,_dP_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _dN_ >>> 0)
           {if(33 < (_dN_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _dN_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _dG_=caml_ml_bytes_length(s$0) - 1 | 0,
           _dF_=0;
          if(! (_dG_ < 0))
           {var i$0=_dF_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _dK_=match - 34 | 0,switch$2=0;
                if(58 < _dK_ >>> 0)
                 {if(93 <= _dK_)switch$2 = 1}
                else
                 if(56 < (_dK_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _dL_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _dL_=4;break;case 1:var _dL_=2;break}
              n[1] = n[1] + _dL_ | 0;
              var _dM_=i$0 + 1 | 0;
              if(_dG_ !== i$0){var i$0=_dM_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _dI_=caml_ml_bytes_length(s$0) - 1 | 0,_dH_=0;
            if(! (_dI_ < 0))
             {var i=_dH_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _dO_=s}
          var str$0=caml_string_of_bytes(_dO_)}
         ...
         {var i$0=_dz_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _dE_=i$0 + 1 | 0;
            if(_dA_ !== i$0){var i$0=_dE_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _dC_=caml_ml_string_length(s) - 1 | 0,
         _dB_=0;
        if(! (_dC_ < 0))
         {var i=_dB_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _dy_=_ag_;break;
        case 2:var _dy_=_ah_;break;
        case 4:var _dy_=_aj_;break;
        case 5:var _dy_=_ak_;break;
        case 6:var _dy_=_al_;break;
        case 7:var _dy_=_am_;break;
        case 8:var _dy_=_an_;break;
        case 9:var _dy_=_ao_;break;
        case 10:var _dy_=_ap_;break;
        case 11:var _dy_=_aq_;break;
        case 0:
        case 13:var _dy_=_af_;break;
        case 3:
        case 14:var _dy_=_ai_;break;
        default:var _dy_=_ar_}
    ...
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _dw_=_aT_;break;
        case 2:var _dw_=_aU_;break;
        case 4:var _dw_=_aW_;break;
        case 5:var _dw_=_aX_;break;
        case 6:var _dw_=_aY_;break;
        case 7:var _dw_=_aZ_;break;
        case 8:var _dw_=_a0_;break;
        case 9:var _dw_=_a1_;break;
        case 10:var _dw_=_a2_;break;
        case 11:var _dw_=_a3_;break;
        case 0:
        case 13:var _dw_=_aS_;break;
        case 3:
        case 14:var _dw_=_aV_;break;
        default:var _dw_=_a4_}
    ...
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _dv_=_at_;break;
        ...
        case 8:var _dv_=_aA_;break;
        case 9:var _dv_=_aB_;break;
        case 10:var _dv_=_aC_;break;
        case 11:var _dv_=_aD_;break;
        case 0:
        case 13:var _dv_=_as_;break;
        case 3:
        case 14:var _dv_=_av_;break;
        default:var _dv_=_aE_}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _ds_ >>> 0)
              {if(55 === _ds_)switch$0 = 1}
             else
              if(21 < (_ds_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _dt_=1}
           var _du_=_dt_?str:symbol(str,_a5_);
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _dj_=pad$5[2],_dk_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_dk_,_dj_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_dk_,_dj_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_dk_,_dj_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _dl_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_dl_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_dl_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_dl_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_di_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_di_])}}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_dc_,_db_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_dc_,_db_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_dc_,_db_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _dd_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_dd_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_dd_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_dd_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_c8_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_c8_,fmt)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _c1_=other_fields(e,2),
          _c2_=field(e,1),
          _c4_=caml_call2(sprintf(_bn_),_c2_,_c1_);
        else
         switch(match)
          {case 0:var _c4_=_bo_;break;
           case 1:var _c4_=_bp_;break;
           default:var _c3_=field(e,1),_c4_=caml_call1(sprintf(_bq_),_c3_)}
        return symbol(constructor,_c4_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _cZ_=a.length - 1 - 1 | 0,_cY_=0;
        if(! (_cZ_ < 0))
         {var i=_cY_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call7(sprintf(_bB_),_cW_,_cV_,_cU_,_cT_,_cS_,_cR_,_cQ_)];
            else
             if(slot[1])
              var match=0;
             else
              var _cX_=info(0),match=[0,caml_call1(sprintf(_bD_),_cX_)];
