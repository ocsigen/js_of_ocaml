...
```
```ocaml
method powerPreference : Js_of_ocaml__.Js.js_string Js_of_ocaml__.Js.t
                           Js_of_ocaml__.Js.prop
```
`"default"`, `"low-power"` or `"high-performance"`.

```ocaml
method desynchronized : bool Js_of_ocaml__.Js.t Js_of_ocaml__.Js.prop
```
```ocaml
method xrCompatible : bool Js_of_ocaml__.Js.t Js_of_ocaml__.Js.prop
```
