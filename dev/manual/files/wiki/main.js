...
(function(globalThis){
   ...
   function engine(tbl, state, buf){
    var
     ...
     _ff_ = 0 <= result ? 1 : 0,
     _fg_ = _ff_ ? buf[12] !== dummy_pos ? 1 : 0 : _ff_;
    if(_fg_){
     buf[11] = buf[12];
     var _fh_ = buf[12];
     buf[12] = [0, _fh_[1], _fh_[2], _fh_[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
   ...
   var at_exit_key = new_key(0, function(param, _fe_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _eT_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _eT_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _eU_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _eU_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _eV_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _eV_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _eW_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _eW_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _eX_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _eX_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _eY_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _eY_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _eZ_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _eZ_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _e0_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _e0_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _e1_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _e1_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _e2_ = function(param){jd(0); de$8(0); return 0;},
         _e3_ = function(param){ed$8(0); dj(0); return 0;},
         _e4_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _e5_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _e5_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _e6_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _e6_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _e7_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _e7_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _e8_ = function(param){de$12(0); return 0;},
         _e9_ = function(param){ed$12(0); return 0;},
         _e__ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _e__, _e9_, _e8_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _e$_ = function(param){de$13(0); return 0;},
         _fa_ = function(param){ed$13(0); return 0;},
         _fb_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _fb_, _fa_, _e$_];
     }
    function _eQ_(param){return 0;}
    function _eR_(param){return 0;}
    function _eS_(param){return 0;}
    return [0, function(param){return 0;}, _eS_, _eR_, _eQ_];
   }
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_d$_){break b;}
   ...
   function push(c, v){
    var _dC_ = c[12];
    if(typeof _dC_ !== "number" && 1 === _dC_[0]){c[8] = [0, v, c[8]]; return 0;}
    var _dD_ = c[7];
   ...
   function style_change(c, style){
    ...
    return style ? push_string(c, _b__) : push_string(c, _b$_);
   }
        ...
        if(typeof stack !== "number")
         switch(stack[0]){
           ...
           case 4:
            ...
            if(0 === n){var correct = k === kind ? 1 : 0; break a;}
           ...
           for(;;){
            ...
            if(2 >= ocaml_lex_state$2 >>> 0)
             switch(ocaml_lex_state$2){
               ...
               default:
                var _dj_ = c[9]; c[9] = [0, lexeme(lexbuf), _dj_]; break b;
             }
            caml_call1(lexbuf[1], lexbuf);
   ...
   function parse_rem(counter, c, lexbuf){
    ...
    if(counter >= 50)
     return caml_trampoline_return
             (ocaml_lex_parse_rem_rec, [0, c, lexbuf, _db_]);
    var counter$0 = counter + 1 | 0;
    return ocaml_lex_parse_rem_rec(counter$0, c, lexbuf, _db_);
   }
      ...
      switch(ocaml_lex_state$1){
        ...
        case 4:
         ...
         var
          ...
          _c5_ = c[7],
          _c6_ = [0, caml_call1(c[1][1], addr), 0];
         c[7] = [0, caml_call2(c[1][7], addr, _c6_), _c5_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$2 = counter + 1 | 0;
         return parse_rem(counter$2, c, lexbuf);
        case 5:
         ...
         var
          ...
          _c7_ = c[7],
          _c8_ = [0, caml_call1(c[1][1], addr$0), 0];
         c[7] = [0, caml_call2(c[1][8], addr$0, _c8_), _c7_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$3 = counter + 1 | 0;
         return parse_rem(counter$3, c, lexbuf);
        ...
        case 8:
         ...
         var
          ...
          _c9_ = c[7],
          _c__ = [0, caml_call1(c[1][1], addr$3), 0];
         c[7] = [0, caml_call2(c[1][7], addr$3, _c__), _c9_];
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$6 = counter + 1 | 0;
        ...
        case 11:
         var
          ...
          _c$_ = caml_call1(c[1][1], txt),
          _da_ = [0, caml_call1(c[1][21], _c$_), 0];
         push(c, caml_call1(c[1][6], _da_));
         if(counter >= 50)
          return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
         var counter$8 = counter + 1 | 0;
     ...
     _c2_ =
       map
        (function(param){
          ...
          if(l) var v = l[1], _c3_ = [0, v, 0]; else var _c3_ = 0;
          var _c4_ = symbol$0(c, _c3_);
          return symbol$1(d.createElement("li"), _c4_);
         },
         c);
    return symbol$1(d.createElement(caml_jsstring_of_string(tag)), _c2_);
   }
           ...
           _c1_ =
             map
              (function(param){
               ...
               entries);
          return symbol$1(document.createElement("tr"), _c1_);
         },
         rows),
     _c0_ = [0, symbol$1(document.createElement("tbody"), rows$0), 0];
    return symbol$1(document.createElement("table"), _c0_);
   }
   ...
   function _cq_(s){return symbol$1(document.createElement("h6"), s);}
   function _cr_(s){return symbol$1(document.createElement("h5"), s);}
   function _cs_(s){return symbol$1(document.createElement("h4"), s);}
   function _ct_(s){return symbol$1(document.createElement("h3"), s);}
   function _cu_(s){return symbol$1(document.createElement("h2"), s);}
   function _cv_(s){return symbol$1(document.createElement("h1"), s);}
   function _cw_(s){
   ...
   function _cx_(s){return symbol$1(document.createElement("p"), s);}
   ...
   function _cB_(s){return symbol$1(document.createElement("tt"), s);}
   ...
   function _cE_(s){return symbol$1(document.createElement("em"), s);}
   function _cF_(s){return symbol$1(document.createElement("strong"), s);}
   var
    builder =
      [0,
       function(s){
    ...
    function dyn_preview(old_text, n){
     ...
     if(caml_string_notequal(text, old_text)){
      try{
       ...
       var
        _cS_ = rev(c[11]),
        rendered = symbol$1(createDiv(document), _cS_),
