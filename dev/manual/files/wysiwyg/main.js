...
(function(globalThis){
   ...
   function concat(sep, l){
    ...
    for(;;){
     if(param){
      ...
      var _fa_ = caml_ml_string_length(hd) + acc | 0;
     }
     else
      var _fa_ = acc;
     var dst = caml_create_bytes(_fa_), pos = pos$1, param$0 = l;
     for(;;){
      if(param$0){
       var hd$0 = param$0[1];
       if(param$0[2]){
   ...
   var at_exit_key = new_key(0, function(param, _e$_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _eO_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _eO_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _eP_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _eP_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _eQ_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _eQ_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _eR_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _eR_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _eS_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _eS_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _eT_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _eT_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _eU_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _eU_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _eV_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _eV_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _eW_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _eW_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _eX_ = function(param){jd(0); de$8(0); return 0;},
         _eY_ = function(param){ed$8(0); dj(0); return 0;},
         _eZ_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _e0_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _e0_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _e1_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _e1_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _e2_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _e2_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _e3_ = function(param){de$12(0); return 0;},
         _e4_ = function(param){ed$12(0); return 0;},
         _e5_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _e5_, _e4_, _e3_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _e6_ = function(param){de$13(0); return 0;},
         _e7_ = function(param){ed$13(0); return 0;},
         _e8_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _e8_, _e7_, _e6_];
     }
    function _eL_(param){return 0;}
    function _eM_(param){return 0;}
    function _eN_(param){return 0;}
    return [0, function(param){return 0;}, _eN_, _eM_, _eL_];
   }
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_d6_){break b;}
