...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _g0_ = caml_wrap_exception(_g1_);
      if(_g0_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_g0_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function iteri(f, a){
    var _gY_ = a.length - 1 - 1 | 0, _gX_ = 0;
    if(_gY_ >= 0){
     var i = _gX_;
     for(;;){
   ...
   function _z_(Ord){
    ...
    function create(l, x, d, r){
     var
      hl = height(l),
      hr = height(r),
      _gW_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
     return [0, l, x, d, r, _gW_];
    }
    ...
    function bal(l, x, d, r){
     ...
     if((hr + 2 | 0) < hl){
      ...
      var lr = l[4], ld = l[3], lv = l[2], ll = l[1], _gR_ = height(lr);
      if(_gR_ <= height(ll)) return create(ll, lv, ld, create(lr, x, d, r));
      ...
      var
       ...
       lrv = lr[2],
       lrl = lr[1],
       _gS_ = create(lrr, x, d, r);
      return create(create(ll, lv, ld, lrl), lrv, lrd, _gS_);
     }
     if((hl + 2 | 0) >= hr){
      var _gV_ = hr <= hl ? hl + 1 | 0 : hr + 1 | 0;
      return [0, l, x, d, r, _gV_];
     }
     if(! r) return invalid_arg(_u_);
     var rr = r[4], rd = r[3], rv = r[2], rl = r[1], _gT_ = height(rl);
     if(_gT_ <= height(rr)) return create(create(l, x, d, rl), rv, rd, rr);
     ...
     var
      ...
      rlv = rl[2],
      rll = rl[1],
      _gU_ = create(rlr, rv, rd, rr);
     return create(create(l, x, d, rll), rlv, rld, _gU_);
    }
    var empty = 0;
    ...
    function max_binding(param){
     ...
     for(;;){
      if(! param$0) throw caml_maybe_attach_backtrace(Not_found, 1);
      if(! param$0[4]){var d = param$0[3], v = param$0[2]; return [0, v, d];}
    ...
    function seq_of_enum(c, param){
     if(! c) return 0;
     var rest = c[4], t = c[3], v = c[2], k = c[1], _gy_ = cons_enum(t, rest);
     return [0, [0, k, v], function(_gz_){return seq_of_enum(_gy_, _gz_);}];
    }
    function to_seq(m){
     var _gw_ = cons_enum(m, 0);
     return function(_gx_){return seq_of_enum(_gw_, _gx_);};
    }
    ...
    function rev_seq_of_enum(c, param){
     if(! c) return 0;
     var rest = c[4], t = c[3], v = c[2], k = c[1], _gu_ = snoc_enum(t, rest);
     return [0,
             [0, k, v],
             function(_gv_){return rev_seq_of_enum(_gu_, _gv_);}];
    }
    function to_rev_seq(c){
     var _gs_ = snoc_enum(c, 0);
     return function(_gt_){return rev_seq_of_enum(_gs_, _gt_);};
    }
    function to_seq_from(low, m){
     ...
     for(;;){
      if(m$0){
       ...
       var _gq_ = c;
      return function(_gr_){return seq_of_enum(_gq_, _gr_);};
     }
    }
    return [0,
            empty,
   ...
   var at_exit_key = new_key(0, function(param, _go_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _f3_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _f3_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _f4_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _f4_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _f5_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _f5_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _f6_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _f6_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _f7_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _f7_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _f8_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _f8_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _f9_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _f9_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _f__ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _f__, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _f$_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _f$_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _ga_ = function(param){jd(0); de$8(0); return 0;},
         _gb_ = function(param){ed$8(0); dj(0); return 0;},
         _gc_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _gd_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _gd_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _ge_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _ge_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _gf_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _gf_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _gg_ = function(param){de$12(0); return 0;},
         _gh_ = function(param){ed$12(0); return 0;},
         _gi_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _gi_, _gh_, _gg_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _gj_ = function(param){de$13(0); return 0;},
         _gk_ = function(param){ed$13(0); return 0;},
         _gl_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _gl_, _gk_, _gj_];
     }
    function _f0_(param){return 0;}
    function _f1_(param){return 0;}
    function _f2_(param){return 0;}
    return [0, function(param){return 0;}, _f2_, _f1_, _f0_];
   }
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _fM_ = caml_ml_bytes_length(b) - 1 | 0,
     _fL_ = 0;
    if(_fM_ >= 0){
     var i$0 = _fL_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _fO_ = caml_ml_bytes_length(b) - 1 | 0, _fN_ = 0;
     if(_fO_ >= 0){
      var i = _fN_;
      for(;;){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fy_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fy_ >>> 0){
           if(55 === _fy_) break a;
          }
          else if(21 < _fy_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _fz_ = 1;
        }
        var _fA_ = _fz_ ? str : symbol(str, _be_);
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _fs_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _fs_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _fs_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _fr_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _fr_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _fo_ = [8, acc, _bn_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _fo_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _fo_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _fn_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _fn_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _fn_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _fm_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _fm_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _fk_ = other_fields(x, i + 1 | 0), _fl_ = field(x, i);
    return caml_call2(sprintf(_bw_), _fl_, _fk_);
   }
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_fj_){break b;}
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        _ff_ = other_fields(e, 2),
        _fg_ = field(e, 1),
        _fi_ = caml_call2(sprintf(_bx_), _fg_, _ff_);
      else
       switch(match){
         case 0:
          var _fi_ = _by_; break;
         case 1:
          var _fi_ = _bz_; break;
         default:
          var _fh_ = field(e, 1), _fi_ = caml_call1(sprintf(_bA_), _fh_);
       }
      var match$0 = [0, constructor, [0, _fi_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _e7_ = slot[4],
        _e8_ = slot[3],
        _e9_ = slot[6] ? _bK_ : _bM_,
        _e__ = slot[2],
        _e$_ = slot[7],
        _fa_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bL_), _fa_, _e$_, _e__, _e9_, _e8_, _e7_, _e6_)];
      else if(slot[1])
       var match = 0;
      else
       var _fb_ = info(0), match = [0, caml_call1(sprintf(_bN_), _fb_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_e4_){}
      try{
       var _eU_ = to_string(exn$0);
       caml_call1(eprintf(_bQ_), _eU_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _eV_ = abs(status);
        prerr_endline(caml_check_bound(errors, _eV_)[1 + _eV_]);
       }
       var _eW_ = caml_ml_flush(stderr), _e0_ = _eW_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _eY_ = to_string(exn$0);
       caml_call1(eprintf(_bS_), _eY_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eZ_ = to_string(exn);
       caml_call1(eprintf(_bT_), _eZ_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _e0_ = caml_ml_flush(stderr);
      }
      var _e1_ = _e0_;
     }
     catch(_e3_){
      var _eX_ = caml_wrap_exception(_e3_);
      if(_eX_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_eX_, 0);
      var _e1_ = prerr_endline(_bR_);
     }
     return _e1_;
    }
    catch(_e2_){return 0;}
   ...
   function public_method_label(s){
    var accu = [0, 0], _eR_ = caml_ml_string_length(s) - 1 | 0, _eQ_ = 0;
    if(_eR_ >= 0){
     var i = _eQ_;
     for(;;){
      var _eS_ = caml_string_get(s, i);
      accu[1] = (223 * accu[1] | 0) + _eS_ | 0;
      var _eT_ = i + 1 | 0;
      if(_eR_ === i) break;
      var i = _eT_;
     }
   ...
   function new_table(pub_labels){
    ...
    var _eK_ = ((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
    caml_check_bound(methods, 1)[2] = _eK_;
    var _eM_ = len - 1 | 0, _eL_ = 0;
    if(_eM_ >= 0){
     var i = _eL_;
     for(;;){
      var
       _eO_ = (i * 2 | 0) + 3 | 0,
       _eN_ = caml_check_bound(pub_labels, i)[1 + i];
      caml_check_bound(methods, _eO_)[1 + _eO_] = _eN_;
      var _eP_ = i + 1 | 0;
      if(_eM_ === i) break;
      var i = _eP_;
     }
   ...
   function resize$0(array, new_size){
    var old_size = array[2].length - 1, _eI_ = old_size < new_size ? 1 : 0;
    if(_eI_){
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _co_ = caml_wrap_exception(_eC_);
   ...
   if(a$0 && ! caml_string_notequal(a$0[1], cst$2)){
    var _cn_ = a$0[2];
    if(! _cn_ || ! caml_string_notequal(_cn_[1], cst$2) && ! _cn_[2]) break a;
   }
   var
    ...
    for(;;){
     ...
     try{
      var
       ...
       _et_ = aux$0([0, case$1(arr[idx$0], interrupt, _es_), acc], _er_);
      return _et_;
     }
     catch(_eu_){
      var _eq_ = caml_wrap_exception(_eu_);
      if(_eq_ !== Local_exn) throw caml_maybe_attach_backtrace(_eq_, 0);
   ...
   symbol(s$1, symbol(_db_, git_version));
   var
    console$0 = caml_js_get_console(0),
    compare$2 = caml_compare,
    Storage_map = _z_([0, compare$2]);
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _ep_ = caml_call1(f, v); return _ep_;}
    catch(exn$0){
   ...
   function run_in_resolution_loop(f){
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      ...
      if(! _en_) throw caml_maybe_attach_backtrace(Empty, 1);
      var content = _en_[1];
      if(_en_[2]){
       var next = _en_[2];
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _el_ = caml_call1(f, v), user_provided_promise = _el_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_cz_, function(param){return caml_call1(f, v);}, _ek_);
    }
   }
   ...
   function put_pixmap(param, x, y, xsrc, ysrc, width, height, _ei_){
   ...
   function _cG_(st, scale, x$2, y$2, x$1, y$1, w, h){
    var ctx = get_pixmap(st[8])[2];
    ctx.save();
    var
     _ed_ = 0 === st[1].length - 1 ? 1 : 0,
     _ee_ = _ed_ ? 0 < st[2].length - 1 ? 1 : 0 : _ed_;
    if(_ee_) throw caml_maybe_attach_backtrace([0, Assert_failure, _cM_], 1);
    ctx.beginPath();
   ...
   function redraw(st, scale, x0, y0, window, a, x, y, width$0, height$0){
    ...
    a:
    {
     b:
     {
      ...
      var
       ...
       _d6_ = 0 !== dx ? 1 : 0,
       _d7_ = _d6_ || (0 !== dy ? 1 : 0);
      if(_d7_) put_pixmap(p, dx, dy, 0, 0, r$2[3], r$2[4], p);
      var
       offset =
         function(p, l, d, m){
          return 0 < ((p + d | 0) + l | 0)
      ...
      if(0 < height$2)
       if(0 < x$0){
        ...
        _cG_(st, scale, x0$2, y0$2, 0, y$0, x$0, height$2);
       }
       else{
        if(0 !== x$0)
      ...
      if(0 < y$0){
       ...
       _cG_(st, scale, x0$2, y0$2, 0, 0, a[3], y$0);
      }
      else{
       if(0 !== y$0)
        throw caml_maybe_attach_backtrace([0, Assert_failure, _cJ_], 1);
       if(height$2 < a[4])
        _cG_(st, scale, x0$2, y0$2, 0, height$2, a[3], a[4] - height$2 | 0);
      }
    ...
    if(_d1_)
     ...
     if(_d4_)
      ...
      var
       _d5_ = r$0[3] < (x + width$0 | 0) ? 1 : 0,
       _d2_ = _d5_ || (r$0[4] < (y + height$0 | 0) ? 1 : 0);
    }
    if(_d2_){
     _cG_(st, scale, x0$2, y0$2, 0, 0, a[3], a[4]);
     pm[4] = [0, x0$2, y0$2, a[3], a[4]];
    }
    var _d3_ = get_pixmap(pm);
    return put_pixmap
            (get_drawable(window), x, y, x, y, width$0, height$0, _d3_);
   }
   var json = JSON;
   if(0 === public_methods)
   ...
   if(_b8_ >= 0){
    ...
    for(;;){
     ...
     try{var _b4_ = Meths[28].call(null, name$0, table$0[3]), _cc_ = _b4_;}
      ...
      var _b3_ = caml_wrap_exception(_dW_);
   ...
   if(_b__ >= 0){
    ...
    for(;;){
     ...
     try{var _b6_ = Vars[28].call(null, name, table$0[7]), _b$_ = _b6_;}
      ...
      var _b5_ = caml_wrap_exception(_dV_);
   ...
   var
    ...
    _cT_ = res[7],
    _cU_ = res[8];
   function _c1_(self_1, lower, upper, step_incr, page_incr, page_size, param){
    if(lower){var v = lower[1]; self_1[1 + _cW_] = v;}
    if(upper){var v$0 = upper[1]; self_1[1 + _cX_] = v$0;}
    if(step_incr){var v$1 = step_incr[1]; self_1[1 + _cY_] = v$1;}
    if(page_incr){var v$2 = page_incr[1]; self_1[1 + _cZ_] = v$2;}
    if(! page_size) return 0;
    var v$3 = page_size[1];
    self_1[1 + _c0_] = v$3;
    return 0;
   }
   function _c2_(self_1, v){self_1[1 + _cV_] = v; return 0;}
   function _c3_(self_1){return self_1[1 + _c0_];}
   function _c4_(self_1){return self_1[1 + _cZ_];}
   function _c5_(self_1){return self_1[1 + _cY_];}
   function _c6_(self_1){return self_1[1 + _cX_];}
   function _c7_(self_1){return self_1[1 + _cW_];}
   var
    methods =
      [0,
       _cN_,
       function(self_1){return self_1[1 + _cV_];},
       _cU_,
       _c7_,
       _cO_,
       _c6_,
     ...
     var
      ...
      next =
        function(param){
         i$2[1]++;
         var _dg_ = i$2[1];
         return caml_check_bound(methods, _dg_)[1 + _dg_];
        },
      clo = next(0);
        ...
        case 19:
         var
          ...
          element =
            function(n, m){
              return function(obj){
               var _de_ = caml_call1(obj[1][1 + m], obj);
               return caml_call2(obj[1][1 + n], obj, _de_);};
             }
             (n$15, m$1);
         break;
        case 20:
        ...
        default:
         ...
         var
          element =
            function(m, n){
              return function(obj){
               var _df_ = caml_call1(obj[1][1 + n], obj);
          ...
          handler
           (function(param$0){
             ...
             var
              ...
              t = match$0[1],
              d = 500.;
             function callback(_dS_){return wakeup(w$0, _dS_);}
             var id = [0, 0];
             function loop(d, param){
              ...
              var
               cb =
                 remain == 0.
                  ? callback
                  : function(_dR_){return loop(remain, _dR_);};
             ...
             function _dl_(s){
              var
               _dv_ = json.parse(caml_jsstring_of_string(s)),
               scene = _dv_[3],
               bboxes = _dv_[2],
               match = _dv_[1],
               y2 = match[4],
              ...
              var
               ...
               sadj = caml_call5(_ce_(0, 0)(0), _c$_, _c__, _c9_, _c8_, 0);
              function get_scale(param){
               var _dQ_ = st[3];
               return Math.pow
                       (2.,
                        caml_call1
                         (caml_get_public_method(sadj, 834174833, 369), sadj)
                        / 8.)
                      / _dQ_;
              }
              ...
              function update_view(force){
               ...
               var
                _dL_ =
                  caml_call1
                   (caml_get_public_method(hadj, 307110897, 371), hadj),
                mv = st[6] - _dL_;
               if
                (caml_call1
                  (caml_get_public_method(hadj, 834174833, 372), hadj)
                 < 0.)
                caml_call2
               ...
               if
                (mv
                 <
                  caml_call1
                   (caml_get_public_method(hadj, 834174833, 374), hadj))
                caml_call2
                 (caml_get_public_method(hadj, -659372076, 375), hadj, mv);
               var _dM_ = [0, min(ah, st[7])];
               caml_call7
               ...
               var
                _dN_ =
                  caml_call1
                   (caml_get_public_method(vadj, 307110897, 377), vadj),
                mv$0 = st[7] - _dN_;
               if
                (caml_call1
                  (caml_get_public_method(vadj, 834174833, 378), vadj)
                 < 0.)
                caml_call2
               ...
               if
                (mv$0
                 <
                  caml_call1
                   (caml_get_public_method(vadj, 834174833, 380), vadj))
                caml_call2
                 (caml_get_public_method(vadj, -659372076, 381), vadj, mv$0);
               var
                _dO_ = 1 - redraw_queued[1],
                _dP_ =
                  _dO_
                   ? (redraw_queued
                      [1]
                      ...
                      (caml_js_wrap_callback
                        (function(param){
                          ...
                          var
                           v =
                             caml_call1
                              (caml_get_public_method(vadj, 834174833, 383), vadj),
                           h =
                             caml_call1
                              (caml_get_public_method(hadj, 834174833, 384), hadj),
                           s = get_scale(0),
                           width = canvas.width,
              ...
              function rescale(x, y){
               var
                ...
                _dI_ =
                  caml_call1
                   (caml_get_public_method(hadj, 307110897, 385), hadj)
                  * r
                  * x;
               caml_call2
                (caml_get_public_method(hadj, -659372076, 387),
                 hadj,
                 caml_call1
                  (caml_get_public_method(hadj, 834174833, 386), hadj)
                 + _dI_);
               var
                _dJ_ =
                  caml_call1
                   (caml_get_public_method(vadj, 307110897, 388), vadj)
                  * r
                  * y;
               caml_call2
                (caml_get_public_method(vadj, -659372076, 390),
                 vadj,
                 caml_call1
                  (caml_get_public_method(vadj, 834174833, 389), vadj)
                 + _dJ_);
               prev_scale[1] = scale;
               var p = st[8];
               p[4] = empty_rectangle;
              ...
              function points(d){
               return caml_jsstring_of_string(caml_call1(sprintf(_da_), d));
              }
              var
               size_px = points(size),
               pos = [0, height],
              ...
              function set_slider_position(pos$0){
               ...
               caml_call2
                 ...
                 *
                  caml_call1
                   (caml_get_public_method(sadj, 675223906, 410), sadj)
                 / 284);
               ...
               (canvas,
                function(dx, dy){
                 ...
                 function offset(a, d){
                  var
                   _dF_ =
                     caml_call1(caml_get_public_method(a, 307110897, 424), a),
                   _dG_ =
              ...
              function bump_scale(x, y, v){
               var
                ...
                prev =
                  caml_call1
                   (caml_get_public_method(sadj, 834174833, 428), sadj),
                _dD_ =
                  prev
                  +
                   v
                   *
                    caml_call1
                     (caml_get_public_method(sadj, -292814788, 429), sadj),
                _dE_ =
                  max
                   (caml_call1
                ...
                vl =
                  min
                   (caml_call1
                     (caml_get_public_method(sadj, 675223906, 431), sadj),
                    _dE_);
               a:
               if(vl != prev){
                caml_call2
                ...
                var
                 _dC_ =
                   caml_call1
                    (caml_get_public_method(sadj, 675223906, 414), sadj),
                 pos$0 =
                   284
                   -
                    (caml_call1
                     (caml_get_public_method(sadj, 834174833, 415), sadj)
                    * 284
                    / _dC_
                    + 0.5
                    | 0)
               ...
               (canvas,
                ...
                handler
                 (function(t176){
                   ...
                   get(t176.wheelDeltaX, _dA_);
                   function _dB_(param){return t176.wheelDelta;}
                   var
                    dy = (- get(t176.wheelDeltaY, _dB_) | 0) / 40 | 0,
               ...
               switch(switcher){
                 case 0:
                  var
                   _dw_ =
                     caml_call1
                      (caml_get_public_method(hadj, -292814788, 436), hadj);
                  caml_call2
                   (caml_get_public_method(hadj, -659372076, 438),
                    hadj,
                    caml_call1
                     (caml_get_public_method(hadj, 834174833, 437), hadj)
                    - _dw_);
                  update_view(0);
                  return false$0;
                 case 1:
                  var
                   _dx_ =
                     caml_call1
                      (caml_get_public_method(vadj, -292814788, 439), vadj);
                  caml_call2
                   (caml_get_public_method(vadj, -659372076, 441),
                    vadj,
                    caml_call1
                     (caml_get_public_method(vadj, 834174833, 440), vadj)
                    - _dx_);
                  update_view(0);
                  return false$0;
                 case 2:
                  var
                   _dy_ =
                     caml_call1
                      (caml_get_public_method(hadj, -292814788, 442), hadj);
                  caml_call2
                   (caml_get_public_method(hadj, -659372076, 444),
                    hadj,
                    caml_call1
                     (caml_get_public_method(hadj, 834174833, 443), hadj)
                    + _dy_);
                  update_view(0);
                  return false$0;
                 default:
                  var
                   _dz_ =
                     caml_call1
                      (caml_get_public_method(vadj, -292814788, 445), vadj);
                  caml_call2
                   (caml_get_public_method(vadj, -659372076, 447),
                    vadj,
                    caml_call1
                     (caml_get_public_method(vadj, 834174833, 446), vadj)
                    + _dz_);
                  update_view(0);
                  return false$0;
               }
             ...
             try{
              var
               _dj_ = return$0(caml_read_file_content(cst_scene_json)),
               _dm_ = _dj_;
             }
             catch(_dn_){
                      ...
                      switch(req.readyState){
                        ...
                        case 4:
                         ...
                         var
                          ...
                          _dp_ = caml_string_of_jsstring,
                          _dq_ = function(param){return _cD_;},
                          response =
                            [0,
                             url,
                             code,
                             headers,
                             case$0(req.responseText, _dq_, _dp_),
                             _do_];
