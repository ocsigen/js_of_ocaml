...
(function(globalThis){
   ...
   var
    ...
    _bX_ = "script",
    _bW_ = cst_canvas,
    _bY_ = [0, "lib/js_of_ocaml/regexp.ml", 34, 64],
    _bZ_ = "[\\][()\\\\|+*.?{}^$]",
    _b0_ = "Js_of_ocaml__Url.Local_exn",
    _cL_ = cst$3,
    _ch_ = [0, 0],
    _ci_ = [0, 1],
    _cf_ = [0, 0],
    ...
    _b9_ = "wakeup_exn",
    _b8_ = "wakeup",
    _b5_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b6_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b7_ = [0, 0],
    _b3_ = cst_Fatal_error_exception,
    _b4_ = "Lwt.Resolution_loop.Canceled",
    _cp_ = cst_POST,
    _cn_ = cst_POST,
    _co_ = cst_POST,
    _cm_ = cst$0,
    ...
    _cJ_ = [0, [11, cst_fetching_model, 0], cst_fetching_model],
    _cI_ = [0, [8, [0, 0, 0], 0, [0, 1], 0], "%.1f"],
    _cB_ = [0, [11, cst_init_canvas, 0], cst_init_canvas],
    _cC_ = [0, [11, cst_create_program, 0], cst_create_program],
    _cD_ = "fragment-shader",
    _cE_ = "vertex-shader",
    _cF_ = [0, [11, cst_use_program, 0], cst_use_program],
    _cG_ = [0, [11, cst_program_loaded, 0], cst_program_loaded],
    _cH_ = [0, [11, cst_ready, 0], cst_ready],
    _cA_ = "\n",
    _cz_ = [0, 1, [0, 2, [0, 3, [0, 4, 0]]]],
    _cy_ = [0, 1, [0, 2, 0]],
    _cv_ =
      [0,
    ...
    _cr_ = [0, [11, cst_WebGL_error, 0], cst_WebGL_error],
    _cw_ = "(v|vn|f)\\ ([^\\ ]+)\\ ([^\\ ]+)\\ ([^\\ ]+)",
    _cx_ = "([0-9]+)//([0-9]+)";
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gf_ = caml_wrap_exception(_gg_);
      if(_gf_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gf_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    if(0 === l) return [0];
    if(0 > l) return invalid_arg(_p_);
    var res = caml_make_vect(l, caml_call1(f, 0)), _gd_ = l - 1 | 0, _gc_ = 1;
    if(_gd_ >= 1){
     var i = _gc_;
     for(;;){
   ...
   function take(q){
    var _gb_ = q[2];
    if(! _gb_) throw caml_maybe_attach_backtrace(Empty, 1);
    var content = _gb_[1];
    if(_gb_[2]){
     var next = _gb_[2];
     q[1] = q[1] - 1 | 0;
   ...
   var at_exit_key = new_key(0, function(param, _ga_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _fR_ = function(param){af(0); return;};
        return [0, function(param){fa(0); return;}, _fR_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _fS_ = function(param){af$0(0); return;};
        return [0, function(param){fa$0(0); return;}, _fS_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _fT_ = function(param){af$1(0); return;};
        return [0, function(param){fa$1(0); return;}, _fT_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _fU_ = function(param){af$2(0); return;};
        return [0, function(param){fa$2(0); return;}, _fU_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _fV_ = function(param){af$3(0); return;};
        return [0, function(param){fa$3(0); return;}, _fV_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _fW_ = function(param){af$4(0); return;};
        return [0, function(param){fa$4(0); return;}, _fW_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _fX_ = function(param){af$5(0); return;};
        return [0, function(param){fa$5(0); return;}, _fX_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _fY_ = function(param){af$6(0); return;};
        return [0, function(param){fa$6(0); return;}, _fY_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _fZ_ = function(param){af$7(0); return;};
        return [0, function(param){fa$7(0); return;}, _fZ_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _f0_ = function(param){jd(0); de$8(0); return;},
         _f1_ = function(param){ed$8(0); dj(0); return;},
         _f2_ = function(param){ga(0); af$8(0); return;};
        return [0, function(param){fa$8(0); ag(0); return;}, _f2_, _f1_, _f0_];
       case 10:
        var
         rest$9 = param[1],
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _f3_ = function(param){af$9(0); return;};
        return [0, function(param){fa$9(0); return;}, _f3_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _f4_ = function(param){af$10(0); return;};
        return [0, function(param){fa$10(0); return;}, _f4_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _f5_ = function(param){af$11(0); return;};
        return [0, function(param){fa$11(0); return;}, _f5_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _f6_ = function(param){de$12(0); return;},
         _f7_ = function(param){ed$12(0); return;},
         _f8_ = function(param){af$12(0); return;};
        return [0, function(param){fa$12(0); return;}, _f8_, _f7_, _f6_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _f9_ = function(param){de$13(0); return;},
         _f__ = function(param){ed$13(0); return;},
         _f$_ = function(param){af$13(0); return;};
        return [0, function(param){fa$13(0); return;}, _f$_, _f__, _f9_];
     }
    function _fO_(param){return;}
    function _fP_(param){return;}
    function _fQ_(param){return;}
    return [0, function(param){return;}, _fQ_, _fP_, _fO_];
   }
                ...
                switch(ty2[0]){
                  case 8:
                   var
                    rest2$7 = ty2[2],
                    ty2$0 = ty2[1],
                    _fN_ = trans(rest1$7, rest2$7);
                   return [8, trans(ty1$0, ty2$0), _fN_];
                  case 10:
                   break a;
                  case 11:
                   break b;
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _fM_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _fM_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _fM_[1];
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _fA_ = caml_ml_bytes_length(b) - 1 | 0,
     _fz_ = 0;
    if(_fA_ >= 0){
     var i$0 = _fz_;
     for(;;){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _fC_ = caml_ml_bytes_length(b) - 1 | 0, _fB_ = 0;
     if(_fC_ >= 0){
      var i = _fB_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _fu_ = caml_ml_string_length(s) - 1 | 0, _ft_ = 0;
    if(_fu_ >= 0){
     var i$0 = _ft_;
     for(;;){
    ...
    var
     ...
     _fw_ = caml_ml_string_length(s) - 1 | 0,
     _fv_ = 0;
    if(_fw_ >= 0){
     var i = _fv_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fp_ = _ay_; break;
      default: var _fp_ = _aH_;
    }
    return transform_int_alt(iconv, caml_int64_format(_fp_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fm_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fm_ >>> 0){
           if(55 === _fm_) break a;
          }
          else if(21 < _fm_ - 1 >>> 0) break a;
          var i$1 = i$0 + 1 | 0, i$0 = i$1;
          continue;
         }
         var _fn_ = 1;
        }
        var _fo_ = _fn_ ? str : symbol(str, _a8_);
        return caml_special_val(_fo_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _fi_ = l - 1 | 0, _fh_ = 0;
        if(_fi_ >= 0){
         var i = _fh_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _fj_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _fj_);
          var _fk_ = i + 1 | 0;
          if(_fi_ === i) break;
          var i = _fk_;
         }
       ...
       return caml_string_of_bytes(_fl_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _ff_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _ff_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _fc_ = [8, acc, _bf_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _fc_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _fc_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _fb_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _fb_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _fb_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _fa_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bo_), _e$_, _e__);
   }
   function to_string(e){
    a:
    {
     b:
     {
      ...
      for(;;){
       ...
       c:
       {
        try{var val = caml_call1(hd, e);}catch(_e9_){break c;}
        if(val) break b;
       }
       var param = tl;
      }
    ...
    if(0 === caml_obj_tag(e)){
     ...
     if(2 < match >>> 0)
      var
       _e5_ = other_fields(e, 2),
       _e6_ = field(e, 1),
       _e8_ = caml_call2(sprintf(_bp_), _e6_, _e5_);
     else
      switch(match){
        case 0:
         var _e8_ = _bq_; break;
        case 1:
         var _e8_ = _br_; break;
        default:
         var _e7_ = field(e, 1), _e8_ = caml_call1(sprintf(_bs_), _e7_);
      }
     var match$0 = [0, constructor, [0, _e8_]];
    }
    else
     var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _eV_ = slot[4],
        _eW_ = slot[3],
        _eX_ = slot[6] ? _bC_ : _bE_,
        _eY_ = slot[2],
        _eZ_ = slot[7],
        _e0_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bD_), _e0_, _eZ_, _eY_, _eX_, _eW_, _eV_, _eU_)];
      else if(slot[1])
       var match = 0;
      else
       var _e1_ = info(0), match = [0, caml_call1(sprintf(_bF_), _e1_)];
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_eS_){}
      try{
       var _eI_ = to_string(exn$0);
       caml_call1(eprintf(_bI_), _eI_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _eJ_ = abs(status);
        prerr_endline(caml_check_bound(errors, _eJ_)[1 + _eJ_]);
       }
       var _eK_ = caml_ml_flush(stderr), _eO_ = _eK_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _eM_ = to_string(exn$0);
       caml_call1(eprintf(_bK_), _eM_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _eN_ = to_string(exn);
       caml_call1(eprintf(_bL_), _eN_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _eO_ = caml_ml_flush(stderr);
      }
      var _eP_ = _eO_;
     }
     catch(_eR_){
      var _eL_ = caml_wrap_exception(_eR_);
      if(_eL_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_eL_, 0);
      var _eP_ = prerr_endline(_bJ_);
     }
     return _eP_;
    }
    catch(_eQ_){return 0;}
   ...
   function to_option(x){
    ...
    return case$0(x, function(param){return 0;}, _eH_);
   }
   ...
   function string_match(t10, s, t9){
    ...
    var
     ...
     _eG_ = x == no_handler ? no_handler : x;
    return to_option(_eG_);
   }
   function matched_group(r, i){
    ...
    function _eF_(x){return [0, x];}
    return case$1(x$0, function(param){return 0;}, _eF_);
   }
   var
    quote_repl_re = new regExp("[$]", cst_g),
    quote_re = regexp(_bZ_),
    Local_exn = [248, _b0_, caml_fresh_oo_id(0)];
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _eE_){return 0;},
     t41 = function(param, _eD_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b2_ = caml_wrap_exception(_eC_);
    if(_b2_[1] !== Failure) throw caml_maybe_attach_backtrace(_b2_, 0);
   }
   var
     ...
     a:
     {
      ...
      if(0 <= ofs && lim >= ofs){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _eA_ = i; break a;}
        var i$0 = i + 1 | 0, i = i$0;
       }
      }
      var _eA_ = invalid_arg(_o_);
     }
     var j = _eA_;
    }
    catch(_eB_){
     var _ez_ = caml_wrap_exception(_eB_);
   ...
   if(a && ! caml_string_notequal(a[1], cst$0)){
    var _b1_ = a[2];
    if(! _b1_ || ! caml_string_notequal(_b1_[1], cst$0) && ! _b1_[2]) break a;
   }
   var
       ...
       _et_ =
         function(s){
          function _ex_(param){
           ...
           return [0, urldecode_js_string_string(x), _ey_];
          }
          var index = s.indexOf(caml_jsstring_of_string(make$0(1, 61)));
          if(0 <= index)
           var
            _ev_ = s.slice(index + 1 | 0),
            _ew_ = [0, s.slice(0, index), _ev_];
          else
           var _ew_ = undefined$0;
          return case$1(_ew_, interrupt, _ex_);
         };
      aux$0([0, case$1(arr[idx$0], interrupt, _et_), acc], _es_);
      return;
     }
     catch(_eu_){
      var _er_ = caml_wrap_exception(_eu_);
      if(_er_ !== Local_exn) throw caml_maybe_attach_backtrace(_er_, 0);
   ...
   symbol(s$0, symbol(_cL_, git_version));
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _eq_ = caml_call1(f, v); return _eq_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _ep_ = result[1] === Canceled ? 1 : 0, is_canceled = _ep_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _eo_ = p[1];
    switch(_eo_[0]){
      case 1:
       return _eo_[1] === Canceled
               ? 0
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       resolve(_b$_, 0, outer_promise, p[1]); return;
      case 2:
       var
        p_callbacks = match[1],
      ...
      default: resolve(_b__, 0, outer_promise, p[1]); return;
    }
   }
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_ca_, 0, p$2, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _en_ = caml_call1(f, v), p$0 = _en_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_cb_, function(param){return caml_call1(f, v);}, _em_);
    }
   }
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_cd_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _ek_ = [0, caml_call1(f, v)], p_result$0 = _ek_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
       if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_ce_,
                function(param){
                 try{var _ej_ = [0, caml_call1(f, v)], _ei_ = _ej_;}
                 catch(exn$0){
                  var exn = caml_wrap_exception(exn$0);
                  if(! 1) throw caml_maybe_attach_backtrace(exn, 0);
                  var _ei_ = [1, exn];
   ...
   function debug(f){
    ksprintf
     (function(s){return console$0.log(caml_jsstring_of_string(s));}, f);
    return;
   }
   function check_error(gl){
    var _ef_ = gl.NO_ERROR, _eg_ = caml_notequal(gl.getError(), _ef_);
    if(! _eg_) return _eg_;
    error(_cr_);
    return;
   }
   function load_shader(t15, shader, text){
    ...
    var _ed_ = 1 - (t15.getShaderParameter(shader, t15.COMPILE_STATUS) | 0);
    if(! _ed_) return _ed_;
    var _ee_ = caml_string_of_jsstring(t15.getShaderInfoLog(shader));
    caml_call2(error(_ct_), caml_string_of_jsstring(text), _ee_);
    return;
   }
   function get_source(src_id){
    function _ec_(param){return caml_call1(error(_cv_), src_id);}
    var
     script$0 =
       get
        (bind
   ...
   function mult(m1, m2){
    function v(p){
     var
      j = p % 4 | 0,
      i = p / 4 | 0,
      _d4_ = caml_array_get(m2, c$0(3, j)),
      _d5_ = caml_array_get(m1, c$0(i, 3)) * _d4_,
      _d6_ = caml_array_get(m2, c$0(2, j)),
      _d7_ = caml_array_get(m1, c$0(i, 2)) * _d6_,
      _d8_ = caml_array_get(m2, c$0(1, j)),
      _d9_ = caml_array_get(m1, c$0(i, 1)) * _d8_,
      _d__ = caml_array_get(m2, c$0(0, j));
     return caml_array_get(m1, c$0(i, 0)) * _d__ + _d9_ + _d7_ + _d5_;
    }
    return init(16, v);
   }
   var line_regexp = regexp(_cw_), couple_regexp = regexp(_cx_);
   function read_coord_couple(c){
    var match = string_match(couple_regexp, c, 0);
    if(! match) return 0;
    var
     res = match[1],
     match$0 = map(function(_d3_){return matched_group(res, _d3_);}, _cy_);
    if(match$0){
     var _dZ_ = match$0[1];
     if(_dZ_){
      var _d0_ = match$0[2];
      if(_d0_){
       var _d1_ = _d0_[1];
       if(_d1_ && ! _d0_[2]){
        var vn = _d1_[1], v = _dZ_[1], _d2_ = caml_int_of_string(vn);
        return [0, [0, caml_int_of_string(v), _d2_]];
       }
      }
     }
    }
   ...
   function concat(a){
    var r = [0, 0], _dW_ = a.length - 1 - 1 | 0, _dV_ = 0;
    if(_dW_ >= 0){
     var i = _dV_;
     for(;;){
    ...
    function next(param){
     for(;;){
      ...
      pos[1]++;
      var _dY_ = pos[1];
      l$1[1] = caml_check_bound(a, _dY_)[1 + _dY_];
     }
    }
   ...
   function start(param){
    ...
    debug(_cB_);
    function _dN_(param){return caml_call1(error(_cs_), canvas_id);}
    var
     canvas$0 = get(bind(document.getElementById(cst_canvas), canvas), _dN_);
    function _dO_(param){
     return ksprintf
             (function(s){
    ...
    try{
     var
      ...
      _dQ_ = test(ctx) ? ctx : canvas$0.getContext("experimental-webgl"),
      _dP_ = _dQ_;
    }
    catch(_dU_){var _dP_ = no_handler;}
    var t102 = get(_dP_, _dO_);
    debug(_cC_);
    var
     frag_src = get_source(_cD_),
     vert_src = get_source(_cE_),
    ...
    function f$0(param){
     ...
     var
      ...
      t138 = caml_jsstring_of_string(caml_call1(sprintf(_cI_), fps));
     fps_text.data = t138;
     ...
     function loop(d, param){
      ...
      var
       cb =
         remain == 0. ? callback : function(_dS_){return loop(remain, _dS_);};
   ...
   function go(param$2){
    ...
    function h(exn){
     ...
     return caml_call1(error(_cK_), _dM_);
    }
    try{
     var
      _cU_ =
          ...
          for(;;){
           ...
           if(match){
            ...
            if(match$0){
             ...
             if(_c$_){
              var _da_ = _c$_[1];
              if(caml_string_notequal(_da_, "f"))
               if(caml_string_notequal(_da_, "v")){
                if(! caml_string_notequal(_da_, "vn")){
                 var _db_ = match$0[2];
                 if(_db_){
                  var _dc_ = _db_[1];
                  if(_dc_){
                     ...
                     if(_df_){
                      ...
                      if(_dg_ && ! _df_[2]){
                       var
                        ...
                        y = _de_[1],
                        x$0 = _dc_[1],
                        _dh_ = caml_float_of_string(z),
                        _di_ = caml_float_of_string(y),
                        match$2 =
                          [0, [1, [0, caml_float_of_string(x$0), _di_, _dh_]]];
                       break a;
                      }
                     }
                    }
                    ...
                    if(_dn_){
                     ...
                     if(_do_ && ! _dn_[2]){
                      var
                       ...
                       y$0 = _dm_[1],
                       x$1 = _dk_[1],
                       _dp_ = caml_float_of_string(z$0),
                       _dq_ = caml_float_of_string(y$0),
                       match$2 =
                         [0, [0, [0, caml_float_of_string(x$1), _dq_, _dp_]]];
                      break a;
                     }
                    }
                   }
     ...
     try{
      var
       _cT_ = return$0(caml_read_file_content(cst_monkey_model)),
       _cV_ = _cT_;
     }
     catch(_cY_){
      var _cR_ = caml_wrap_exception(_cY_);
      if(_cR_ !== Not_found) throw caml_maybe_attach_backtrace(_cR_, 0);
      var
       _cS_ = function(s){return s;},
       _cQ_ =
         function(r){
          var cod = r[2], msg = r[4];
       ...
       content_type$1 = 0,
       headers$0 = 0,
       check_headers = function(param, _c7_){return 1;},
       contents = 0;
      ...
      req.open(caml_jsstring_of_string(method$0), cst_monkey_model, true$0);
      ...
      var
       headers =
         function(s){
          function _c5_(v){return [0, caml_string_of_jsstring(v)];}
          function _c6_(param){return 0;}
          return case$0
            ...
            switch(req.readyState){
              ...
              case 4:
               ...
               var
                ...
                _c2_ = caml_string_of_jsstring,
                _c3_ = function(param){return _cm_;},
                response =
                  [0,
                   url,
                   code,
                   headers,
                   case$0(req.responseText, _c3_, _c2_),
                   _c1_];
      ...
      if(contents){
       var match$1 = contents[1], _cP_ = match$1[1];
       if(-836918635 === _cP_){
             ...
             (function(param){
               ...
               if(781515420 <= match[1]){
                var
                 t0 = match[2],
                 _cZ_ =
                   symbol(_cj_, urlencode(0, caml_string_of_jsstring(t0.name)));
                return symbol(urlencode(0, name), _cZ_);
               }
               var
                s = match[2],
                _c0_ = symbol(_ck_, urlencode(0, caml_string_of_jsstring(s)));
               return symbol(urlencode(0, name), _c0_);
              },
              l$2);
         if(l$0){
          ...
          a:
          {
           ...
           var _cM_ = caml_ml_string_length(hd) + acc | 0;
          }
          var dst = caml_create_bytes(_cM_);
          a:
          {
           b:
           {
          ...
          var _cO_ = caml_string_of_bytes(dst);
         }
         else
          var _cO_ = _n_;
         req.send(caml_jsstring_of_string(_cO_));
        }
        else{var f$0 = match$2[2]; req.send(f$0);}
       }
       else if(737307005 <= _cP_){
        var b = match$1[2];
        req.send(b);
       }
       else{var s = match$1[2]; req.send(caml_jsstring_of_string(s));}
      }
      else
       req.send(no_handler);
      on_cancel(res, function(param){return req.abort();});
      var _cV_ = symbol$0(symbol_bind(res, _cQ_), _cS_);
     }
     var _cW_ = symbol_bind(symbol$0(_cV_, _cU_), start), p = _cW_;
    }
    ...
    switch(match[0]){
      case 1:
       ...
       run_callback_or_defer_it(_cg_, function(param){return h(exn$0);}, _cN_);
       break;
      case 2:
       var
        p_callbacks = match[1],
