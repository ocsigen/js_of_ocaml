...
(function(globalThis){
   ...
   var
    ...
    _cC_ = [0, [11, cst_fetching_model, 0], cst_fetching_model],
    _cB_ = [0, [8, [0, 0, 0], 0, [0, 1], 0], "%.1f"],
    _cu_ = [0, [11, cst_init_canvas, 0], cst_init_canvas],
    _cv_ = [0, [11, cst_create_program, 0], cst_create_program],
    _cw_ = "fragment-shader",
    _cx_ = "vertex-shader",
    _cy_ = [0, [11, cst_use_program, 0], cst_use_program],
    _cz_ = [0, [11, cst_program_loaded, 0], cst_program_loaded],
    _cA_ = [0, [11, cst_ready, 0], cst_ready],
    _ct_ = "\n",
    _cs_ = [0, 1, [0, 2, [0, 3, [0, 4, 0]]]],
    _cr_ = [0, 1, [0, 2, 0]],
    _co_ =
      [0,
    ...
    _ck_ = [0, [11, cst_WebGL_error, 0], cst_WebGL_error],
    _cp_ = "(v|vn|f)\\ ([^\\ ]+)\\ ([^\\ ]+)\\ ([^\\ ]+)",
    _cq_ = "([0-9]+)//([0-9]+)";
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _f7_ = caml_wrap_exception(_f8_);
      if(_f7_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_f7_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _f5_ = l - 1 | 0, _f4_ = 1;
    if(_f5_ >= 1){
     var i = _f4_;
     for(;;){
   ...
   function take(q){
    var _f3_ = q[2];
    if(! _f3_) throw caml_maybe_attach_backtrace(Empty, 1);
    var content = _f3_[1];
    if(_f3_[2]){
     var next = _f3_[2];
     q[1] = q[1] - 1 | 0;
   ...
   var at_exit_key = new_key(0, function(param, _f2_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _fF_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _fF_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _fG_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _fG_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _fH_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _fH_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _fI_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _fI_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _fJ_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _fJ_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _fK_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _fK_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _fL_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _fL_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _fM_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _fM_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _fN_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _fN_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _fO_ = function(param){jd(0); de$8(0); return 0;},
         _fP_ = function(param){ed$8(0); dj(0); return 0;},
         _fQ_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _fR_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _fR_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _fS_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _fS_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _fT_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _fT_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _fU_ = function(param){de$12(0); return 0;},
         _fV_ = function(param){ed$12(0); return 0;},
         _fW_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _fW_, _fV_, _fU_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _fX_ = function(param){de$13(0); return 0;},
         _fY_ = function(param){ed$13(0); return 0;},
         _fZ_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _fZ_, _fY_, _fX_];
     }
    ...
    switch(fconv[2]){
      case 5:
       ...
       for(;;){
        ...
        var _fc_ = _fb_ ? str : symbol(str, _a6_);
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bm_), _eZ_, _eY_);
   }
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_eX_){break b;}
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        ...
        _eU_ = field(e, 1),
        _eW_ = caml_call2(sprintf(_bn_), _eU_, _eT_);
      else
       switch(match){
         case 0:
          var _eW_ = _bo_; break;
         case 1:
          var _eW_ = _bp_; break;
         default:
          var _eV_ = field(e, 1), _eW_ = caml_call1(sprintf(_bq_), _eV_);
       }
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _eJ_ = slot[4],
        _eK_ = slot[3],
        _eL_ = slot[6] ? _bA_ : _bC_,
        _eM_ = slot[2],
        _eN_ = slot[7],
        _eO_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bB_), _eO_, _eN_, _eM_, _eL_, _eK_, _eJ_, _eI_)];
      else if(slot[1])
       var match = 0;
      else
       var _eP_ = info(0), match = [0, caml_call1(sprintf(_bD_), _eP_)];
   ...
   function matched_group(r, i){
    ...
    return case$1(x$0, function(param){return 0;}, _et_);
   }
   new regExp("[$]", cst_g);
   ...
   if(test$0(global.location))
    ...
    var
     t42 = function(param, _es_){return 0;},
     t41 = function(param, _er_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b0_ = caml_wrap_exception(_eq_);
     ...
     a:
     {
      ...
      if(0 <= ofs && lim >= ofs){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _eo_ = i; break a;}
        var i$0 = i + 1 | 0, i = i$0;
       }
      }
      var _eo_ = invalid_arg(_m_);
     }
     var j = _eo_;
    }
    catch(_ep_){
     var _en_ = caml_wrap_exception(_ep_);
   ...
   if(a && ! caml_string_notequal(a[1], cst$2)){
    var _bZ_ = a[2];
    if(! _bZ_ || ! caml_string_notequal(_bZ_[1], cst$2) && ! _bZ_[2]) break a;
   }
   var
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      try{var _ea_ = caml_call1(f, v), p$0 = _ea_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_b$_, function(param){return caml_call1(f, v);}, _d$_);
    }
   }
   ...
   function check_error(gl){
    ...
    return _d5_ ? error(_ck_) : _d5_;
   }
   function load_shader(t15, shader, text){
    t15.shaderSource(shader, text);
    t15.compileShader(shader);
    var _d2_ = 1 - (t15.getShaderParameter(shader, t15.COMPILE_STATUS) | 0);
    if(! _d2_) return _d2_;
    var _d3_ = caml_string_of_jsstring(t15.getShaderInfoLog(shader));
    return caml_call2(error(_cm_), caml_string_of_jsstring(text), _d3_);
   }
   function get_source(src_id){
    function _d1_(param){return caml_call1(error(_co_), src_id);}
    var
     script$0 =
       get
        (bind
   ...
   var line_regexp = regexp(_cp_), couple_regexp = regexp(_cq_);
   function read_coord_couple(c){
    var match = string_match(couple_regexp, c, 0);
    if(! match) return 0;
    var
     res = match[1],
     match$0 = map(function(_dQ_){return matched_group(res, _dQ_);}, _cr_);
    if(match$0){
     var _dM_ = match$0[1];
     if(_dM_){
      var _dN_ = match$0[2];
   ...
   function concat(a){
    var r = [0, 0], _dJ_ = a.length - 1 - 1 | 0, _dI_ = 0;
    if(_dJ_ >= 0){
     var i = _dI_;
     a:
     for(;;){
    ...
    function next(param){
     for(;;){
      ...
      pos[1]++;
      var _dL_ = pos[1];
      l$1[1] = caml_check_bound(a, _dL_)[1 + _dL_];
     }
    }
   ...
   function start(param){
    ...
    debug(_cu_);
    function _dA_(param){return caml_call1(error(_cl_), canvas_id);}
    var
     canvas$0 = get(bind(document.getElementById(cst_canvas), canvas), _dA_);
    function _dB_(param){
     return ksprintf
             (function(s){
    ...
    try{
     var
      ...
      _dD_ = test(ctx) ? ctx : canvas$0.getContext("experimental-webgl"),
      _dC_ = _dD_;
    }
    catch(_dH_){var _dC_ = no_handler;}
    var t102 = get(_dC_, _dB_);
    debug(_cv_);
    var
    ...
    function f$0(param){
     ...
     for(;;){
      if(! cell){
       var
        fps = 1. / accu * _dE_ * 1000.,
        t138 = caml_jsstring_of_string(caml_call1(sprintf(_cB_), fps));
       fps_text.data = t138;
       var
        match = task(0),
        w = match[2],
        t = match[1],
        d = 20.,
        callback = function(_dG_){return wakeup(w, _dG_);},
        id = [0, 0],
        loop =
          function(d, param){
           if(2147483000. < d)
           ...
           var
            cb =
              remain == 0.
               ? callback
               : function(_dF_){return loop(remain, _dF_);};
   ...
   function go(param$0){
    debug(_cC_);
    function h(exn){
     var _dz_ = to_string(exn);
     return caml_call1(error(_cD_), _dz_);
    }
    try{
     var
      _cK_ =
             ...
             if(match){
              var
               ...
               match$0 =
                 map
                  (function(res){
                     return function(_dy_){return matched_group(res, _dy_);};
                    }
                    (res),
                   _cs_);
              if(match$0){
               ...
               if(_cY_){
                var _cZ_ = _cY_[1];
                if(caml_string_notequal(_cZ_, "f"))
                 if(caml_string_notequal(_cZ_, "v")){
                  if(! caml_string_notequal(_cZ_, "vn")){
                   var _c0_ = match$0[2];
                   if(_c0_){
                    var _c1_ = _c0_[1];
                    if(_c1_){
                       ...
                       if(_c4_){
                        ...
                        if(_c5_ && ! _c4_[2]){
                         var
                          ...
                          y = _c3_[1],
                          x$0 = _c1_[1],
                          _c6_ = caml_float_of_string(z),
                          _c7_ = caml_float_of_string(y),
                          match$2 =
                            [0, [1, [0, caml_float_of_string(x$0), _c7_, _c6_]]];
                         break a;
                        }
                       }
                      }
                      ...
                      if(_da_){
                       ...
                       if(_db_ && ! _da_[2]){
                        var
                         ...
                         y$0 = _c$_[1],
                         x$1 = _c9_[1],
                         _dc_ = caml_float_of_string(z$0),
                         _dd_ = caml_float_of_string(y$0),
                         match$2 =
                           [0, [0, [0, caml_float_of_string(x$1), _dd_, _dc_]]];
                        break a;
                       }
                      }
                     }
            ...
            vertex =
              init
               (face$0.length - 1,
                function(i){
                 var
                  _du_ = caml_check_bound(face$0, i)[1 + i],
                  cv = _du_[3][1],
                  bv = _du_[2][1],
                  av = _du_[1][1],
                  _dv_ = av - 1 | 0,
                  match = caml_check_bound(vertex$2, _dv_)[1 + _dv_],
                  a3 = match[3],
                  a2 = match[2],
                  a1 = match[1],
                  _dw_ = bv - 1 | 0,
                  match$0 = caml_check_bound(vertex$2, _dw_)[1 + _dw_],
                  b3 = match$0[3],
                  b2 = match$0[2],
                  b1 = match$0[1],
                  _dx_ = cv - 1 | 0,
                  match$1 = caml_check_bound(vertex$2, _dx_)[1 + _dx_],
                  c3 = match$1[3],
                  c2 = match$1[2],
                  c1 = match$1[1];
                 return [0,
            ...
            norm =
              init
               (face$0.length - 1,
                function(i){
                 var
                  _dq_ = caml_check_bound(face$0, i)[1 + i],
                  cn = _dq_[3][2],
                  bn = _dq_[2][2],
                  an = _dq_[1][2],
                  _dr_ = an - 1 | 0,
                  match = caml_check_bound(norm$2, _dr_)[1 + _dr_],
                  a3 = match[3],
                  a2 = match[2],
                  a1 = match[1],
                  _ds_ = bn - 1 | 0,
                  match$0 = caml_check_bound(norm$2, _ds_)[1 + _ds_],
                  b3 = match$0[3],
                  b2 = match$0[2],
                  b1 = match$0[1],
                  _dt_ = cn - 1 | 0,
                  match$1 = caml_check_bound(norm$2, _dt_)[1 + _dt_],
                  c3 = match$1[3],
                  c2 = match$1[2],
                  c1 = match$1[1];
                 return [0,
     ...
     try{
      var
       _cJ_ = return$0(caml_read_file_content(cst_monkey_model)),
       _cL_ = _cJ_;
     }
     catch(_cO_){
      var _cH_ = caml_wrap_exception(_cO_);
      if(_cH_ !== Not_found) throw caml_maybe_attach_backtrace(_cH_, 0);
      var
       _cI_ = function(s){return s;},
       _cG_ =
         function(r){
          var cod = r[2], msg = r[4];
      ...
      for(;;){
       if(! param){
        var
         headers =
           function(s){
            function _cT_(v){return [0, caml_string_of_jsstring(v)];}
              ...
              switch(req.readyState){
                ...
                case 4:
                 ...
                 var
                  ...
                  _cQ_ = caml_string_of_jsstring,
                  _cR_ = function(param){return _ci_;},
                  response =
                    [0,
                     url,
                     code,
                     headers,
                     case$0(req.responseText, _cR_, _cQ_),
                     _cP_];
        ...
        var _cL_ = symbol$0(symbol_bind(res, _cG_), _cI_);
        break;
       }
     ...
     var _cM_ = symbol_bind(symbol$0(_cL_, _cK_), start), p = _cM_;
    }
    ...
    switch(match[0]){
      case 1:
       ...
       run_callback_or_defer_it(_ce_, function(param){return h(exn$0);}, _cF_);
       break;
      case 2:
       var
        p_callbacks = match[1],
