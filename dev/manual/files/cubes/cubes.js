...
(function(globalThis){
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ea_ = caml_wrap_exception(_eb_);
      if(_ea_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ea_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function sub_string(b, ofs, len){
    a:
    {
     ...
     var _d$_ = invalid_arg(_j_);
    }
    return caml_string_of_bytes(_d$_);
   }
   ...
   function init(l, f){
    ...
    var res = caml_make_vect(l, caml_call1(f, 0)), _d9_ = l - 1 | 0, _d8_ = 1;
    if(_d9_ >= 1){
     var i = _d8_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _d7_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _dK_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _dK_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _dL_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _dL_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _dM_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _dM_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _dN_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _dN_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _dO_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _dO_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _dP_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _dP_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _dQ_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _dQ_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _dR_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _dR_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _dS_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _dS_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _dT_ = function(param){jd(0); de$8(0); return 0;},
         _dU_ = function(param){ed$8(0); dj(0); return 0;},
         _dV_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _dW_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _dW_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _dX_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _dX_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _dY_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _dY_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _dZ_ = function(param){de$12(0); return 0;},
         _d0_ = function(param){ed$12(0); return 0;},
         _d1_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _d1_, _d0_, _dZ_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _d2_ = function(param){de$13(0); return 0;},
         _d3_ = function(param){ed$13(0); return 0;},
         _d4_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _d4_, _d3_, _d2_];
     }
    function _dH_(param){return 0;}
    function _dI_(param){return 0;}
    function _dJ_(param){return 0;}
    return [0, function(param){return 0;}, _dJ_, _dI_, _dH_];
   }
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_c2_){break b;}
    ...
    for(;;){
     ...
     for(;;)
      for(;;){
       ...
       var _cq_ = k$1 + 1 | 0;
       if(11 !== k$1){var k$1 = _cq_; break;}
       var _co_ = i$1 + 1 | 0;
       if(11 !== i$1){var i$1 = _co_; break a;}
       var j$0 = 0;
       for(;;){
        var i$0 = [0, 11], k$0 = 0;
        b:
        for(;;)
         for(;;){
          ...
          var _cn_ = k$0 + 1 | 0;
          if(11 !== k$0){var k$0 = _cn_; break;}
          var _cl_ = j$0 + 1 | 0;
          if(11 !== j$0){var j$0 = _cl_; break b;}
          var i = 0;
          for(;;){
           var k = [0, 11], j = 0;
           c:
