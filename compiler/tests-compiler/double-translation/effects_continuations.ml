...
let%expect_test "test-compiler/lib-effects/test1.ml" =
  ...
  [%expect
    ...
    function exceptions$0(s){
     ...
     try{
      if(caml_string_equal(s, cst))
       throw caml_maybe_attach_backtrace(Stdlib[8], 1);
      var _I_ = [0, [0, caml_doublecall1(Stdlib[79], cst_toto), n, m]];
      return _I_;
     }
     catch(_L_){
    ...
    function exceptions$1(s, cont){
     try{var _A_ = caml_int_of_string(s), n = _A_;}
     catch(_E_){
      var _w_ = caml_wrap_exception(_E_);
      if(_w_[1] !== Stdlib[7]){
       var raise$1 = caml_pop_trap();
       return raise$1(caml_maybe_attach_backtrace(_w_, 0));
      }
      var n = 0;
     }
     try{
    ...
    function cond1$1(b, cont){
     ...
     return b
             ? caml_cps_call2(Stdlib[79], cst_toto$0, _v_)
             : caml_cps_call2(Stdlib[79], cst_titi, _v_);
    }
    //end
    ...
    function cond2$1(b, cont){
     ...
     return b
             ? caml_cps_call2(Stdlib_Printf[3], _h_, _t_)
             : caml_cps_call2(Stdlib_Printf[3], _i_, _t_);
    }
    //end
    ...
    function cond3$1(b, cont){
     ...
     return b ? (x[1] = 1, _r_(0)) : caml_cps_call2(Stdlib_Printf[3], _j_, _r_);
    }
    //end
               ...
               function _p_(_q_){
                return caml_cps_call2
                        (Stdlib[83],
                         ...
                         function(line){
                          return b
                                  ? caml_cps_call2(Stdlib[53], line, _p_)
                                  : caml_cps_exact_call1(_p_, 0);
                         });
               }
               return _p_(0);
              });
               ...
               function _n_(_o_){
                return caml_cps_call2
                        (Stdlib[83],
                         ic,
                         function(line){
                          return caml_cps_call2(Stdlib[53], line, _n_);
                         });
               }
               return caml_cps_call2(Stdlib_Printf[3], _k_, _n_);
              });
    }
    //end
