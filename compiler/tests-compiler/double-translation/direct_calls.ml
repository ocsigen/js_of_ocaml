...
|}
  ...
  [%expect
    ...
    (function(globalThis){
       ...
       function caml_doublecall2(f, a0, a1){
        return (f.l >= 0 ? f.l : f.l = f.length) == 2
                ? f(a0, a1)
                : runtime.caml_call_gen(f, [a0, a1]);
       }
       function caml_cps_exact_double_call2(f, a0, a1){
       ...
       function caml_cps_exact_double_call3(f, a0, a1, a2){
        return runtime.caml_stack_check_depth()
                ? f.cps.call(null, a0, a1, a2)
                : runtime.caml_trampoline_return(f, [a0, a1, a2]);
       }
       ...
       function test1$0(param){
        function f(g, x){
         try{caml_doublecall1(g, undef); return;}
         catch(e$0){
       ...
       function f$0(){
        function f$0(g, x){
         try{caml_doublecall1(g, x); return;}
         catch(e$0){
          var e = caml_wrap_exception(e$0);
          throw caml_maybe_attach_backtrace(e, 0);
         }
        ...
        function f$1(g, x, cont){
         ...
         return caml_cps_exact_double_call2
                 (g, x, function(_y_){caml_pop_trap(); return cont(undef);});
        }
       ...
       function _h_(){
        return caml_cps_closure
                (function(x){return;}, function(x, cont){return cont(undef);});
       }
       function _j_(){
        return caml_cps_closure
                (function(x){return caml_doublecall2(Stdlib[28], x, cst_a$0);},
                 function(x, cont){
       ...
       function test3$0(x){
        ...
        var M1 = F(undef), M2 = F(undef), _v_ = caml_doublecall1(M2[1], 2);
        return [0, caml_doublecall1(M1[1], 1), _v_];
       }
       function test3$1(x, cont){
        function F(symbol){function f(x){return x + 1 | 0;} return [0, f];}
        var M1 = F(undef), M2 = F(undef), _u_ = M2[1].call(null, 2);
        return cont([0, M1[1].call(null, 1), _u_]);
       }
       var test3 = caml_cps_closure(test3$0, test3$1);
       function f(){
        function f$0(x){return caml_doublecall2(Stdlib_Printf[2], _s_, x);}
        function f$1(x, cont){
         return caml_cps_call3(Stdlib_Printf[2], _s_, x, cont);
        }
        var f = caml_cps_closure(f$0, f$1);
        return f;
       }
       ...
       function test4$1(x, cont){
        ...
        return caml_cps_exact_double_call2
                (M1[1],
                 1,
                 function(_t_){
                  return caml_cps_exact_double_call2(M2[1], 2, cont);
                 });
       }
       var
