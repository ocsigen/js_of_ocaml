    ...
    (function(globalThis)
       {"use strict";
        var
         ...
         caml_cps_function=runtime.caml_cps_function,
         caml_string_of_jsbytes=runtime.caml_string_of_jsbytes;
        function caml_cps_exact_call1(f,a0)
         {return runtime.caml_stack_check_depth()
                  ?f(a0)
                  :runtime.caml_trampoline_exact_return(f,[a0])}
        function caml_cps_call2(f,a0,a1)
         {return runtime.caml_stack_check_depth()
                  ?f.cps
                    ?(f.l >= 0?f.l:f.l = f.length) == 2
                      ?f(a0,a1)
                      :runtime.caml_cps_call_gen(f,[a0,a1])
        ...
        function caml_cps_exact_call2(f,a0,a1)
         {return runtime.caml_stack_check_depth()
                  ?f(a0,a1)
                  :runtime.caml_trampoline_exact_return(f,[a0,a1])}
