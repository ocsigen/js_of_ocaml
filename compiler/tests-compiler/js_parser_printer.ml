...
let%expect_test "arrow" =
 ...
 |};
  ...
  [%expect
    ...
    var
     a = /*<<fake:16:10>>*/
       x=> /*<<fake:16:17>>*/ y=> /*<<fake:16:22>>*/ x + y /*<<fake:16:27>>*/ ;
    var
     a = /*<<fake:17:10>>*/
       x=>
 ...
 |};
  ...
  [%expect
    ...
    function rehb_shape(_face, text){
     var
      str = /*<<fake:13:10>>*/
         /*<<fake:13:12>>*/ caml_to_js_string( /*<<fake:13:10>>*/ text);
     var
      ret = /*<<fake:14:10>>*/
         /*<<fake:14:12>>*/ str.split("").map
         ( /*<<fake:14:10>>*/ function mapper(_char){
      ...
      /*<<fake:3:8>>*/ return  /*<<fake:3:15>>*/ checkIfInitialized().then
             ( /*<<fake:3:8>>*/ function(){
                /*<<fake:4:10>>*/ return  /*<<fake:4:17>>*/ callWithProto
                       ( /*<<fake:4:10>>*/ api_json[key_module][key_func], args) /*<<fake:4:68>>*/ ;
               /*<<fake:3:41>>*/ }) /*<<fake:5:10>>*/ ;
     /*<<fake:2:38>>*/ }; |}]
...
let%expect_test "async/await" =
 ...
 |};
  ...
  [%expect
    ...
    async function compile(src){
     const
      glslangModule = /*<<fake:4:31>>*/
        await
         /*<<fake:4:39>>*/ import
         ( /*<<fake:4:31>>*/ "https://unpkg.com/@webgpu/glslang@0.0.7/web/glslang.js");
     const
      glslang = /*<<fake:7:25>>*/
        await  /*<<fake:7:33>>*/ glslangModule.default( /*<<fake:7:25>>*/ );
      /*<<fake:8:11>>*/ return  /*<<fake:8:18>>*/ glslang.compileGLSL
             ( /*<<fake:8:11>>*/ src, "compute") /*<<fake:8:53>>*/ ;
     /*<<fake:2:9>>*/ }
     /*<<fake:12:4>>*/ async;
...
let%expect_test "string template" =
 ...
 |};
  ...
  [%expect
    ...
    var
     s = /*<<fake:7:10>>*/
       `asd ${ /*<<fake:7:20>>*/ f( /*<<fake:7:10>>*/ `space ${test} space`, 32)} te`; |}]
              ...
              ( /*<<fake:6:6>>*/ [field],
               function(state){
                 /*<<fake:6:50>>*/ return  /*<<fake:6:57>>*/ get
                        ( /*<<fake:6:50>>*/  /*<<fake:6:61>>*/ state.field
                          ( /*<<fake:6:50>>*/ field)) /*<<fake:6:80>>*/ ;
                /*<<fake:6:34>>*/ }) /*<<fake:6:83>>*/ ;
      /*<<fake:4:3>>*/ }}); |}]
