...
|}
  ...
  [%expect
    ...
    function test2(param,cont)
     {var
       f=caml_cps_function(function(g,x,cont){return caml_cps_call2(g,x,cont)}),
       _f_=7;
      function _g_(x){return x + 1 | 0}
    ...
    function test4(x,cont)
     {function F(symbol)
       {var
         f=
          caml_cps_function
           (function(x,cont){return caml_cps_call3(Stdlib_Printf[2],_a_,x,cont)});
        return [0,f]}
