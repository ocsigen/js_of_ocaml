...
|}
  ...
  [%expect
    ...
    $ cat "test.js"
     ...
     28:     /*<<test.ml:3:0>>*/  /*<<test.ml:3:0>>*/ caml_call1(Stdlib[46], greeting);
     29:     /*<<test.ml:5:0>>*/  /*<<test.ml:5:0>>*/ caml_call1
     30:     (Stdlib[46], greeting$0);
     31:     /*<<test.ml:7:47>>*/ var
     32:      /*<<test.ml:7:47>>*/ _a_ =
     33:        /*<<test.ml:7:47>>*/ caml_call1(Stdlib_Random[5], 30),
     34:      /*<<test.ml:7:34>>*/ unicodeLength =
     35:        /*<<test.ml:7:34>>*/ runtime.caml_ml_string_length
     36:        ( /*<<test.ml:7:34>>*/ caml_call2(Stdlib_String[1], _a_, 105)),
     37:      /*<<test.ml:8:56>>*/ _b_ =
     38:        /*<<test.ml:8:56>>*/ caml_call1(Stdlib[33], unicodeLength),
     39:      /*<<test.ml:8:14>>*/ _c_ =
     40:        /*<<test.ml:8:14>>*/ caml_call2
     41:        (Stdlib[28],
     42:         caml_string_of_jsbytes('String.length("\xc9\x8a") should be two:'),
     43:         _b_);
     44:     /*<<test.ml:8:0>>*/  /*<<test.ml:8:0>>*/ caml_call1(Stdlib[46], _c_);
     45:     /*<<test.ml:9:39>>*/ var
     46:      /*<<test.ml:9:39>>*/ _d_ =
     47:        /*<<test.ml:9:39>>*/ caml_call2(Stdlib_String[1], 1, 138),
     48:      /*<<test.ml:9:14>>*/ _e_ =
     49:        /*<<test.ml:9:14>>*/ caml_call2(Stdlib_String[1], 1, 201),
     50:      /*<<test.ml:9:13>>*/ _f_ =
     51:        /*<<test.ml:9:13>>*/ caml_call2(Stdlib[28], _e_, _d_);
     52:     /*<<test.ml:9:0>>*/  /*<<test.ml:9:0>>*/ caml_call1(Stdlib[46], _f_);
     53:    var Test = [0, greeting$0, unicodeLength];
...
|}
  ...
  [%expect
    ...
    $ cat "test.js"
     ...
     31:      /*<<test.ml:14:22>>*/ executable_name =
    ...
    101:       _l_ = slot[2],
    102:       _m_ = slot[7],
    103:        /*<<test.ml:59:14>>*/ _n_ = info(slot[1]);
    ...
    109:      /*<<test.ml:56:51>>*/  /*<<test.ml:56:51>>*/ var _o_ = info(0);
    ...
    119:      var i = _e_;
    120:      for(;;){
    121:        /*<<test.ml:70:14>>*/  /*<<test.ml:70:14>>*/ var
    122:        match = format_backtrace_slot(i, runtime.caml_check_bound(a, i)[1 + i]);
    123:       if(match){
    124:        var str = match[1];
    125:         /*<<test.ml:72:24>>*/  /*<<test.ml:72:24>>*/ caml_call3
    126:         (Stdlib_Printf[1], outchan, _c_, str);
    127:       }
    128:        /*<<test.ml:69:6>>*/  /*<<test.ml:69:6>>*/ var _g_ = i + 1 | 0;
    129:       if(_f_ === i) break;
    130:       i = _g_;
    131:      }
    132:     }
