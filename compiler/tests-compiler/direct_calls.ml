...
|}
  ...
  [%expect
    ...
    function test1(param){
     var f = function(g, x){return caml_call1(g, x);}, _d_ = 7;
    ...
    function test2(param){
     var f = function(g, x){return caml_call1(g, x);}, _c_ = 7;
    ...
    function test3(x){
     var
      F = function(symbol){var f = function(x){return x + 1 | 0;}; return [0, f];},
      M1 = F([0]),
      M2 = F([0]),
      _b_ = M2[1].call(null, 2);
    ...
    function test4(x){
     var
      F =
        function(symbol){
         var f = function(x){return caml_call2(Stdlib_Printf[2], _a_, x);};
         return [0, f];
        },
      M1 = F([0]),
      M2 = F([0]);
...
|}
  ...
  [%expect
    ...
    function test1(param, cont){
     var f = function(g, x){return g(x);}, _k_ = 7;
    ...
    function test2(param, cont){
     var
      f = function(g, x, cont){return caml_cps_exact_call2(g, x, cont);},
      _f_ = 7,
      _g_ = function(x, cont){return cont(x + 1 | 0);};
      ...
      F =
        function(symbol){
         var
          f =
            function(x, cont){
             return caml_cps_call3(Stdlib_Printf[2], _a_, x, cont);
            };
         return [0, f];
        },
      M1 = F([0]),
