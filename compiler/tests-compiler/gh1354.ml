    ...
    (function(globalThis)
       {"use strict";
        ...
        var
         ...
         _a_=0;
        try
         {var _b_=_a_;_b_ = _a_ + 1 | 0;0;throw Stdlib[3]}
        catch(_d_)
       ...
       {"use strict";
        ...
        try
         {var _c_=_a_,_e_=_a_ + 1 | 0;
          ...
          0;
          try
           {var _f_=_e_,_h_=_e_ + 1 | 0;_f_ = _h_;_c_ = _h_;0;throw Stdlib[3]}
    ...
    (function(globalThis)
       {"use strict";
        ...
        try
         {var _b_=_a_;
          try
           {var _d_=_a_,_f_=_a_ + 1 | 0;_d_ = _f_;_b_ = _f_;0;throw Stdlib[3]}
