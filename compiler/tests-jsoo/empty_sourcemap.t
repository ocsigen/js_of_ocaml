...
Build object files and executable with --empty-sourcemap:
  ...
  $ js_of_ocaml --sourcemap --empty-sourcemap a.cmo -o a.js
  $ cat a.map
  {"version":3,"file":"a.js","sources":[],"sourcesContent":[],"names":[],"mappings":""}
  $ js_of_ocaml --sourcemap --empty-sourcemap b.cmo -o b.js
  $ cat b.map
  {"version":3,"file":"b.js","sources":[],"sourcesContent":[],"names":[],"mappings":""}
  $ js_of_ocaml --sourcemap --empty-sourcemap test.bc -o test.js
  $ cat test.map
...
Build object files with sourcemap and link with --empty-sourcemap:
  ...
  $ js_of_ocaml --sourcemap a.cmo -o a.js
  $ js_of_ocaml --sourcemap b.cmo -o b.js
  $ js_of_ocaml link --sourcemap --resolve-sourcemap-url=true --empty-sourcemap a.js b.js -o test.js -a
  $ cat test.map
