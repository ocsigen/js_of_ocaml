...
let cmo_block_descs (t : Compilation_unit_descr.t) = Some (Obj.repr t.cu_block_descs)
[@@if introspect]

let cmo_block_descs (_ : Compilation_unit_descr.t) = None [@@if not introspect]
