...
let ops =
  ...
  let instrs =
    Array.concat
      ...
      ; (if Config.oxcaml
         then
           [| CONTINUE, KNullaryCall, "CONTINUE"
            ; CONTINUETERM, KStop 1, "CONTINUETERM"
            ; DISCONTINUE, KNullaryCall, "DISCONTINUE"
            ; DISCONTINUETERM, KStop 1, "DISCONTINUETERM"
            ; DISCONTINUE_WITH_BACKTRACE, KNullaryCall, "DISCONTINUE_WITH_BACKTRACE"
            ; DISCONTINUE_WITH_BACKTRACETERM, KStop 1, "DISCONTINUE_WITH_BACKTRACETERM"
           |]
         else
