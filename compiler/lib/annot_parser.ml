 ...
 fun _menhir_env _menhir_stack _menhir_s _v ->
  ...
  | MenhirState24 ->
      ...
      ( let (_menhir_env : _menhir_env) = _menhir_env in
        ...
        let _ : _menhir_state = _menhir_s in
        let ((_4 : 'tv_endline) : 'tv_endline) = _v in
        ( let _menhir_stack, _, (l : 'tv_separated_nonempty_list_TComma_TIdent_)
              =
            _menhir_stack
          in
          let _2 = () in
  ...
  | MenhirState46 ->
      ...
      ( let (_menhir_env : _menhir_env) = _menhir_env in
        ...
        ( let ( ((_menhir_stack, (id : string)), (opt : 'tv_option_prim_annot_))
              , (args :
                  'tv_option_delimited_LPARENT_separated_list_TComma_arg_annot__RPARENT__)
              ) =
            _menhir_stack
  ...
  | MenhirState35 ->
      ...
      ( let (_menhir_env : _menhir_env) = _menhir_env in
        ...
        let ((x : 'tv_separated_nonempty_list_TComma_arg_annot_)
          ...
          _v
        in
        ( let _v : 'tv_loption_separated_nonempty_list_TComma_arg_annot__ = x in
  ...
  | MenhirState44 ->
      ...
      ( let (_menhir_env : _menhir_env) = _menhir_env in
        ...
        ( let _menhir_stack, _menhir_s, (x : 'tv_arg_annot) = _menhir_stack in
          let _2 = () in
          let _v : 'tv_separated_nonempty_list_TComma_arg_annot_ = x :: xs in
...
and _menhir_goto_arg_annot :
    _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_arg_annot -> 'ttv_return =
 fun _menhir_env _menhir_stack _menhir_s _v ->
  let _menhir_stack = _menhir_stack, _menhir_s, _v in
  let (_menhir_env : _menhir_env) = _menhir_env in
    ...
    | TVNum _v ->
        ...
        ( let _menhir_env = _menhir_discard _menhir_env in
          ...
          ( let _menhir_stack, _menhir_s, (_1 : 'tv_op) = _menhir_stack in
            ...
            ( let _menhir_stack = _menhir_stack, _menhir_s, _v in
              let (_menhir_env : _menhir_env) = _menhir_env in
              let (_menhir_stack : 'freshtv133 * _menhir_state * 'tv_version) =
                Obj.magic _menhir_stack
              in
              ( assert (not _menhir_env._menhir_error) ;
                let _tok = _menhir_env._menhir_token in
...
and _menhir_goto_option_delimited_LPARENT_separated_list_TComma_arg_annot__RPARENT__
 ...
 fun _menhir_env _menhir_stack _v ->
  ...
  ( assert (not _menhir_env._menhir_error) ;
    let _tok = _menhir_env._menhir_token in
    match _tok with
    | EOF -> _menhir_run17 _menhir_env (Obj.magic _menhir_stack) MenhirState46
    | EOL -> _menhir_run16 _menhir_env (Obj.magic _menhir_stack) MenhirState46
    | TOTHER _v ->
