...
module In_channel = struct
  let stdlib_input_line = input_line [@@if ocaml_version >= (4, 14, 0)]

  module In_channel = In_channel [@@if ocaml_version >= (4, 14, 0)]

  module In_channel = struct end [@@if ocaml_version < (4, 14, 0)]
