...
dead variables with a sentinal zero variable (the JS value `undefined`).
...
dead variables that are then removed by [deadcode.ml]. In particular it allows for the elimination of unused functions defined 
