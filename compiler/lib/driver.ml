...
let o1 = loop 2 "round" (round false) 1 +> phi +> flow +> specialize +> eval +> print

(* o2 *)

let o2 = loop 10 "round" (round true) 1 +> print

(* o3 *)

let o3 = loop 30 "round" (round true) 1 +> print
