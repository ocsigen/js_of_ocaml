...
class type mediaTrackConstraints = object
  method deviceId : Js.js_string Js.t Js.optdef Js.prop

  method groupId : Js.js_string Js.t Js.optdef Js.prop

  method facingMode : Js.js_string Js.t Js.optdef Js.prop

  method width : int Js.optdef Js.prop

  method height : int Js.optdef Js.prop

  method aspectRatio : Js.number_t Js.optdef Js.prop

  method frameRate : Js.number_t Js.optdef Js.prop

  method resizeMode : Js.js_string Js.t Js.optdef Js.prop

  method sampleRate : int Js.optdef Js.prop

  method sampleSize : int Js.optdef Js.prop

  method channelCount : int Js.optdef Js.prop

  method echoCancellation : bool Js.t Js.optdef Js.prop

  method noiseSuppression : bool Js.t Js.optdef Js.prop

  method autoGainControl : bool Js.t Js.optdef Js.prop
end
...
class type mediaStreamConstraints = object
  ...
  method audio_constraints : mediaTrackConstraints Js.t Js.writeonly_prop

  method video : bool Js.t Js.writeonly_prop

  method video_constraints : mediaTrackConstraints Js.t Js.writeonly_prop
end
...
class type mediaStream = object ('self)
  ...
  method onaddtrack :
    ('self Js.t, 'self trackEvent Js.t) Dom.event_listener Js.writeonly_prop
