...
class type audioNode = object
  ...
  method connect_withOutput : audioNode Js.t -> int -> audioNode Js.t Js.meth

  method connect_withOutputAndInput :
    audioNode Js.t -> int -> int -> audioNode Js.t Js.meth

  method connect_param : audioParam Js.t -> unit Js.meth

  method connect_param_withOutput : audioParam Js.t -> int -> unit Js.meth

  method disconnect : unit Js.meth

  method disconnect_output : int -> unit Js.meth

  method disconnect_node : audioNode Js.t -> unit Js.meth

  method disconnect_node_withOutput : audioNode Js.t -> int -> unit Js.meth

  method disconnect_node_withOutputAndInput : audioNode Js.t -> int -> int -> unit Js.meth

  method disconnect_param : audioParam Js.t -> unit Js.meth

  method disconnect_param_withOutput : audioParam Js.t -> int -> unit Js.meth
end
