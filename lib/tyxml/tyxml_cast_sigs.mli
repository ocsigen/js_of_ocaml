...
module type OF = sig
  ...
  val of_tableCell : Dom_html.tableCellElement Js.t -> [> Html_types.td | Html_types.th ] elt
  ...
  val of_tableSection : Dom_html.tableSectionElement Js.t -> [> Html_types.tfoot | Html_types.thead | Html_types.tbody ] elt
