...
;;
test 2 eq_big_int (add_big_int zero_big_int (big_int_of_int 1), big_int_of_int 1)

;;
test 3 eq_big_int (add_big_int (big_int_of_int 1) zero_big_int, big_int_of_int 1)

;;
test 4 eq_big_int (add_big_int zero_big_int (big_int_of_int (-1)), big_int_of_int (-1))

;;
test 5 eq_big_int (add_big_int (big_int_of_int (-1)) zero_big_int, big_int_of_int (-1))

;;
test 6 eq_big_int (add_big_int (big_int_of_int 1) (big_int_of_int 1), big_int_of_int 2)

;;
test 7 eq_big_int (add_big_int (big_int_of_int 1) (big_int_of_int 2), big_int_of_int 3)

;;
test 8 eq_big_int (add_big_int (big_int_of_int 2) (big_int_of_int 1), big_int_of_int 3)
...
;;
test 12 eq_big_int (add_big_int (big_int_of_int 1) (big_int_of_int (-1)), zero_big_int)
...
;;
test 2 eq_big_int (sub_big_int zero_big_int (big_int_of_int 1), big_int_of_int (-1))

;;
test 3 eq_big_int (sub_big_int (big_int_of_int 1) zero_big_int, big_int_of_int 1)

;;
test 4 eq_big_int (sub_big_int zero_big_int (big_int_of_int (-1)), big_int_of_int 1)

;;
test 5 eq_big_int (sub_big_int (big_int_of_int (-1)) zero_big_int, big_int_of_int (-1))

;;
test 6 eq_big_int (sub_big_int (big_int_of_int 1) (big_int_of_int 1), zero_big_int)

;;
test 7 eq_big_int (sub_big_int (big_int_of_int 1) (big_int_of_int 2), big_int_of_int (-1))

;;
test 8 eq_big_int (sub_big_int (big_int_of_int 2) (big_int_of_int 1), big_int_of_int 1)

;;
test 9 eq_big_int (sub_big_int (big_int_of_int (-1)) (big_int_of_int (-1)), zero_big_int)
...
;;
test 2 eq_big_int (mult_big_int (big_int_of_int 2) (big_int_of_int 3), big_int_of_int 6)
...
test
  4
  eq_big_int
  ( mult_big_int (big_int_of_string "12724951") (big_int_of_string "81749606400")
...
test
  5
  eq_big_int
  ( mult_big_int (big_int_of_string "26542080") (big_int_of_string "81749606400")
...
;;
let quotient, modulo = quomod_big_int (big_int_of_int 1) (big_int_of_int 1) in
test 1 eq_big_int (quotient, big_int_of_int 1) && test 2 eq_big_int (modulo, zero_big_int)
...
;;
let quotient, modulo = quomod_big_int (big_int_of_int 3) (big_int_of_int 2) in
test 7 eq_big_int (quotient, big_int_of_int 1)
&& test 8 eq_big_int (modulo, big_int_of_int 1)

;;
let quotient, modulo = quomod_big_int (big_int_of_int 5) (big_int_of_int 3) in
...
;;
let quotient, modulo = quomod_big_int (big_int_of_int 1) (big_int_of_int 2) in
test 13 eq_big_int (quotient, zero_big_int)
&& test 14 eq_big_int (modulo, big_int_of_int 1)

;;
let quotient, modulo = quomod_big_int (big_int_of_int (-1)) (big_int_of_int 3) in
test 15 eq_big_int (quotient, minus_big_int unit_big_int)
&& test 16 eq_big_int (modulo, big_int_of_int 2)

;;
failwith_test 17 (quomod_big_int (big_int_of_int 1)) zero_big_int Division_by_zero

;;
let quotient, modulo = quomod_big_int (big_int_of_int 10) (big_int_of_int 20) in
...
;;
test 2 eq_big_int (gcd_big_int zero_big_int (big_int_of_int 1), big_int_of_int 1)

;;
test 3 eq_big_int (gcd_big_int (big_int_of_int 1) zero_big_int, big_int_of_int 1)

;;
test 4 eq_big_int (gcd_big_int (big_int_of_int 1) (big_int_of_int 2), big_int_of_int 1)

;;
test 5 eq_big_int (gcd_big_int (big_int_of_int 2) (big_int_of_int 1), big_int_of_int 1)

;;
test 6 eq_big_int (gcd_big_int (big_int_of_int 1) (big_int_of_int 1), big_int_of_int 1)

;;
test 7 eq_big_int (gcd_big_int (big_int_of_int 9) (big_int_of_int 16), big_int_of_int 1)

;;
test 8 eq_big_int (gcd_big_int (big_int_of_int 12) (big_int_of_int 16), big_int_of_int 4)
...
failwith_test
  8
  (fun () -> int_of_big_int (mult_big_int (big_int_of_int min_int) (big_int_of_int 2)))
  ()
  (Failure "int_of_big_int")
...
test
  9
  eq
  (is_int_big_int (succ_big_int (succ_big_int (big_int_of_int biggest_int))), false)
...
test
  10
  eq
  (is_int_big_int (minus_big_int (big_int_of_string (string_of_int monster_int))), false)
...
test
  10
  eq_big_int
  (bi1, add_big_int (mult_big_int bi2 (big_int_of_string "10")) (big_int_of_string "2"))
...
;;
test 2 eq_big_int (big_int_of_nat (power_base_int 10 8), big_int_of_int 100000000)
...
;;
test 2 eq_big_int (base_power_big_int 10 2 (big_int_of_int 2), big_int_of_int 200)

;;
test 3 eq_big_int (base_power_big_int 10 1 (big_int_of_int 123), big_int_of_int 1230)

;;
testing_function "power_int_positive_big_int"

;;
test 1 eq_big_int (power_int_positive_big_int 2 (big_int_of_int 10), big_int_of_int 1024)
...
;;
test 1 eq_big_int (power_big_int_positive_int (big_int_of_int 2) 10, big_int_of_int 1024)
...
test
  3
  eq_big_int
  ( power_big_int_positive_big_int (big_int_of_string "3") (big_int_of_string "47")
  , big_int_of_string "26588814358957503287787" )
...
;;
test 1 eq_big_int (square_big_int (big_int_of_string "0"), big_int_of_string "0")

;;
test 2 eq_big_int (square_big_int (big_int_of_string "1"), big_int_of_string "1")

;;
test 3 eq_big_int (square_big_int (big_int_of_string "-1"), big_int_of_string "1")

;;
test 4 eq_big_int (square_big_int (big_int_of_string "-7"), big_int_of_string "49")
...
;;
test 3 eq_big_int (big_int_of_int32 (-2147483648l), big_int_of_string "-2147483648")
...
;;
test 3 eq_int32 (int32_of_big_int (big_int_of_string "-2147483648"), -2147483648l)
...
let big_int_128 hi lo =
  add_big_int
    (mult_big_int (big_int_of_int64 hi) (big_int_of_string "18446744073709551616"))
    (big_int_of_int64 lo)
...
;;
test 2 eq_big_int (shift_left_big_int unit_big_int 31, big_int_of_string "2147483648")

;;
test
  3
  eq_big_int
  (shift_left_big_int unit_big_int 64, big_int_of_string "18446744073709551616")

;;
test
  4
  eq_big_int
  (shift_left_big_int unit_big_int 95, big_int_of_string "39614081257132168796771975168")
...
test
  2
  eq_big_int
  (shift_right_big_int (big_int_of_int 12345678) 3, big_int_of_int 1543209)

;;
test
  3
  eq_big_int
  (shift_right_big_int (big_int_of_string "5299989648942") 32, big_int_of_int 1234)
...
test
  5
  eq_big_int
  (shift_right_big_int (big_int_of_string "-5299989648942") 32, big_int_of_int (-1235))
...
test
  1
  eq_big_int
  (extract_big_int (big_int_of_int64 0x123456789ABCDEFL) 3 13, big_int_of_int 6589)

;;
test 2 eq_big_int (extract_big_int (big_int_128 h1 h2) 67 12, big_int_of_int 1343)

;;
test
  3
  eq_big_int
  (extract_big_int (big_int_of_string "-1844674407370955178") 37 9, big_int_of_int 307)
...
;;
test 6 eq_big_int (extract_big_int (big_int_of_int (-1)) 0 16, big_int_of_int 0xFFFF)

;;
test 7 eq_big_int (extract_big_int (big_int_of_int (-1)) 1027 12, big_int_of_int 0xFFF)

;;
test 8 eq_big_int (extract_big_int (big_int_of_int (-1234567)) 0 16, big_int_of_int 10617)
