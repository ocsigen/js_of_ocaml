...
failwith_test 8
  (fun () ->
    int_of_big_int (mult_big_int (big_int_of_int min_int) (big_int_of_int 2))
    )
  () (Failure "int_of_big_int")
...
;;
test 9 eq
  ( is_int_big_int (succ_big_int (succ_big_int (big_int_of_int biggest_int)))
  , false )
...
(* test 11 && eq_big_int (bi1, (add_big_int (mult_big_int bi2
   ...
   (big_int_of_string "+20e-1"))) && test 14 eq_big_int (minus_big_int bi1,
   (add_big_int (mult_big_int bi2 (big_int_of_string "-10e+0"))
   (big_int_of_string "-20e-1"))) && test 15 eq_big_int (minus_big_int bi1,
   (add_big_int (mult_big_int bi2 (big_int_of_string "-1e+1"))
   (big_int_of_string "-2e-0"))) && test 16 eq_big_int (minus_big_int bi1,
   (add_big_int (mult_big_int bi2 (big_int_of_string "-0.1e+2"))
   (big_int_of_string "-2.0e-0"))) && test 17 eq_big_int (minus_big_int bi1,
