...
;;
test 1 eq
  ( null_denominator (create_ratio (big_int_of_int 1) (big_int_of_int (-2)))
  , false )
...
(***** testing_function "verify_null_denominator" ;;
  ...
  test 1 eq (verify_null_denominator (ratio_of_string "0/1"), false) ;; test 2
...
;;
test 2 eq
  (is_integer_ratio (create_ratio (big_int_of_int 2) (big_int_of_int 3)), false)
...
(*********** test 2 eq_ratio (ratio_of_string ("12.3/34.56"), create_ratio
  ...
  (big_int_of_int 32560)) ;; test 4 eq_ratio (ratio_of_string ("12.3/345.6"),
  create_ratio (big_int_of_int 123) (big_int_of_int 3456)) ;; test 5 eq_ratio
  (ratio_of_string ("12.3/0.0"), create_ratio (big_int_of_int 123)
  (big_int_of_int 0)) ;; ***********)
...
(*********** testing_function "msd_ratio" ;;
  ...
  (create_ratio (big_int_of_int 1) (big_int_of_int 2)), (-1)) ;; test 5 eq_int
  (msd_ratio (create_ratio (big_int_of_int 2) (big_int_of_int 1)), 0) ;; test 6
  eq_int (msd_ratio (create_ratio (big_int_of_int 25) (big_int_of_int 21)), 0)
  ;; test 7 eq_int (msd_ratio (create_ratio (big_int_of_int 35) (big_int_of_int
  21)), 0) ;; test 8 eq_int (msd_ratio (create_ratio (big_int_of_int 215)
  (big_int_of_int 31)), 0) ;; test 9 eq_int (msd_ratio (create_ratio
  (big_int_of_int 2) (big_int_of_int 30)), (-2)) ;; test 10 eq_int (msd_ratio
  (create_ratio (big_int_of_int 2345) (big_int_of_int 23456)), (-2)) ;; test 11
  eq_int (msd_ratio (create_ratio (big_int_of_int 2345) (big_int_of_int 2346)),
  (-1)) ;; test 12 eq_int (msd_ratio (create_ratio (big_int_of_int 2345)
  (big_int_of_int 2344)), 0) ;; test 13 eq_int (msd_ratio (create_ratio
  (big_int_of_int 23456) (big_int_of_int 2345)), 1) ;; test 14 eq_int
  (msd_ratio (create_ratio (big_int_of_int 23467) (big_int_of_int 2345)), 1) ;;
  failwith_test 15 msd_ratio (create_ratio (big_int_of_int 1) (big_int_of_int
  0)) ("msd_ratio "^infinite_failure) ;; failwith_test 16 msd_ratio
  (create_ratio (big_int_of_int (-1)) (big_int_of_int 0)) ("msd_ratio
...
;;
test 2 eq_string
  ( approx_ratio_fix 5 (create_ratio (big_int_of_int 20) (big_int_of_int 3))
  , "+6.66667" )

;;
test 3 eq_string
  ( approx_ratio_fix 5 (create_ratio (big_int_of_int 2) (big_int_of_int 30))
  , "+0.06667" )
...
;;
test 9 eq_string
  ( approx_ratio_fix 5 (create_ratio (big_int_of_int 0) (big_int_of_int 1))
  , "+0" )
...
;;
test 13 eq_string
  ( approx_ratio_fix 1 (create_ratio (big_int_of_int 94) (big_int_of_int 1000))
  , "+0.1" )

;;
test 14 eq_string
  ( approx_ratio_fix 1 (create_ratio (big_int_of_int 49) (big_int_of_int 1000))
  , "+0.0" )
...
;;
test 1 eq_string
  ( approx_ratio_exp 5 (create_ratio (big_int_of_int 2) (big_int_of_int 3))
  , "+0.66667e0" )

;;
test 2 eq_string
  ( approx_ratio_exp 5 (create_ratio (big_int_of_int 20) (big_int_of_int 3))
  , "+0.66667e1" )
...
;;
test 7 eq_string
  ( approx_ratio_exp 5 (create_ratio (big_int_of_int 0) (big_int_of_int 1))
  , "+0.00000e0" )
