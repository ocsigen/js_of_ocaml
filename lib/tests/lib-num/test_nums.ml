...
test
  3
  eq_num
  (add_num (Int 1) (Ratio (ratio_of_string "3/4")), Ratio (ratio_of_string "7/4"))
...
;;
test 5 eq_num (add_num (Big_int (big_int_of_int 1)) (Big_int (big_int_of_int 3)), Int 4)
...
test
  7
  eq_num
  ( add_num (Ratio (ratio_of_string "2/3")) (Ratio (ratio_of_string "3/4"))
...
test
  3
  eq_num
  (sub_num (Int 1) (Ratio (ratio_of_string "3/4")), Ratio (ratio_of_string "1/4"))
...
test
  5
  eq_num
  (sub_num (Big_int (big_int_of_int 1)) (Big_int (big_int_of_int 3)), Int (-2))
...
test
  8
  eq_num
  ( sub_num (Ratio (ratio_of_string "2/3")) (Ratio (ratio_of_string "3/4"))
...
test
  2
  eq_num
  (mult_num (Int 127) (Int (int_of_string "257")), Int (int_of_string "32639"))

;;
test
  3
  eq_num
  (mult_num (Int 257) (Int (int_of_string "260")), Big_int (big_int_of_string "66820"))
...
test
  5
  eq_num
  (mult_num (Int 10) (Ratio (ratio_of_string "3/4")), Ratio (ratio_of_string "15/2"))
...
;;
test 7 eq_num (mult_num (Big_int (big_int_of_int 2)) (Big_int (big_int_of_int 3)), Int 6)
...
test
  9
  eq_num
  ( mult_num (Ratio (ratio_of_string "2/3")) (Ratio (ratio_of_string "3/4"))
...
;;
test 2 eq_num (div_num (Int (int_of_string "32639")) (Int (int_of_string "257")), Int 127)

;;
test
  3
  eq_num
  (div_num (Big_int (big_int_of_string "66820")) (Int (int_of_string "257")), Int 260)
...
test
  5
  eq_num
  (div_num (Ratio (ratio_of_string "15/2")) (Int 10), Ratio (ratio_of_string "3/4"))

;;
test 6 eq_num (div_num (Big_int (big_int_of_int 6)) (Big_int (big_int_of_int 3)), Int 2)
...
test
  8
  eq_num
  ( div_num (Ratio (ratio_of_string "15/2")) (Ratio (ratio_of_string "3/4"))
...
test
  9
  eq_num
  ( div_num (Ratio (ratio_of_string "1/2")) (Ratio (ratio_of_string "3/4"))
...
;;
test 7 eq_num (num_of_string "1234567890", Big_int (big_int_of_string "1234567890"))
...
;;
test 13 eq_num (num_of_string "0b1101/0O1765", Ratio (ratio_of_string "0b1101/0o1765"))
