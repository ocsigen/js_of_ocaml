...
;;
test 5 eq_num
  (add_num (Big_int (big_int_of_int 1)) (Big_int (big_int_of_int 3)), Int 4)
...
;;
test 7 eq_num
  (mult_num (Big_int (big_int_of_int 2)) (Big_int (big_int_of_int 3)), Int 6)
...
;;
test 2 eq_num
  (div_num (Int (int_of_string "32639")) (Int (int_of_string "257")), Int 127)

;;
test 3 eq_num
  ( div_num (Big_int (big_int_of_string "66820")) (Int (int_of_string "257"))
  , Int 260 )
...
;;
test 6 eq_num
  (div_num (Big_int (big_int_of_int 6)) (Big_int (big_int_of_int 3)), Int 2)
...
(********* test 2 eq_num (num_of_string "12.3/34.56", Ratio (ratio_of_string
  ...
  (ratio_of_string "123/32560"));; test 4 eq_num (num_of_string "12.3/345.6",
  Ratio (ratio_of_string "123/3456"));; set_error_when_null_denominator false;;
  test 5 eq_num (num_of_string "12.3/0.0", Ratio (ratio_of_string "123/0"));;
  test 6 eq_num (num_of_string "0/0", Ratio (ratio_of_string "0/0"));;
