...
let html_element : htmlElement t constr = Js.Unsafe.get_global_dot "HTMLElement"
...
module CoerceTo = struct
  ...
  let mouseEvent ev = unsafeCoerceEvent (Js.Unsafe.get_global_dot "MouseEvent") ev
  let keyboardEvent ev = unsafeCoerceEvent (Js.Unsafe.get_global_dot "KeyboardEvent") ev
  let wheelEvent ev = unsafeCoerceEvent (Js.Unsafe.get_global_dot "WheelEvent") ev
  let mouseScrollEvent ev = unsafeCoerceEvent (Js.Unsafe.get_global_dot "MouseScrollEvent") ev
  let popStateEvent ev = unsafeCoerceEvent (Js.Unsafe.get_global_dot "PopStateEvent") ev
