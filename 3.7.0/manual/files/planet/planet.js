...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _t_=[0,0,0,0],
     _u_=[0,caml_string_of_jsbytes("map.ml"),398,10],
     _v_=[0,0,0],
     ...
     {var switch$0=0;
      if
       ...
       {var r=caml_create_bytes(len);
        ...
        var _gm_=r;
        switch$0 = 1}
      if(! switch$0)var _gm_=invalid_arg(_k_);
      return caml_string_of_bytes(_gm_)}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _gk_=1;return _gk_}
       catch(_gl_)
        {_gl_ = caml_wrap_exception(_gl_);
         if(_gl_ === Not_found)return 0;
         throw _gl_}
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_gi_=l - 1 | 0,_gh_=1;
      if(! (_gi_ < 1))
       {var i=_gh_;
        for(;;)
    ...
    function _w_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_gg_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gb_=height(lr);
            if(_gb_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _gc_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_gc_)}
            return invalid_arg(_o_)}
          return invalid_arg(_p_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gd_=height(rl);
            if(_gd_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _ge_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_ge_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        var _gf_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gf_]}
      var empty=0;
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _f__=param$0[1];
            if(_f__){var param$0=_f__;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
         ...
         {var _f9_=param[1];
          if(_f9_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_f9_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_s_)}
      function _fM_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _f6_=caml_call2(p,v,d);
            if(_f6_)
             {var _f7_=for_all(p,l);
              if(_f7_){var param$0=r;continue}
              var _f8_=_f7_}
            else
             var _f8_=_f6_;
            return _f8_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _f3_=caml_call2(p,v,d);
            if(_f3_)
             var _f4_=_f3_;
            else
             {var _f5_=exists(p,l);
              if(! _f5_){var param$0=r;continue}
              var _f4_=_f5_}
            return _f4_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _fZ_=merge(f,r1,r2),
             _f0_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_f0_,_fZ_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _f1_=merge(f,r1$0,r2$0),
           _f2_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_f2_,_f1_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _fX_=concat(lf,rf);return [0,join(lt,v,d,rt),_fX_]}
          var _fY_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_fY_]}
        return _v_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _fU_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_fU_)
               {var _fV_=caml_call2(cmp,d1,d2);
                if(_fV_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_fT_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _fT_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_fR_=cons_enum(t,rest);
          return [0,[0,k,v],function(_fS_){return seq_of_enum(_fR_,_fS_)}]}
        return 0}
      function to_seq(m)
       {var _fP_=cons_enum(m,0);
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _fN_=c;
          return function(_fO_){return seq_of_enum(_fN_,_fO_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_fL_=q[3];
      return _fL_
              ?(q[1] = q[1] + 1 | 0,_fL_[2] = cell,q[3] = cell,0)
       ...
       switch(ty1[0])
        {case 0:
         ...
         case 7:
          ...
          break;
         case 8:
          var switch$9=0,_fy_=ty1[2],_fz_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fA_=trans(_fy_,rest2$7);
              return [8,trans(_fz_,ty2),_fA_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_fB_=ty1[3],_fC_=ty1[2],_fD_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fC_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fD_,ty22,trans(_fB_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_fE_,rest2$9)]}
          throw [0,Assert_failure,_ai_];
         case 11:
          var switch$11=0,_fF_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_fF_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_aj_];
          break;
         case 12:
          var switch$12=0,_fG_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_fG_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ak_];
          break;
         case 13:
          var switch$13=0,_fH_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_fH_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_al_];
          break;
         default:
          var switch$14=0,_fI_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_fI_,rest2$13)];
             default:switch$14 = 1}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _e4_=function(param){return 0},
         _e5_=function(param){return 0},
         _e6_=function(param){return 0};
        return [0,function(param){return 0},_e6_,_e5_,_e4_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _e7_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_e7_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _e8_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _e9_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _e__=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _e$_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _fa_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _fb_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _fc_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _fd_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _fe_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _ff_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _fg_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _fh_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _fi_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _fj_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _fk_=function(param){caml_call1(de$12,0);return 0},
           _fl_=function(param){caml_call1(ed$12,0);return 0},
           _fm_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _fn_=function(param){caml_call1(de$13,0);return 0},
           _fo_=function(param){caml_call1(ed$13,0);return 0},
           _fp_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       {if(prec)
         {var _e3_=match[2];
          if(typeof _e3_ !== "number" && 2 === _e3_[0])
           {var rest=_e3_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _e1_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_e1_))
             throw Type_mismatch;
            var _e2_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_e2_))
             throw Type_mismatch;
            var
         ...
         case 4:
          ...
          if(typeof _eO_ !== "number" && 2 === _eO_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_eN_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           _eQ_=match$7[3],
           _eP_=match$7[1];
          if(typeof _eQ_ !== "number" && 3 === _eQ_[0])
           {var
             fmtty_rest$4=_eQ_[1],
             prec$2=match$7[2],
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_eP_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _eS_=match$9[3],
           _eR_=match$9[1];
          if(typeof _eS_ !== "number" && 4 === _eS_[0])
           {var
             fmtty_rest$5=_eS_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_eR_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
          ...
          if(typeof _eU_ !== "number" && 5 === _eU_[0])
           {var
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_eT_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _eW_=match$13[3],
           _eV_=match$13[1];
          if(typeof _eW_ !== "number" && 6 === _eW_[0])
           {var
             fmtty_rest$7=_eW_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_eV_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _eY_=match$15[2],
           _eX_=match$15[1];
          if(typeof _eY_ !== "number" && 7 === _eY_[0])
           {var
             fmtty_rest$8=_eY_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_eX_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _eZ_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_eZ_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _e0_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_e0_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_e0_[1];
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _eG_ >>> 0)
           {if(33 < (_eG_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _eG_)switch$0 = 1;
           ...
           {var i$0=_ey_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _eD_=match - 34 | 0,switch$2=0;
                if(58 < _eD_ >>> 0)
                 {if(93 <= _eD_)switch$2 = 1}
                else
                 if(56 < (_eD_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _el_ >>> 0)
              {if(55 === _el_)switch$0 = 1}
             else
              if(21 < (_el_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _em_=1}
           var _en_=_em_?str:symbol(str,_bc_);
           return caml_special_val(_en_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_eh_=l - 1 | 0,_eg_=0;
           if(! (_eh_ < 0))
            {var i=_eg_;
             for(;;)
              {var c=caml_bytes_unsafe_get(s,i),switch$1=0;
               if(97 <= c && ! (122 < c)){var _ei_=c - 32 | 0;switch$1 = 1}
               if(! switch$1)var _ei_=c;
               caml_bytes_unsafe_set(r,i,_ei_);
               var _ej_=i + 1 | 0;
               if(_eh_ !== i){var i=_ej_;continue}
               break}}
           var _ek_=r}
         return caml_string_of_bytes(_ek_);
            ...
            {if(0 === pad$5[0])
              {var _ec_=pad$5[2],_ed_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_ed_,_ec_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_ed_,_ec_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_ed_,_ec_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _ee_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_ee_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_ee_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_ee_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _ef_=type_format_gen(fmt$0,fmtty$0);
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_eb_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_eb_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _d__=[8,acc,_bm_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_d__,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_d__,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_d9_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_d9_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_d7_,_d6_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_d7_,_d6_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_d7_,_d6_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _d8_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_d8_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_d8_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_d8_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_d1_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_d1_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bu_;
      var _dZ_=other_fields(x,i + 1 | 0),_d0_=field(x,i);
      return caml_call2(sprintf(_bv_),_d0_,_dZ_)}
       ...
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          ...
          _dV_=field(e,1),
          _dX_=caml_call2(sprintf(_bw_),_dV_,_dU_);
        else
         switch(match)
          {case 0:var _dX_=_bx_;break;
           case 1:var _dX_=_by_;break;
           default:var _dW_=field(e,1),_dX_=caml_call1(sprintf(_bz_),_dW_)}
        return symbol(constructor,_dX_)}
      return e[1]}
           ...
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _dP_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bK_),_dP_,_dO_,_dN_,_dM_,_dL_,_dK_)];
            else
             if(slot[1])
              var match=0;
             else
              var _dQ_=info(0),match=[0,caml_call1(sprintf(_bM_),_dQ_)];
    ...
    var mouseup="mouseup",mousemove="mousemove",doc=window.document;
    ...
    function checkbox(txt,checked,action)
     {var b=createInput([0,"checkbox"],0,doc);
      ...
      add$0(lab,b);
      add$0(lab,doc.createTextNode(caml_jsstring_of_string(txt)));
      return lab}
    ...
    function start(param$0)
     {function _cv_(texture)
       {var
        ...
        var
         ctx$1=canvas$0.getContext("2d"),
         ctx$2=canvas$1.getContext("2d"),
         tw=texture.width,
         th=texture.height,
         _cw_=o[1],
         uv=
        ...
        var d=createDiv(doc);
        add$0(d,doc.createTextNode("Click and drag mouse to rotate."));
        add$0(ctrl,d);
        ...
        for(;;)
         {if(param$0)
           {var l=param$0[2],a=param$0[1],o$0=unsafeCreateElement(doc,_bT_);
            add$0(o$0,doc.createTextNode(caml_jsstring_of_string(a)));
