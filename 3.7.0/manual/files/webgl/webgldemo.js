...
(function(joo_global_object)
   {"use strict";
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_gY_ = caml_wrap_exception(_gY_);
              if(_gY_[1] !== Sys_error)throw _gY_;
              var _gX_=_gY_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function init(l,f)
     {if(0 === l)return [0];
      if(0 <= l)
       {var res=caml_make_vect(l,caml_call1(f,0)),_gV_=l - 1 | 0,_gU_=1;
        if(! (_gV_ < 1))
         {var i=_gU_;
          for(;;)
    ...
    function add(x,q)
     {var cell=[0,x,0],_gT_=q[3];
      return _gT_
              ?(q[1] = q[1] + 1 | 0,_gT_[2] = cell,q[3] = cell,0)
    ...
    function take(q)
     {var _gR_=q[2];
      if(_gR_)
       {var _gS_=_gR_[1];
        if(_gR_[2])
         {var next=_gR_[2];q[1] = q[1] - 1 | 0;q[2] = next;return _gS_}
        q[1] = 0;
        q[2] = 0;
        q[3] = 0;
        return _gS_}
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_gw_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_gw_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_gx_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_gx_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_gy_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_gy_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_gz_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_gz_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
         ...
         case 7:
          ...
          break;
         case 8:
          var switch$9=0,_gE_=ty1[2],_gF_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
          ...
          break;
         case 9:
          var switch$10=0,_gH_=ty1[3],_gI_=ty1[2],_gJ_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
       ...
       {if(prec)
         {var _f9_=match[2];
          if(typeof _f9_ !== "number" && 2 === _f9_[0])
           {var rest=_f9_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _f7_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_f7_))
             throw Type_mismatch;
            var _f8_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_f8_))
             throw Type_mismatch;
            var
         ...
         case 4:
          ...
          if(typeof _fU_ !== "number" && 2 === _fU_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_fT_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _fW_ !== "number" && 3 === _fW_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_fV_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
          ...
          if(typeof _fY_ !== "number" && 4 === _fY_[0])
           {var
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_fX_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _f0_=match$11[3],
           _fZ_=match$11[1];
          if(typeof _f0_ !== "number" && 5 === _f0_[0])
           {var
             fmtty_rest$6=_f0_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_fZ_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
          ...
          if(typeof _f2_ !== "number" && 6 === _f2_[0])
           {var
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_f1_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _f4_=match$15[2],
           _f3_=match$15[1];
          if(typeof _f4_ !== "number" && 7 === _f4_[0])
           {var
             fmtty_rest$8=_f4_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_f3_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _f6_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_f6_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_f6_[1];
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _fM_ >>> 0)
           {if(33 < (_fM_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _fM_)switch$0 = 1;
           ...
           {var i$0=_fE_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _fJ_=match - 34 | 0,switch$2=0;
                if(58 < _fJ_ >>> 0)
                 {if(93 <= _fJ_)switch$2 = 1}
                else
                 if(56 < (_fJ_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _fK_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _fK_=4;break;case 1:var _fK_=2;break}
              n[1] = n[1] + _fK_ | 0;
              var _fL_=i$0 + 1 | 0;
              if(_fF_ !== i$0){var i$0=_fL_;continue}
              break}}
             ...
             {var i=_fG_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _fN_=s}
          var str$0=caml_string_of_bytes(_fN_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_fz_=caml_ml_string_length(s) - 1 | 0,_fy_=0;
        if(! (_fz_ < 0))
         {var i$0=_fy_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _fD_=i$0 + 1 | 0;
            if(_fz_ !== i$0){var i$0=_fD_;continue}
            break}}
        var
         digits=n[1],
         buf=
    ...
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _fw_=_aI_;break;
        case 2:var _fw_=_aJ_;break;
        case 4:var _fw_=_aL_;break;
        case 5:var _fw_=_aM_;break;
        case 6:var _fw_=_aN_;break;
        case 7:var _fw_=_aO_;break;
        case 8:var _fw_=_aP_;break;
        case 9:var _fw_=_aQ_;break;
        case 10:var _fw_=_aR_;break;
        case 11:var _fw_=_aS_;break;
        case 0:
        case 13:var _fw_=_aH_;break;
        case 3:
        case 14:var _fw_=_aK_;break;
        default:var _fw_=_aT_}
    ...
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _fv_=_aV_;break;
        ...
        case 6:var _fv_=_a0_;break;
        case 7:var _fv_=_a1_;break;
        case 8:var _fv_=_a2_;break;
        case 9:var _fv_=_a3_;break;
        case 10:var _fv_=_a4_;break;
        case 11:var _fv_=_a5_;break;
        case 0:
        case 13:var _fv_=_aU_;break;
        case 3:
        case 14:var _fv_=_aX_;break;
        default:var _fv_=_a6_}
      return transform_int_alt(iconv,caml_format_int(_fv_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _fu_=_av_;break;
        case 2:var _fu_=_aw_;break;
        case 4:var _fu_=_ay_;break;
        case 5:var _fu_=_az_;break;
        case 6:var _fu_=_aA_;break;
        case 7:var _fu_=_aB_;break;
        case 8:var _fu_=_aC_;break;
        case 9:var _fu_=_aD_;break;
        case 10:var _fu_=_aE_;break;
        case 11:var _fu_=_aF_;break;
        case 0:
        case 13:var _fu_=_au_;break;
        case 3:
        case 14:var _fu_=_ax_;break;
        default:var _fu_=_aG_}
      return transform_int_alt(iconv,caml_int64_format(_fu_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _fr_ >>> 0)
              {if(55 === _fr_)switch$0 = 1}
             else
              if(21 < (_fr_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _fs_=1}
           var _ft_=_fs_?str:symbol(str,_a7_);
           return caml_special_val(_ft_)}
        case 6:return hex(0);
        case 7:
            ...
            {var i=_fm_;
             for(;;)
              {var c=caml_bytes_unsafe_get(s,i),switch$1=0;
               if(97 <= c && ! (122 < c)){var _fo_=c - 32 | 0;switch$1 = 1}
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _fl_=type_format_gen(fmt$0,fmtty$0);
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_fh_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_fh_])}}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_fb_,_fa_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_fb_,_fa_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_fb_,_fa_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _fc_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_fc_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_fc_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_fc_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_e7_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_e7_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bn_;
      var _e5_=other_fields(x,i + 1 | 0),_e6_=field(x,i);
      return caml_call2(sprintf(_bo_),_e6_,_e5_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _e0_=other_fields(e,2),
          _e1_=field(e,1),
          _e3_=caml_call2(sprintf(_bp_),_e1_,_e0_);
        else
         switch(match)
          {case 0:var _e3_=_bq_;break;
           case 1:var _e3_=_br_;break;
           default:var _e2_=field(e,1),_e3_=caml_call1(sprintf(_bs_),_e2_)}
        return symbol(constructor,_e3_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _eY_=a.length - 1 - 1 | 0,_eX_=0;
        if(! (_eY_ < 0))
         {var i=_eX_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _eV_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bD_),_eV_,_eU_,_eT_,_eS_,_eR_,_eQ_)];
            else
             if(slot[1])
              var match=0;
             else
              var _eW_=info(0),match=[0,caml_call1(sprintf(_bF_),_eW_)];
    ...
    function unsafeCoerce(tag,e)
     {var _eO_=caml_jsstring_of_string(tag);
      return e.tagName.toLowerCase() === _eO_?e:no_handler}
    ...
    var
     ...
     arr=_bV_.split(caml_jsstring_of_string(make$0(1,38))),
     len=arr.length;
    ...
    function load_shader(gl,shader,text)
     {gl.shaderSource(shader,text);
      ...
      var _dY_=1 - (gl.getShaderParameter(shader,gl.COMPILE_STATUS) | 0);
      if(_dY_)
       {var
         ...
         headers$0=
          function(s)
           {function _dz_(v){return [0,caml_string_of_jsstring(v)]}
            ...
            return case$0
                    (req.getResponseHeader(caml_jsbytes_of_string(s)),_dA_,_dz_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
           {if(382334108 === st[1])
    ...
    function start(param)
     {var
      ...
      gl.linkProgram(prog);
      if(1 - (gl.getProgramParameter(prog,gl.LINK_STATUS) | 0))error(_cj_);
      debug(_cy_);
      gl.useProgram(prog);
      check_error(gl);
      debug(_cz_);
       ...
       {var
        ...
        for(;;)
         {if(cell)
          ...
          n.data = caml_jsstring_of_string(caml_call1(sprintf(_cB_),fps));
          var
           match=task(0),
           w=match[2],
           t=match[1],
          ...
          on_cancel
           (t,
            function(param)
             {var _dn_=id[1];
              if(_dn_){var x=_dn_[1];id[1] = 0;return window.clearTimeout(x)}
              return 0});
