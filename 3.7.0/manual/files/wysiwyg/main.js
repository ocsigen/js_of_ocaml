...
(function(joo_global_object)
   {"use strict";
       ...
       switch(ty1[0])
        {case 0:
         ...
         case 7:
          ...
          break;
         case 8:
          var switch$9=0,_fN_=ty1[2],_fO_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
          ...
          break;
         case 9:
          var switch$10=0,_fQ_=ty1[3],_fR_=ty1[2],_fS_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _fh_=function(param){return 0},
         _fi_=function(param){return 0},
         _fj_=function(param){return 0};
        return [0,function(param){return 0},_fj_,_fi_,_fh_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _fk_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_fk_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _fl_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _fm_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _fn_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _fo_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _fp_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _fq_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _fr_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _fs_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _ft_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _fu_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _fv_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _fw_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _fx_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _fy_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _fz_=function(param){caml_call1(de$12,0);return 0},
           _fA_=function(param){caml_call1(ed$12,0);return 0},
           _fB_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _fC_=function(param){caml_call1(de$13,0);return 0},
           _fD_=function(param){caml_call1(ed$13,0);return 0},
           _fE_=function(param){caml_call1(af$13,0);return 0};
          return [0,
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _fe_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_fe_))
             throw Type_mismatch;
            var _ff_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_ff_))
             throw Type_mismatch;
            var
        ...
        {case 0:
         ...
         case 4:
          var
           ...
           _e3_=match$5[3],
           _e2_=match$5[1];
          if(typeof _e3_ !== "number" && 2 === _e3_[0])
           {var
             fmtty_rest$3=_e3_[1],
             prec$0=match$5[2],
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_e2_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           _e5_=match$7[3],
           _e4_=match$7[1];
          if(typeof _e5_ !== "number" && 3 === _e5_[0])
           {var
             fmtty_rest$4=_e5_[1],
             prec$2=match$7[2],
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_e4_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _e7_=match$9[3],
           _e6_=match$9[1];
          if(typeof _e7_ !== "number" && 4 === _e7_[0])
           {var
             fmtty_rest$5=_e7_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_e6_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _e9_=match$11[3],
           _e8_=match$11[1];
          if(typeof _e9_ !== "number" && 5 === _e9_[0])
           {var
             fmtty_rest$6=_e9_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_e8_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _e$_=match$13[3],
           _e__=match$13[1];
          if(typeof _e$_ !== "number" && 6 === _e$_[0])
           {var
             fmtty_rest$7=_e$_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_e__,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fd_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_fd_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_fd_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_eq_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_eq_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _en_=[8,acc,_be_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_en_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_en_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_em_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_em_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_ek_,_ej_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_ek_,_ej_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_ek_,_ej_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _el_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_el_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_el_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_el_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
